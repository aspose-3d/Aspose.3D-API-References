...
url: /hi/nodejs-java/aspose.threed/ellipseshape/
---
## EllipseShape class

पैरामीटरों द्वारा परिभाषित IFC संगत एलिप्स आकार। प्रोफ़ाइल की मध्य स्थिति बाउंडिंग बॉक्स के केंद्र में होती है।
...
| नाम | विवरण |
| --- | --- |
| getSemiAxis1() | x अक्ष की दिशा में मापी गई दीर्घवृत्त की पहली त्रिज्या को प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setSemiAxis1(value) | x अक्ष की दिशा में मापी गई दीर्घवृत्त की पहली त्रिज्या को प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getSemiAxis2() | एलिप्स के दूसरे त्रिज्या को प्राप्त करता है या सेट करता है, जो y‑अक्ष की दिशा में मापी जाती है। |
...
| नाम | विवरण |
| --- | --- |
| setSemiAxis2(value) | एलिप्स के दूसरे त्रिज्या को प्राप्त करता है या सेट करता है, जो y‑अक्ष की दिशा में मापी जाती है। |

...
url: /hi/nodejs-java/aspose.threed/compositecurve/
---
## CompositeCurve class

एक CompositeCurve कई कर्व खंडों से बना होता है।
...
| नाम | विवरण |
| --- | --- |
| constructor() | CompositeCurve का कंस्ट्रक्टर |
...
| नाम | विवरण |
| --- | --- |
| addSegment(curve, sameDirection) | यह |

...
url: /hi/nodejs-java/aspose.threed/entity/
---
## Entity class

सभी एंटिटीज़ की बेस क्लास। एंटिटी एक ठोस ऑब्जेक्ट को दर्शाता है जो Light/Geometry जैसी नोड के अंतर्गत जुड़ा होता है।
...
| नाम | विवरण |
| --- | --- |
| constructor(name) | Entity क्लास की नई इंस्टेंस को इनिशियलाइज़ करता है। |

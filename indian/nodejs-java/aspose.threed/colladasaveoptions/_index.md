...
url: /hi/nodejs-java/aspose.threed/colladasaveoptions/
---
## ColladaSaveOptions class

Collada के लिए सहेजने के विकल्प
...
| नाम | विवरण |
| --- | --- |
| constructor() | ColladaSaveOptions का कंस्ट्रक्टर |
...
| नाम | विवरण |
| --- | --- |
| getIndented() | निर्यात किए गए XML दस्तावेज़ को इंडेंट किया गया है या नहीं, इसे प्राप्त या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setIndented(value) | निर्यात किए गए XML दस्तावेज़ को इंडेंट किया गया है या नहीं, इसे प्राप्त या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getTransformStyle() | नोड ट्रांसफ़ॉर्मेशन की शैली को प्राप्त या सेट करता है। इस प्रॉपर्टी का मान ColladaTransformStyle पूर्णांक स्थिरांक है। |
...
| नाम | विवरण |
| --- | --- |
| setTransformStyle(value) | नोड ट्रांसफ़ॉर्मेशन की शैली को प्राप्त या सेट करता है। इस प्रॉपर्टी का मान ColladaTransformStyle पूर्णांक स्थिरांक है। |

...
url: /hi/nodejs-java/aspose.threed/mirroredprofile/
---
## MirroredProfile class

IFC संगत मिरर प्रोफ़ाइल। यह प्रोफ़ाइल बेस प्रोफ़ाइल को y-अक्ष के बारे में प्रतिबिंबित करके नई प्रोफ़ाइल परिभाषित करती है।
...
| नाम | विवरण |
| --- | --- |
| constructor(baseProfile) | मौजूदा प्रोफ़ाइल से एक नया MirroredProfile बनाता है। |

 **Parameters:**

| नाम | प्रकार | विवरण |
| --- | --- | --- |
| baseProfile | Profile | मिरर करने के लिए बेस प्रोफ़ाइल। |
...
| नाम | विवरण |
| --- | --- |
| getBaseProfile() | मिरर करने के लिए बेस प्रोफ़ाइल। |

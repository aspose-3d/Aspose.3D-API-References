...
url: /hi/nodejs-java/aspose.threed/gltfloadoptions/
---
...
| नाम | विवरण |
| --- | --- |
| constructor() | GltfLoadOptions का कंस्ट्रक्टर |
...
| नाम | विवरण |
| --- | --- |
| getFlipTexCoordV() | जाल (mesh) के टेक्सचर कोऑर्डिनेट में v(t) कोऑर्डिनेट को उलटें, डिफ़ॉल्ट मान true है। |
...
| नाम | विवरण |
| --- | --- |
| setFlipTexCoordV(value) | जाल (mesh) के टेक्सचर कोऑर्डिनेट में v(t) कोऑर्डिनेट को उलटें, डिफ़ॉल्ट मान true है। |

...
url: /hi/nodejs-java/aspose.threed/hollowcircleshape/
---
## HollowCircleShape class

IFC संगत खोखला सर्कल प्रोफ़ाइल।
...
| नाम | विवरण |
| --- | --- |
| getWallThickness() | बाहरी और आंतरिक त्रिज्या के बीच अंतर को प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setWallThickness(value) | बाहरी और आंतरिक त्रिज्या के बीच अंतर को प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getRadius() | वृत्त की त्रिज्या को प्राप्त या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setRadius(value) | वृत्त की त्रिज्या को प्राप्त या सेट करता है। |

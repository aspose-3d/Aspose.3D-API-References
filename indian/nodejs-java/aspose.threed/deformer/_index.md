...
url: /hi/nodejs-java/aspose.threed/deformer/
---
## Deformer class

SkinDeformer और MorphTargetDeformer के लिए बेस क्लास
...
| नाम | विवरण |
| --- | --- |
| constructor(name) | Deformer क्लास की नई इंस्टेंस को प्रारंभ करता है। |

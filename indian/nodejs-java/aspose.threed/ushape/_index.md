...
url: /hi/nodejs-java/aspose.threed/ushape/
---
## UShape class

IFC संगत U-आकार, पैरामीटरों द्वारा परिभाषित।
...
| नाम | विवरण |
| --- | --- |
| constructor() | UShape का कंस्ट्रक्टर |
...
| नाम | विवरण |
| --- | --- |
| getDepth() | वेब की लंबाई को प्राप्त या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setDepth(value) | वेब की लंबाई को प्राप्त या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getFlangeWidth() | फ्लैंज की लंबाई को प्राप्त या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setFlangeWidth(value) | फ्लैंज की लंबाई को प्राप्त या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getWebThickness() | वेब की मोटाई प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setWebThickness(value) | वेब की मोटाई प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getFlangeThickness() | फ्लैंज की मोटाई को प्राप्त या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setFlangeThickness(value) | फ्लैंज की मोटाई को प्राप्त या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getFilletRadius() | फ्लैंज और वेब के बीच फ़िलेट की त्रिज्या को प्राप्त या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setFilletRadius(value) | फ्लैंज और वेब के बीच फ़िलेट की त्रिज्या को प्राप्त या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getEdgeRadius() | फ्लैंज के किनारे में किनारे की त्रिज्या प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setEdgeRadius(value) | फ्लैंज के किनारे में किनारे की त्रिज्या प्राप्त करता है या सेट करता है। |

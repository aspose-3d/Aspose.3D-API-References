...
url: /hi/nodejs-java/aspose.threed/hollowrectangleshape/
---
## HollowRectangleShape class

IFC संगत खोखला आयताकार आकार जिसमें अंदरूनी/बाहरी गोल कोने हों।
...
| नाम | विवरण |
| --- | --- |
| getWallThickness() | आयत की सीमा और आंतरिक छेद के बीच की मोटाई |
...
| नाम | विवरण |
| --- | --- |
| setWallThickness(value) | आयत की सीमा और आंतरिक छेद के बीच की मोटाई |
...
| नाम | विवरण |
| --- | --- |
| getInnerFilletRadius() | आंतरिक आयत की फ़िलेट त्रिज्या। |
...
| नाम | विवरण |
| --- | --- |
| setInnerFilletRadius(value) | आंतरिक आयत की फ़िलेट त्रिज्या। |
...
| नाम | विवरण |
| --- | --- |
| getRoundingRadius() | सभी चार कोनों के गोलाकार चापों की त्रिज्या प्राप्त करता है या सेट करता है, डिग्री में मापी गई। डिफ़ॉल्ट मान 0.0 है। |
...
| नाम | विवरण |
| --- | --- |
| setRoundingRadius(value) | सभी चार कोनों के गोलाकार चापों की त्रिज्या प्राप्त करता है या सेट करता है, डिग्री में मापी गई। डिफ़ॉल्ट मान 0.0 है। |
...
| नाम | विवरण |
| --- | --- |
| getXDim() | x-अक्ष की दिशा में आयत की सीमा प्राप्त करता है या सेट करता है। डिफ़ॉल्ट मान 2.0 है। |
...
| नाम | विवरण |
| --- | --- |
| setXDim(value) | x-अक्ष की दिशा में आयत की सीमा प्राप्त करता है या सेट करता है। डिफ़ॉल्ट मान 2.0 है। |
...
| नाम | विवरण |
| --- | --- |
| getYDim() | y-अक्ष की दिशा में आयत की सीमा प्राप्त करता है या सेट करता है। डिफ़ॉल्ट मान 2.0 है। |
...
| नाम | विवरण |
| --- | --- |
| setYDim(value) | y-अक्ष की दिशा में आयत की सीमा प्राप्त करता है या सेट करता है। डिफ़ॉल्ट मान 2.0 है। |

...
url: /hi/nodejs-java/aspose.threed/transformedcurve/
---
## TransformedCurve class

एक TransformedCurve ट्रांसफ़ॉर्म मैट्रिक्स का उपयोग करके कर्व को स्थान देता है। यह TrimmedCurve या CompositeCurve के भीतर ट्रांसफ़ॉर्मेशन करने की अनुमति देता है।
...
| नाम | विवरण |
| --- | --- |
| constructor() | TransformedCurve का कंस्ट्रक्टर |
...
| नाम | विवरण |
| --- | --- |
| constructor_overload(basisCurve, transformation) | TransformedCurve का कंस्ट्रक्टर |
...
| नाम | विवरण |
| --- | --- |
| getTransformMatrix() | ट्रांसफ़ॉर्मेशन मैट्रिक्स। |
...
| नाम | विवरण |
| --- | --- |
| setTransformMatrix(value) | ट्रांसफ़ॉर्मेशन मैट्रिक्स। |
...
| नाम | विवरण |
| --- | --- |
| setBasisCurve(value) | बेसिस कर्व। |

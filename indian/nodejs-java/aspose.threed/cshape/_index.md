...
url: /hi/nodejs-java/aspose.threed/cshape/
---
## CShape class

पैरामीटरों द्वारा परिभाषित IFC संगत C-आकार प्रोफ़ाइल। प्रोफ़ाइल की मध्य स्थिति बाउंडिंग बॉक्स के केंद्र में होती है।
...
| नाम | विवरण |
| --- | --- |
| constructor() | CShape का कंस्ट्रक्टर |
...
| नाम | विवरण |
| --- | --- |
| getDepth() | प्रोफ़ाइल की गहराई प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setDepth(value) | प्रोफ़ाइल की गहराई प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getWidth() | प्रोफ़ाइल की चौड़ाई प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setWidth(value) | प्रोफ़ाइल की चौड़ाई प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getGirth() | परिधि की लंबाई प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setGirth(value) | परिधि की लंबाई प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getWallThickness() | दीवार की मोटाई प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setWallThickness(value) | दीवार की मोटाई प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getInternalFilletRadius() | आंतरिक फ़िलेट त्रिज्या प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setInternalFilletRadius(value) | आंतरिक फ़िलेट त्रिज्या प्राप्त करता है या सेट करता है। |

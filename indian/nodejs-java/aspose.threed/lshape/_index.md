...
url: /hi/nodejs-java/aspose.threed/lshape/
---
## LShape class
...
| नाम | विवरण |
| --- | --- |
| constructor() | LShape का कंस्ट्रक्टर |
...
| नाम | विवरण |
| --- | --- |
| getThickness() | स्थिर दीवार की मोटाई प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setThickness(value) | स्थिर दीवार की मोटाई प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getFilletRadius() | फ़िलेट की त्रिज्या प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setFilletRadius(value) | फ़िलेट की त्रिज्या प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getEdgeRadius() | किनारे की त्रिज्या प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setEdgeRadius(value) | किनारे की त्रिज्या प्राप्त करता है या सेट करता है। |

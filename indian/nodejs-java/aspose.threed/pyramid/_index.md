...
url: /hi/nodejs-java/aspose.threed/pyramid/
---
## Pyramid class
...
| नाम | विवरण |
| --- | --- |
| constructor() | डिफ़ॉल्ट नीचे के क्षेत्र (10, 10) और डिफ़ॉल्ट ऊँचाई (5) के साथ एक नया pyramid इंस्टेंस बनाएं। |
...
| नाम | विवरण |
| --- | --- |
| constructor_overload(xbottom, ybottom, height) | निर्दिष्ट नीचे के क्षेत्र के साथ एक नया pyramid इंस्टेंस बनाएं |

 **Parameters:**

| नाम | प्रकार | विवरण |
| --- | --- | --- |
| xbottom | Number | नीचे के हिस्से की x-दिशा लंबाई |
| ybottom | Number | नीचे के हिस्से की y-दिशा लंबाई |
| height | Number | pyramid की ऊँचाई |
...
| नाम | विवरण |
| --- | --- |
| constructor_overload2(xbottom, ybottom, xtop, ytop, height) | निर्दिष्ट नीचे के क्षेत्र, ऊपर के क्षेत्र और ऊँचाई के साथ एक नया pyramid इंस्टेंस बनाएं। |

 **Parameters:**

| नाम | प्रकार | विवरण |
| --- | --- | --- |
| xbottom | Number | नीचे के क्षेत्र की x-दिशा लंबाई |
| ybottom | Number | नीचे के क्षेत्र की y-दिशा लंबाई |
| xtop | Number | ऊपर के क्षेत्र की x-दिशा लंबाई |
| ytop | Number | ऊपर के क्षेत्र की y-दिशा लंबाई |
| height | Number | pyramid की ऊँचाई |
...
| नाम | विवरण |
| --- | --- |
| constructor_overload3(name, xbottom, ybottom, xtop, ytop, height) | निर्दिष्ट नीचे के क्षेत्र, ऊपर के क्षेत्र और ऊँचाई के साथ एक नया pyramid इंस्टेंस बनाएं। |

 **Parameters:**

| नाम | प्रकार | विवरण |
| --- | --- | --- |
| name | स्ट्रिंग | पिरामिड का नाम |
| xbottom | Number | नीचे के क्षेत्र की x-दिशा लंबाई |
| ybottom | Number | नीचे के क्षेत्र की y-दिशा लंबाई |
| xtop | Number | ऊपर के क्षेत्र की x-दिशा लंबाई |
| ytop | Number | ऊपर के क्षेत्र की y-दिशा लंबाई |
...
| नाम | विवरण |
| --- | --- |
| getBottomArea() | नीचे के कैप का क्षेत्रफल |
...
| नाम | विवरण |
| --- | --- |
| setBottomArea(value) | नीचे के कैप का क्षेत्रफल |
...
| नाम | विवरण |
| --- | --- |
| getTopArea() | ऊपर के कैप का क्षेत्रफल |
...
| नाम | विवरण |
| --- | --- |
| setTopArea(value) | ऊपर के कैप का क्षेत्रफल |
...
| नाम | विवरण |
| --- | --- |
| getBottomOffset() | नीचे के शीर्ष बिंदुओं के लिए ऑफसेट |
...
| नाम | विवरण |
| --- | --- |
| setBottomOffset(value) | नीचे के शीर्ष बिंदुओं के लिए ऑफसेट |
...
| नाम | विवरण |
| --- | --- |
| setHeight(value) | पिरामिड की ऊँचाई |

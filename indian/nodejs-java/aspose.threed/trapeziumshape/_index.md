...
url: /hi/nodejs-java/aspose.threed/trapeziumshape/
---
## TrapeziumShape class

पैरामीटर द्वारा परिभाषित IFC संगत ट्रैपेज़ियम आकार।
...
| नाम | विवरण |
| --- | --- |
| constructor() | TrapeziumShape का कंस्ट्रक्टर |
...
| नाम | विवरण |
| --- | --- |
| getBottomXDim() | x-अक्ष के साथ मापी गई नीचे की लाइन की सीमा प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setBottomXDim(value) | x-अक्ष के साथ मापी गई नीचे की लाइन की सीमा प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getTopXDim() | x-अक्ष के साथ मापी गई शीर्ष रेखा की सीमा को प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setTopXDim(value) | x-अक्ष के साथ मापी गई शीर्ष रेखा की सीमा को प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getYDim() | y-अक्ष के साथ मापी गई शीर्ष और निचली रेखाओं के बीच की दूरी को प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setYDim(value) | y-अक्ष के साथ मापी गई शीर्ष और निचली रेखाओं के बीच की दूरी को प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getTopXOffset() | शीर्ष रेखा की शुरुआत से निचली रेखा तक का ऑफ़सेट प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setTopXOffset(value) | शीर्ष रेखा की शुरुआत से निचली रेखा तक का ऑफ़सेट प्राप्त करता है या सेट करता है। |

...
url: /hi/nodejs-java/aspose.threed/sceneobject/
---
## SceneObject class
...
| नाम | विवरण |
| --- | --- |
| constructor(name) | डिफ़ॉल्ट नाम के साथ एक SceneObject को प्रारंभ करें। |

 **Parameters:**

| नाम | प्रकार | विवरण |
| --- | --- | --- |
| name | स्ट्रिंग | इस इंस्टेंस का नाम |
...
| नाम | विवरण |
| --- | --- |
| constructor_overload() | एक SceneObject को प्रारंभ करें। |

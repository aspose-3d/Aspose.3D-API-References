...
url: /hi/nodejs-java/aspose.threed/dish/
---
## Dish class
...
| नाम | विवरण |
| --- | --- |
| constructor() | डिफ़ॉल्ट त्रिज्या(10) और डिफ़ॉल्ट ऊँचाई(5) के साथ नया डिश इंस्टेंस बनाएं |
...
| नाम | विवरण |
| --- | --- |
| constructor_overload(radius, height) | निर्दिष्ट त्रिज्या और ऊँचाई के साथ नया डिश इंस्टेंस बनाएं |

 **Parameters:**

| नाम | प्रकार | विवरण |
| --- | --- | --- |
| radius | Number | डिश की त्रिज्या |
| height | Number | डिश की ऊँचाई |
...
| नाम | विवरण |
| --- | --- |
| constructor_overload2(name, radius, height, widthSegments, heightSegments) | निर्दिष्ट त्रिज्या और ऊँचाई के साथ नया डिश इंस्टेंस बनाएं |

 **Parameters:**

| नाम | प्रकार | विवरण |
| --- | --- | --- |
| name | स्ट्रिंग | डिश का नाम |
| radius | Number | डिश की त्रिज्या |
| height | Number | डिश की ऊँचाई |
| widthSegments | Number | डिश का चौड़ाई सेगमेंट |
| heightSegments | Number | डिश का ऊँचाई खंड |
...
| नाम | विवरण |
| --- | --- |
| setRadius(value) | डिश की त्रिज्या |
...
| नाम | विवरण |
| --- | --- |
| getWidthSegments() | चौड़ाई सेगमेंट्स को प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setWidthSegments(value) | चौड़ाई सेगमेंट्स को प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getHeightSegments() | ऊँचाई खंडों को प्राप्त करता है या सेट करता है |
...
| नाम | विवरण |
| --- | --- |
| setHeightSegments(value) | ऊँचाई खंडों को प्राप्त करता है या सेट करता है |

...
url: /hi/nodejs-java/aspose.threed/tshape/
---
## TShape class

पैरामीटर द्वारा परिभाषित IFC संगत T-आकार।
...
| नाम | विवरण |
| --- | --- |
| constructor() | TShape का कंस्ट्रक्टर |
...
| नाम | विवरण |
| --- | --- |
| getDepth() | वेब की लंबाई प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setDepth(value) | वेब की लंबाई प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getFlangeWidth() | फ़्लैंज की लंबाई प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setFlangeWidth(value) | फ़्लैंज की लंबाई प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getWebThickness() | वेब की दीवार की मोटाई प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setWebThickness(value) | वेब की दीवार की मोटाई प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getFlangeThickness() | फ़्लैंज की दीवार की मोटाई प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setFlangeThickness(value) | फ़्लैंज की दीवार की मोटाई प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getFilletRadius() | वेब और फ्लैंज के बीच फ़िलेट की त्रिज्या को प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setFilletRadius(value) | वेब और फ्लैंज के बीच फ़िलेट की त्रिज्या को प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getFlangeEdgeRadius() | फ़्लैंज किनारे की त्रिज्या को प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setFlangeEdgeRadius(value) | फ़्लैंज किनारे की त्रिज्या को प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getWebEdgeRadius() | वेब किनारे की त्रिज्या को प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setWebEdgeRadius(value) | वेब किनारे की त्रिज्या को प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| getExtent() | x और y आयाम में विस्तार प्राप्त करता है। |

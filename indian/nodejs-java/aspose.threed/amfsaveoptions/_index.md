...
url: /hi/nodejs-java/aspose.threed/amfsaveoptions/
---
...
| नाम | विवरण |
| --- | --- |
| constructor() | AmfSaveOptions का कंस्ट्रक्टर |
...
| नाम | विवरण |
| --- | --- |
| getEnableCompression() | अंतिम फ़ाइल आकार को कम करने के लिए संपीड़न का उपयोग करना है या नहीं, डिफ़ॉल्ट मान true है। |
...
| नाम | विवरण |
| --- | --- |
| setEnableCompression(value) | अंतिम फ़ाइल आकार को कम करने के लिए संपीड़न का उपयोग करना है या नहीं, डिफ़ॉल्ट मान true है। |

...
url: /hi/nodejs-java/aspose.threed/trimmedcurve/
---
## TrimmedCurve class

एक बाउंडेड कर्व जो दोनों सिरों पर बेसिस कर्व को ट्रिम करता है।
...
| नाम | विवरण |
| --- | --- |
| constructor() | TrimmedCurve का कंस्ट्रक्टर |
...
| नाम | विवरण |
| --- | --- |
| getBasisCurve() | कटे जाने वाले बेसिस कर्व। |
...
| नाम | विवरण |
| --- | --- |
| setBasisCurve(value) | कटे जाने वाले बेसिस कर्व। |
...
| नाम | विवरण |
| --- | --- |
| getFirst() | कटने के लिए पहला अंत बिंदु, यह कार्टेशियन बिंदु या वास्तविक पैरामीटर हो सकता है। |
...
| नाम | विवरण |
| --- | --- |
| setFirst(value) | कटने के लिए पहला अंत बिंदु, यह कार्टेशियन बिंदु या वास्तविक पैरामीटर हो सकता है। |
...
| नाम | विवरण |
| --- | --- |
| getSecond() | दूसरा अंत बिंदु जिसे ट्रिम किया जाता है, एक कार्टेशियन बिंदु या वास्तविक पैरामीटर हो सकता है। |
...
| नाम | विवरण |
| --- | --- |
| setSecond(value) | दूसरा अंत बिंदु जिसे ट्रिम किया जाता है, एक कार्टेशियन बिंदु या वास्तविक पैरामीटर हो सकता है। |
...
| नाम | विवरण |
| --- | --- |
| getSameDirection() | ट्रिम किए गए परिणाम के आधार वक्र की वही दिशा उपयोग करता है या नहीं, इसे प्राप्त या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| setSameDirection(value) | ट्रिम किए गए परिणाम के आधार वक्र की वही दिशा उपयोग करता है या नहीं, इसे प्राप्त या सेट करता है। |

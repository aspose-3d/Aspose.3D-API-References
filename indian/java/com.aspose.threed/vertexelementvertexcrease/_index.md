...
description: निर्दिष्ट घटकों के लिए वर्टेक्स क्रीज़ को परिभाषित करता है
type: docs
weight: 224
url: /hi/java/com.aspose.threed/vertexelementvertexcrease/
---
...
निर्दिष्ट घटकों के लिए वर्टेक्स क्रीज़ को परिभाषित करता है
## Constructors

| Constructor | विवरण |
| --- | --- |
| [VertexElementVertexCrease()](#VertexElementVertexCrease--) | एक नया उदाहरण [VertexElementVertexCrease](../../com.aspose.threed/vertexelementvertexcrease) क्लास का प्रारंभ करता है। |
## Methods
...
एक नया उदाहरण [VertexElementVertexCrease](../../com.aspose.threed/vertexelementvertexcrease) क्लास का प्रारंभ करता है।

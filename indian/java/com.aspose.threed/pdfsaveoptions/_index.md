...
description: "PDF निर्यात में सहेजने के विकल्प।"
type: docs
weight: 125
url: /hi/java/com.aspose.threed/pdfsaveoptions/
---
...
PDF निर्यात में सहेजने के विकल्प।
## कंस्ट्रक्टर

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [PdfSaveOptions()](#PdfSaveOptions--) | [PdfSaveOptions](../../com.aspose.threed/pdfsaveoptions) का कंस्ट्रक्टर |
## विधियाँ

| विधि | विवरण |
| --- | --- |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getAuxiliaryColor()](#getAuxiliaryColor--) | रेंडरिंग के दौरान 3D सामग्री में उपयोग होने वाला सहायक रंग प्राप्त करता है। |
| [getBackgroundColor()](#getBackgroundColor--) | PDF फ़ाइल में 3D दृश्य की पृष्ठभूमि रंग। |
| [getClass()](#getClass--) |  |
| [getEmbedTextures()](#getEmbedTextures--) | बाहरी टेक्सचर को PDF फ़ाइल में एम्बेड करें, डिफ़ॉल्ट मान false है। |
...
| [getFaceColor()](#getFaceColor--) | रेंडरिंग के दौरान 3D सामग्री में उपयोग होने वाला फेस रंग प्राप्त करता है। |
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | एक्सपोर्टिंग के दौरान सीन के निर्देशांक प्रणाली को उलटने के लिए प्राप्त करता है। |
| [getLightingScheme()](#getLightingScheme--) | LightingScheme 3D कला पर लागू करने के लिए प्रकाश को निर्दिष्ट करता है। |
...
| [getRenderMode()](#getRenderMode--) | रेंडर मोड उस शैली को निर्दिष्ट करता है जिसमें 3D कला रेंडर की जाती है। |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAuxiliaryColor(Vector3 value)](#setAuxiliaryColor-com.aspose.threed.Vector3-) | रेंडरिंग के दौरान 3D सामग्री में उपयोग होने वाला सहायक रंग सेट करता है। |
| [setBackgroundColor(Vector3 value)](#setBackgroundColor-com.aspose.threed.Vector3-) | PDF फ़ाइल में 3D दृश्य की पृष्ठभूमि रंग। |
| [setEmbedTextures(boolean value)](#setEmbedTextures-boolean-) | बाहरी टेक्सचर को PDF फ़ाइल में एम्बेड करें, डिफ़ॉल्ट मान false है। |
...
| [setFaceColor(Vector3 value)](#setFaceColor-com.aspose.threed.Vector3-) | रेंडरिंग के दौरान 3D सामग्री में उपयोग होने वाला फेस रंग सेट करता है। |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | एक्सपोर्टिंग के दौरान सीन के निर्देशांक प्रणाली को उलटने के लिए सेट करता है। |
| [setLightingScheme(PdfLightingScheme value)](#setLightingScheme-com.aspose.threed.PdfLightingScheme-) | LightingScheme 3D कला पर लागू करने के लिए प्रकाश को निर्दिष्ट करता है। |
...
| [setRenderMode(PdfRenderMode value)](#setRenderMode-com.aspose.threed.PdfRenderMode-) | रेंडर मोड उस शैली को निर्दिष्ट करता है जिसमें 3D कला रेंडर की जाती है। |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[PdfSaveOptions](../../com.aspose.threed/pdfsaveoptions) का कंस्ट्रक्टर
...
रेंडरिंग के दौरान 3D सामग्री में उपयोग होने वाला सहायक रंग प्राप्त करता है। इस रंग की व्याख्या [getRenderMode](../../com.aspose.threed/pdfsaveoptions\#getRenderMode) पर निर्भर करती है।
...
PDF फ़ाइल में 3D दृश्य की पृष्ठभूमि रंग।
...
बाहरी टेक्सचर को PDF फ़ाइल में एम्बेड करें, डिफ़ॉल्ट मान false है।

**Returns:**
boolean - बाहरी टेक्सचर को PDF फ़ाइल में एम्बेड करें, डिफ़ॉल्ट मान false है।
...
रेंडरिंग के दौरान 3D सामग्री में उपयोग होने वाला फेस रंग प्राप्त करता है। यह केवल तब प्रासंगिक है जब [getRenderMode](../../com.aspose.threed/pdfsaveoptions\#getRenderMode) का मान Illustration हो।
...
एक्सपोर्टिंग के दौरान सीन के निर्देशांक प्रणाली को उलटने के लिए प्राप्त करता है।

**Returns:**
boolean - एक्सपोर्टिंग के दौरान सीन के निर्देशांक प्रणाली को उलटने के लिए।
...
LightingScheme 3D कला पर लागू करने के लिए प्रकाश को निर्दिष्ट करता है।
...
रेंडरिंग के दौरान 3D सामग्री में उपयोग होने वाला सहायक रंग सेट करता है। इस रंग की व्याख्या [getRenderMode](../../com.aspose.threed/pdfsaveoptions\#getRenderMode) पर निर्भर करती है।
...
रेंडरिंग के दौरान 3D सामग्री में उपयोग होने वाला फेस रंग सेट करता है। यह केवल तब प्रासंगिक है जब [getRenderMode](../../com.aspose.threed/pdfsaveoptions\#getRenderMode) का मान Illustration हो।
...
एक्सपोर्टिंग के दौरान सीन के निर्देशांक प्रणाली को उलटने के लिए सेट करता है।
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| value | [PdfLightingScheme](../../com.aspose.threed/pdflightingscheme) | नया मान |
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| value | [PdfRenderMode](../../com.aspose.threed/pdfrendermode) | नया मान |

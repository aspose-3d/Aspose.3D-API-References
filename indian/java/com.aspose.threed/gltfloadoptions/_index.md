...
description: glTF फ़ॉर्मेट के लिए लोड विकल्प
type: docs
weight: 73
url: /hi/java/com.aspose.threed/gltfloadoptions/
---
...
glTF फ़ॉर्मेट के लिए लोड विकल्प
## Constructors

| Constructor | विवरण |
| --- | --- |
| [GltfLoadOptions()](#GltfLoadOptions--) | [GltfLoadOptions](../../com.aspose.threed/gltfloadoptions) का कन्स्ट्रक्टर। |
## Methods
...
| [getFlipTexCoordV()](#getFlipTexCoordV--) | मेश की टेक्सचर कोऑर्डिनेट में v(t) कोऑर्डिनेट को उलटें, डिफ़ॉल्ट मान true है। |
...
| [setFlipTexCoordV(boolean value)](#setFlipTexCoordV-boolean-) | मेश की टेक्सचर कोऑर्डिनेट में v(t) कोऑर्डिनेट को उलटें, डिफ़ॉल्ट मान true है। |
...
[GltfLoadOptions](../../com.aspose.threed/gltfloadoptions) का कन्स्ट्रक्टर।
...
मेश की टेक्सचर कोऑर्डिनेट में v(t) कोऑर्डिनेट को उलटें, डिफ़ॉल्ट मान true है।

**Returns:**
boolean - मेश की टेक्सचर कोऑर्डिनेट में v(t) कोऑर्डिनेट को उलटें, डिफ़ॉल्ट मान true है।

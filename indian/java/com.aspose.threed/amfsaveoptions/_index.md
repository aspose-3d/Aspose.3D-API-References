...
description: AMF के लिए सहेजने विकल्प
type: docs
weight: 12
url: /hi/java/com.aspose.threed/amfsaveoptions/
---
...
AMF के लिए सहेजने विकल्प
## Constructors

| Constructor | विवरण |
| --- | --- |
| [AmfSaveOptions()](#AmfSaveOptions--) | [AmfSaveOptions](../../com.aspose.threed/amfsaveoptions) का कंस्ट्रक्टर |
## Methods
...
| [getClass()](#getClass--) |  |
| [getEnableCompression()](#getEnableCompression--) | अंतिम फ़ाइल आकार को कम करने के लिए संपीड़न का उपयोग करना है या नहीं, डिफ़ॉल्ट मान true है |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEnableCompression(boolean value)](#setEnableCompression-boolean-) | अंतिम फ़ाइल आकार को कम करने के लिए संपीड़न का उपयोग करना है या नहीं, डिफ़ॉल्ट मान true है |
...
[AmfSaveOptions](../../com.aspose.threed/amfsaveoptions) का कंस्ट्रक्टर
...
**Returns:**
boolean - अंतिम फ़ाइल आकार को कम करने के लिए संपीड़न का उपयोग करना है या नहीं, डिफ़ॉल्ट मान true है

...
description: STL के लिए लोड विकल्प।
type: docs
weight: 176
url: /hi/java/com.aspose.threed/stlloadoptions/
---
...
STL के लिए लोड विकल्प।
## Constructors

| Constructor | विवरण |
| --- | --- |
| [StlLoadOptions()](#StlLoadOptions--) | एक नए [StlLoadOptions](../../com.aspose.threed/stlloadoptions) इंस्टेंस को प्रारंभ करता है। |
| [StlLoadOptions(FileContentType contentType)](#StlLoadOptions-com.aspose.threed.FileContentType-) | एक नए [StlLoadOptions](../../com.aspose.threed/stlloadoptions) इंस्टेंस को प्रारंभ करता है। |
## Methods
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | इम्पोर्ट करते समय कंट्रोल पॉइंट्स/नॉर्मल के कोऑर्डिनेट सिस्टम को उलटने की स्थिति प्राप्त करता है। |
...
| [getRecalculateNormal()](#getRecalculateNormal--) | STL फ़ाइल में संग्रहीत नॉर्मल डेटा को अनदेखा करें और वर्टेक्स स्थिति के आधार पर नॉर्मल डेटा को पुनः गणना करें। |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | इम्पोर्ट करते समय कंट्रोल पॉइंट्स/नॉर्मल के कोऑर्डिनेट सिस्टम को उलटने की स्थिति सेट करता है। |
...
| [setRecalculateNormal(boolean value)](#setRecalculateNormal-boolean-) | STL फ़ाइल में संग्रहीत नॉर्मल डेटा को अनदेखा करें और वर्टेक्स स्थिति के आधार पर नॉर्मल डेटा को पुनः गणना करें। |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
एक नए [StlLoadOptions](../../com.aspose.threed/stlloadoptions) इंस्टेंस को प्रारंभ करता है।
...
इम्पोर्ट करते समय कंट्रोल पॉइंट्स/नॉर्मल के कोऑर्डिनेट सिस्टम को उलटने की स्थिति प्राप्त करता है।

**Returns:**
boolean - इम्पोर्ट करते समय कंट्रोल पॉइंट्स/नॉर्मल के कोऑर्डिनेट सिस्टम को उलटना है या नहीं।
...
STL फ़ाइल में संग्रहीत नॉर्मल डेटा को अनदेखा करें और वर्टेक्स स्थिति के आधार पर नॉर्मल डेटा को पुनः गणना करें। डिफ़ॉल्ट मान false है।

**Returns:**
boolean - STL फ़ाइल में संग्रहीत नॉर्मल डेटा को अनदेखा करें और वर्टेक्स स्थिति के आधार पर नॉर्मल डेटा को पुनः गणना करें। डिफ़ॉल्ट मान false है।
### hashCode() {#hashCode--}
```
...
इम्पोर्ट करते समय कंट्रोल पॉइंट्स/नॉर्मल के कोऑर्डिनेट सिस्टम को उलटने की स्थिति सेट करता है।

...
description: आम तौर पर उपयोग किए जाने वाले रेंडरिंग API
type: docs
weight: 269
url: /hi/java/com.aspose.threed/renderingapi/
---
...
आम तौर पर उपयोग किए जाने वाले रेंडरिंग API
## फ़ील्ड्स

| फ़ील्ड | विवरण |
| --- | --- |
| [ARNOLD](#ARNOLD) | Arnold रेंडरर |
| [CUSTOM](#CUSTOM) | कस्टम रेंडरिंग API |
| [DIRECTX](#DIRECTX) | DirectX |
| [MANTLE](#MANTLE) | AMD Mantle |
| [MENTAL_RAY](#MENTAL-RAY) | MentalRay |
| [METAL](#METAL) | Apple द्वारा विकसित Metal |
| [NONE](#NONE) | कोई रेंडरिंग API नहीं |
| [OPENGL](#OPENGL) | OpenGL |
| [OPENGLES](#OPENGLES) | OpenGL ES |
| [PREVIEW](#PREVIEW) | PreviewColorAPI, FBX के साथ संगत |
| [RENDER_MAN](#RENDER-MAN) | RenderMan |
| [RENDER_WARE](#RENDER-WARE) | RenderWare |
| [SHADERFX](#SHADERFX) | ShaderFX रेंडरर |
| [STAGE3D](#STAGE3D) | Adobe Flash में उपयोग किया गया Stage3D |
...
PreviewColorAPI, FBX के साथ संगत
...
Adobe Flash में उपयोग किया गया Stage3D

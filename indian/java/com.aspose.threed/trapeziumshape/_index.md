...
description: पैरामीटरों द्वारा परिभाषित IFC संगत ट्रैपेज़ियम आकार।
type: docs
weight: 193
url: /hi/java/com.aspose.threed/trapeziumshape/
---
...
पैरामीटरों द्वारा परिभाषित IFC संगत ट्रैपेज़ियम आकार।
## Constructors

| Constructor | विवरण |
| --- | --- |
| [TrapeziumShape()](#TrapeziumShape--) | [TrapeziumShape](../../com.aspose.threed/trapeziumshape) का कंस्ट्रक्टर |
## Methods
...
| [getBottomXDim()](#getBottomXDim--) | x-अक्ष के साथ मापी गई नीचे की रेखा की सीमा प्राप्त करता है। |
...
| [getTopXDim()](#getTopXDim--) | x-अक्ष के साथ मापी गई ऊपर की रेखा की सीमा प्राप्त करता है। |
| [getTopXOffset()](#getTopXOffset--) | ऊपर की रेखा की शुरुआत से नीचे की रेखा तक का ऑफसेट प्राप्त करता है। |
| [getYDim()](#getYDim--) | y-अक्ष के साथ मापी गई ऊपर और नीचे की रेखाओं के बीच की दूरी प्राप्त करता है। |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setBottomXDim(double value)](#setBottomXDim-double-) | x-अक्ष के साथ मापी गई नीचे की रेखा की सीमा सेट करता है। |
...
| [setTopXDim(double value)](#setTopXDim-double-) | x-अक्ष के साथ मापी गई ऊपर की रेखा की सीमा सेट करता है। |
| [setTopXOffset(double value)](#setTopXOffset-double-) | ऊपर की रेखा की शुरुआत से नीचे की रेखा तक का ऑफसेट सेट करता है। |
| [setYDim(double value)](#setYDim-double-) | y-अक्ष के साथ मापी गई ऊपर और नीचे की रेखाओं के बीच की दूरी सेट करता है। |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[TrapeziumShape](../../com.aspose.threed/trapeziumshape) का कंस्ट्रक्टर
...
x-अक्ष के साथ मापी गई नीचे की रेखा की सीमा प्राप्त करता है।

**Returns:**
double - x-अक्ष के साथ मापी गई नीचे की रेखा की सीमा।
...
x-अक्ष के साथ मापी गई ऊपर की रेखा की सीमा प्राप्त करता है।

**Returns:**
double - x-अक्ष के साथ मापी गई ऊपर की रेखा की सीमा।
...
ऊपर की रेखा की शुरुआत से नीचे की रेखा तक का ऑफसेट प्राप्त करता है।

**Returns:**
double - ऊपर की रेखा की शुरुआत से नीचे की रेखा तक का ऑफसेट।
### getYDim() {#getYDim--}
```
...
y-अक्ष के साथ मापी गई ऊपर और नीचे की रेखाओं के बीच की दूरी प्राप्त करता है।

**Returns:**
double - y-अक्ष के साथ मापी गई ऊपर और नीचे की रेखाओं के बीच की दूरी।
### hashCode() {#hashCode--}
```
...
x-अक्ष के साथ मापी गई नीचे की रेखा की सीमा सेट करता है।
...
x-अक्ष के साथ मापी गई ऊपर की रेखा की सीमा सेट करता है।
...
ऊपर की रेखा की शुरुआत से नीचे की रेखा तक का ऑफसेट सेट करता है।
...
y-अक्ष के साथ मापी गई ऊपर और नीचे की रेखाओं के बीच की दूरी सेट करता है।

...
description: "Microsoft 3MF के लिए फ़ाइल फ़ॉर्मेट इंस्टेंस, जिसमें 3MF संबंधित उपयोगिताएँ शामिल हैं।"
type: docs
weight: 104
url: /hi/java/com.aspose.threed/microsoft3mfformat/
---
...
Microsoft 3MF के लिए फ़ाइल फ़ॉर्मेट इंस्टेंस, जिसमें 3MF संबंधित उपयोगिताएँ शामिल हैं।
## फ़ील्ड्स
...
| [getObjectType(Node node)](#getObjectType-com.aspose.threed.Node-) | निर्दिष्ट नोड के लिए मॉडल प्रकार प्राप्त करता है। |
| [getTransformForBuild(Node node)](#getTransformForBuild-com.aspose.threed.Node-) | बिल्ड में उपयोग किए गए नोड के लिए ट्रांसफ़ॉर्म मैट्रिक्स प्राप्त करें। |
| [getVersion()](#getVersion--) | फ़ाइल फ़ॉर्मेट संस्करण प्राप्त करता है |
| [hashCode()](#hashCode--) |  |
| [isBuildable(Node node)](#isBuildable-com.aspose.threed.Node-) | जाँचें कि क्या यह नोड बिल्ड के रूप में चिह्नित है। |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBuildable(Node node, boolean value, Matrix4 transform)](#setBuildable-com.aspose.threed.Node-boolean-com.aspose.threed.Matrix4-) | बिल्ड के लिए एक नोड को चिह्नित करें। |
| [setObjectType(Node node, String modelType)](#setObjectType-com.aspose.threed.Node-java.lang.String-) | निर्दिष्ट नोड के लिए मॉडल प्रकार सेट करें। |
...
निर्दिष्ट नोड के लिए मॉडल प्रकार प्राप्त करता है।
...
**Returns:**
java.lang.String - दिए गए नोड के लिए 3MF का ऑब्जेक्ट प्रकार
...
बिल्ड में उपयोग किए गए नोड के लिए ट्रांसफ़ॉर्म मैट्रिक्स प्राप्त करें।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | कौन सा नोड 3MF बिल्ड के लिए ट्रांसफ़ॉर्म मैट्रिक्स प्राप्त करेगा। |
...
जाँचें कि क्या यह नोड बिल्ड के रूप में चिह्नित है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | कौन सा नोड जाँचना है |

**Returns:**
boolean - यदि यह बिल्ड के रूप में चिह्नित है तो True
### notify() {#notify--}
```
...
बिल्ड के लिए एक नोड को चिह्नित करें।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | कौन सा नोड बिल्ड के रूप में चिह्नित करना है। |
| मान | boolean |  |
| transform | [Matrix4](../../com.aspose.threed/matrix4) | बिल्ड में नोड का ट्रांसफ़ॉर्म। |
...
निर्दिष्ट नोड के लिए मॉडल प्रकार सेट करें। संभावित मान: model surface solidsupport support other

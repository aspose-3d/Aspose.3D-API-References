...
description: निर्दिष्ट घटकों के लिए बिनॉर्मल वेक्टर को परिभाषित करता है।
type: docs
weight: 208
url: /hi/java/com.aspose.threed/vertexelementbinormal/
---
...
निर्दिष्ट घटकों के लिए बिनॉर्मल वेक्टर को परिभाषित करता है।
## Constructors

| Constructor | विवरण |
| --- | --- |
| [VertexElementBinormal()](#VertexElementBinormal--) | एक नया उदाहरण इनिशियलाइज़ करता है [VertexElementBinormal](../../com.aspose.threed/vertexelementbinormal) क्लास का। |
## Methods
...
एक नया उदाहरण इनिशियलाइज़ करता है [VertexElementBinormal](../../com.aspose.threed/vertexelementbinormal) क्लास का।

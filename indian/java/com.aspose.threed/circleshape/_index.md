...
description: IFC संगत सर्कल प्रोफ़ाइल जिसे मेष बनाने के लिए उपयोग किया जा सकता है।
type: docs
weight: 32
url: /hi/java/com.aspose.threed/circleshape/
---
...
IFC संगत सर्कल प्रोफ़ाइल, जिसे [LinearExtrusion](../../com.aspose.threed/linearextrusion) के माध्यम से मेष बनाने के लिए उपयोग किया जा सकता है।
## Constructors

| Constructor | विवरण |
| --- | --- |
| [CircleShape()](#CircleShape--) | डिफ़ॉल्ट त्रिज्या (5) के साथ एक [CircleShape](../../com.aspose.threed/circleshape) प्रोफ़ाइल बनाएं। |
| [CircleShape(double radius)](#CircleShape-double-) | निर्दिष्ट त्रिज्या के साथ एक [CircleShape](../../com.aspose.threed/circleshape) प्रोफ़ाइल बनाएं। |
## Methods
...
| [getRadius()](#getRadius--) | सर्कल की त्रिज्या प्राप्त करता है। |
...
| [setRadius(double value)](#setRadius-double-) | सर्कल की त्रिज्या सेट करता है। |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
डिफ़ॉल्ट त्रिज्या (5) के साथ एक [CircleShape](../../com.aspose.threed/circleshape) प्रोफ़ाइल बनाएं।
...
निर्दिष्ट त्रिज्या के साथ एक [CircleShape](../../com.aspose.threed/circleshape) प्रोफ़ाइल बनाएं।

**Parameters:**
| Parameter | Type | विवरण |
| --- | --- | --- |
| त्रिज्या | double | सर्कल की त्रिज्या |
...
सर्कल की त्रिज्या प्राप्त करता है।

**Returns:**
double - वृत्त की त्रिज्या।
### getScene() {#getScene--}
```

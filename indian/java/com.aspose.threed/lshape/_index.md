...
description: पैरामीटरों द्वारा परिभाषित IFC संगत L-आकार प्रोफ़ाइल।
type: docs
weight: 91
url: /hi/java/com.aspose.threed/lshape/
---
...
पैरामीटरों द्वारा परिभाषित IFC संगत L-आकार प्रोफ़ाइल।
## Constructors

| Constructor | विवरण |
| --- | --- |
| [LShape()](#LShape--) | [LShape](../../com.aspose.threed/lshape) का कंस्ट्रक्टर |
## Methods
...
| [getEdgeRadius()](#getEdgeRadius--) | एज की त्रिज्या प्राप्त करता है। |
...
| [getFilletRadius()](#getFilletRadius--) | फ़िलेट की त्रिज्या प्राप्त करता है। |
...
| [getThickness()](#getThickness--) | स्थिर दीवार की मोटाई प्राप्त करता है। |
...
| [setEdgeRadius(double value)](#setEdgeRadius-double-) | एज की त्रिज्या सेट करता है। |
| [setExcluded(boolean value)](#setExcluded-boolean-) | निर्यात के दौरान इस एंटिटी को बाहर रखने के बारे में सेट करता है। |
| [setFilletRadius(double value)](#setFilletRadius-double-) | फ़िलेट की त्रिज्या सेट करता है। |
...
| [setThickness(double value)](#setThickness-double-) | स्थिर दीवार की मोटाई सेट करता है। |
...
[LShape](../../com.aspose.threed/lshape) का कंस्ट्रक्टर
...
एज की त्रिज्या प्राप्त करता है।

**Returns:**
double - एज की त्रिज्या।
...
फ़िलेट की त्रिज्या प्राप्त करता है।

**Returns:**
double - फ़िलेट की त्रिज्या।
### getName() {#getName--}
```
...
स्थिर दीवार की मोटाई प्राप्त करता है।

**Returns:**
double - स्थिर दीवार की मोटाई।
### getWidth() {#getWidth--}
```
...
फ़िलेट की त्रिज्या सेट करता है।
...
स्थिर दीवार की मोटाई सेट करता है।

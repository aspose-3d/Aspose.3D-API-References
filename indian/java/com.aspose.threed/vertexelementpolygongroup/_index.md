...
description: निर्दिष्ट घटकों के लिए बहुभुज समूह को परिभाषित करता है ताकि संबंधित बहुभुजों को एक साथ समूहित किया जा सके।
type: docs
weight: 215
url: /hi/java/com.aspose.threed/vertexelementpolygongroup/
---
...
निर्दिष्ट घटकों के लिए बहुभुज समूह को परिभाषित करता है ताकि संबंधित बहुभुजों को एक साथ समूहित किया जा सके।
## Constructors

| Constructor | विवरण |
| --- | --- |
| [VertexElementPolygonGroup()](#VertexElementPolygonGroup--) | नया उदाहरण प्रारंभ करता है [VertexElementPolygonGroup](../../com.aspose.threed/vertexelementpolygongroup) क्लास का। |
## Methods
...
नया उदाहरण प्रारंभ करता है [VertexElementPolygonGroup](../../com.aspose.threed/vertexelementpolygongroup) क्लास का।

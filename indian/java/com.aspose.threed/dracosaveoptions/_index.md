...
description: Google Draco फ़ाइलों के लिए सहेजने विकल्प
type: docs
weight: 47
url: /hi/java/com.aspose.threed/dracosaveoptions/
---
...
Google Draco फ़ाइलों के लिए सहेजने विकल्प
## Constructors

| Constructor | विवरण |
| --- | --- |
| [DracoSaveOptions()](#DracoSaveOptions--) | ड्रैको फ़ाइलें सहेजने के लिए एक डिफ़ॉल्ट कॉन्फ़िगरेशन बनाएं। |
## Methods
...
| [getClass()](#getClass--) |  |
| [getColorBits()](#getColorBits--) | वर्टेक्स रंग के लिए क्वांटाइज़ेशन बिट्स, डिफ़ॉल्ट मान 10 है। |
| [getCompressionLevel()](#getCompressionLevel--) | कम्प्रेशन स्तर, डिफ़ॉल्ट मान [DracoCompressionLevel.STANDARD](../../com.aspose.threed/dracocompressionlevel\#STANDARD) है। |
...
| [getNormalBits()](#getNormalBits--) | नॉर्मल वेक्टर के लिए क्वांटाइज़ेशन बिट्स, डिफ़ॉल्ट मान 10 है। |
| [getPointCloud()](#getPointCloud--) | सीन को पॉइंट क्लाउड के रूप में निर्यात करें, डिफ़ॉल्ट मान false है। |
| [getPositionBits()](#getPositionBits--) | पोजीशन के लिए क्वांटाइज़ेशन बिट्स, डिफ़ॉल्ट मान 14 है। |
| [getTextureCoordinateBits()](#getTextureCoordinateBits--) | टेक्सचर कोऑर्डिनेट के लिए क्वांटाइज़ेशन बिट्स, डिफ़ॉल्ट मान 12 है। |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setColorBits(int value)](#setColorBits-int-) | वर्टेक्स रंग के लिए क्वांटाइज़ेशन बिट्स, डिफ़ॉल्ट मान 10 है। |
| [setCompressionLevel(DracoCompressionLevel value)](#setCompressionLevel-com.aspose.threed.DracoCompressionLevel-) | कम्प्रेशन स्तर, डिफ़ॉल्ट मान [DracoCompressionLevel.STANDARD](../../com.aspose.threed/dracocompressionlevel\#STANDARD) है। |
...
| [setNormalBits(int value)](#setNormalBits-int-) | नॉर्मल वेक्टर के लिए क्वांटाइज़ेशन बिट्स, डिफ़ॉल्ट मान 10 है। |
| [setPointCloud(boolean value)](#setPointCloud-boolean-) | सीन को पॉइंट क्लाउड के रूप में निर्यात करें, डिफ़ॉल्ट मान false है। |
| [setPositionBits(int value)](#setPositionBits-int-) | पोजीशन के लिए क्वांटाइज़ेशन बिट्स, डिफ़ॉल्ट मान 14 है। |
| [setTextureCoordinateBits(int value)](#setTextureCoordinateBits-int-) | टेक्सचर कोऑर्डिनेट के लिए क्वांटाइज़ेशन बिट्स, डिफ़ॉल्ट मान 12 है। |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
ड्रैको फ़ाइलें सहेजने के लिए एक डिफ़ॉल्ट कॉन्फ़िगरेशन बनाएं।
...
वर्टेक्स रंग के लिए क्वांटाइज़ेशन बिट्स, डिफ़ॉल्ट मान 10 है।

**Returns:**
इंट - वर्टेक्स रंग के लिए क्वांटाइज़ेशन बिट्स, डिफ़ॉल्ट मान 10 है।
...
कम्प्रेशन स्तर, डिफ़ॉल्ट मान [DracoCompressionLevel.STANDARD](../../com.aspose.threed/dracocompressionlevel\#STANDARD) है।
...
नॉर्मल वेक्टर के लिए क्वांटाइज़ेशन बिट्स, डिफ़ॉल्ट मान 10 है।

**Returns:**
इंट - नॉर्मल वेक्टर के लिए क्वांटाइज़ेशन बिट्स, डिफ़ॉल्ट मान 10 है।
...
**Returns:**
बूलियन - सीन को पॉइंट क्लाउड के रूप में निर्यात करें, डिफ़ॉल्ट मान false है।
...
पोजीशन के लिए क्वांटाइज़ेशन बिट्स, डिफ़ॉल्ट मान 14 है।

**Returns:**
इंट - पोजीशन के लिए क्वांटाइज़ेशन बिट्स, डिफ़ॉल्ट मान 14 है।
...
टेक्सचर कोऑर्डिनेट के लिए क्वांटाइज़ेशन बिट्स, डिफ़ॉल्ट मान 12 है।

**Returns:**
इंट - टेक्सचर कोऑर्डिनेट के लिए क्वांटाइज़ेशन बिट्स, डिफ़ॉल्ट मान 12 है।
### hashCode() {#hashCode--}
```
...
| Parameter | Type | विवरण |
| --- | --- | --- |
| value | [DracoCompressionLevel](../../com.aspose.threed/dracocompressionlevel) | नया मान |

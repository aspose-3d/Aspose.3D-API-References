...
description: STL के लिए सहेजने के विकल्प।
type: docs
weight: 177
url: /hi/java/com.aspose.threed/stlsaveoptions/
---
...
STL के लिए सहेजने के विकल्प।
## Constructors

| Constructor | विवरण |
| --- | --- |
| [StlSaveOptions()](#StlSaveOptions--) | नए [StlSaveOptions](../../com.aspose.threed/stlsaveoptions) इंस्टेंस को प्रारंभ करता है। |
| [StlSaveOptions(FileContentType contentType)](#StlSaveOptions-com.aspose.threed.FileContentType-) | नए [StlSaveOptions](../../com.aspose.threed/stlsaveoptions) इंस्टेंस को प्रारंभ करता है। |
## Methods
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | निर्यात के दौरान नियंत्रण बिंदुओं/नॉर्मल के कोऑर्डिनेट सिस्टम को उलटने की स्थिति प्राप्त करता है। |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | निर्यात के दौरान नियंत्रण बिंदुओं/नॉर्मल के कोऑर्डिनेट सिस्टम को उलटने की स्थिति सेट करता है। |
...
नए [StlSaveOptions](../../com.aspose.threed/stlsaveoptions) इंस्टेंस को प्रारंभ करता है।
...
निर्यात के दौरान नियंत्रण बिंदुओं/नॉर्मल के कोऑर्डिनेट सिस्टम को उलटने की स्थिति प्राप्त करता है।

**Returns:**
बूलियन - निर्यात के दौरान नियंत्रण बिंदुओं/सामान्य के निर्देशांक प्रणाली को उलटना है या नहीं।
...
निर्यात के दौरान नियंत्रण बिंदुओं/नॉर्मल के कोऑर्डिनेट सिस्टम को उलटने की स्थिति सेट करता है।

...
description: पैरामीटरों द्वारा परिभाषित IFC संगत T-आकार।
type: docs
weight: 182
url: /hi/java/com.aspose.threed/tshape/
---
...
पैरामीटरों द्वारा परिभाषित IFC संगत T-आकार।
## Constructors

| Constructor | विवरण |
| --- | --- |
| [TShape()](#TShape--) | [TShape](../../com.aspose.threed/tshape) का कंस्ट्रक्टर |
## Methods
...
| [getFilletRadius()](#getFilletRadius--) | वेब और फ्लैंज के बीच फ़िलेट की त्रिज्या प्राप्त करता है। |
| [getFlangeEdgeRadius()](#getFlangeEdgeRadius--) | फ्लैंज किनारे की त्रिज्या प्राप्त करता है। |
| [getFlangeThickness()](#getFlangeThickness--) | फ्लैंज की दीवार की मोटाई प्राप्त करता है। |
| [getFlangeWidth()](#getFlangeWidth--) | फ्लैंज की लंबाई प्राप्त करता है। |
...
| [getWebEdgeRadius()](#getWebEdgeRadius--) | वेब किनारे की त्रिज्या प्राप्त करता है। |
| [getWebThickness()](#getWebThickness--) | वेब की दीवार की मोटाई प्राप्त करता है। |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFilletRadius(double value)](#setFilletRadius-double-) | वेब और फ्लैंज के बीच फ़िलेट की त्रिज्या सेट करता है। |
| [setFlangeEdgeRadius(double value)](#setFlangeEdgeRadius-double-) | फ्लैंज किनारे की त्रिज्या सेट करता है। |
| [setFlangeThickness(double value)](#setFlangeThickness-double-) | फ्लैंज की दीवार की मोटाई सेट करता है। |
| [setFlangeWidth(double value)](#setFlangeWidth-double-) | फ्लैंज की लंबाई सेट करता है। |
...
| [setWebEdgeRadius(double value)](#setWebEdgeRadius-double-) | वेब किनारे की त्रिज्या सेट करता है। |
| [setWebThickness(double value)](#setWebThickness-double-) | वेब की दीवार की मोटाई सेट करता है। |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[TShape](../../com.aspose.threed/tshape) का कंस्ट्रक्टर
...
वेब और फ्लैंज के बीच फ़िलेट की त्रिज्या प्राप्त करता है।

**Returns:**
double - वेब और फ्लैंज के बीच फ़िलेट की त्रिज्या।
...
फ्लैंज किनारे की त्रिज्या प्राप्त करता है।

**Returns:**
double - फ्लैंज किनारे की त्रिज्या।
...
फ्लैंज की दीवार की मोटाई प्राप्त करता है।

**Returns:**
double - फ्लैंज की दीवार की मोटाई।
...
फ्लैंज की लंबाई प्राप्त करता है।

**Returns:**
double - फ्लैंज की लंबाई।
### getName() {#getName--}
```
...
वेब किनारे की त्रिज्या प्राप्त करता है।

**Returns:**
double - वेब किनारे की त्रिज्या।
...
वेब की दीवार की मोटाई प्राप्त करता है।

**Returns:**
double - वेब की दीवार की मोटाई।
### hashCode() {#hashCode--}
```
...
वेब और फ्लैंज के बीच फ़िलेट की त्रिज्या सेट करता है।
...
फ्लैंज किनारे की त्रिज्या सेट करता है।
...
फ्लैंज की दीवार की मोटाई सेट करता है।
...
वेब किनारे की त्रिज्या सेट करता है।
...
वेब की दीवार की मोटाई सेट करता है।

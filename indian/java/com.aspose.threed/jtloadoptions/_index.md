...
description: Siemens JT के लिए लोड विकल्प
type: docs
weight: 88
url: /hi/java/com.aspose.threed/jtloadoptions/
---
...
| [getLoadPMI()](#getLoadPMI--) | यदि संभव हो तो JT फ़ाइल से PMI जानकारी लोड करें, डेटा को [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo) की प्रॉपर्टी "PMI" के रूप में सहेजा जाएगा। |
| [getLoadProperties()](#getLoadProperties--) | JT की प्रॉपर्टी टेबल से प्रॉपर्टी लोड करें, Aspose.3D प्रॉपर्टी के रूप में। |
...
| [setLoadPMI(boolean value)](#setLoadPMI-boolean-) | यदि संभव हो तो JT फ़ाइल से PMI जानकारी लोड करें, डेटा को [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo) की प्रॉपर्टी "PMI" के रूप में सहेजा जाएगा। |
| [setLoadProperties(boolean value)](#setLoadProperties-boolean-) | JT की प्रॉपर्टी टेबल से प्रॉपर्टी लोड करें, Aspose.3D प्रॉपर्टी के रूप में। |
...
यदि संभव हो तो JT फ़ाइल से PMI जानकारी लोड करें, डेटा को [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo) की प्रॉपर्टी "PMI" के रूप में सहेजा जाएगा। डिफ़ॉल्ट मान false है।

**Returns:**
boolean - यदि संभव हो तो JT फ़ाइल से PMI जानकारी लोड करें, डेटा को [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo) की प्रॉपर्टी "PMI" के रूप में सहेजा जाएगा। डिफ़ॉल्ट मान false है।
...
JT की प्रॉपर्टी टेबल से प्रॉपर्टी लोड करें, Aspose.3D प्रॉपर्टी के रूप में। डिफ़ॉल्ट मान false है।

**Returns:**
boolean - JT की प्रॉपर्टी टेबल से प्रॉपर्टी लोड करें, Aspose.3D प्रॉपर्टी के रूप में। डिफ़ॉल्ट मान false है।

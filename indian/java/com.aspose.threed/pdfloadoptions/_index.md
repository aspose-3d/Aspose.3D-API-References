...
description: PDF लोडिंग के विकल्प
type: docs
weight: 124
url: /hi/java/com.aspose.threed/pdfloadoptions/
---
...
PDF लोडिंग के विकल्प
## Constructors

| Constructor | विवरण |
| --- | --- |
| [PdfLoadOptions()](#PdfLoadOptions--) | [PdfLoadOptions](../../com.aspose.threed/pdfloadoptions) का कन्स्ट्रक्टर। |
## Methods
...
| [getPassword()](#getPassword--) | एन्क्रिप्टेड PDF फ़ाइल को अनलॉक करने के लिए पासवर्ड। |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setPassword(byte[] value)](#setPassword-byte---) | एन्क्रिप्टेड PDF फ़ाइल को अनलॉक करने के लिए पासवर्ड। |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[PdfLoadOptions](../../com.aspose.threed/pdfloadoptions) का कन्स्ट्रक्टर।
...
एन्क्रिप्टेड PDF फ़ाइल को अनलॉक करने के लिए पासवर्ड।

**Returns:**
byte[] - एन्क्रिप्टेड PDF फ़ाइल को अनलॉक करने के लिए पासवर्ड।
### hashCode() {#hashCode--}
```

...
description: 3DS फ़ाइल के लिए लोड विकल्प।
type: docs
weight: 43
url: /hi/java/com.aspose.threed/discreet3dsloadoptions/
---
...
| Constructor | विवरण |
| --- | --- |
| [Discreet3dsLoadOptions()](#Discreet3dsLoadOptions--) | का कंस्ट्रक्टर [Discreet3dsLoadOptions](../../com.aspose.threed/discreet3dsloadoptions) |
## Methods

| Method | विवरण |
| --- | --- |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getApplyAnimationTransform()](#getApplyAnimationTransform--) | पहले फ़्रेम की एनीमेशन ट्रैक में परिभाषित ट्रांसफ़ॉर्मेशन का उपयोग करना है या नहीं, प्राप्त करता है। |
| [getClass()](#getClass--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setApplyAnimationTransform(boolean value)](#setApplyAnimationTransform-boolean-) | पहले फ़्रेम की एनीमेशन ट्रैक में परिभाषित ट्रांसफ़ॉर्मेशन का उपयोग करना है या नहीं, सेट करता है। |
...
का कंस्ट्रक्टर [Discreet3dsLoadOptions](../../com.aspose.threed/discreet3dsloadoptions)
...
पहले फ़्रेम की एनीमेशन ट्रैक में परिभाषित ट्रांसफ़ॉर्मेशन का उपयोग करना है या नहीं, प्राप्त करता है।

**Returns:**
बूलियन - पहले फ़्रेम की एनीमेशन ट्रैक में परिभाषित ट्रांसफ़ॉर्मेशन का उपयोग करना है या नहीं।
### getClass() {#getClass--}
```
...
पहले फ़्रेम की एनीमेशन ट्रैक में परिभाषित ट्रांसफ़ॉर्मेशन का उपयोग करना है या नहीं, सेट करता है।

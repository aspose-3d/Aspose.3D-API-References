...
description: Fbx फ़ॉर्मेट के लिए लोड विकल्प।
type: docs
weight: 62
url: /hi/java/com.aspose.threed/fbxloadoptions/
---
...
Fbx फ़ॉर्मेट के लिए लोड विकल्प।
## Constructors

| Constructor | विवरण |
| --- | --- |
| [FbxLoadOptions(FileFormat format)](#FbxLoadOptions-com.aspose.threed.FileFormat-) | का कंस्ट्रक्टर [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions) |
| [FbxLoadOptions()](#FbxLoadOptions--) | का कंस्ट्रक्टर [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions) |
## Methods
...
| [getClass()](#getClass--) |  |
| [getCompatibleMode()](#getCompatibleMode--) | संगत मोड को सक्षम करना है या नहीं, प्राप्त करता है। |
...
| [getKeepBuiltinGlobalSettings()](#getKeepBuiltinGlobalSettings--) | GlobalSettings में अंतर्निहित प्रॉपर्टीज़ को रखना है या नहीं, प्राप्त करता है, जिनका मूल प्रॉपर्टी प्रतिस्थापन [AssetInfo](../../com.aspose.threed/assetinfo) में है। |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setCompatibleMode(boolean value)](#setCompatibleMode-boolean-) | संगत मोड को सक्षम करना है या नहीं, सेट करता है। |
...
| [setKeepBuiltinGlobalSettings(boolean value)](#setKeepBuiltinGlobalSettings-boolean-) | GlobalSettings में अंतर्निहित प्रॉपर्टीज़ को रखना है या नहीं, सेट करता है, जिनका मूल प्रॉपर्टी प्रतिस्थापन [AssetInfo](../../com.aspose.threed/assetinfo) में है। |
...
का कंस्ट्रक्टर [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions)

**Parameters:**
| Parameter | Type | विवरण |
| --- | --- | --- |
| format | [FileFormat](../../com.aspose.threed/fileformat) | [getFileFormat](../../com.aspose.threed/fbxloadoptions\#getFileFormat) का उदाहरण, यह एक वैध FBX फ़ॉर्मेट होना चाहिए। |
...
संगत मोड को सक्षम करना है या नहीं, प्राप्त करता है। संगत मोड ब्लेंडर द्वारा निर्यात किए गए PBR सामग्री जैसी गैर-मानक FBX परिभाषाओं का समर्थन करने की कोशिश करेगा। डिफ़ॉल्ट मान false है।

**Returns:**
बूलियन - संगत मोड को सक्षम करना है या नहीं। संगत मोड ब्लेंडर द्वारा निर्यात किए गए PBR सामग्री जैसी गैर-मानक FBX परिभाषाओं का समर्थन करने की कोशिश करेगा। डिफ़ॉल्ट मान false है।
...
GlobalSettings में अंतर्निहित प्रॉपर्टीज़ को रखना है या नहीं, प्राप्त करता है, जिनका मूल प्रॉपर्टी प्रतिस्थापन [AssetInfo](../../com.aspose.threed/assetinfo) में है। यदि आप GlobalSettings में सभी प्रॉपर्टीज़ चाहते हैं तो इसे true सेट करें। डिफ़ॉल्ट मान false है।

**Returns:**
बूलियन - GlobalSettings में अंतर्निहित प्रॉपर्टीज़ को रखना है या नहीं, जिनका मूल प्रॉपर्टी प्रतिस्थापन [AssetInfo](../../com.aspose.threed/assetinfo) में है। यदि आप GlobalSettings में सभी प्रॉपर्टीज़ चाहते हैं तो इसे true सेट करें। डिफ़ॉल्ट मान false है।
...
संगत मोड को सक्षम करना है या नहीं, सेट करता है। संगत मोड ब्लेंडर द्वारा निर्यात किए गए PBR सामग्री जैसी गैर-मानक FBX परिभाषाओं का समर्थन करने की कोशिश करेगा। डिफ़ॉल्ट मान false है।
...
GlobalSettings में अंतर्निहित प्रॉपर्टीज़ को रखना है या नहीं, सेट करता है, जिनका मूल प्रॉपर्टी प्रतिस्थापन [AssetInfo](../../com.aspose.threed/assetinfo) में है। यदि आप GlobalSettings में सभी प्रॉपर्टीज़ चाहते हैं तो इसे true सेट करें। डिफ़ॉल्ट मान false है।

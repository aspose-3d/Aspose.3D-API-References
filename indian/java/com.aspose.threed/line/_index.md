...
description: एक पॉलीलाइन वह पथ है जो बिंदुओं के सेट द्वारा परिभाषित होती है और   द्वारा जुड़ी होती है, जिसका अर्थ है कि यह जुड़े हुए रेखा खंडों का सेट भी हो सकता है।
type: docs
weight: 95
url: /hi/java/com.aspose.threed/line/
---
...
एक पॉलीलाइन वह पथ है जो बिंदुओं के सेट द्वारा परिभाषित होती है जिसमें [Geometry.getControlPoints](../../com.aspose.threed/geometry\#getControlPoints) है, और [getSegments](../../com.aspose.threed/line\#getSegments) द्वारा जुड़ी होती है, जिसका अर्थ है कि यह जुड़े हुए रेखा खंडों का सेट भी हो सकता है। लाइन आमतौर पर एक रैखिक वस्तु होती है, जिसका अर्थ है कि इसे वक्र को दर्शाने के लिए उपयोग नहीं किया जा सकता, वक्र को दर्शाने के लिए, [NurbsCurve](../../com.aspose.threed/nurbscurve) का उपयोग करता है।
## Constructors

| Constructor | विवरण |
| --- | --- |
| [Line()](#Line--) | नए [Line](../../com.aspose.threed/line) वर्ग का एक नया उदाहरण आरंभ करता है। |
| [Line(String name)](#Line-java.lang.String-) | नए [Line](../../com.aspose.threed/line) वर्ग का एक नया उदाहरण आरंभ करता है। |
## Methods
...
| [fromPoints(Vector3[] points)](#fromPoints-com.aspose.threed.Vector3...-) | [Line](../../com.aspose.threed/line) का एक उदाहरण बिंदुओं के सेट से बनाएं। |
...
| [getSegments()](#getSegments--) | लाइन के खंड प्राप्त करता है |
| [getVisible()](#getVisible--) | जियोमेट्री दृश्यमान है या नहीं प्राप्त करता है |
| [hashCode()](#hashCode--) |  |
| [makeDefaultIndices()](#makeDefaultIndices--) | क्रम 0,1,2,3....[Geometry.getControlPoints](../../com.aspose.threed/geometry\#getControlPoints).Length-1 उत्पन्न करें ताकि [getSegments](../../com.aspose.threed/line\#getSegments) के द्वारा ControlPoints को एकल लाइन के रूप में उपयोग किया जा सके। |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
नए [Line](../../com.aspose.threed/line) वर्ग का एक नया उदाहरण आरंभ करता है।
...
[Line](../../com.aspose.threed/line) का एक उदाहरण बिंदुओं के सेट से बनाएं।
...
**Returns:**
java.util.List<int[]> - लाइन के खंड
...
क्रम 0,1,2,3....[Geometry.getControlPoints](../../com.aspose.threed/geometry\#getControlPoints).Length-1 उत्पन्न करें ताकि [getSegments](../../com.aspose.threed/line\#getSegments) के द्वारा ControlPoints को एकल लाइन के रूप में उपयोग किया जा सके।

...
description: यह क्लास आपको मनमाने कर्व से सीधे 2D प्रोफ़ाइल बनाने की अनुमति देती है।
type: docs
weight: 16
url: /hi/java/com.aspose.threed/arbitraryprofile/
---
...
यह क्लास आपको मनमाने कर्व से सीधे 2D प्रोफ़ाइल बनाने की अनुमति देती है।
## Constructors

| Constructor | विवरण |
| --- | --- |
| [ArbitraryProfile()](#ArbitraryProfile--) | [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) का कंस्ट्रक्टर |
| [ArbitraryProfile(Curve curve)](#ArbitraryProfile-com.aspose.threed.Curve-) | [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) का कंस्ट्रक्टर प्रारंभिक कर्व के साथ। |
## Methods
...
| [getClass()](#getClass--) |  |
| [getCurve()](#getCurve--) | प्रोफ़ाइल बनाने के लिए उपयोग किया गया कर्व |
...
| [getHoles()](#getHoles--) | प्रोफ़ाइल के छेद, जिन्हें कर्व के रूप में भी दर्शाया गया है |
...
| [setCurve(Curve value)](#setCurve-com.aspose.threed.Curve-) | प्रोफ़ाइल बनाने के लिए उपयोग किया गया कर्व |
...
[ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) का कंस्ट्रक्टर
...
[ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) का कंस्ट्रक्टर प्रारंभिक कर्व के साथ।

**Parameters:**
| Parameter | Type | विवरण |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | प्रोफ़ाइल का प्रारंभिक कर्व |
...
प्रोफ़ाइल बनाने के लिए उपयोग किया गया कर्व
...
प्रोफ़ाइल के छेद, जिन्हें कर्व के रूप में भी दर्शाया गया है

**Returns:**
java.util.ArrayList<com.aspose.threed.Curve> - प्रोफ़ाइल के छेद, जिन्हें वक्र के रूप में भी दर्शाया गया है
### getName() {#getName--}
```

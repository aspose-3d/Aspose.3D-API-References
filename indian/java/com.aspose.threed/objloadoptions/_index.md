...
description: वेवफ्रंट obj के लिए लोड विकल्प
type: docs
weight: 115
url: /hi/java/com.aspose.threed/objloadoptions/
---
...
वेवफ्रंट obj के लिए लोड विकल्प
## Constructors

| Constructor | विवरण |
| --- | --- |
| [ObjLoadOptions()](#ObjLoadOptions--) | [ObjLoadOptions](../../com.aspose.threed/objloadoptions) का कंस्ट्रक्टर |
## Methods
...
| [getClass()](#getClass--) |  |
| [getEnableMaterials()](#getEnableMaterials--) | प्रत्येक ऑब्जेक्ट के लिए सामग्री आयात करना है या नहीं प्राप्त करता है |
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | आयात के दौरान नियंत्रण बिंदुओं/नॉर्मल के निर्देशांक प्रणाली को उलटना है या नहीं प्राप्त करता है |
...
| [getNormalizeNormal()](#getNormalizeNormal--) | लोडिंग के दौरान सामान्य वेक्टर को सामान्यीकृत करना है या नहीं प्राप्त करता है। |
| [getScale()](#getScale--) | x/y/z अक्ष पर स्केल करता है, डिफ़ॉल्ट मान 1.0 है |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEnableMaterials(boolean value)](#setEnableMaterials-boolean-) | प्रत्येक ऑब्जेक्ट के लिए सामग्री आयात करना है या नहीं सेट करता है |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | आयात के दौरान नियंत्रण बिंदुओं/नॉर्मल के निर्देशांक प्रणाली को उलटना है या नहीं सेट करता है |
...
| [setNormalizeNormal(boolean value)](#setNormalizeNormal-boolean-) | लोडिंग के दौरान सामान्य वेक्टर को सामान्यीकृत करना है या नहीं सेट करता है। |
| [setScale(double value)](#setScale-double-) | x/y/z अक्ष पर स्केल करता है, डिफ़ॉल्ट मान 1.0 है |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[ObjLoadOptions](../../com.aspose.threed/objloadoptions) का कंस्ट्रक्टर
...
प्रत्येक ऑब्जेक्ट के लिए सामग्री आयात करना है या नहीं प्राप्त करता है

**Returns:**
boolean - प्रत्येक ऑब्जेक्ट के लिए सामग्री आयात करना है या नहीं
...
आयात के दौरान नियंत्रण बिंदुओं/नॉर्मल के निर्देशांक प्रणाली को उलटना है या नहीं प्राप्त करता है

**Returns:**
boolean - आयात के दौरान नियंत्रण बिंदुओं/नॉर्मल के निर्देशांक प्रणाली को उलटना है या नहीं
...
लोडिंग के दौरान सामान्य वेक्टर को सामान्यीकृत करना है या नहीं प्राप्त करता है। डिफ़ॉल्ट मान true है।

**Returns:**
boolean - लोडिंग के दौरान सामान्य वेक्टर को सामान्यीकृत करना है या नहीं। डिफ़ॉल्ट मान true है।
### getScale() {#getScale--}
```
...
x/y/z अक्ष पर स्केल करता है, डिफ़ॉल्ट मान 1.0 है

**Returns:**
double - x/y/z अक्ष पर स्केल करता है, डिफ़ॉल्ट मान 1.0 है
### hashCode() {#hashCode--}
```
...
प्रत्येक ऑब्जेक्ट के लिए सामग्री आयात करना है या नहीं सेट करता है
...
आयात के दौरान नियंत्रण बिंदुओं/नॉर्मल के निर्देशांक प्रणाली को उलटना है या नहीं सेट करता है
...
लोडिंग के दौरान सामान्य वेक्टर को सामान्यीकृत करना है या नहीं सेट करता है। डिफ़ॉल्ट मान true है।

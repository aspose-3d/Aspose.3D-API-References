...
description: विभिन्न प्रकारों के लिए फ़ाइल लोडिंग में विकल्प कॉन्फ़िगर करने की बेस क्लास
type: docs
weight: 97
url: /hi/java/com.aspose.threed/loadoptions/
---
...
विभिन्न प्रकारों के लिए फ़ाइल लोडिंग में विकल्प कॉन्फ़िगर करने की बेस क्लास
## Methods

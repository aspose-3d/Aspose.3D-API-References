...
type: docs
weight: 93
url: /hi/java/com.aspose.threed/license/
---
...
और अधिक जानने के लिए, **Licensing and Subscription** दस्तावेज़ लेख देखें।
## Constructors
...
| Parameter | Type | विवरण |
| --- | --- | --- |
| स्ट्रीम | java.io.InputStream | लाइसेंस शामिल करने वाली एक स्ट्रीम। |
...
| Parameter | Type | विवरण |
| --- | --- | --- |
| licenseName | java.lang.String | पूरा या छोटा फ़ाइल नाम हो सकता है। मूल्यांकन मोड में स्विच करने के लिए खाली स्ट्रिंग उपयोग करें। |

...
description: IFC संगत मिरर प्रोफ़ाइल।
type: docs
weight: 106
url: /hi/java/com.aspose.threed/mirroredprofile/
---
...
IFC संगत मिरर प्रोफ़ाइल। यह प्रोफ़ाइल बेस प्रोफ़ाइल को y अक्ष के बारे में मिरर करके एक नई प्रोफ़ाइल परिभाषित करती है।
## Constructors

| Constructor | विवरण |
| --- | --- |
| [MirroredProfile(Profile baseProfile)](#MirroredProfile-com.aspose.threed.Profile-) | एक मौजूदा प्रोफ़ाइल से नई [MirroredProfile](../../com.aspose.threed/mirroredprofile) बनाएं। |
## Methods
...
| [getBaseProfile()](#getBaseProfile--) | मिरर की जाने वाली बेस प्रोफ़ाइल। |
...
एक मौजूदा प्रोफ़ाइल से नई [MirroredProfile](../../com.aspose.threed/mirroredprofile) बनाएं।

**Parameters:**
| Parameter | Type | विवरण |
| --- | --- | --- |
| baseProfile | [Profile](../../com.aspose.threed/profile) | मिरर की जाने वाली बेस प्रोफ़ाइल। |
...
मिरर की जाने वाली बेस प्रोफ़ाइल।

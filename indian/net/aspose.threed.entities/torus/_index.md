...
description: पैरमट्रकृत टरस.
type: docs
weight: 710
url: /hi/net/aspose.threed.entities/torus/
---
## Torus class
...
| नाम | विवरण |
| --- | --- |
| [Torus](torus/#constructor)() | का एक नया उदाहरण प्रारंभ करता है`Torus` वर्ग. |
| [Torus](torus/#constructor_1)(double, double) | का एक नया उदाहरण प्रारंभ करता है`Torus` वर्ग. |
| [Torus](torus/#constructor_2)(double, double, double) | का एक नया उदाहरण प्रारंभ करता है`Torus` वर्ग. |
| [Torus](torus/#constructor_3)(string, double, double, int, int, double) | का एक नया उदाहरण प्रारंभ करता है`Torus` वर्ग. |

## गुण

| नाम | विवरण |
| --- | --- |
| [Arc](../../aspose.threed.entities/torus/arc/) { get; set; } | आर्क प्राप्त करता है या सेट करता है। |
...
| [RadialSegments](../../aspose.threed.entities/torus/radialsegments/) { get; set; } | रेडियल सेगमेंट प्राप्त या सेट करता है। |
| [Radius](../../aspose.threed.entities/torus/radius/) { get; set; } | टोरस की त्रिज्या प्राप्त या सेट करता है। |
...
| [Tube](../../aspose.threed.entities/torus/tube/) { get; set; } | ट्यूब की त्रिज्या प्राप्त या सेट करता है। |
| [TubularSegments](../../aspose.threed.entities/torus/tubularsegments/) { get; set; } | ट्यूबलर सेगमेंट प्राप्त या सेट करता है। |
...
| override [ToMesh](../../aspose.threed.entities/torus/tomesh/)() | वर्तमान वस्तु को मेश में बदलें |

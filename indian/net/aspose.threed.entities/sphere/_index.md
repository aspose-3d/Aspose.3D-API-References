...
description: पैरमटरयुक्त क्षेत्र
type: docs
weight: 670
url: /hi/net/aspose.threed.entities/sphere/
---
## Sphere class

पैरामीटरयुक्त क्षेत्र।
...
| नाम | विवरण |
| --- | --- |
| [Sphere](sphere/#constructor)() | का एक नया उदाहरण प्रारंभ करता है`Sphere` डिफ़ॉल्ट त्रिज्या 1. के साथ |
| [Sphere](sphere/#constructor_1)(double) | का एक नया उदाहरण प्रारंभ करता है`Sphere` वर्ग के साथ निर्दिष्ट त्रिज्या. |
| [Sphere](sphere/#constructor_2)(double, int, int) | का एक नया उदाहरण प्रारंभ करता है`Sphere` वर्ग के साथ निर्दिष्ट त्रिज्या, चौड़ाई खंड और ऊंचाई खंड. |
| [Sphere](sphere/#constructor_3)(string, double, int, int, double, double, double, double) | का एक नया उदाहरण प्रारंभ करता है`Sphere` वर्ग. |
...
| [HeightSegments](../../aspose.threed.entities/sphere/heightsegments/) { get; set; } | ऊंचाई खंड प्राप्त या सेट करता है। |
...
| [PhiLength](../../aspose.threed.entities/sphere/philength/) { get; set; } | phi. की लंबाई प्राप्त या सेट करता है |
| [PhiStart](../../aspose.threed.entities/sphere/phistart/) { get; set; } | फाई स्टार्ट को प्राप्त या सेट करता है। |
| [Properties](../../aspose.threed/a3dobject/properties/) { get; } | सभी संपत्तियों का संग्रह प्राप्त करता है। |
| [Radius](../../aspose.threed.entities/sphere/radius/) { get; set; } | गोले की त्रिज्या प्राप्त या सेट करता है। |
...
| [ThetaLength](../../aspose.threed.entities/sphere/thetalength/) { get; set; } | थीटा की लंबाई प्राप्त या सेट करता है। |
| [ThetaStart](../../aspose.threed.entities/sphere/thetastart/) { get; set; } | थीटा स्टार्ट हो जाता है या सेट हो जाता है। |
| [WidthSegments](../../aspose.threed.entities/sphere/widthsegments/) { get; set; } | चौड़ाई खंड प्राप्त या सेट करता है। |
...
| override [ToMesh](../../aspose.threed.entities/sphere/tomesh/)() | वर्तमान वस्तु को मेश में बदलें |

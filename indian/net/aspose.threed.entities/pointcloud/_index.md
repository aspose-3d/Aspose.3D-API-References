...
description: पइंट क्लउड में कई टपलज जनकर नहं है लेकन केवल नयंत्रण बंदु और वर्टेक्स तत्व हैं
type: docs
weight: 540
url: /hi/net/aspose.threed.entities/pointcloud/
---
## PointCloud class

पॉइंट क्लाउड में कोई टोपोलॉजी जानकारी नहीं है, लेकिन केवल नियंत्रण बिंदु और वर्टेक्स तत्व हैं।
...
| नाम | विवरण |
| --- | --- |
| [PointCloud](pointcloud/#constructor)() | का निर्माता`PointCloud` |
| [PointCloud](pointcloud/#constructor_1)(string) | का निर्माता`PointCloud` |
...
| नाम | विवरण |
| --- | --- |
| static [FromGeometry](../../aspose.threed.entities/pointcloud/fromgeometry/#fromgeometry)(Geometry) | एक ज्योमेट्री ऑब्जेक्ट से एक नया पॉइंटक्लाउड इंस्टेंस बनाएं |
| static [FromGeometry](../../aspose.threed.entities/pointcloud/fromgeometry/#fromgeometry_1)(Geometry, int) | एक ज्योमेट्री ऑब्जेक्ट से एक नया पॉइंट क्लाउड इंस्टेंस बनाएं। घनत्व प्रति यूनिट त्रिकोण बिंदुओं की संख्या है (यूनिट त्रिकोण जाल से अधिकतम सतह क्षेत्र वाला त्रिकोण है) |
...
| override [GetEntityRendererKey](../../aspose.threed.entities/pointcloud/getentityrendererkey/)() | रेंडरर में पंजीकृत इकाई रेंडरर की कुंजी प्राप्त करता है |

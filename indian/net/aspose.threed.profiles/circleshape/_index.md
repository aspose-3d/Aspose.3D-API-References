...
description: IFC संगत सर्कल प्रफ़इल जसक उपयग जल बनने के लए कय ज सकत हैLinearExtrusion../aspose.threed.entities/linearextrusion/
type: docs
weight: 1530
url: /hi/net/aspose.threed.profiles/circleshape/
---
## CircleShape class

IFC संगत सर्कल प्रोफ़ाइल, जिसका उपयोग जाल बनाने के लिए किया जा सकता है[`LinearExtrusion`](../../aspose.threed.entities/linearextrusion/)
...
| नाम | विवरण |
| --- | --- |
| [CircleShape](circleshape/#constructor)() | का निर्माण करें`CircleShape` डिफ़ॉल्ट त्रिज्या के साथ प्रोफ़ाइल (5). |
| [CircleShape](circleshape/#constructor_1)(double) | का निर्माण करें`CircleShape` प्रोफ़ाइल के साथ निर्दिष्ट त्रिज्या. |
...
| [Radius](../../aspose.threed.profiles/circleshape/radius/) { get; set; } | वृत्त की त्रिज्या प्राप्त या सेट करता है। |
...
| override [GetExtent](../../aspose.threed.profiles/circleshape/getextent/)() | एक्स और वाई आयाम में सीमा प्राप्त करता है। |

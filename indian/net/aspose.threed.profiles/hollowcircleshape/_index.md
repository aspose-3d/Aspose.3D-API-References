...
description: IFC संगत हल सर्कल प्रफ़इल.
type: docs
weight: 1560
url: /hi/net/aspose.threed.profiles/hollowcircleshape/
---
## HollowCircleShape class

IFC संगत होलो सर्कल प्रोफ़ाइल.
...
| नाम | विवरण |
| --- | --- |
| [HollowCircleShape](hollowcircleshape/)() | डिफ़ॉल्ट कंस्ट्रक्टर। |
...
| [WallThickness](../../aspose.threed.profiles/hollowcircleshape/wallthickness/) { get; set; } | बाहरी और आंतरिक त्रिज्या के बीच अंतर प्राप्त या सेट करता है। |

...
description: पडएफ लडंग के लए वकल्प
type: docs
weight: 1250
url: /hi/net/aspose.threed.formats/pdfloadoptions/
---
## PdfLoadOptions class

पीडीएफ लोडिंग के लिए विकल्प
...
| नाम | विवरण |
| --- | --- |
| [PdfLoadOptions](pdfloadoptions/)() | का निर्माता`PdfLoadOptions` |
...
| [Password](../../aspose.threed.formats/pdfloadoptions/password/) { get; set; } | एन्क्रिप्ट की गई PDF फ़ाइल को अनलॉक करने का पासवर्ड. |

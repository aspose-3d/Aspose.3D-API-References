...
description: STL के लए वकल्प सहेजें
type: docs
weight: 1360
url: /hi/net/aspose.threed.formats/stlsaveoptions/
---
## StlSaveOptions class

STL के लिए विकल्प सहेजें
...
| नाम | विवरण |
| --- | --- |
| [StlSaveOptions](stlsaveoptions/#constructor)() | एक नए की शुरुआत करता है`StlSaveOptions` उदाहरण. |
| [StlSaveOptions](stlsaveoptions/#constructor_1)(FileContentType) | एक नए की शुरुआत करता है`StlSaveOptions` उदाहरण. |
...
| [FlipCoordinateSystem](../../aspose.threed.formats/stlsaveoptions/flipcoordinatesystem/) { get; set; } | हो जाता है या सेट हो जाता है कि नियंत्रण बिंदुओं की फ़्लिप समन्वय प्रणाली/निर्यात के दौरान सामान्य है या नहीं। |

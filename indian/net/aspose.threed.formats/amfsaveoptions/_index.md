...
description: AMF के लए वकल्प सहेजें
type: docs
weight: 1030
url: /hi/net/aspose.threed.formats/amfsaveoptions/
---
## AmfSaveOptions class

AMF के लिए विकल्प सहेजें
...
| नाम | विवरण |
| --- | --- |
| [AmfSaveOptions](amfsaveoptions/)() | का निर्माता`AmfSaveOptions` |

## गुण

| नाम | विवरण |
| --- | --- |
| [EnableCompression](../../aspose.threed.formats/amfsaveoptions/enablecompression/) { get; set; } | अंतिम फ़ाइल आकार को कम करने के लिए संपीड़न का उपयोग करना है या नहीं, डिफ़ॉल्ट मान true है |

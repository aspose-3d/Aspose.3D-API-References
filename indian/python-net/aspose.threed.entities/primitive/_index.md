...
type: docs
weight: 310
url: /hi/python-net/aspose.threed.entities/primitive/
is_root: false
---
...
| [`remove_property(self, property)`](/3d/python-net/aspose.threed.entities/primitive/remove_property/#system.string) | Remove the specified property identified by name |
| [`get_property(self, property)`](/3d/python-net/aspose.threed.entities/primitive/get_property/#system.string) | Get the value of specified property |
| [`set_property(self, property, value)`](/3d/python-net/aspose.threed.entities/primitive/set_property/#system.string-system.object) | Sets the value of specified property |
| [`find_property(self, property_name)`](/3d/python-net/aspose.threed.entities/primitive/find_property/#system.string) | Finds the property.

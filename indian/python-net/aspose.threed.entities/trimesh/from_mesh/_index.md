...
type: docs
weight: 70
url: /hi/python-net/aspose.threed.entities/trimesh/from_mesh/
is_root: false
---
...
# एक वर्टेक्स घोषणा इस प्रकार परिभाषित करें {FVector3 Position; FVector3 Normal; FVector2 UV}
...
# निर्दिष्ट मेमोरी लेआउट का उपयोग करके एक मेष को त्रि-मे़श में बदलें
mesh = Sphere().to_mesh()
triMesh = TriMesh.from_mesh(vd, mesh)
# इसे एक स्ट्रीम में सहेजें, 115 वर्टिसेज * प्रति वर्टेक्स 32 बाइट्स
with open("output.bin", "wb") as stream:
    triMesh.write_vertices_to(stream)
    # इंडेक्स को ushort के रूप में स्ट्रीम में सहेजें, 504 इंडेक्स * प्रति इंडेक्स 2 बाइट्स

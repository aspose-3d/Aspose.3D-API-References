...
description: 所有混凝土纹理的基类 纹理定义几何表面的外观
type: docs
weight: 2360
...
| 姓名 | 描述 |
| --- | --- |
| [TextureBase](texturebase)(string) | 初始化[`TextureBase`](../texturebase)类. |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [Alpha](../../aspose.threed.shading/texturebase/alpha) { get; set; } | 获取或设置纹理的默认 alpha 值 这在[`AlphaSource`](./alphasource)是PixelAlpha 默认值为 1.0，有效值范围在 0 和 1 之间 |

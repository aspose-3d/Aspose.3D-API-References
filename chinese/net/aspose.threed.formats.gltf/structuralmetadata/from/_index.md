...
description: "StructuralMetadata method. 获取与指定场景关联的 StructuralMetadata"
type: docs
weight: 20
url: /zh/net/aspose.threed.formats.gltf/structuralmetadata/from/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 场景 | 场景 | 要在哪个场景中查找结构化元数据 |

### 返回值

如果在场景中找到，则返回 [`StructuralMetadata`](../) 的有效实例，否则返回 null

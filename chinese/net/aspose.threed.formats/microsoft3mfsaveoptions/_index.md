---
title: "Microsoft3MFSaveOptions 类"
...
| 名称 | 描述 |
| --- | --- |
| [BuildAll](../../aspose.threed.formats/microsoft3mfsaveoptions/buildall/) { get; set; } | 将场景中的所有几何体标记为可打印。或者您可以通过 [`SetBuildable`](../microsoft3mfformat/setbuildable/) 手动标记节点为可打印。默认值为 true |

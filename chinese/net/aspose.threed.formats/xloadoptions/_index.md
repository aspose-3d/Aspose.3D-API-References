...
| 姓名 | 描述 |
| --- | --- |
| [XLoadOptions](xloadoptions)(FileContentType) | 的构造函数[`XLoadOptions`](../xloadoptions) |
...
| [FlipCoordinateSystem](../../aspose.threed.formats/xloadoptions/flipcoordinatesystem) { get; set; } | 翻转坐标系，默认是这样 |

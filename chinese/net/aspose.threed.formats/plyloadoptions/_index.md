...
| 姓名 | 描述 |
| --- | --- |
| [PlyLoadOptions](plyloadoptions)() | [`PlyLoadOptions`](../plyloadoptions) |
...
| [FlipCoordinateSystem](../../aspose.threed.formats/plyloadoptions/flipcoordinatesystem) { get; set; } | 获取或设置导入/导出过程中控制点/法线的翻转坐标系。 |

...
| 姓名 | 描述 |
| --- | --- |
| [U3dLoadOptions](u3dloadoptions)() | 的构造函数[`U3dLoadOptions`](../u3dloadoptions) |
...
| [FlipCoordinateSystem](../../aspose.threed.formats/u3dloadoptions/flipcoordinatesystem) { get; set; } | 获取或设置在导入/导出时是否翻转控制点/法线坐标系。 |

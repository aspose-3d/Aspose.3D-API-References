---
title: "类 U3dLoadOptions"
second_title: "Aspose.3D for .NET API 参考"
description: "Aspose.ThreeD.Formats.U3dLoadOptions 类。通用 3D 的加载选项"
type: docs
weight: 1520
url: /zh/net/aspose.threed.formats/u3dloadoptions/
---
...
| 名称 | 描述 |
| --- | --- |
| [U3dLoadOptions](u3dloadoptions/)() | `U3dLoadOptions` 的构造函数 |
...
| [FlipCoordinateSystem](../../aspose.threed.formats/u3dloadoptions/flipcoordinatesystem/) { get; set; } | 获取或设置在导入/导出时是否翻转控制点/法线的坐标系。 |

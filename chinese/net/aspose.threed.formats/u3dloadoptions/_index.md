...
| 姓名 | 描述 |
| --- | --- |
| [U3dLoadOptions](u3dloadoptions)() | [`U3dLoadOptions`](../u3dloadoptions) |
...
| [FlipCoordinateSystem](../../aspose.threed.formats/u3dloadoptions/flipcoordinatesystem) { get; set; } | 获取或设置在导入/导出时是否翻转控制点坐标系/法线。 |

---
title: "类 PdfLoadOptions"
second_title: "Aspose.3D for .NET API 参考"
description: "Aspose.ThreeD.Formats.PdfLoadOptions 类。PDF 加载的选项"
type: docs
weight: 1400
url: /zh/net/aspose.threed.formats/pdfloadoptions/
---
...
| 名称 | 描述 |
| --- | --- |
| [PdfLoadOptions](pdfloadoptions/)() | `PdfLoadOptions` 的构造函数 |
...
| [Password](../../aspose.threed.formats/pdfloadoptions/password/) { get; set; } | 用于解锁加密 PDF 文件的密码。 |

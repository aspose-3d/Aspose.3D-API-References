...
| 姓名 | 描述 |
| --- | --- |
| [AmfSaveOptions](amfsaveoptions)() | 的构造函数[`AmfSaveOptions`](../amfsaveoptions) |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [EnableCompression](../../aspose.threed.formats/amfsaveoptions/enablecompression) { get; set; } | 是否使用压缩来减小最终文件大小，默认值为true |

...
| 姓名 | 描述 |
| --- | --- |
| [GltfLoadOptions](gltfloadoptions)() | 的构造函数[`GltfLoadOptions`](../gltfloadoptions) |
...
| [FlipTexCoordV](../../aspose.threed.formats/gltfloadoptions/fliptexcoordv) { get; set; } | 在mesh的纹理坐标中翻转v(t)坐标，默认值为true。 |

...
| 姓名 | 描述 |
| --- | --- |
| [Html5SaveOptions](html5saveoptions)() | 的构造函数[`Html5SaveOptions`](../html5saveoptions)使用所有默认设置。 |
...
| [ShowGrid](../../aspose.threed.formats/html5saveoptions/showgrid) { get; set; } | 在场景中显示一个网格。 默认值为true。 |
| [ShowRulers](../../aspose.threed.formats/html5saveoptions/showrulers) { get; set; } | 在场景中显示x/y/z轴的标尺来测量模型。 默认值为false。 |
| [ShowUI](../../aspose.threed.formats/html5saveoptions/showui) { get; set; } | 在场景中显示一个简单的 UI。 默认值为 true。 |
| [UpVector](../../aspose.threed.formats/html5saveoptions/upvector) { get; set; } | 获取或设置上向量，取值可以是"x"/"y"/"z"，默认是"y" |

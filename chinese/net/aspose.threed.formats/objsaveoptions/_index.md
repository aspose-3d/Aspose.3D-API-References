...
| 姓名 | 描述 |
| --- | --- |
| [ObjSaveOptions](objsaveoptions)() | [`ObjSaveOptions`](../objsaveoptions) |
...
| [FlipCoordinateSystem](../../aspose.threed.formats/objsaveoptions/flipcoordinatesystem) { get; set; } | 获取或设置在导入/导出时是否翻转控制点坐标系/法线。 |
| [LookupPaths](../../aspose.threed.formats/ioconfig/lookuppaths) { get; set; } | 像 OBJ 这样的一些文件依赖于外部文件，查找路径将允许 Aspose.3D 查找要加载的外部文件。 |
| [PointCloud](../../aspose.threed.formats/objsaveoptions/pointcloud) { get; set; } | 获取或设置导出器是否将场景导出为点云的标志（无拓扑结构），默认值为false |
| [SerializeW](../../aspose.threed.formats/objsaveoptions/serializew) { get; set; } | 获取或设置是否序列化模型顶点位置的W组件。 |
| [Verbose](../../aspose.threed.formats/objsaveoptions/verbose) { get; set; } | 获取或设置是否为每个部分生成评论 |

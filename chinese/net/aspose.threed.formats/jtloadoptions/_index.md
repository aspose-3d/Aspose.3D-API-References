...
| [LoadPMI](../../aspose.threed.formats/jtloadoptions/loadpmi/) { get; set; } | 如果可能，从 JT 文件加载 PMI 信息，数据将保存为 [`AssetInfo`](../../aspose.threed/scene/assetinfo/) 的属性 \"PMI\"。默认值为 false。 |
| [LoadProperties](../../aspose.threed.formats/jtloadoptions/loadproperties/) { get; set; } | 从 JT 的属性表加载属性，作为 Aspose.3D 属性。默认值为 false。 |

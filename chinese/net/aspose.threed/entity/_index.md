...
description: 所有实体的基类 实体表示附加在节点下的具体对象例如Light../aspose.threed.entities/light/Geometry../aspose.threed.entities/geometry.
type: docs
weight: 970
...
所有实体的基类。 实体表示附加在节点下的具体对象，例如[`Light`](../../aspose.threed.entities/light)/[`Geometry`](../../aspose.threed.entities/geometry).
...
| 姓名 | 描述 |
| --- | --- |
| [Entity](entity)(string) | 初始化[`Entity`](../entity)类. |

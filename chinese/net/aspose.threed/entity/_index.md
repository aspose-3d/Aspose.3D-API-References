...
description: "Aspose.ThreeD.Entity 类。所有实体的基类。Entity 表示附加在如 Light/Geometry 节点下的具体对象"
type: docs
weight: 1030
...
所有实体的基类。Entity 表示附加在如 [`Light`](../../aspose.threed.entities/light/)/[`Geometry`](../../aspose.threed.entities/geometry/) 节点下的具体对象。

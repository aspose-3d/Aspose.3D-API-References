...
姿势用于在几何体蒙皮时存储变换矩阵。姿势是一组 [`BonePose`](../bonepose/)，每个 [`BonePose`](../bonepose/) 保存骨节点的具体变换信息。
...
| 名称 | 描述 |
| --- | --- |
| [AddBonePose](../../aspose.threed/pose/addbonepose/#addbonepose)(Node, Matrix4) | 为给定的骨节点保存姿势变换矩阵。隐含全局变换矩阵。 |
| [AddBonePose](../../aspose.threed/pose/addbonepose/#addbonepose_1)(Node, Matrix4, bool) | 为给定的骨节点保存姿势变换矩阵。 |

...
description: "Aspose.ThreeD.AssetInfo 类。资产信息。资产信息可以附加到场景。子场景可以拥有自己的 AssetInfo 来覆盖父级定义。"
type: docs
weight: 130
...
资产信息。资产信息可以附加到 [`Scene`](../scene/)。子 [`Scene`](../scene/) 可以拥有自己的 `AssetInfo` 来覆盖父级定义。
...
| 名称 | 描述 |
| --- | --- |
| [Ambient](../../aspose.threed/assetinfo/ambient/) { get; set; } | 获取或设置此资产的默认环境光颜色 |
...
| [CoordinateSystem](../../aspose.threed/assetinfo/coordinatesystem/) { get; set; } | 获取或设置此资产中使用的坐标系。 |
...
| [FrontVector](../../aspose.threed/assetinfo/frontvector/) { get; set; } | 获取或设置此资产中使用的前向量。 |
...
| [Revision](../../aspose.threed/assetinfo/revision/) { get; set; } | 获取或设置此资产的修订号，通常在版本控制系统中使用。 |

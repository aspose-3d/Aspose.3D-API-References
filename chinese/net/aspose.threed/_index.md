...
| [AssetInfo](./assetinfo/) | 资产信息。资产信息可以附加到 [`Scene`](../aspose.threed/scene/)。子 [`Scene`](../aspose.threed/scene/) 可以拥有自己的 [`AssetInfo`](../aspose.threed/assetinfo/) 来覆盖父级的定义。 |
| [AxisSystem](./axissystem/) | 坐标系是坐标系统、上向量和前向量的组合。 |
| [BonePose](./bonepose/) | [`BonePose`](../aspose.threed/bonepose/) 包含骨骼节点的变换矩阵。 |
| [CustomObject](./customobject/) | 此类管理 3D 文件中使用的元数据或自定义对象。所有自定义属性均保存为动态属性。 |
| [Entity](./entity/) | 所有实体的基类。实体表示附加在节点下的具体对象，例如 [`Light`](../aspose.threed.entities/light/) / [`Geometry`](../aspose.threed.entities/geometry/)。 |
...
| [ImportException](./importexception/) | Aspose.3D 未能打开指定源时的异常 |
...
| [Pose](./pose/) | 当几何体进行蒙皮时，姿势用于存储变换矩阵。姿势是一组 [`BonePose`](../aspose.threed/bonepose/)，每个 [`BonePose`](../aspose.threed/bonepose/) 保存骨骼节点的具体变换信息。 |
| [Property](./property/) | 用于保存用户自定义属性的类。 |
| [PropertyCollection](./propertycollection/) | 属性集合 |
| [Scene](./scene/) | 场景是包含节点、几何体、材质、纹理、动画、姿势、子场景等的顶层对象。场景可以拥有子场景，在 collada、blender、fbx 等文件中充当多文档支持。可以通过 [`RootNode`](../aspose.threed/scene/rootnode/)[`Library`](../aspose.threed/scene/library/) 访问节点层次结构，[`Library`](../aspose.threed/scene/library/) 用于在序列化期间保存未关联对象的引用（如元数据或自定义对象），因此可用作库。 |
| [SceneObject](./sceneobject/) | 将在场景中存储的对象的根类。 |
| [Transform](./transform/) | 变换包含信息，允许以最小开销访问对象的平移/缩放/旋转或变换矩阵。这用于局部变换。 |
| [TrialException](./trialexception/) | 当未应用许可证时，在 Scene.Open/Scene.Save 中会抛出此异常。可以通过将 SuppressTrialException 设置为 true 来关闭此异常。 |
## 接口

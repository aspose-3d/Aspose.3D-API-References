...
description: "Aspose.ThreeD.Profiles.EllipseShape 类。兼容 IFC 的椭圆形，由参数定义。轮廓的中心位置位于包围盒的中心"
type: docs
weight: 1710
...
兼容 IFC 的椭圆形，由参数定义。配置文件的中心位置位于包围盒的中心。
...
| [SemiAxis1](../../aspose.threed.profiles/ellipseshape/semiaxis1/) { get; set; } | 获取或设置椭圆在 x 轴方向测量的第一半径。 |
| [SemiAxis2](../../aspose.threed.profiles/ellipseshape/semiaxis2/) { get; set; } | 获取或设置椭圆在 y 轴方向测量的第二半径。 |

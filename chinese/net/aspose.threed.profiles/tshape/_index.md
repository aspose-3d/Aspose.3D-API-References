...
description: "Aspose.ThreeD.Profiles.TShape 类。由参数定义的符合 IFC 的 TShape"
type: docs
weight: 1810
url: /zh/net/aspose.threed.profiles/tshape/
---
## TShape class
...
| 名称 | 描述 |
| --- | --- |
| [TShape](tshape/)() | `TShape` 的构造函数 |

## 属性

| 名称 | 描述 |
| --- | --- |
| [Depth](../../aspose.threed.profiles/tshape/depth/) { get; set; } | 获取或设置腹板的长度。 |
| [Excluded](../../aspose.threed/entity/excluded/) { get; set; } | 获取或设置在导出时是否排除此实体。 |
| [FilletRadius](../../aspose.threed.profiles/tshape/filletradius/) { get; set; } | 获取或设置腹板与法兰之间圆角的半径。 |
| [FlangeEdgeRadius](../../aspose.threed.profiles/tshape/flangeedgeradius/) { get; set; } | 获取或设置法兰边缘的半径。 |
| [FlangeThickness](../../aspose.threed.profiles/tshape/flangethickness/) { get; set; } | 获取或设置法兰的壁厚。 |
| [FlangeWidth](../../aspose.threed.profiles/tshape/flangewidth/) { get; set; } | 获取或设置法兰的长度。 |
...
| [WebEdgeRadius](../../aspose.threed.profiles/tshape/webedgeradius/) { get; set; } | 获取或设置腹板边缘的半径。 |
| [WebThickness](../../aspose.threed.profiles/tshape/webthickness/) { get; set; } | 获取或设置腹板的壁厚。 |
...
| override [GetExtent](../../aspose.threed.profiles/tshape/getextent/)() | 获取 x 和 y 维度的范围。 |

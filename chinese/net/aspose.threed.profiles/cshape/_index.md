...
description: 由参数定义的 IFC 兼容 C 形轮廓 轮廓的中心位置在边界框的中心
type: docs
weight: 1510
...
由参数定义的 IFC 兼容 C 形轮廓。 轮廓的中心位置在边界框的中心。
...
| 姓名 | 描述 |
| --- | --- |
| [Depth](../../aspose.threed.profiles/cshape/depth) { get; set; } | 获取或设置轮廓的深度。 |
| [Excluded](../../aspose.threed/entity/excluded) { get; set; } | 获取或设置是否在导出时排除该实体。 |
| [Girth](../../aspose.threed.profiles/cshape/girth) { get; set; } | 获取或设置周长。 |

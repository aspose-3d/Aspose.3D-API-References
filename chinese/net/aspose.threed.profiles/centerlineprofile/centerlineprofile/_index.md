...
description: "CenterLineProfile 构造函数。使用指定曲线作为中心线构造新的 CenterLineProfile"
type: docs
weight: 10
url: /zh/net/aspose.threed.profiles/centerlineprofile/centerlineprofile/
---
## CenterLineProfile constructor

构造一个新的 [`CenterLineProfile`](../)，使用指定曲线作为中心线。

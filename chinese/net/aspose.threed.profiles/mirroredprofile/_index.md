---
title: "类 MirroredProfile"
second_title: "Aspose.3D for .NET API 参考"
description: "Aspose.ThreeD.Profiles.MirroredProfile 类。符合 IFC 的镜像轮廓。此轮廓通过关于 y 轴镜像基准轮廓来定义新的轮廓"
type: docs
weight: 1770
...
兼容 IFC 的镜像配置文件。该配置文件通过沿 y 轴镜像基准配置文件来定义新配置文件。
...
| 名称 | 描述 |
| --- | --- |
| [MirroredProfile](mirroredprofile/)(Profile) | 从现有轮廓构造一个新的 `MirroredProfile`。 |

## 属性

| 名称 | 描述 |
| --- | --- |
| [BaseProfile](../../aspose.threed.profiles/mirroredprofile/baseprofile/) { get; } | 要镜像的基准轮廓。 |

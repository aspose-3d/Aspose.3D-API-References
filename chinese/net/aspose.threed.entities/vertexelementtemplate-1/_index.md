...
type: docs
weight: 880
url: /zh/net/aspose.threed.entities/vertexelementtemplate-1/
---
...
| 姓名 | 描述 |
| --- | --- |
| [Data](../../aspose.threed.entities/vertexelementtemplate`1/data) { get; } | 获取顶点数据 |
...
| 姓名 | 描述 |
| --- | --- |
| override [Clear](../../aspose.threed.entities/vertexelementtemplate`1/clear)() | 从直接数组和索引数组中删除所有元素。 |

---
title: "类 VertexElementIntsTemplate"
second_title: "Aspose.3D for .NET API 参考"
description: "Aspose.ThreeD.Entities.VertexElementIntsTemplate 类。 用于定义具体 VertexElement 实现的辅助类"
type: docs
weight: 870
url: /zh/net/aspose.threed.entities/vertexelementintstemplate/
---
## VertexElementIntsTemplate class

用于定义具体 [`VertexElement`](../vertexelement/) 实现的辅助类。

```csharp
public class VertexElementIntsTemplate : VertexElement
```
...
| 名称 | 描述 |
| --- | --- |
| override [Clear](../../aspose.threed.entities/vertexelementintstemplate/clear/)() | 从直接数组和索引数组中移除所有元素。 |

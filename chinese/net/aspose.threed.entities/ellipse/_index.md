...
description: "Aspose.ThreeD.Entities.Ellipse 类。Ellipse 定义了一组形成椭圆形状的点。"
type: docs
weight: 380
...
| 名称 | 描述 |
| --- | --- |
| [Ellipse](ellipse/#constructor)() | `Ellipse` 的构造函数 |
| [Ellipse](ellipse/#constructor_1)(double, double) | `Ellipse` 的构造函数 |

...
| 姓名 | 描述 |
| --- | --- |
| [PointCloud](pointcloud#constructor)() | 的构造函数[`PointCloud`](../pointcloud) |
| [PointCloud](pointcloud#constructor_1)(string) | 的构造函数[`PointCloud`](../pointcloud) |
...
| override [GetEntityRendererKey](../../aspose.threed.entities/pointcloud/getentityrendererkey)() | 获取渲染器中注册的实体渲染器的key |

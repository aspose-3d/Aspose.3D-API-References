...
description: TriMesh 包含可由 GPU 直接使用的原始数据 此类是一个实用程序可帮助构建仅包含每个顶点数据的网格
type: docs
weight: 730
...
| 姓名 | 描述 |
| --- | --- |
| [TriMesh](trimesh)(string, VertexDeclaration) | 初始化一个实例[`TriMesh`](../trimesh) |
...
| [UnmergedVerticesCount](../../aspose.threed.entities/trimesh/unmergedverticescount) { get; } | 传入的未合并顶点数[`BeginVertex`](./beginvertex)和[`EndVertex`](./endvertex). |
...
| 姓名 | 描述 |
| --- | --- |
| static [CopyFrom](../../aspose.threed.entities/trimesh/copyfrom)(TriMesh, VertexDeclaration) | 复制[`TriMesh`](../trimesh)来自具有新顶点 layout 的输入 |
| static [FromMesh](../../aspose.threed.entities/trimesh/frommesh#frommesh)(Mesh, bool) | 从给定的网格对象创建一个 TriMesh，顶点声明基于输入网格的结构。 |
| static [FromMesh](../../aspose.threed.entities/trimesh/frommesh#frommesh_1)(VertexDeclaration, Mesh) | 使用给定的顶点布局从给定的网格对象创建一个 TriMesh。 |

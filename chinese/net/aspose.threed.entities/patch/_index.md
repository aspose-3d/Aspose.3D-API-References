...
description: APatch./patch是一个参数化建模曲面类似于NurbsSurface它也由两个 PatchDirection./patchdirection定义U./patch/u和V./patch/v 但是Patch./patch和NurbsSurface之间的区别是PatchDirection./patchdirection曲线 可以是Bezier之一QuadraticBezierBasisSplineCardinalSpline和Linear
type: docs
weight: 500
...
A[`Patch`](../patch)是一个参数化建模曲面，类似于NurbsSurface，它也由两个 [`PatchDirection`](../patchdirection)定义，[`U`](./u)和[`V`](./v)。 但是[`Patch`](../patch)和NurbsSurface之间的区别是[`PatchDirection`](../patchdirection)曲线 可以是Bezier之一,QuadraticBezier,BasisSpline,CardinalSpline和Linear
...
| 姓名 | 描述 |
| --- | --- |
| [Patch](patch#constructor)() | 初始化[`Patch`](../patch)类的新实例。 |
| [Patch](patch#constructor_1)(string) | 初始化[`Patch`](../patch)类的新实例。 |

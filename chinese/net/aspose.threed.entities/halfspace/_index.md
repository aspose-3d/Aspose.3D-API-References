...
description: "Aspose.ThreeD.Entities.HalfSpace 类。HalfSpace 表示被平面划分的无限空间，可与 BooleanOperator 一起使用"
type: docs
weight: 420
...
| [Normal](../../aspose.threed.entities/halfspace/normal/) { get; set; } | 划分平面的法向量，平面的定义为 N * P + D = 0，其中 N 为法向量，P 为平面上的任意点。 |
...
| [Position](../../aspose.threed.entities/halfspace/position/) { get; set; } | 划分平面上的任意点，平面的定义为 N * P + D = 0，其中 N 为法向量，P 为平面上的任意点。 |

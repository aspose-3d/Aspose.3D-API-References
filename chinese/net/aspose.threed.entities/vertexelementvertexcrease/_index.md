---
title: "类 VertexElementVertexCrease"
second_title: "Aspose.3D for .NET API 参考"
description: "Aspose.ThreeD.Entities.VertexElementVertexCrease 类。定义了指定组件的顶点折痕"
type: docs
weight: 1000
url: /zh/net/aspose.threed.entities/vertexelementvertexcrease/
---
...
| 名称 | 描述 |
| --- | --- |
| [VertexElementVertexCrease](vertexelementvertexcrease/)() | 初始化 `VertexElementVertexCrease` 类的新实例。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Clear](../../aspose.threed.entities/vertexelementdoublestemplate/clear/)() | 从直接数组和索引数组中移除所有元素。 |

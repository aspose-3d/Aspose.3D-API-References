...
| 姓名 | 描述 |
| --- | --- |
| [Camera](camera#constructor)() | 初始化[`Camera`](../camera)类的新实例。 |
| [Camera](camera#constructor_1)(ProjectionType) | 初始化[`Camera`](../camera)类的新实例。 |
| [Camera](camera#constructor_2)(string) | 初始化[`Camera`](../camera)类的新实例。 |
| [Camera](camera#constructor_3)(string, ProjectionType) | 初始化[`Camera`](../camera)类的新实例。 |
...
| [FieldOfView](../../aspose.threed.entities/camera/fieldofview) { get; set; } | 获取或设置相机的视野，单位为度，该属性仅在 ApertureMode 为Horizontal时使用或Vertical |
| [FieldOfViewX](../../aspose.threed.entities/camera/fieldofviewx) { get; set; } | 获取或设置相机的水平视野（以度为单位），该属性仅在 ApertureMode 为ApertureMode时使用。HorizAndVert |
| [FieldOfViewY](../../aspose.threed.entities/camera/fieldofviewy) { get; set; } | 获取或设置相机的垂直视野，以度为单位，该属性仅在 ApertureMode 为ApertureMode时使用。HorizAndVert |
...
| [Width](../../aspose.threed.entities/camera/width) { get; set; } | 获取或设置以英寸为单位的视图平面宽度 |

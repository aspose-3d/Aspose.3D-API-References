...
| 姓名 | 描述 |
| --- | --- |
| [Sphere](sphere#constructor)() | 初始化[`Sphere`](../sphere)的新实例，默认半径为 1。 |
| [Sphere](sphere#constructor_1)(double) | 初始化具有指定半径的[`Sphere`](../sphere)类的新实例。 |
| [Sphere](sphere#constructor_2)(double, int, int) | 用指定的半径、宽度段和高度段初始化[`Sphere`](../sphere)类的新实例。 |
| [Sphere](sphere#constructor_3)(string, double, int, int, double, double, double, double) | 初始化[`Sphere`](../sphere)类的新实例。 |
...
| [PhiStart](../../aspose.threed.entities/sphere/phistart) { get; set; } | 获取或设置 phi 开始。 |

...
| 姓名 | 描述 |
| --- | --- |
| [Torus](torus#constructor)() | 初始化[`Torus`](../torus)类的新实例。 |
| [Torus](torus#constructor_1)(double, double) | 初始化[`Torus`](../torus)类的新实例。 |
| [Torus](torus#constructor_2)(double, double, double) | 初始化[`Torus`](../torus)类的新实例。 |
| [Torus](torus#constructor_3)(string, double, double, int, int, double) | 初始化[`Torus`](../torus)类的新实例。 |

...
| 姓名 | 描述 |
| --- | --- |
| [Plane](plane#constructor)() | 初始化[`Plane`](../plane)默认大小为 1x1. |
| [Plane](plane#constructor_1)(double, double) | 初始化[`Plane`](../plane). |
| [Plane](plane#constructor_2)(string, double, double, int, int) | 初始化[`Plane`](../plane). |

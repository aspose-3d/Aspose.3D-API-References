...
description: "BooleanOperand 方法。构造一个 BooleanOperand 实例，需要提供一个节点以及一个实现了 IMeshConvertible 的有效实体"
type: docs
weight: 10
...
构造一个 [`BooleanOperand`](../) 实例，需要提供一个节点和一个实现了 [`IMeshConvertible`](../../imeshconvertible/) 的有效实体
...
从一个裸的 [`IMeshConvertible`](../../imeshconvertible/) 实例构造一个 [`BooleanOperand`](../) 实例。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| mesh | Entity | 用于布尔运算的操作数的网格，它可以是 [`IMeshConvertible`](../../imeshconvertible/) 或 [`HalfSpace`](../../halfspace/) 的实例。 |

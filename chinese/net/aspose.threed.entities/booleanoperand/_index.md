...
description: "Aspose.ThreeD.Entities.BooleanOperand 类。此类将变换后的网格封装为布尔运算的操作数。"
type: docs
weight: 260
...
| 名称 | 描述 |
| --- | --- |
| static [Of](../../aspose.threed.entities/booleanoperand/of/#of)(Entity) | 从裸露的 [`IMeshConvertible`](../imeshconvertible/) 实例构造 `BooleanOperand` 实例。 |
...
| override [ToString](../../aspose.threed.entities/booleanoperand/tostring/)() | 获取 `BooleanOperand` 的字符串表示 |

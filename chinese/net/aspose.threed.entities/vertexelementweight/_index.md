---
title: "类 VertexElementWeight"
second_title: "Aspose.3D for .NET API 参考"
description: "Aspose.ThreeD.Entities.VertexElementWeight 类。定义指定组件的混合权重"
type: docs
weight: 1020
...
| 名称 | 描述 |
| --- | --- |
| [VertexElementWeight](vertexelementweight/)() | 初始化 `VertexElementWeight` 类的新实例。 |

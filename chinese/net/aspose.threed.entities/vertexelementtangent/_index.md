---
title: "类 VertexElementTangent"
second_title: "Aspose.3D for .NET API 参考"
description: "Aspose.ThreeD.Entities.VertexElementTangent 类。定义指定组件的切线向量"
type: docs
weight: 930
...
| 名称 | 描述 |
| --- | --- |
| [VertexElementTangent](vertexelementtangent/)() | 初始化 `VertexElementTangent` 类的新实例。 |

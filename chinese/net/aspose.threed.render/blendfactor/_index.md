...
| OneMinusSrcColor | `3` | 混合因子是 vec4(1) - src.rgba |
...
| OneMinusConstantColor | `11` | 混合因子是 vec4(1) - c 其中 c 在[`BlendColor`](../renderstate/blendcolor)中指定 |
| ConstantAlpha | `12` | 混合因子是 vec4(c.a)，其中 c 在 [`BlendColor`](../renderstate/blendcolor) |
| OneMinusConstantAlpha | `13` | 混合因子是 vec4(1 - ca) 其中 c 在[`BlendColor`](../renderstate/blendcolor)中指定 |

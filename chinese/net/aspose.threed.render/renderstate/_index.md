...
| [BlendColor](../../aspose.threed.render/renderstate/blendcolor) { get; set; } | 获取或设置在ConstantColor |
...
| [StencilMask](../../aspose.threed.render/renderstate/stencilmask) { get; set; } | 获取或设置在测试完成时与引用和存储的模板值进行与运算的掩码。 |
...
| [Dispose](../../aspose.threed.render/renderstate/dispose)() | 处理[`RenderState`](../renderstate)并释放所有内部资源。 |
| override [Equals](../../aspose.threed.render/renderstate/equals)(object) | 返回一个值，指示此实例是否等于指定对象。 |

...
description: "使用变换矩阵为曲线提供定位。"
type: docs
weight: 192
url: /zh/java/com.aspose.threed/transformedcurve/
---
...
使用变换矩阵为曲线提供定位的 [TransformedCurve](../../com.aspose.threed/transformedcurve)。这允许在 [TrimmedCurve](../../com.aspose.threed/trimmedcurve) 或 [CompositeCurve](../../com.aspose.threed/compositecurve) 中执行变换。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [TransformedCurve()](#TransformedCurve--) | [TransformedCurve](../../com.aspose.threed/transformedcurve) 的构造函数 |
| [TransformedCurve(Curve basisCurve, Matrix4 transformation)](#TransformedCurve-com.aspose.threed.Curve-com.aspose.threed.Matrix4-) | [TransformedCurve](../../com.aspose.threed/transformedcurve) 的构造函数 |
## 方法
...
| [getBasisCurve()](#getBasisCurve--) | 基础曲线。 |
...
| [getTransformMatrix()](#getTransformMatrix--) | 变换矩阵。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setBasisCurve(Curve value)](#setBasisCurve-com.aspose.threed.Curve-) | 基础曲线。 |
...
| [setTransformMatrix(Matrix4 value)](#setTransformMatrix-com.aspose.threed.Matrix4-) | 变换矩阵。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[TransformedCurve](../../com.aspose.threed/transformedcurve) 的构造函数
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | [Curve](../../com.aspose.threed/curve) | 新值 |

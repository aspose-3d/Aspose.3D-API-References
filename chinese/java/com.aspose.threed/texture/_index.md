...
description: "此类定义了来自外部文件的纹理。"
type: docs
weight: 184
url: /zh/java/com.aspose.threed/texture/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [Texture()](#Texture--) | 初始化 [Texture](../../com.aspose.threed/texture) 类的新实例。 |
| [Texture(String name)](#Texture-java.lang.String-) | 初始化 [Texture](../../com.aspose.threed/texture) 类的新实例。 |
## 方法
...
| [getClass()](#getClass--) |  |
| [getContent()](#getContent--) | 获取纹理的二进制内容。 |
| [getEnableMipMap()](#getEnableMipMap--) | 获取此纹理的 mipmap 是否已启用 |
| [getFileName()](#getFileName--) | 获取关联的纹理文件。 |
...
| [setContent(byte[] value)](#setContent-byte---) | 设置纹理的二进制内容。 |
| [setEnableMipMap(boolean value)](#setEnableMipMap-boolean-) | 设置是否为此纹理启用 mipmap |
| [setFileName(String value)](#setFileName-java.lang.String-) | 设置关联的纹理文件。 |
...
初始化 [Texture](../../com.aspose.threed/texture) 类的新实例。
...
**Returns:**
byte[] - 纹理的二进制内容。嵌入的纹理内容是可选的，如果缺失，用户应从外部文件加载纹理。

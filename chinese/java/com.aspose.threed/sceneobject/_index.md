...
description: "将在场景内部存储的对象的根类。"
type: docs
weight: 162
url: /zh/java/com.aspose.threed/sceneobject/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [SceneObject(String name)](#SceneObject-java.lang.String-) | 使用默认名称初始化 SceneObject |
| [SceneObject()](#SceneObject--) | 初始化 SceneObject。 |
## 方法
...
使用默认名称初始化 SceneObject

**Parameters:**
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 名称 | java.lang.String | 此实例的名称 |

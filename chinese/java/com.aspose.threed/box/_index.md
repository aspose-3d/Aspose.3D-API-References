...
type: docs
weight: 26
url: /zh/java/com.aspose.threed/box/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [Box()](#Box--) | 初始化一个新的 [Box](../../com.aspose.threed/box) 类实例。 |
| [Box(double length, double width, double height)](#Box-double-double-double-) | 初始化一个新的 [Box](../../com.aspose.threed/box) 类实例。 |
| [Box(String name, double length, double width, double height, int lengthSegments, int widthSegments, int heightSegments)](#Box-java.lang.String-double-double-double-int-int-int-) | 初始化一个新的 [Box](../../com.aspose.threed/box) 类实例。 |
## 方法
...
| [getHeight()](#getHeight--) | 获取沿 y 轴对齐的盒子的高度。 |
| [getHeightSegments()](#getHeightSegments--) | 获取或设置高度细分。 |
| [getLength()](#getLength--) | 获取沿 z 轴对齐的盒子的长度。 |
...
| [getWidth()](#getWidth--) | 获取沿 x 轴对齐的盒子的宽度。 |
...
| [setHeight(double value)](#setHeight-double-) | 设置沿 y 轴对齐的盒子的高度。 |
| [setHeightSegments(int value)](#setHeightSegments-int-) | 获取或设置高度细分。 |
| [setLength(double value)](#setLength-double-) | 设置沿 z 轴对齐的盒子的长度。 |
...
| [setWidth(double value)](#setWidth-double-) | 设置沿 x 轴对齐的盒子的宽度。 |
...
初始化一个新的 [Box](../../com.aspose.threed/box) 类实例。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 长度 | double | 沿 z 轴对齐的盒子的长度。 |
| 宽度 | double | 沿 x 轴对齐的盒子的宽度。 |
| 高度 | double | 沿 y 轴对齐的盒子的高度。 |

...
description: "导出场景为 PLY 文件的保存选项。"
type: docs
weight: 131
url: /zh/java/com.aspose.threed/plysaveoptions/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [PlySaveOptions()](#PlySaveOptions--) | 构造函数 [PlySaveOptions](../../com.aspose.threed/plysaveoptions) |
| [PlySaveOptions(FileContentType contentType)](#PlySaveOptions-com.aspose.threed.FileContentType-) | 构造函数 [PlySaveOptions](../../com.aspose.threed/plysaveoptions) |
## 方法

| 方法 | 描述 |
| --- | --- |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getAxisSystem()](#getAxisSystem--) | 获取导出 stl 文件中的坐标系。 |
| [getClass()](#getClass--) |  |
| [getColorComponents()](#getColorComponents--) | 顶点颜色的组件名称，默认值为 ("red", "green", "blue") |
| [getEncoding()](#getEncoding--) | 获取基于文本的文件的默认编码。 |
| [getExportTextures()](#getExportTextures--) | 尝试将场景中使用的纹理复制到输出目录。 |
| [getFaceElement()](#getFaceElement--) | 面数据的元素名称，默认值为 "face" |
| [getFaceProperty()](#getFaceProperty--) | 面数据的属性名称，默认值为 "vertex\_index" |
...
| [getFlipCoordinate()](#getFlipCoordinate--) | 保存场景时翻转坐标，默认值为 true |
| [getLookupPaths()](#getLookupPaths--) | 某些文件（如 OBJ）依赖外部文件，查找路径将允许 Aspose.3D 查找并加载外部文件。 |
| [getNormalComponents()](#getNormalComponents--) | 法线数据的组件名称，默认值为 ("nx", "ny", "nz") |
| [getPointCloud()](#getPointCloud--) | 将场景导出为点云，默认值为 false。 |
| [getPositionComponents()](#getPositionComponents--) | 位置数据的组件名称，默认值为 ("x", "y", "z") |
| [getTextureCoordinateComponents()](#getTextureCoordinateComponents--) | 纹理坐标数据的组件名称，默认值为 ("u", "v") |
| [getVertexElement()](#getVertexElement--) | 顶点数据的元素名称，默认值为 "vertex" |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAxisSystem(AxisSystem value)](#setAxisSystem-com.aspose.threed.AxisSystem-) | 设置导出 STL 文件中的坐标系。 |
| [setColorComponents(Tuple_3<String,String,String> value)](#setColorComponents-com.aspose.threed.Tuple-3-java.lang.String-java.lang.String-java.lang.String--) | 顶点颜色的组件名称，默认值为 ("red", "green", "blue") |
...
| [setFaceElement(String value)](#setFaceElement-java.lang.String-) | 面数据的元素名称，默认值为 "face" |
| [setFaceProperty(String value)](#setFaceProperty-java.lang.String-) | 面数据的属性名称，默认值为 "vertex\_index" |
...
| [setFlipCoordinate(boolean value)](#setFlipCoordinate-boolean-) | 保存场景时翻转坐标，默认值为 true |
...
| [setNormalComponents(Tuple_3<String,String,String> value)](#setNormalComponents-com.aspose.threed.Tuple-3-java.lang.String-java.lang.String-java.lang.String--) | 法线数据的组件名称，默认值为 ("nx", "ny", "nz") |
| [setPointCloud(boolean value)](#setPointCloud-boolean-) | 将场景导出为点云，默认值为 false。 |
| [setPositionComponents(Tuple_3<String,String,String> value)](#setPositionComponents-com.aspose.threed.Tuple-3-java.lang.String-java.lang.String-java.lang.String--) | 位置数据的组件名称，默认值为 ("x", "y", "z") |
| [setTextureCoordinateComponents(Tuple_2<String,String> value)](#setTextureCoordinateComponents-com.aspose.threed.Tuple-2-java.lang.String-java.lang.String--) | 纹理坐标数据的组件名称，默认值为 ("u", "v") |
| [setVertexElement(String value)](#setVertexElement-java.lang.String-) | 顶点数据的元素名称，默认值为 "vertex" |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
构造函数 [PlySaveOptions](../../com.aspose.threed/plysaveoptions)
...
**Returns:**
com.aspose.threed.Tuple_3<java.lang.String,java.lang.String,java.lang.String> - 顶点颜色的组件名称，默认值为 ("red", "green", "blue")
...
**Returns:**
java.lang.String - 面数据的元素名称，默认值为 "face"
...
面数据的属性名称，默认值为 "vertex\_index"

**Returns:**
java.lang.String - 面数据的属性名称，默认值为 "vertex\_index"
...
**Returns:**
com.aspose.threed.Tuple_3<java.lang.String,java.lang.String,java.lang.String> - 法线数据的组件名称，默认值为 ("nx", "ny", "nz")
...
**Returns:**
com.aspose.threed.Tuple_3<java.lang.String,java.lang.String,java.lang.String> - 位置数据的组件名称，默认值为 ("x", "y", "z")
...
**Returns:**
com.aspose.threed.Tuple_2<java.lang.String,java.lang.String> - 纹理坐标数据的组件名称，默认值为 ("u", "v")
...
**Returns:**
java.lang.String - 顶点数据的元素名称，默认值为 "vertex"
### hashCode() {#hashCode--}
```
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | [AxisSystem](../../com.aspose.threed/axissystem) | 新值 **Remarks:** 必须启用 FlipCoordinateSystem 才能使用此功能。 |

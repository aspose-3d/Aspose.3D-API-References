...
description: "AMF 的保存选项"
type: docs
weight: 12
url: /zh/java/com.aspose.threed/amfsaveoptions/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [AmfSaveOptions()](#AmfSaveOptions--) | [AmfSaveOptions](../../com.aspose.threed/amfsaveoptions) 的构造函数 |
## 方法
...
| [getClass()](#getClass--) |  |
| [getEnableCompression()](#getEnableCompression--) | 是否使用压缩以减小最终文件大小，默认值为 true |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEnableCompression(boolean value)](#setEnableCompression-boolean-) | 是否使用压缩以减小最终文件大小，默认值为 true |
...
[AmfSaveOptions](../../com.aspose.threed/amfsaveoptions) 的构造函数
...
是否使用压缩以减小最终文件大小，默认值为 true

**Returns:**
boolean - 是否使用压缩以减小最终文件大小，默认值为 true

...
description: "Microsoft 3MF 文件格式实例，包含 3MF 相关工具。"
type: docs
weight: 104
url: /zh/java/com.aspose.threed/microsoft3mfformat/
---
...
| [getObjectType(Node node)](#getObjectType-com.aspose.threed.Node-) | 获取指定节点的模型类型。 |
| [getTransformForBuild(Node node)](#getTransformForBuild-com.aspose.threed.Node-) | 获取在构建中使用的节点的变换矩阵。 |
| [getVersion()](#getVersion--) | 获取文件格式版本 |
| [hashCode()](#hashCode--) |  |
| [isBuildable(Node node)](#isBuildable-com.aspose.threed.Node-) | 检查此节点是否标记为构建。 |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBuildable(Node node, boolean value, Matrix4 transform)](#setBuildable-com.aspose.threed.Node-boolean-com.aspose.threed.Matrix4-) | 标记节点用于构建。 |
| [setObjectType(Node node, String modelType)](#setObjectType-com.aspose.threed.Node-java.lang.String-) | 设置指定节点的模型类型。 |
...
**Returns:**
java.lang.String - 给定节点的 3MF 对象类型
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | 获取 3MF 构建的变换矩阵的节点。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | 要检查的节点 |

**Returns:**
boolean - 如果标记为构建则为 True
### notify() {#notify--}
```
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | 要标记为构建的节点。 |
| 值 | 布尔 |  |
| transform | [Matrix4](../../com.aspose.threed/matrix4) | 构建中节点的变换。 |
...
设置指定节点的模型类型。可能的值：model surface solidsupport support other

...
description: "纹理采样期间的过滤选项。"
type: docs
weight: 305
url: /zh/java/com.aspose.threed/texturefilter/
---
...
| 字段 | 描述 |
| --- | --- |
| [ANISOTROPIC](#ANISOTROPIC) | 使用各向异性插值进行采样，此仅在缩小过滤器中使用。 |
| [LINEAR](#LINEAR) | 使用线性插值进行采样 |
| [NONE](#NONE) | 无缩小，此仅在缩小过滤器中使用。 |
| [POINT](#POINT) | 使用点采样 |
## 方法

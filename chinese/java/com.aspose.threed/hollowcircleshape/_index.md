...
description: "兼容 IFC 的空心圆形剖面。"
type: docs
weight: 78
url: /zh/java/com.aspose.threed/hollowcircleshape/
---
...
| [getWallThickness()](#getWallThickness--) | 获取外半径和内半径之间的差值。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setWallThickness(double value)](#setWallThickness-double-) | 设置外半径和内半径之间的差值。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |

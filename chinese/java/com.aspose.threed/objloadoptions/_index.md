...
description: "Wavefront OBJ 的加载选项"
type: docs
weight: 115
url: /zh/java/com.aspose.threed/objloadoptions/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [ObjLoadOptions()](#ObjLoadOptions--) | [ObjLoadOptions](../../com.aspose.threed/objloadoptions) 的构造函数 |
## 方法
...
| [getClass()](#getClass--) |  |
| [getEnableMaterials()](#getEnableMaterials--) | 获取是否为每个对象导入材质 |
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | 获取在导入期间是否翻转控制点/法线的坐标系 |
| [getLookupPaths()](#getLookupPaths--) | 某些文件（如 OBJ）依赖外部文件，查找路径将允许 Aspose.3D 查找并加载外部文件。 |
| [getNormalizeNormal()](#getNormalizeNormal--) | 获取在加载期间是否归一化法向量。 |
| [getScale()](#getScale--) | 在 x/y/z 轴上的缩放比例，默认值为 1.0 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEnableMaterials(boolean value)](#setEnableMaterials-boolean-) | 设置是否为每个对象导入材质 |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | 设置在导入期间是否翻转控制点/法线的坐标系 |
...
| [setNormalizeNormal(boolean value)](#setNormalizeNormal-boolean-) | 设置在加载期间是否归一化法向量。 |
| [setScale(double value)](#setScale-double-) | 在 x/y/z 轴上的缩放比例，默认值为 1.0 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[ObjLoadOptions](../../com.aspose.threed/objloadoptions) 的构造函数
...
获取在导入期间是否翻转控制点/法线的坐标系

**Returns:**
boolean - 是否在导入期间翻转控制点/法线的坐标系
...
获取在加载期间是否归一化法向量。默认值为 true。

**Returns:**
boolean - 是否在加载期间归一化法向量。默认值为 true。
### getScale() {#getScale--}
```
...
在 x/y/z 轴上的缩放比例，默认值为 1.0

**Returns:**
double - 在 x/y/z 轴上的缩放比例，默认值为 1.0
### hashCode() {#hashCode--}
```

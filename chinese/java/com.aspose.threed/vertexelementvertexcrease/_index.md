...
description: "为指定的分量定义顶点折痕"
type: docs
weight: 224
url: /zh/java/com.aspose.threed/vertexelementvertexcrease/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [VertexElementVertexCrease()](#VertexElementVertexCrease--) | 初始化 [VertexElementVertexCrease](../../com.aspose.threed/vertexelementvertexcrease) 类的新实例。 |
## 方法
...
| [copyTo(VertexElementDoublesTemplate target)](#copyTo-com.aspose.threed.VertexElementDoublesTemplate-) | 将数据复制到指定的元素 |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(double[] data)](#setData-double---) | 加载数据 |
...
初始化 [VertexElementVertexCrease](../../com.aspose.threed/vertexelementvertexcrease) 类的新实例。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| target | [VertexElementDoublesTemplate](../../com.aspose.threed/vertexelementdoublestemplate) | 目标。 |
...
**Returns:**
java.util.List<java.lang.Double> - 顶点数据

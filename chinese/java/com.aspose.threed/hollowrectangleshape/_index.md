...
description: "兼容 IFC 的空心矩形形状，具有内外圆角。"
type: docs
weight: 79
url: /zh/java/com.aspose.threed/hollowrectangleshape/
---
...
| [getInnerFilletRadius()](#getInnerFilletRadius--) | 内部矩形的内圆角半径。 |
...
| [getWallThickness()](#getWallThickness--) | 矩形边界与内部孔之间的厚度 |
...
| [setInnerFilletRadius(double value)](#setInnerFilletRadius-double-) | 内部矩形的内圆角半径。 |
...
| [setWallThickness(double value)](#setWallThickness-double-) | 矩形边界与内部孔之间的厚度 |

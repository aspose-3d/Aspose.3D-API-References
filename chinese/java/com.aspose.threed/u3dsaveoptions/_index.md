...
description: "通用 3D 的保存选项"
type: docs
weight: 198
url: /zh/java/com.aspose.threed/u3dsaveoptions/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [U3dSaveOptions()](#U3dSaveOptions--) | [U3dSaveOptions](../../com.aspose.threed/u3dsaveoptions) 的构造函数 |
## 方法
...
| [getClass()](#getClass--) |  |
| [getEmbedTextures()](#getEmbedTextures--) | 将外部纹理嵌入 U3D 文件，默认值为 false。 |
| [getEncoding()](#getEncoding--) | 获取基于文本的文件的默认编码。 |
| [getExportNormals()](#getExportNormals--) | 获取是否导出法线数据。 |
| [getExportTextureCoordinates()](#getExportTextureCoordinates--) | 获取是否导出纹理坐标。 |
| [getExportTextures()](#getExportTextures--) | 尝试将场景中使用的纹理复制到输出目录。 |
| [getExportVertexDiffuse()](#getExportVertexDiffuse--) | 获取是否导出顶点的漫反射颜色。 |
| [getExportVertexSpecular()](#getExportVertexSpecular--) | 获取是否导出顶点的高光颜色。 |
...
| [getMeshCompression()](#getMeshCompression--) | 获取是否启用网格数据压缩。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEmbedTextures(boolean value)](#setEmbedTextures-boolean-) | 将外部纹理嵌入 U3D 文件，默认值为 false。 |
| [setEncoding(Charset value)](#setEncoding-java.nio.charset.Charset-) | 设置基于文本的文件的默认编码。 |
| [setExportNormals(boolean value)](#setExportNormals-boolean-) | 设置是否导出法线数据。 |
| [setExportTextureCoordinates(boolean value)](#setExportTextureCoordinates-boolean-) | 设置是否导出纹理坐标。 |
| [setExportTextures(boolean value)](#setExportTextures-boolean-) | 尝试将场景中使用的纹理复制到输出目录。 |
| [setExportVertexDiffuse(boolean value)](#setExportVertexDiffuse-boolean-) | 设置是否导出顶点的漫反射颜色。 |
| [setExportVertexSpecular(boolean value)](#setExportVertexSpecular-boolean-) | 设置是否导出顶点的高光颜色。 |
...
| [setMeshCompression(boolean value)](#setMeshCompression-boolean-) | 设置是否启用网格数据压缩。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[U3dSaveOptions](../../com.aspose.threed/u3dsaveoptions) 的构造函数
...
将外部纹理嵌入 U3D 文件，默认值为 false。

**Returns:**
boolean - 将外部纹理嵌入 U3D 文件，默认值为 false。

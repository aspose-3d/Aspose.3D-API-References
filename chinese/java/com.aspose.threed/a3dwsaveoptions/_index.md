...
type: docs
weight: 11
url: /zh/java/com.aspose.threed/a3dwsaveoptions/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [A3dwSaveOptions()](#A3dwSaveOptions--) | [A3dwSaveOptions](../../com.aspose.threed/a3dwsaveoptions) 的构造函数 |
## 方法
...
| [getExportMetaData()](#getExportMetaData--) | 将与 Scene/Node 关联的元数据导出到客户端，默认值为 true |
...
| [getMetaDataPrefix()](#getMetaDataPrefix--) | 如果此属性非空，则仅导出以此前缀开头的 Scene/Node 属性，并且会移除该前缀。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEncoding(Charset value)](#setEncoding-java.nio.charset.Charset-) | 设置基于文本的文件的默认编码。 |
| [setExportMetaData(boolean value)](#setExportMetaData-boolean-) | 将与 Scene/Node 关联的元数据导出到客户端，默认值为 true |
...
| [setMetaDataPrefix(String value)](#setMetaDataPrefix-java.lang.String-) | 如果此属性非空，则仅导出以此前缀开头的 Scene/Node 属性，并且会移除该前缀。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[A3dwSaveOptions](../../com.aspose.threed/a3dwsaveoptions) 的构造函数
...
将与 Scene/Node 关联的元数据导出到客户端，默认值为 true

**Returns:**
boolean - 将与 Scene/Node 关联的元数据导出到客户端，默认值为 true
...
如果此属性非空，则仅导出以此前缀开头的 Scene/Node 属性，并且会移除该前缀。

**Returns:**
java.lang.String - 如果此属性非空，则仅导出以此前缀开头的 Scene/Node 属性，并且会移除该前缀。
### hashCode() {#hashCode--}
```

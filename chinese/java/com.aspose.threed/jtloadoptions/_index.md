...
description: "Siemens JT 的加载选项。"
type: docs
weight: 88
url: /zh/java/com.aspose.threed/jtloadoptions/
---
...
| [getLoadPMI()](#getLoadPMI--) | 如果可能，从 JT 文件加载 PMI 信息，数据将保存为属性 "PMI" 于 [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo)。 |
| [getLoadProperties()](#getLoadProperties--) | 将 JT 的属性表中的属性加载为 Aspose.3D 属性。 |
...
| [setLoadPMI(boolean value)](#setLoadPMI-boolean-) | 如果可能，从 JT 文件加载 PMI 信息，数据将保存为属性 "PMI" 于 [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo)。 |
| [setLoadProperties(boolean value)](#setLoadProperties-boolean-) | 将 JT 的属性表中的属性加载为 Aspose.3D 属性。 |
...
如果可能，从 JT 文件加载 PMI 信息，数据将保存为属性 "PMI" 于 [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo)。默认值为 false。

**Returns:**
boolean - 如果可能，从 JT 文件加载 PMI 信息，数据将保存为属性 "PMI" 于 [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo)。默认值为 false。
...
将 JT 的属性表中的属性加载为 Aspose.3D 属性。默认值为 false。

**Returns:**
boolean - 将 JT 的属性表中的属性加载为 Aspose.3D 属性。默认值为 false。

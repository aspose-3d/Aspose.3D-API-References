...
description: "定义指定的分量是否可见"
type: docs
weight: 225
url: /zh/java/com.aspose.threed/vertexelementvisibility/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [VertexElementVisibility()](#VertexElementVisibility--) | 初始化 [VertexElementVisibility](../../com.aspose.threed/vertexelementvisibility) 类的新实例。 |
## 方法
...
| [copyTo(VertexElementTemplate<T> target)](#copyTo-com.aspose.threed.VertexElementTemplate-T--) | 将数据复制到指定的元素 |
...
初始化 [VertexElementVisibility](../../com.aspose.threed/vertexelementvisibility) 类的新实例。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| target | [VertexElementTemplate](../../com.aspose.threed/vertexelementtemplate) | 目标。 |

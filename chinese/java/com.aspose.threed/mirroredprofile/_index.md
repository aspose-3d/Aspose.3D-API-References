...
description: "IFC 兼容的镜像配置文件。"
type: docs
weight: 106
url: /zh/java/com.aspose.threed/mirroredprofile/
---
...
兼容 IFC 的镜像轮廓。此轮廓通过沿 y 轴镜像基准轮廓来定义一个新轮廓。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [MirroredProfile(Profile baseProfile)](#MirroredProfile-com.aspose.threed.Profile-) | 从现有轮廓构造一个新的 [MirroredProfile](../../com.aspose.threed/mirroredprofile)。 |
## 方法
...
| [getBaseProfile()](#getBaseProfile--) | 要镜像的基准轮廓。 |
...
从现有轮廓构造一个新的 [MirroredProfile](../../com.aspose.threed/mirroredprofile)。

**Parameters:**
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| baseProfile | [Profile](../../com.aspose.threed/profile) | 要镜像的基准轮廓。 |

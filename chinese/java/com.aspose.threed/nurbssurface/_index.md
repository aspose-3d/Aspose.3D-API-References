...
description: "是一种由 NURBS（Non-uniform rational basis spline）表示的曲面。A 由两个  和  定义。"
type: docs
weight: 114
url: /zh/java/com.aspose.threed/nurbssurface/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [NurbsSurface()](#NurbsSurface--) | 初始化 [NurbsSurface](../../com.aspose.threed/nurbssurface) 类的新实例。 |
| [NurbsSurface(String name)](#NurbsSurface-java.lang.String-) | 初始化 [NurbsSurface](../../com.aspose.threed/nurbssurface) 类的新实例。 |
## 方法
...
| [getU()](#getU--) | 获取 NURBS 曲面的 U 方向 |
| [getV()](#getV--) | 获取 NURBS 曲面的 V 方向 |
...
初始化 [NurbsSurface](../../com.aspose.threed/nurbssurface) 类的新实例。

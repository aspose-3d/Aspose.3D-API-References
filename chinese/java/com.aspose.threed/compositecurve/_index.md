...
description: "A 由多个曲线段组成。"
type: docs
weight: 34
url: /zh/java/com.aspose.threed/compositecurve/
---
...
A [CompositeCurve](../../com.aspose.threed/compositecurve) 由多个曲线段组成。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [CompositeCurve()](#CompositeCurve--) | [CompositeCurve](../../com.aspose.threed/compositecurve) 的构造函数 |
## 方法

| 方法 | 描述 |
| --- | --- |
| [addSegment(Curve curve)](#addSegment-com.aspose.threed.Curve-) | 向当前曲线添加新段。 |
| [addSegment(Curve curve, boolean sameDirection)](#addSegment-com.aspose.threed.Curve-boolean-) | 向当前曲线添加新段。 |
...
[CompositeCurve](../../com.aspose.threed/compositecurve) 的构造函数
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | 要添加的曲线 |
...
**Returns:**
java.util.ArrayList<com.aspose.threed.CompositeCurve.Segment> - 曲线的段。
### hashCode() {#hashCode--}
```

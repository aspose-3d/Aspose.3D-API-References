...
type: docs
weight: 278
url: /zh/java/com.aspose.threed/extrapolationtype/
---
...
| 字段 | 描述 |
| --- | --- |
| [CONSTANT](#CONSTANT) | 值将保持上一个值的相同数值 |
| [CYCLE](#CYCLE) | 重复。 |
| [CYCLE_RELATIVE](#CYCLE-RELATIVE) | 根据上一个值重复先前的模式 |
| [GRADIENT](#GRADIENT) | 值将随时间保持相同的斜率 |
| [OSCILLATE](#OSCILLATE) | 镜像重复。 |
## 方法

...
description: "Google Draco 格式示例          以下代码展示了如何对 Mesh 进行编码和解码为/从字节数组。"
type: docs
weight: 46
url: /zh/java/com.aspose.threed/dracoformat/
---
...
Google Draco 格式 **示例：** 以下代码展示了如何将 Mesh 编码和解码为/从字节数组：
...
| [decode(byte[] data)](#decode-byte---) | 从内存数据解码点云或网格 |
| [decode(String fileName)](#decode-java.lang.String-) | 从指定的文件名解码点云或网格 |
...
| [encode(Entity entity)](#encode-com.aspose.threed.Entity-) | 将实体编码为 Draco 原始数据 |
| [encode(Entity entity, DracoSaveOptions options)](#encode-com.aspose.threed.Entity-com.aspose.threed.DracoSaveOptions-) | 将实体编码为 Draco 原始数据 |
| [encode(Entity entity, Stream stream)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-) | 将实体编码到指定流 |
| [encode(Entity entity, Stream stream, DracoSaveOptions options)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-com.aspose.threed.DracoSaveOptions-) | 将实体编码到指定流 |
| [encode(Entity entity, String fileName)](#encode-com.aspose.threed.Entity-java.lang.String-) | 将实体编码到指定文件 |
| [encode(Entity entity, String fileName, DracoSaveOptions options)](#encode-com.aspose.threed.Entity-java.lang.String-com.aspose.threed.DracoSaveOptions-) | 将实体编码到指定文件 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 文件名 | java.lang.String | 文件名包含 drc 文件 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | 待编码的实体 |

**Returns:**
byte[] - 以字节表示的已编码 draco 数据 **Example:** 以下代码展示了如何对 Mesh 进行编码和解码为/从字节数组：
...
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | 待编码的实体 |
| options | [DracoSaveOptions](../../com.aspose.threed/dracosaveoptions) | 编码点云的额外选项 |
...
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | 待编码的实体 |
| stream | [Stream](../../com.aspose.threed/stream) | 已编码数据将写入的流 |

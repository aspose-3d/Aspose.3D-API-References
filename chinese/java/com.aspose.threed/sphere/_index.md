...
type: docs
weight: 174
url: /zh/java/com.aspose.threed/sphere/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [Sphere()](#Sphere--) | 使用默认半径 1 初始化 [Sphere](../../com.aspose.threed/sphere) 的新实例。 |
| [Sphere(double radius)](#Sphere-double-) | 使用指定半径初始化 [Sphere](../../com.aspose.threed/sphere) 类的新实例。 |
| [Sphere(double radius, int widthSegments, int heightSegments)](#Sphere-double-int-int-) | 使用指定的半径、宽度段和高度段初始化 [Sphere](../../com.aspose.threed/sphere) 类的新实例。 |
| [Sphere(String name, double radius, int widthSegments, int heightSegments, double phiStart, double phiLength, double thetaStart, double thetaLength)](#Sphere-java.lang.String-double-int-int-double-double-double-double-) | 初始化 [Sphere](../../com.aspose.threed/sphere) 类的新实例。 |
## 方法
...
| [setPhiLength(double value)](#setPhiLength-double-) | 设置 phi 的长度。 |
| [setPhiStart(double value)](#setPhiStart-double-) | 设置 phi 起始。 |
| [setProperty(String property, Object value)](#setProperty-java.lang.String-java.lang.Object-) | 设置指定属性的值 |
| [setRadius(double value)](#setRadius-double-) | 设置球体的半径。 |
...
使用默认半径 1 初始化 [Sphere](../../com.aspose.threed/sphere) 的新实例。
...
使用指定半径初始化 [Sphere](../../com.aspose.threed/sphere) 类的新实例。
...
使用指定的半径、宽度段和高度段初始化 [Sphere](../../com.aspose.threed/sphere) 类的新实例。
...
初始化 [Sphere](../../com.aspose.threed/sphere) 类的新实例。

...
description: "由参数定义的 IFC 兼容椭圆形状。"
type: docs
weight: 50
url: /zh/java/com.aspose.threed/ellipseshape/
---
...
由参数定义的符合 IFC 标准的椭圆形状。轮廓的中心位置位于包围盒的中心。
## 构造函数
...
| [getSemiAxis1()](#getSemiAxis1--) | 获取椭圆在 x 轴方向测量的第一半径。 |
| [getSemiAxis2()](#getSemiAxis2--) | 获取椭圆在 y 轴方向测量的第二半径。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setSemiAxis1(double value)](#setSemiAxis1-double-) | 设置椭圆在 x 轴方向测量的第一半径。 |
| [setSemiAxis2(double value)](#setSemiAxis2-double-) | 设置椭圆在 y 轴方向测量的第二半径。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |

...
description: "定义映射信息的存储和引用方式。"
type: docs
weight: 296
url: /zh/java/com.aspose.threed/referencemode/
---
...
| 字段 | 描述 |
| --- | --- |
| [DIRECT](#DIRECT) | 数据被直接引用 |
| [INDEX](#INDEX) | 数据通过索引引用 |
| [INDEX_TO_DIRECT](#INDEX-TO-DIRECT) | 数据通过索引引用，然后在 [VertexElement](../../com.aspose.threed/vertexelement) 的数据列表中通过索引访问。 |
## 方法
...
数据通过索引引用，然后在 [VertexElement](../../com.aspose.threed/vertexelement) 的数据列表中通过索引访问。

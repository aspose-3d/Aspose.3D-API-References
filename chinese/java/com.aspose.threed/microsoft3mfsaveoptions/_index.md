...
description: "Microsoft 3MF 文件的保存选项。"
type: docs
weight: 105
url: /zh/java/com.aspose.threed/microsoft3mfsaveoptions/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [Microsoft3MFSaveOptions()](#Microsoft3MFSaveOptions--) | 构造一个 [Microsoft3MFSaveOptions](../../com.aspose.threed/microsoft3mfsaveoptions) |
## 方法

| 方法 | 描述 |
| --- | --- |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getBuildAll()](#getBuildAll--) | 将场景中的所有几何体标记为可打印。 |
| [getClass()](#getClass--) |  |
| [getEnableCompression()](#getEnableCompression--) | 在输出的 3mf 文件上启用压缩，默认值为 true。 |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBuildAll(boolean value)](#setBuildAll-boolean-) | 将场景中的所有几何体标记为可打印。 |
| [setEnableCompression(boolean value)](#setEnableCompression-boolean-) | 在输出的 3mf 文件上启用压缩，默认值为 true。 |
...
构造一个 [Microsoft3MFSaveOptions](../../com.aspose.threed/microsoft3mfsaveoptions)
...
将场景中的所有几何体标记为可打印。或者您可以通过 [Microsoft3MFFormat](../../com.aspose.threed/microsoft3mfformat) 手动将节点标记为可打印，默认值为 true。

**Returns:**
boolean - 将场景中的所有几何体标记为可打印。或者您可以通过 [Microsoft3MFFormat](../../com.aspose.threed/microsoft3mfformat) 手动将节点标记为可打印，默认值为 true。
### getClass() {#getClass--}
```
...
在输出的 3mf 文件上启用压缩，默认值为 true。

**Returns:**
boolean - 在输出的 3mf 文件上启用压缩，默认值为 true。

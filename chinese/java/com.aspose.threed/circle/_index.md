...
description: "曲线由一组位于圆形边缘的点组成。"
type: docs
weight: 31
url: /zh/java/com.aspose.threed/circle/
---
...
一个 [Circle](../../com.aspose.threed/circle) 曲线由一组位于圆形边缘的点组成。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [Circle()](#Circle--) | 构造函数 [Circle](../../com.aspose.threed/circle) |
| [Circle(double radius)](#Circle-double-) | 构造函数 [Circle](../../com.aspose.threed/circle) |
## 方法
...
| [getRadius()](#getRadius--) | 圆曲线的半径，默认值为 10 |
...
| [setRadius(double value)](#setRadius-double-) | 圆曲线的半径，默认值为 10 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
构造函数 [Circle](../../com.aspose.threed/circle)

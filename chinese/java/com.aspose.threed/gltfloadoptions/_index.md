...
type: docs
weight: 73
url: /zh/java/com.aspose.threed/gltfloadoptions/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [GltfLoadOptions()](#GltfLoadOptions--) | [GltfLoadOptions](../../com.aspose.threed/gltfloadoptions) 的构造函数 |
## 方法
...
| [getFlipTexCoordV()](#getFlipTexCoordV--) | 翻转网格纹理坐标中的 v(t) 坐标，默认值为 true。 |
...
| [setFlipTexCoordV(boolean value)](#setFlipTexCoordV-boolean-) | 翻转网格纹理坐标中的 v(t) 坐标，默认值为 true。 |
...
[GltfLoadOptions](../../com.aspose.threed/gltfloadoptions) 的构造函数
...
**Returns:**
boolean - 翻转网格纹理坐标中的 v(t) 坐标，默认值为 true。

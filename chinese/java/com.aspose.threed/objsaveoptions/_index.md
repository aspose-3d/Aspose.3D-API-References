...
description: "Wavefront OBJ 文件的保存选项"
type: docs
weight: 116
url: /zh/java/com.aspose.threed/objsaveoptions/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [ObjSaveOptions()](#ObjSaveOptions--) | [ObjSaveOptions](../../com.aspose.threed/objsaveoptions) 的构造函数 |
## 方法
...
| [getAxisSystem()](#getAxisSystem--) | 获取导出文件中的坐标系。 |
| [getClass()](#getClass--) |  |
| [getEnableMaterials()](#getEnableMaterials--) | 获取是否为每个对象导入/导出材质。 |
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | 获取在导入/导出期间是否翻转控制点/法线的坐标系。 |
| [getLookupPaths()](#getLookupPaths--) | 某些文件（如 OBJ）依赖外部文件，查找路径将允许 Aspose.3D 查找并加载外部文件。 |
| [getPointCloud()](#getPointCloud--) | 获取导出器是否应将场景导出为点云（无拓扑结构）的标志，默认值为 false。 |
| [getSerializeW()](#getSerializeW--) | 获取是否在模型的顶点位置中序列化 W 分量。 |
| [getVerbose()](#getVerbose--) | 获取是否为每个部分生成注释。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setAxisSystem(AxisSystem value)](#setAxisSystem-com.aspose.threed.AxisSystem-) | 设置导出文件中的坐标系。 |
| [setEnableMaterials(boolean value)](#setEnableMaterials-boolean-) | 设置是否为每个对象导入/导出材质。 |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | 设置在导入/导出期间是否翻转控制点/法线的坐标系。 |
...
| [setPointCloud(boolean value)](#setPointCloud-boolean-) | 设置导出器是否应将场景导出为点云（无拓扑结构）的标志，默认值为 false。 |
| [setSerializeW(boolean value)](#setSerializeW-boolean-) | 设置是否在模型的顶点位置序列化 W 分量。 |
| [setVerbose(boolean value)](#setVerbose-boolean-) | 设置是否为每个部分生成注释 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[ObjSaveOptions](../../com.aspose.threed/objsaveoptions) 的构造函数
...
获取在导入/导出期间是否翻转控制点/法线的坐标系。

**Returns:**
boolean - 是否在导入/导出期间翻转控制点/法线的坐标系。
...
获取导出器是否应将场景导出为点云（无拓扑结构）的标志，默认值为 false。

**Returns:**
布尔 - 标志位，指示导出器是否应将场景导出为点云（无拓扑结构），默认值为 false
...
获取是否在模型的顶点位置中序列化 W 分量。

**Returns:**
布尔 - 是否在模型的顶点位置序列化 W 分量。
...
设置导出器是否应将场景导出为点云（无拓扑结构）的标志，默认值为 false。

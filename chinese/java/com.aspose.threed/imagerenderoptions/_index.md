...
description: "用于 和 的选项"
type: docs
weight: 83
url: /zh/java/com.aspose.threed/imagerenderoptions/
---
...
用于 [Scene](../../com.aspose.threed/scene) 和 [Scene](../../com.aspose.threed/scene) 的选项
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [ImageRenderOptions()](#ImageRenderOptions--) | 初始化 [ImageRenderOptions](../../com.aspose.threed/imagerenderoptions) 的实例 |
## 方法
...
| [getAssetDirectories()](#getAssetDirectories--) | 存储外部资源（如纹理）的目录 |
| [getBackgroundColor()](#getBackgroundColor--) | 渲染结果的背景颜色。 |
| [getClass()](#getClass--) |  |
| [getEnableShadows()](#getEnableShadows--) | 获取是否渲染阴影。 |
...
| [setAssetDirectories(ArrayList<String> value)](#setAssetDirectories-java.util.ArrayList-java.lang.String--) | 存储外部资源（如纹理）的目录 |
| [setBackgroundColor(Vector3 value)](#setBackgroundColor-com.aspose.threed.Vector3-) | 渲染结果的背景颜色。 |
| [setEnableShadows(boolean value)](#setEnableShadows-boolean-) | 设置是否渲染阴影。 |
...
初始化 [ImageRenderOptions](../../com.aspose.threed/imagerenderoptions) 的实例
...
**Returns:**
java.util.ArrayList<java.lang.String> - 存储外部资源（如纹理）的目录
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 值 | java.util.ArrayList<java.lang.String> | 新值 |

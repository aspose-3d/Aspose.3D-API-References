...
type: docs
weight: 271
url: /zh/java/com.aspose.threed/comparefunction/
---
...
| --- | --- |
| [ALWAYS](#ALWAYS) | 始终通过 |
| [EQUAL](#EQUAL) | 如果传入的值等于存储的值，则通过。 |
| [GREATER](#GREATER) | 如果传入的值大于存储的值，则通过。 |
| [G_EQUAL](#G-EQUAL) | 如果传入的值大于或等于存储的值，则通过。 |
| [LESS](#LESS) | 如果传入的值小于存储的值，则通过。 |
| [L_EQUAL](#L-EQUAL) | 如果传入的值小于或等于存储的值，则通过。 |
| [NEVER](#NEVER) | 永不通过 |
| [NOT_EQUAL](#NOT-EQUAL) | 如果传入的值不等于存储的值，则通过。 |
## 方法

...
description: "在子网格之间共享顶点/控制点数据，或每个子网格拥有各自的压缩数据。"
type: docs
weight: 302
url: /zh/java/com.aspose.threed/splitmeshpolicy/
---
...
在子网格之间共享顶点/控制点数据，或每个子网格拥有各自的压缩数据。
## 字段

| 字段 | 描述 |
| --- | --- |
| [CLONE_DATA](#CLONE-DATA) | 控制点和顶点元素数据将被克隆 |
| [COMPACT_DATA](#COMPACT-DATA) | 仅使用的控制点和顶点元素数据将被复制到子网格 |
## 方法

...
type: docs
weight: 176
url: /zh/java/com.aspose.threed/stlloadoptions/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [StlLoadOptions()](#StlLoadOptions--) | 初始化一个新的 [StlLoadOptions](../../com.aspose.threed/stlloadoptions) 实例。 |
| [StlLoadOptions(FileContentType contentType)](#StlLoadOptions-com.aspose.threed.FileContentType-) | 初始化一个新的 [StlLoadOptions](../../com.aspose.threed/stlloadoptions) 实例。 |
## 方法
...
| [getRecalculateNormal()](#getRecalculateNormal--) | 忽略 STL 文件中存储的法线数据，并根据顶点位置重新计算法线数据。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setRecalculateNormal(boolean value)](#setRecalculateNormal-boolean-) | 忽略 STL 文件中存储的法线数据，并根据顶点位置重新计算法线数据。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
初始化一个新的 [StlLoadOptions](../../com.aspose.threed/stlloadoptions) 实例。
...
忽略 STL 文件中存储的法线数据，并根据顶点位置重新计算法线数据。默认值为 false。

**Returns:**
boolean - 忽略 STL 文件中存储的法线数据，并根据顶点位置重新计算法线数据。默认值为 false。
### hashCode() {#hashCode--}
```

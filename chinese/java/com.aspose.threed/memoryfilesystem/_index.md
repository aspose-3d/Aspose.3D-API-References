...
description: "该功能将把读/写操作映射到内存。"
type: docs
weight: 95
url: /zh/java/com.aspose.threed/memoryfilesystem/
---
...
该 [MemoryFileSystem](../../com.aspose.threed/memoryfilesystem) 将把读/写操作映射到内存。 **Example:** 以下代码展示了如何将文件导出到内存，并通过使用 MemoryFileSystem 包含依赖文件。
...
| [getClass()](#getClass--) |  |
| [getFileContent(String fileName)](#getFileContent-java.lang.String-) | 返回指定文件的原始内容。 |
| [getFileNames()](#getFileNames--) | 此内存文件系统中的文件名。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |

...
description: "折线是一条由一组点定义的路径，使用  并通过   连接，这意味着它也可以是一组相连的线段。"
type: docs
weight: 95
url: /zh/java/com.aspose.threed/line/
---
...
折线是一条由一组点定义的路径，使用 [Geometry.getControlPoints](../../com.aspose.threed/geometry\#getControlPoints) 并通过 [getSegments](../../com.aspose.threed/line\#getSegments) 连接，这意味着它也可以是一组相连的线段。该线通常是线性对象，这意味着它不能用于表示曲线，若要表示曲线，请使用 [NurbsCurve](../../com.aspose.threed/nurbscurve)。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [Line()](#Line--) | 初始化 [Line](../../com.aspose.threed/line) 类的新实例。 |
| [Line(String name)](#Line-java.lang.String-) | 初始化 [Line](../../com.aspose.threed/line) 类的新实例。 |
## 方法
...
| [fromPoints(Vector3[] points)](#fromPoints-com.aspose.threed.Vector3...-) | 从一组点构造 [Line](../../com.aspose.threed/line) 实例。 |
...
| [getSegments()](#getSegments--) | 获取线段 |
| [getVisible()](#getVisible--) | 获取几何体是否可见 |
| [hashCode()](#hashCode--) |  |
| [makeDefaultIndices()](#makeDefaultIndices--) | 生成序列 0,1,2,3....[Geometry.getControlPoints](../../com.aspose.threed/geometry\#getControlPoints).Length-1 以调用 [getSegments](../../com.aspose.threed/line\#getSegments)，使 ControlPoints 可用作单条线。 |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
初始化 [Line](../../com.aspose.threed/line) 类的新实例。
...
从一组点构造 [Line](../../com.aspose.threed/line) 实例。
...
生成序列 0,1,2,3....[Geometry.getControlPoints](../../com.aspose.threed/geometry\#getControlPoints).Length-1 以调用 [getSegments](../../com.aspose.threed/line\#getSegments)，使 ControlPoints 可用作单条线。

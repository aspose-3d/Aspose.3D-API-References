...
description: "在两端修剪基曲线的有界曲线。"
type: docs
weight: 196
url: /zh/java/com.aspose.threed/trimmedcurve/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [TrimmedCurve()](#TrimmedCurve--) | [TrimmedCurve](../../com.aspose.threed/trimmedcurve) 的构造函数 |
## 方法
...
| [getBasisCurve()](#getBasisCurve--) | 要被修剪的基准曲线。 |
...
| [getFirst()](#getFirst--) | 要修剪的第一个端点，可以是笛卡尔点或实数参数。 |
...
| [getSameDirection()](#getSameDirection--) | 获取修剪结果是否使用基曲线的相同方向。 |
| [getScene()](#getScene--) | 获取此对象所属的场景 |
| [getSecond()](#getSecond--) | 要修剪的第二个端点，可以是笛卡尔点或实数参数。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setBasisCurve(Curve value)](#setBasisCurve-com.aspose.threed.Curve-) | 要被修剪的基准曲线。 |
...
| [setFirst(EndPoint value)](#setFirst-com.aspose.threed.EndPoint-) | 要修剪的第一个端点，可以是笛卡尔点或实数参数。 |
...
| [setSameDirection(boolean value)](#setSameDirection-boolean-) | 设置修剪结果是否使用基曲线的相同方向。 |
| [setSecond(EndPoint value)](#setSecond-com.aspose.threed.EndPoint-) | 要修剪的第二个端点，可以是笛卡尔点或实数参数。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[TrimmedCurve](../../com.aspose.threed/trimmedcurve) 的构造函数
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | [EndPoint](../../com.aspose.threed/endpoint) | 新值 |

...
description: "通过参数定义的 IFC 兼容 T 形状。"
type: docs
weight: 182
url: /zh/java/com.aspose.threed/tshape/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [TShape()](#TShape--) | 构造函数 [TShape](../../com.aspose.threed/tshape) |
## 方法
...
| [getFilletRadius()](#getFilletRadius--) | 获取 web 与法兰之间圆角的半径。 |
| [getFlangeEdgeRadius()](#getFlangeEdgeRadius--) | 获取法兰边缘的半径。 |
| [getFlangeThickness()](#getFlangeThickness--) | 获取法兰的壁厚。 |
...
| [getWebEdgeRadius()](#getWebEdgeRadius--) | 获取 web 边缘的半径。 |
| [getWebThickness()](#getWebThickness--) | 获取 web 的壁厚。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFilletRadius(double value)](#setFilletRadius-double-) | 设置 web 与法兰之间圆角的半径。 |
| [setFlangeEdgeRadius(double value)](#setFlangeEdgeRadius-double-) | 设置法兰边缘的半径。 |
| [setFlangeThickness(double value)](#setFlangeThickness-double-) | 设置法兰的壁厚。 |
...
| [setWebEdgeRadius(double value)](#setWebEdgeRadius-double-) | 设置 web 边缘的半径。 |
| [setWebThickness(double value)](#setWebThickness-double-) | 设置 web 的壁厚。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
构造函数 [TShape](../../com.aspose.threed/tshape)

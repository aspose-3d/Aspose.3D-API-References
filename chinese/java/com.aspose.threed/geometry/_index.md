...
description: "所有可渲染几何对象的基类，例如    等等。"
type: docs
weight: 71
url: /zh/java/com.aspose.threed/geometry/
---
...
所有可渲染几何对象的基类（如 [Mesh](../../com.aspose.threed/mesh)、[NurbsSurface](../../com.aspose.threed/nurbssurface)、[Patch](../../com.aspose.threed/patch) 等）。

[Geometry](../../com.aspose.threed/geometry) 基类支持：
...
| 构造函数 | 描述 |
| --- | --- |
| [Geometry(String name)](#Geometry-java.lang.String-) | 初始化 [Geometry](../../com.aspose.threed/geometry) 类的新实例。 |
## 方法
...
初始化 [Geometry](../../com.aspose.threed/geometry) 类的新实例。

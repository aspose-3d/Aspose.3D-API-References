...
type: docs
weight: 263
url: /zh/java/com.aspose.threed/alphasource/
---
...
| 字段 | 描述 |
| --- | --- |
| [FIXED_VALUE](#FIXED-VALUE) | Alpha 是由 [TextureBase.getAlpha](../../com.aspose.threed/texturebase\#getAlpha) 定义的固定值。 |
| [NONE](#NONE) | 纹理中未定义 alpha。 |
| [PIXEL_ALPHA](#PIXEL-ALPHA) | Alpha 由像素的 Alpha 通道定义 |
## 方法
...
Alpha 是由 [TextureBase.getAlpha](../../com.aspose.threed/texturebase\#getAlpha) 定义的固定值。

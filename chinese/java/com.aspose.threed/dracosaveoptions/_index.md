...
description: "Google draco 文件的保存选项。"
type: docs
weight: 47
url: /zh/java/com.aspose.threed/dracosaveoptions/
---
...
| [getClass()](#getClass--) |  |
| [getColorBits()](#getColorBits--) | 顶点颜色的量化位数，默认值为 10 |
| [getCompressionLevel()](#getCompressionLevel--) | 压缩级别，默认值为 [DracoCompressionLevel.STANDARD](../../com.aspose.threed/dracocompressionlevel\#STANDARD) |
...
| [getNormalBits()](#getNormalBits--) | 法线向量的量化位数，默认值为 10 |
| [getPointCloud()](#getPointCloud--) | 将场景导出为点云，默认值为 false。 |
| [getPositionBits()](#getPositionBits--) | 位置的量化位数，默认值为 14 |
| [getTextureCoordinateBits()](#getTextureCoordinateBits--) | 纹理坐标的量化位数，默认值为 12 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setColorBits(int value)](#setColorBits-int-) | 顶点颜色的量化位数，默认值为 10 |
| [setCompressionLevel(DracoCompressionLevel value)](#setCompressionLevel-com.aspose.threed.DracoCompressionLevel-) | 压缩级别，默认值为 [DracoCompressionLevel.STANDARD](../../com.aspose.threed/dracocompressionlevel\#STANDARD) |
...
| [setNormalBits(int value)](#setNormalBits-int-) | 法线向量的量化位数，默认值为 10 |
| [setPointCloud(boolean value)](#setPointCloud-boolean-) | 将场景导出为点云，默认值为 false。 |
| [setPositionBits(int value)](#setPositionBits-int-) | 位置的量化位数，默认值为 14 |
| [setTextureCoordinateBits(int value)](#setTextureCoordinateBits-int-) | 纹理坐标的量化位数，默认值为 12 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
压缩级别，默认值为 [DracoCompressionLevel.STANDARD](../../com.aspose.threed/dracocompressionlevel\#STANDARD)
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | [DracoCompressionLevel](../../com.aspose.threed/dracocompressionlevel) | 新值 |

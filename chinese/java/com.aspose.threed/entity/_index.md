...
type: docs
weight: 52
url: /zh/java/com.aspose.threed/entity/
---
...
所有实体的基类。Entity 表示附加在节点下的具体对象，如 [Light](../../com.aspose.threed/light) / [Geometry](../../com.aspose.threed/geometry)。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [Entity(String name)](#Entity-java.lang.String-) | 初始化 [Entity](../../com.aspose.threed/entity) 类的新实例。 |
## 方法
...
初始化 [Entity](../../com.aspose.threed/entity) 类的新实例。

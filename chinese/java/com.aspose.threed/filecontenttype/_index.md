...
type: docs
weight: 279
url: /zh/java/com.aspose.threed/filecontenttype/
---
...
| 字段 | 描述 |
| --- | --- |
| [ASCII](#ASCII) | ASCII 格式类型，例如 ASCII FBX、ASCII STL |
| [BINARY](#BINARY) | 二进制格式类型，例如 binary FBX、binary STL |
## 方法
...
ASCII 格式类型，例如 ASCII FBX、ASCII STL
...
二进制格式类型，例如 binary FBX、binary STL

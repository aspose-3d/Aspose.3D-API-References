...
type: docs
weight: 62
url: /zh/java/com.aspose.threed/fbxloadoptions/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [FbxLoadOptions(FileFormat format)](#FbxLoadOptions-com.aspose.threed.FileFormat-) | 构造函数 [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions) |
| [FbxLoadOptions()](#FbxLoadOptions--) | 构造函数 [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions) |
## 方法
...
| [getClass()](#getClass--) |  |
| [getCompatibleMode()](#getCompatibleMode--) | 获取是否启用兼容模式。 |
...
| [getKeepBuiltinGlobalSettings()](#getKeepBuiltinGlobalSettings--) | 获取是否保留在 GlobalSettings 中具有原生属性替换的内置属性，这些属性在 [AssetInfo](../../com.aspose.threed/assetinfo) 中。 |
| [getLookupPaths()](#getLookupPaths--) | 某些文件（如 OBJ）依赖外部文件，查找路径将允许 Aspose.3D 查找并加载外部文件。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setCompatibleMode(boolean value)](#setCompatibleMode-boolean-) | 设置是否启用兼容模式。 |
...
| [setKeepBuiltinGlobalSettings(boolean value)](#setKeepBuiltinGlobalSettings-boolean-) | 设置是否保留在 GlobalSettings 中具有原生属性替换的内置属性，这些属性在 [AssetInfo](../../com.aspose.threed/assetinfo) 中。 |
...
构造函数 [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions)

**Parameters:**
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| format | [FileFormat](../../com.aspose.threed/fileformat) | [getFileFormat](../../com.aspose.threed/fbxloadoptions\#getFileFormat) 的实例，它应该是有效的 FBX 格式。 |
...
获取是否启用兼容模式。兼容模式将尝试支持非标准的 FBX 定义，例如 Blender 导出的 PBR 材质。默认值为 false。

**Returns:**
布尔值 - 是否启用兼容模式。兼容模式将尝试支持非标准的 FBX 定义，例如 Blender 导出的 PBR 材质。默认值为 false。
...
获取是否保留在 GlobalSettings 中具有原生属性替换的内置属性，这些属性在 [AssetInfo](../../com.aspose.threed/assetinfo) 中。如果希望在 GlobalSettings 中拥有完整属性，请将其设为 true。默认值为 false。

**Returns:**
布尔值 - 是否保留在 GlobalSettings 中具有原生属性替换的内置属性，这些属性在 [AssetInfo](../../com.aspose.threed/assetinfo) 中。如果希望在 GlobalSettings 中拥有完整属性，请将其设为 true。默认值为 false。
...
设置是否启用兼容模式。兼容模式将尝试支持非标准的 FBX 定义，例如 Blender 导出的 PBR 材质。默认值为 false。
...
设置是否保留在 GlobalSettings 中具有原生属性替换的内置属性，这些属性在 [AssetInfo](../../com.aspose.threed/assetinfo) 中。如果希望在 GlobalSettings 中拥有完整属性，请将其设为 true。默认值为 false。

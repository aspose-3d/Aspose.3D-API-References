...
description: "平滑组是多边形网格中的一组多边形，应该呈现出平滑表面。"
type: docs
weight: 216
url: /zh/java/com.aspose.threed/vertexelementsmoothinggroup/
---
...
平滑组是多边形网格中的一组多边形，应该看起来形成光滑的表面。一些早期的 3D 建模软件，如 DOS 版 3D Studio Max，使用平滑组来避免为每个网格顶点存储法线向量。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [VertexElementSmoothingGroup()](#VertexElementSmoothingGroup--) | 初始化 [VertexElementSmoothingGroup](../../com.aspose.threed/vertexelementsmoothinggroup) 类的新实例。 |
## 方法
...
初始化 [VertexElementSmoothingGroup](../../com.aspose.threed/vertexelementsmoothinggroup) 类的新实例。

...
description: "兼容 IFC 的圆形轮廓，可用于通过以下方式构建网格"
type: docs
weight: 32
url: /zh/java/com.aspose.threed/circleshape/
---
...
兼容 IFC 的圆形轮廓，可用于通过 [LinearExtrusion](../../com.aspose.threed/linearextrusion) 构建网格。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [CircleShape()](#CircleShape--) | 构造一个具有默认半径 (5) 的 [CircleShape](../../com.aspose.threed/circleshape) 轮廓。 |
| [CircleShape(double radius)](#CircleShape-double-) | 构造一个具有指定半径的 [CircleShape](../../com.aspose.threed/circleshape) 轮廓。 |
## 方法
...
| [setRadius(double value)](#setRadius-double-) | 设置圆的半径。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
构造一个具有默认半径 (5) 的 [CircleShape](../../com.aspose.threed/circleshape) 轮廓。
...
构造一个具有指定半径的 [CircleShape](../../com.aspose.threed/circleshape) 轮廓。

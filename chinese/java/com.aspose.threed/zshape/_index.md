...
description: "由参数定义的兼容 IFC 的 Z 形截面。"
type: docs
weight: 234
url: /zh/java/com.aspose.threed/zshape/
---
...
由参数定义的兼容 IFC 的 Z 形截面。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [ZShape()](#ZShape--) | 构造函数 [ZShape](../../com.aspose.threed/zshape) |
## 方法
...
| [getWebThickness()](#getWebThickness--) | 获取壁的厚度。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setWebThickness(double value)](#setWebThickness-double-) | 设置壁的厚度。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
构造函数 [ZShape](../../com.aspose.threed/zshape)

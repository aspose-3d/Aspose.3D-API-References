...
description: "PDF 加载选项"
type: docs
weight: 124
url: /zh/java/com.aspose.threed/pdfloadoptions/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [PdfLoadOptions()](#PdfLoadOptions--) | [PdfLoadOptions](../../com.aspose.threed/pdfloadoptions) 的构造函数 |
## 方法
...
| [getPassword()](#getPassword--) | 用于解锁加密 PDF 文件的密码。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setPassword(byte[] value)](#setPassword-byte---) | 用于解锁加密 PDF 文件的密码。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[PdfLoadOptions](../../com.aspose.threed/pdfloadoptions) 的构造函数

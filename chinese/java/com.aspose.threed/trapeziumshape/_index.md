...
description: "通过参数定义的 IFC 兼容梯形形状。"
type: docs
weight: 193
url: /zh/java/com.aspose.threed/trapeziumshape/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [TrapeziumShape()](#TrapeziumShape--) | [TrapeziumShape](../../com.aspose.threed/trapeziumshape) 的构造函数 |
## 方法
...
| [getBottomXDim()](#getBottomXDim--) | 获取沿 x 轴测量的底线长度。 |
...
| [getTopXDim()](#getTopXDim--) | 获取沿 x 轴测量的顶线长度。 |
| [getTopXOffset()](#getTopXOffset--) | 获取从顶线起点到底线的偏移量。 |
| [getYDim()](#getYDim--) | 获取沿 y 轴测量的顶线与底线之间的距离。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setBottomXDim(double value)](#setBottomXDim-double-) | 设置沿 x 轴测量的底线长度。 |
...
| [setTopXDim(double value)](#setTopXDim-double-) | 设置沿 x 轴测量的顶线长度。 |
| [setTopXOffset(double value)](#setTopXOffset-double-) | 设置从顶线起点到底线的偏移量。 |
| [setYDim(double value)](#setYDim-double-) | 设置沿 y 轴测量的顶线与底线之间的距离。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[TrapeziumShape](../../com.aspose.threed/trapeziumshape) 的构造函数
...
获取沿 y 轴测量的顶线与底线之间的距离。

**Returns:**
double - 沿 y 轴测量的顶线与底线之间的距离。
### hashCode() {#hashCode--}
```

...
description: "该形状描述了一组控制点上的变形，类似于 Maya 中的集群变形器。"
type: docs
weight: 171
url: /zh/java/com.aspose.threed/shape/
---
...
该形状描述了一组控制点上的变形，类似于 Maya 中的集群变形器。例如，我们可以向已创建的几何体添加一个形状。该形状与几何体具有相同的拓扑信息，但控制点的位置不同。通过不同程度的影响，几何体实现变形效果。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [Shape()](#Shape--) | 初始化 [Shape](../../com.aspose.threed/shape) 类的新实例。 |
| [Shape(String name)](#Shape-java.lang.String-) | 初始化 [Shape](../../com.aspose.threed/shape) 类的新实例。 |
## 方法
...
| [fromControlPoints(Vector3[] controlPoints)](#fromControlPoints-com.aspose.threed.Vector3...-) | 使用指定的控制点和默认索引创建一个形状。 |
...
初始化 [Shape](../../com.aspose.threed/shape) 类的新实例。
...
**Returns:**
java.util.List<java.lang.Integer> - 索引。
### getName() {#getName--}
```

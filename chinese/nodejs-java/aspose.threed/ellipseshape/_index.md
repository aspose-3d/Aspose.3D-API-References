...
url: /zh/nodejs-java/aspose.threed/ellipseshape/
---
## EllipseShape class

IFC 兼容的椭圆形状，由参数定义。轮廓的中心位置位于包围盒的中心。
...
| 名称 | 描述 |
| --- | --- |
| getSemiAxis1() | 获取或设置椭圆的第一半径（沿 x 轴方向测量）。 |
...
| 名称 | 描述 |
| --- | --- |
| setSemiAxis1(value) | 获取或设置椭圆的第一半径（沿 x 轴方向测量）。 |
...
| 名称 | 描述 |
| --- | --- |
| getSemiAxis2() | 获取或设置椭圆在 y 轴方向测量的第二个半径。 |
...
| 名称 | 描述 |
| --- | --- |
| setSemiAxis2(value) | 获取或设置椭圆在 y 轴方向测量的第二个半径。 |

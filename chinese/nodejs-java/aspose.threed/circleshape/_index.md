...
url: /zh/nodejs-java/aspose.threed/circleshape/
---
## CircleShape class

IFC 兼容的圆形轮廓，可用于通过 LinearExtrusion 构建网格。
...
| 名称 | 描述 |
| --- | --- |
| constructor() | 使用默认半径 (5) 构造 CircleShape 轮廓。 |
...
| 名称 | 描述 |
| --- | --- |
| constructor_overload(radius) | 使用指定半径构造 CircleShape 轮廓。 |

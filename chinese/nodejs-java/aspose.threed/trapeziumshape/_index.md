...
url: /zh/nodejs-java/aspose.threed/trapeziumshape/
---
...
| 名称 | 描述 |
| --- | --- |
| constructor() | TrapeziumShape 的构造函数 |
...
| 名称 | 描述 |
| --- | --- |
| getBottomXDim() | 获取或设置沿 x 轴测量的底线长度。 |
...
| 名称 | 描述 |
| --- | --- |
| setBottomXDim(value) | 获取或设置沿 x 轴测量的底线长度。 |
...
| 名称 | 描述 |
| --- | --- |
| getTopXDim() | 获取或设置沿 x 轴测量的顶部线的范围。 |
...
| 名称 | 描述 |
| --- | --- |
| setTopXDim(value) | 获取或设置沿 x 轴测量的顶部线的范围。 |
...
| 名称 | 描述 |
| --- | --- |
| getYDim() | 获取或设置沿 y 轴测量的顶部线和底部线之间的距离。 |
...
| 名称 | 描述 |
| --- | --- |
| setYDim(value) | 获取或设置沿 y 轴测量的顶部线和底部线之间的距离。 |
...
| 名称 | 描述 |
| --- | --- |
| getTopXOffset() | 获取或设置从顶部线起点到底部线的偏移量。 |
...
| 名称 | 描述 |
| --- | --- |
| setTopXOffset(value) | 获取或设置从顶部线起点到底部线的偏移量。 |

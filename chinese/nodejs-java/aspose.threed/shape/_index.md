...
url: /zh/nodejs-java/aspose.threed/shape/
---
## Shape class

形状描述了一组控制点上的变形，类似于 Maya 中的 cluster deformer。例如，我们可以向已创建的几何体添加一个形状。该形状与几何体拥有相同的拓扑信息，但控制点的位置不同。通过不同程度的影响，几何体产生变形效果。
...
| 名称 | 描述 |
| --- | --- |
| constructor_overload(name) | 初始化 Shape 类的新实例。 |
...
| 名称 | 描述 |
| --- | --- |
| fromControlPoints(controlPoints) | 使用指定的控制点创建形状，使用默认索引。 |

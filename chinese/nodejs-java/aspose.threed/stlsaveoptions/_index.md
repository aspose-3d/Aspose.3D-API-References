...
url: /zh/nodejs-java/aspose.threed/stlsaveoptions/
---
...
| 名称 | 描述 |
| --- | --- |
| constructor() | 初始化一个新的 StlSaveOptions 实例。 |
...
| 名称 | 描述 |
| --- | --- |
| constructor_overload(contentType) | 初始化一个新的 StlSaveOptions 实例。 |
...
| 名称 | 描述 |
| --- | --- |
| getFlipCoordinateSystem() | 获取或设置在导出期间是否翻转控制点/法线的坐标系。 |
...
| 名称 | 描述 |
| --- | --- |
| setFlipCoordinateSystem(value) | 获取或设置在导出期间是否翻转控制点/法线的坐标系。 |

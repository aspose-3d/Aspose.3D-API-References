...
url: /zh/nodejs-java/aspose.threed/tshape/
---
## TShape class
...
| 名称 | 描述 |
| --- | --- |
| setFlangeWidth(value) | 获取或设置法兰的长度。 |
...
| 名称 | 描述 |
| --- | --- |
| setWebThickness(value) | 获取或设置腹板的壁厚。 |
...
| 名称 | 描述 |
| --- | --- |
| setFlangeThickness(value) | 获取或设置法兰的壁厚。 |
...
| 名称 | 描述 |
| --- | --- |
| getFilletRadius() | 获取或设置网板与法兰之间圆角的半径。 |
...
| 名称 | 描述 |
| --- | --- |
| setFilletRadius(value) | 获取或设置网板与法兰之间圆角的半径。 |
...
| 名称 | 描述 |
| --- | --- |
| getFlangeEdgeRadius() | 获取或设置法兰边缘的半径。 |
...
| 名称 | 描述 |
| --- | --- |
| setFlangeEdgeRadius(value) | 获取或设置法兰边缘的半径。 |
...
| 名称 | 描述 |
| --- | --- |
| setWebEdgeRadius(value) | 获取或设置网板边缘的半径。 |

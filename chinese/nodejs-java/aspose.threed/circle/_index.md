...
url: /zh/nodejs-java/aspose.threed/circle/
---
## Circle class

Circle 曲线由圆形边缘上的一组点组成。
...
| 名称 | 描述 |
| --- | --- |
| constructor_overload(radius) | Circle 的构造函数 |
...
| 名称 | 描述 |
| --- | --- |
| setRadius(value) | 圆曲线的半径，默认值为 10。 |

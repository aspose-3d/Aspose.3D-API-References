...
url: /zh/nodejs-java/aspose.threed/ellipse/
---
## Ellipse class

Ellipse 定义了一组形成椭圆形状的点。
...
| 名称 | 描述 |
| --- | --- |
| constructor_overload(semiAxis1, semiAxis2) | Ellipse 的构造函数 |

...
url: /zh/nodejs-java/aspose.threed/xloadoptions/
---
## XLoadOptions class
...
| 名称 | 描述 |
| --- | --- |
| constructor(contentType) | XLoadOptions 的构造函数 |
...
| 名称 | 描述 |
| --- | --- |
| getFlipCoordinateSystem() | 翻转坐标系，默认情况下为 true |
...
| 名称 | 描述 |
| --- | --- |
| setFlipCoordinateSystem(value) | 翻转坐标系，默认情况下为 true |

...
url: /zh/nodejs-java/aspose.threed/skeleton/
---
## Skeleton class

Skeleton主要用于CAD软件，帮助设计师操作骨骼结构的变换，在CAD软件之外通常无用。为了使骨骼层级在CAD软件中表现为一个对象，需要通过将Type设置为SkeletonType.SKELETON将顶部Skeleton节点标记为根节点，并将所有子节点设置为SkeletonType.BONE。
...
| 名称 | 描述 |
| --- | --- |
| constructor() | 初始化 Skeleton 类的新实例。 |
...
| 名称 | 描述 |
| --- | --- |
| constructor_overload(name) | 初始化 Skeleton 类的新实例。 |
...
| 名称 | 描述 |
| --- | --- |
| getSize() | 获取或设置在 CAD 软件中用于表示骨骼大小的肢体节点尺寸。 |
...
| 名称 | 描述 |
| --- | --- |
| setSize(value) | 获取或设置在 CAD 软件中用于表示骨骼大小的肢体节点尺寸。 |
...
| 名称 | 描述 |
| --- | --- |
| getType() | 获取或设置骨骼的类型。属性值为 SkeletonType 整数常量。骨骼的类型。 |
...
| 名称 | 描述 |
| --- | --- |
| setType(value) | 获取或设置骨骼的类型。属性值为 SkeletonType 整数常量。骨骼的类型。 |

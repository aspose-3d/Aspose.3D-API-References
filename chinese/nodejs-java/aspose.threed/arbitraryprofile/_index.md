...
url: /zh/nodejs-java/aspose.threed/arbitraryprofile/
---
## ArbitraryProfile class

此类允许您直接从任意曲线构建 2D 轮廓。
...
| 名称 | 描述 |
| --- | --- |
| constructor() | ArbitraryProfile 的构造函数 |
...
| 名称 | 描述 |
| --- | --- |
| constructor_overload(curve) | 带有初始曲线的 ArbitraryProfile 构造函数。 |

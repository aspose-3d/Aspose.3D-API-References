...
url: /zh/nodejs-java/aspose.threed/skindeformer/
---
## SkinDeformer class

皮肤变形器包含多个骨骼工作，每个骨骼通过控制点的权重混合几何体的一部分。
...
| 名称 | 描述 |
| --- | --- |
| constructor(name) | 初始化 SkinDeformer 类的新实例。 |
...
| 名称 | 描述 |
| --- | --- |
| constructor_overload() | 初始化 SkinDeformer 类的新实例。 |
...
| 名称 | 描述 |
| --- | --- |
| getBones() | 获取 skin deformer 包含的所有骨骼 |

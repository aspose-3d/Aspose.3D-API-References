...
url: /zh/nodejs-java/aspose.threed/dish/
---
## Dish class
...
| 名称 | 描述 |
| --- | --- |
| constructor() | 创建一个具有默认半径 (10) 和默认高度 (5) 的新 Dish 实例 |
...
| 名称 | 描述 |
| --- | --- |
| constructor_overload(radius, height) | 创建一个具有指定半径和高度的新 Dish 实例 |
...
| 名称 | 描述 |
| --- | --- |
| constructor_overload2(name, radius, height, widthSegments, heightSegments) | 创建一个具有指定半径和高度的新 Dish 实例 |
...
| 半径 | 数字 | Dish 的半径 |
| height | 数字 | Dish 的高度 |
| widthSegments | 数字 | Dish 的宽段 |
| heightSegments | 数字 | 盘子的高度段 |
...
| 名称 | 描述 |
| --- | --- |
| setWidthSegments(value) | 获取或设置宽度段 |
...
| 名称 | 描述 |
| --- | --- |
| setHeightSegments(value) | 获取或设置高度段 |

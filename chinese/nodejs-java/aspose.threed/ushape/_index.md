...
url: /zh/nodejs-java/aspose.threed/ushape/
---
## UShape class
...
| 名称 | 描述 |
| --- | --- |
| setWebThickness(value) | 获取或设置网格的厚度。 |
...
| 名称 | 描述 |
| --- | --- |
| setEdgeRadius(value) | 获取或设置法兰边缘的半径。 |

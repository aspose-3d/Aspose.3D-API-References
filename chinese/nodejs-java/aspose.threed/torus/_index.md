...
url: /zh/nodejs-java/aspose.threed/torus/
---
## Torus class
...
| 名称 | 描述 |
| --- | --- |
| constructor_overload(radius, tube) | 初始化 Torus 类的新实例。 |
...
| 名称 | 描述 |
| --- | --- |
| constructor_overload2(radius, tube, arc) | 初始化 Torus 类的新实例。 |
...
| 名称 | 描述 |
| --- | --- |
| constructor_overload3(name, radius, tube, radialSegments, tubularSegments, arc) | 初始化 Torus 类的新实例。 |
...
| 半径 | 数字 | 环面的半径。 |
| tube | 数字 | 环面管的半径。 |
| radialSegments | 数字 | 径向分段。 |
| tubularSegments | 数字 | 管状段。 |
| arc | 数字 | 弧。 |
...
| 名称 | 描述 |
| --- | --- |
| getTubularSegments() | 获取或设置管状段。管状段。 |
...
| 名称 | 描述 |
| --- | --- |
| setTubularSegments(value) | 获取或设置管状段。管状段。 |

...
url: /zh/nodejs-java/aspose.threed/gltfloadoptions/
---
...
| 名称 | 描述 |
| --- | --- |
| constructor() | GltfLoadOptions 的构造函数 |
...
| 名称 | 描述 |
| --- | --- |
| getFlipTexCoordV() | 翻转网格纹理坐标中的 v(t) 坐标，默认值为 true。 |
...
| 名称 | 描述 |
| --- | --- |
| setFlipTexCoordV(value) | 翻转网格纹理坐标中的 v(t) 坐标，默认值为 true。 |

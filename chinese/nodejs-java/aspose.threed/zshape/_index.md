...
url: /zh/nodejs-java/aspose.threed/zshape/
---
## ZShape class

由参数定义的符合 IFC 标准的 Z 形截面。
...
| 名称 | 描述 |
| --- | --- |
| setFlangeWidth(value) | 获取或设置翼缘的长度。 |
...
| 名称 | 描述 |
| --- | --- |
| setWebThickness(value) | 获取或设置壁的厚度。 |
...
| 名称 | 描述 |
| --- | --- |
| setFlangeThickness(value) | 获取或设置翼缘的厚度。 |
...
| 名称 | 描述 |
| --- | --- |
| getFilletRadius() | 获取或设置翼缘与腹板之间圆角的半径。 |
...
| 名称 | 描述 |
| --- | --- |
| setFilletRadius(value) | 获取或设置翼缘与腹板之间圆角的半径。 |
...
| 名称 | 描述 |
| --- | --- |
| setEdgeRadius(value) | 获取或设置翼缘边缘的半径。 |

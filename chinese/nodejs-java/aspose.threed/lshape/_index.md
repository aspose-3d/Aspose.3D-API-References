...
url: /zh/nodejs-java/aspose.threed/lshape/
---
## LShape class

由参数定义的符合 IFC 标准的 L 形截面。
...
| 名称 | 描述 |
| --- | --- |
| setThickness(value) | 获取或设置恒定墙壁的厚度。 |
...
| 名称 | 描述 |
| --- | --- |
| setFilletRadius(value) | 获取或设置圆角的半径。 |
...
| 名称 | 描述 |
| --- | --- |
| setEdgeRadius(value) | 获取或设置边缘的半径。 |

...
url: /zh/nodejs-java/aspose.threed/sweptareasolid/
---
## SweptAreaSolid class

SweptAreaSolid通过沿导线扫掠轮廓来构建几何体。
...
| 名称 | 描述 |
| --- | --- |
| setDirectrix(value) | 扫掠区域随之扫掠的准线。 |

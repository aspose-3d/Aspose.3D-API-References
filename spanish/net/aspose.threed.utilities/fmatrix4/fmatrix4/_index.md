...
description: Inicializar la instancia deFMatrix4aspose.threed.utilities/fmatrix4
type: docs
weight: 10
url: /es/net/aspose.threed.utilities/fmatrix4/fmatrix4/
---
## FMatrix4(float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float) {#constructor_2}

Inicializar la instancia de[`FMatrix4`](../../fmatrix4)
...
Inicializar la instancia de[`FMatrix4`](../../fmatrix4) a partir de una[`Matrix4`](../../matrix4) instancia.

...
description: La clase base para configurar opciones en el guardado de archivos para diferentes tipos
type: docs
weight: 1340
url: /es/net/aspose.threed.formats/saveoptions/
---
## SaveOptions class

La clase base para configurar opciones en el guardado de archivos para diferentes tipos

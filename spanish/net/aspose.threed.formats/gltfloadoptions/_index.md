...
description: Opciones de carga para formato glTF
type: docs
weight: 1150
url: /es/net/aspose.threed.formats/gltfloadoptions/
---
## GltfLoadOptions class

Opciones de carga para formato glTF
...
| Nombre | Descripción |
| --- | --- |
| [GltfLoadOptions](gltfloadoptions)() | Constructor de[`GltfLoadOptions`](../gltfloadoptions) |
...
| [FlipTexCoordV](../../aspose.threed.formats/gltfloadoptions/fliptexcoordv) { get; set; } | Voltee la coordenada v(t) en la coordenada de textura de la malla, el valor predeterminado es verdadero. |

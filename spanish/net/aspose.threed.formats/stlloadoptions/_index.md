...
type: docs
weight: 1350
url: /es/net/aspose.threed.formats/stlloadoptions/
---
...
| Nombre | Descripción |
| --- | --- |
| [StlLoadOptions](stlloadoptions#constructor)() | Inicializa de un nuevo[`StlLoadOptions`](../stlloadoptions) instancia. |
| [StlLoadOptions](stlloadoptions#constructor_1)(FileContentType) | Inicializa de un nuevo[`StlLoadOptions`](../stlloadoptions) instancia. |
...
| [FlipCoordinateSystem](../../aspose.threed.formats/stlloadoptions/flipcoordinatesystem) { get; set; } | Obtiene o establece si cambiar el sistema de coordenadas de puntos de control/normal durante la importación. |
...
| [RecalculateNormal](../../aspose.threed.formats/stlloadoptions/recalculatenormal) { get; set; } | Ignora los datos normales almacenados en el archivo STL y vuelve a calcular los datos normales en función de la posición del vértice. El valor predeterminado es false |

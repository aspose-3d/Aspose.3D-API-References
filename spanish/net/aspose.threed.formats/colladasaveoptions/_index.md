...
description: Guardar opciones para collada
type: docs
weight: 1040
url: /es/net/aspose.threed.formats/colladasaveoptions/
---
## ColladaSaveOptions class

Guardar opciones para collada
...
| Nombre | Descripción |
| --- | --- |
| [ColladaSaveOptions](colladasaveoptions)() | Constructor de[`ColladaSaveOptions`](../colladasaveoptions) |
...
| [Indented](../../aspose.threed.formats/colladasaveoptions/indented) { get; set; } | Obtiene o establece si el documento XML exportado está sangrado. |
...
| [TransformStyle](../../aspose.threed.formats/colladasaveoptions/transformstyle) { get; set; } | Obtiene o establece el estilo de transformación del nodo |

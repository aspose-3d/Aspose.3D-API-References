...
description: Opciones de carga para formato Fbx.
type: docs
weight: 1110
url: /es/net/aspose.threed.formats/fbxloadoptions/
---
...
| Nombre | Descripción |
| --- | --- |
| [FbxLoadOptions](fbxloadoptions#constructor)() | Constructor de[`FbxLoadOptions`](../fbxloadoptions) |
| [FbxLoadOptions](fbxloadoptions#constructor_1)(FileFormat) | Constructor de[`FbxLoadOptions`](../fbxloadoptions) |
...
| [KeepBuiltinGlobalSettings](../../aspose.threed.formats/fbxloadoptions/keepbuiltinglobalsettings) { get; set; } | Obtiene o establece si se deben mantener las propiedades integradas en GlobalSettings que tienen un reemplazo de propiedad nativo en[`AssetInfo`](../../aspose.threed/assetinfo) . Establezca esto en verdadero si desea las propiedades completas en GlobalSettings El valor predeterminado es false |

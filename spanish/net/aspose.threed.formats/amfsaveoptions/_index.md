...
description: Guardar opciones para AMF
type: docs
weight: 1030
url: /es/net/aspose.threed.formats/amfsaveoptions/
---
## AmfSaveOptions class

Guardar opciones para AMF
...
| Nombre | Descripción |
| --- | --- |
| [AmfSaveOptions](amfsaveoptions)() | Constructor de[`AmfSaveOptions`](../amfsaveoptions) |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [EnableCompression](../../aspose.threed.formats/amfsaveoptions/enablecompression) { get; set; } | Si usar compresión para reducir el tamaño final del archivo, el valor predeterminado es true |

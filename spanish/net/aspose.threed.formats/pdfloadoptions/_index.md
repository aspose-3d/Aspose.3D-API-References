...
description: Opciones para cargar PDF
type: docs
weight: 1250
url: /es/net/aspose.threed.formats/pdfloadoptions/
---
...
| Nombre | Descripción |
| --- | --- |
| [PdfLoadOptions](pdfloadoptions)() | Constructor de[`PdfLoadOptions`](../pdfloadoptions) |
...
| [Password](../../aspose.threed.formats/pdfloadoptions/password) { get; set; } | La contraseña para desbloquear el archivo PDF encriptado. |

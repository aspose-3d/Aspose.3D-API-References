...
description: Perfil en forma de C compatible con IFC definido por parámetros. La posición central del perfil está en el centro del cuadro delimitador.
type: docs
weight: 1520
url: /es/net/aspose.threed.profiles/cshape/
---
## CShape class
...
| Nombre | Descripción |
| --- | --- |
| [CShape](cshape)() | Constructor de[`CShape`](../cshape) |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [Depth](../../aspose.threed.profiles/cshape/depth) { get; set; } | Obtiene o establece la profundidad del perfil. |
| [Excluded](../../aspose.threed/entity/excluded) { get; set; } | Obtiene o establece si se excluye esta entidad durante la exportación. |
| [Girth](../../aspose.threed.profiles/cshape/girth) { get; set; } | Obtiene o establece la longitud de la circunferencia. |
| [InternalFilletRadius](../../aspose.threed.profiles/cshape/internalfilletradius) { get; set; } | Obtiene o establece el radio de empalme interno. |
...
| [WallThickness](../../aspose.threed.profiles/cshape/wallthickness) { get; set; } | Obtiene o establece el grosor del muro. |
| [Width](../../aspose.threed.profiles/cshape/width) { get; set; } | Obtiene o establece el ancho del perfil. |
...
| override [GetExtent](../../aspose.threed.profiles/cshape/getextent)() | Obtiene la extensión en dimensión xey. |

...
description: La clase base de todas las entidades. La entidad representa un objeto concreto que se adjunta bajo un nodo comoLight../aspose.threed.entities/light/Geometry../aspose.threed.entities/geometry .
type: docs
weight: 970
url: /es/net/aspose.threed/entity/
---
## Entity class

La clase base de todas las entidades. La entidad representa un objeto concreto que se adjunta bajo un nodo como[`Light`](../../aspose.threed.entities/light)/[`Geometry`](../../aspose.threed.entities/geometry) .
...
| Nombre | Descripción |
| --- | --- |
| [Entity](entity)(string) | Inicializa una nueva instancia del[`Entity`](../entity) clase. |

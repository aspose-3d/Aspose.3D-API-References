...
description: Perfil de línea central compatible con IFC
type: docs
weight: 30
url: /es/java/com.aspose.threed/centerlineprofile/
---
...
Perfil de línea central compatible con IFC
## Constructores

| Constructor | Descripción |
| --- | --- |
| [CenterLineProfile(Curve curve, double thickness)](#CenterLineProfile-com.aspose.threed.Curve-double-) | Construye un nuevo [CenterLineProfile](../../com.aspose.threed/centerlineprofile) con la curva especificada como línea central. |
| [CenterLineProfile(Curve curve)](#CenterLineProfile-com.aspose.threed.Curve-) | Construye un nuevo [CenterLineProfile](../../com.aspose.threed/centerlineprofile) con la curva especificada como línea central. |
## Métodos
...
| [getClass()](#getClass--) |  |
| [getCurve()](#getCurve--) | La curva de la línea central del perfil |
...
| [getThickness()](#getThickness--) | Espesor aplicado a lo largo de la línea central |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setCurve(Curve value)](#setCurve-com.aspose.threed.Curve-) | La curva de la línea central del perfil |
...
| [setThickness(double value)](#setThickness-double-) | Espesor aplicado a lo largo de la línea central |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Construye un nuevo [CenterLineProfile](../../com.aspose.threed/centerlineprofile) con la curva especificada como línea central.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Curva de la línea central |
| espesor | double | Espesor aplicado a lo largo de la línea central |
...
La curva de la línea central del perfil
...
Espesor aplicado a lo largo de la línea central

**Returns:**
double - Espesor aplicado a lo largo de la línea central
### hashCode() {#hashCode--}
```

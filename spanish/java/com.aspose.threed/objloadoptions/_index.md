...
description: Opciones de carga para wavefront obj
type: docs
weight: 115
url: /es/java/com.aspose.threed/objloadoptions/
---
...
| --- | --- |
| [ObjLoadOptions()](#ObjLoadOptions--) | Constructor de [ObjLoadOptions](../../com.aspose.threed/objloadoptions) |
## Métodos
...
| [getClass()](#getClass--) |  |
| [getEnableMaterials()](#getEnableMaterials--) | Obtiene si se importan materiales para cada objeto |
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | Obtiene si se invierte el sistema de coordenadas de los puntos de control/normal durante la importación |
...
| [getNormalizeNormal()](#getNormalizeNormal--) | Obtiene si se normaliza el vector normal durante la carga. |
| [getScale()](#getScale--) | Escalas en los ejes x/y/z, el valor predeterminado es 1.0 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEnableMaterials(boolean value)](#setEnableMaterials-boolean-) | Establece si se importan materiales para cada objeto |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | Establece si se invierte el sistema de coordenadas de los puntos de control/normal durante la importación |
...
| [setNormalizeNormal(boolean value)](#setNormalizeNormal-boolean-) | Establece si se normaliza el vector normal durante la carga. |
| [setScale(double value)](#setScale-double-) | Escalas en los ejes x/y/z, el valor predeterminado es 1.0 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Constructor de [ObjLoadOptions](../../com.aspose.threed/objloadoptions)
...
Obtiene si se importan materiales para cada objeto

**Returns:**
booleano - si se importan materiales para cada objeto
...
Obtiene si se invierte el sistema de coordenadas de los puntos de control/normal durante la importación

**Returns:**
booleano - si se invierte el sistema de coordenadas de los puntos de control/normal durante la importación
...
Obtiene si se normaliza el vector normal durante la carga. El valor predeterminado es verdadero.

**Returns:**
booleano - si se normaliza el vector normal durante la carga. El valor predeterminado es verdadero.
### getScale() {#getScale--}
```
...
Escalas en los ejes x/y/z, el valor predeterminado es 1.0

**Returns:**
doble - Escalas en los ejes x/y/z, el valor predeterminado es 1.0
### hashCode() {#hashCode--}
```
...
Establece si se importan materiales para cada objeto
...
Establece si se invierte el sistema de coordenadas de los puntos de control/normal durante la importación
...
Establece si se normaliza el vector normal durante la carga. El valor predeterminado es verdadero.

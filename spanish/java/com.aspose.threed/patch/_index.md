...
description: Un  es una superficie de modelado paramétrico similar a  y también está definida por dos   el  y .
type: docs
weight: 119
url: /es/java/com.aspose.threed/patch/
---
...
Un [Patch](../../com.aspose.threed/patch) es una superficie de modelado paramétrico, similar a [NurbsSurface](../../com.aspose.threed/nurbssurface), también está definida por dos [PatchDirection](../../com.aspose.threed/patchdirection), el [getU](../../com.aspose.threed/patch\#getU) y el [getV](../../com.aspose.threed/patch\#getV). Pero la diferencia entre [Patch](../../com.aspose.threed/patch) y [NurbsSurface](../../com.aspose.threed/nurbssurface) es que la curva [PatchDirection](../../com.aspose.threed/patchdirection) puede ser una de [PatchDirectionType.BEZIER](../../com.aspose.threed/patchdirectiontype\#BEZIER), [PatchDirectionType.QUADRATIC\_BEZIER](../../com.aspose.threed/patchdirectiontype\#QUADRATIC-BEZIER), [PatchDirectionType.BASIS\_SPLINE](../../com.aspose.threed/patchdirectiontype\#BASIS-SPLINE), [PatchDirectionType.CARDINAL\_SPLINE](../../com.aspose.threed/patchdirectiontype\#CARDINAL-SPLINE) y [PatchDirectionType.LINEAR](../../com.aspose.threed/patchdirectiontype\#LINEAR)
## Constructores

| Constructor | Descripción |
| --- | --- |
| [Patch()](#Patch--) | Inicializa una nueva instancia de la clase [Patch](../../com.aspose.threed/patch). |
| [Patch(String name)](#Patch-java.lang.String-) | Inicializa una nueva instancia de la clase [Patch](../../com.aspose.threed/patch). |
## Métodos
...
| [getU()](#getU--) | Obtiene la dirección u. |
| [getV()](#getV--) | Obtiene la dirección v. |
...
Inicializa una nueva instancia de la clase [Patch](../../com.aspose.threed/patch).

...
description: Instancia de formato de archivo para Microsoft 3MF con utilidades relacionadas con 3MF.
type: docs
weight: 104
url: /es/java/com.aspose.threed/microsoft3mfformat/
---
...
| [getObjectType(Node node)](#getObjectType-com.aspose.threed.Node-) | Obtiene el tipo de modelo para el nodo especificado. |
| [getTransformForBuild(Node node)](#getTransformForBuild-com.aspose.threed.Node-) | Obtiene la matriz de transformación para el nodo usado en la compilación. |
| [getVersion()](#getVersion--) | Obtiene la versión del formato de archivo |
| [hashCode()](#hashCode--) |  |
| [isBuildable(Node node)](#isBuildable-com.aspose.threed.Node-) | Comprueba si este nodo está marcado como una compilación. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBuildable(Node node, boolean value, Matrix4 transform)](#setBuildable-com.aspose.threed.Node-boolean-com.aspose.threed.Matrix4-) | Marca un nodo para la compilación. |
| [setObjectType(Node node, String modelType)](#setObjectType-com.aspose.threed.Node-java.lang.String-) | Establece el tipo de modelo para el nodo especificado. |
...
**Returns:**
java.lang.String - tipo de objeto 3MF para el nodo dado
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Qué nodo usar para obtener la matriz de transformación para la compilación 3MF. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Qué nodo comprobar |

**Returns:**
boolean - Verdadero si está marcado como una compilación
### notify() {#notify--}
```
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Qué nodo marcar como una compilación. |
| valor | boolean |  |
| transform | [Matrix4](../../com.aspose.threed/matrix4) | La transformación del nodo en la compilación. |

...
description: Opciones de guardado para AMF
type: docs
weight: 12
url: /es/java/com.aspose.threed/amfsaveoptions/
---
...
| --- | --- |
| [AmfSaveOptions()](#AmfSaveOptions--) | Constructor de [AmfSaveOptions](../../com.aspose.threed/amfsaveoptions) |
## Métodos
...
| [getClass()](#getClass--) |  |
| [getEnableCompression()](#getEnableCompression--) | Indica si se debe usar compresión para reducir el tamaño final del archivo, el valor predeterminado es true |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEnableCompression(boolean value)](#setEnableCompression-boolean-) | Indica si se debe usar compresión para reducir el tamaño final del archivo, el valor predeterminado es true |
...
Constructor de [AmfSaveOptions](../../com.aspose.threed/amfsaveoptions)
...
Indica si se debe usar compresión para reducir el tamaño final del archivo, el valor predeterminado es true

**Returns:**
boolean - Indica si se debe usar compresión para reducir el tamaño final del archivo, el valor predeterminado es true

...
description: Define el grupo de polígonos para los componentes especificados para agrupar polígonos relacionados juntos.
type: docs
weight: 215
url: /es/java/com.aspose.threed/vertexelementpolygongroup/
---
...
| --- | --- |
| [VertexElementPolygonGroup()](#VertexElementPolygonGroup--) | Inicializa una nueva instancia de la clase [VertexElementPolygonGroup](../../com.aspose.threed/vertexelementpolygongroup). |
## Métodos
...
Inicializa una nueva instancia de la clase [VertexElementPolygonGroup](../../com.aspose.threed/vertexelementpolygongroup).

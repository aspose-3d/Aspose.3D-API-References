...
description: Tipo de contenido de archivo
type: docs
weight: 279
url: /es/java/com.aspose.threed/filecontenttype/
---
...
| Campo | Descripción |
| --- | --- |
| [ASCII](#ASCII) | Tipo de formato ASCII, como ASCII FBX, ASCII STL |
| [BINARY](#BINARY) | Tipo de formato binario, como binary FBX, binary STL |
## Métodos
...
Tipo de formato ASCII, como ASCII FBX, ASCII STL
...
Tipo de formato binario, como binary FBX, binary STL

...
description: Un grupo de suavizado es un conjunto de polígonos en una malla de polígonos que debe aparecer como una superficie lisa.
type: docs
weight: 216
url: /es/java/com.aspose.threed/vertexelementsmoothinggroup/
---
...
Un grupo de suavizado es un conjunto de polígonos en una malla de polígonos que debe aparecer como una superficie lisa. Algunos programas de modelado 3D tempranos, como 3D Studio Max para DOS, utilizaban el grupo de suavizado para evitar almacenar el vector normal de cada vértice de la malla.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [VertexElementSmoothingGroup()](#VertexElementSmoothingGroup--) | Inicializa una nueva instancia de la clase [VertexElementSmoothingGroup](../../com.aspose.threed/vertexelementsmoothinggroup). |
## Métodos
...
| [copyTo(VertexElementIntsTemplate target)](#copyTo-com.aspose.threed.VertexElementIntsTemplate-) | Copia datos al elemento especificado. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(int[] data)](#setData-int---) | Cargar datos |
...
Inicializa una nueva instancia de la clase [VertexElementSmoothingGroup](../../com.aspose.threed/vertexelementsmoothinggroup).
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| target | [VertexElementIntsTemplate](../../com.aspose.threed/vertexelementintstemplate) | Objetivo. |
...
**Returns:**
java.util.List<java.lang.Integer> - los datos del vértice

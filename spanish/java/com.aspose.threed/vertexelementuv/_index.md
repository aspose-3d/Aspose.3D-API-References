...
description: Define las coordenadas UV para los componentes especificados.
type: docs
weight: 220
url: /es/java/com.aspose.threed/vertexelementuv/
---
...
Define las coordenadas UV para los componentes especificados. Una geometría puede tener múltiples elementos [VertexElementUV](../../com.aspose.threed/vertexelementuv), y cada uno tiene diferentes [TextureMapping](../../com.aspose.threed/texturemapping)s.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [VertexElementUV()](#VertexElementUV--) | Inicializa una nueva instancia de la clase [VertexElementUV](../../com.aspose.threed/vertexelementuv). |
| [VertexElementUV(TextureMapping textureMapping)](#VertexElementUV-com.aspose.threed.TextureMapping-) | Inicializa una nueva instancia de la clase [VertexElementUV](../../com.aspose.threed/vertexelementuv). |
## Métodos

| Método | Descripción |
| --- | --- |
| [addData(Iterable<Vector2> data)](#addData-java.lang.Iterable-com.aspose.threed.Vector2--) | Añade un conjunto de [Vector2](../../com.aspose.threed/vector2) a VertexElementUV.Data. |
| [addData2(Iterable<Vector3> data)](#addData2-java.lang.Iterable-com.aspose.threed.Vector3--) | Añade un conjunto de [Vector3](../../com.aspose.threed/vector3) a VertexElementUV.Data. |
...
Inicializa una nueva instancia de la clase [VertexElementUV](../../com.aspose.threed/vertexelementuv). El tipo de mapeo de textura predeterminado es [TextureMapping.DIFFUSE](../../com.aspose.threed/texturemapping\#DIFFUSE)
...
Inicializa una nueva instancia de la clase [VertexElementUV](../../com.aspose.threed/vertexelementuv).

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| textureMapping | [TextureMapping](../../com.aspose.threed/texturemapping) | El tipo de mapeo de textura. |
...
Añade un conjunto de [Vector2](../../com.aspose.threed/vector2) a VertexElementUV.Data. Esto es un atajo, este método convertirá el [Vector2](../../com.aspose.threed/vector2) a [Vector4](../../com.aspose.threed/vector4) con z a 0 y w a 0.
...
Añade un conjunto de [Vector3](../../com.aspose.threed/vector3) a VertexElementUV.Data. Esto es un atajo, este método convertirá el [Vector3](../../com.aspose.threed/vector3) a [Vector4](../../com.aspose.threed/vector4) con w a 0.

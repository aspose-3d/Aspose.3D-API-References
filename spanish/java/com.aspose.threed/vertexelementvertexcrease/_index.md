...
description: Define el pliegue del vértice para los componentes especificados
type: docs
weight: 224
url: /es/java/com.aspose.threed/vertexelementvertexcrease/
---
...
| --- | --- |
| [VertexElementVertexCrease()](#VertexElementVertexCrease--) | Inicializa una nueva instancia de la clase [VertexElementVertexCrease](../../com.aspose.threed/vertexelementvertexcrease). |
## Métodos
...
| [copyTo(VertexElementDoublesTemplate target)](#copyTo-com.aspose.threed.VertexElementDoublesTemplate-) | Copia datos al elemento especificado. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(double[] data)](#setData-double---) | Cargar datos |
...
Inicializa una nueva instancia de la clase [VertexElementVertexCrease](../../com.aspose.threed/vertexelementvertexcrease).
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| target | [VertexElementDoublesTemplate](../../com.aspose.threed/vertexelementdoublestemplate) | Objetivo. |
...
**Returns:**
java.util.List<java.lang.Double> - los datos del vértice

...
description: "Un está compuesto por varios segmentos de curva."
type: docs
weight: 34
url: /es/java/com.aspose.threed/compositecurve/
---
...
Un [CompositeCurve](../../com.aspose.threed/compositecurve) está compuesto por varios segmentos de curva.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [CompositeCurve()](#CompositeCurve--) | Constructor de [CompositeCurve](../../com.aspose.threed/compositecurve) |
## Métodos

| Método | Descripción |
| --- | --- |
| [addSegment(Curve curve)](#addSegment-com.aspose.threed.Curve-) | Agregar un nuevo segmento a la curva actual. |
| [addSegment(Curve curve, boolean sameDirection)](#addSegment-com.aspose.threed.Curve-boolean-) | Agregar un nuevo segmento a la curva actual. |
...
| [getSegments()](#getSegments--) | Los segmentos de la curva. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Constructor de [CompositeCurve](../../com.aspose.threed/compositecurve)
...
Agregar un nuevo segmento a la curva actual.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | La curva a agregar |
...
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | La curva a agregar |
| sameDirection | boolean | Misma dirección con la curva actual. |
...
**Returns:**
java.util.ArrayList<com.aspose.threed.CompositeCurve.Segment> - Los segmentos de la curva.
### hashCode() {#hashCode--}
```

...
description: "Creado por lexchou el 16/6/2017."
type: docs
weight: 66
url: /es/java/com.aspose.threed/filestream/
---
...
Creado por lexchou el 16/6/2017.
## Constructores
...
| [wrap(OutputStream stream)](#wrap-java.io.OutputStream-) | Envuelve un OutputStream como Stream, el flujo debe cerrarse para vaciar los datos al flujo de salida. |
...
Envuelve un OutputStream como Stream, el flujo debe cerrarse para vaciar los datos al flujo de salida.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| flujo | java.io.OutputStream | flujo de salida para envolver |

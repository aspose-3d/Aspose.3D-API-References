...
description: A  representa las relaciones lógicas de .
type: docs
weight: 75
url: /es/java/com.aspose.threed/group/
---
...
A [Group](../../com.aspose.threed/group) representa las relaciones lógicas de [Node](../../com.aspose.threed/node).
## Constructores

| Constructor | Descripción |
| --- | --- |
| [Group(String name)](#Group-java.lang.String-) | Crea una nueva instancia de [Group](../../com.aspose.threed/group) |
| [Group()](#Group--) | Crea una nueva instancia de [Group](../../com.aspose.threed/group) |
## Métodos
...
| [getClass()](#getClass--) |  |
| [getGroups()](#getGroups--) | Subgrupos |
| [getName()](#getName--) | Obtiene el nombre. |
| [getNodes()](#getNodes--) | Los nodos en este grupo |
| [getParent()](#getParent--) | Grupo padre del grupo actual |
...
| [toString()](#toString--) | Obtiene la representación en cadena de [Group](../../com.aspose.threed/group) |
| [wait()](#wait--) |  |
...
Crea una nueva instancia de [Group](../../com.aspose.threed/group)

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| nombre | java.lang.String | Nombre del grupo |
...
**Returns:**
java.util.List<com.aspose.threed.Group> - Subgrupos
### getName() {#getName--}
```
...
Los nodos en este grupo

**Returns:**
java.util.List<com.aspose.threed.Node> - Los nodos en este grupo
### getParent() {#getParent--}
```
...
Obtiene la representación en cadena de [Group](../../com.aspose.threed/group)

**Returns:**
java.lang.String - La representación en cadena de la instancia actual
### wait() {#wait--}
```

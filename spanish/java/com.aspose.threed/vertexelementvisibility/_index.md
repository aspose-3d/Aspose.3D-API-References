...
description: Define si los componentes especificados son visibles
type: docs
weight: 225
url: /es/java/com.aspose.threed/vertexelementvisibility/
---
...
| --- | --- |
| [VertexElementVisibility()](#VertexElementVisibility--) | Inicializa una nueva instancia de la clase [VertexElementVisibility](../../com.aspose.threed/vertexelementvisibility). |
## Métodos
...
| [copyTo(VertexElementTemplate<T> target)](#copyTo-com.aspose.threed.VertexElementTemplate-T--) | Copia datos al elemento especificado. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(T[] data)](#setData-T---) | Cargar datos |
...
Inicializa una nueva instancia de la clase [VertexElementVisibility](../../com.aspose.threed/vertexelementvisibility).
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| target | [VertexElementTemplate](../../com.aspose.threed/vertexelementtemplate) | Objetivo. |
...
**Returns:**
java.util.List<T> - los datos del vértice

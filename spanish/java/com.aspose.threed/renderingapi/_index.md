...
description: APIs de renderizado de uso común
type: docs
weight: 269
url: /es/java/com.aspose.threed/renderingapi/
---
...
APIs de renderizado de uso común
## Campos

| Campo | Descripción |
| --- | --- |
| [ARNOLD](#ARNOLD) | Renderizador Arnold |
| [CUSTOM](#CUSTOM) | API de renderizado personalizada |
| [DIRECTX](#DIRECTX) | DirectX |
| [MANTLE](#MANTLE) | AMD Mantle |
| [MENTAL_RAY](#MENTAL-RAY) | MentalRay |
| [METAL](#METAL) | Metal desarrollado por Apple |
| [NONE](#NONE) | Sin API de renderizado |
| [OPENGL](#OPENGL) | OpenGL |
| [OPENGLES](#OPENGLES) | OpenGL ES |
| [PREVIEW](#PREVIEW) | PreviewColorAPI, compatible con FBX |
| [RENDER_MAN](#RENDER-MAN) | RenderMan |
| [RENDER_WARE](#RENDER-WARE) | RenderWare |
| [SHADERFX](#SHADERFX) | Renderizador ShaderFX |
| [STAGE3D](#STAGE3D) | Stage3D usado en Adobe Flash |
...
API de renderizado personalizada
...
PreviewColorAPI, compatible con FBX

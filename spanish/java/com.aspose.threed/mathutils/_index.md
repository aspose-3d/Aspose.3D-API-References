...
| [toRadian(double degree)](#toRadian-double-) | Convertir un número de grados a radianes |
| [toRadian(double x, double y, double z)](#toRadian-double-double-double-) | Convertir un vector de grados a radianes |
| [toRadian(float degree)](#toRadian-float-) | Convertir un número de grados a radianes |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
**Returns:**
double - El valor entre [min, max] **Ejemplo:**
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| radian | [Vector3](../../com.aspose.threed/vector3) | El valor radiano. |
...
**Returns:**
double - El valor en grados. **Ejemplo:**
...
**Returns:**
float - El valor en grados. **Ejemplo:**
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| degree | [Vector3](../../com.aspose.threed/vector3) | El valor en grados. |
...
**Returns:**
double - El valor radiano. **Ejemplo:**
...
**Returns:**
float - El valor radiano. **Ejemplo:**

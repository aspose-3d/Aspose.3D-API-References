...
description: "Un  construye una geometría al barrer un perfil a lo largo de una directriz."
type: docs
weight: 181
url: /es/java/com.aspose.threed/sweptareasolid/
---
...
Un [SweptAreaSolid](../../com.aspose.threed/sweptareasolid) construye una geometría al barrer un perfil a lo largo de una directriz. **Example:** El siguiente código muestra cómo modelar una entidad sólida al barrer una forma en C sobre un círculo
...
| [getClass()](#getClass--) |  |
| [getDirectrix()](#getDirectrix--) | La directriz con la que el área barrida se desplaza. |
| [getEndPoint()](#getEndPoint--) | El punto final de la directriz. |
...
| [getShape()](#getShape--) | El perfil base para construir la geometría. |
| [getStartPoint()](#getStartPoint--) | El punto de inicio de la directriz. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setDirectrix(Curve value)](#setDirectrix-com.aspose.threed.Curve-) | La directriz con la que el área barrida se desplaza. |
| [setEndPoint(EndPoint value)](#setEndPoint-com.aspose.threed.EndPoint-) | El punto final de la directriz. |
...
| [setShape(Profile value)](#setShape-com.aspose.threed.Profile-) | El perfil base para construir la geometría. |
| [setStartPoint(EndPoint value)](#setStartPoint-com.aspose.threed.EndPoint-) | El punto de inicio de la directriz. |
...
La directriz con la que el área barrida se desplaza.

...
description: Perfil de texto este perfil describe contornos usando fuente y texto.
type: docs
weight: 183
url: /es/java/com.aspose.threed/text/
---
...
| [getClass()](#getClass--) |  |
| [getContent()](#getContent--) | Contenido del texto |
...
| [getFont()](#getFont--) | La fuente del texto. |
| [getFontSize()](#getFontSize--) | Escala del tamaño de la fuente. |
...
| [setContent(String value)](#setContent-java.lang.String-) | Contenido del texto |
| [setExcluded(boolean value)](#setExcluded-boolean-) | Establece si se debe excluir esta entidad durante la exportación. |
| [setFont(FontFile value)](#setFont-com.aspose.threed.FontFile-) | La fuente del texto. |
| [setFontSize(float value)](#setFontSize-float-) | Escala del tamaño de la fuente. |
...
**Returns:**
java.lang.String - Contenido del texto **Ejemplo:** El siguiente código muestra cómo crear una malla 3D a partir de texto usando el archivo de fuente especificado.
...
**Returns:**
float - Escala del tamaño de la fuente. **Ejemplo:** El siguiente código muestra cómo crear una malla 3D a partir de texto usando el archivo de fuente especificado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
|  | valor | java.lang.String | Nuevo valor **Ejemplo:** El siguiente código muestra cómo crear una malla 3D a partir de texto usando el archivo de fuente especificado. |

...
description: Opciones de carga para STL.
type: docs
weight: 176
url: /es/java/com.aspose.threed/stlloadoptions/
---
...
| --- | --- |
| [StlLoadOptions()](#StlLoadOptions--) | Inicializa una nueva instancia de [StlLoadOptions](../../com.aspose.threed/stlloadoptions). |
| [StlLoadOptions(FileContentType contentType)](#StlLoadOptions-com.aspose.threed.FileContentType-) | Inicializa una nueva instancia de [StlLoadOptions](../../com.aspose.threed/stlloadoptions). |
## Métodos
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | Obtiene si se debe invertir el sistema de coordenadas de los puntos de control/normal durante la importación. |
...
| [getRecalculateNormal()](#getRecalculateNormal--) | Ignora los datos de normales almacenados en el archivo STL y recalcula los datos de normales basándose en la posición de los vértices. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | Establece si se debe invertir el sistema de coordenadas de los puntos de control/normal durante la importación. |
...
| [setRecalculateNormal(boolean value)](#setRecalculateNormal-boolean-) | Ignora los datos de normales almacenados en el archivo STL y recalcula los datos de normales basándose en la posición de los vértices. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Inicializa una nueva instancia de [StlLoadOptions](../../com.aspose.threed/stlloadoptions).
...
Obtiene si se debe invertir el sistema de coordenadas de los puntos de control/normal durante la importación.

**Returns:**
boolean - si se debe invertir el sistema de coordenadas de los puntos de control/normal durante la importación.
...
Ignora los datos de normales almacenados en el archivo STL y recalcula los datos de normales basándose en la posición de los vértices. El valor predeterminado es false.

**Returns:**
boolean - Ignora los datos de normales almacenados en el archivo STL y recalcula los datos de normales basándose en la posición de los vértices. El valor predeterminado es false.
### hashCode() {#hashCode--}
```
...
Establece si se debe invertir el sistema de coordenadas de los puntos de control/normal durante la importación.

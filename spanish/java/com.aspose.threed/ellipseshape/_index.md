...
description: Forma de elipse compatible con IFC que se define por parámetros.
type: docs
weight: 50
url: /es/java/com.aspose.threed/ellipseshape/
---
...
Forma elíptica compatible con IFC definida por parámetros. La posición central del perfil está en el centro del cuadro delimitador.
## Constructores
...
| [getSemiAxis1()](#getSemiAxis1--) | Obtiene el primer radio de la elipse medido en la dirección del eje x. |
| [getSemiAxis2()](#getSemiAxis2--) | Obtiene el segundo radio de la elipse medido en la dirección del eje y. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setSemiAxis1(double value)](#setSemiAxis1-double-) | Establece el primer radio de la elipse medido en la dirección del eje x. |
| [setSemiAxis2(double value)](#setSemiAxis2-double-) | Establece el segundo radio de la elipse medido en la dirección del eje y. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Obtiene el primer radio de la elipse medido en la dirección del eje x.

**Returns:**
double - el primer radio de la elipse medido en la dirección del eje x.
...
Obtiene el segundo radio de la elipse medido en la dirección del eje y.

**Returns:**
double - el segundo radio de la elipse medido en la dirección del eje y.
### hashCode() {#hashCode--}
```
...
Establece el primer radio de la elipse medido en la dirección del eje x.
...
Establece el segundo radio de la elipse medido en la dirección del eje y.

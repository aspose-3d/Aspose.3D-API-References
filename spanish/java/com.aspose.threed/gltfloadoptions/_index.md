...
description: Opciones de carga para el formato glTF
type: docs
weight: 73
url: /es/java/com.aspose.threed/gltfloadoptions/
---
...
| --- | --- |
| [GltfLoadOptions()](#GltfLoadOptions--) | Constructor de [GltfLoadOptions](../../com.aspose.threed/gltfloadoptions) |
## Métodos
...
| [getFlipTexCoordV()](#getFlipTexCoordV--) | Invertir la coordenada v(t) en la coordenada de textura de la malla, el valor predeterminado es true. |
...
| [setFlipTexCoordV(boolean value)](#setFlipTexCoordV-boolean-) | Invertir la coordenada v(t) en la coordenada de textura de la malla, el valor predeterminado es true. |
...
Constructor de [GltfLoadOptions](../../com.aspose.threed/gltfloadoptions)
...
Invertir la coordenada v(t) en la coordenada de textura de la malla, el valor predeterminado es true.

**Returns:**
boolean - Invertir la coordenada v(t) en la coordenada de textura de la malla, el valor predeterminado es true.

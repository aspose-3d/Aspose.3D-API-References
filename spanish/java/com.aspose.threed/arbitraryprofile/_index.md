...
description: "Esta clase le permite construir un perfil 2D directamente a partir de una curva arbitraria."
type: docs
weight: 16
url: /es/java/com.aspose.threed/arbitraryprofile/
---
...
| --- | --- |
| [ArbitraryProfile()](#ArbitraryProfile--) | Constructor de [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) |
| [ArbitraryProfile(Curve curve)](#ArbitraryProfile-com.aspose.threed.Curve-) | Constructor de [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) con una curva inicial. |
## Métodos
...
| [getClass()](#getClass--) |  |
| [getCurve()](#getCurve--) | La Curva utilizada para construir el perfil |
...
| [getHoles()](#getHoles--) | Agujeros del perfil, también representados como curva. |
...
| [setCurve(Curve value)](#setCurve-com.aspose.threed.Curve-) | La Curva utilizada para construir el perfil |
...
Constructor de [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile)
...
Constructor de [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) con una curva inicial.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Curva inicial del perfil. |
...
Agujeros del perfil, también representados como curva.

**Returns:**
java.util.ArrayList<com.aspose.threed.Curve> - Agujeros del perfil, también representados como curva
### getName() {#getName--}
```

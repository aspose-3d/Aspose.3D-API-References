...
description: Una polilínea es una ruta definida por un conjunto de puntos con  y conectada por   lo que significa que también puede ser un conjunto de segmentos de línea conectados.
type: docs
weight: 95
url: /es/java/com.aspose.threed/line/
---
...
Una polilínea es una ruta definida por un conjunto de puntos con [Geometry.getControlPoints](../../com.aspose.threed/geometry\#getControlPoints), y conectada por [getSegments](../../com.aspose.threed/line\#getSegments), lo que significa que también puede ser un conjunto de segmentos de línea conectados. La línea suele ser un objeto lineal, lo que significa que no puede usarse para representar una curva; para representar una curva, se utiliza [NurbsCurve](../../com.aspose.threed/nurbscurve).
## Constructores

| Constructor | Descripción |
| --- | --- |
| [Line()](#Line--) | Inicializa una nueva instancia de la clase [Line](../../com.aspose.threed/line). |
| [Line(String name)](#Line-java.lang.String-) | Inicializa una nueva instancia de la clase [Line](../../com.aspose.threed/line). |
## Métodos
...
| [fromPoints(Vector3[] points)](#fromPoints-com.aspose.threed.Vector3...-) | Construye una instancia de [Line](../../com.aspose.threed/line) a partir de un conjunto de puntos. |
...
| [getSegments()](#getSegments--) | Obtiene los segmentos de la línea |
| [getVisible()](#getVisible--) | Obtiene si la geometría es visible |
| [hashCode()](#hashCode--) |  |
| [makeDefaultIndices()](#makeDefaultIndices--) | Genera la secuencia 0,1,2,3....[Geometry.getControlPoints](../../com.aspose.threed/geometry\#getControlPoints).Length-1 a [getSegments](../../com.aspose.threed/line\#getSegments) para que los ControlPoints puedan usarse como una única línea |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Inicializa una nueva instancia de la clase [Line](../../com.aspose.threed/line).
...
Construye una instancia de [Line](../../com.aspose.threed/line) a partir de un conjunto de puntos.
...
**Returns:**
java.util.List<int[]> - los segmentos de la línea
...
Genera la secuencia 0,1,2,3....[Geometry.getControlPoints](../../com.aspose.threed/geometry\#getControlPoints).Length-1 a [getSegments](../../com.aspose.threed/line\#getSegments) para que los ControlPoints puedan usarse como una única línea

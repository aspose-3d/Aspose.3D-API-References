...
description: "Implementación de matriz 4x4."
type: docs
weight: 100
url: /es/java/com.aspose.threed/matrix4/
---
...
| --- | --- |
| [Matrix4(Vector4 r0, Vector4 r1, Vector4 r2, Vector4 r3)](#Matrix4-com.aspose.threed.Vector4-com.aspose.threed.Vector4-com.aspose.threed.Vector4-com.aspose.threed.Vector4-) | Construye la matriz a partir de 4 filas. |
| [Matrix4(double m00, double m01, double m02, double m03, double m10, double m11, double m12, double m13, double m20, double m21, double m22, double m23, double m30, double m31, double m32, double m33)](#Matrix4-double-double-double-double-double-double-double-double-double-double-double-double-double-double-double-double-) | Inicializa una nueva instancia de la estructura [Matrix4](../../com.aspose.threed/matrix4). |
| [Matrix4(FMatrix4 m)](#Matrix4-com.aspose.threed.FMatrix4-) | Construye [Matrix4](../../com.aspose.threed/matrix4) a partir de una instancia de [FMatrix4](../../com.aspose.threed/fmatrix4). |
| [Matrix4(double[] m)](#Matrix4-double---) | Inicializa una nueva instancia de la estructura [Matrix4](../../com.aspose.threed/matrix4). |
| [Matrix4()](#Matrix4--) |  |
## Campos
...
| --- | --- |
| [clone()](#clone--) |  |
| [concatenate(Matrix4 m2)](#concatenate-com.aspose.threed.Matrix4-) | Concatena las dos matrices |
| [copyFrom(Matrix4 src)](#copyFrom-com.aspose.threed.Matrix4-) |  |
| [decompose(Vector3 translation, Vector3 scaling, Quaternion rotation)](#decompose-com.aspose.threed.Vector3-com.aspose.threed.Vector3-com.aspose.threed.Quaternion-) | Descompone la matriz de transformación. |
| [equals(Object obj)](#equals-java.lang.Object-) |  |
| [getClass()](#getClass--) |  |
| [getDeterminant()](#getDeterminant--) | Obtiene el determinante de la matriz. |
| [getIdentity()](#getIdentity--) | Obtiene la matriz identidad. |
| [hashCode()](#hashCode--) |  |
| [inverse()](#inverse--) | Invierte esta instancia. |
| [mul(Matrix4 lhs, Matrix4 rhs)](#mul-com.aspose.threed.Matrix4-com.aspose.threed.Matrix4-) | Multiplica las dos matrices |
| [mul(Matrix4 lhs, Vector3 v)](#mul-com.aspose.threed.Matrix4-com.aspose.threed.Vector3-) | Multiplica la matriz y vector3 |
| [mul(Matrix4 lhs, Vector4 v)](#mul-com.aspose.threed.Matrix4-com.aspose.threed.Vector4-) | Multiplica la matriz y vector4 |
| [mul(Matrix4 lhs, double v)](#mul-com.aspose.threed.Matrix4-double-) | Multiplica la matriz y el valor double |
| [normalize()](#normalize--) | Normaliza esta instancia. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [rotate(Quaternion q)](#rotate-com.aspose.threed.Quaternion-) | Crea una matriz de rotación a partir de un cuaternión |
| [rotate(double angle, Vector3 axis)](#rotate-double-com.aspose.threed.Vector3-) | Crea una matriz de rotación mediante ángulo de rotación y eje |
| [rotateFromEuler(Vector3 eul)](#rotateFromEuler-com.aspose.threed.Vector3-) | Crea una matriz de rotación a partir de ángulos de Euler |
| [rotateFromEuler(double rx, double ry, double rz)](#rotateFromEuler-double-double-double-) | Crea una matriz de rotación a partir de ángulos de Euler |
| [scale(Vector3 s)](#scale-com.aspose.threed.Vector3-) | Crea una matriz que escala a lo largo del eje x, el eje y y el eje z. |
| [scale(double s)](#scale-double-) | Crea una matriz que escala a lo largo del eje x, el eje y y el eje z. |
| [scale(double sx, double sy, double sz)](#scale-double-double-double-) | Crea una matriz que escala a lo largo del eje x, el eje y y el eje z. |
| [setTRS(Vector3 translation, Vector3 rotation, Vector3 scale)](#setTRS-com.aspose.threed.Vector3-com.aspose.threed.Vector3-com.aspose.threed.Vector3-) | Inicializa la matriz con traslación/rotación/escala |
| [toArray()](#toArray--) | Convierte la matriz a un arreglo. |
| [toString()](#toString--) | Devuelve un java.lang.String que representa el [Matrix4](../../com.aspose.threed/matrix4) actual. |
| [translate(Vector3 t)](#translate-com.aspose.threed.Vector3-) | Crea una matriz que traslada a lo largo del eje x, el eje y y el eje z |
| [translate(double tx, double ty, double tz)](#translate-double-double-double-) | Crea una matriz que traslada a lo largo del eje x, el eje y y el eje z |
| [transpose()](#transpose--) | Transpone esta instancia. |
| [wait()](#wait--) |  |

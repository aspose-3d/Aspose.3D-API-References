...
type: docs
weight: 129
url: /es/java/com.aspose.threed/plyformat/
---
...
El formato PLY. **Ejemplo:** El siguiente código muestra cómo decodificar una malla a partir de un archivo PLY:
...
| [decode(Stream stream)](#decode-com.aspose.threed.Stream-) | Decodifique una nube de puntos o malla desde el flujo especificado. |
| [decode(Stream stream, PlyLoadOptions opt)](#decode-com.aspose.threed.Stream-com.aspose.threed.PlyLoadOptions-) | Decodifique una nube de puntos o malla desde el flujo especificado. |
| [decode(String fileName)](#decode-java.lang.String-) | Decodifique una nube de puntos o malla desde el flujo especificado. |
| [decode(String fileName, PlyLoadOptions opt)](#decode-java.lang.String-com.aspose.threed.PlyLoadOptions-) | Decodifique una nube de puntos o malla desde el flujo especificado. |
...
| [encode(Entity entity, Stream stream)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-) | Codifique la entidad y guarde el resultado en el flujo. |
| [encode(Entity entity, Stream stream, PlySaveOptions opt)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-com.aspose.threed.PlySaveOptions-) | Codifique la entidad y guarde el resultado en el flujo. |
| [encode(Entity entity, String fileName)](#encode-com.aspose.threed.Entity-java.lang.String-) | Codifique la entidad y guarde el resultado en un archivo externo. |
| [encode(Entity entity, String fileName, PlySaveOptions opt)](#encode-com.aspose.threed.Entity-java.lang.String-com.aspose.threed.PlySaveOptions-) | Codifique la entidad y guarde el resultado en un archivo externo. |
...
Decodifique una nube de puntos o malla desde el flujo especificado.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | El flujo de entrada |
...
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | El flujo de entrada |
| opt | [PlyLoadOptions](../../com.aspose.threed/plyloadoptions) | La opción de carga del formato PLY |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| fileName | java.lang.String | El flujo de entrada |
...
Codifique la entidad y guarde el resultado en el flujo.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | La entidad a codificar |
|  | stream | [Stream](../../com.aspose.threed/stream) | El flujo al que escribir, este método no cerrará este flujo **Example:** El siguiente código muestra cómo codificar una malla en un archivo PLY: |
...
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | La entidad a codificar |
| stream | [Stream](../../com.aspose.threed/stream) | El flujo al que escribir, este método no cerrará este flujo |
|  | opt | [PlySaveOptions](../../com.aspose.threed/plysaveoptions) | Opciones de guardado **Example:** El siguiente código muestra cómo codificar una malla en un archivo PLY: |
...
Codifique la entidad y guarde el resultado en un archivo externo.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | La entidad a codificar |
|  | fileName | java.lang.String | El archivo al que escribir **Example:** El siguiente código muestra cómo codificar una malla en un archivo PLY: |
...
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | La entidad a codificar |
| fileName | java.lang.String | El archivo al que escribir |
|  | opt | [PlySaveOptions](../../com.aspose.threed/plysaveoptions) | Opciones de guardado **Example:** El siguiente código muestra cómo codificar una malla en un archivo PLY: |

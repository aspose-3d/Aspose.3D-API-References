...
description: Perfil de espejo compatible con IFC.
type: docs
weight: 106
url: /es/java/com.aspose.threed/mirroredprofile/
---
...
Perfil de espejo compatible con IFC. Este perfil define un nuevo perfil al reflejar el perfil base alrededor del eje y.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [MirroredProfile(Profile baseProfile)](#MirroredProfile-com.aspose.threed.Profile-) | Construir un nuevo [MirroredProfile](../../com.aspose.threed/mirroredprofile) a partir de un perfil existente. |
## Métodos
...
| [getBaseProfile()](#getBaseProfile--) | El perfil base que será reflejado. |
...
Construir un nuevo [MirroredProfile](../../com.aspose.threed/mirroredprofile) a partir de un perfil existente.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| baseProfile | [Profile](../../com.aspose.threed/profile) | El perfil base que será reflejado. |
...
El perfil base que será reflejado.

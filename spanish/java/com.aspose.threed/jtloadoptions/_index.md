...
description: Opciones de carga para Siemens JT
type: docs
weight: 88
url: /es/java/com.aspose.threed/jtloadoptions/
---
...
Opciones de carga para Siemens JT
## Constructores
...
| [getLoadPMI()](#getLoadPMI--) | Cargar información PMI del archivo JT si es posible, los datos se guardarán como la propiedad "PMI" de [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). |
| [getLoadProperties()](#getLoadProperties--) | Cargar propiedades de la tabla de propiedades de JT como propiedades de Aspose.3D. |
...
| [setLoadPMI(boolean value)](#setLoadPMI-boolean-) | Cargar información PMI del archivo JT si es posible, los datos se guardarán como la propiedad "PMI" de [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). |
| [setLoadProperties(boolean value)](#setLoadProperties-boolean-) | Cargar propiedades de la tabla de propiedades de JT como propiedades de Aspose.3D. |
...
Cargar información PMI del archivo JT si es posible, los datos se guardarán como la propiedad "PMI" de [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). El valor predeterminado es false.

**Returns:**
boolean - Cargar información PMI del archivo JT si es posible, los datos se guardarán como la propiedad "PMI" de [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). El valor predeterminado es false.
...
Cargar propiedades de la tabla de propiedades de JT como propiedades de Aspose.3D. El valor predeterminado es false.

**Returns:**
boolean - Cargar propiedades de la tabla de propiedades de JT como propiedades de Aspose.3D. El valor predeterminado es false.

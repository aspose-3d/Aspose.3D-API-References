...
description: La forma describe la deformación en un conjunto de puntos de control, lo cual es similar al deformador de clúster en Maya.
type: docs
weight: 171
url: /es/java/com.aspose.threed/shape/
---
...
La forma describe la deformación en un conjunto de puntos de control, lo cual es similar al deformador de clúster en Maya. Por ejemplo, podemos agregar una forma a una geometría creada. Y la forma y la geometría tienen la misma información topológica pero diferentes posiciones de los puntos de control. Con cantidades variables de influencia, la geometría produce un efecto de deformación.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [Shape()](#Shape--) | Inicializa una nueva instancia de la clase [Shape](../../com.aspose.threed/shape). |
| [Shape(String name)](#Shape-java.lang.String-) | Inicializa una nueva instancia de la clase [Shape](../../com.aspose.threed/shape). |
## Métodos
...
| [fromControlPoints(Vector3[] controlPoints)](#fromControlPoints-com.aspose.threed.Vector3...-) | Cree una forma con puntos de control especificados y con índices predeterminados. |
...
| [getIndices()](#getIndices--) | Obtiene los índices. |
...
Inicializa una nueva instancia de la clase [Shape](../../com.aspose.threed/shape).
...
Cree una forma con puntos de control especificados y con índices predeterminados.
...
**Returns:**
java.util.List<java.lang.Integer> - los índices.
### getName() {#getName--}
```

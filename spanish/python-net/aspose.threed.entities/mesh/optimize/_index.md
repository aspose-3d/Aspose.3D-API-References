...
type: docs
weight: 170
url: /es/python-net/aspose.threed.entities/mesh/optimize/
is_root: false
---
...
# Sphere.ToMesh genera 117 puntos de control
mesh = Sphere().to_mesh()
# Después de optimizar, solo hay 86 puntos de control, los índices de los polígonos también se reasignan.

...
type: docs
weight: 60
url: /es/python-net/aspose.threed.entities/polygonmodifier/merge_mesh/
is_root: false
---
...
# El archivo de entrada puede contener varios objetos
scene = Scene.from_file("input.fbx")
# ahora fusionarlos en una sola malla
merged = PolygonModifier.merge_mesh(scene)
# luego lo guardamos en un archivo con una sola malla

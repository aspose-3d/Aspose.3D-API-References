...
type: docs
weight: 40
url: /es/python-net/aspose.threed.profiles/circleshape/
is_root: false
---
...
| [`remove_property(self, property)`](/3d/python-net/aspose.threed.profiles/circleshape/remove_property/#system.string) | Remove the specified property identified by name |
| [`get_property(self, property)`](/3d/python-net/aspose.threed.profiles/circleshape/get_property/#system.string) | Get the value of specified property |
| [`set_property(self, property, value)`](/3d/python-net/aspose.threed.profiles/circleshape/set_property/#system.string-system.object) | Sets the value of specified property |
| [`find_property(self, property_name)`](/3d/python-net/aspose.threed.profiles/circleshape/find_property/#system.string) | Finds the property.

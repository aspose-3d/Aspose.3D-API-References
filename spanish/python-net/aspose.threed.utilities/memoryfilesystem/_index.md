...
type: docs
weight: 130
url: /es/python-net/aspose.threed.utilities/memoryfilesystem/
is_root: false
---
...
with BytesIO() as ms:
    scene.save(ms, opt)
# El test.obj se escribió en la variable ms, y también podemos obtener el contenido del archivo test.mtl mediante

...
type: docs
weight: 170
url: /el/python-net/aspose.threed.entities/mesh/optimize/
is_root: false
---
...
# Η μέθοδος Sphere.ToMesh δημιουργεί 117 σημεία ελέγχου
mesh = Sphere().to_mesh()
# Μετά τη βελτιστοποίηση, υπάρχουν μόνο 86 σημεία ελέγχου, οι δείκτες των πολυγώνων επίσης επαναχαρτογραφήθηκαν.

...
type: docs
weight: 90
url: /el/python-net/aspose.threed.entities/polygonmodifier/triangulate/
is_root: false
---
...
# Τριγωνοποιήστε αυτό το πλέγμα βασισμένο σε τετράγωνα σε πλέγμα βασισμένο σε τρίγωνα

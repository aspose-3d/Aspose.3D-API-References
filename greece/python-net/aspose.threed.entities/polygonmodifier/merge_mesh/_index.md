...
type: docs
weight: 60
url: /el/python-net/aspose.threed.entities/polygonmodifier/merge_mesh/
is_root: false
---
...
# Το αρχείο εισόδου μπορεί να περιέχει πολλαπλά αντικείμενα
scene = Scene.from_file("input.fbx")
# Τώρα συγχωνεύστε τα σε ένα ενιαίο πλέγμα
merged = PolygonModifier.merge_mesh(scene)
# Στη συνέχεια το αποθηκεύουμε σε ένα αρχείο με μόνο ένα πλέγμα

...
type: docs
weight: 60
url: /el/python-net/aspose.threed.formats/dracoformat/
is_root: false
---
...
| :- | :- |
| [formats](/3d/python-net/aspose.threed.formats/dracoformat/formats) | Access to all supported formats |
| [version](/3d/python-net/aspose.threed.formats/dracoformat/version) | Gets file format version |
...
| Method | Description |
| :- | :- |
| [`detect(, stream, file_name)`](/3d/python-net/aspose.threed.formats/dracoformat/detect/#io.rawiobase-system.string) | Detect the file format from data stream, file name is optional for guessing types that has no magic header. |
| [`detect(, file_name)`](/3d/python-net/aspose.threed.formats/dracoformat/detect/#system.string) | Detect the file format from file name, file must be readable so Aspose.3D can detect the file format through file header. |
| [`decode(self, file_name)`](/3d/python-net/aspose.threed.formats/dracoformat/decode/#system.string) | Decode the point cloud or mesh from specified file name |
| [`decode(self, data)`](/3d/python-net/aspose.threed.formats/dracoformat/decode/#bytes) | Decode the point cloud or mesh from memory data |
| [`encode(self, entity, stream, options)`](/3d/python-net/aspose.threed.formats/dracoformat/encode/#aspose.threed.entity-io.rawiobase-aspose.threed.formats.dracosaveoptions) | Encode the entity to specified stream |
| [`encode(self, entity, file_name, options)`](/3d/python-net/aspose.threed.formats/dracoformat/encode/#aspose.threed.entity-system.string-aspose.threed.formats.dracosaveoptions) | Encode the entity to specified file |
| [`encode(self, entity, options)`](/3d/python-net/aspose.threed.formats/dracoformat/encode/#aspose.threed.entity-aspose.threed.formats.dracosaveoptions) | Encode the entity to Draco raw data |
| [`get_format_by_extension(, extension_name)`](/3d/python-net/aspose.threed.formats/dracoformat/get_format_by_extension/#system.string) | Gets the preferred file format from the file extension name
<br/>The extension name should starts with a dot('.'). |
| [`create_load_options(self)`](/3d/python-net/aspose.threed.formats/dracoformat/create_load_options/#) | Create a default load options for this file format |
| [`create_save_options(self)`](/3d/python-net/aspose.threed.formats/dracoformat/create_save_options/#) | Create a default save options for this file format |
...
mesh = Sphere().to_mesh()
# Κωδικοποίηση του πλέγματος σε μορφή Draco
draco = FileFormat.DRACO.encode(mesh)
# Αποκωδικοποίηση του πλέγματος από τη μορφή Draco

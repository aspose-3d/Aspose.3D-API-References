...
type: docs
weight: 130
url: /el/python-net/aspose.threed.utilities/memoryfilesystem/
is_root: false
---
...
# δημιουργήστε μια σκηνή με υλικό
scene = Scene()
scene.root_node.create_child_node(Box()).material = LambertMaterial()
# δημιουργήστε μια επιλογή αποθήκευσης και καθορίστε το σύστημα αρχείων, ώστε το εξαρτημένο αρχείο να γραφτεί στη μνήμη
opt = FileFormat.WAVEFRONT_OBJ.create_save_options()
mfs = MemoryFileSystem()
opt.file_system = mfs
# Το όνομα αρχείου υλικού του obj συνδέεται με το όνομα αρχείου του obj, επομένως χρειαζόμαστε ένα σαφές όνομα.
opt.file_name = "test.obj"
with BytesIO() as ms:
    scene.save(ms, opt)
# το test.obj γράφτηκε στη μεταβλητή ms, και μπορούμε επίσης να πάρουμε το περιεχόμενο του αρχείου test.mtl με

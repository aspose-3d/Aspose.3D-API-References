...
url: /el/nodejs-java/aspose.threed/compositecurve/
---
## CompositeCurve class

Ένα CompositeCurve αποτελείται από αρκετά τμήματα καμπύλης.
...
| Όνομα | Περιγραφή |
| --- | --- |
| constructor() | Κατασκευαστής του CompositeCurve |
...
| Όνομα | Περιγραφή |
| --- | --- |
| getSegments() | Τα τμήματα της καμπύλης. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| addSegment(curve, sameDirection) | Το |

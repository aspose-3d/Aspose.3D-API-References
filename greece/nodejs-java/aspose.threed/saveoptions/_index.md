...
url: /el/nodejs-java/aspose.threed/saveoptions/
---
## SaveOptions class

Η βασική κλάση για τη διαμόρφωση επιλογών στην αποθήκευση αρχείων για διαφορετικούς τύπους  @hideconstructor

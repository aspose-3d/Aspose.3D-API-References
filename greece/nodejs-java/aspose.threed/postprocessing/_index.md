...
url: /el/nodejs-java/aspose.threed/postprocessing/
---
## PostProcessing class

Τα εφέ μετα-επεξεργασίας  @hideconstructor
...
| Όνομα | Περιγραφή |
| --- | --- |
| getInput() | Είσοδος αυτής της μετα-επεξεργασίας |
...
| Όνομα | Περιγραφή |
| --- | --- |
| setInput(value) | Είσοδος αυτής της μετα-επεξεργασίας |

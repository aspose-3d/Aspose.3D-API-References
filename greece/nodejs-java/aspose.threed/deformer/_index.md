...
url: /el/nodejs-java/aspose.threed/deformer/
---
## Deformer class

Βασική κλάση για SkinDeformer και MorphTargetDeformer
...
| Όνομα | Περιγραφή |
| --- | --- |
| constructor(name) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης Deformer. |

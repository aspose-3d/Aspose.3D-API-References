...
| Όνομα | Περιγραφή |
| --- | --- |
| constructor() | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης Patch. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| constructor_overload(name) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης Patch. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| getU() | Λαμβάνει την κατεύθυνση u. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| getV() | Λαμβάνει την κατεύθυνση v. Το v. |

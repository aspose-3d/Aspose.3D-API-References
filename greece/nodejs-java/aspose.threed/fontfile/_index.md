...
url: /el/nodejs-java/aspose.threed/fontfile/
---
## FontFile class

Το αρχείο γραμματοσειράς περιέχει ορισμούς για γλύφους, χρησιμοποιείται για τη δημιουργία προφίλ κειμένου.  @hideconstructor
...
| Όνομα | Περιγραφή |
| --- | --- |
| fromFile(fileName) | Φορτώστε το FontFile από το όνομα αρχείου |

 **Parameters:**

| Όνομα | Τύπος | Περιγραφή |
| --- | --- | --- |
| fileName | String | Διαδρομή προς το αρχείο γραμματοσειράς |
...
| Όνομα | Περιγραφή |
| --- | --- |
| parse(bytes) | Αναλύστε το FontFile από bytes |

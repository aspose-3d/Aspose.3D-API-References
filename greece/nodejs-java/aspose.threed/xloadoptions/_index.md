...
url: /el/nodejs-java/aspose.threed/xloadoptions/
---
## XLoadOptions class
...
| Όνομα | Περιγραφή |
| --- | --- |
| constructor(contentType) | Κατασκευαστής του XLoadOptions |
...
| Όνομα | Περιγραφή |
| --- | --- |
| getFlipCoordinateSystem() | Αναστρέψτε το σύστημα συντεταγμένων, αυτό είναι αληθές εξ ορισμού |
...
| Όνομα | Περιγραφή |
| --- | --- |
| setFlipCoordinateSystem(value) | Αναστρέψτε το σύστημα συντεταγμένων, αυτό είναι αληθές εξ ορισμού |

...
url: /el/nodejs-java/aspose.threed/arbitraryprofile/
---
## ArbitraryProfile class

Αυτή η κλάση σας επιτρέπει να δημιουργήσετε ένα προφίλ 2D απευθείας από αυθαίρετη καμπύλη.
...
| Όνομα | Περιγραφή |
| --- | --- |
| constructor() | Κατασκευαστής του ArbitraryProfile |
...
| Όνομα | Περιγραφή |
| --- | --- |
| constructor_overload(curve) | Κατασκευαστής του ArbitraryProfile με αρχική καμπύλη. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| getCurve() | Η Καμπύλη που χρησιμοποιείται για τη δημιουργία του προφίλ |
...
| Όνομα | Περιγραφή |
| --- | --- |
| setCurve(value) | Η Καμπύλη που χρησιμοποιείται για τη δημιουργία του προφίλ |

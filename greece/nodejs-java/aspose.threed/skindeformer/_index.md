...
url: /el/nodejs-java/aspose.threed/skindeformer/
---
## SkinDeformer class

Ένας skin deformer περιέχει πολλαπλά οστά για λειτουργία, κάθε οστό συνδυάζει ένα μέρος της γεωμετρίας βάσει των βαρών των σημείων ελέγχου.
...
| Όνομα | Περιγραφή |
| --- | --- |
| constructor(name) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης SkinDeformer. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| constructor_overload() | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης SkinDeformer. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| getBones() | Λαμβάνει όλα τα οστά που περιέχει ο SkinDeformer. |

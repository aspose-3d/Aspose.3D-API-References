...
url: /el/nodejs-java/aspose.threed/customobject/
---
## CustomObject class

Τα μεταδεδομένα ή προσαρμοσμένα αντικείμενα που χρησιμοποιούνται σε αρχεία 3D διαχειρίζονται από αυτήν την κλάση.  Όλες οι προσαρμοσμένες ιδιότητες αποθηκεύονται ως δυναμικές ιδιότητες.
...
| Όνομα | Περιγραφή |
| --- | --- |
| constructor() | Αρχικοποιεί μια νέα παρουσία της κλάσης CustomObject. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| constructor_overload(name) | Αρχικοποιεί μια νέα παρουσία της κλάσης CustomObject. |

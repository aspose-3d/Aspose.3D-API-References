...
url: /el/nodejs-java/aspose.threed/zshape/
---
## ZShape class

Προφίλ Z-σχήματος συμβατό με IFC, ορισμένο από παραμέτρους.
...
| Όνομα | Περιγραφή |
| --- | --- |
| constructor() | Κατασκευαστής της ZShape |
...
| Όνομα | Περιγραφή |
| --- | --- |
| getDepth() | Λαμβάνει ή ορίζει το μήκος του πλέγματος. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| setDepth(value) | Λαμβάνει ή ορίζει το μήκος του πλέγματος. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| getFlangeWidth() | Λαμβάνει ή ορίζει το μήκος της πλάτης. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| setFlangeWidth(value) | Λαμβάνει ή ορίζει το μήκος της πλάτης. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| getWebThickness() | Λαμβάνει ή ορίζει το πάχος του τοίχου. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| setWebThickness(value) | Λαμβάνει ή ορίζει το πάχος του τοίχου. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| getFlangeThickness() | Λαμβάνει ή ορίζει το πάχος της πλάτης. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| setFlangeThickness(value) | Λαμβάνει ή ορίζει το πάχος της πλάτης. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| getFilletRadius() | Λαμβάνει ή ορίζει την ακτίνα του στρογγυλοποίησης μεταξύ πλάτης και πλέγματος. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| setFilletRadius(value) | Λαμβάνει ή ορίζει την ακτίνα του στρογγυλοποίησης μεταξύ πλάτης και πλέγματος. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| getEdgeRadius() | Λαμβάνει ή ορίζει την ακτίνα της άκρης της πλάτης. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| setEdgeRadius(value) | Λαμβάνει ή ορίζει την ακτίνα της άκρης της πλάτης. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| getExtent() | Λαμβάνει την έκταση στις διαστάσεις x και y. |

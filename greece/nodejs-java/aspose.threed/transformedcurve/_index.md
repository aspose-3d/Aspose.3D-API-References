...
url: /el/nodejs-java/aspose.threed/transformedcurve/
---
## TransformedCurve class

Ένα TransformedCurve δίνει σε μια καμπύλη θέση χρησιμοποιώντας έναν πίνακα μετασχηματισμού. Αυτό επιτρέπει την εκτέλεση μετασχηματισμού μέσα σε ένα TrimmedCurve ή CompositeCurve.
...
| Όνομα | Περιγραφή |
| --- | --- |
| constructor() | Ο κατασκευαστής της TransformedCurve |
...
| Όνομα | Περιγραφή |
| --- | --- |
| constructor_overload(basisCurve, transformation) | Ο κατασκευαστής της TransformedCurve |
...
| Όνομα | Περιγραφή |
| --- | --- |
| getTransformMatrix() | Ο πίνακας μετασχηματισμού. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| setTransformMatrix(value) | Ο πίνακας μετασχηματισμού. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| getBasisCurve() | Η βασική καμπύλη. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| setBasisCurve(value) | Η βασική καμπύλη. |

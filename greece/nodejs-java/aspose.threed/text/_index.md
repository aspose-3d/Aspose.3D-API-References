...
url: /el/nodejs-java/aspose.threed/text/
---
## Text class

Προφίλ κειμένου, αυτό το προφίλ περιγράφει τα περιγράμματα χρησιμοποιώντας γραμματοσειρά και κείμενο.
...
| Όνομα | Περιγραφή |
| --- | --- |
| getContent() | Περιεχόμενο του κειμένου |
...
| Όνομα | Περιγραφή |
| --- | --- |
| setContent(value) | Περιεχόμενο του κειμένου |
...
| Όνομα | Περιγραφή |
| --- | --- |
| getFont() | Η γραμματοσειρά του κειμένου. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| setFont(value) | Η γραμματοσειρά του κειμένου. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| getFontSize() | Κλίμακα μεγέθους γραμματοσειράς. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| setFontSize(value) | Κλίμακα μεγέθους γραμματοσειράς. |

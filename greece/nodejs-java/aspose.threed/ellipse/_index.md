...
url: /el/nodejs-java/aspose.threed/ellipse/
---
## Ellipse class

Μία Έλλειψη ορίζει ένα σύνολο σημείων που σχηματίζουν το σχήμα της έλλειψης.
...
| Όνομα | Περιγραφή |
| --- | --- |
| constructor() | Κατασκευαστής της Έλλειψης |
...
| Όνομα | Περιγραφή |
| --- | --- |
| constructor_overload(semiAxis1, semiAxis2) | Κατασκευαστής της Έλλειψης |
...
| Όνομα | Περιγραφή |
| --- | --- |
| getSemiAxis1() | Ακτίνα στον άξονα X |
...
| Όνομα | Περιγραφή |
| --- | --- |
| setSemiAxis1(value) | Ακτίνα στον άξονα X |
...
| Όνομα | Περιγραφή |
| --- | --- |
| getSemiAxis2() | Ακτίνα στον άξονα Y |
...
| Όνομα | Περιγραφή |
| --- | --- |
| setSemiAxis2(value) | Ακτίνα στον άξονα Y |

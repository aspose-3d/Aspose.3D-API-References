...
url: /el/nodejs-java/aspose.threed/mirroredprofile/
---
## MirroredProfile class

Προφίλ καθρέφτη συμβατό με IFC.  Αυτό το προφίλ ορίζει ένα νέο προφίλ αντικατοπτρίζοντας το βασικό προφίλ γύρω από τον άξονα y.
...
| Όνομα | Περιγραφή |
| --- | --- |
| constructor(baseProfile) | Δημιουργεί ένα νέο MirroredProfile από ένα υπάρχον προφίλ. |

 **Parameters:**

| Όνομα | Τύπος | Περιγραφή |
| --- | --- | --- |
| baseProfile | Προφίλ | Το βασικό προφίλ που θα κατοπτριστεί. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| getBaseProfile() | Το βασικό προφίλ που θα κατοπτριστεί. |

...
url: /el/nodejs-java/aspose.threed/ellipseshape/
---
## EllipseShape class

Συμβατό με IFC σχήμα έλλειψης που ορίζεται από παραμέτρους.  Η κεντρική θέση του προφίλ βρίσκεται στο κέντρο του περιοριστικού πλαισίου.
...
| Όνομα | Περιγραφή |
| --- | --- |
| getSemiAxis1() | Λαμβάνει ή ορίζει την πρώτη ακτίνα του έλλειψης που μετράται στην κατεύθυνση του άξονα x. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| setSemiAxis1(value) | Λαμβάνει ή ορίζει την πρώτη ακτίνα του έλλειψης που μετράται στην κατεύθυνση του άξονα x. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| getSemiAxis2() | Λαμβάνει ή ορίζει τη δεύτερη ακτίνα του έλλειψης που μετράται στην κατεύθυνση του άξονα y. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| setSemiAxis2(value) | Λαμβάνει ή ορίζει τη δεύτερη ακτίνα του έλλειψης που μετράται στην κατεύθυνση του άξονα y. |

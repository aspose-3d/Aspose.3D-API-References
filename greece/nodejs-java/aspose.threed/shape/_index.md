...
| Όνομα | Περιγραφή |
| --- | --- |
| constructor() | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης Shape. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| constructor_overload(name) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης Shape. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| getIndices() | Αποκτά τα ευρετήρια. Τα ευρετήρια. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| fromControlPoints(controlPoints) | Δημιουργεί ένα σχήμα με καθορισμένα σημεία ελέγχου με προεπιλεγμένα ευρετήρια. |

...
description: "Επιλογές αποθήκευσης για STL"
type: docs
weight: 177
url: /el/java/com.aspose.threed/stlsaveoptions/
---
...
Επιλογές αποθήκευσης για STL
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [StlSaveOptions()](#StlSaveOptions--) | Αρχικοποιεί ένα νέο αντικείμενο [StlSaveOptions](../../com.aspose.threed/stlsaveoptions). |
| [StlSaveOptions(FileContentType contentType)](#StlSaveOptions-com.aspose.threed.FileContentType-) | Αρχικοποιεί ένα νέο αντικείμενο [StlSaveOptions](../../com.aspose.threed/stlsaveoptions). |
## Μέθοδοι
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | Λαμβάνει αν γίνεται αντιστροφή του συστήματος συντεταγμένων των σημείων ελέγχου/κανονικής κατά την εξαγωγή. |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | Ορίζει αν γίνεται αντιστροφή του συστήματος συντεταγμένων των σημείων ελέγχου/κανονικής κατά την εξαγωγή. |
...
Αρχικοποιεί ένα νέο αντικείμενο [StlSaveOptions](../../com.aspose.threed/stlsaveoptions).
...
Λαμβάνει αν γίνεται αντιστροφή του συστήματος συντεταγμένων των σημείων ελέγχου/κανονικής κατά την εξαγωγή.

**Returns:**
boolean - εάν αντιστρέψετε το σύστημα συντεταγμένων των σημείων ελέγχου/κανονικών κατά την εξαγωγή.
...
Ορίζει αν γίνεται αντιστροφή του συστήματος συντεταγμένων των σημείων ελέγχου/κανονικής κατά την εξαγωγή.

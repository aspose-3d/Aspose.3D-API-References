...
description: Σχήμα έλλειψης συμβατό με IFC που ορίζεται από παραμέτρους.
type: docs
weight: 50
url: /el/java/com.aspose.threed/ellipseshape/
---
...
Σχήμα έλλειψης συμβατό με IFC που ορίζεται από παραμέτρους. Η κεντρική θέση του προφίλ βρίσκεται στο κέντρο του περιοριστικού πλαισίου.
## Constructors
...
| [getSemiAxis1()](#getSemiAxis1--) | Λαμβάνει την πρώτη ακτίνα της έλλειψης που μετράται στην κατεύθυνση του άξονα x. |
| [getSemiAxis2()](#getSemiAxis2--) | Λαμβάνει τη δεύτερη ακτίνα της έλλειψης που μετράται στην κατεύθυνση του άξονα y. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setSemiAxis1(double value)](#setSemiAxis1-double-) | Ορίζει την πρώτη ακτίνα της έλλειψης που μετράται στην κατεύθυνση του άξονα x. |
| [setSemiAxis2(double value)](#setSemiAxis2-double-) | Ορίζει τη δεύτερη ακτίνα της έλλειψης που μετράται στην κατεύθυνση του άξονα y. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Λαμβάνει την πρώτη ακτίνα της έλλειψης που μετράται στην κατεύθυνση του άξονα x.

**Returns:**
double - η πρώτη ακτίνα της έλλειψης που μετράται στην κατεύθυνση του άξονα x.
...
Λαμβάνει τη δεύτερη ακτίνα της έλλειψης που μετράται στην κατεύθυνση του άξονα y.

**Returns:**
double - η δεύτερη ακτίνα της έλλειψης που μετράται στην κατεύθυνση του άξονα y.
### hashCode() {#hashCode--}
```
...
Ορίζει την πρώτη ακτίνα της έλλειψης που μετράται στην κατεύθυνση του άξονα x.
...
Ορίζει τη δεύτερη ακτίνα της έλλειψης που μετράται στην κατεύθυνση του άξονα y.

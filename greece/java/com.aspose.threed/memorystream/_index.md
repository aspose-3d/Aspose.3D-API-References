...
description: "Δημιουργήθηκε από lexchou στις 6/13/2017."
type: docs
weight: 101
url: /el/java/com.aspose.threed/memorystream/
---
...
Δημιουργήθηκε από lexchou στις 6/13/2017.
## Κατασκευαστές
...
| [setCapacity(int cap)](#setCapacity-int-) | Ορίζει τη χωρητικότητα στην καθορισμένη τιμή |
...
| [wrap(OutputStream stream)](#wrap-java.io.OutputStream-) | Τυλίξτε ένα OutputStream ως Stream, η ροή πρέπει να κλείσει για να εκκενώσει τα δεδομένα στην έξοδο ροής. |
...
Ορίζει τη χωρητικότητα στην καθορισμένη τιμή

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| cap | int | νέα χωρητικότητα του MemoryStream. |
...
Τυλίξτε ένα OutputStream ως Stream, η ροή πρέπει να κλείσει για να εκκενώσει τα δεδομένα στην έξοδο ροής.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| ροή | java.io.OutputStream | output stream για τυλίξιμο |

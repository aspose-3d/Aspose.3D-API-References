...
description: Συμβατό με IFC σχήμα τραπεζίου ορισμένο από παραμέτρους.
type: docs
weight: 193
url: /el/java/com.aspose.threed/trapeziumshape/
---
...
Συμβατό με IFC σχήμα τραπεζίου ορισμένο από παραμέτρους.
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [TrapeziumShape()](#TrapeziumShape--) | Κατασκευαστής του [TrapeziumShape](../../com.aspose.threed/trapeziumshape) |
## Μέθοδοι
...
| [getBottomXDim()](#getBottomXDim--) | Λαμβάνει το μέγεθος της κάτω γραμμής μετρημένο κατά τον άξονα x. |
...
| [getTopXDim()](#getTopXDim--) | Λαμβάνει το μέγεθος της άνω γραμμής μετρημένο κατά τον άξονα x. |
| [getTopXOffset()](#getTopXOffset--) | Λαμβάνει τη μετατόπιση από την αρχή της άνω γραμμής προς την κάτω γραμμή. |
| [getYDim()](#getYDim--) | Λαμβάνει την απόσταση μεταξύ της άνω και της κάτω γραμμής μετρημένη κατά τον άξονα y. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setBottomXDim(double value)](#setBottomXDim-double-) | Ορίζει το μέγεθος της κάτω γραμμής μετρημένο κατά τον άξονα x. |
...
| [setTopXDim(double value)](#setTopXDim-double-) | Ορίζει το μέγεθος της άνω γραμμής μετρημένο κατά τον άξονα x. |
| [setTopXOffset(double value)](#setTopXOffset-double-) | Ορίζει τη μετατόπιση από την αρχή της άνω γραμμής προς την κάτω γραμμή. |
| [setYDim(double value)](#setYDim-double-) | Ορίζει την απόσταση μεταξύ της άνω και της κάτω γραμμής μετρημένη κατά τον άξονα y. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Κατασκευαστής του [TrapeziumShape](../../com.aspose.threed/trapeziumshape)
...
Λαμβάνει το μέγεθος της κάτω γραμμής μετρημένο κατά τον άξονα x.

**Returns:**
double - το μέγεθος της κάτω γραμμής μετρημένο κατά τον άξονα x.
...
Λαμβάνει το μέγεθος της άνω γραμμής μετρημένο κατά τον άξονα x.

**Returns:**
double - το μέγεθος της άνω γραμμής μετρημένο κατά τον άξονα x.
...
Λαμβάνει τη μετατόπιση από την αρχή της άνω γραμμής προς την κάτω γραμμή.

**Returns:**
double - η μετατόπιση από την αρχή της άνω γραμμής προς την κάτω γραμμή.
### getYDim() {#getYDim--}
```
...
Λαμβάνει την απόσταση μεταξύ της άνω και της κάτω γραμμής μετρημένη κατά τον άξονα y.

**Returns:**
double - η απόσταση μεταξύ της άνω και της κάτω γραμμής μετρημένη κατά τον άξονα y.
### hashCode() {#hashCode--}
```
...
Ορίζει το μέγεθος της κάτω γραμμής μετρημένο κατά τον άξονα x.
...
Ορίζει το μέγεθος της άνω γραμμής μετρημένο κατά τον άξονα x.
...
Ορίζει τη μετατόπιση από την αρχή της άνω γραμμής προς την κάτω γραμμή.
...
Ορίζει την απόσταση μεταξύ της άνω και της κάτω γραμμής μετρημένη κατά τον άξονα y.

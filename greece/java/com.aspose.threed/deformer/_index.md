...
description: "Βασική κλάση για  και"
type: docs
weight: 41
url: /el/java/com.aspose.threed/deformer/
---
...
Βασική κλάση για [SkinDeformer](../../com.aspose.threed/skindeformer) και [MorphTargetDeformer](../../com.aspose.threed/morphtargetdeformer)
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [Deformer(String name)](#Deformer-java.lang.String-) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [Deformer](../../com.aspose.threed/deformer). |
## Μέθοδοι
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [Deformer](../../com.aspose.threed/deformer).

...
description: "Επιλογές φόρτωσης για τη μορφή Fbx."
type: docs
weight: 62
url: /el/java/com.aspose.threed/fbxloadoptions/
---
...
Επιλογές φόρτωσης για τη μορφή Fbx.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [FbxLoadOptions(FileFormat format)](#FbxLoadOptions-com.aspose.threed.FileFormat-) | Κατασκευαστής του [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions) |
| [FbxLoadOptions()](#FbxLoadOptions--) | Κατασκευαστής του [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions) |
## Μέθοδοι
...
| [getClass()](#getClass--) |  |
| [getCompatibleMode()](#getCompatibleMode--) | Λαμβάνει εάν να ενεργοποιηθεί η συμβατή λειτουργία. |
...
| [getKeepBuiltinGlobalSettings()](#getKeepBuiltinGlobalSettings--) | Λαμβάνει εάν να διατηρηθούν οι ενσωματωμένες ιδιότητες στο GlobalSettings που έχουν αντικατάσταση ιδιότητας εγγενή στο [AssetInfo](../../com.aspose.threed/assetinfo). |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setCompatibleMode(boolean value)](#setCompatibleMode-boolean-) | Ορίζει εάν να ενεργοποιηθεί η συμβατή λειτουργία. |
...
| [setKeepBuiltinGlobalSettings(boolean value)](#setKeepBuiltinGlobalSettings-boolean-) | Ορίζει εάν να διατηρηθούν οι ενσωματωμένες ιδιότητες στο GlobalSettings που έχουν αντικατάσταση ιδιότητας εγγενή στο [AssetInfo](../../com.aspose.threed/assetinfo). |
...
Κατασκευαστής του [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions)

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| format | [FileFormat](../../com.aspose.threed/fileformat) | Παράδειγμα του [getFileFormat](../../com.aspose.threed/fbxloadoptions\#getFileFormat), πρέπει να είναι έγκυρη μορφή FBX. |
...
Λαμβάνει εάν να ενεργοποιηθεί η συμβατή λειτουργία. Η συμβατή λειτουργία θα προσπαθήσει να υποστηρίξει μη τυπικούς ορισμούς FBX όπως υλικά PBR που εξάγονται από το Blender. Η προεπιλεγμένη τιμή είναι ψευδής.

**Returns:**
boolean - εάν να ενεργοποιηθεί η συμβατή λειτουργία. Η συμβατή λειτουργία θα προσπαθήσει να υποστηρίξει μη τυπικούς ορισμούς FBX όπως υλικά PBR που εξάγονται από το Blender. Η προεπιλεγμένη τιμή είναι ψευδής.
...
Λαμβάνει εάν να διατηρηθούν οι ενσωματωμένες ιδιότητες στο GlobalSettings που έχουν αντικατάσταση ιδιότητας εγγενή στο [AssetInfo](../../com.aspose.threed/assetinfo). Ορίστε το σε true εάν θέλετε τις πλήρεις ιδιότητες στο GlobalSettings. Η προεπιλεγμένη τιμή είναι ψευδής

**Returns:**
boolean - εάν να διατηρηθούν οι ενσωματωμένες ιδιότητες στο GlobalSettings που έχουν αντικατάσταση ιδιότητας εγγενή στο [AssetInfo](../../com.aspose.threed/assetinfo). Ορίστε το σε true εάν θέλετε τις πλήρεις ιδιότητες στο GlobalSettings. Η προεπιλεγμένη τιμή είναι ψευδής
...
Ορίζει εάν να ενεργοποιηθεί η συμβατή λειτουργία. Η συμβατή λειτουργία θα προσπαθήσει να υποστηρίξει μη τυπικούς ορισμούς FBX όπως υλικά PBR που εξάγονται από το Blender. Η προεπιλεγμένη τιμή είναι ψευδής.
...
Ορίζει εάν να διατηρηθούν οι ενσωματωμένες ιδιότητες στο GlobalSettings που έχουν αντικατάσταση ιδιότητας εγγενή στο [AssetInfo](../../com.aspose.threed/assetinfo). Ορίστε το σε true εάν θέλετε τις πλήρεις ιδιότητες στο GlobalSettings. Η προεπιλεγμένη τιμή είναι ψευδής

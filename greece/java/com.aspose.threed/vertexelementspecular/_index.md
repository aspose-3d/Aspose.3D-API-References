...
description: Ορίζει το κατοπτρικό χρώμα για τα καθορισμένα στοιχεία.
type: docs
weight: 217
url: /el/java/com.aspose.threed/vertexelementspecular/
---
...
Ορίζει το κατοπτρικό χρώμα για τα καθορισμένα στοιχεία.
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [VertexElementSpecular()](#VertexElementSpecular--) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [VertexElementSpecular](../../com.aspose.threed/vertexelementspecular). |
## Μέθοδοι
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [VertexElementSpecular](../../com.aspose.threed/vertexelementspecular).

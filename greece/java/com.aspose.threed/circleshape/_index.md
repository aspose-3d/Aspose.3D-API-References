...
description: "Προφίλ κύκλου συμβατό με IFC που μπορεί να χρησιμοποιηθεί για την κατασκευή ενός πλέγματος μέσω"
type: docs
weight: 32
url: /el/java/com.aspose.threed/circleshape/
---
...
Προφίλ κύκλου συμβατό με IFC, που μπορεί να χρησιμοποιηθεί για την κατασκευή ενός πλέγματος μέσω του [LinearExtrusion](../../com.aspose.threed/linearextrusion).
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [CircleShape()](#CircleShape--) | Δημιουργήστε ένα προφίλ [CircleShape](../../com.aspose.threed/circleshape) με προεπιλεγμένη ακτίνα (5). |
| [CircleShape(double radius)](#CircleShape-double-) | Δημιουργήστε ένα προφίλ [CircleShape](../../com.aspose.threed/circleshape) με καθορισμένη ακτίνα. |
## Μέθοδοι
...
| [getRadius()](#getRadius--) | Λαμβάνει την ακτίνα του κύκλου. |
...
| [setRadius(double value)](#setRadius-double-) | Ορίζει την ακτίνα του κύκλου. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Δημιουργήστε ένα προφίλ [CircleShape](../../com.aspose.threed/circleshape) με προεπιλεγμένη ακτίνα (5).
...
Δημιουργήστε ένα προφίλ [CircleShape](../../com.aspose.threed/circleshape) με καθορισμένη ακτίνα.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| ακτίνα | double | Ακτίνα του κύκλου |
...
Λαμβάνει την ακτίνα του κύκλου.

**Returns:**
double - η ακτίνα του κύκλου.
### getScene() {#getScene--}
```

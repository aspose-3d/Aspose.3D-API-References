...
description: Πιάτο με παραμέτρους.
type: docs
weight: 45
url: /el/java/com.aspose.threed/dish/
---
...
Πιάτο με παραμέτρους.
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [Dish()](#Dish--) | Δημιουργήστε ένα νέο αντικείμενο πιάτου με προεπιλεγμένη ακτίνα (10) και προεπιλεγμένο ύψος (5) |
| [Dish(double radius, double height)](#Dish-double-double-) | Δημιουργήστε ένα νέο αντικείμενο πιάτου με καθορισμένη ακτίνα και ύψος |
| [Dish(String name, double radius, double height, int widthSegments, int heightSegments)](#Dish-java.lang.String-double-double-int-int-) | Δημιουργήστε ένα νέο αντικείμενο πιάτου με καθορισμένη ακτίνα και ύψος |
## Μέθοδοι
...
| [getHeight()](#getHeight--) | Ύψος του πιάτου |
...
| [getRadius()](#getRadius--) | Ακτίνα του πιάτου |
...
| [setHeight(double value)](#setHeight-double-) | Ύψος του πιάτου |
...
| [setRadius(double value)](#setRadius-double-) | Ακτίνα του πιάτου |
...
Δημιουργήστε ένα νέο αντικείμενο πιάτου με προεπιλεγμένη ακτίνα (10) και προεπιλεγμένο ύψος (5)
...
Δημιουργήστε ένα νέο αντικείμενο πιάτου με καθορισμένη ακτίνα και ύψος

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| ακτίνα | double | Η ακτίνα του πιάτου |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| name | java.lang.String | Το όνομα του πιάτου |
| ακτίνα | double | Η ακτίνα του πιάτου |
| height | double | Το ύψος του πιάτου |
| widthSegments | int | Το τμήμα πλάτους του πιάτου |
| heightSegments | int | Το τμήμα ύψους του πιάτου |

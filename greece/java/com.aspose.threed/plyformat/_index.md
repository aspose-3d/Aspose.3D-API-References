...
|  | stream | [Stream](../../com.aspose.threed/stream) | Η ροή για εγγραφή, αυτή η μέθοδος δεν θα κλείσει αυτή τη ροή **Example:** Ο παρακάτω κώδικας δείχνει πώς να κωδικοποιήσετε ένα πλέγμα σε αρχείο PLY: |
...
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | Η οντότητα προς κωδικοποίηση |
| stream | [Stream](../../com.aspose.threed/stream) | Η ροή για εγγραφή, αυτή η μέθοδος δεν θα κλείσει αυτή τη ροή |
|  | opt | [PlySaveOptions](../../com.aspose.threed/plysaveoptions) | Επιλογές αποθήκευσης **Example:** Ο παρακάτω κώδικας δείχνει πώς να κωδικοποιήσετε ένα πλέγμα σε αρχείο PLY: |
...
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | Η οντότητα προς κωδικοποίηση |
|  | fileName | java.lang.String | Το αρχείο για εγγραφή **Example:** Ο παρακάτω κώδικας δείχνει πώς να κωδικοποιήσετε ένα πλέγμα σε αρχείο PLY: |

...
description: "Ένα  αντιπροσωπεύει τις λογικές σχέσεις του ."
type: docs
weight: 75
url: /el/java/com.aspose.threed/group/
---
...
Ένα [Group](../../com.aspose.threed/group) αντιπροσωπεύει τις λογικές σχέσεις του [Node](../../com.aspose.threed/node).
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [Group(String name)](#Group-java.lang.String-) | Δημιουργήστε ένα νέο παράδειγμα του [Group](../../com.aspose.threed/group) |
| [Group()](#Group--) | Δημιουργήστε ένα νέο παράδειγμα του [Group](../../com.aspose.threed/group) |
## Μέθοδοι
...
| [getClass()](#getClass--) |  |
| [getGroups()](#getGroups--) | Υποομάδες |
| [getName()](#getName--) | Λαμβάνει το όνομα. |
| [getNodes()](#getNodes--) | Οι κόμβοι σε αυτήν την ομάδα |
| [getParent()](#getParent--) | Γονική ομάδα της τρέχουσας ομάδας |
...
| [toString()](#toString--) | Λαμβάνει την αναπαράσταση ως συμβολοσειρά του [Group](../../com.aspose.threed/group) |
| [wait()](#wait--) |  |
...
Δημιουργήστε ένα νέο παράδειγμα του [Group](../../com.aspose.threed/group)

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| name | java.lang.String | Όνομα της Group |
...
**Returns:**
java.util.List<com.aspose.threed.Group> - Υπο-ομάδες
### getName() {#getName--}
```
...
Οι κόμβοι σε αυτήν την ομάδα

**Returns:**
java.util.List<com.aspose.threed.Node> - Οι κόμβοι σε αυτήν την ομάδα
### getParent() {#getParent--}
```
...
Γονική ομάδα της τρέχουσας ομάδας
...
Λαμβάνει την αναπαράσταση ως συμβολοσειρά του [Group](../../com.aspose.threed/group)

**Returns:**
java.lang.String - Η αναπαράσταση ως συμβολοσειρά της τρέχουσας παρουσίας
### wait() {#wait--}
```

...
description: Οι επιλογές φόρτωσης για αρχεία DirectX X.
type: docs
weight: 233
url: /el/java/com.aspose.threed/xloadoptions/
---
...
Οι επιλογές φόρτωσης για αρχεία DirectX X.
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [XLoadOptions(FileContentType contentType)](#XLoadOptions-com.aspose.threed.FileContentType-) | Κατασκευαστής του [XLoadOptions](../../com.aspose.threed/xloadoptions) |
## Μέθοδοι
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | Αναστροφή του συστήματος συντεταγμένων, αυτό είναι αληθές εξ ορισμού |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | Αναστροφή του συστήματος συντεταγμένων, αυτό είναι αληθές εξ ορισμού |
...
Κατασκευαστής του [XLoadOptions](../../com.aspose.threed/xloadoptions)
...
Αναστροφή του συστήματος συντεταγμένων, αυτό είναι αληθές εξ ορισμού

**Returns:**
boolean - Αναστροφή του συστήματος συντεταγμένων, αυτό είναι αληθές εξ ορισμού

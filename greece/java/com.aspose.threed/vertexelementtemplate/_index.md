...
type: docs
weight: 219
url: /el/java/com.aspose.threed/vertexelementtemplate/
---
...
| [copyTo(VertexElementTemplate<T> target)](#copyTo-com.aspose.threed.VertexElementTemplate-T--) | Αντιγράφει δεδομένα στο καθορισμένο στοιχείο |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(T[] data)](#setData-T---) | Φόρτωση δεδομένων |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| target | [VertexElementTemplate](../../com.aspose.threed/vertexelementtemplate) | Στόχος. |

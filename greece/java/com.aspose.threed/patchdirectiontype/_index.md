...
description: "Τύποι κατευθύνσεων patch."
type: docs
weight: 287
url: /el/java/com.aspose.threed/patchdirectiontype/
---
...
Τύποι κατεύθυνσης του patch.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
|  | [BASIS_SPLINE](#BASIS-SPLINE) | [Η κατεύθυνση του patch είναι μια spline βάσης.][] |


[The patch direction is a basis spline.]: https://en.wikipedia.org/wiki/B-spline |
|  | [BEZIER](#BEZIER) | [Η κατεύθυνση του patch είναι μια καμπύλη Bezier.][] |


[The patch direction is a Bezier curve.]: https://en.wikipedia.org/wiki/B%C3%A9zier_curve |
| [CARDINAL_SPLINE](#CARDINAL-SPLINE) | καρδινική patch. |
|  | [LINEAR](#LINEAR) | [Η κατεύθυνση του patch είναι μια γραμμική καμπύλη.][] |


[The patch direction is a linear curve.]: https://en.wikipedia.org/wiki/B%C3%A9zier_curve#Linear_curves |
| [QUADRATIC_BEZIER](#QUADRATIC-BEZIER) | Η τετραγωνική bezier patch. |
## Μέθοδοι
...
καρδινική patch. [Η κατεύθυνση του patch είναι μια καρδινική spline.][]
...
Η τετραγωνική bezier patch. [Η κατεύθυνση του patch είναι μια τετραγωνική καμπύλη.][]

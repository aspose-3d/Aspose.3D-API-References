...
description: Η ακολουθία των key-frames περιγράφει τη μετατροπή μιας δειγματοληπτικής τιμής στο χρόνο.
type: docs
weight: 90
url: /el/java/com.aspose.threed/keyframesequence/
---
...
Η ακολουθία των key-frames περιγράφει τον μετασχηματισμό μιας δειγματοληπτικής τιμής στο χρόνο.
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [KeyframeSequence(String name)](#KeyframeSequence-java.lang.String-) | Αρχικοποιεί μια νέα παρουσία της κλάσης [KeyframeSequence](../../com.aspose.threed/keyframesequence). |
| [KeyframeSequence()](#KeyframeSequence--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [KeyframeSequence](../../com.aspose.threed/keyframesequence). |
## Μέθοδοι
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [KeyframeSequence](../../com.aspose.threed/keyframesequence).

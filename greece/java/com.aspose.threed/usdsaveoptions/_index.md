...
description: Επιλογές αποθήκευσης για μορφές USD/USDZ.
type: docs
weight: 200
url: /el/java/com.aspose.threed/usdsaveoptions/
---
...
Επιλογές αποθήκευσης για μορφές USD/USDZ.
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [UsdSaveOptions()](#UsdSaveOptions--) | Αρχικοποιεί ένα νέο [UsdSaveOptions](../../com.aspose.threed/usdsaveoptions) με μορφή [FileFormat.USD](../../com.aspose.threed/fileformat\#USD). |
| [UsdSaveOptions(FileFormat fileFormat)](#UsdSaveOptions-com.aspose.threed.FileFormat-) | Αρχικοποιεί ένα νέο [UsdSaveOptions](../../com.aspose.threed/usdsaveoptions) με καθορισμένη μορφή USD/USDZ. |
## Μέθοδοι
...
| [getExportMetaData()](#getExportMetaData--) | Εξάγει τις ιδιότητες του κόμβου μέσω του πεδίου customData του USD. |
...
| [getMaterialConverter()](#getMaterialConverter--) | Προσαρμοσμένος μετατροπέας για τη μετατροπή του υλικού της γεωμετρίας σε υλικό PBR. Εάν δεν έχει οριστεί, ο εξαγωγέας USD θα μετατρέψει αυτόματα το τυπικό υλικό σε υλικό PBR. |
| [getPrimitiveToMesh()](#getPrimitiveToMesh--) | Μετατρέπει τις πρωτόγονες οντότητες σε πλέγμα κατά την εξαγωγή. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEncoding(Charset value)](#setEncoding-java.nio.charset.Charset-) | Ορίζει την προεπιλεγμένη κωδικοποίηση για αρχεία κειμένου. |
| [setExportMetaData(boolean value)](#setExportMetaData-boolean-) | Εξάγει τις ιδιότητες του κόμβου μέσω του πεδίου customData του USD. |
...
| [setMaterialConverter(MaterialConverter value)](#setMaterialConverter-com.aspose.threed.MaterialConverter-) | Προσαρμοσμένος μετατροπέας για τη μετατροπή του υλικού της γεωμετρίας σε υλικό PBR. Εάν δεν έχει οριστεί, ο εξαγωγέας USD θα μετατρέψει αυτόματα το τυπικό υλικό σε υλικό PBR. |
| [setPrimitiveToMesh(boolean value)](#setPrimitiveToMesh-boolean-) | Μετατρέπει τις πρωτόγονες οντότητες σε πλέγμα κατά την εξαγωγή. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Αρχικοποιεί ένα νέο [UsdSaveOptions](../../com.aspose.threed/usdsaveoptions) με μορφή [FileFormat.USD](../../com.aspose.threed/fileformat\#USD).
...
Αρχικοποιεί ένα νέο [UsdSaveOptions](../../com.aspose.threed/usdsaveoptions) με καθορισμένη μορφή USD/USDZ.
...
Εξάγει τις ιδιότητες του κόμβου μέσω του πεδίου customData του USD.

**Returns:**
boolean - Εξαγωγή των ιδιοτήτων του κόμβου μέσω του πεδίου customData του USD.
...
Προσαρμοσμένος μετατροπέας για τη μετατροπή του υλικού της γεωμετρίας σε υλικό PBR. Εάν αυτό δεν έχει οριστεί, ο εξαγωγέας USD θα μετατρέπει αυτόματα το τυπικό υλικό σε υλικό PBR. Η προεπιλεγμένη τιμή είναι null.
...
Μετατρέψτε τις πρωτόγονες οντότητες σε πλέγμα κατά την εξαγωγή. Ή κωδικοποιήστε απευθείας τις πρωτόγονες στο αρχείο εξόδου (θα χρησιμοποιηθεί ο ορισμός επέκτασης της Aspose για ανεπίσημες πρωτόγονες όπως Dish, Torus). Η προεπιλεγμένη τιμή είναι true.

**Returns:**
boolean - Μετατρέψτε τις πρωτόγονες οντότητες σε πλέγμα κατά την εξαγωγή. Ή κωδικοποιήστε απευθείας τις πρωτόγονες στο αρχείο εξόδου (θα χρησιμοποιηθεί ο ορισμός επέκτασης της Aspose για ανεπίσημες πρωτόγονες όπως Dish, Torus). Η προεπιλεγμένη τιμή είναι true.
### hashCode() {#hashCode--}
```

...
| [iterator()](#iterator--) | Αποκτήστε τον απαριθμητή για να απαριθμήσετε [Vertex](../../com.aspose.threed/vertex) |
...
| [toString()](#toString--) | Λαμβάνει την αναπαράσταση συμβολοσειράς του [TriMesh](../../com.aspose.threed/trimesh) |
| [verticesToArray()](#verticesToArray--) | Μετατρέψτε τα δεδομένα των κορυφών σε πίνακα byte |
| [wait()](#wait--) |  |
| [wait(long arg0)](#wait-long-) |  |
| [wait(long arg0, int arg1)](#wait-long-int-) |  |
| [write16bIndicesTo(Stream stream)](#write16bIndicesTo-com.aspose.threed.Stream-) | Γράψτε τα δεδομένα δεικτών ως 16-bit ακέραιο στη ροή **Παράδειγμα:** |
| [write16bIndicesTo(OutputStream stream)](#write16bIndicesTo-java.io.OutputStream-) | Γράψτε τα δεδομένα δεικτών ως 16-bit ακέραιο στη ροή |
| [write32bIndicesTo(Stream stream)](#write32bIndicesTo-com.aspose.threed.Stream-) | Γράψτε τα δεδομένα δεικτών ως 32-bit ακέραιο στη ροή **Παράδειγμα:** |
| [write32bIndicesTo(OutputStream stream)](#write32bIndicesTo-java.io.OutputStream-) | Γράψτε τα δεδομένα δεικτών ως 32-bit ακέραιο στη ροή |
| [writeVerticesTo(Stream stream)](#writeVerticesTo-com.aspose.threed.Stream-) | Γράψτε τα δεδομένα κορυφών στη καθορισμένη ροή |
| [writeVerticesTo(OutputStream stream)](#writeVerticesTo-java.io.OutputStream-) | Γράψτε τα δεδομένα κορυφών στη καθορισμένη ροή |
...
| --- | --- | --- |
| name | java.lang.String | Το όνομα αυτού του TriMesh |
| declaration | [VertexDeclaration](../../com.aspose.threed/vertexdeclaration) | Η δήλωση της κορυφής |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| α | int | Ο δείκτης της πρώτης κορυφής |
| b | int | Ο δείκτης της δεύτερης κορυφής |
| c | int | Ο δείκτης της τρίτης κορυφής |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| input | [TriMesh](../../com.aspose.threed/trimesh) | Το εισαγόμενο TriMesh για αντιγραφή |
| vd | [VertexDeclaration](../../com.aspose.threed/vertexdeclaration) | Η νέα δήλωση κορυφής του εξόδου TriMesh |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| declaration | [VertexDeclaration](../../com.aspose.threed/vertexdeclaration) | Ο ορισμός τύπου της κορυφής, ή η διάταξη μνήμης |
| mesh | [Mesh](../../com.aspose.threed/mesh) | Πηγαίο πλέγμα |
...
| generateVertexMapping | boolean | Δημιουργήστε [Vertex](../../com.aspose.threed/vertex) για κάθε κορυφή, το οποίο δεν είναι απαραίτητο μόνο για σειριοποίηση/αποσειριοποίηση. |
...
**Returns:**
int - Η χωρητικότητα των προ-κατανεμημένων κορυφών.
### getClass() {#getClass--}
```
...
**Returns:**
int - Ο αριθμός των δεικτών σε αυτό το [TriMesh](../../com.aspose.threed/trimesh)
...
**Returns:**
int - Ο αριθμός των μη συγχωνευμένων κορυφών που περάστηκαν από [beginVertex](../../com.aspose.threed/trimesh\#beginVertex) και [endVertex](../../com.aspose.threed/trimesh\#endVertex).
...
**Returns:**
int - Ο αριθμός των κορυφών σε αυτό το [TriMesh](../../com.aspose.threed/trimesh)
...
**Returns:**
int - Το συνολικό μέγεθος όλων των κορυφών σε bytes
### hashCode() {#hashCode--}
```
...
Αποκτήστε τον απαριθμητή για να απαριθμήσετε [Vertex](../../com.aspose.threed/vertex)
...
Φορτώστε κορυφές από byte, το μήκος των byte πρέπει να είναι ακέραιο πολλαπλάσιο του μεγέθους της κορυφής. **Example:** Ο παρακάτω κώδικας δείχνει πώς να δημιουργήσετε ένα κενό TriMesh και να φορτώσετε χειροκίνητα κορυφές από ακατέργαστα byte.
...
**Returns:**
double - Double τιμή του πεδίου της καθορισμένης κορυφής
...
**Returns:**
float - Float τιμή του πεδίου της καθορισμένης κορυφής
...
Λαμβάνει την αναπαράσταση συμβολοσειράς του [TriMesh](../../com.aspose.threed/trimesh)

**Returns:**
java.lang.String - Η αναπαράσταση της συμβολοσειράς
...
Γράψτε τα δεδομένα δεικτών ως 16-bit ακέραιο στη ροή **Παράδειγμα:**
...
Γράψτε τα δεδομένα δεικτών ως 16-bit ακέραιο στη ροή

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
|  | ροή | java.io.OutputStream | **Example:** |
...
Γράψτε τα δεδομένα δεικτών ως 32-bit ακέραιο στη ροή **Παράδειγμα:**
...
Γράψτε τα δεδομένα δεικτών ως 32-bit ακέραιο στη ροή
...
Γράψτε τα δεδομένα κορυφών στη καθορισμένη ροή

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
|  | stream | [Stream](../../com.aspose.threed/stream) | Η ροή στην οποία θα γραφούν τα δεδομένα των κορυφών **Example:** |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
|  | ροή | java.io.OutputStream | Η ροή στην οποία θα γραφούν τα δεδομένα των κορυφών **Example:** |

...
description: "Επιλογές για  και"
type: docs
weight: 83
url: /el/java/com.aspose.threed/imagerenderoptions/
---
...
Επιλογές για [Scene](../../com.aspose.threed/scene) και [Scene](../../com.aspose.threed/scene)
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [ImageRenderOptions()](#ImageRenderOptions--) | Αρχικοποιήστε μια παρουσία του [ImageRenderOptions](../../com.aspose.threed/imagerenderoptions) |
## Μέθοδοι
...
| [getAssetDirectories()](#getAssetDirectories--) | Κατάλογοι που αποθήκευσαν εξωτερικά περιουσιακά στοιχεία (όπως υφές) |
| [getBackgroundColor()](#getBackgroundColor--) | Το χρώμα φόντου του αποτελέσματος απόδοσης. |
| [getClass()](#getClass--) |  |
| [getEnableShadows()](#getEnableShadows--) | Λαμβάνει αν θα αποδοθούν σκιές. |
...
| [setAssetDirectories(ArrayList<String> value)](#setAssetDirectories-java.util.ArrayList-java.lang.String--) | Κατάλογοι που αποθήκευσαν εξωτερικά περιουσιακά στοιχεία (όπως υφές) |
| [setBackgroundColor(Vector3 value)](#setBackgroundColor-com.aspose.threed.Vector3-) | Το χρώμα φόντου του αποτελέσματος απόδοσης. |
| [setEnableShadows(boolean value)](#setEnableShadows-boolean-) | Ορίζει αν θα αποδοθούν σκιές. |
...
Αρχικοποιήστε μια παρουσία του [ImageRenderOptions](../../com.aspose.threed/imagerenderoptions)
...
Κατάλογοι που αποθήκευσαν εξωτερικά περιουσιακά στοιχεία (όπως υφές)

**Returns:**
java.util.ArrayList<java.lang.String> - Κατάλογοι που αποθήκευσαν εξωτερικά περιουσιακά στοιχεία (όπως υφές)
...
Λαμβάνει αν θα αποδοθούν σκιές.

**Returns:**
boolean - αν θα αποδοθούν σκιές.
### getName() {#getName--}
```
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| τιμή | java.util.ArrayList<java.lang.String> | Νέα τιμή |

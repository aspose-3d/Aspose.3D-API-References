...
description: "Συμβατό με IFC σχήμα T ορισμένο από παραμέτρους."
type: docs
weight: 182
url: /el/java/com.aspose.threed/tshape/
---
...
Συμβατό με IFC σχήμα T ορισμένο από παραμέτρους.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [TShape()](#TShape--) | Κατασκευαστής του [TShape](../../com.aspose.threed/tshape) |
## Μέθοδοι
...
| [getClass()](#getClass--) |  |
| [getDepth()](#getDepth--) | Λαμβάνει το μήκος του web. |
...
| [getFilletRadius()](#getFilletRadius--) | Λαμβάνει την ακτίνα του στρογγυλοποίησης μεταξύ web και flange. |
| [getFlangeEdgeRadius()](#getFlangeEdgeRadius--) | Λαμβάνει την ακτίνα της άκρης του flange. |
| [getFlangeThickness()](#getFlangeThickness--) | Λαμβάνει το πάχος τοίχου του περιθωρίου. |
| [getFlangeWidth()](#getFlangeWidth--) | Λαμβάνει το μήκος του περιθωρίου. |
...
| [getWebEdgeRadius()](#getWebEdgeRadius--) | Λαμβάνει την ακτίνα της άκρης του web. |
| [getWebThickness()](#getWebThickness--) | Λαμβάνει το πάχος τοίχου του web. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setDepth(double value)](#setDepth-double-) | Ορίζει το μήκος του web. |
| [setExcluded(boolean value)](#setExcluded-boolean-) | Ορίζει αν θα εξαιρεθεί αυτή η οντότητα κατά την εξαγωγή. |
| [setFilletRadius(double value)](#setFilletRadius-double-) | Ορίζει την ακτίνα του στρογγυλοποίησης μεταξύ web και περιθωρίου. |
| [setFlangeEdgeRadius(double value)](#setFlangeEdgeRadius-double-) | Ορίζει την ακτίνα της άκρης του περιθωρίου. |
| [setFlangeThickness(double value)](#setFlangeThickness-double-) | Ορίζει το πάχος τοίχου του περιθωρίου. |
| [setFlangeWidth(double value)](#setFlangeWidth-double-) | Ορίζει το μήκος του περιθωρίου. |
...
| [setWebEdgeRadius(double value)](#setWebEdgeRadius-double-) | Ορίζει την ακτίνα της άκρης του web. |
| [setWebThickness(double value)](#setWebThickness-double-) | Ορίζει το πάχος τοίχου του web. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Κατασκευαστής του [TShape](../../com.aspose.threed/tshape)
...
Λαμβάνει το μήκος του web.

**Returns:**
double - το μήκος του web.
...
Λαμβάνει την ακτίνα του στρογγυλοποίησης μεταξύ web και flange.

**Returns:**
double - η ακτίνα του στρογγυλοποίησης μεταξύ web και περιθωρίου.
...
Λαμβάνει την ακτίνα της άκρης του flange.

**Returns:**
double - η ακτίνα της άκρης του περιθωρίου.
...
Λαμβάνει το πάχος τοίχου του περιθωρίου.

**Returns:**
double - το πάχος τοίχου του περιθωρίου.
...
Λαμβάνει το μήκος του περιθωρίου.

**Returns:**
double - το μήκος του περιθωρίου.
### getName() {#getName--}
```
...
Λαμβάνει την ακτίνα της άκρης του web.

**Returns:**
double - η ακτίνα της άκρης του web.
...
Λαμβάνει το πάχος τοίχου του web.

**Returns:**
double - το πάχος τοίχου του web.
### hashCode() {#hashCode--}
```
...
Ορίζει την ακτίνα του στρογγυλοποίησης μεταξύ web και περιθωρίου.
...
Ορίζει την ακτίνα της άκρης του περιθωρίου.
...
Ορίζει το πάχος τοίχου του περιθωρίου.
...
Ορίζει το μήκος του περιθωρίου.
...
Ορίζει την ακτίνα της άκρης του web.
...
Ορίζει το πάχος τοίχου του web.

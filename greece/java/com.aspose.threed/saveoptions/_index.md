...
description: Η βασική κλάση για τη διαμόρφωση επιλογών κατά την αποθήκευση αρχείων για διαφορετικούς τύπους.
type: docs
weight: 160
url: /el/java/com.aspose.threed/saveoptions/
---
...
Η βασική κλάση για τη διαμόρφωση επιλογών κατά την αποθήκευση αρχείων για διαφορετικούς τύπους.
## Μέθοδοι

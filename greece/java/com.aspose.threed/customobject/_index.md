...
description: "Τα μεταδεδομένα ή τα προσαρμοσμένα αντικείμενα που χρησιμοποιούνται σε αρχεία 3D διαχειρίζονται από αυτήν την κλάση."
type: docs
weight: 39
url: /el/java/com.aspose.threed/customobject/
---
...
| --- | --- |
| [CustomObject()](#CustomObject--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [CustomObject](../../com.aspose.threed/customobject). |
| [CustomObject(String name)](#CustomObject-java.lang.String-) | Αρχικοποιεί μια νέα παρουσία της κλάσης [CustomObject](../../com.aspose.threed/customobject). |
## Μέθοδοι
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [CustomObject](../../com.aspose.threed/customobject).

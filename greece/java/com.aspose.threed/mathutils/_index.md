...
**Returns:**
double - Η τιμή μεταξύ [min, max] **Παράδειγμα:**
...
**Returns:**
double - Η τιμή σε μοίρες. **Παράδειγμα:**
...
**Returns:**
float - Η τιμή σε μοίρες. **Παράδειγμα:**
...
**Returns:**
double - Η τιμή σε ακτίνια. **Παράδειγμα:**
...
**Returns:**
float - Η τιμή σε ακτίνια. **Παράδειγμα:**

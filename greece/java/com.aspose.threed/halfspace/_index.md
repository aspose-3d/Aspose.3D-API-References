...
description: "Αντιπροσωπεύει έναν άπειρο χώρο που χωρίζεται από ένα επίπεδο· αυτό μπορεί να χρησιμοποιηθεί με"
type: docs
weight: 77
url: /el/java/com.aspose.threed/halfspace/
---
...
| --- | --- |
| [HalfSpace()](#HalfSpace--) | Δημιουργεί ένα νέο αντικείμενο [HalfSpace](../../com.aspose.threed/halfspace) |
| [HalfSpace(Vector3 normal, Vector3 position)](#HalfSpace-com.aspose.threed.Vector3-com.aspose.threed.Vector3-) | Δημιουργεί ένα νέο αντικείμενο [HalfSpace](../../com.aspose.threed/halfspace) με δεδομένο διάνυσμα κανονικής και θέση στο επίπεδο κοπής· |
## Μέθοδοι
...
| [getNormal()](#getNormal--) | Η κανονική του χωρισμένου επιπέδου, το επίπεδο ορίζεται ως N \* P + D = 0 όπου N είναι η Κανονική και P είναι οποιοδήποτε σημείο στο επίπεδο. |
...
| [getPosition()](#getPosition--) | Ο οποιοσδήποτε σημείο στο χωρισμένο επίπεδο, το επίπεδο ορίζεται ως N \* P + D = 0 όπου N είναι η Κανονική και P είναι οποιοδήποτε σημείο στο επίπεδο. |
...
| [setNormal(Vector3 value)](#setNormal-com.aspose.threed.Vector3-) | Η κανονική του χωρισμένου επιπέδου, το επίπεδο ορίζεται ως N \* P + D = 0 όπου N είναι η Κανονική και P είναι οποιοδήποτε σημείο στο επίπεδο. |
...
| [setPosition(Vector3 value)](#setPosition-com.aspose.threed.Vector3-) | Ο οποιοσδήποτε σημείο στο χωρισμένο επίπεδο, το επίπεδο ορίζεται ως N \* P + D = 0 όπου N είναι η Κανονική και P είναι οποιοδήποτε σημείο στο επίπεδο. |
...
Δημιουργεί ένα νέο αντικείμενο [HalfSpace](../../com.aspose.threed/halfspace)
...
Δημιουργεί ένα νέο αντικείμενο [HalfSpace](../../com.aspose.threed/halfspace) με δεδομένο διάνυσμα κανονικής και θέση στο επίπεδο κοπής·
...
Η κανονική του χωρισμένου επιπέδου, το επίπεδο ορίζεται ως N \* P + D = 0 όπου N είναι η Κανονική και P είναι οποιοδήποτε σημείο στο επίπεδο.
...
Ο οποιοσδήποτε σημείο στο χωρισμένο επίπεδο, το επίπεδο ορίζεται ως N \* P + D = 0 όπου N είναι η Κανονική και P είναι οποιοδήποτε σημείο στο επίπεδο.

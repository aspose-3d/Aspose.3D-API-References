...
type: docs
weight: 275
url: /el/java/com.aspose.threed/curvedimension/
---
...
| Πεδίο | Περιγραφή |
| --- | --- |
| [THREE_DIMENSIONAL](#THREE-DIMENSIONAL) | Οι καμπύλες είναι σημεία τριών διαστάσεων. |
| [TWO_DIMENSIONAL](#TWO-DIMENSIONAL) | Οι καμπύλες είναι σημεία δύο διαστάσεων. |
## Μέθοδοι
...
Οι καμπύλες είναι σημεία τριών διαστάσεων.
...
Οι καμπύλες είναι σημεία δύο διαστάσεων.

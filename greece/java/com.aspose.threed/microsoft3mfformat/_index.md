...
description: "Παράδειγμα μορφής αρχείου για Microsoft 3MF με εργαλεία σχετιζόμενα με 3MF."
type: docs
weight: 104
url: /el/java/com.aspose.threed/microsoft3mfformat/
---
...
Παράδειγμα μορφής αρχείου για Microsoft 3MF με εργαλεία σχετιζόμενα με 3MF.
## Πεδία
...
| [getObjectType(Node node)](#getObjectType-com.aspose.threed.Node-) | Λαμβάνει τον τύπο μοντέλου για τον καθορισμένο κόμβο. |
| [getTransformForBuild(Node node)](#getTransformForBuild-com.aspose.threed.Node-) | Λάβετε τον πίνακα μετασχηματισμού για τον κόμβο που χρησιμοποιείται στην κατασκευή. |
| [getVersion()](#getVersion--) | Λαμβάνει την έκδοση μορφής αρχείου |
| [hashCode()](#hashCode--) |  |
| [isBuildable(Node node)](#isBuildable-com.aspose.threed.Node-) | Ελέγξτε εάν αυτός ο κόμβος έχει επισημανθεί ως κατασκευή. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBuildable(Node node, boolean value, Matrix4 transform)](#setBuildable-com.aspose.threed.Node-boolean-com.aspose.threed.Matrix4-) | Επισημάνετε έναν κόμβο για κατασκευή. |
| [setObjectType(Node node, String modelType)](#setObjectType-com.aspose.threed.Node-java.lang.String-) | Ορίστε τον τύπο μοντέλου για τον καθορισμένο κόμβο. |
...
Λαμβάνει τον τύπο μοντέλου για τον καθορισμένο κόμβο.
...
**Returns:**
java.lang.String - ο τύπος αντικειμένου 3MF για τον δεδομένο κόμβο
...
Λάβετε τον πίνακα μετασχηματισμού για τον κόμβο που χρησιμοποιείται στην κατασκευή.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Ποιος κόμβος για λήψη του πίνακα μετασχηματισμού για την κατασκευή 3MF. |
...
Ελέγξτε εάν αυτός ο κόμβος έχει επισημανθεί ως κατασκευή.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Ποιος κόμβος να ελεγχθεί |

**Returns:**
boolean - Αληθές εάν έχει επισημανθεί ως κατασκευή
### notify() {#notify--}
```
...
Επισημάνετε έναν κόμβο για κατασκευή.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Ποιος κόμβος να επισημανθεί ως κατασκευή. |
| τιμή | boolean |  |
| transform | [Matrix4](../../com.aspose.threed/matrix4) | Ο μετασχηματισμός του κόμβου στην κατασκευή. |
...
Ορίστε τον τύπο μοντέλου για τον καθορισμένο κόμβο. Πιθανές τιμές: model surface solidsupport support other

...
description: Σχήμα ορθογωνίου κενού συμβατό με IFC με στρογγυλεμένες εσωτερικές/εξωτερικές γωνίες.
type: docs
weight: 79
url: /el/java/com.aspose.threed/hollowrectangleshape/
---
...
Σχήμα ορθογωνίου κενού συμβατό με IFC με στρογγυλεμένες εσωτερικές/εξωτερικές γωνίες.
## Constructors
...
| [getInnerFilletRadius()](#getInnerFilletRadius--) | Η εσωτερική ακτίνα στρογγυλοποίησης του εσωτερικού ορθογωνίου. |
...
| [getRoundingRadius()](#getRoundingRadius--) | Λαμβάνει την ακτίνα των κυκλικών τόξων των τεσσάρων γωνιών, μετρημένη σε μοίρες. |
| [getScene()](#getScene--) | Λαμβάνει τη σκηνή στην οποία ανήκει αυτό το αντικείμενο |
| [getWallThickness()](#getWallThickness--) | Το πάχος μεταξύ του περιγράμματος του ορθογωνίου και της εσωτερικής τρύπας |
| [getXDim()](#getXDim--) | Λαμβάνει το μέγεθος του ορθογωνίου προς την κατεύθυνση του άξονα x. Default value is 2.0 |
| [getYDim()](#getYDim--) | Λαμβάνει το μέγεθος του ορθογωνίου προς την κατεύθυνση του άξονα y. Default value is 2.0 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setInnerFilletRadius(double value)](#setInnerFilletRadius-double-) | Η εσωτερική ακτίνα στρογγυλοποίησης του εσωτερικού ορθογωνίου. |
...
| [setRoundingRadius(double value)](#setRoundingRadius-double-) | Ορίζει την ακτίνα των κυκλικών τόξων των τεσσάρων γωνιών, μετρημένη σε μοίρες. |
| [setWallThickness(double value)](#setWallThickness-double-) | Το πάχος μεταξύ του περιγράμματος του ορθογωνίου και της εσωτερικής τρύπας |
| [setXDim(double value)](#setXDim-double-) | Ορίζει το μέγεθος του ορθογωνίου προς την κατεύθυνση του άξονα x. Default value is 2.0 |
| [setYDim(double value)](#setYDim-double-) | Ορίζει το μέγεθος του ορθογωνίου προς την κατεύθυνση του άξονα y. Default value is 2.0 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Η εσωτερική ακτίνα στρογγυλοποίησης του εσωτερικού ορθογωνίου.

**Returns:**
double - Η εσωτερική ακτίνα στρογγυλοποίησης του εσωτερικού ορθογωνίου.
### getName() {#getName--}
```
...
Λαμβάνει την ακτίνα των κυκλικών τόξων των τεσσάρων γωνιών, μετρημένη σε μοίρες. Default value is 0.0

**Returns:**
double - η ακτίνα των κυκλικών τόξων των τεσσάρων γωνιών, μετρημένη σε μοίρες. Default value is 0.0
### getScene() {#getScene--}
```
...
Το πάχος μεταξύ του περιγράμματος του ορθογωνίου και της εσωτερικής τρύπας

**Returns:**
double - Το πάχος μεταξύ του περιγράμματος του ορθογωνίου και της εσωτερικής τρύπας
### getXDim() {#getXDim--}
```
...
Λαμβάνει το μέγεθος του ορθογωνίου προς την κατεύθυνση του άξονα x. Default value is 2.0

**Returns:**
double - το μέγεθος του ορθογωνίου προς την κατεύθυνση του άξονα x. Default value is 2.0
### getYDim() {#getYDim--}
```
...
Λαμβάνει το μέγεθος του ορθογωνίου προς την κατεύθυνση του άξονα y. Default value is 2.0

**Returns:**
double - το μέγεθος του ορθογωνίου προς την κατεύθυνση του άξονα y. Default value is 2.0
### hashCode() {#hashCode--}
```
...
Ορίζει την ακτίνα των κυκλικών τόξων των τεσσάρων γωνιών, μετρημένη σε μοίρες. Default value is 0.0
...
Ορίζει το μέγεθος του ορθογωνίου προς την κατεύθυνση του άξονα x. Default value is 2.0
...
Ορίζει το μέγεθος του ορθογωνίου προς την κατεύθυνση του άξονα y. Default value is 2.0

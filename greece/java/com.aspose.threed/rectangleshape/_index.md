...
description: "Σχήμα ορθογωνίου συμβατό με IFC με στρογγυλεμένες γωνίες."
type: docs
weight: 145
url: /el/java/com.aspose.threed/rectangleshape/
---
...
Σχήμα ορθογωνίου συμβατό με IFC με στρογγυλεμένες γωνίες.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [RectangleShape()](#RectangleShape--) | Κατασκευαστής του [RectangleShape](../../com.aspose.threed/rectangleshape) |
| [RectangleShape(double xdim, double ydim)](#RectangleShape-double-double-) | Κατασκευαστής του [RectangleShape](../../com.aspose.threed/rectangleshape) με καθορισμένες διαστάσεις στον άξονα x και y. |
## Μέθοδοι
...
Κατασκευαστής του [RectangleShape](../../com.aspose.threed/rectangleshape)
...
Κατασκευαστής του [RectangleShape](../../com.aspose.threed/rectangleshape) με καθορισμένες διαστάσεις στον άξονα x και y.

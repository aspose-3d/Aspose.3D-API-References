...
description: "Η μορφή RVM."
type: docs
weight: 156
url: /el/java/com.aspose.threed/rvmformat/
---
...
| [hashCode()](#hashCode--) |  |
| [loadAttributes(Scene scene, Stream stream)](#loadAttributes-com.aspose.threed.Scene-com.aspose.threed.Stream-) | Φορτώστε τις ιδιότητες από την καθορισμένη ροή |
| [loadAttributes(Scene scene, Stream stream, String prefix)](#loadAttributes-com.aspose.threed.Scene-com.aspose.threed.Stream-java.lang.String-) | Φορτώστε τις ιδιότητες από την καθορισμένη ροή |
| [loadAttributes(Scene scene, String fileName)](#loadAttributes-com.aspose.threed.Scene-java.lang.String-) | Φορτώστε τις ιδιότητες από το καθορισμένο όνομα αρχείου |
| [loadAttributes(Scene scene, String fileName, String prefix)](#loadAttributes-com.aspose.threed.Scene-java.lang.String-java.lang.String-) | Φορτώστε τις ιδιότητες από το καθορισμένο όνομα αρχείου |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Φορτώστε τις ιδιότητες από την καθορισμένη ροή

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| scene | [Scene](../../com.aspose.threed/scene) | Η σκηνή στην οποία θα εφαρμοστούν οι ιδιότητες |
| stream | [Stream](../../com.aspose.threed/stream) | Η ροή που περιέχει τις ιδιότητες |
...
| scene | [Scene](../../com.aspose.threed/scene) | Η σκηνή στην οποία θα εφαρμοστούν οι ιδιότητες |
| stream | [Stream](../../com.aspose.threed/stream) | Η ροή που περιέχει τις ιδιότητες |
| πρόθεμα | java.lang.String | Το πρόθεμα των ιδιοτήτων που χρησιμοποιείται για την αποφυγή συγκρούσεων ονομάτων, η προεπιλεγμένη τιμή είναι "rvm:" |
...
Φορτώστε τις ιδιότητες από το καθορισμένο όνομα αρχείου

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| scene | [Scene](../../com.aspose.threed/scene) | Η σκηνή στην οποία θα εφαρμοστούν οι ιδιότητες |
| fileName | java.lang.String | Το όνομα του αρχείου που περιέχει τις ιδιότητες |

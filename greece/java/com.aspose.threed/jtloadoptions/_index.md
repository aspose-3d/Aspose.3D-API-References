...
description: Επιλογές φόρτωσης για Siemens JT
type: docs
weight: 88
url: /el/java/com.aspose.threed/jtloadoptions/
---
...
Επιλογές φόρτωσης για Siemens JT
## Constructors
...
| [getLoadPMI()](#getLoadPMI--) | Φορτώστε πληροφορίες PMI από αρχείο JT εάν είναι δυνατόν, τα δεδομένα θα αποθηκευτούν ως ιδιότητα "PMI" του [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). |
| [getLoadProperties()](#getLoadProperties--) | Φορτώστε ιδιότητες από τον πίνακα ιδιοτήτων του JT ως ιδιότητες Aspose.3D. |
...
| [setLoadPMI(boolean value)](#setLoadPMI-boolean-) | Φορτώστε πληροφορίες PMI από αρχείο JT εάν είναι δυνατόν, τα δεδομένα θα αποθηκευτούν ως ιδιότητα "PMI" του [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). |
| [setLoadProperties(boolean value)](#setLoadProperties-boolean-) | Φορτώστε ιδιότητες από τον πίνακα ιδιοτήτων του JT ως ιδιότητες Aspose.3D. |
...
Φορτώστε πληροφορίες PMI από αρχείο JT εάν είναι δυνατόν, τα δεδομένα θα αποθηκευτούν ως ιδιότητα "PMI" του [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). Η προεπιλεγμένη τιμή είναι ψευδής.

**Returns:**
boolean - Φορτώστε πληροφορίες PMI από αρχείο JT εάν είναι δυνατόν, τα δεδομένα θα αποθηκευτούν ως ιδιότητα "PMI" του [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). Η προεπιλεγμένη τιμή είναι ψευδής.
...
Φορτώστε ιδιότητες από τον πίνακα ιδιοτήτων του JT ως ιδιότητες Aspose.3D. Η προεπιλεγμένη τιμή είναι ψευδής.

**Returns:**
boolean - Φορτώστε ιδιότητες από τον πίνακα ιδιοτήτων του JT ως ιδιότητες Aspose.3D. Η προεπιλεγμένη τιμή είναι ψευδής.

...
description: Μια ομάδα εξομάλυνσης είναι μια ομάδα πολυγώνων σε ένα πλέγμα πολυγώνων που πρέπει να φαίνεται ότι σχηματίζει μια ομαλή επιφάνεια.
type: docs
weight: 216
url: /el/java/com.aspose.threed/vertexelementsmoothinggroup/
---
...
Μια ομάδα εξομάλυνσης είναι μια ομάδα πολυγώνων σε ένα πλέγμα πολυγώνων που πρέπει να φαίνεται ότι σχηματίζει μια ομαλή επιφάνεια. Κάποιο πρώιμο λογισμικό 3D μοντελοποίησης όπως το 3D studio max για DOS χρησιμοποιούσε την ομάδα εξομάλυνσης για να αποφύγει την αποθήκευση του διανύσματος κανονικής για κάθε κορυφή του πλέγματος.
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [VertexElementSmoothingGroup()](#VertexElementSmoothingGroup--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [VertexElementSmoothingGroup](../../com.aspose.threed/vertexelementsmoothinggroup). |
## Μέθοδοι
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [VertexElementSmoothingGroup](../../com.aspose.threed/vertexelementsmoothinggroup).

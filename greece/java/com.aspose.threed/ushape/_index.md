...
description: "Συμβατό με IFC σχήμα U ορισμένο από παραμέτρους."
type: docs
weight: 199
url: /el/java/com.aspose.threed/ushape/
---
...
Συμβατό με IFC σχήμα U ορισμένο από παραμέτρους.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [UShape()](#UShape--) | Κατασκευαστής του [UShape](../../com.aspose.threed/ushape) |
## Μέθοδοι
...
| [getEdgeRadius()](#getEdgeRadius--) | Λαμβάνει την ακτίνα της άκρης στην άκρη του φλάντζου. |
...
| [getFilletRadius()](#getFilletRadius--) | Λαμβάνει την ακτίνα του fillet μεταξύ flange και web. |
| [getFlangeThickness()](#getFlangeThickness--) | Λαμβάνει το πάχος του flange. |
| [getFlangeWidth()](#getFlangeWidth--) | Λαμβάνει το μήκος του flange. |
...
| [getWebThickness()](#getWebThickness--) | Λαμβάνει το πάχος του πλέγματος. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setDepth(double value)](#setDepth-double-) | Ορίζει το μήκος του πλέγματος. |
| [setEdgeRadius(double value)](#setEdgeRadius-double-) | Ορίζει την ακτίνα της άκρης στην άκρη του φλάντζου. |
| [setExcluded(boolean value)](#setExcluded-boolean-) | Ορίζει αν θα εξαιρεθεί αυτή η οντότητα κατά την εξαγωγή. |
| [setFilletRadius(double value)](#setFilletRadius-double-) | Ορίζει την ακτίνα του στρογγυλοποιημένου άκρου μεταξύ πλάτης και πλέγματος. |
| [setFlangeThickness(double value)](#setFlangeThickness-double-) | Ορίζει το πάχος της πλάτης. |
| [setFlangeWidth(double value)](#setFlangeWidth-double-) | Ορίζει το μήκος της πλάτης. |
...
| [setWebThickness(double value)](#setWebThickness-double-) | Ορίζει το πάχος του πλέγματος. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Κατασκευαστής του [UShape](../../com.aspose.threed/ushape)
...
Λαμβάνει την ακτίνα της άκρης στην άκρη του φλάντζου.

**Returns:**
double - η ακτίνα της άκρης στην άκρη του φλάντζου.
...
Λαμβάνει την ακτίνα του fillet μεταξύ flange και web.

**Returns:**
double - η ακτίνα του στρογγυλοποιημένου άκρου μεταξύ πλάτης και πλέγματος.
...
Λαμβάνει το πάχος του flange.

**Returns:**
double - το πάχος της πλάτης.
...
Λαμβάνει το μήκος του flange.

**Returns:**
double - το μήκος της πλάτης.
### getName() {#getName--}
```
...
Λαμβάνει το πάχος του πλέγματος.

**Returns:**
double - το πάχος του πλέγματος.
### hashCode() {#hashCode--}
```
...
Ορίζει την ακτίνα της άκρης στην άκρη του φλάντζου.
...
Ορίζει την ακτίνα του στρογγυλοποιημένου άκρου μεταξύ πλάτης και πλέγματος.

...
description: Το υλικό ορίζει τις παραμέτρους που απαιτούνται για την οπτική εμφάνιση της γεωμετρίας.
type: docs
weight: 98
url: /el/java/com.aspose.threed/material/
---
...
Το Material ορίζει τις παραμέτρους που απαιτούνται για την οπτική εμφάνιση της γεωμετρίας. Το Aspose.3D παρέχει μοντέλο σκίασης για [LambertMaterial](../../com.aspose.threed/lambertmaterial), [PhongMaterial](../../com.aspose.threed/phongmaterial) και [ShaderMaterial](../../com.aspose.threed/shadermaterial) **Example:**

...
Οι λειτουργίες ανάγνωσης/εγγραφής είναι ψεύτικες λειτουργίες. **Παράδειγμα:** Ο παρακάτω κώδικας δείχνει πώς να εξάγετε το αρχείο στη μνήμη και να αγνοήσετε όλες τις εξαρτημένες δημιουργίες αρχείων.

...
description: Ένα  ορίζει ένα σύνολο σημείων που σχηματίζουν το σχήμα της έλλειψης.
type: docs
weight: 49
url: /el/java/com.aspose.threed/ellipse/
---
...
Ένα [Ellipse](../../com.aspose.threed/ellipse) ορίζει ένα σύνολο σημείων που σχηματίζουν το σχήμα της έλλειψης.
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [Ellipse()](#Ellipse--) | Κατασκευαστής του [Ellipse](../../com.aspose.threed/ellipse) |
| [Ellipse(double semiAxis1, double semiAxis2)](#Ellipse-double-double-) | Κατασκευαστής του [Ellipse](../../com.aspose.threed/ellipse) |
## Μέθοδοι
...
| [getSemiAxis1()](#getSemiAxis1--) | Ακτίνα στον άξονα X |
| [getSemiAxis2()](#getSemiAxis2--) | Ακτίνα στον άξονα Y |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setSemiAxis1(double value)](#setSemiAxis1-double-) | Ακτίνα στον άξονα X |
| [setSemiAxis2(double value)](#setSemiAxis2-double-) | Ακτίνα στον άξονα Y |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Κατασκευαστής του [Ellipse](../../com.aspose.threed/ellipse)
...
| --- | --- | --- |
| semiAxis1 | double | Μήκος του πρώτου ημιάξονα |
| semiAxis2 | double | Μήκος του δεύτερου ημιάξονα |

...
description: "Προφίλ κυκλικού κενού συμβατό με IFC."
type: docs
weight: 78
url: /el/java/com.aspose.threed/hollowcircleshape/
---
...
Προφίλ κυκλικού κενού συμβατό με IFC.
## Κατασκευαστές
...
| [getWallThickness()](#getWallThickness--) | Λαμβάνει τη διαφορά μεταξύ της εξωτερικής και της εσωτερικής ακτίνας. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setWallThickness(double value)](#setWallThickness-double-) | Ορίζει τη διαφορά μεταξύ της εξωτερικής και της εσωτερικής ακτίνας. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Λαμβάνει τη διαφορά μεταξύ της εξωτερικής και της εσωτερικής ακτίνας.

**Returns:**
double - η διαφορά μεταξύ της εξωτερικής και της εσωτερικής ακτίνας.
### hashCode() {#hashCode--}
```
...
Ορίζει τη διαφορά μεταξύ της εξωτερικής και της εσωτερικής ακτίνας.

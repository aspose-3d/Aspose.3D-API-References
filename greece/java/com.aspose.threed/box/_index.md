...
type: docs
weight: 26
url: /el/java/com.aspose.threed/box/
---
...
| --- | --- |
| [Box()](#Box--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [Box](../../com.aspose.threed/box). |
| [Box(double length, double width, double height)](#Box-double-double-double-) | Αρχικοποιεί μια νέα παρουσία της κλάσης [Box](../../com.aspose.threed/box). |
| [Box(String name, double length, double width, double height, int lengthSegments, int widthSegments, int heightSegments)](#Box-java.lang.String-double-double-double-int-int-int-) | Αρχικοποιεί μια νέα παρουσία της κλάσης [Box](../../com.aspose.threed/box). |
## Μέθοδοι
...
| [getHeight()](#getHeight--) | Λαμβάνει το ύψος του κουτιού ευθυγραμμισμένο στον άξονα y. |
| [getHeightSegments()](#getHeightSegments--) | Λαμβάνει ή ορίζει τα τμήματα ύψους. |
| [getLength()](#getLength--) | Λαμβάνει το μήκος του κουτιού ευθυγραμμισμένο στον άξονα z. |
| [getLengthSegments()](#getLengthSegments--) | Λαμβάνει τα τμήματα μήκους. |
...
| [getWidth()](#getWidth--) | Λαμβάνει το πλάτος του κουτιού ευθυγραμμισμένο στον άξονα x. |
...
| [setHeight(double value)](#setHeight-double-) | Ορίζει το ύψος του κουτιού ευθυγραμμισμένο στον άξονα y. |
| [setHeightSegments(int value)](#setHeightSegments-int-) | Λαμβάνει ή ορίζει τα τμήματα ύψους. |
| [setLength(double value)](#setLength-double-) | Ορίζει το μήκος του κουτιού ευθυγραμμισμένο στον άξονα z. |
| [setLengthSegments(int value)](#setLengthSegments-int-) | Ορίζει τα τμήματα μήκους. |
...
| [setWidth(double value)](#setWidth-double-) | Ορίζει το πλάτος του κουτιού ευθυγραμμισμένο στον άξονα x. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [Box](../../com.aspose.threed/box).
...
| --- | --- | --- |
| μήκος | double | Μήκος του κουτιού ευθυγραμμισμένο στον άξονα z. |
| width | double | Πλάτος του κουτιού ευθυγραμμισμένο στον άξονα x. |
| ύψος | double | Ύψος του κουτιού ευθυγραμμισμένο στον άξονα y. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| name | java.lang.String | Όνομα του κουτιού. |
| μήκος | double | Μήκος του κουτιού ευθυγραμμισμένο στον άξονα z. |
| width | double | Πλάτος του κουτιού ευθυγραμμισμένο στον άξονα x. |
| ύψος | double | Ύψος του κουτιού ευθυγραμμισμένο στον άξονα y. |
| lengthSegments | int | Τμήματα μήκους. |
...
Λαμβάνει το ύψος του κουτιού ευθυγραμμισμένο στον άξονα y.

**Returns:**
double - το ύψος του κουτιού ευθυγραμμισμένο στον άξονα y.
...
**Returns:**
int - λαμβάνει ή ορίζει τα τμήματα ύψους.
### getLength() {#getLength--}
```
...
Λαμβάνει το μήκος του κουτιού ευθυγραμμισμένο στον άξονα z.

**Returns:**
double - το μήκος του κουτιού ευθυγραμμισμένο στον άξονα z.
...
Λαμβάνει τα τμήματα μήκους.

**Returns:**
int - τα τμήματα μήκους.
### getName() {#getName--}
```
...
Λαμβάνει το πλάτος του κουτιού ευθυγραμμισμένο στον άξονα x.

**Returns:**
double - το πλάτος του κουτιού ευθυγραμμισμένο στον άξονα x.
...
Ορίζει το ύψος του κουτιού ευθυγραμμισμένο στον άξονα y.
...
Ορίζει το μήκος του κουτιού ευθυγραμμισμένο στον άξονα z.
...
Ορίζει το πλάτος του κουτιού ευθυγραμμισμένο στον άξονα x.

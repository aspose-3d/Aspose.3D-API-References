...
description: "Συχνά χρησιμοποιούμενα APIs απόδοσης"
type: docs
weight: 269
url: /el/java/com.aspose.threed/renderingapi/
---
...
Συχνά χρησιμοποιούμενα APIs απόδοσης
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [ARNOLD](#ARNOLD) | Arnold renderer |
| [CUSTOM](#CUSTOM) | Προσαρμοσμένο API απόδοσης |
| [DIRECTX](#DIRECTX) | DirectX |
| [MANTLE](#MANTLE) | AMD Mantle |
| [MENTAL_RAY](#MENTAL-RAY) | MentalRay |
| [METAL](#METAL) | Metal που αναπτύχθηκε από την Apple |
| [NONE](#NONE) | Κανένα API απόδοσης |
| [OPENGL](#OPENGL) | OpenGL |
| [OPENGLES](#OPENGLES) | OpenGL ES |
| [PREVIEW](#PREVIEW) | PreviewColorAPI, συμβατό με FBX |
| [RENDER_MAN](#RENDER-MAN) | RenderMan |
| [RENDER_WARE](#RENDER-WARE) | RenderWare |
| [SHADERFX](#SHADERFX) | ShaderFX renderer |
| [STAGE3D](#STAGE3D) | Stage3D που χρησιμοποιείται στο Adobe Flash |
...
Metal που αναπτύχθηκε από την Apple
...
PreviewColorAPI, συμβατό με FBX
...
Stage3D που χρησιμοποιείται στο Adobe Flash

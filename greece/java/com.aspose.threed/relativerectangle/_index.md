...
Σχετικό ορθογώνιο Η φόρμουλα μεταξύ του σχετικού στοιχείου και της απόλυτης τιμής είναι: Scale \* (Reference Width) + offset Έτσι, αν θέλουμε να αντιπροσωπεύει μια απόλυτη τιμή, αφήστε όλα τα πεδία κλίμακας στο μηδέν και χρησιμοποιήστε τα πεδία μετατόπισης αντί αυτού.
## Κατασκευαστές
...
**Returns:**
int - η μετατόπιση για το πλάτος
...
**Returns:**
int - η μετατόπιση για τη συντεταγμένη X
...
**Returns:**
int - η μετατόπιση για τη συντεταγμένη Y

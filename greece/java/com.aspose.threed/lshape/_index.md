...
description: "Προφίλ L-σχήματος συμβατό με IFC που ορίζεται από παραμέτρους."
type: docs
weight: 91
url: /el/java/com.aspose.threed/lshape/
---
...
Προφίλ L-σχήματος συμβατό με IFC που ορίζεται από παραμέτρους.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [LShape()](#LShape--) | Κατασκευαστής του [LShape](../../com.aspose.threed/lshape) |
## Μέθοδοι
...
| [getEdgeRadius()](#getEdgeRadius--) | Λαμβάνει την ακτίνα της άκρης. |
...
| [getFilletRadius()](#getFilletRadius--) | Λαμβάνει την ακτίνα του στρογγυλοποιημένου άκρου. |
...
| [getThickness()](#getThickness--) | Λαμβάνει το πάχος του σταθερού τοίχου. |
...
| [setEdgeRadius(double value)](#setEdgeRadius-double-) | Ορίζει την ακτίνα της άκρης. |
| [setExcluded(boolean value)](#setExcluded-boolean-) | Ορίζει αν θα εξαιρεθεί αυτή η οντότητα κατά την εξαγωγή. |
| [setFilletRadius(double value)](#setFilletRadius-double-) | Ορίζει την ακτίνα του στρογγυλοποιημένου άκρου. |
...
| [setThickness(double value)](#setThickness-double-) | Ορίζει το πάχος του σταθερού τοίχου. |
...
Κατασκευαστής του [LShape](../../com.aspose.threed/lshape)
...
Λαμβάνει την ακτίνα της άκρης.

**Returns:**
double - η ακτίνα της άκρης.
...
Λαμβάνει την ακτίνα του στρογγυλοποιημένου άκρου.

**Returns:**
double - η ακτίνα του στρογγυλοποιημένου άκρου.
### getName() {#getName--}
```
...
Λαμβάνει το πάχος του σταθερού τοίχου.

**Returns:**
double - το πάχος του σταθερού τοίχου.
### getWidth() {#getWidth--}
```
...
Ορίζει την ακτίνα του στρογγυλοποιημένου άκρου.
...
Ορίζει το πάχος του σταθερού τοίχου.

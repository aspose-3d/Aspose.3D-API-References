...
description: Οι βασικοί τύποι για απόδοση
type: docs
weight: 277
url: /el/java/com.aspose.threed/drawoperation/
---
...
Οι βασικοί τύποι για απόδοση
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [LINES](#LINES) | Γραμμές |
| [LINE_STRIP](#LINE-STRIP) | Ταινίες γραμμών |
| [POINTS](#POINTS) | Σημεία |
| [TRIANGLES](#TRIANGLES) | Τρίγωνα |
| [TRIANGLE_FAN](#TRIANGLE-FAN) | Ανεμοστρόβιλος τριγώνων |
| [TRIANGLE_STRIP](#TRIANGLE-STRIP) | Ταινίες τριγώνων |
## Μέθοδοι

...
description: Η βασική κλάση για τη διαμόρφωση επιλογών στη φόρτωση αρχείων για διαφορετικούς τύπους.
type: docs
weight: 97
url: /el/java/com.aspose.threed/loadoptions/
---
...
Η βασική κλάση για τη διαμόρφωση επιλογών στη φόρτωση αρχείων για διαφορετικούς τύπους.
## Μέθοδοι

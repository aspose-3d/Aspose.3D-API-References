...
| [toMesh()](#toMesh--) | Λαμβάνει την παρουσία Mesh από την τρέχουσα οντότητα. |
| [toString()](#toString--) |  |
| [triangulate()](#triangulate--) | Επιστρέφει το τριγωνοποιημένο πλέγμα |
| [union(Mesh a, Mesh b)](#union-com.aspose.threed.Mesh-com.aspose.threed.Mesh-) | Υπολογίζει την ένωση δύο πλεγμάτων |
| [wait()](#wait--) |  |
...
Υπολογίζει την ένωση δύο πλεγμάτων

...
description: Το  θα χαρτογραφήσει τις λειτουργίες ανάγνωσης/εγγραφής στη μνήμη.
type: docs
weight: 95
url: /el/java/com.aspose.threed/memoryfilesystem/
---
...
Το [MemoryFileSystem](../../com.aspose.threed/memoryfilesystem) θα χαρτογραφήσει τις λειτουργίες ανάγνωσης/εγγραφής στη μνήμη. **Παράδειγμα:** Ο παρακάτω κώδικας δείχνει πώς να εξάγετε το αρχείο στη μνήμη, περιλαμβάνει το εξαρτημένο αρχείο χρησιμοποιώντας το MemoryFileSystem.
...
| [getClass()](#getClass--) |  |
| [getFileContent(String fileName)](#getFileContent-java.lang.String-) | Επιστρέφει το ακατέργαστο περιεχόμενο του συγκεκριμένου αρχείου. |
| [getFileNames()](#getFileNames--) | Ονόματα αρχείων που βρίσκονται σε αυτό το σύστημα αρχείων μνήμης. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Επιστρέφει το ακατέργαστο περιεχόμενο του συγκεκριμένου αρχείου. Ρίχνει java.io.FileNotFoundException εάν το συγκεκριμένο αρχείο δεν υπάρχει.

...
| [setSubject(String value)](#setSubject-java.lang.String-) | Ορίζει το θέμα αυτού του στοιχείου |
| [setTitle(String value)](#setTitle-java.lang.String-) | Ορίζει τον τίτλο αυτού του στοιχείου |
| [setUnitName(String value)](#setUnitName-java.lang.String-) | Ορίζει τη μονάδα μήκους που χρησιμοποιείται σε αυτό το στοιχείο. |
...
Ορίζει το θέμα αυτού του στοιχείου
...
Ορίζει τον τίτλο αυτού του στοιχείου

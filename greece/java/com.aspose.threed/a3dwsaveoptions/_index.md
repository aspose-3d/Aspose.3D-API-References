...
description: Επιλογές αποθήκευσης για μορφή A3DW.
type: docs
weight: 11
url: /el/java/com.aspose.threed/a3dwsaveoptions/
---
...
Επιλογές αποθήκευσης για μορφή A3DW.
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [A3dwSaveOptions()](#A3dwSaveOptions--) | Κατασκευαστής του [A3dwSaveOptions](../../com.aspose.threed/a3dwsaveoptions) |
## Μέθοδοι
...
| [getExportMetaData()](#getExportMetaData--) | Εξαγωγή μεταδεδομένων που σχετίζονται με Scene/Node στον πελάτη. Η προεπιλεγμένη τιμή είναι true |
...
| [getMetaDataPrefix()](#getMetaDataPrefix--) | Εάν αυτή η ιδιότητα δεν είναι null, μόνο οι ιδιότητες του Scene/Node που ξεκινούν με αυτό το πρόθεμα θα εξαχθούν, και το πρόθεμα θα αφαιρεθεί. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEncoding(Charset value)](#setEncoding-java.nio.charset.Charset-) | Ορίζει την προεπιλεγμένη κωδικοποίηση για αρχεία κειμένου. |
| [setExportMetaData(boolean value)](#setExportMetaData-boolean-) | Εξαγωγή μεταδεδομένων που σχετίζονται με Scene/Node στον πελάτη. Η προεπιλεγμένη τιμή είναι true |
...
| [setMetaDataPrefix(String value)](#setMetaDataPrefix-java.lang.String-) | Εάν αυτή η ιδιότητα δεν είναι null, μόνο οι ιδιότητες του Scene/Node που ξεκινούν με αυτό το πρόθεμα θα εξαχθούν, και το πρόθεμα θα αφαιρεθεί. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Κατασκευαστής του [A3dwSaveOptions](../../com.aspose.threed/a3dwsaveoptions)
...
Εξαγωγή μεταδεδομένων που σχετίζονται με Scene/Node στον πελάτη. Η προεπιλεγμένη τιμή είναι true

**Returns:**
boolean - Εξαγωγή μεταδεδομένων που σχετίζονται με Scene/Node στον πελάτη. Η προεπιλεγμένη τιμή είναι true
...
Εάν αυτή η ιδιότητα δεν είναι null, μόνο οι ιδιότητες του Scene/Node που ξεκινούν με αυτό το πρόθεμα θα εξαχθούν, και το πρόθεμα θα αφαιρεθεί.

**Returns:**
java.lang.String - Εάν αυτή η ιδιότητα δεν είναι null, μόνο οι ιδιότητες του Scene/Node που ξεκινούν με αυτό το πρόθεμα θα εξαχθούν, και το πρόθεμα θα αφαιρεθεί.
### hashCode() {#hashCode--}
```

...
description: Επιλογές αποθήκευσης για collada
type: docs
weight: 33
url: /el/java/com.aspose.threed/colladasaveoptions/
---
...
Επιλογές αποθήκευσης για collada
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [ColladaSaveOptions()](#ColladaSaveOptions--) | Κατασκευαστής του [ColladaSaveOptions](../../com.aspose.threed/colladasaveoptions) |
## Μέθοδοι
...
| [getIndented()](#getIndented--) | Λαμβάνει εάν το εξαγόμενο έγγραφο XML είναι εσοχή. |
...
| [getTransformStyle()](#getTransformStyle--) | Λαμβάνει το στυλ της μετατροπής κόμβου |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setIndented(boolean value)](#setIndented-boolean-) | Ορίζει εάν το εξαγόμενο έγγραφο XML είναι εσοχή. |
...
| [setTransformStyle(ColladaTransformStyle value)](#setTransformStyle-com.aspose.threed.ColladaTransformStyle-) | Ορίζει το στυλ της μετατροπής κόμβου |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Κατασκευαστής του [ColladaSaveOptions](../../com.aspose.threed/colladasaveoptions)
...
Λαμβάνει εάν το εξαγόμενο έγγραφο XML είναι εσοχή.

**Returns:**
boolean - εάν το εξαγόμενο έγγραφο XML είναι εσοχή.
...
Λαμβάνει το στυλ της μετατροπής κόμβου
...
Ορίζει εάν το εξαγόμενο έγγραφο XML είναι εσοχή.
...
Ορίζει το στυλ της μετατροπής κόμβου

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| value | [ColladaTransformStyle](../../com.aspose.threed/colladatransformstyle) | Νέα τιμή |

...
description: "Παράδειγμα μορφής Google Draco         Ο παρακάτω κώδικας δείχνει πώς να κωδικοποιήσετε και να αποκωδικοποιήσετε ένα Mesh σε/από πίνακα byte"
type: docs
weight: 46
url: /el/java/com.aspose.threed/dracoformat/
---
...
Μορφή Google Draco **Example:** Ο παρακάτω κώδικας δείχνει πώς να κωδικοποιήσετε και να αποκωδικοποιήσετε ένα Mesh σε/από byte array:
...
| Πεδίο | Περιγραφή |
| --- | --- |
| [AMF](#AMF) | Μορφή αρχείου προσθετικής κατασκευής |
| [ASE](#ASE) | Μορφή ASCII εξαγωγέα σκηνής του 3D Studio Max. |
| [ASPOSE3D_WEB](#ASPOSE3D-WEB) | Μορφή Aspose.3D Web. |
| [BLENDER](#BLENDER) | Μορφή 3D αρχείου του Blender |
| [COLLADA](#COLLADA) | Μορφή αρχείου Collada |
| [DISCREET3DS](#DISCREET3DS) | Μορφή αρχείου του 3D Studio |
| [DRACO](#DRACO) | Google Draco Mesh |
| [DXF](#DXF) | AutoCAD DXF |
| [FBX6100ASCII](#FBX6100ASCII) | Μορφή αρχείου ASCII FBX, με έκδοση 6.1.0 |
| [FBX6100_BINARY](#FBX6100-BINARY) | Μορφή αρχείου Binary FBX, με έκδοση 6.1.0 |
...
| [decode(byte[] data)](#decode-byte---) | Αποκωδικοποίηση του point cloud ή του mesh από δεδομένα μνήμης |
| [decode(String fileName)](#decode-java.lang.String-) | Αποκωδικοποίηση του point cloud ή του mesh από το καθορισμένο όνομα αρχείου |
...
| [encode(Entity entity)](#encode-com.aspose.threed.Entity-) | Κωδικοποίηση της οντότητας σε ακατέργαστα δεδομένα Draco |
| [encode(Entity entity, DracoSaveOptions options)](#encode-com.aspose.threed.Entity-com.aspose.threed.DracoSaveOptions-) | Κωδικοποίηση της οντότητας σε ακατέργαστα δεδομένα Draco |
| [encode(Entity entity, Stream stream)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-) | Κωδικοποιήστε την οντότητα σε καθορισμένο stream |
| [encode(Entity entity, Stream stream, DracoSaveOptions options)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-com.aspose.threed.DracoSaveOptions-) | Κωδικοποιήστε την οντότητα σε καθορισμένο stream |
| [encode(Entity entity, String fileName)](#encode-com.aspose.threed.Entity-java.lang.String-) | Κωδικοποίηση της οντότητας σε καθορισμένο αρχείο |
| [encode(Entity entity, String fileName, DracoSaveOptions options)](#encode-com.aspose.threed.Entity-java.lang.String-com.aspose.threed.DracoSaveOptions-) | Κωδικοποίηση της οντότητας σε καθορισμένο αρχείο |
...
Μορφή αρχείου προσθετικής κατασκευής
...
Μορφή ASCII εξαγωγέα σκηνής του 3D Studio Max.
...
Μορφή αρχείου Binary FBX, με έκδοση 6.1.0
...
Αποκωδικοποίηση του point cloud ή του mesh από δεδομένα μνήμης

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| δεδομένα | byte[] | Τα ακατέργαστα bytes drc |
...
Αποκωδικοποίηση του point cloud ή του mesh από το καθορισμένο όνομα αρχείου

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| fileName | java.lang.String | Το όνομα αρχείου περιέχει το αρχείο drc |
...
Κωδικοποίηση της οντότητας σε ακατέργαστα δεδομένα Draco

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | Η οντότητα που θα κωδικοποιηθεί |

**Returns:**
byte[] - Τα κωδικοποιημένα δεδομένα draco που αναπαρίστανται σε bytes **Παράδειγμα:** Ο παρακάτω κώδικας δείχνει πώς να κωδικοποιήσετε και να αποκωδικοποιήσετε ένα Mesh σε/από πίνακα byte:
...
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | Η οντότητα που θα κωδικοποιηθεί |
| options | [DracoSaveOptions](../../com.aspose.threed/dracosaveoptions) | Επιπλέον επιλογές για την κωδικοποίηση του point cloud |
...
Κωδικοποιήστε την οντότητα σε καθορισμένο stream

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | Η οντότητα που θα κωδικοποιηθεί |
| stream | [Stream](../../com.aspose.threed/stream) | Το stream στο οποίο θα γραφτούν τα κωδικοποιημένα δεδομένα |
...
Κωδικοποίηση της οντότητας σε καθορισμένο αρχείο

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | Η οντότητα που θα κωδικοποιηθεί |
| fileName | java.lang.String | Το όνομα αρχείου που θα γραφτεί |

...
description: Ορίζει τις συντεταγμένες UV για τα καθορισμένα στοιχεία.
type: docs
weight: 220
url: /el/java/com.aspose.threed/vertexelementuv/
---
...
Ορίζει τις συντεταγμένες UV για καθορισμένα στοιχεία. Ένα γεωμετρικό αντικείμενο μπορεί να έχει πολλαπλά στοιχεία [VertexElementUV](../../com.aspose.threed/vertexelementuv) και το καθένα έχει διαφορετικό [TextureMapping](../../com.aspose.threed/texturemapping)s.
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [VertexElementUV()](#VertexElementUV--) | Δημιουργεί μια νέα παρουσία της κλάσης [VertexElementUV](../../com.aspose.threed/vertexelementuv). |
| [VertexElementUV(TextureMapping textureMapping)](#VertexElementUV-com.aspose.threed.TextureMapping-) | Δημιουργεί μια νέα παρουσία της κλάσης [VertexElementUV](../../com.aspose.threed/vertexelementuv). |
## Μέθοδοι

| Μέθοδος | Περιγραφή |
| --- | --- |
| [addData(Iterable<Vector2> data)](#addData-java.lang.Iterable-com.aspose.threed.Vector2--) | Προσθέτει ένα σύνολο από [Vector2](../../com.aspose.threed/vector2) στο VertexElementUV.Data. |
| [addData2(Iterable<Vector3> data)](#addData2-java.lang.Iterable-com.aspose.threed.Vector3--) | Προσθέτει ένα σύνολο από [Vector3](../../com.aspose.threed/vector3) στο VertexElementUV.Data. |
...
Δημιουργεί μια νέα παρουσία της κλάσης [VertexElementUV](../../com.aspose.threed/vertexelementuv). Ο προεπιλεγμένος τύπος χαρτογράφησης υφής είναι [TextureMapping.DIFFUSE](../../com.aspose.threed/texturemapping\#DIFFUSE)
...
Δημιουργεί μια νέα παρουσία της κλάσης [VertexElementUV](../../com.aspose.threed/vertexelementuv).

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| textureMapping | [TextureMapping](../../com.aspose.threed/texturemapping) | Ο τύπος χαρτογράφησης υφής. |
...
Προσθέτει ένα σύνολο από [Vector2](../../com.aspose.threed/vector2) στο VertexElementUV.Data. Αυτό είναι συντόμευση, αυτή η μέθοδος θα μετατρέψει το [Vector2](../../com.aspose.threed/vector2) σε [Vector4](../../com.aspose.threed/vector4) με z στο 0 και w στο 0.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| δεδομένα | java.lang.Iterable<com.aspose.threed.Vector2> |  |
...
Προσθέτει ένα σύνολο από [Vector3](../../com.aspose.threed/vector3) στο VertexElementUV.Data. Αυτό είναι συντόμευση, αυτή η μέθοδος θα μετατρέψει το [Vector3](../../com.aspose.threed/vector3) σε [Vector4](../../com.aspose.threed/vector4) με w στο 0.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| δεδομένα | java.lang.Iterable<com.aspose.threed.Vector3> |  |

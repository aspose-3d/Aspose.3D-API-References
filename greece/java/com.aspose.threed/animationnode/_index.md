...
description: "Aspose.3Ds υποστηρίζει ιεραρχία κίνησης, κάθε κίνηση μπορεί να αποτελείται από πολλές κινήσεις και ορισμό καρέ-κλειδιού κίνησης."
type: docs
weight: 15
...
Το Aspose.3D υποστηρίζει ιεραρχία κίνησης, κάθε κίνηση μπορεί να αποτελείται από πολλές κινήσεις και τον ορισμό των key‑frame της κίνησης. [AnimationNode](../../com.aspose.threed/animationnode) ορίζει τον μετασχηματισμό μιας τιμής ιδιότητας με την πάροδο του χρόνου, για παράδειγμα, ο κόμβος κίνησης μπορεί να χρησιμοποιηθεί για να ελέγξει τον μετασχηματισμό ενός κόμβου ή άλλων αριθμητικών ιδιοτήτων του αντικειμένου [A3DObject](../../com.aspose.threed/a3dobject).
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [AnimationNode(String name)](#AnimationNode-java.lang.String-) | Αρχικοποιεί μια νέα παρουσία της κλάσης [AnimationNode](../../com.aspose.threed/animationnode). |
| [AnimationNode()](#AnimationNode--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [AnimationNode](../../com.aspose.threed/animationnode). |
## Μέθοδοι
...
| [findBindPoint(A3DObject target, String name)](#findBindPoint-com.aspose.threed.A3DObject-java.lang.String-) | Βρίσκει το σημείο σύνδεσης με βάση τον στόχο και το όνομα. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [AnimationNode](../../com.aspose.threed/animationnode).

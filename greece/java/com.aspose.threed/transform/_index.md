...
| [getRotationPivot()](#getRotationPivot--) | Λαμβάνει τον άξονα περιστροφής |
| [getScaling()](#getScaling--) | Λαμβάνει την κλιμάκωση |
| [getScalingOffset()](#getScalingOffset--) | Λαμβάνει τη μετατόπιση κλιμάκωσης |
| [getScalingPivot()](#getScalingPivot--) | Λαμβάνει τον άξονα κλιμάκωσης |
...
| [setEulerAngles(Vector3 value)](#setEulerAngles-com.aspose.threed.Vector3-) | Ορίζει τη περιστροφή που εκφράζεται σε γωνίες Euler, μετρημένες σε μοίρες |
...
| [setGeometricRotation(Vector3 value)](#setGeometricRotation-com.aspose.threed.Vector3-) | Ορίζει τη γεωμετρική περιστροφή Euler (μετρημένη σε μοίρες). |
| [setGeometricRotation(double rx, double ry, double rz)](#setGeometricRotation-double-double-double-) | Ορίζει τη γεωμετρική περιστροφή Euler (μετρημένη σε μοίρες). |
| [setGeometricScaling(Vector3 value)](#setGeometricScaling-com.aspose.threed.Vector3-) | Ορίζει τη γεωμετρική κλιμάκωση. |
| [setGeometricScaling(double sx, double sy, double sz)](#setGeometricScaling-double-double-double-) | Ορίζει τη γεωμετρική κλιμάκωση. |
| [setGeometricTranslation(Vector3 value)](#setGeometricTranslation-com.aspose.threed.Vector3-) | Ορίζει τη γεωμετρική μετάφραση. |
| [setGeometricTranslation(double x, double y, double z)](#setGeometricTranslation-double-double-double-) | Ορίζει τη γεωμετρική μετάφραση. |
...
| [setPostRotation(double rx, double ry, double rz)](#setPostRotation-double-double-double-) | Ορίζει τη μετα-περιστροφή που εκφράζεται σε μοίρες **Example:** |
...
| [setPreRotation(double rx, double ry, double rz)](#setPreRotation-double-double-double-) | Ορίζει τη προ-περιστροφή που εκφράζεται σε μοίρες **Example:** |
...
| [setRotation(Quaternion value)](#setRotation-com.aspose.threed.Quaternion-) | Ορίζει τη περιστροφή που εκφράζεται σε quaternion. |
...
| [setRotationOffset(Vector3 value)](#setRotationOffset-com.aspose.threed.Vector3-) | Ορίζει τη μετατόπιση περιστροφής |
| [setRotationPivot(Vector3 value)](#setRotationPivot-com.aspose.threed.Vector3-) | Ορίζει τον άξονα περιστροφής |
| [setScale(double sx, double sy, double sz)](#setScale-double-double-double-) | Ορίζει την κλίμακα του τρέχοντος μετασχηματισμού. |
| [setScaling(Vector3 value)](#setScaling-com.aspose.threed.Vector3-) | Ορίζει την κλιμάκωση |
| [setScalingOffset(Vector3 value)](#setScalingOffset-com.aspose.threed.Vector3-) | Ορίζει τη μετατόπιση κλιμάκωσης |
| [setScalingPivot(Vector3 value)](#setScalingPivot-com.aspose.threed.Vector3-) | Ορίζει τον άξονα κλιμάκωσης |
| [setTransformMatrix(Matrix4 value)](#setTransformMatrix-com.aspose.threed.Matrix4-) | Ορίζει τον πίνακα μετασχηματισμού. |
| [setTranslation(Vector3 value)](#setTranslation-com.aspose.threed.Vector3-) | Ορίζει τη μετάφραση |
...
Λαμβάνει τη γεωμετρική περιστροφή Euler (μετρημένη σε μοίρες). Ο γεωμετρικός μετασχηματισμός επηρεάζει μόνο τις συνδεδεμένες οντότητες και αφήνει τους υποκόμβους αμετάβλητους. Θα συγχωνευτεί ως τοπικός μετασχηματισμός όταν εξάγετε τον γεωμετρικό μετασχηματισμό σε τύπους αρχείων που δεν τον υποστηρίζουν.
...
Λαμβάνει τον άξονα περιστροφής
...
Λαμβάνει τη μετατόπιση κλιμάκωσης
...
Ορίζει τη περιστροφή που εκφράζεται σε γωνίες Euler, μετρημένες σε μοίρες
...
Ορίζει τη μετα-περιστροφή που εκφράζεται σε μοίρες **Example:**
...
Ορίζει τη προ-περιστροφή που εκφράζεται σε μοίρες **Example:**
...
Ορίζει τη περιστροφή που εκφράζεται σε quaternion.
...
Ορίζει τη μετατόπιση περιστροφής
...
Ορίζει τη μετατόπιση κλιμάκωσης
...
Ορίζει τον πίνακα μετασχηματισμού.

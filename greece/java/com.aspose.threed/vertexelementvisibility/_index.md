...
description: Ορίζει αν τα καθορισμένα στοιχεία είναι ορατά
type: docs
weight: 225
url: /el/java/com.aspose.threed/vertexelementvisibility/
---
...
| --- | --- |
| [VertexElementVisibility()](#VertexElementVisibility--) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [VertexElementVisibility](../../com.aspose.threed/vertexelementvisibility). |
## Μέθοδοι
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [VertexElementVisibility](../../com.aspose.threed/vertexelementvisibility).

...
| --- | --- |
| [Pyramid()](#Pyramid--) | Δημιουργήστε ένα νέο αντικείμενο πυραμίδας με προεπιλεγμένη περιοχή βάσης (10, 10) και προεπιλεγμένο ύψος (5) |
| [Pyramid(double xbottom, double ybottom, double height)](#Pyramid-double-double-double-) | Δημιουργήστε ένα νέο αντικείμενο πυραμίδας με καθορισμένη περιοχή βάσης |
...
Δημιουργήστε ένα νέο αντικείμενο πυραμίδας με προεπιλεγμένη περιοχή βάσης (10, 10) και προεπιλεγμένο ύψος (5)
...
Δημιουργήστε ένα νέο αντικείμενο πυραμίδας με καθορισμένη περιοχή βάσης

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| xbottom | double | Το μήκος της βάσης στην κατεύθυνση x |
| ybottom | double | Το μήκος της βάσης στην κατεύθυνση y |
| ύψος | double | Το ύψος της πυραμίδας |

...
description: "Υλοποίηση πίνακα 4x4."
type: docs
weight: 100
url: /el/java/com.aspose.threed/matrix4/
---
...
| --- | --- |
| [Matrix4(Vector4 r0, Vector4 r1, Vector4 r2, Vector4 r3)](#Matrix4-com.aspose.threed.Vector4-com.aspose.threed.Vector4-com.aspose.threed.Vector4-com.aspose.threed.Vector4-) | Δημιουργεί μήτρα από 4 σειρές. |
| [Matrix4(double m00, double m01, double m02, double m03, double m10, double m11, double m12, double m13, double m20, double m21, double m22, double m23, double m30, double m31, double m32, double m33)](#Matrix4-double-double-double-double-double-double-double-double-double-double-double-double-double-double-double-double-) | Αρχικοποιεί μια νέα παρουσία της δομής [Matrix4](../../com.aspose.threed/matrix4). |
| [Matrix4(FMatrix4 m)](#Matrix4-com.aspose.threed.FMatrix4-) | Δημιουργεί το [Matrix4](../../com.aspose.threed/matrix4) από μια παρουσία του [FMatrix4](../../com.aspose.threed/fmatrix4). |
| [Matrix4(double[] m)](#Matrix4-double---) | Αρχικοποιεί μια νέα παρουσία της δομής [Matrix4](../../com.aspose.threed/matrix4). |
| [Matrix4()](#Matrix4--) |  |
## Πεδία
...
| [decompose(Vector3 translation, Vector3 scaling, Quaternion rotation)](#decompose-com.aspose.threed.Vector3-com.aspose.threed.Vector3-com.aspose.threed.Quaternion-) | Αποσυνθέτει τον πίνακα μετασχηματισμού. |
| [equals(Object obj)](#equals-java.lang.Object-) |  |
| [getClass()](#getClass--) |  |
| [getDeterminant()](#getDeterminant--) | Λαμβάνει την ορίζουσα του πίνακα. |
| [getIdentity()](#getIdentity--) | Λαμβάνει τον μοναδιαίο πίνακα. |
| [hashCode()](#hashCode--) |  |
| [inverse()](#inverse--) | Αντιστρέφει αυτήν την παρουσία. |
| [mul(Matrix4 lhs, Matrix4 rhs)](#mul-com.aspose.threed.Matrix4-com.aspose.threed.Matrix4-) | Πολλαπλασιάζει τους δύο πίνακες |
| [mul(Matrix4 lhs, Vector3 v)](#mul-com.aspose.threed.Matrix4-com.aspose.threed.Vector3-) | Πολλαπλασιάζει τον πίνακα και το vector3 |
| [mul(Matrix4 lhs, Vector4 v)](#mul-com.aspose.threed.Matrix4-com.aspose.threed.Vector4-) | Πολλαπλασιάζει τον πίνακα και το vector4 |
| [mul(Matrix4 lhs, double v)](#mul-com.aspose.threed.Matrix4-double-) | Πολλαπλασιάστε τη μήτρα με διπλή τιμή |
| [normalize()](#normalize--) | Κανονικοποιεί αυτήν την instance. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [rotate(Quaternion q)](#rotate-com.aspose.threed.Quaternion-) | Δημιουργεί έναν πίνακα περιστροφής από ένα quaternion |
| [rotate(double angle, Vector3 axis)](#rotate-double-com.aspose.threed.Vector3-) | Δημιουργεί έναν πίνακα περιστροφής με γωνία περιστροφής και άξονα |
| [rotateFromEuler(Vector3 eul)](#rotateFromEuler-com.aspose.threed.Vector3-) | Δημιουργεί έναν πίνακα περιστροφής από γωνία Euler |
| [rotateFromEuler(double rx, double ry, double rz)](#rotateFromEuler-double-double-double-) | Δημιουργεί έναν πίνακα περιστροφής από γωνία Euler |
| [scale(Vector3 s)](#scale-com.aspose.threed.Vector3-) | Δημιουργεί έναν πίνακα που κλιμακώνει κατά τον άξονα x, τον άξονα y και τον άξονα z. |
| [scale(double s)](#scale-double-) | Δημιουργεί έναν πίνακα που κλιμακώνει κατά τον άξονα x, τον άξονα y και τον άξονα z. |
| [scale(double sx, double sy, double sz)](#scale-double-double-double-) | Δημιουργεί έναν πίνακα που κλιμακώνει κατά τον άξονα x, τον άξονα y και τον άξονα z. |
| [setTRS(Vector3 translation, Vector3 rotation, Vector3 scale)](#setTRS-com.aspose.threed.Vector3-com.aspose.threed.Vector3-com.aspose.threed.Vector3-) | Αρχικοποιεί τον πίνακα με μετάφραση/περιστροφή/κλίμακα |
| [toArray()](#toArray--) | Μετατρέπει τον πίνακα σε array. |
| [toString()](#toString--) | Επιστρέφει ένα java.lang.String που αντιπροσωπεύει το τρέχον [Matrix4](../../com.aspose.threed/matrix4). |
| [translate(Vector3 t)](#translate-com.aspose.threed.Vector3-) | Δημιουργεί έναν πίνακα που μεταφράζει κατά τον άξονα x, τον άξονα y και τον άξονα z |
| [translate(double tx, double ty, double tz)](#translate-double-double-double-) | Δημιουργεί έναν πίνακα που μεταφράζει κατά τον άξονα x, τον άξονα y και τον άξονα z |

...
description: Επιλογές φόρτωσης για καθολικό 3D
type: docs
weight: 197
url: /el/java/com.aspose.threed/u3dloadoptions/
---
...
Επιλογές φόρτωσης για καθολικό 3D
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [U3dLoadOptions()](#U3dLoadOptions--) | Κατασκευαστής της [U3dLoadOptions](../../com.aspose.threed/u3dloadoptions). |
## Μέθοδοι
...
Κατασκευαστής της [U3dLoadOptions](../../com.aspose.threed/u3dloadoptions).

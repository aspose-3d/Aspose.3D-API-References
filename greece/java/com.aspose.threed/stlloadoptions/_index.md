...
type: docs
weight: 176
url: /el/java/com.aspose.threed/stlloadoptions/
---
...
| --- | --- |
| [StlLoadOptions()](#StlLoadOptions--) | Αρχικοποιεί ένα νέο αντικείμενο [StlLoadOptions](../../com.aspose.threed/stlloadoptions). |
| [StlLoadOptions(FileContentType contentType)](#StlLoadOptions-com.aspose.threed.FileContentType-) | Αρχικοποιεί ένα νέο αντικείμενο [StlLoadOptions](../../com.aspose.threed/stlloadoptions). |
## Μέθοδοι
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | Λαμβάνει αν θα αντιστραφεί το σύστημα συντεταγμένων των σημείων ελέγχου/κανονικών κατά την εισαγωγή. |
...
| [getRecalculateNormal()](#getRecalculateNormal--) | Αγνοεί τα δεδομένα κανονικών που αποθηκεύονται στο αρχείο STL και επανυπολογίζει τα δεδομένα κανονικών βάσει της θέσης των κορυφών. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | Ορίζει αν θα αντιστραφεί το σύστημα συντεταγμένων των σημείων ελέγχου/κανονικών κατά την εισαγωγή. |
...
| [setRecalculateNormal(boolean value)](#setRecalculateNormal-boolean-) | Αγνοεί τα δεδομένα κανονικών που αποθηκεύονται στο αρχείο STL και επανυπολογίζει τα δεδομένα κανονικών βάσει της θέσης των κορυφών. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Αρχικοποιεί ένα νέο αντικείμενο [StlLoadOptions](../../com.aspose.threed/stlloadoptions).
...
Λαμβάνει αν θα αντιστραφεί το σύστημα συντεταγμένων των σημείων ελέγχου/κανονικών κατά την εισαγωγή.

**Returns:**
boolean - αν θα αντιστραφεί το σύστημα συντεταγμένων των σημείων ελέγχου/κανονικών κατά την εισαγωγή.
...
Αγνοεί τα δεδομένα κανονικών που αποθηκεύονται στο αρχείο STL και επανυπολογίζει τα δεδομένα κανονικών βάσει της θέσης των κορυφών. Η προεπιλεγμένη τιμή είναι false

**Returns:**
boolean - Αγνοεί τα δεδομένα κανονικών που αποθηκεύονται στο αρχείο STL και επανυπολογίζει τα δεδομένα κανονικών βάσει της θέσης των κορυφών. Η προεπιλεγμένη τιμή είναι false
### hashCode() {#hashCode--}
```
...
Ορίζει αν θα αντιστραφεί το σύστημα συντεταγμένων των σημείων ελέγχου/κανονικών κατά την εισαγωγή.

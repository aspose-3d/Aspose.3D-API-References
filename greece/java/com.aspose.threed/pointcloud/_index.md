...
description: "Το σύννεφο σημείων δεν περιέχει πληροφορίες τοπολογίας, αλλά μόνο τα σημεία ελέγχου και τα στοιχεία κορυφών."
type: docs
weight: 132
url: /el/java/com.aspose.threed/pointcloud/
---
...
Το σύννεφο σημείων δεν περιέχει πληροφορίες τοπολογίας, αλλά μόνο τα σημεία ελέγχου και τα στοιχεία κορυφών.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PointCloud(String name)](#PointCloud-java.lang.String-) | Κατασκευαστής του [PointCloud](../../com.aspose.threed/pointcloud) |
| [PointCloud()](#PointCloud--) | Κατασκευαστής του [PointCloud](../../com.aspose.threed/pointcloud) |
## Μέθοδοι
...
| [fromGeometry(Geometry g)](#fromGeometry-com.aspose.threed.Geometry-) | Δημιουργήστε ένα νέο αντικείμενο PointCloud από ένα γεωμετρικό αντικείμενο |
| [fromGeometry(Geometry g, int density)](#fromGeometry-com.aspose.threed.Geometry-int-) | Δημιουργήστε ένα νέο αντικείμενο point cloud από ένα γεωμετρικό αντικείμενο. |
...
| [getDimension()](#getDimension--) | Εάν υπάρχει τιμή διάστασης για το point cloud, υποδεικνύει ένα οργανωμένο point cloud. |
...
| [setDimension(Vector2 value)](#setDimension-com.aspose.threed.Vector2-) | Εάν υπάρχει τιμή διάστασης για το point cloud, υποδεικνύει ένα οργανωμένο point cloud. |
...
Κατασκευαστής του [PointCloud](../../com.aspose.threed/pointcloud)
...
Δημιουργήστε ένα νέο αντικείμενο PointCloud από ένα γεωμετρικό αντικείμενο
...
Δημιουργήστε ένα νέο αντικείμενο point cloud από ένα γεωμετρικό αντικείμενο. Η πυκνότητα είναι ο αριθμός των σημείων ανά μονάδα τριγώνου (Το μονάδα τριγώνου είναι η τριγωνική με τη μέγιστη επιφάνεια από το πλέγμα)

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| g | [Geometry](../../com.aspose.threed/geometry) | Mesh ή άλλο αντικείμενο γεωμετρίας |
| πυκνότητα | int | Αριθμός σημείων ανά μονάδα τριγώνου |
...
Εάν υπάρχει τιμή διάστασης για το point cloud, υποδεικνύει ένα οργανωμένο point cloud. Χωρίς καθορισμένο μέγεθος, θεωρείται ένα ακατάστατο point cloud. Το οργανωμένο point cloud σημαίνει ότι έχει δομή παρόμοια με εικόνα.

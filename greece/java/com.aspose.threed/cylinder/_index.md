...
| --- | --- |
| [Cylinder()](#Cylinder--) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [Cylinder](../../com.aspose.threed/cylinder). |
| [Cylinder(double radius, double height)](#Cylinder-double-double-) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [Cylinder](../../com.aspose.threed/cylinder). |
| [Cylinder(double radiusTop, double radiusBottom, double height)](#Cylinder-double-double-double-) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [Cylinder](../../com.aspose.threed/cylinder). |
| [Cylinder(double radiusTop, double radiusBottom, double height, int radialSegments, int heightSegments, boolean openEnded)](#Cylinder-double-double-double-int-int-boolean-) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [Cylinder](../../com.aspose.threed/cylinder). |
| [Cylinder(String name, double radiusTop, double radiusBottom, double height, int radialSegments, int heightSegments, boolean openEnded, double thetaStart, double thetaLength)](#Cylinder-java.lang.String-double-double-double-int-int-boolean-double-double-) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [Cylinder](../../com.aspose.threed/cylinder). |
## Μέθοδοι
...
| [getGenerateFanCylinder()](#getGenerateFanCylinder--) | Λαμβάνει εάν δημιουργείται ο κύλινδρος τύπου fan όταν το ThetaLength είναι μικρότερο από 2\*PI, διαφορετικά το μοντέλο δεν θα κοπεί. |
| [getHeight()](#getHeight--) | Λαμβάνει το ύψος του κυλίνδρου. |
| [getHeightSegments()](#getHeightSegments--) | Λαμβάνει τα τμήματα ύψους. |
| [getName()](#getName--) | Λαμβάνει το όνομα. |
| [getOffsetBottom()](#getOffsetBottom--) | Λαμβάνει τη μετατόπιση μετασχηματισμού των κορυφών της κάτω πλευράς. |
| [getOffsetTop()](#getOffsetTop--) | Λαμβάνει τη μετατόπιση μετασχηματισμού των κορυφών της πάνω πλευράς. |
| [getOpenEnded()](#getOpenEnded--) | Λαμβάνει μια τιμή που υποδεικνύει εάν αυτός ο [Cylinder](../../com.aspose.threed/cylinder) είναι ανοιχτού άκρου. |
...
| [getRadialSegments()](#getRadialSegments--) | Λαμβάνει τα ακτινικά τμήματα. |
| [getRadiusBottom()](#getRadiusBottom--) | Λαμβάνει την ακτίνα του κάτω καπάκιου του κυλίνδρου. |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [Cylinder](../../com.aspose.threed/cylinder).
...
| ύψος | double | Ύψος του κυλίνδρου. |
...
Λαμβάνει εάν δημιουργείται ο κύλινδρος τύπου fan όταν το ThetaLength είναι μικρότερο από 2\*PI, διαφορετικά το μοντέλο δεν θα κοπεί.
...
Λαμβάνει το ύψος του κυλίνδρου.
...
Λαμβάνει τη μετατόπιση μετασχηματισμού των κορυφών της κάτω πλευράς.
...
Λαμβάνει τη μετατόπιση μετασχηματισμού των κορυφών της πάνω πλευράς.
...
Λαμβάνει την ακτίνα του κάτω καπάκιου του κυλίνδρου.

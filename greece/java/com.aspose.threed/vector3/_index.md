...
| [negative(Vector3 v)](#negative-com.aspose.threed.Vector3-) | Υπερφόρτωση τελεστή για - |
| [normalize()](#normalize--) | Κανονικοποιεί αυτήν την instance. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [op_eq(Vector3 lhs, Vector3 rhs)](#op-eq-com.aspose.threed.Vector3-com.aspose.threed.Vector3-) | Τελεστής ισότητας για Vector3 |
| [op_ne(Vector3 lhs, Vector3 rhs)](#op-ne-com.aspose.threed.Vector3-com.aspose.threed.Vector3-) | Τελεστής ανισότητας για Vector3 |
| [set(double newX, double newY, double newZ)](#set-double-double-double-) | Ορίζει τα συστατικά x/y/z σε μία κλήση. |
| [set(int idx, double value)](#set-int-double-) | Ορίζει το στοιχείο του διανύσματος με βάση το δείκτη. |
| [sin()](#sin--) | Υπολογίζει το ημίτονο σε κάθε συνιστώσα. |
| [sub(Vector3 lhs, Vector3 rhs)](#sub-com.aspose.threed.Vector3-com.aspose.threed.Vector3-) | Υπερφόρτωση τελεστή για - (μείον) |
| [toString()](#toString--) | Επιστρέφει ένα java.lang.String που αντιπροσωπεύει το τρέχον [Vector3](../../com.aspose.threed/vector3). |
| [wait()](#wait--) |  |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| vec | [FVector3](../../com.aspose.threed/fvector3) | Η συντεταγμένη x. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| lhs | [Vector3](../../com.aspose.threed/vector3) | Το αριστερό διάνυσμα |
| rhs | [Vector3](../../com.aspose.threed/vector3) | Το δεξί διάνυσμα |
...
**Returns:**
double - εσωτερική γωνία σε ακτίνια
...
| --- | --- | --- |
| lhs | [Vector3](../../com.aspose.threed/vector3) | Το αριστερό διάνυσμα |
| rhs | double | Η δεξιά τιμή double |
...
**Returns:**
double - Το εσωτερικό γινόμενο των δύο διανυσμάτων.
...
**Returns:**
double - το στοιχείο του διανύσματος κατά δείκτη.
### getClass() {#getClass--}
```
...
**Returns:**
double - το μήκος αυτού του διανύσματος.
...
**Returns:**
double - το τετράγωνο του μήκους.
### getOne() {#getOne--}
```
...
**Returns:**
int - Ο κωδικός κατακερματισμού του [Vector3](../../com.aspose.threed/vector3)
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| lhs | double | Ο αριστερός βαθμωτός |
| rhs | [Vector3](../../com.aspose.threed/vector3) | Το δεξί διάνυσμα |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| v | [Vector3](../../com.aspose.threed/vector3) | Το διάνυσμα προέλευσης |
...
Τελεστής ισότητας για Vector3

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| lhs | [Vector3](../../com.aspose.threed/vector3) | Τιμή αριστερής πλευράς. |
| rhs | [Vector3](../../com.aspose.threed/vector3) | Τιμή δεξιάς πλευράς. |
...
Τελεστής ανισότητας για Vector3
...
**Returns:**
boolean - Αληθές εάν δύο διανύσματα δεν είναι ίσα.
...
Ορίζει το στοιχείο του διανύσματος με βάση το δείκτη.
...
Επιστρέφει ένα java.lang.String που αντιπροσωπεύει το τρέχον [Vector3](../../com.aspose.threed/vector3).

**Returns:**
java.lang.String - Μια java.lang.String που αντιπροσωπεύει το τρέχον [Vector3](../../com.aspose.threed/vector3).
### wait() {#wait--}
```

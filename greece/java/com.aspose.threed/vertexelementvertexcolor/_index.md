...
description: Ορίζει το χρώμα κορυφής για τα καθορισμένα στοιχεία
type: docs
weight: 223
url: /el/java/com.aspose.threed/vertexelementvertexcolor/
---
...
| --- | --- |
| [VertexElementVertexColor()](#VertexElementVertexColor--) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [VertexElementVertexColor](../../com.aspose.threed/vertexelementvertexcolor). |
## Μέθοδοι
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [VertexElementVertexColor](../../com.aspose.threed/vertexelementvertexcolor).

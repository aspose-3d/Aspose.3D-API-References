...
description: είναι μια επιφάνεια που αναπαρίσταται από NURBS Non-uniform rational basis spline. Μια επιφάνεια ορίζεται από δύο  και .
type: docs
weight: 114
url: /el/java/com.aspose.threed/nurbssurface/
---
...
| --- | --- |
| [NurbsSurface()](#NurbsSurface--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [NurbsSurface](../../com.aspose.threed/nurbssurface). |
| [NurbsSurface(String name)](#NurbsSurface-java.lang.String-) | Αρχικοποιεί μια νέα παρουσία της κλάσης [NurbsSurface](../../com.aspose.threed/nurbssurface). |
## Μέθοδοι
...
| [getU()](#getU--) | Λαμβάνει την κατεύθυνση U της επιφάνειας NURBS |
| [getV()](#getV--) | Λαμβάνει την κατεύθυνση V της επιφάνειας NURBS |
...
| [toMesh()](#toMesh--) | Μετατρέπει την επιφάνεια NURBS σε πλέγμα |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [NurbsSurface](../../com.aspose.threed/nurbssurface).
...
Μετατρέπει την επιφάνεια NURBS σε πλέγμα

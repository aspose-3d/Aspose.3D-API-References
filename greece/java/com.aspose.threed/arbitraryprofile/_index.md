...
description: Αυτή η κλάση σας επιτρέπει να δημιουργήσετε ένα 2D προφίλ απευθείας από αυθαίρετη καμπύλη.
type: docs
weight: 16
url: /el/java/com.aspose.threed/arbitraryprofile/
---
...
Αυτή η κλάση σας επιτρέπει να δημιουργήσετε ένα 2D προφίλ απευθείας από αυθαίρετη καμπύλη.
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [ArbitraryProfile()](#ArbitraryProfile--) | Κατασκευαστής του [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) |
| [ArbitraryProfile(Curve curve)](#ArbitraryProfile-com.aspose.threed.Curve-) | Κατασκευαστής του [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) με αρχική καμπύλη. |
## Μέθοδοι
...
| [getClass()](#getClass--) |  |
| [getCurve()](#getCurve--) | Η Καμπύλη που χρησιμοποιείται για την κατασκευή του προφίλ |
...
| [getHoles()](#getHoles--) | Τρύπες του προφίλ, επίσης αναπαριστώνται ως καμπύλη |
...
| [setCurve(Curve value)](#setCurve-com.aspose.threed.Curve-) | Η Καμπύλη που χρησιμοποιείται για την κατασκευή του προφίλ |
...
Κατασκευαστής του [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile)
...
Κατασκευαστής του [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) με αρχική καμπύλη.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Αρχική καμπύλη του προφίλ |
...
Η Καμπύλη που χρησιμοποιείται για την κατασκευή του προφίλ
...
Τρύπες του προφίλ, επίσης αναπαριστώνται ως καμπύλη

**Returns:**
java.util.ArrayList<com.aspose.threed.Curve> - Τρύπες του προφίλ, επίσης αναπαριστώνται ως καμπύλη
### getName() {#getName--}
```

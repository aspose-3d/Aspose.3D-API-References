...
description: Επιλογές φόρτωσης για αρχείο 3DS.
type: docs
weight: 43
url: /el/java/com.aspose.threed/discreet3dsloadoptions/
---
...
Επιλογές φόρτωσης για αρχείο 3DS.
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [Discreet3dsLoadOptions()](#Discreet3dsLoadOptions--) | Κατασκευαστής του [Discreet3dsLoadOptions](../../com.aspose.threed/discreet3dsloadoptions) |
## Μέθοδοι

| Μέθοδος | Περιγραφή |
| --- | --- |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getApplyAnimationTransform()](#getApplyAnimationTransform--) | Λαμβάνει εάν να χρησιμοποιηθεί η μετατροπή που ορίζεται στο πρώτο καρέ του κομματιού κίνησης. |
| [getClass()](#getClass--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setApplyAnimationTransform(boolean value)](#setApplyAnimationTransform-boolean-) | Ορίζει εάν να χρησιμοποιηθεί η μετατροπή που ορίζεται στο πρώτο καρέ του κομματιού κίνησης. |
...
Κατασκευαστής του [Discreet3dsLoadOptions](../../com.aspose.threed/discreet3dsloadoptions)
...
Λαμβάνει εάν να χρησιμοποιηθεί η μετατροπή που ορίζεται στο πρώτο καρέ του κομματιού κίνησης.

**Returns:**
boolean - εάν να χρησιμοποιηθεί η μετατροπή που ορίζεται στο πρώτο καρέ του κομματιού κίνησης.
### getClass() {#getClass--}
```
...
Ορίζει εάν να χρησιμοποιηθεί η μετατροπή που ορίζεται στο πρώτο καρέ του κομματιού κίνησης.

...
description: Ορίζει τα κανονικά διανύσματα για τα καθορισμένα στοιχεία.
type: docs
weight: 214
url: /el/java/com.aspose.threed/vertexelementnormal/
---
...
| --- | --- |
| [VertexElementNormal()](#VertexElementNormal--) | Δημιουργεί ένα νέο στιγμιότυπο της κλάσης [VertexElementNormal](../../com.aspose.threed/vertexelementnormal). |
## Μέθοδοι
...
Δημιουργεί ένα νέο στιγμιότυπο της κλάσης [VertexElementNormal](../../com.aspose.threed/vertexelementnormal).

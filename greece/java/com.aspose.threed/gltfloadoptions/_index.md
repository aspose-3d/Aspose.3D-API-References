...
description: Επιλογές φόρτωσης για τη μορφή glTF
type: docs
weight: 73
url: /el/java/com.aspose.threed/gltfloadoptions/
---
...
Επιλογές φόρτωσης για τη μορφή glTF
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [GltfLoadOptions()](#GltfLoadOptions--) | Κατασκευαστής του [GltfLoadOptions](../../com.aspose.threed/gltfloadoptions) |
## Μέθοδοι
...
| [getFlipTexCoordV()](#getFlipTexCoordV--) | Αντιστρέψτε τη συντεταγμένη v(t) στις υφασματικές συντεταγμένες του πλέγματος, η προεπιλεγμένη τιμή είναι true. |
...
| [setFlipTexCoordV(boolean value)](#setFlipTexCoordV-boolean-) | Αντιστρέψτε τη συντεταγμένη v(t) στις υφασματικές συντεταγμένες του πλέγματος, η προεπιλεγμένη τιμή είναι true. |
...
Κατασκευαστής του [GltfLoadOptions](../../com.aspose.threed/gltfloadoptions)
...
Αντιστρέψτε τη συντεταγμένη v(t) στις υφασματικές συντεταγμένες του πλέγματος, η προεπιλεγμένη τιμή είναι true.

**Returns:**
boolean - Αντιστρέψτε τη συντεταγμένη v(t) στις υφασματικές συντεταγμένες του πλέγματος, η προεπιλεγμένη τιμή είναι true.

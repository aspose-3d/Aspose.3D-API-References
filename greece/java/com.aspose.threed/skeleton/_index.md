...
description: Το  χρησιμοποιείται κυρίως από λογισμικό CAD για να βοηθήσει τον σχεδιαστή να χειριστεί τη μετασχηματισμό της σκελετικής δομής· συνήθως είναι άχρηστο εκτός των λογισμικών CAD.
type: docs
weight: 172
url: /el/java/com.aspose.threed/skeleton/
---
...
Το [Skeleton](../../com.aspose.threed/skeleton) χρησιμοποιείται κυρίως από λογισμικό CAD για να βοηθήσει τον σχεδιαστή να χειριστεί τη μετασχηματισμό της σκελετικής δομής· συνήθως είναι άχρηστο εκτός των λογισμικών CAD. Για να λειτουργεί η ιεραρχία του σκελετού σαν ένα αντικείμενο στο λογισμικό CAD, είναι απαραίτητο να σηματοδοτηθεί ο κορυφαίος κόμβος [Skeleton](../../com.aspose.threed/skeleton) ως ρίζα ορίζοντας το [getType](../../com.aspose.threed/skeleton\#getType) σε [SkeletonType.SKELETON](../../com.aspose.threed/skeletontype\#SKELETON), και όλα τα παιδιά να οριστούν σε [SkeletonType.BONE](../../com.aspose.threed/skeletontype\#BONE).
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [Skeleton()](#Skeleton--) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [Skeleton](../../com.aspose.threed/skeleton). |
| [Skeleton(String name)](#Skeleton-java.lang.String-) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [Skeleton](../../com.aspose.threed/skeleton). |
| [Skeleton(String name, SkeletonType type)](#Skeleton-java.lang.String-com.aspose.threed.SkeletonType-) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [Skeleton](../../com.aspose.threed/skeleton). |
## Μέθοδοι
...
| [getSize()](#getSize--) | Λαμβάνει το μέγεθος του κόμβου άκρου που χρησιμοποιείται στο λογισμικό CAD για να αντιπροσωπεύσει το μέγεθος του οστού. |
| [getType()](#getType--) | Λαμβάνει τον τύπο του σκελετού. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setSize(double value)](#setSize-double-) | Ορίζει το μέγεθος του κόμβου άκρου που χρησιμοποιείται στο λογισμικό CAD για να αντιπροσωπεύσει το μέγεθος του οστού. |
| [setType(SkeletonType value)](#setType-com.aspose.threed.SkeletonType-) | Ορίζει τον τύπο του σκελετού. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [Skeleton](../../com.aspose.threed/skeleton).
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| name | java.lang.String | Όνομα οντότητας. |
| type | [SkeletonType](../../com.aspose.threed/skeletontype) | Τύπος σκελετού |
...
Λαμβάνει το μέγεθος του κόμβου άκρου που χρησιμοποιείται στο λογισμικό CAD για να αντιπροσωπεύσει το μέγεθος του οστού.

**Returns:**
double - το μέγεθος του κόμβου άκρου που χρησιμοποιείται στο λογισμικό CAD για να αντιπροσωπεύσει το μέγεθος του οστού.
### getType() {#getType--}
```
...
Λαμβάνει τον τύπο του σκελετού.
...
Ορίζει το μέγεθος του κόμβου άκρου που χρησιμοποιείται στο λογισμικό CAD για να αντιπροσωπεύσει το μέγεθος του οστού.
...
Ορίζει τον τύπο του σκελετού.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| value | [SkeletonType](../../com.aspose.threed/skeletontype) | Νέα τιμή |

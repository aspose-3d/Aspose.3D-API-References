...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [bindDescriptorSet(IDescriptorSet descriptorSet)](#bindDescriptorSet-com.aspose.threed.IDescriptorSet-) | Δέσμευση του συνόλου περιγραφέα στην τρέχουσα pipeline |
...
Δέσμευση του συνόλου περιγραφέα στην τρέχουσα pipeline

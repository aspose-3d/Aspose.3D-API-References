...
type: docs
weight: 162
url: /el/java/com.aspose.threed/sceneobject/
---
...
| --- | --- |
| [SceneObject(String name)](#SceneObject-java.lang.String-) | Αρχικοποιήστε ένα SceneObject με προεπιλεγμένο όνομα |
| [SceneObject()](#SceneObject--) | Αρχικοποιήστε ένα SceneObject. |
## Μέθοδοι
...
Αρχικοποιήστε ένα SceneObject με προεπιλεγμένο όνομα

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| name | java.lang.String | Το όνομα αυτής της παρουσίας |

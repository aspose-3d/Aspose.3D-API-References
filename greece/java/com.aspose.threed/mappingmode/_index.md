...
Καθορίζει πώς το στοιχείο αντιστοιχίζεται σε μια επιφάνεια. Το [MappingMode](../../com.aspose.threed/mappingmode) ορίζει πώς το [VertexElement](../../com.aspose.threed/vertexelement) αντιστοιχίζεται στην επιφάνεια της γεωμετρίας.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [ALL_SAME](#ALL-SAME) | Ένα δεδομένο αντιστοιχίζεται σε ολόκληρη την επιφάνεια. |

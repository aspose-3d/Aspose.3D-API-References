...
description: Ορίζει τα διπλά διανύσματα για τα καθορισμένα στοιχεία.
type: docs
weight: 208
url: /el/java/com.aspose.threed/vertexelementbinormal/
---
...
Ορίζει τα διπλά διανύσματα για τα καθορισμένα στοιχεία.
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [VertexElementBinormal()](#VertexElementBinormal--) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [VertexElementBinormal](../../com.aspose.threed/vertexelementbinormal). |
## Μέθοδοι
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [VertexElementBinormal](../../com.aspose.threed/vertexelementbinormal).

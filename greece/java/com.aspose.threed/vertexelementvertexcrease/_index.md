...
description: Ορίζει τη ραφή κορυφής για τα καθορισμένα στοιχεία
type: docs
weight: 224
url: /el/java/com.aspose.threed/vertexelementvertexcrease/
---
...
Ορίζει τη ραφή κορυφής για τα καθορισμένα στοιχεία
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [VertexElementVertexCrease()](#VertexElementVertexCrease--) | Initializes a new instance of the [VertexElementVertexCrease](../../com.aspose.threed/vertexelementvertexcrease) class. |
## Μέθοδοι
...
Initializes a new instance of the [VertexElementVertexCrease](../../com.aspose.threed/vertexelementvertexcrease) class.

...
description: "Η βασική κλάση όλων των οντοτήτων."
type: docs
weight: 52
url: /el/java/com.aspose.threed/entity/
---
...
Η βασική κλάση όλων των οντοτήτων. Η Entity αντιπροσωπεύει ένα συγκεκριμένο αντικείμενο που είναι προσαρτημένο κάτω από έναν κόμβο όπως το [Light](../../com.aspose.threed/light)/[Geometry](../../com.aspose.threed/geometry).
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [Entity(String name)](#Entity-java.lang.String-) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [Entity](../../com.aspose.threed/entity). |
## Μέθοδοι
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [Entity](../../com.aspose.threed/entity).

...
description: Υλικό για το μοντέλο σκίασης blinn-phong.
type: docs
weight: 126
url: /el/java/com.aspose.threed/phongmaterial/
---
...
| --- | --- |
| [PhongMaterial()](#PhongMaterial--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [PhongMaterial](../../com.aspose.threed/phongmaterial). |
| [PhongMaterial(String name)](#PhongMaterial-java.lang.String-) | Αρχικοποιεί μια νέα παρουσία της κλάσης [PhongMaterial](../../com.aspose.threed/phongmaterial). |
## Πεδία
...
| [getReflectionColor()](#getReflectionColor--) | Λαμβάνει το χρώμα ανάκλασης. |
| [getReflectionFactor()](#getReflectionFactor--) | Λαμβάνει την εξασθένιση του χρώματος ανάκλασης. |
| [getShininess()](#getShininess--) | Λαμβάνει τη γυαλάδα, η οποία ελέγχει το μέγεθος της αντανακλαστικής λάμψης. |
| [getSpecularColor()](#getSpecularColor--) | Λαμβάνει το χρώμα αντανακλαστικό. |
| [getSpecularFactor()](#getSpecularFactor--) | Λαμβάνει τον παράγοντα αντανακλαστικότητας. |
...
| [setReflectionColor(Vector3 value)](#setReflectionColor-com.aspose.threed.Vector3-) | Ορίζει το χρώμα ανάκλασης. |
| [setReflectionFactor(double value)](#setReflectionFactor-double-) | Ορίζει την εξασθένιση του χρώματος αντανάκλασης. |
| [setShininess(double value)](#setShininess-double-) | Ορίζει τη γυαλάδα, η οποία ελέγχει το μέγεθος της ειδικής αντανάκλασης. |
| [setSpecularColor(Vector3 value)](#setSpecularColor-com.aspose.threed.Vector3-) | Ορίζει το χρώμα του ειδικού φωτός. |
| [setSpecularFactor(double value)](#setSpecularFactor-double-) | Ορίζει τον παράγοντα ειδικής αντανάκλασης. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [PhongMaterial](../../com.aspose.threed/phongmaterial).
...
Λαμβάνει την εξασθένιση του χρώματος ανάκλασης.

**Returns:**
double - η εξασθένιση του χρώματος αντανάκλασης.
...
Λαμβάνει τη γυαλάδα, η οποία ελέγχει το μέγεθος της ειδικής αντανάκλασης. Ο τύπος του ειδικού φωτός: SpecularColor \* SpecularFactor \* (N dot H) ^ Shininess

**Returns:**
double - η γυαλάδα, η οποία ελέγχει το μέγεθος της ειδικής αντανάκλασης. Ο τύπος του ειδικού φωτός: SpecularColor \* SpecularFactor \* (N dot H) ^ Shininess
...
Λαμβάνει το χρώμα αντανακλαστικό.
...
Λαμβάνει τον παράγοντα ειδικής αντανάκλασης. Ο τύπος του ειδικού φωτός: SpecularColor \* SpecularFactor \* (N dot H) ^ Shininess

**Returns:**
double - ο παράγοντας ειδικής αντανάκλασης. Ο τύπος του ειδικού φωτός: SpecularColor \* SpecularFactor \* (N dot H) ^ Shininess
...
Ορίζει την εξασθένιση του χρώματος αντανάκλασης.
...
Ορίζει τη γυαλάδα, η οποία ελέγχει το μέγεθος της ειδικής αντανάκλασης. Ο τύπος του ειδικού φωτός: SpecularColor \* SpecularFactor \* (N dot H) ^ Shininess
...
Ορίζει το χρώμα του ειδικού φωτός.
...
Ορίζει τον παράγοντα ειδικής αντανάκλασης. Ο τύπος του ειδικού φωτός: SpecularColor \* SpecularFactor \* (N dot H) ^ Shininess

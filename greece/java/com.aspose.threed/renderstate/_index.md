...
| [getPolygonMode()](#getPolygonMode--) | Λαμβάνει τη λειτουργία απόδοσης του πολύγωνου. |
...
| [getStencilMask()](#getStencilMask--) | Λαμβάνει τη μάσκα που γίνεται AND με την τιμή αναφοράς και την αποθηκευμένη τιμή στένσιλ όταν ολοκληρωθεί η δοκιμή. |
| [getStencilReference()](#getStencilReference--) | Λαμβάνει την τιμή αναφοράς για τη δοκιμή στένσιλ. |
...
| [setBlendColor(FVector4 value)](#setBlendColor-com.aspose.threed.FVector4-) | Ορίζει το χρώμα ανάμειξης όπου χρησιμοποιείται στο [BlendFactor.CONSTANT\_COLOR](../../com.aspose.threed/blendfactor\#CONSTANT-COLOR) |
| [setCullFace(boolean value)](#setCullFace-boolean-) | Ενεργοποίηση ή απενεργοποίηση του cull face |
| [setCullFaceMode(int value)](#setCullFaceMode-int-) | Ορίζει ποιο πρόσωπο θα αποκοπεί. |
| [setDepthFunction(CompareFunction value)](#setDepthFunction-com.aspose.threed.CompareFunction-) | Ορίζει τη συνάρτηση σύγκρισης που χρησιμοποιείται στη δοκιμή βάθους. |
...
| [setDestinationBlendFactor(BlendFactor value)](#setDestinationBlendFactor-com.aspose.threed.BlendFactor-) | Ορίζει πώς γίνεται η ανάμειξη του χρώματος. |
| [setFrontFace(FrontFace value)](#setFrontFace-com.aspose.threed.FrontFace-) | Ορίζει ποια σειρά είναι το μπροστινό πρόσωπο. |
...
| [setSourceBlendFactor(BlendFactor value)](#setSourceBlendFactor-com.aspose.threed.BlendFactor-) | Ορίζει πώς γίνεται η ανάμειξη του χρώματος. |
...
Λαμβάνει τη λειτουργία απόδοσης του πολύγωνου.
...
Λαμβάνει τη μάσκα που γίνεται AND με την τιμή αναφοράς και την αποθηκευμένη τιμή στένσιλ όταν ολοκληρωθεί η δοκιμή.
...
Λαμβάνει την τιμή αναφοράς για τη δοκιμή στένσιλ.
...
Ορίζει το χρώμα ανάμειξης όπου χρησιμοποιείται στο [BlendFactor.CONSTANT\_COLOR](../../com.aspose.threed/blendfactor\#CONSTANT-COLOR)
...
Ορίζει ποιο πρόσωπο θα αποκοπεί.
...
Ορίζει τη συνάρτηση σύγκρισης που χρησιμοποιείται στη δοκιμή βάθους.
...
Ορίζει πώς γίνεται η ανάμειξη του χρώματος.
...
Ορίζει ποια σειρά είναι το μπροστινό πρόσωπο.

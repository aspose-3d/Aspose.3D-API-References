...
description: Ένα  δίνει σε μια καμπύλη μια τοποθέτηση χρησιμοποιώντας έναν πίνακα μετασχηματισμού.
type: docs
weight: 192
url: /el/java/com.aspose.threed/transformedcurve/
---
...
Ένα [TransformedCurve](../../com.aspose.threed/transformedcurve) δίνει σε μια καμπύλη μια τοποθέτηση χρησιμοποιώντας έναν πίνακα μετασχηματισμού. Αυτό επιτρέπει την εκτέλεση ενός μετασχηματισμού μέσα σε ένα [TrimmedCurve](../../com.aspose.threed/trimmedcurve) ή [CompositeCurve](../../com.aspose.threed/compositecurve).
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [TransformedCurve()](#TransformedCurve--) | Ο κατασκευαστής του [TransformedCurve](../../com.aspose.threed/transformedcurve) |
| [TransformedCurve(Curve basisCurve, Matrix4 transformation)](#TransformedCurve-com.aspose.threed.Curve-com.aspose.threed.Matrix4-) | Ο κατασκευαστής του [TransformedCurve](../../com.aspose.threed/transformedcurve) |
## Μέθοδοι
...
| [getBasisCurve()](#getBasisCurve--) | Η βασική καμπύλη. |
...
| [getTransformMatrix()](#getTransformMatrix--) | Ο πίνακας μετασχηματισμού. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setBasisCurve(Curve value)](#setBasisCurve-com.aspose.threed.Curve-) | Η βασική καμπύλη. |
...
| [setTransformMatrix(Matrix4 value)](#setTransformMatrix-com.aspose.threed.Matrix4-) | Ο πίνακας μετασχηματισμού. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Ο κατασκευαστής του [TransformedCurve](../../com.aspose.threed/transformedcurve)

...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [add(FVector3 a, FVector3 b)](#add-com.aspose.threed.FVector3-com.aspose.threed.FVector3-) | \+ Υπερφόρτωση τελεστή |
| [clone()](#clone--) |  |
...
| [negative(FVector3 a)](#negative-com.aspose.threed.FVector3-) | \- Υπερφόρτωση του τελεστή |
| [normalize()](#normalize--) | Κανονικοποιεί αυτήν την instance. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [sub(FVector3 a, FVector3 b)](#sub-com.aspose.threed.FVector3-com.aspose.threed.FVector3-) | \- Υπερφόρτωση του τελεστή |
...
| --- | --- | --- |
| x | float | Συστατικό X του διανύσματος |
| y | float | Συστατικό Y του διανύσματος |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| a | [FVector3](../../com.aspose.threed/fvector3) | Πρώτο διάνυσμα |
| b | [FVector3](../../com.aspose.threed/fvector3) | Δεύτερο διάνυμα |

...
description: Ένα  είναι μια παραμετρική επιφάνεια μοντελοποίησης παρόμοια με  και επίσης ορίζεται από δύο   το  και .
type: docs
weight: 119
url: /el/java/com.aspose.threed/patch/
---
...
Ένα [Patch](../../com.aspose.threed/patch) είναι μια παραμετρική επιφάνεια μοντελοποίησης, παρόμοια με το [NurbsSurface](../../com.aspose.threed/nurbssurface), και επίσης ορίζεται από δύο [PatchDirection](../../com.aspose.threed/patchdirection), το [getU](../../com.aspose.threed/patch\#getU) και το [getV](../../com.aspose.threed/patch\#getV). Αλλά η διαφορά μεταξύ του [Patch](../../com.aspose.threed/patch) και του [NurbsSurface](../../com.aspose.threed/nurbssurface) είναι ότι η καμπύλη [PatchDirection](../../com.aspose.threed/patchdirection) μπορεί να είναι μία από τις [PatchDirectionType.BEZIER](../../com.aspose.threed/patchdirectiontype\#BEZIER), [PatchDirectionType.QUADRATIC\_BEZIER](../../com.aspose.threed/patchdirectiontype\#QUADRATIC-BEZIER), [PatchDirectionType.BASIS\_SPLINE](../../com.aspose.threed/patchdirectiontype\#BASIS-SPLINE), [PatchDirectionType.CARDINAL\_SPLINE](../../com.aspose.threed/patchdirectiontype\#CARDINAL-SPLINE) και [PatchDirectionType.LINEAR](../../com.aspose.threed/patchdirectiontype\#LINEAR).
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [Patch()](#Patch--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [Patch](../../com.aspose.threed/patch). |
| [Patch(String name)](#Patch-java.lang.String-) | Αρχικοποιεί μια νέα παρουσία της κλάσης [Patch](../../com.aspose.threed/patch). |
## Μέθοδοι
...
| [getU()](#getU--) | Λαμβάνει την κατεύθυνση u. |
| [getV()](#getV--) | Λαμβάνει την κατεύθυνση v. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [Patch](../../com.aspose.threed/patch).

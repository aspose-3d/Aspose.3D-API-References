...
| ύψος | int | Το ύψος της υφής απόδοσης |
...
| drawOperation | [DrawOperation](../../com.aspose.threed/drawoperation) | Λειτουργία σχεδίασης |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| textureType | [TextureType](../../com.aspose.threed/texturetype) | Τύπος της υφής |

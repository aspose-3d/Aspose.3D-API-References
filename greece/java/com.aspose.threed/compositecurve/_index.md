...
description: Ένα αποτελείται από αρκετά τμήματα καμπύλης.
type: docs
weight: 34
url: /el/java/com.aspose.threed/compositecurve/
---
...
Ένα [CompositeCurve](../../com.aspose.threed/compositecurve) αποτελείται από αρκετά τμήματα καμπύλης.
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [CompositeCurve()](#CompositeCurve--) | Κατασκευαστής του [CompositeCurve](../../com.aspose.threed/compositecurve) |
## Μέθοδοι

| Μέθοδος | Περιγραφή |
| --- | --- |
| [addSegment(Curve curve)](#addSegment-com.aspose.threed.Curve-) | Προσθέστε ένα νέο τμήμα στην τρέχουσα καμπύλη. |
| [addSegment(Curve curve, boolean sameDirection)](#addSegment-com.aspose.threed.Curve-boolean-) | Προσθέστε ένα νέο τμήμα στην τρέχουσα καμπύλη. |
...
| [getSegments()](#getSegments--) | Τα τμήματα της καμπύλης. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Κατασκευαστής του [CompositeCurve](../../com.aspose.threed/compositecurve)
...
Προσθέστε ένα νέο τμήμα στην τρέχουσα καμπύλη.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Η καμπύλη για προσθήκη |
...
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Η καμπύλη για προσθήκη |
| sameDirection | boolean | Ίδια κατεύθυνση με την τρέχουσα καμπύλη. |
...
**Returns:**
java.util.ArrayList<com.aspose.threed.CompositeCurve.Segment> - Τα τμήματα της καμπύλης.
### hashCode() {#hashCode--}
```

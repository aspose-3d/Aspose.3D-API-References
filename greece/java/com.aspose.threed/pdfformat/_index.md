...
description: "Παράδειγμα Adobe Portable Document Format         Ο παρακάτω κώδικας δείχνει πώς να εξάγετε όλες τις υποστηριζόμενες 3D σκηνές από ένα αρχείο 3D PDF και να τις γράψετε σε μορφή obj."
type: docs
weight: 123
url: /el/java/com.aspose.threed/pdfformat/
---
...
Το Portable Document Format της Adobe **Example:** Ο παρακάτω κώδικας δείχνει πώς να εξάγετε όλες τις υποστηριζόμενες 3D σκηνές από ένα αρχείο 3D PDF και να τις γράψετε σε μορφή obj.
...
| [extract(Stream stream)](#extract-com.aspose.threed.Stream-) | Εξαγωγή ακατέργαστου 3D περιεχομένου από τη ροή PDF. |
| [extract(Stream stream, byte[] password)](#extract-com.aspose.threed.Stream-byte---) | Εξαγωγή ακατέργαστου 3D περιεχομένου από τη ροή PDF. |
| [extract(String fileName)](#extract-java.lang.String-) | Εξάγετε ακατέργαστο 3D περιεχόμενο από αρχείο PDF. |
| [extract(String fileName, byte[] password)](#extract-java.lang.String-byte---) | Εξάγετε ακατέργαστο 3D περιεχόμενο από αρχείο PDF. |
| [extractScene(Stream stream)](#extractScene-com.aspose.threed.Stream-) | Εξαγωγή ακατέργαστου 3D περιεχομένου από τη ροή PDF. |
| [extractScene(Stream stream, byte[] password)](#extractScene-com.aspose.threed.Stream-byte---) | Εξαγωγή ακατέργαστου 3D περιεχομένου από τη ροή PDF. |
| [extractScene(String fileName)](#extractScene-java.lang.String-) | Εξάγετε 3D σκηνές από αρχείο PDF. |
| [extractScene(String fileName, byte[] password)](#extractScene-java.lang.String-byte---) | Εξάγετε 3D σκηνές από αρχείο PDF. |
...
Εξαγωγή ακατέργαστου 3D περιεχομένου από τη ροή PDF.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | Ροή του εισερχόμενου αρχείου PDF |

**Returns:**
java.util.ArrayList<byte[]> - Μια λίστα με όλα τα 3D περιεχόμενα σε byte, συμπεριλαμβανομένων των μορφών που δεν υποστηρίζονται από το Aspose.3D. **Example:** Ο παρακάτω κώδικας δείχνει πώς να εξάγετε όλα τα ακατέργαστα 3D περιεχόμενα από ένα αρχείο 3D PDF και να τα γράψετε σε αρχεία.
...
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | Ροή του εισερχόμενου αρχείου PDF |
| password | byte[] | Κωδικός πρόσβασης του αρχείου PDF |
...
Εξάγετε ακατέργαστο 3D περιεχόμενο από αρχείο PDF.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| fileName | java.lang.String | Όνομα αρχείου του εισερχόμενου αρχείου PDF |
...
**Returns:**
java.util.ArrayList<com.aspose.threed.Scene> - Λίστα με αποκωδικοποιημένες 3D σκηνές που υποστηρίζονται από το Aspose.3D **Example:** Ο παρακάτω κώδικας δείχνει πώς να εξάγετε όλες τις υποστηριζόμενες 3D σκηνές από ένα αρχείο 3D PDF και να τις γράψετε σε μορφή obj.
...
Εξάγετε 3D σκηνές από αρχείο PDF.

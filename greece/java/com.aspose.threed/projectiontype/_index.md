...
description: "Τύποι προβολής των καμερών."
type: docs
weight: 295
url: /el/java/com.aspose.threed/projectiontype/
---
...
Τύποι προβολής της κάμερας.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [ORTHOGRAPHIC](#ORTHOGRAPHIC) | Η κάμερα χρησιμοποιεί ορθογώνια προβολή. |
| [PERSPECTIVE](#PERSPECTIVE) | Η κάμερα χρησιμοποιεί προοπτική προβολή. |
## Μέθοδοι
...
Η κάμερα χρησιμοποιεί ορθογώνια προβολή.
...
Η κάμερα χρησιμοποιεί προοπτική προβολή.

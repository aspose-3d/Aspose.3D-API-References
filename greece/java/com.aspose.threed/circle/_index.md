...
description: Μια καμπύλη αποτελείται από ένα σύνολο σημείων στην άκρη του σχήματος του κύκλου.
type: docs
weight: 31
url: /el/java/com.aspose.threed/circle/
---
...
Μια [Circle](../../com.aspose.threed/circle) καμπύλη αποτελείται από ένα σύνολο σημείων στην άκρη του σχήματος του κύκλου.
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [Circle()](#Circle--) | Κατασκευαστής του [Circle](../../com.aspose.threed/circle) |
| [Circle(double radius)](#Circle-double-) | Κατασκευαστής του [Circle](../../com.aspose.threed/circle) |
## Μέθοδοι
...
| [getRadius()](#getRadius--) | Η ακτίνα της καμπύλης κύκλου, η προεπιλεγμένη τιμή είναι 10 |
...
| [setRadius(double value)](#setRadius-double-) | Η ακτίνα της καμπύλης κύκλου, η προεπιλεγμένη τιμή είναι 10 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Κατασκευαστής του [Circle](../../com.aspose.threed/circle)
...
| --- | --- | --- |
| ακτίνα | double | Η ακτίνα της καμπύλης κύκλου. |
...
Η ακτίνα της καμπύλης κύκλου, η προεπιλεγμένη τιμή είναι 10

**Returns:**
double - Η ακτίνα της καμπύλης κύκλου, η προεπιλεγμένη τιμή είναι 10
### getScene() {#getScene--}
```

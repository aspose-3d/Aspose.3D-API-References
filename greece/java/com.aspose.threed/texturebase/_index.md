...
description: Βασική κλάση για όλες τις συγκεκριμένες υφές.
type: docs
weight: 185
url: /el/java/com.aspose.threed/texturebase/
---
...
Βασική κλάση για όλες τις συγκεκριμένες υφές. Texture ορίζει την εμφάνιση και την αίσθηση μιας επιφάνειας γεωμετρίας.
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [TextureBase(String name)](#TextureBase-java.lang.String-) | Αρχικοποιεί μια νέα παρουσία της κλάσης [TextureBase](../../com.aspose.threed/texturebase). |
## Μέθοδοι
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [TextureBase](../../com.aspose.threed/texturebase).

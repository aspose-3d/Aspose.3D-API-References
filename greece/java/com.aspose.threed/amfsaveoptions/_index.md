...
description: Επιλογές αποθήκευσης για AMF
type: docs
weight: 12
url: /el/java/com.aspose.threed/amfsaveoptions/
---
...
Επιλογές αποθήκευσης για AMF
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [AmfSaveOptions()](#AmfSaveOptions--) | Κατασκευαστής του [AmfSaveOptions](../../com.aspose.threed/amfsaveoptions) |
## Μέθοδοι
...
| [getClass()](#getClass--) |  |
| [getEnableCompression()](#getEnableCompression--) | Εάν θα χρησιμοποιηθεί συμπίεση για τη μείωση του τελικού μεγέθους αρχείου, η προεπιλεγμένη τιμή είναι true |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEnableCompression(boolean value)](#setEnableCompression-boolean-) | Εάν θα χρησιμοποιηθεί συμπίεση για τη μείωση του τελικού μεγέθους αρχείου, η προεπιλεγμένη τιμή είναι true |
...
Κατασκευαστής του [AmfSaveOptions](../../com.aspose.threed/amfsaveoptions)
...
**Returns:**
boolean - Εάν θα χρησιμοποιηθεί συμπίεση για τη μείωση του τελικού μεγέθους αρχείου, η προεπιλεγμένη τιμή είναι true

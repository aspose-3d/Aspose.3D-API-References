...
description: "Η NURBS curve είναι μια καμπύλη που αναπαρίσταται από NURBSNon-uniform rational basis spline. Μια NURBS curve ορίζεται από το σύνολό της, ένα σύνολο βαρυμένων σημείων και ένα άλλο σύνολο. Το στοιχείο w σε σημείο ελέγχου χρησιμοποιείται ως βάρος σημείων ελέγχου, ό,τι και αν είναι ή"
type: docs
weight: 112

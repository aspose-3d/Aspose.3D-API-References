...
description: Η βασική κλάση όλων των αντικειμένων γεωμετρίας που μπορούν να αποδοθούν, όπως    και κ.λπ..
type: docs
weight: 71
url: /el/java/com.aspose.threed/geometry/
---
...
Η βασική κλάση όλων των αντικειμένων γεωμετρίας που μπορούν να αποδοθούν (όπως [Mesh](../../com.aspose.threed/mesh), [NurbsSurface](../../com.aspose.threed/nurbssurface), [Patch](../../com.aspose.threed/patch) και άλλα).

Η βασική κλάση [Geometry](../../com.aspose.threed/geometry) υποστηρίζει:
...
| --- | --- |
| [Geometry(String name)](#Geometry-java.lang.String-) | Αρχικοποιεί μια νέα παρουσία της κλάσης [Geometry](../../com.aspose.threed/geometry). |
## Μέθοδοι
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [Geometry](../../com.aspose.threed/geometry).

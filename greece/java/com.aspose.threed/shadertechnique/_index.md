...
| --- | --- |
| [ShaderTechnique()](#ShaderTechnique--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [ShaderTechnique](../../com.aspose.threed/shadertechnique). |
## Μέθοδοι
...
| [getClass()](#getClass--) |  |
| [getDescription()](#getDescription--) | Λαμβάνει την περιγραφή αυτής της τεχνικής |
| [getRenderAPI()](#getRenderAPI--) | Λαμβάνει το API απόδοσης που χρησιμοποιείται από αυτήν την τεχνική |
| [getRenderAPIVersion()](#getRenderAPIVersion--) | Λαμβάνει την έκδοση του API απόδοσης. |
| [getShaderContent()](#getShaderContent--) | Λαμβάνει το περιεχόμενο ενός ενσωματωμένου script shader. |
| [getShaderEntry()](#getShaderEntry--) | Λαμβάνει το σημείο εισόδου του shader, ορισμένα shaders όπως το HLSL μπορούν να έχουν προσαρμοσμένα σημεία εισόδου. |
| [getShaderFile()](#getShaderFile--) | Λαμβάνει το όνομα αρχείου του εξωτερικού αρχείου shader. |
| [getShaderLanguage()](#getShaderLanguage--) | Λαμβάνει τη γλώσσα shader που χρησιμοποιείται από αυτήν την τεχνική. |
| [getShaderParameters()](#getShaderParameters--) | Λαμβάνει τον ορισμό της παραμέτρου shader. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [ShaderTechnique](../../com.aspose.threed/shadertechnique).
...
Λαμβάνει την περιγραφή αυτής της τεχνικής
...
Λαμβάνει το API απόδοσης που χρησιμοποιείται από αυτήν την τεχνική
...
Λαμβάνει την έκδοση του API απόδοσης.
...
Λαμβάνει το σημείο εισόδου του shader, ορισμένα shaders όπως το HLSL μπορούν να έχουν προσαρμοσμένα σημεία εισόδου.
...
Λαμβάνει το όνομα αρχείου του εξωτερικού αρχείου shader.
...
Λαμβάνει τη γλώσσα shader που χρησιμοποιείται από αυτήν την τεχνική.

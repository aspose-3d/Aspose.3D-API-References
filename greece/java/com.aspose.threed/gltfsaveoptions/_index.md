...
| --- | --- |
| [GltfSaveOptions(FileContentType contentType)](#GltfSaveOptions-com.aspose.threed.FileContentType-) | Κατασκευαστής του [GltfSaveOptions](../../com.aspose.threed/gltfsaveoptions) |
| [GltfSaveOptions(FileFormat format)](#GltfSaveOptions-com.aspose.threed.FileFormat-) | Κατασκευαστής του [GltfSaveOptions](../../com.aspose.threed/gltfsaveoptions) |
## Μέθοδοι
...
| [getBufferFile()](#getBufferFile--) | Το όνομα αρχείου του εξωτερικού αρχείου buffer που χρησιμοποιείται για την αποθήκευση δυαδικών δεδομένων. |
| [getClass()](#getClass--) |  |
| [getDracoCompression()](#getDracoCompression--) | Λαμβάνει αν ενεργοποιηθεί η συμπίεση draco |
...
| [getExternalDracoEncoder()](#getExternalDracoEncoder--) | Χρησιμοποιήστε εξωτερικό κωδικοποιητή draco για να επιταχύνετε την ταχύτητα συμπίεσης draco. |
| [getFallbackNormal()](#getFallbackNormal--) | Όταν ο εξαγωγέας GLTF2 εντοπίσει ένα μη έγκυρο κανονικό διάνυσμα, αυτό θα χρησιμοποιηθεί αντί της αρχικής του τιμής για να παρακάμψει την επικύρωση. |
...
| [setBufferFile(String value)](#setBufferFile-java.lang.String-) | Το όνομα αρχείου του εξωτερικού αρχείου buffer που χρησιμοποιείται για την αποθήκευση δυαδικών δεδομένων. |
...
| [setExternalDracoEncoder(String value)](#setExternalDracoEncoder-java.lang.String-) | Χρησιμοποιήστε εξωτερικό κωδικοποιητή draco για να επιταχύνετε την ταχύτητα συμπίεσης draco. |
| [setFallbackNormal(Vector3 value)](#setFallbackNormal-com.aspose.threed.Vector3-) | Όταν ο εξαγωγέας GLTF2 εντοπίσει ένα μη έγκυρο κανονικό διάνυσμα, αυτό θα χρησιμοποιηθεί αντί της αρχικής του τιμής για να παρακάμψει την επικύρωση. |
...
Κατασκευαστής του [GltfSaveOptions](../../com.aspose.threed/gltfsaveoptions)
...
Λαμβάνει αν ενεργοποιηθεί η συμπίεση draco

...
description: Επιλογές φόρτωσης PDF
type: docs
weight: 124
url: /el/java/com.aspose.threed/pdfloadoptions/
---
...
Επιλογές φόρτωσης PDF
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [PdfLoadOptions()](#PdfLoadOptions--) | Κατασκευαστής του [PdfLoadOptions](../../com.aspose.threed/pdfloadoptions) |
## Μέθοδοι
...
| [getPassword()](#getPassword--) | Ο κωδικός πρόσβασης για το ξεκλείδωμα του κρυπτογραφημένου αρχείου PDF. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setPassword(byte[] value)](#setPassword-byte---) | Ο κωδικός πρόσβασης για το ξεκλείδωμα του κρυπτογραφημένου αρχείου PDF. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Κατασκευαστής του [PdfLoadOptions](../../com.aspose.threed/pdfloadoptions)
...
Ο κωδικός πρόσβασης για το ξεκλείδωμα του κρυπτογραφημένου αρχείου PDF.

**Returns:**
byte[] - Ο κωδικός πρόσβασης για το ξεκλείδωμα του κρυπτογραφημένου αρχείου PDF.
### hashCode() {#hashCode--}
```
...
### setPassword(byte[] value) {#setPassword-byte---}
```

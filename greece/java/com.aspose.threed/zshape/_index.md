...
description: "Προφίλ σχήματος Z συμβατό με IFC, ορισμένο από παραμέτρους."
type: docs
weight: 234
url: /el/java/com.aspose.threed/zshape/
---
...
Προφίλ σχήματος Z συμβατό με IFC, ορισμένο από παραμέτρους.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [ZShape()](#ZShape--) | Κατασκευαστής της κλάσης [ZShape](../../com.aspose.threed/zshape) |
## Μέθοδοι
...
| [getEdgeRadius()](#getEdgeRadius--) | Λαμβάνει την ακτίνα της άκρης του flange. |
...
| [getWebThickness()](#getWebThickness--) | Λαμβάνει το πάχος του τοίχου. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setEdgeRadius(double value)](#setEdgeRadius-double-) | Ορίζει την ακτίνα της άκρης της πλάτης. |
...
| [setWebThickness(double value)](#setWebThickness-double-) | Ορίζει το πάχος του τοίχου. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Κατασκευαστής της κλάσης [ZShape](../../com.aspose.threed/zshape)
...
**Returns:**
double - η ακτίνα της άκρης της πλάτης.
...
Λαμβάνει το πάχος του τοίχου.

**Returns:**
double - το πάχος του τοίχου.
### hashCode() {#hashCode--}
```
...
Ορίζει την ακτίνα της άκρης της πλάτης.

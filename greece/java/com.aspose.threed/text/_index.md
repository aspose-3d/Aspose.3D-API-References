...
description: "Προφίλ κειμένου αυτό το προφίλ περιγράφει τα περιγράμματα χρησιμοποιώντας γραμματοσειρά και κείμενο."
type: docs
weight: 183
...
Προφίλ κειμένου, αυτό το προφίλ περιγράφει τα περιγράμματα χρησιμοποιώντας γραμματοσειρά και κείμενο. **Παράδειγμα:** Ο παρακάτω κώδικας δείχνει πώς να δημιουργήσετε ένα 3D πλέγμα από κείμενο χρησιμοποιώντας το καθορισμένο αρχείο γραμματοσειράς.

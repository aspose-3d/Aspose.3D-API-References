...
description: Ο τύπος του
type: docs
weight: 307
url: /el/java/com.aspose.threed/texturetype/
---
...
Ο τύπος του [ITextureUnit](../../com.aspose.threed/itextureunit)
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [ARRAY2D](#ARRAY2D) | Πολλαπλό σύνολο 2d υφών |
| [CUBE_MAP](#CUBE-MAP) | Η υφή χάρτη κύβου περιέχει 6 2d υφές |
| [TEXTURE1D](#TEXTURE1D) | 1-διάστατη υφή |
| [TEXTURE2D](#TEXTURE2D) | 2-διάστατη υφή |
| [TEXTURE3D](#TEXTURE3D) | 3-διάστατη υφή |
## Μέθοδοι
...
Η υφή χάρτη κύβου περιέχει 6 2d υφές

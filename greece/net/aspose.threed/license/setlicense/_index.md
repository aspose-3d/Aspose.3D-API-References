...
type: docs
weight: 20
url: /el/net/aspose.threed/license/setlicense/
---
...
Μπορεί να είναι πλήρες ή σύντομο όνομα αρχείουή όνομα ενός ενσωματωμένου πόρου. Χρησιμοποιήστε μια κενή συμβολοσειρά για να μεταβείτε στη λειτουργία αξιολόγησης.

### Δείτε επίσης

* class [License](../)
* χώρος ονομάτων [Aspose.ThreeD](../../license/)
* συνέλευση [Aspose.3D](../../../)

...
description: Αποθήκευση επιλογών για STL
type: docs
weight: 1360
url: /el/net/aspose.threed.formats/stlsaveoptions/
---
## StlSaveOptions class

Αποθήκευση επιλογών για STL
...
| Ονομα | Περιγραφή |
| --- | --- |
| [StlSaveOptions](stlsaveoptions/#constructor)() | Αρχικοποιεί ένα νέο`StlSaveOptions` παράδειγμα. |
| [StlSaveOptions](stlsaveoptions/#constructor_1)(FileContentType) | Αρχικοποιεί ένα νέο`StlSaveOptions` παράδειγμα. |
...
| [FlipCoordinateSystem](../../aspose.threed.formats/stlsaveoptions/flipcoordinatesystem/) { get; set; } | Λαμβάνει ή ορίζει εάν το σύστημα συντεταγμένων αναστροφής των σημείων ελέγχου/κανονικό κατά την εξαγωγή. |

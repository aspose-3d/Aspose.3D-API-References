...
description: IO config για σειριοποίηση/αποσειριοποίηση. Ο χρήστης μπορεί να καθορίσει λεπτομερείς διαμορφώσεις όπως διαδρομή αναζήτησης εξάρτησης Ή διαμορφώσεις που σχετίζονται με τη μορφή εδώ
type: docs
weight: 1180
url: /el/net/aspose.threed.formats/ioconfig/
---
## IOConfig class

IO config για σειριοποίηση/αποσειριοποίηση. Ο χρήστης μπορεί να καθορίσει λεπτομερείς διαμορφώσεις όπως διαδρομή αναζήτησης εξάρτησης Ή διαμορφώσεις που σχετίζονται με τη μορφή εδώ
...
| static [FileSystemFactory](../../aspose.threed.formats/ioconfig/filesystemfactory/) { get; set; } | Λαμβάνει ή ορίζει την εργοστασιακή κλάση για το FileSystem. Το προεπιλεγμένο εργοστασιακό θα δημιουργήσει[`LocalFileSystem`](../../aspose.threed.utilities/localfilesystem/) που δεν είναι κατάλληλο για περιβάλλον διακομιστή. |

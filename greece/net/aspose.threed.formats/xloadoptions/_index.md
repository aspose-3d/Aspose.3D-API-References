...
type: docs
weight: 1400
url: /el/net/aspose.threed.formats/xloadoptions/
---
## XLoadOptions class
...
| Ονομα | Περιγραφή |
| --- | --- |
| [XLoadOptions](xloadoptions/)(FileContentType) | Κατασκευαστής του`XLoadOptions` |
...
| [FlipCoordinateSystem](../../aspose.threed.formats/xloadoptions/flipcoordinatesystem/) { get; set; } | Αναστρέψτε το σύστημα συντεταγμένων, αυτό ισχύει από προεπιλογή |

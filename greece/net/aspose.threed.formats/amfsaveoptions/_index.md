...
description: Αποθήκευση επιλογών για AMF
type: docs
weight: 1030
url: /el/net/aspose.threed.formats/amfsaveoptions/
---
## AmfSaveOptions class

Αποθήκευση επιλογών για AMF
...
| Ονομα | Περιγραφή |
| --- | --- |
| [AmfSaveOptions](amfsaveoptions/)() | Κατασκευαστής του`AmfSaveOptions` |

## Ιδιότητες

| Ονομα | Περιγραφή |
| --- | --- |
| [EnableCompression](../../aspose.threed.formats/amfsaveoptions/enablecompression/) { get; set; } | Εάν θα χρησιμοποιηθεί συμπίεση για τη μείωση του τελικού μεγέθους αρχείου, η προεπιλεγμένη τιμή είναι true |

...
description: Επιλογές για φόρτωση PDF
type: docs
weight: 1250
url: /el/net/aspose.threed.formats/pdfloadoptions/
---
...
| Ονομα | Περιγραφή |
| --- | --- |
| [PdfLoadOptions](pdfloadoptions/)() | Κατασκευαστής του`PdfLoadOptions` |
...
| [Password](../../aspose.threed.formats/pdfloadoptions/password/) { get; set; } | Ο κωδικός πρόσβασης για να ξεκλειδώσετε το κρυπτογραφημένο αρχείο PDF. |

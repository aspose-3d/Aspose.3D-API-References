...
description: Επιλογές φόρτωσης για μορφή glTF
type: docs
weight: 1150
url: /el/net/aspose.threed.formats/gltfloadoptions/
---
...
| Ονομα | Περιγραφή |
| --- | --- |
| [GltfLoadOptions](gltfloadoptions/)() | Κατασκευαστής του`GltfLoadOptions` |
...
| [FlipTexCoordV](../../aspose.threed.formats/gltfloadoptions/fliptexcoordv/) { get; set; } | Αναστρέψτε τη συντεταγμένη v(t) στη συντεταγμένη υφής του πλέγματος, η προεπιλεγμένη τιμή είναι αληθής. |

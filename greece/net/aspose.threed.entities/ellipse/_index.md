...
description: ΑνEllipse./ellipse/ορίζει ένα σύνολο σημείων που σχηματίζουν το σχήμα έλλειψης.
type: docs
weight: 330
url: /el/net/aspose.threed.entities/ellipse/
---
## Ellipse class

Αν`Ellipse`ορίζει ένα σύνολο σημείων που σχηματίζουν το σχήμα έλλειψης.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [Ellipse](ellipse/#constructor)() | Κατασκευαστής του`Ellipse` |
| [Ellipse](ellipse/#constructor_1)(double, double) | Κατασκευαστής του`Ellipse` |
...
| [SemiAxis1](../../aspose.threed.entities/ellipse/semiaxis1/) { get; set; } | Ακτίνα στον άξονα Χ |
| [SemiAxis2](../../aspose.threed.entities/ellipse/semiaxis2/) { get; set; } | Ακτίνα στον άξονα Υ |

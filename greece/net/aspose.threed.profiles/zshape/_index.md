...
description: Προφίλ σχήματος Z συμβατό με IFC που ορίζεται από παραμέτρους.
type: docs
weight: 1660
url: /el/net/aspose.threed.profiles/zshape/
---
## ZShape class

Προφίλ σχήματος Z συμβατό με IFC που ορίζεται από παραμέτρους.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [ZShape](zshape/)() | Κατασκευαστής του`ZShape` |

## Ιδιότητες

| Ονομα | Περιγραφή |
| --- | --- |
| [Depth](../../aspose.threed.profiles/zshape/depth/) { get; set; } | Λαμβάνει ή ορίζει το μήκος του ιστού. |
| [EdgeRadius](../../aspose.threed.profiles/zshape/edgeradius/) { get; set; } | Λαμβάνει ή ορίζει την ακτίνα της ακμής της φλάντζας. |
| [Excluded](../../aspose.threed/entity/excluded/) { get; set; } | Λαμβάνει ή ορίζει εάν θα εξαιρεθεί αυτή η οντότητα κατά την εξαγωγή. |
| [FilletRadius](../../aspose.threed.profiles/zshape/filletradius/) { get; set; } | Λαμβάνει ή ρυθμίζει την ακτίνα του φιλέτου μεταξύ της φλάντζας και του ιστού. |
| [FlangeThickness](../../aspose.threed.profiles/zshape/flangethickness/) { get; set; } | Λαμβάνει ή ρυθμίζει το πάχος της φλάντζας. |
| [FlangeWidth](../../aspose.threed.profiles/zshape/flangewidth/) { get; set; } | Λαμβάνει ή ορίζει το μήκος της φλάντζας. |
...
| [WebThickness](../../aspose.threed.profiles/zshape/webthickness/) { get; set; } | Λαμβάνει ή καθορίζει το πάχος του τοίχου. |
...
| override [GetExtent](../../aspose.threed.profiles/zshape/getextent/)() | Λαμβάνει την έκταση σε διάσταση x και y. |

...
description: Σχήμα έλλειψης συμβατό με IFC που ορίζεται από παραμέτρους. Η κεντρική θέση του προφίλ βρίσκεται στο κέντρο του πλαισίου οριοθέτησης.
type: docs
weight: 1540
url: /el/net/aspose.threed.profiles/ellipseshape/
---
## EllipseShape class

Σχήμα έλλειψης συμβατό με IFC που ορίζεται από παραμέτρους. Η κεντρική θέση του προφίλ βρίσκεται στο κέντρο του πλαισίου οριοθέτησης.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [EllipseShape](ellipseshape/)() | Ο προεπιλεγμένος κατασκευαστής. |
...
| [SemiAxis1](../../aspose.threed.profiles/ellipseshape/semiaxis1/) { get; set; } | Λαμβάνει ή ορίζει την πρώτη ακτίνα της έλλειψης που μετρήθηκε προς την κατεύθυνση του άξονα x. |
| [SemiAxis2](../../aspose.threed.profiles/ellipseshape/semiaxis2/) { get; set; } | Λαμβάνει ή ορίζει τη δεύτερη ακτίνα της έλλειψης που μετρήθηκε προς την κατεύθυνση του άξονα y. |
...
| override [GetExtent](../../aspose.threed.profiles/ellipseshape/getextent/)() | Λαμβάνει την έκταση σε διάσταση x και y. |

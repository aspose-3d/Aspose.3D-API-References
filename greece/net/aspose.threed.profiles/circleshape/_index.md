...
description: Προφίλ κύκλου συμβατό με IFC το οποίο μπορεί να χρησιμοποιηθεί για την κατασκευή ενός πλέγματοςLinearExtrusion../aspose.threed.entities/linearextrusion/
type: docs
weight: 1530
url: /el/net/aspose.threed.profiles/circleshape/
---
## CircleShape class

Προφίλ κύκλου συμβατό με IFC, το οποίο μπορεί να χρησιμοποιηθεί για την κατασκευή ενός πλέγματος[`LinearExtrusion`](../../aspose.threed.entities/linearextrusion/)
...
| Ονομα | Περιγραφή |
| --- | --- |
| [CircleShape](circleshape/#constructor)() | Κατασκευάστε α`CircleShape` προφίλ με προεπιλεγμένη ακτίνα(5). |
| [CircleShape](circleshape/#constructor_1)(double) | Κατασκευάστε α`CircleShape` προφίλ με καθορισμένη ακτίνα. |

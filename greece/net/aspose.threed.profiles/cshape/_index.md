...
description: Προφίλ σε σχήμα C συμβατό με IFC που ορίζεται από παραμέτρους. Η κεντρική θέση του προφίλ βρίσκεται στο κέντρο του πλαισίου οριοθέτησης.
type: docs
weight: 1520
url: /el/net/aspose.threed.profiles/cshape/
---
## CShape class

Προφίλ σε σχήμα C συμβατό με IFC που ορίζεται από παραμέτρους. Η κεντρική θέση του προφίλ βρίσκεται στο κέντρο του πλαισίου οριοθέτησης.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [CShape](cshape/)() | Κατασκευαστής του`CShape` |

## Ιδιότητες

| Ονομα | Περιγραφή |
| --- | --- |
| [Depth](../../aspose.threed.profiles/cshape/depth/) { get; set; } | Λαμβάνει ή ορίζει το βάθος του προφίλ. |
| [Excluded](../../aspose.threed/entity/excluded/) { get; set; } | Λαμβάνει ή ορίζει εάν θα εξαιρεθεί αυτή η οντότητα κατά την εξαγωγή. |
| [Girth](../../aspose.threed.profiles/cshape/girth/) { get; set; } | Λαμβάνει ή ορίζει το μήκος της περιφέρειας. |
| [InternalFilletRadius](../../aspose.threed.profiles/cshape/internalfilletradius/) { get; set; } | Λαμβάνει ή ρυθμίζει την εσωτερική ακτίνα φιλέτου. |
...
| [WallThickness](../../aspose.threed.profiles/cshape/wallthickness/) { get; set; } | Παίρνει ή ρυθμίζει το πάχος του τοίχου. |
| [Width](../../aspose.threed.profiles/cshape/width/) { get; set; } | Λαμβάνει ή ορίζει το πλάτος του προφίλ. |
...
| override [GetExtent](../../aspose.threed.profiles/cshape/getextent/)() | Λαμβάνει την έκταση σε διάσταση x και y. |

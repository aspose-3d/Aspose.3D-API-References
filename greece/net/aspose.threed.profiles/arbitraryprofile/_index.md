...
description: Αυτή η κλάση σάς επιτρέπει να κατασκευάσετε ένα δισδιάστατο προφίλ απευθείας από αυθαίρετη καμπύλη.
type: docs
weight: 1510
url: /el/net/aspose.threed.profiles/arbitraryprofile/
---
## ArbitraryProfile class

Αυτή η κλάση σάς επιτρέπει να κατασκευάσετε ένα δισδιάστατο προφίλ απευθείας από αυθαίρετη καμπύλη.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [ArbitraryProfile](arbitraryprofile/#constructor)() | Κατασκευαστής του`ArbitraryProfile` |
| [ArbitraryProfile](arbitraryprofile/#constructor_1)(Curve) | Κατασκευαστής του`ArbitraryProfile` με αρχική καμπύλη. |

## Ιδιότητες

| Ονομα | Περιγραφή |
| --- | --- |
| [Curve](../../aspose.threed.profiles/arbitraryprofile/curve/) { get; set; } | Η καμπύλη που χρησιμοποιήθηκε για την κατασκευή του προφίλ |

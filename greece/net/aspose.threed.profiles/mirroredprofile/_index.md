...
description: Προφίλ καθρέφτη συμβατό με IFC. Αυτό το προφίλ ορίζει ένα νέο προφίλ αντικατοπτρίζοντας το προφίλ βάσης γύρω από τον άξονα y.
type: docs
weight: 1590
url: /el/net/aspose.threed.profiles/mirroredprofile/
---
## MirroredProfile class

Προφίλ καθρέφτη συμβατό με IFC. Αυτό το προφίλ ορίζει ένα νέο προφίλ αντικατοπτρίζοντας το προφίλ βάσης γύρω από τον άξονα y.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [MirroredProfile](mirroredprofile/)(Profile) | Κατασκευάστε ένα νέο`MirroredProfile` από ένα υπάρχον προφίλ. |

## Ιδιότητες

| Ονομα | Περιγραφή |
| --- | --- |
| [BaseProfile](../../aspose.threed.profiles/mirroredprofile/baseprofile/) { get; } | Το προφίλ βάσης που θα αντικατοπτριστεί. |

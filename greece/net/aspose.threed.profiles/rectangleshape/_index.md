...
description: Ορθογώνιο σχήμα συμβατό με IFC με στρογγυλεμένες γωνίες.
type: docs
weight: 1620
url: /el/net/aspose.threed.profiles/rectangleshape/
---
## RectangleShape class

Ορθογώνιο σχήμα συμβατό με IFC με στρογγυλεμένες γωνίες.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [RectangleShape](rectangleshape/)() | Κατασκευαστής του`RectangleShape` |

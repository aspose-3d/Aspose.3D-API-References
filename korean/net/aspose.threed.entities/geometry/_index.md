...
description: 렌더링 가능한 모든 기하학적 개체의 기본 클래스예Mesh./mesh/ NurbsSurface./nurbssurface/ Patch./patch/ 등.
type: docs
weight: 360
url: /ko/net/aspose.threed.entities/geometry/
---
## Geometry class

렌더링 가능한 모든 기하학적 개체의 기본 클래스(예:[`Mesh`](../mesh/) ,[`NurbsSurface`](../nurbssurface/) ,[`Patch`](../patch/) 등).

`Geometry` 기본 클래스 지원:  **제어점 관리** , 제어점은 형상의 기본 3D 공간 구조를 정의하며, 형상 유형에 따라 구체적인 3D 모델을 정의하는 방법이 다릅니다. **정점 요소 정의** , 정점 요소는 법선/uv 좌표/정점 색상과 같은 추가 정보를 형상에 적용합니다.[`VertexElement`](../vertexelement/) 상세 사항은. **개체 변형** ,[`Deformer`](../../aspose.threed.deformers/deformer/) 애니메이션 기하학의 모양에 결합될 수 있습니다.
...
| 이름 | 설명 |
| --- | --- |
| [Geometry](geometry/)(string) | 의 새 인스턴스를 초기화합니다.`Geometry` 클래스. |
...
| [CreateElement](../../aspose.threed.entities/geometry/createelement/#createelement)(VertexElementType) | 지정된 유형의 꼭지점 요소를 생성하고 기하학에 추가합니다. |
| [CreateElement](../../aspose.threed.entities/geometry/createelement/#createelement_1)(VertexElementType, MappingMode, ReferenceMode) | 지정된 유형의 꼭지점 요소를 생성하고 기하학에 추가합니다. |
| [CreateElementUV](../../aspose.threed.entities/geometry/createelementuv/#createelementuv)(TextureMapping) | 생성[`VertexElementUV`](../vertexelementuv/) 주어진 텍스처 매핑 type. |
| [CreateElementUV](../../aspose.threed.entities/geometry/createelementuv/#createelementuv_1)(TextureMapping, MappingMode, ReferenceMode) | 생성[`VertexElementUV`](../vertexelementuv/) 주어진 텍스처 매핑 type. |

...
description: 양쪽 끝에서 기준 곡선을 트리밍한 유계 곡선.
type: docs
weight: 750
url: /ko/net/aspose.threed.entities/trimmedcurve/
---
## TrimmedCurve class

양쪽 끝에서 기준 곡선을 트리밍한 유계 곡선.
...
| 이름 | 설명 |
| --- | --- |
| [TrimmedCurve](trimmedcurve/)() | 의 생성자`TrimmedCurve` |

## 속성

| 이름 | 설명 |
| --- | --- |
| [BasisCurve](../../aspose.threed.entities/trimmedcurve/basiscurve/) { get; set; } | 트리밍할 기준 곡선입니다. |
...
| [First](../../aspose.threed.entities/trimmedcurve/first/) { get; set; } | 트리밍할 첫 번째 끝점은 데카르트 점 또는 실제 매개변수일 수 있습니다. |
...
| [SameDirection](../../aspose.threed.entities/trimmedcurve/samedirection/) { get; set; } | 트리밍된 결과가 기본 곡선의 동일한 방향을 사용하는지 여부를 가져오거나 설정합니다. |
| [Scene](../../aspose.threed/sceneobject/scene/) { get; } | 이 개체가 속한 장면을 가져옵니다 |
| [Second](../../aspose.threed.entities/trimmedcurve/second/) { get; set; } | 트리밍할 두 번째 끝점은 데카르트 점 또는 실제 매개변수일 수 있습니다. |

...
description: 모든 primitives 의 기본 클래스
type: docs
weight: 570
url: /ko/net/aspose.threed.entities/primitive/
---
## Primitive class

모든 primitives 의 기본 클래스
...
| 이름 | 설명 |
| --- | --- |
| [Primitive](primitive/)(string) | 의 새 인스턴스를 초기화합니다.`Primitive` 클래스. |
...
| abstract [ToMesh](../../aspose.threed.entities/primitive/tomesh/)() | 현재 개체를 mesh 로 변환 |

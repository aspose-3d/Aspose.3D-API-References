...
description: 안Ellipse./ellipse/타원 모양을 형성하는 점 집합을 정의합니다.
type: docs
weight: 330
url: /ko/net/aspose.threed.entities/ellipse/
---
## Ellipse class

안`Ellipse`타원 모양을 형성하는 점 집합을 정의합니다.
...
| 이름 | 설명 |
| --- | --- |
| [Ellipse](ellipse/#constructor)() | 의 생성자`Ellipse` |
| [Ellipse](ellipse/#constructor_1)(double, double) | 의 생성자`Ellipse` |
...
| [SemiAxis1](../../aspose.threed.entities/ellipse/semiaxis1/) { get; set; } | X축 반경 |
| [SemiAxis2](../../aspose.threed.entities/ellipse/semiaxis2/) { get; set; } | Y축 반경 |

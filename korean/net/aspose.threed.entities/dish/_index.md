...
description: 매개변수화된 접시.
type: docs
weight: 320
url: /ko/net/aspose.threed.entities/dish/
---
## Dish class
...
| 이름 | 설명 |
| --- | --- |
| [Dish](dish/#constructor)() | 기본 반경(10) 및 기본 높이(5) 로 새 접시 인스턴스를 만듭니다. |
| [Dish](dish/#constructor_1)(double, double) | 지정된 반경과 height 로 새 접시 인스턴스를 만듭니다. |
| [Dish](dish/#constructor_2)(string, double, double, int, int) | 지정된 반경과 height 로 새 접시 인스턴스를 만듭니다. |
...
| [Height](../../aspose.threed.entities/dish/height/) { get; set; } | 접시 높이 |
| [HeightSegments](../../aspose.threed.entities/dish/heightsegments/) { get; set; } | 높이 세그먼트를 얻거나 설정합니다 |
...
| [Radius](../../aspose.threed.entities/dish/radius/) { get; set; } | 접시 반경 |
...
| [WidthSegments](../../aspose.threed.entities/dish/widthsegments/) { get; set; } | 세그먼트의 너비를 얻거나 설정합니다 |
...
| override [ToMesh](../../aspose.threed.entities/dish/tomesh/)() | 현재 개체를 mesh 로 변환 |

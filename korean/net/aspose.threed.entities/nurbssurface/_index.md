...
description: NurbsSurface./nurbssurface/ 로 표현되는 표면이다.NURBS비균일 유리 기저 스플라인https//en.wikipedia.org/wiki/Nonuniform_rational_Bspline ANurbsSurface./nurbssurface/ 두 가지로 정의된다NurbsDirection./nurbsdirection/U./nurbssurface/u/ 그리고V./nurbssurface/v/ . 제어점의 w 성분은 방향의 종류가 무엇이든 제어점의 가중치로 사용됩니다.TwoDimensional 또는ThreeDimensional
type: docs
weight: 480
url: /ko/net/aspose.threed.entities/nurbssurface/
---
## NurbsSurface class

`NurbsSurface` 로 표현되는 표면이다.[NURBS(비균일 유리 기저 스플라인)](https://en.wikipedia.org/wiki/Non-uniform_rational_B-spline), A`NurbsSurface` 두 가지로 정의된다[`NurbsDirection`](../nurbsdirection/)[`U`](./u/) 그리고[`V`](./v/) . 제어점의 w 성분은 방향의 종류가 무엇이든 제어점의 가중치로 사용됩니다.TwoDimensional 또는ThreeDimensional
...
| 이름 | 설명 |
| --- | --- |
| [NurbsSurface](nurbssurface/#constructor)() | 의 새 인스턴스를 초기화합니다.`NurbsSurface` 클래스. |
| [NurbsSurface](nurbssurface/#constructor_1)(string) | 의 새 인스턴스를 초기화합니다.`NurbsSurface` 클래스. |
...
| [U](../../aspose.threed.entities/nurbssurface/u/) { get; } | NURBS 표면의 U 방향을 가져옵니다 |
| [V](../../aspose.threed.entities/nurbssurface/v/) { get; } | NURBS 표면의 V 방향을 가져옵니다 |
...
| [ToMesh](../../aspose.threed.entities/nurbssurface/tomesh/)() | NURBS 표면을 mesh 로 변환 |

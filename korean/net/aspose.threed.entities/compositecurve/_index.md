...
description: ACompositeCurve./compositecurve/ 여러 커브 세그먼트로 구성되어 있습니다.
type: docs
weight: 270
url: /ko/net/aspose.threed.entities/compositecurve/
---
## CompositeCurve class

A`CompositeCurve` 여러 커브 세그먼트로 구성되어 있습니다.
...
| 이름 | 설명 |
| --- | --- |
| [CompositeCurve](compositecurve/)() | 의 생성자`CompositeCurve` |
...
| [Segments](../../aspose.threed.entities/compositecurve/segments/) { get; } | 곡선의 세그먼트. |

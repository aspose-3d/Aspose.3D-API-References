...
description: STL 에 대한 옵션 저장
type: docs
weight: 1360
url: /ko/net/aspose.threed.formats/stlsaveoptions/
---
...
| 이름 | 설명 |
| --- | --- |
| [StlSaveOptions](stlsaveoptions/#constructor)() | 새 항목을 초기화합니다.`StlSaveOptions` 인스턴스. |
| [StlSaveOptions](stlsaveoptions/#constructor_1)(FileContentType) | 새 항목을 초기화합니다.`StlSaveOptions` 인스턴스. |
...
| [FlipCoordinateSystem](../../aspose.threed.formats/stlsaveoptions/flipcoordinatesystem/) { get; set; } | 내보내는 동안 제어점/정상의 좌표계 반전 여부를 가져오거나 설정합니다. |

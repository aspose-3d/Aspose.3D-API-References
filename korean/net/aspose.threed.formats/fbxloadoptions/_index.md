...
type: docs
weight: 1110
url: /ko/net/aspose.threed.formats/fbxloadoptions/
---
...
| 이름 | 설명 |
| --- | --- |
| [FbxLoadOptions](fbxloadoptions/#constructor)() | 의 생성자`FbxLoadOptions` |
| [FbxLoadOptions](fbxloadoptions/#constructor_1)(FileFormat) | 의 생성자`FbxLoadOptions` |
...
| [KeepBuiltinGlobalSettings](../../aspose.threed.formats/fbxloadoptions/keepbuiltinglobalsettings/) { get; set; } | 기본 속성 대체가 있는 GlobalSettings의 기본 속성을 유지할지 여부를 가져오거나 설정합니다.[`AssetInfo`](../../aspose.threed/assetinfo/) . GlobalSettings 의 전체 속성을 원하면 true로 설정합니다. 기본값은 false 입니다. |

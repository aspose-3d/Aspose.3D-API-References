...
type: docs
weight: 1290
url: /ko/net/aspose.threed.formats/plyloadoptions/
---
...
| 이름 | 설명 |
| --- | --- |
| [PlyLoadOptions](plyloadoptions/)() | 의 생성자`PlyLoadOptions` |
...
| [FlipCoordinateSystem](../../aspose.threed.formats/plyloadoptions/flipcoordinatesystem/) { get; set; } | 가져오기/내보내기 중에 제어점/법선의 반전 좌표계를 가져오거나 설정합니다. |

...
description: 범용 3d 에 대한 로드 옵션
type: docs
weight: 1370
url: /ko/net/aspose.threed.formats/u3dloadoptions/
---
...
| 이름 | 설명 |
| --- | --- |
| [U3dLoadOptions](u3dloadoptions/)() | 의 생성자`U3dLoadOptions` |
...
| [FlipCoordinateSystem](../../aspose.threed.formats/u3dloadoptions/flipcoordinatesystem/) { get; set; } | 가져오기/내보내기 중에 제어점/정상 좌표계 뒤집기 여부를 가져오거나 설정합니다. |

...
description: AMF 에 대한 저장 옵션
type: docs
weight: 1030
url: /ko/net/aspose.threed.formats/amfsaveoptions/
---
...
| 이름 | 설명 |
| --- | --- |
| [AmfSaveOptions](amfsaveoptions/)() | 의 생성자`AmfSaveOptions` |

## 속성

| 이름 | 설명 |
| --- | --- |
| [EnableCompression](../../aspose.threed.formats/amfsaveoptions/enablecompression/) { get; set; } | 최종 파일 크기를 줄이기 위해 압축을 사용할지 여부, 기본값은 true |

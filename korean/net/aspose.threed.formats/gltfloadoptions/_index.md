...
description: glTF format 에 대한 로드 옵션
type: docs
weight: 1150
url: /ko/net/aspose.threed.formats/gltfloadoptions/
---
## GltfLoadOptions class

glTF format 에 대한 로드 옵션
...
| 이름 | 설명 |
| --- | --- |
| [GltfLoadOptions](gltfloadoptions/)() | 의 생성자`GltfLoadOptions` |
...
| [FlipTexCoordV](../../aspose.threed.formats/gltfloadoptions/fliptexcoordv/) { get; set; } | 메시의 텍스처 좌표에서 v(t) 좌표를 뒤집습니다. 기본값은 true입니다. |

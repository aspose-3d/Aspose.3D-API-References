...
description: PDF loading 옵션
type: docs
weight: 1250
url: /ko/net/aspose.threed.formats/pdfloadoptions/
---
...
| 이름 | 설명 |
| --- | --- |
| [PdfLoadOptions](pdfloadoptions/)() | 의 생성자`PdfLoadOptions` |
...
| [Password](../../aspose.threed.formats/pdfloadoptions/password/) { get; set; } | 암호화된 PDF 파일의 잠금을 해제하기 위한 암호입니다. |

...
description: DirectX X 파일에 대한 로드 옵션입니다.
type: docs
weight: 1400
url: /ko/net/aspose.threed.formats/xloadoptions/
---
## XLoadOptions class

DirectX X 파일에 대한 로드 옵션입니다.
...
| 이름 | 설명 |
| --- | --- |
| [XLoadOptions](xloadoptions/)(FileContentType) | 의 생성자`XLoadOptions` |
...
| [FlipCoordinateSystem](../../aspose.threed.formats/xloadoptions/flipcoordinatesystem/) { get; set; } | 좌표계 뒤집기, 기본적으로 true |

...
description: 매개변수로 정의된 IFC 호환 U자형.
type: docs
weight: 1650
url: /ko/net/aspose.threed.profiles/ushape/
---
## UShape class

매개변수로 정의된 IFC 호환 U자형.
...
| 이름 | 설명 |
| --- | --- |
| [UShape](ushape/)() | 의 생성자`UShape` |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Depth](../../aspose.threed.profiles/ushape/depth/) { get; set; } | web. 의 길이를 가져오거나 설정합니다. |
| [EdgeRadius](../../aspose.threed.profiles/ushape/edgeradius/) { get; set; } | 플랜지 가장자리의 가장자리 반경을 가져오거나 설정합니다. |
| [Excluded](../../aspose.threed/entity/excluded/) { get; set; } | 내보내는 동안 이 엔터티를 제외할지 여부를 가져오거나 설정합니다. |
| [FilletRadius](../../aspose.threed.profiles/ushape/filletradius/) { get; set; } | 플랜지와 웹 사이의 필렛 반경을 가져오거나 설정합니다. |
| [FlangeThickness](../../aspose.threed.profiles/ushape/flangethickness/) { get; set; } | 플랜지의 두께를 가져오거나 설정합니다. |
| [FlangeWidth](../../aspose.threed.profiles/ushape/flangewidth/) { get; set; } | 플랜지 길이를 가져오거나 설정합니다. |
...
| [WebThickness](../../aspose.threed.profiles/ushape/webthickness/) { get; set; } | 웹의 두께를 가져오거나 설정합니다. |
...
| override [GetExtent](../../aspose.threed.profiles/ushape/getextent/)() | x 및 y 차원의 범위를 가져옵니다. |

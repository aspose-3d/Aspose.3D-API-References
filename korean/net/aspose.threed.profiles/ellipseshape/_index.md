...
description: 매개변수로 정의된 IFC 호환 타원 모양. 프로파일의 중심 위치는 경계 상자의 중심입니다.
type: docs
weight: 1540
url: /ko/net/aspose.threed.profiles/ellipseshape/
---
## EllipseShape class

매개변수로 정의된 IFC 호환 타원 모양. 프로파일의 중심 위치는 경계 상자의 중심입니다.
...
| 이름 | 설명 |
| --- | --- |
| [EllipseShape](ellipseshape/)() | 기본 생성자입니다. |
...
| [SemiAxis1](../../aspose.threed.profiles/ellipseshape/semiaxis1/) { get; set; } | x축 방향으로 측정한 타원의 첫 번째 반지름을 가져오거나 설정합니다. |
| [SemiAxis2](../../aspose.threed.profiles/ellipseshape/semiaxis2/) { get; set; } | y축 방향으로 측정한 타원의 두 번째 반지름을 가져오거나 설정합니다. |
...
| override [GetExtent](../../aspose.threed.profiles/ellipseshape/getextent/)() | x 및 y 차원의 범위를 가져옵니다. |

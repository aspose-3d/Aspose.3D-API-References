...
description: 메쉬를 구성하는 데 사용할 수 있는 IFC 호환 원형 프로파일LinearExtrusion../aspose.threed.entities/linearextrusion/
type: docs
weight: 1530
url: /ko/net/aspose.threed.profiles/circleshape/
---
## CircleShape class

메쉬를 구성하는 데 사용할 수 있는 IFC 호환 원형 프로파일[`LinearExtrusion`](../../aspose.threed.entities/linearextrusion/)
...
| 이름 | 설명 |
| --- | --- |
| [CircleShape](circleshape/#constructor)() | 구성`CircleShape` 기본 반경이 있는 프로필(5). |
| [CircleShape](circleshape/#constructor_1)(double) | 구성`CircleShape` 반경이 지정된 프로파일. |

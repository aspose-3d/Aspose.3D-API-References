...
description: 매개변수로 정의된 IFC 호환 C형 프로파일. 프로파일의 중심 위치는 경계 상자의 중심입니다.
type: docs
weight: 1520
url: /ko/net/aspose.threed.profiles/cshape/
---
## CShape class

매개변수로 정의된 IFC 호환 C형 프로파일. 프로파일의 중심 위치는 경계 상자의 중심입니다.
...
| 이름 | 설명 |
| --- | --- |
| [CShape](cshape/)() | 의 생성자`CShape` |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Depth](../../aspose.threed.profiles/cshape/depth/) { get; set; } | 프로필의 깊이를 가져오거나 설정합니다. |
| [Excluded](../../aspose.threed/entity/excluded/) { get; set; } | 내보내는 동안 이 엔터티를 제외할지 여부를 가져오거나 설정합니다. |
| [Girth](../../aspose.threed.profiles/cshape/girth/) { get; set; } | 둘레 길이를 가져오거나 설정합니다. |
| [InternalFilletRadius](../../aspose.threed.profiles/cshape/internalfilletradius/) { get; set; } | 내부 필렛 반경을 가져오거나 설정합니다. |
...
| [WallThickness](../../aspose.threed.profiles/cshape/wallthickness/) { get; set; } | 벽의 두께를 가져오거나 설정합니다. |
| [Width](../../aspose.threed.profiles/cshape/width/) { get; set; } | 프로필의 너비를 가져오거나 설정합니다. |
...
| override [GetExtent](../../aspose.threed.profiles/cshape/getextent/)() | x 및 y 차원의 범위를 가져옵니다. |

...
description: 둥근 모서리가 있는 IFC 호환 직사각형 모양.
type: docs
weight: 1620
url: /ko/net/aspose.threed.profiles/rectangleshape/
---
## RectangleShape class

둥근 모서리가 있는 IFC 호환 직사각형 모양.
...
| 이름 | 설명 |
| --- | --- |
| [RectangleShape](rectangleshape/)() | 의 생성자`RectangleShape` |

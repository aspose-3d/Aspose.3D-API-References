...
description: 매개 변수가 있는 모든 프로필의 기본 클래스입니다.
type: docs
weight: 1600
url: /ko/net/aspose.threed.profiles/parameterizedprofile/
---
## ParameterizedProfile class

매개 변수가 있는 모든 프로필의 기본 클래스입니다.
...
| abstract [GetExtent](../../aspose.threed.profiles/parameterizedprofile/getextent/)() | x 및 y 차원의 범위를 가져옵니다. |

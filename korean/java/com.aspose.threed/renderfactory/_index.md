...
| drawOperation | [DrawOperation](../../com.aspose.threed/drawoperation) | 그리기 작업 |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| parameters | [RenderParameters](../../com.aspose.threed/renderparameters) | 렌더 창을 만들기 위한 렌더 매개변수 |
| handle | [WindowHandle](../../com.aspose.threed/windowhandle) | 렌더링할 창의 핸들 |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| shaderSource | [ShaderSource](../../com.aspose.threed/shadersource) | 셰이더의 소스 코드 |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| textureType | [TextureType](../../com.aspose.threed/texturetype) | 텍스처 유형 |

...
파라미터화된 Cylinder. radiusTop/radiusBottom 중 하나가 0일 때 원뿔을 나타내는 데에도 사용할 수 있습니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [Cylinder()](#Cylinder--) | 새 인스턴스를 초기화합니다 [Cylinder](../../com.aspose.threed/cylinder) 클래스. |
| [Cylinder(double radius, double height)](#Cylinder-double-double-) | 새 인스턴스를 초기화합니다 [Cylinder](../../com.aspose.threed/cylinder) 클래스. |
| [Cylinder(double radiusTop, double radiusBottom, double height)](#Cylinder-double-double-double-) | 새 인스턴스를 초기화합니다 [Cylinder](../../com.aspose.threed/cylinder) 클래스. |
| [Cylinder(double radiusTop, double radiusBottom, double height, int radialSegments, int heightSegments, boolean openEnded)](#Cylinder-double-double-double-int-int-boolean-) | 새 인스턴스를 초기화합니다 [Cylinder](../../com.aspose.threed/cylinder) 클래스. |
| [Cylinder(String name, double radiusTop, double radiusBottom, double height, int radialSegments, int heightSegments, boolean openEnded, double thetaStart, double thetaLength)](#Cylinder-java.lang.String-double-double-double-int-int-boolean-double-double-) | 새 인스턴스를 초기화합니다 [Cylinder](../../com.aspose.threed/cylinder) 클래스. |
## 메서드
...
| [getGenerateFanCylinder()](#getGenerateFanCylinder--) | ThetaLength가 2\*PI보다 작을 때 팬 스타일 실린더를 생성할지 여부를 가져옵니다. 그렇지 않으면 모델이 잘리지 않습니다. |
| [getHeight()](#getHeight--) | 실린더의 높이를 가져옵니다. |
| [getHeightSegments()](#getHeightSegments--) | 세로 세그먼트를 가져옵니다. |
| [getName()](#getName--) | 이름을 가져옵니다. |
| [getOffsetBottom()](#getOffsetBottom--) | 하단 측면의 정점 변환 오프셋을 가져옵니다. |
| [getOffsetTop()](#getOffsetTop--) | 상단 측면의 정점 변환 오프셋을 가져옵니다. |
| [getOpenEnded()](#getOpenEnded--) | 이 [Cylinder](../../com.aspose.threed/cylinder)가 개방형인지 여부를 나타내는 값을 가져옵니다. |
...
| [getRadialSegments()](#getRadialSegments--) | 방사형 세그먼트를 가져옵니다. |
| [getRadiusBottom()](#getRadiusBottom--) | 실린더 하단 캡의 반경을 가져옵니다. |
...
새 인스턴스를 초기화합니다 [Cylinder](../../com.aspose.threed/cylinder) 클래스.
...
ThetaLength가 2\*PI보다 작을 때 팬 스타일 실린더를 생성할지 여부를 가져옵니다. 그렇지 않으면 모델이 잘리지 않습니다.

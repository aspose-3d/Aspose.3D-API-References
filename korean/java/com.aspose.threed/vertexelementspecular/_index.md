...
description: 지정된 구성 요소에 대한 스페큘러 색상을 정의합니다.
type: docs
weight: 217
url: /ko/java/com.aspose.threed/vertexelementspecular/
---
...
지정된 구성 요소에 대한 스페큘러 색상을 정의합니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [VertexElementSpecular()](#VertexElementSpecular--) | 새 인스턴스를 초기화합니다. [VertexElementSpecular](../../com.aspose.threed/vertexelementspecular) 클래스. |
## 메서드
...
새 인스턴스를 초기화합니다. [VertexElementSpecular](../../com.aspose.threed/vertexelementspecular) 클래스.

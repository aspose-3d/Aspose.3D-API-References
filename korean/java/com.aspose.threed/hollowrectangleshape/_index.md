...
description: 내부/외부 모서리 라운딩이 모두 적용된 IFC 호환 중공 직사각형 형태.
type: docs
weight: 79
url: /ko/java/com.aspose.threed/hollowrectangleshape/
---
...
| [getInnerFilletRadius()](#getInnerFilletRadius--) | 내부 사각형의 내부 필렛 반경. |
...
| [getWallThickness()](#getWallThickness--) | 사각형 경계와 내부 구멍 사이의 두께. |
...
| [setInnerFilletRadius(double value)](#setInnerFilletRadius-double-) | 내부 사각형의 내부 필렛 반경. |
...
| [setWallThickness(double value)](#setWallThickness-double-) | 사각형 경계와 내부 구멍 사이의 두께. |
...
사각형 경계와 내부 구멍 사이의 두께.

**Returns:**
double - 사각형 경계와 내부 구멍 사이의 두께
### getXDim() {#getXDim--}
```

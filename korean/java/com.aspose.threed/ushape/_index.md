...
description: 파라미터로 정의된 IFC 호환 U형.
type: docs
weight: 199
url: /ko/java/com.aspose.threed/ushape/
---
...
| 생성자 | 설명 |
| --- | --- |
| [UShape()](#UShape--) | 생성자 [UShape](../../com.aspose.threed/ushape) |
## 메서드
...
| [getEdgeRadius()](#getEdgeRadius--) | 플랜지 가장자리의 모서리 반경을 가져옵니다. |
...
| [getWebThickness()](#getWebThickness--) | 웹의 두께를 가져옵니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setEdgeRadius(double value)](#setEdgeRadius-double-) | 플랜지 가장자리의 모서리 반경을 설정합니다. |
...
| [setWebThickness(double value)](#setWebThickness-double-) | 웹의 두께를 설정합니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
생성자 [UShape](../../com.aspose.threed/ushape)
...
플랜지 가장자리의 모서리 반경을 가져옵니다.

**Returns:**
double - 플랜지 가장자리의 모서리 반경.

...
description: 매개변수로 정의된 IFC 호환 C-형 프로파일.
type: docs
weight: 27
url: /ko/java/com.aspose.threed/cshape/
---
...
매개변수로 정의된 IFC 호환 C-형 프로파일. 프로파일의 중심 위치는 경계 상자의 중앙에 있습니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [CShape()](#CShape--) | 생성자 [CShape](../../com.aspose.threed/cshape) |
## 메서드
...
| [getClass()](#getClass--) |  |
| [getDepth()](#getDepth--) | 프로파일의 깊이를 가져옵니다. |
...
| [getGirth()](#getGirth--) | 둘레의 길이를 가져옵니다. |
| [getInternalFilletRadius()](#getInternalFilletRadius--) | 내부 필렛 반경을 가져옵니다. |
...
| [getWallThickness()](#getWallThickness--) | 벽의 두께를 가져옵니다. |
| [getWidth()](#getWidth--) | 프로파일의 너비를 가져옵니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setDepth(double value)](#setDepth-double-) | 프로파일의 깊이를 설정합니다. |
| [setExcluded(boolean value)](#setExcluded-boolean-) | 내보내기 중에 이 엔터티를 제외할지 여부를 설정합니다. |
| [setGirth(double value)](#setGirth-double-) | 둘레의 길이를 설정합니다. |
| [setInternalFilletRadius(double value)](#setInternalFilletRadius-double-) | 내부 필렛 반경을 설정합니다. |
...
| [setWallThickness(double value)](#setWallThickness-double-) | 벽의 두께를 설정합니다. |
| [setWidth(double value)](#setWidth-double-) | 프로파일의 너비를 설정합니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
생성자 [CShape](../../com.aspose.threed/cshape)

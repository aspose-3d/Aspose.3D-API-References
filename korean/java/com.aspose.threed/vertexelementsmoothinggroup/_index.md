...
description: 스무딩 그룹은 폴리곤 메쉬에서 부드러운 표면을 형성하는 것처럼 보이는 폴리곤들의 그룹입니다.
type: docs
weight: 216
url: /ko/java/com.aspose.threed/vertexelementsmoothinggroup/
---
...
스무딩 그룹은 매끄러운 표면을 형성하는 것처럼 보이는 폴리곤 메시의 폴리곤 그룹입니다. DOS용 3D Studio Max와 같은 초기 3D 모델링 소프트웨어는 각 메시 정점에 대한 법선 벡터 저장을 방지하기 위해 스무딩 그룹을 사용했습니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [VertexElementSmoothingGroup()](#VertexElementSmoothingGroup--) | 새로운 [VertexElementSmoothingGroup](../../com.aspose.threed/vertexelementsmoothinggroup) 클래스의 인스턴스를 초기화합니다. |
## 메서드
...
| [copyTo(VertexElementIntsTemplate target)](#copyTo-com.aspose.threed.VertexElementIntsTemplate-) | 지정된 요소에 데이터를 복사합니다. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(int[] data)](#setData-int---) | 데이터를 로드합니다. |
...
새로운 [VertexElementSmoothingGroup](../../com.aspose.threed/vertexelementsmoothinggroup) 클래스의 인스턴스를 초기화합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| target | [VertexElementIntsTemplate](../../com.aspose.threed/vertexelementintstemplate) | 대상. |
...
**Returns:**
java.util.List<java.lang.Integer> - 정점 데이터

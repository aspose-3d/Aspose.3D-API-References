...
description: "프러스텀의 회전 모드."
type: docs
weight: 299
url: /ko/java/com.aspose.threed/rotationmode/
---
...
| 필드 | 설명 |
| --- | --- |
| [FIXED_DIRECTION](#FIXED-DIRECTION) | 방향은 고정되고, 바라보는 방향은 방향에 의해 계산됩니다. |
| [FIXED_TARGET](#FIXED-TARGET) | 대상은 고정되고, 방향은 바라보는 대상에 의해 계산됩니다. |
## 메서드
...
방향은 고정되고, 바라보는 방향은 방향에 의해 계산됩니다.
...
대상은 고정되고, 방향은 바라보는 대상에 의해 계산됩니다.

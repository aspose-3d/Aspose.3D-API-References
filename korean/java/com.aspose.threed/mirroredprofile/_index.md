...
description: IFC 호환 미러 프로파일.
type: docs
weight: 106
url: /ko/java/com.aspose.threed/mirroredprofile/
---
...
IFC 호환 미러 프로파일. 이 프로파일은 y축을 기준으로 기본 프로파일을 미러링하여 새로운 프로파일을 정의합니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [MirroredProfile(Profile baseProfile)](#MirroredProfile-com.aspose.threed.Profile-) | 기존 프로파일에서 새로운 [MirroredProfile](../../com.aspose.threed/mirroredprofile) 를 구성합니다. |
## 메서드
...
| [getBaseProfile()](#getBaseProfile--) | 미러링될 기본 프로파일. |
...
기존 프로파일에서 새로운 [MirroredProfile](../../com.aspose.threed/mirroredprofile) 를 구성합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| baseProfile | [Profile](../../com.aspose.threed/profile) | 미러링될 기본 프로파일. |

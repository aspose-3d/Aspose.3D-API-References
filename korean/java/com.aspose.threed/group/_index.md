...
description: A  는 .의 논리적 관계를 나타냅니다.
type: docs
weight: 75
url: /ko/java/com.aspose.threed/group/
---
...
A [Group](../../com.aspose.threed/group) 는 [Node](../../com.aspose.threed/node) 의 논리적 관계를 나타냅니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [Group(String name)](#Group-java.lang.String-) | 새 인스턴스 [Group](../../com.aspose.threed/group) 를 생성합니다 |
| [Group()](#Group--) | 새 인스턴스 [Group](../../com.aspose.threed/group) 를 생성합니다 |
## 메서드
...
| [getClass()](#getClass--) |  |
| [getGroups()](#getGroups--) | 하위 그룹 |
| [getName()](#getName--) | 이름을 가져옵니다. |
| [getNodes()](#getNodes--) | 이 그룹의 노드들 |
| [getParent()](#getParent--) | 현재 그룹의 상위 그룹 |
...
| [toString()](#toString--) | 다음 [Group](../../com.aspose.threed/group)의 문자열 표현을 가져옵니다 |
| [wait()](#wait--) |  |
...
새 인스턴스 [Group](../../com.aspose.threed/group) 를 생성합니다

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 이름 | java.lang.String | 그룹 이름 |
...
**Returns:**
java.util.List<com.aspose.threed.Group> - 하위 그룹
### getName() {#getName--}
```
...
**Returns:**
java.util.List<com.aspose.threed.Node> - 이 그룹의 노드
### getParent() {#getParent--}
```
...
다음 [Group](../../com.aspose.threed/group)의 문자열 표현을 가져옵니다

**Returns:**
java.lang.String - 현재 인스턴스의 문자열 표현
### wait() {#wait--}
```

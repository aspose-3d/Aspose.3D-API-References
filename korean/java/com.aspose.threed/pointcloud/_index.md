...
description: "점 구름에는 토폴로지 정보가 없고 제어점과 정점 요소만 포함됩니다."
type: docs
weight: 132
url: /ko/java/com.aspose.threed/pointcloud/
---
...
| 생성자 | 설명 |
| --- | --- |
| [PointCloud(String name)](#PointCloud-java.lang.String-) | 생성자 [PointCloud](../../com.aspose.threed/pointcloud) |
| [PointCloud()](#PointCloud--) | 생성자 [PointCloud](../../com.aspose.threed/pointcloud) |
## 메서드
...
| [fromGeometry(Geometry g)](#fromGeometry-com.aspose.threed.Geometry-) | 지오메트리 객체에서 새로운 PointCloud 인스턴스를 생성합니다 |
| [fromGeometry(Geometry g, int density)](#fromGeometry-com.aspose.threed.Geometry-int-) | 지오메트리 객체에서 새로운 포인트 클라우드 인스턴스를 생성합니다. |
...
| [getDimension()](#getDimension--) | 포인트 클라우드에 차원 값이 있으면, 이는 조직된 포인트 클라우드를 나타냅니다. |
...
| [setDimension(Vector2 value)](#setDimension-com.aspose.threed.Vector2-) | 포인트 클라우드에 차원 값이 있으면, 이는 조직된 포인트 클라우드를 나타냅니다. |
...
생성자 [PointCloud](../../com.aspose.threed/pointcloud)
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| g | [Geometry](../../com.aspose.threed/geometry) | 메시 또는 기타 지오메트리 인스턴스 |

...
description: 확산 색상/반사광/광택을 기반으로 하는 물리 기반 렌더링용 재질.
type: docs
weight: 122
url: /ko/java/com.aspose.threed/pbrspecularmaterial/
---
...
확산 색상/반사광/광택을 기반으로 하는 물리 기반 렌더링용 재질.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [PbrSpecularMaterial()](#PbrSpecularMaterial--) | [PbrSpecularMaterial](../../com.aspose.threed/pbrspecularmaterial)의 생성자 |
## 필드
...
| [MAP_SPECULAR_GLOSSINESS](#MAP-SPECULAR-GLOSSINESS) | 반사광택을 위한 텍스처 맵 |
## 메서드
...
| [getClass()](#getClass--) |  |
| [getDiffuse()](#getDiffuse--) | 재질의 확산 색상을 가져옵니다. 기본값은 (1, 1, 1)입니다. |
| [getDiffuseTexture()](#getDiffuseTexture--) | 확산용 텍스처를 가져옵니다. |
| [getEmissiveColor()](#getEmissiveColor--) | 방출 색상을 가져옵니다. 기본값은 (0, 0, 0)입니다. |
| [getEmissiveTexture()](#getEmissiveTexture--) | 방출용 텍스처를 가져옵니다. |
| [getGlossinessFactor()](#getGlossinessFactor--) | 재질의 광택(매끄러움)을 가져옵니다. 1은 완전히 매끄럽고 0은 완전히 거친 것을 의미하며, 기본값은 1이고 범위는 [0, 1]입니다. |
...
| [getSpecular()](#getSpecular--) | 재질의 반사 색상을 가져옵니다. 기본값은 (1, 1, 1)입니다. |
| [getSpecularGlossinessTexture()](#getSpecularGlossinessTexture--) | 반사 색상용 텍스처를 가져옵니다. RGB 채널은 반사 색상을 저장하고 A 채널은 광택을 저장합니다. |
...
| [setDiffuse(Vector3 value)](#setDiffuse-com.aspose.threed.Vector3-) | 재질의 확산 색상을 설정합니다. 기본값은 (1, 1, 1)입니다. |
| [setDiffuseTexture(TextureBase value)](#setDiffuseTexture-com.aspose.threed.TextureBase-) | 확산용 텍스처를 설정합니다. |
| [setEmissiveColor(Vector3 value)](#setEmissiveColor-com.aspose.threed.Vector3-) | 방출 색상을 설정합니다. 기본값은 (0, 0, 0)입니다. |
| [setEmissiveTexture(TextureBase value)](#setEmissiveTexture-com.aspose.threed.TextureBase-) | 방출용 텍스처를 설정합니다 |
| [setGlossinessFactor(double value)](#setGlossinessFactor-double-) | 재질의 광택(매끄러움)을 설정합니다. 1은 완전히 매끄럽고 0은 완전히 거친 것을 의미하며, 기본값은 1이고 범위는 [0, 1]입니다. |
...
| [setSpecular(Vector3 value)](#setSpecular-com.aspose.threed.Vector3-) | 재질의 반사색을 설정합니다. 기본값은 (1, 1, 1)입니다. |
| [setSpecularGlossinessTexture(TextureBase value)](#setSpecularGlossinessTexture-com.aspose.threed.TextureBase-) | 반사색 텍스처를 설정합니다. RGB 채널은 반사색을 저장하고 A 채널은 광택을 저장합니다. |
...
[PbrSpecularMaterial](../../com.aspose.threed/pbrspecularmaterial)의 생성자
...
재질의 확산 색상을 가져옵니다. 기본값은 (1, 1, 1)입니다.
...
재질의 광택(매끄러움)을 가져옵니다. 1은 완전히 매끄럽고 0은 완전히 거친 것을 의미하며, 기본값은 1이고 범위는 [0, 1]입니다.

**Returns:**
double - 재질의 광택(매끄러움). 1은 완전히 매끄럽고 0은 완전히 거친 것을 의미하며, 기본값은 1이고 범위는 [0, 1]입니다.
### getName() {#getName--}
```
...
재질의 반사 색상을 가져옵니다. 기본값은 (1, 1, 1)입니다.
...
반사 색상용 텍스처를 가져옵니다. RGB 채널은 반사 색상을 저장하고 A 채널은 광택을 저장합니다.
...
재질의 확산 색상을 설정합니다. 기본값은 (1, 1, 1)입니다.
...
재질의 광택(매끄러움)을 설정합니다. 1은 완전히 매끄럽고 0은 완전히 거친 것을 의미하며, 기본값은 1이고 범위는 [0, 1]입니다.
...
반사색 텍스처를 설정합니다. RGB 채널은 반사색을 저장하고 A 채널은 광택을 저장합니다.

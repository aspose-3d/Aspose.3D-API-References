...
description: Siemens JT 로드 옵션
type: docs
weight: 88
url: /ko/java/com.aspose.threed/jtloadoptions/
---
...
| [getLoadPMI()](#getLoadPMI--) | 가능하면 JT 파일에서 PMI 정보를 로드하고, 데이터는 [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo)의 "PMI" 속성으로 저장됩니다. |
| [getLoadProperties()](#getLoadProperties--) | JT의 속성 테이블에서 속성을 로드하여 Aspose.3D 속성으로 사용합니다. |
...
| [setLoadPMI(boolean value)](#setLoadPMI-boolean-) | 가능하면 JT 파일에서 PMI 정보를 로드하고, 데이터는 [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo)의 "PMI" 속성으로 저장됩니다. |
| [setLoadProperties(boolean value)](#setLoadProperties-boolean-) | JT의 속성 테이블에서 속성을 로드하여 Aspose.3D 속성으로 사용합니다. |
...
가능하면 JT 파일에서 PMI 정보를 로드하고, 데이터는 [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo)의 "PMI" 속성으로 저장됩니다. 기본값은 false입니다.

**Returns:**
boolean - 가능하면 JT 파일에서 PMI 정보를 로드하고, 데이터는 [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo)의 "PMI" 속성으로 저장됩니다. 기본값은 false입니다.
...
JT의 속성 테이블에서 속성을 로드하여 Aspose.3D 속성으로 사용합니다. 기본값은 false입니다.

**Returns:**
boolean - JT의 속성 테이블에서 속성을 로드하여 Aspose.3D 속성으로 사용합니다. 기본값은 false입니다.

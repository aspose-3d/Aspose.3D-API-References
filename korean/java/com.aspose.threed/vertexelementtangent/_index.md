...
description: 지정된 구성 요소에 대한 탄젠트 벡터를 정의합니다.
type: docs
weight: 218
url: /ko/java/com.aspose.threed/vertexelementtangent/
---
...
지정된 구성 요소에 대한 탄젠트 벡터를 정의합니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [VertexElementTangent()](#VertexElementTangent--) | [VertexElementTangent](../../com.aspose.threed/vertexelementtangent) 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
[VertexElementTangent](../../com.aspose.threed/vertexelementtangent) 클래스의 새 인스턴스를 초기화합니다.

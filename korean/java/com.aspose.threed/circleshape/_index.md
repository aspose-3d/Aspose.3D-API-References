...
description: IFC 호환 원형 프로파일로, 이를 통해 메쉬를 구성할 수 있습니다.
type: docs
weight: 32
url: /ko/java/com.aspose.threed/circleshape/
---
...
IFC 호환 원형 프로파일로, [LinearExtrusion](../../com.aspose.threed/linearextrusion)을 통해 메쉬를 구성할 수 있습니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [CircleShape()](#CircleShape--) | 기본 반경(5)으로 [CircleShape](../../com.aspose.threed/circleshape) 프로파일을 생성합니다. |
| [CircleShape(double radius)](#CircleShape-double-) | 지정된 반경으로 [CircleShape](../../com.aspose.threed/circleshape) 프로파일을 생성합니다. |
## 메서드
...
| [getRadius()](#getRadius--) | 원의 반경을 가져옵니다. |
...
| [setRadius(double value)](#setRadius-double-) | 원의 반경을 설정합니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
기본 반경(5)으로 [CircleShape](../../com.aspose.threed/circleshape) 프로파일을 생성합니다.
...
지정된 반경으로 [CircleShape](../../com.aspose.threed/circleshape) 프로파일을 생성합니다.

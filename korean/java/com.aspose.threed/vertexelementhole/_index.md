...
description: 지정된 폴리곤이 구멍인지 여부를 정의합니다.
type: docs
weight: 211
url: /ko/java/com.aspose.threed/vertexelementhole/
---
...
| 생성자 | 설명 |
| --- | --- |
| [VertexElementHole()](#VertexElementHole--) | 새로운 [VertexElementHole](../../com.aspose.threed/vertexelementhole) 클래스 인스턴스를 초기화합니다. |
## 메서드
...
새로운 [VertexElementHole](../../com.aspose.threed/vertexelementhole) 클래스 인스턴스를 초기화합니다.

...
description: 지정된 구성 요소에 대한 정점 크리스를 정의합니다.
type: docs
weight: 224
url: /ko/java/com.aspose.threed/vertexelementvertexcrease/
---
...
| 생성자 | 설명 |
| --- | --- |
| [VertexElementVertexCrease()](#VertexElementVertexCrease--) | 새 인스턴스를 초기화합니다 [VertexElementVertexCrease](../../com.aspose.threed/vertexelementvertexcrease) 클래스의. |
## 메서드
...
| [copyTo(VertexElementDoublesTemplate target)](#copyTo-com.aspose.threed.VertexElementDoublesTemplate-) | 지정된 요소에 데이터를 복사합니다. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(double[] data)](#setData-double---) | 데이터를 로드합니다. |
...
새 인스턴스를 초기화합니다 [VertexElementVertexCrease](../../com.aspose.threed/vertexelementvertexcrease) 클래스의.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| target | [VertexElementDoublesTemplate](../../com.aspose.threed/vertexelementdoublestemplate) | 대상. |
...
**Returns:**
java.util.List<java.lang.Double> - 버텍스 데이터

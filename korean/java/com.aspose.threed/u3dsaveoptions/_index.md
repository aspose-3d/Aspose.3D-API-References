...
description: "범용 3D 저장 옵션"
type: docs
weight: 198
url: /ko/java/com.aspose.threed/u3dsaveoptions/
---
...
| 생성자 | 설명 |
| --- | --- |
| [U3dSaveOptions()](#U3dSaveOptions--) | 생성자 [U3dSaveOptions](../../com.aspose.threed/u3dsaveoptions) |
## 메서드
...
| [getClass()](#getClass--) |  |
| [getEmbedTextures()](#getEmbedTextures--) | 외부 텍스처를 U3D 파일에 포함합니다. 기본값은 false입니다. |
| [getEncoding()](#getEncoding--) | 텍스트 기반 파일에 대한 기본 인코딩을 가져옵니다. |
| [getExportNormals()](#getExportNormals--) | 노멀 데이터를 내보낼지 여부를 가져옵니다. |
| [getExportTextureCoordinates()](#getExportTextureCoordinates--) | 텍스처 좌표를 내보낼지 여부를 가져옵니다. |
| [getExportTextures()](#getExportTextures--) | 씬에서 사용된 텍스처를 출력 디렉터리로 복사하려고 시도합니다. |
| [getExportVertexDiffuse()](#getExportVertexDiffuse--) | 버텍스의 확산 색상을 내보낼지 여부를 가져옵니다. |
| [getExportVertexSpecular()](#getExportVertexSpecular--) | 버텍스의 반사 색상을 내보낼지 여부를 가져옵니다. |
...
| [getMeshCompression()](#getMeshCompression--) | 메시 데이터 압축을 활성화할지 여부를 가져옵니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEmbedTextures(boolean value)](#setEmbedTextures-boolean-) | 외부 텍스처를 U3D 파일에 포함합니다. 기본값은 false입니다. |
| [setEncoding(Charset value)](#setEncoding-java.nio.charset.Charset-) | 텍스트 기반 파일에 대한 기본 인코딩을 설정합니다. |
| [setExportNormals(boolean value)](#setExportNormals-boolean-) | 노멀 데이터를 내보낼지 설정합니다. |
| [setExportTextureCoordinates(boolean value)](#setExportTextureCoordinates-boolean-) | 텍스처 좌표를 내보낼지 설정합니다. |
| [setExportTextures(boolean value)](#setExportTextures-boolean-) | 씬에서 사용된 텍스처를 출력 디렉터리로 복사하려고 시도합니다. |
| [setExportVertexDiffuse(boolean value)](#setExportVertexDiffuse-boolean-) | 버텍스의 확산 색상을 내보낼지 설정합니다. |
| [setExportVertexSpecular(boolean value)](#setExportVertexSpecular-boolean-) | 버텍스의 반사 색상을 내보낼지 설정합니다. |
...
| [setMeshCompression(boolean value)](#setMeshCompression-boolean-) | 메시 데이터 압축을 활성화할지 설정합니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
생성자 [U3dSaveOptions](../../com.aspose.threed/u3dsaveoptions)
...
**Returns:**
boolean - 외부 텍스처를 U3D 파일에 포함합니다. 기본값은 false.
...
노멀 데이터를 내보낼지 여부를 가져옵니다.

**Returns:**
boolean - 노멀 데이터를 내보낼지 여부.
...
텍스처 좌표를 내보낼지 여부를 가져옵니다.

**Returns:**
boolean - 텍스처 좌표를 내보낼지 여부.
...
버텍스의 확산 색상을 내보낼지 여부를 가져옵니다.

**Returns:**
boolean - 정점의 확산 색상을 내보낼지 여부.
...
버텍스의 반사 색상을 내보낼지 여부를 가져옵니다.

**Returns:**
boolean - 정점의 반사 색상을 내보낼지 여부.
...
메시 데이터 압축을 활성화할지 여부를 가져옵니다.

**Returns:**
boolean - 메시 데이터 압축을 활성화할지 여부.
### hashCode() {#hashCode--}
```

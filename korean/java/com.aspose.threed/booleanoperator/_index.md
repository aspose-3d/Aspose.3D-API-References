...
description: "Boolean 연산자는 두 인스턴스에 Boolean 연산을 적용할 수 있게 해줍니다."
type: docs
weight: 23
url: /ko/java/com.aspose.threed/booleanoperator/
---
...
Boolean 연산자는 두 개의 [IMeshConvertible](../../com.aspose.threed/imeshconvertible) 인스턴스에 Boolean 연산을 적용할 수 있게 합니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [BooleanOperator()](#BooleanOperator--) | [BooleanOperator](../../com.aspose.threed/booleanoperator)의 생성자 |
| [BooleanOperator(BooleanOperation operation, A3DObject first, A3DObject second)](#BooleanOperator-com.aspose.threed.BooleanOperation-com.aspose.threed.A3DObject-com.aspose.threed.A3DObject-) | 두 개의 피연산자를 사용하여 [BooleanOperator](../../com.aspose.threed/booleanoperator)의 새 인스턴스를 생성합니다. |
## 메서드
...
| [getFirst()](#getFirst--) | Boolean 연산자의 첫 번째 피연산자 |
| [getName()](#getName--) | 이름을 가져옵니다. |
| [getOperator()](#getOperator--) | 결과 메쉬를 생성하기 위한 연산에 사용되는 Boolean 연산자. |
...
| [getSecond()](#getSecond--) | Boolean 연산자의 두 번째 피연산자 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFirst(BooleanOperand value)](#setFirst-com.aspose.threed.BooleanOperand-) | Boolean 연산자의 첫 번째 피연산자 |
| [setName(String value)](#setName-java.lang.String-) | 이름을 설정합니다. |
| [setOperator(BooleanOperation value)](#setOperator-com.aspose.threed.BooleanOperation-) | 결과 메쉬를 생성하기 위한 연산에 사용되는 Boolean 연산자. |
...
| [setSecond(BooleanOperand value)](#setSecond-com.aspose.threed.BooleanOperand-) | Boolean 연산자의 두 번째 피연산자 |
| [toMesh()](#toMesh--) | 두 피연산자에 대해 Boolean 연산을 수행합니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[BooleanOperator](../../com.aspose.threed/booleanoperator)의 생성자
...
두 개의 피연산자를 사용하여 [BooleanOperator](../../com.aspose.threed/booleanoperator)의 새 인스턴스를 생성합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| operation | [BooleanOperation](../../com.aspose.threed/booleanoperation) | Boolean 연산 종류 |
| first | [A3DObject](../../com.aspose.threed/a3dobject) | [IMeshConvertible](../../com.aspose.threed/imeshconvertible), [HalfSpace](../../com.aspose.threed/halfspace) 또는 [Node](../../com.aspose.threed/node)의 인스턴스 |
| second | [A3DObject](../../com.aspose.threed/a3dobject) | [IMeshConvertible](../../com.aspose.threed/imeshconvertible), [HalfSpace](../../com.aspose.threed/halfspace) 또는 [Node](../../com.aspose.threed/node)의 인스턴스 |
...
결과 메쉬를 생성하기 위한 연산에 사용되는 Boolean 연산자.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| value | [BooleanOperand](../../com.aspose.threed/booleanoperand) | 새 값 |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| value | [BooleanOperation](../../com.aspose.threed/booleanoperation) | 새 값 |

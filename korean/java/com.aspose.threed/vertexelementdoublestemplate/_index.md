...
description: 구체적인 구현을 정의하기 위한 도우미 클래스입니다.
type: docs
weight: 209
url: /ko/java/com.aspose.threed/vertexelementdoublestemplate/
---
...
구체적인 [VertexElement](../../com.aspose.threed/vertexelement) 구현을 정의하기 위한 도우미 클래스입니다.
## 메서드

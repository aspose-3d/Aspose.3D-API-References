...
description: Fbx 형식에 대한 로드 옵션.
type: docs
weight: 62
url: /ko/java/com.aspose.threed/fbxloadoptions/
---
...
| 생성자 | 설명 |
| --- | --- |
| [FbxLoadOptions(FileFormat format)](#FbxLoadOptions-com.aspose.threed.FileFormat-) | [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions)의 생성자 |
| [FbxLoadOptions()](#FbxLoadOptions--) | [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions)의 생성자 |
## 메서드
...
| [getClass()](#getClass--) |  |
| [getCompatibleMode()](#getCompatibleMode--) | 호환 모드를 활성화할지 여부를 가져옵니다. |
...
| [getKeepBuiltinGlobalSettings()](#getKeepBuiltinGlobalSettings--) | Native property replacement in [AssetInfo](../../com.aspose.threed/assetinfo)가 있는 GlobalSettings의 내장 속성을 유지할지 여부를 가져옵니다. |
| [getLookupPaths()](#getLookupPaths--) | OBJ와 같은 일부 파일은 외부 파일에 의존하며, 검색 경로를 통해 Aspose.3D가 외부 파일을 찾아 로드할 수 있도록 허용합니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setCompatibleMode(boolean value)](#setCompatibleMode-boolean-) | 호환 모드를 활성화할지 여부를 설정합니다. |
...
| [setKeepBuiltinGlobalSettings(boolean value)](#setKeepBuiltinGlobalSettings-boolean-) | Native property replacement in [AssetInfo](../../com.aspose.threed/assetinfo)가 있는 GlobalSettings의 내장 속성을 유지할지 여부를 설정합니다. |
...
[FbxLoadOptions](../../com.aspose.threed/fbxloadoptions)의 생성자

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| format | [FileFormat](../../com.aspose.threed/fileformat) | [getFileFormat](../../com.aspose.threed/fbxloadoptions\#getFileFormat)의 인스턴스이며, 유효한 FBX 형식이어야 합니다. |
...
호환 모드를 활성화할지 여부를 가져옵니다. 호환 모드는 Blender에서 내보낸 PBR 재질과 같은 비표준 FBX 정의를 지원하려고 시도합니다. 기본값은 false입니다.

**Returns:**
boolean - 호환 모드를 활성화할지 여부. 호환 모드는 Blender에서 내보낸 PBR 재질과 같은 비표준 FBX 정의를 지원하려고 시도합니다. 기본값은 false입니다.
...
Native property replacement in [AssetInfo](../../com.aspose.threed/assetinfo)가 있는 GlobalSettings의 내장 속성을 유지할지 여부를 가져옵니다. GlobalSettings에 전체 속성을 원한다면 true로 설정하십시오. 기본값은 false입니다.

**Returns:**
boolean - Native property replacement in [AssetInfo](../../com.aspose.threed/assetinfo)가 있는 GlobalSettings의 내장 속성을 유지할지 여부. GlobalSettings에 전체 속성을 원한다면 true로 설정하십시오. 기본값은 false입니다.
...
호환 모드를 활성화할지 여부를 설정합니다. 호환 모드는 Blender에서 내보낸 PBR 재질과 같은 비표준 FBX 정의를 지원하려고 시도합니다. 기본값은 false입니다.
...
Native property replacement in [AssetInfo](../../com.aspose.threed/assetinfo)가 있는 GlobalSettings의 내장 속성을 유지할지 여부를 설정합니다. GlobalSettings에 전체 속성을 원한다면 true로 설정하십시오. 기본값은 false입니다.

...
| 생성자 | 설명 |
| --- | --- |
| [Matrix4(Vector4 r0, Vector4 r1, Vector4 r2, Vector4 r3)](#Matrix4-com.aspose.threed.Vector4-com.aspose.threed.Vector4-com.aspose.threed.Vector4-com.aspose.threed.Vector4-) | 4개의 행으로부터 행렬을 구성합니다. |
...
| [mul(Matrix4 lhs, double v)](#mul-com.aspose.threed.Matrix4-double-) | 행렬과 실수 값을 곱합니다. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| translation | [Vector3](../../com.aspose.threed/vector3) | 번역. |
| scaling | [Vector3](../../com.aspose.threed/vector3) | 스케일링. |
| rotation | [Quaternion](../../com.aspose.threed/quaternion) | 회전. |

**Returns:**
boolean - 성공했을 경우 True.
### equals(Object obj) {#equals-java.lang.Object-}
```
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
|  | q | [Quaternion](../../com.aspose.threed/quaternion) | 회전 쿼터니언 **예시:** 다음 코드는 회전 연산을 위한 행렬을 만드는 방법을 보여줍니다. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 각도 | double | 라디안 단위 회전 각도 |
|  | axis | [Vector3](../../com.aspose.threed/vector3) | 회전 축 **예시:** 다음 코드는 회전 연산을 위한 행렬을 만드는 방법을 보여줍니다. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
|  | eul | [Vector3](../../com.aspose.threed/vector3) | 라디안 단위 회전 **예시:** 다음 코드는 회전 연산을 위한 행렬을 만드는 방법을 보여줍니다. |

...
description: 관련 폴리곤을 함께 묶기 위해 지정된 구성 요소에 대한 폴리곤 그룹을 정의합니다.
type: docs
weight: 215
url: /ko/java/com.aspose.threed/vertexelementpolygongroup/
---
...
| 생성자 | 설명 |
| --- | --- |
| [VertexElementPolygonGroup()](#VertexElementPolygonGroup--) | 새로운 [VertexElementPolygonGroup](../../com.aspose.threed/vertexelementpolygongroup) 클래스 인스턴스를 초기화합니다. |
## 메서드
...
새로운 [VertexElementPolygonGroup](../../com.aspose.threed/vertexelementpolygongroup) 클래스 인스턴스를 초기화합니다.

...
description: 지정된 구성 요소에 대한 사용자 정의 데이터를 정의합니다.
type: docs
weight: 221
url: /ko/java/com.aspose.threed/vertexelementuserdata/
---
...
지정된 구성 요소에 대한 사용자 정의 데이터를 정의합니다. 일반적으로 특수 목적을 위한 애플리케이션 전용 데이터입니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [VertexElementUserData()](#VertexElementUserData--) | [VertexElementUserData](../../com.aspose.threed/vertexelementuserdata) 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
| [getClass()](#getClass--) |  |
| [getData()](#getData--) | 이 요소에 첨부된 사용자 데이터. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(Object value)](#setData-java.lang.Object-) | 이 요소에 첨부된 사용자 데이터. |
...
[VertexElementUserData](../../com.aspose.threed/vertexelementuserdata) 클래스의 새 인스턴스를 초기화합니다.
...
**Returns:**
java.lang.Object - 이 요소에 첨부된 사용자 데이터

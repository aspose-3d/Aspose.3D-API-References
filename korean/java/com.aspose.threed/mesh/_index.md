...
| 생성자 | 설명 |
| --- | --- |
| [Mesh()](#Mesh--) | 새로운 [Mesh](../../com.aspose.threed/mesh) 클래스 인스턴스를 초기화합니다. |
| [Mesh(String name)](#Mesh-java.lang.String-) | 새로운 [Mesh](../../com.aspose.threed/mesh) 클래스 인스턴스를 초기화합니다. |
## 메서드

| 메서드 | 설명 |
| --- | --- |
| [<T>getDeformers2()](#-T-getDeformers2--) | 지정된 변형기 유형으로 모든 변형기를 가져옵니다 |
| [addControlPoint(double x, double y, double z)](#addControlPoint-double-double-double-) | 메시에 새로운 제어점을 추가합니다. 이는 더 효율적입니다. |
| [addControlPoint(double x, double y, double z, double w)](#addControlPoint-double-double-double-double-) | 메시에 새로운 제어점을 추가합니다. 이는 더 효율적입니다. |
...
새로운 [Mesh](../../com.aspose.threed/mesh) 클래스 인스턴스를 초기화합니다.

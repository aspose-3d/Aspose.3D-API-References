...
description: "일반적으로 사용되는 렌더링 API"
type: docs
weight: 269
url: /ko/java/com.aspose.threed/renderingapi/
---
...
| 필드 | 설명 |
| --- | --- |
| [ARNOLD](#ARNOLD) | Arnold 렌더러 |
| [CUSTOM](#CUSTOM) | 맞춤형 렌더링 API |
| [DIRECTX](#DIRECTX) | DirectX |
| [MANTLE](#MANTLE) | AMD Mantle |
| [MENTAL_RAY](#MENTAL-RAY) | MentalRay |
| [METAL](#METAL) | Apple에서 개발한 Metal |
| [NONE](#NONE) | 렌더링 API 없음 |
| [OPENGL](#OPENGL) | OpenGL |
| [OPENGLES](#OPENGLES) | OpenGL ES |
| [PREVIEW](#PREVIEW) | PreviewColorAPI, FBX와 호환 |
| [RENDER_MAN](#RENDER-MAN) | RenderMan |
| [RENDER_WARE](#RENDER-WARE) | RenderWare |
| [SHADERFX](#SHADERFX) | ShaderFX 렌더러 |
| [STAGE3D](#STAGE3D) | Adobe Flash에서 사용되는 Stage3D |

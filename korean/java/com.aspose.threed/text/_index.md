...
description: "텍스트 프로필 이 프로필은 글꼴과 텍스트를 사용하여 윤곽선을 설명합니다."
type: docs
weight: 183
url: /ko/java/com.aspose.threed/text/
---
...
| [getFont()](#getFont--) | 텍스트의 글꼴입니다. |
| [getFontSize()](#getFontSize--) | 글꼴 크기 비율. |
...
| [setContent(String value)](#setContent-java.lang.String-) | 텍스트의 내용 |
| [setExcluded(boolean value)](#setExcluded-boolean-) | 내보내기 중에 이 엔터티를 제외할지 여부를 설정합니다. |
| [setFont(FontFile value)](#setFont-com.aspose.threed.FontFile-) | 텍스트의 글꼴입니다. |
| [setFontSize(float value)](#setFontSize-float-) | 글꼴 크기 비율. |
...
**Returns:**
java.lang.String - 텍스트의 내용 **Example:** 다음 코드는 지정된 글꼴 파일을 사용하여 텍스트에서 3D 메쉬를 만드는 방법을 보여줍니다.
...
**Returns:**
float - 글꼴 크기 비율. **Example:** 다음 코드는 지정된 글꼴 파일을 사용하여 텍스트에서 3D 메쉬를 만드는 방법을 보여줍니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
|  | 값 | java.lang.String | 새 값 **Example:** 다음 코드는 지정된 글꼴 파일을 사용하여 텍스트에서 3D 메쉬를 만드는 방법을 보여줍니다. |

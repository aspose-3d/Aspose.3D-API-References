...
description: 지정된 구성 요소에 대한 노멀 벡터를 정의합니다.
type: docs
weight: 214
url: /ko/java/com.aspose.threed/vertexelementnormal/
---
...
지정된 구성 요소에 대한 노멀 벡터를 정의합니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [VertexElementNormal()](#VertexElementNormal--) | 새로운 [VertexElementNormal](../../com.aspose.threed/vertexelementnormal) 클래스 인스턴스를 초기화합니다. |
## 메서드
...
새로운 [VertexElementNormal](../../com.aspose.threed/vertexelementnormal) 클래스 인스턴스를 초기화합니다.

...
type: docs
weight: 26
url: /ko/java/com.aspose.threed/box/
---
...
| 생성자 | 설명 |
| --- | --- |
| [Box()](#Box--) | 새 인스턴스인 [Box](../../com.aspose.threed/box) 클래스를 초기화합니다. |
| [Box(double length, double width, double height)](#Box-double-double-double-) | 새 인스턴스인 [Box](../../com.aspose.threed/box) 클래스를 초기화합니다. |
| [Box(String name, double length, double width, double height, int lengthSegments, int widthSegments, int heightSegments)](#Box-java.lang.String-double-double-double-int-int-int-) | 새 인스턴스인 [Box](../../com.aspose.threed/box) 클래스를 초기화합니다. |
## 메서드
...
| [getHeight()](#getHeight--) | y축에 정렬된 박스의 높이를 가져옵니다. |
| [getHeightSegments()](#getHeightSegments--) | 높이 세그먼트를 가져오거나 설정합니다. |
| [getLength()](#getLength--) | z축에 정렬된 박스의 길이를 가져옵니다. |
...
| [getWidth()](#getWidth--) | x축에 정렬된 박스의 너비를 가져옵니다. |
...
| [setHeight(double value)](#setHeight-double-) | y축에 정렬된 박스의 높이를 설정합니다. |
| [setHeightSegments(int value)](#setHeightSegments-int-) | 높이 세그먼트를 가져오거나 설정합니다. |
| [setLength(double value)](#setLength-double-) | z축에 정렬된 박스의 길이를 설정합니다. |
...
| [setWidth(double value)](#setWidth-double-) | x축에 정렬된 박스의 너비를 설정합니다. |
...
새 인스턴스인 [Box](../../com.aspose.threed/box) 클래스를 초기화합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 길이 | double | z축에 정렬된 박스의 길이. |
| 너비 | double | x축에 정렬된 박스의 너비. |
| 높이 | double | y축에 정렬된 박스의 높이. |
...
y축에 정렬된 박스의 높이를 가져옵니다.

**Returns:**
double - y축에 정렬된 박스의 높이.
...
z축에 정렬된 박스의 길이를 가져옵니다.

**Returns:**
double - z축에 정렬된 박스의 길이.
...
x축에 정렬된 박스의 너비를 가져옵니다.

**Returns:**
double - x축에 정렬된 박스의 너비.

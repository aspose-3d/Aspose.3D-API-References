...
description: 렌더 큐의 그룹 ID
type: docs
weight: 297
url: /ko/java/com.aspose.threed/renderqueuegroupid/
---
...
| 필드 | 설명 |
| --- | --- |
| [BACKGROUND](#BACKGROUND) | 배경용 렌더 큐 |
| [GEOMETRIES](#GEOMETRIES) | 기하학용 렌더 큐 |
| [MAIN](#MAIN) | 메인용 렌더 큐 |
| [OPAQUE](#OPAQUE) | 불투명 객체용 렌더 큐 |
| [OVERLAY](#OVERLAY) | 오버레이용 렌더 큐 |
| [SKIES](#SKIES) | 하늘용 렌더 큐 |
## 메서드

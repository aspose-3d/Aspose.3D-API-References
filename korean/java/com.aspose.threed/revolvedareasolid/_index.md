...
description: "이 클래스는 프로파일에 의해 제공된 단면을 축을 중심으로 회전시켜 솔리드 모델을 나타냅니다."
type: docs
weight: 155
url: /ko/java/com.aspose.threed/revolvedareasolid/
---
...
이 클래스는 프로파일에 의해 제공된 단면을 축을 중심으로 회전시켜 만든 솔리드 모델을 나타냅니다. **Example:** 다음 코드는 RevolvedAreaSolid를 사용하여 형태를 솔리드 모델로 회전시키는 방법을 보여줍니다.
...
| [getAngleEnd()](#getAngleEnd--) | 회전 과정의 종료 각도를 라디안 단위로 가져옵니다. 기본값은 π입니다. |
| [getAngleStart()](#getAngleStart--) | 회전 절차의 시작 각도를 가져옵니다(라디안 단위), 기본값은 0입니다. |
| [getAxis()](#getAxis--) | 축 방향을 가져옵니다, 기본값은 (0, 1, 0)입니다. |
...
| [getOrigin()](#getOrigin--) | 회전의 원점 좌표를 가져옵니다, 기본값은 (0, 0, 0)입니다. |
...
| [getShape()](#getShape--) | 회전에 사용되는 기본 프로파일을 가져옵니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setAngleEnd(double value)](#setAngleEnd-double-) | 회전 절차의 종료 각도를 설정합니다(라디안 단위), 기본값은 pi입니다. |
| [setAngleStart(double value)](#setAngleStart-double-) | 회전 절차의 시작 각도를 설정합니다(라디안 단위), 기본값은 0입니다. |
| [setAxis(Vector3 value)](#setAxis-com.aspose.threed.Vector3-) | 축 방향을 설정합니다, 기본값은 (0, 1, 0)입니다. |
...
| [setOrigin(Vector3 value)](#setOrigin-com.aspose.threed.Vector3-) | 회전의 원점 좌표를 설정합니다, 기본값은 (0, 0, 0)입니다. |
...
| [setShape(Profile value)](#setShape-com.aspose.threed.Profile-) | 회전에 사용되는 기본 프로파일을 설정합니다. |
| [toMesh()](#toMesh--) | [RevolvedAreaSolid](../../com.aspose.threed/revolvedareasolid)를 메쉬로 변환합니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
회전 과정의 종료 각도를 라디안 단위로 가져옵니다. 기본값은 π입니다.

**Returns:**
double - 회전 절차의 종료 각도(라디안 단위), 기본값은 pi입니다.
...
회전 절차의 시작 각도를 가져옵니다(라디안 단위), 기본값은 0입니다.

**Returns:**
double - 회전 절차의 시작 각도(라디안 단위), 기본값은 0입니다.
### getAxis() {#getAxis--}
```
...
회전의 원점 좌표를 가져옵니다, 기본값은 (0, 0, 0)입니다.
...
회전 절차의 종료 각도를 설정합니다(라디안 단위), 기본값은 pi입니다.
...
회전 절차의 시작 각도를 설정합니다(라디안 단위), 기본값은 0입니다.
...
회전의 원점 좌표를 설정합니다, 기본값은 (0, 0, 0)입니다.
...
[RevolvedAreaSolid](../../com.aspose.threed/revolvedareasolid)를 메쉬로 변환합니다.

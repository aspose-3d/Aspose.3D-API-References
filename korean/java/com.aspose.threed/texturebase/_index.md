...
description: 모든 구체 텍스처의 기본 클래스.
type: docs
weight: 185
url: /ko/java/com.aspose.threed/texturebase/
---
...
| 생성자 | 설명 |
| --- | --- |
| [TextureBase(String name)](#TextureBase-java.lang.String-) | 새로운 [TextureBase](../../com.aspose.threed/texturebase) 클래스 인스턴스를 초기화합니다. |
## 메서드
...
새로운 [TextureBase](../../com.aspose.threed/texturebase) 클래스 인스턴스를 초기화합니다.

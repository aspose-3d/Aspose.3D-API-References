...
description: 모든 엔터티의 기본 클래스입니다.
type: docs
weight: 52
url: /ko/java/com.aspose.threed/entity/
---
...
모든 엔티티의 기본 클래스입니다. Entity는 [Light](../../com.aspose.threed/light)/[Geometry](../../com.aspose.threed/geometry)와 같은 노드 아래에 첨부되는 구체적인 객체를 나타냅니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [Entity(String name)](#Entity-java.lang.String-) | [Entity](../../com.aspose.threed/entity) 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
[Entity](../../com.aspose.threed/entity) 클래스의 새 인스턴스를 초기화합니다.

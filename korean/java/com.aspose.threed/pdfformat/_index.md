...
description: Adobe의 Portable Document Format 예제         다음 코드는 3D PDF 파일에서 지원되는 모든 3D 씬을 추출하여 obj 형식으로 저장하는 방법을 보여줍니다.
type: docs
weight: 123
url: /ko/java/com.aspose.threed/pdfformat/
---
...
Adobe의 Portable Document Format **Example:** 다음 코드는 3D PDF 파일에서 지원되는 모든 3D 씬을 추출하고 obj 형식으로 기록하는 방법을 보여줍니다.
...
| [extract(Stream stream)](#extract-com.aspose.threed.Stream-) | PDF 스트림에서 원시 3D 콘텐츠를 추출합니다. |
| [extract(Stream stream, byte[] password)](#extract-com.aspose.threed.Stream-byte---) | PDF 스트림에서 원시 3D 콘텐츠를 추출합니다. |
| [extract(String fileName)](#extract-java.lang.String-) | PDF 파일에서 원시 3D 콘텐츠를 추출합니다. |
| [extract(String fileName, byte[] password)](#extract-java.lang.String-byte---) | PDF 파일에서 원시 3D 콘텐츠를 추출합니다. |
| [extractScene(Stream stream)](#extractScene-com.aspose.threed.Stream-) | PDF 스트림에서 원시 3D 콘텐츠를 추출합니다. |
| [extractScene(Stream stream, byte[] password)](#extractScene-com.aspose.threed.Stream-byte---) | PDF 스트림에서 원시 3D 콘텐츠를 추출합니다. |
| [extractScene(String fileName)](#extractScene-java.lang.String-) | PDF 파일에서 3D 씬을 추출합니다. |
| [extractScene(String fileName, byte[] password)](#extractScene-java.lang.String-byte---) | PDF 파일에서 3D 씬을 추출합니다. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | 입력 PDF 파일의 스트림 |

**Returns:**
java.util.ArrayList<byte[]> - 바이트 단위의 모든 3D 콘텐츠 목록이며, Aspose.3D에서 지원하지 않는 형식도 포함합니다. **예시:** 다음 코드는 3D PDF 파일에서 모든 원시 3D 콘텐츠를 추출하고 파일로 저장하는 방법을 보여줍니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| fileName | java.lang.String | 입력 PDF 파일의 파일 이름 |
...
**Returns:**
java.util.ArrayList<com.aspose.threed.Scene> - Aspose.3D에서 지원하는 디코딩된 3D 씬 목록 **예시:** 다음 코드는 3D PDF 파일에서 지원되는 모든 3D 씬을 추출하고 obj 형식으로 저장하는 방법을 보여줍니다.

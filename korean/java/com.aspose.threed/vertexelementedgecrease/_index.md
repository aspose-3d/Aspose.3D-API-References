...
| 생성자 | 설명 |
| --- | --- |
| [VertexElementEdgeCrease()](#VertexElementEdgeCrease--) | 새 인스턴스를 초기화합니다 [VertexElementEdgeCrease](../../com.aspose.threed/vertexelementedgecrease) 클래스. |
## 메서드
...
새 인스턴스를 초기화합니다 [VertexElementEdgeCrease](../../com.aspose.threed/vertexelementedgecrease) 클래스.

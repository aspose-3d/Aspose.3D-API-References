...
description: STL에 대한 로드 옵션
type: docs
weight: 176
url: /ko/java/com.aspose.threed/stlloadoptions/
---
...
| 생성자 | 설명 |
| --- | --- |
| [StlLoadOptions()](#StlLoadOptions--) | 새로운 [StlLoadOptions](../../com.aspose.threed/stlloadoptions) 인스턴스를 초기화합니다. |
| [StlLoadOptions(FileContentType contentType)](#StlLoadOptions-com.aspose.threed.FileContentType-) | 새로운 [StlLoadOptions](../../com.aspose.threed/stlloadoptions) 인스턴스를 초기화합니다. |
## 메서드
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | 가져오기 중에 제어점/법선의 좌표계 뒤집기 여부를 가져옵니다. |
| [getLookupPaths()](#getLookupPaths--) | OBJ와 같은 일부 파일은 외부 파일에 의존하며, 검색 경로를 통해 Aspose.3D가 외부 파일을 찾아 로드할 수 있도록 허용합니다. |
| [getRecalculateNormal()](#getRecalculateNormal--) | STL 파일에 저장된 법선 데이터를 무시하고 정점 위치를 기반으로 법선 데이터를 다시 계산합니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | 가져오기 중에 제어점/법선의 좌표계 뒤집기 여부를 설정합니다. |
...
| [setRecalculateNormal(boolean value)](#setRecalculateNormal-boolean-) | STL 파일에 저장된 법선 데이터를 무시하고 정점 위치를 기반으로 법선 데이터를 다시 계산합니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
새로운 [StlLoadOptions](../../com.aspose.threed/stlloadoptions) 인스턴스를 초기화합니다.
...
가져오기 중에 제어점/법선의 좌표계 뒤집기 여부를 가져옵니다.

**Returns:**
boolean - 가져오기 중에 제어점/법선의 좌표계 뒤집기 여부.
...
STL 파일에 저장된 법선 데이터를 무시하고 정점 위치를 기반으로 법선 데이터를 다시 계산합니다. 기본값은 false입니다.

**Returns:**
boolean - STL 파일에 저장된 법선 데이터를 무시하고 정점 위치를 기반으로 법선 데이터를 다시 계산합니다. 기본값은 false입니다.
### hashCode() {#hashCode--}
```
...
가져오기 중에 제어점/법선의 좌표계 뒤집기 여부를 설정합니다.

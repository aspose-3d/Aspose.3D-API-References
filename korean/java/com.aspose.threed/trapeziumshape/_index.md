...
description: 파라미터로 정의된 IFC 호환 사다리꼴 형태.
type: docs
weight: 193
url: /ko/java/com.aspose.threed/trapeziumshape/
---
...
파라미터로 정의된 IFC 호환 사다리꼴 형태.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [TrapeziumShape()](#TrapeziumShape--) | 생성자 [TrapeziumShape](../../com.aspose.threed/trapeziumshape) |
## 메서드
...
| [getBottomXDim()](#getBottomXDim--) | x축을 따라 측정된 하단 라인의 길이를 가져옵니다. |
...
| [getTopXDim()](#getTopXDim--) | x축을 따라 측정된 상단 라인의 길이를 가져옵니다. |
| [getTopXOffset()](#getTopXOffset--) | 상단 라인의 시작점에서 하단 라인까지의 오프셋을 가져옵니다. |
| [getYDim()](#getYDim--) | y축을 따라 측정된 상단과 하단 라인 사이의 거리를 가져옵니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setBottomXDim(double value)](#setBottomXDim-double-) | x축을 따라 측정된 하단 라인의 길이를 설정합니다. |
...
| [setTopXDim(double value)](#setTopXDim-double-) | x축을 따라 측정된 상단 라인의 길이를 설정합니다. |
| [setTopXOffset(double value)](#setTopXOffset-double-) | 상단 라인의 시작점에서 하단 라인까지의 오프셋을 설정합니다. |
| [setYDim(double value)](#setYDim-double-) | y축을 따라 측정된 상단과 하단 라인 사이의 거리를 설정합니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
생성자 [TrapeziumShape](../../com.aspose.threed/trapeziumshape)
...
x축을 따라 측정된 하단 라인의 길이를 가져옵니다.

**Returns:**
double - x축을 따라 측정된 하단 라인의 길이.
...
x축을 따라 측정된 상단 라인의 길이를 가져옵니다.

**Returns:**
double - x축을 따라 측정된 상단 라인의 길이.
...
상단 라인의 시작점에서 하단 라인까지의 오프셋을 가져옵니다.

**Returns:**
double - 상단 라인의 시작점에서 하단 라인까지의 오프셋.
### getYDim() {#getYDim--}
```
...
y축을 따라 측정된 상단과 하단 라인 사이의 거리를 가져옵니다.

**Returns:**
double - y축을 따라 측정된 상단과 하단 라인 사이의 거리.
### hashCode() {#hashCode--}
```
...
상단 라인의 시작점에서 하단 라인까지의 오프셋을 설정합니다.
...
y축을 따라 측정된 상단과 하단 라인 사이의 거리를 설정합니다.

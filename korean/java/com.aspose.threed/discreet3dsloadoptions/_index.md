...
description: 3DS 파일 로드 옵션.
type: docs
weight: 43
url: /ko/java/com.aspose.threed/discreet3dsloadoptions/
---
...
| 생성자 | 설명 |
| --- | --- |
| [Discreet3dsLoadOptions()](#Discreet3dsLoadOptions--) | [Discreet3dsLoadOptions](../../com.aspose.threed/discreet3dsloadoptions)의 생성자 |
## 메서드

| 메서드 | 설명 |
| --- | --- |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getApplyAnimationTransform()](#getApplyAnimationTransform--) | 첫 번째 프레임의 애니메이션 트랙에 정의된 변환을 사용할지 여부를 가져옵니다. |
| [getClass()](#getClass--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setApplyAnimationTransform(boolean value)](#setApplyAnimationTransform-boolean-) | 첫 번째 프레임의 애니메이션 트랙에 정의된 변환을 사용할지 여부를 설정합니다. |
...
[Discreet3dsLoadOptions](../../com.aspose.threed/discreet3dsloadoptions)의 생성자
...
첫 번째 프레임의 애니메이션 트랙에 정의된 변환을 사용할지 여부를 가져옵니다.

**Returns:**
boolean - 첫 번째 프레임의 애니메이션 트랙에 정의된 변환을 사용할지 여부.
### getClass() {#getClass--}
```
...
첫 번째 프레임의 애니메이션 트랙에 정의된 변환을 사용할지 여부를 설정합니다.

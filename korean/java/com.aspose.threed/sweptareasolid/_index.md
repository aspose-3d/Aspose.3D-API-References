...
description: "A  은 프로파일을 직접선을 따라 스윕하여 기하학을 구성합니다."
type: docs
weight: 181
url: /ko/java/com.aspose.threed/sweptareasolid/
---
...
A [SweptAreaSolid](../../com.aspose.threed/sweptareasolid) 은 프로파일을 직접선을 따라 스윕하여 기하학을 구성합니다. **Example:** 다음 코드는 원 위에 C자 형태를 스윕하여 솔리드 엔티티를 모델링하는 방법을 보여줍니다.
...
| [getClass()](#getClass--) |  |
| [getDirectrix()](#getDirectrix--) | 스윕 영역이 따라가는 직접선. |
| [getEndPoint()](#getEndPoint--) | 직접선의 끝점. |
...
| [getShape()](#getShape--) | 기하학을 구성하기 위한 기본 프로파일. |
| [getStartPoint()](#getStartPoint--) | 직접선의 시작점. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setDirectrix(Curve value)](#setDirectrix-com.aspose.threed.Curve-) | 스윕 영역이 따라가는 직접선. |
| [setEndPoint(EndPoint value)](#setEndPoint-com.aspose.threed.EndPoint-) | 직접선의 끝점. |
...
| [setShape(Profile value)](#setShape-com.aspose.threed.Profile-) | 기하학을 구성하기 위한 기본 프로파일. |
| [setStartPoint(EndPoint value)](#setStartPoint-com.aspose.threed.EndPoint-) | 직접선의 시작점. |

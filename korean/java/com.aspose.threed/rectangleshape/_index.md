...
description: 모서리가 둥근 IFC 호환 사각형 형태.
type: docs
weight: 145
url: /ko/java/com.aspose.threed/rectangleshape/
---
...
모서리가 둥근 IFC 호환 사각형 형태.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [RectangleShape()](#RectangleShape--) | [RectangleShape](../../com.aspose.threed/rectangleshape)의 생성자 |
| [RectangleShape(double xdim, double ydim)](#RectangleShape-double-double-) | x 및 y 축에 지정된 차원을 가진 [RectangleShape](../../com.aspose.threed/rectangleshape)의 생성자. |
## 메서드
...
| [getRoundingRadius()](#getRoundingRadius--) | 모든 네 모서리의 원호 반경을 가져옵니다(단위:도). |
| [getScene()](#getScene--) | 이 객체가 속한 씬을 가져옵니다. |
| [getXDim()](#getXDim--) | x축 방향으로 사각형의 크기를 가져옵니다. 기본값은 2.0입니다. |
| [getYDim()](#getYDim--) | y축 방향으로 사각형의 크기를 가져옵니다. 기본값은 2.0입니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setRoundingRadius(double value)](#setRoundingRadius-double-) | 모든 네 모서리의 원호 반경을 설정합니다(단위:도). |
| [setXDim(double value)](#setXDim-double-) | x축 방향으로 사각형의 크기를 설정합니다. 기본값은 2.0입니다. |
| [setYDim(double value)](#setYDim-double-) | y축 방향으로 사각형의 크기를 설정합니다. 기본값은 2.0입니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[RectangleShape](../../com.aspose.threed/rectangleshape)의 생성자
...
x 및 y 축에 지정된 차원을 가진 [RectangleShape](../../com.aspose.threed/rectangleshape)의 생성자.
...
모든 네 모서리의 원호 반경을 가져옵니다(단위:도). 기본값은 0.0입니다.

**Returns:**
double - 모든 네 모서리의 원호 반경(단위:도). 기본값은 0.0입니다.
### getScene() {#getScene--}
```
...
x축 방향으로 사각형의 크기를 가져옵니다. 기본값은 2.0입니다.

**Returns:**
double - x축 방향으로 사각형의 크기. 기본값은 2.0
### getYDim() {#getYDim--}
```
...
y축 방향으로 사각형의 크기를 가져옵니다. 기본값은 2.0입니다.

**Returns:**
double - y축 방향으로 사각형의 크기. 기본값은 2.0
### hashCode() {#hashCode--}
```
...
모든 네 모서리의 원호 반경을 설정합니다(단위:도). 기본값은 0.0입니다.
...
x축 방향으로 사각형의 크기를 설정합니다. 기본값은 2.0입니다.
...
y축 방향으로 사각형의 크기를 설정합니다. 기본값은 2.0입니다.

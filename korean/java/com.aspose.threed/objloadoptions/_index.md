...
description: Wavefront OBJ에 대한 로드 옵션.
type: docs
weight: 115
url: /ko/java/com.aspose.threed/objloadoptions/
---
...
Wavefront OBJ에 대한 로드 옵션.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [ObjLoadOptions()](#ObjLoadOptions--) | [ObjLoadOptions](../../com.aspose.threed/objloadoptions)의 생성자 |
## 메서드
...
| [getClass()](#getClass--) |  |
| [getEnableMaterials()](#getEnableMaterials--) | 각 객체에 대한 재질 가져오기 여부를 가져옵니다 |
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | 가져오기 중에 제어점/법선의 좌표계 반전 여부를 가져옵니다 |
| [getLookupPaths()](#getLookupPaths--) | OBJ와 같은 일부 파일은 외부 파일에 의존하며, 검색 경로를 통해 Aspose.3D가 외부 파일을 찾아 로드할 수 있도록 허용합니다. |
| [getNormalizeNormal()](#getNormalizeNormal--) | 로드 중에 법선 벡터를 정규화할지 여부를 가져옵니다. |
| [getScale()](#getScale--) | x/y/z 축에 대한 스케일, 기본값은 1.0입니다 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEnableMaterials(boolean value)](#setEnableMaterials-boolean-) | 각 객체에 대한 재질 가져오기 여부를 설정합니다 |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | 가져오기 중에 제어점/법선의 좌표계 반전 여부를 설정합니다 |
...
| [setNormalizeNormal(boolean value)](#setNormalizeNormal-boolean-) | 로드 중에 법선 벡터를 정규화할지 여부를 설정합니다. |
| [setScale(double value)](#setScale-double-) | x/y/z 축에 대한 스케일, 기본값은 1.0입니다 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[ObjLoadOptions](../../com.aspose.threed/objloadoptions)의 생성자
...
각 객체에 대한 재질 가져오기 여부를 가져옵니다

**Returns:**
boolean - 각 객체에 대한 재질 가져오기 여부
...
가져오기 중에 제어점/법선의 좌표계 반전 여부를 가져옵니다

**Returns:**
boolean - 가져오기 중에 제어점/법선의 좌표계 반전 여부
...
로드 중에 법선 벡터를 정규화할지 여부를 가져옵니다. 기본값은 true입니다.

**Returns:**
boolean - 로드 중에 법선 벡터를 정규화할지 여부. 기본값은 true입니다.
### getScale() {#getScale--}
```
...
x/y/z 축에 대한 스케일, 기본값은 1.0입니다

**Returns:**
double - x/y/z 축에 대한 스케일, 기본값은 1.0
### hashCode() {#hashCode--}
```
...
가져오기 중에 제어점/법선의 좌표계 반전 여부를 설정합니다
...
로드 중에 법선 벡터를 정규화할지 여부를 설정합니다. 기본값은 true입니다.

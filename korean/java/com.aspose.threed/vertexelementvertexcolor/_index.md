...
description: 지정된 구성 요소에 대한 정점 색상을 정의합니다.
type: docs
weight: 223
url: /ko/java/com.aspose.threed/vertexelementvertexcolor/
---
...
| 생성자 | 설명 |
| --- | --- |
| [VertexElementVertexColor()](#VertexElementVertexColor--) | [VertexElementVertexColor](../../com.aspose.threed/vertexelementvertexcolor) 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
[VertexElementVertexColor](../../com.aspose.threed/vertexelementvertexcolor) 클래스의 새 인스턴스를 초기화합니다.

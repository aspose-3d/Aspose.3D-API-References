...
description: IFC 호환 중심선 프로파일
type: docs
weight: 30
url: /ko/java/com.aspose.threed/centerlineprofile/
---
...
| 생성자 | 설명 |
| --- | --- |
| [CenterLineProfile(Curve curve, double thickness)](#CenterLineProfile-com.aspose.threed.Curve-double-) | 지정된 곡선을 중심선으로 사용하여 새로운 [CenterLineProfile](../../com.aspose.threed/centerlineprofile)을 생성합니다. |
| [CenterLineProfile(Curve curve)](#CenterLineProfile-com.aspose.threed.Curve-) | 지정된 곡선을 중심선으로 사용하여 새로운 [CenterLineProfile](../../com.aspose.threed/centerlineprofile)을 생성합니다. |
## 메서드
...
| [getClass()](#getClass--) |  |
| [getCurve()](#getCurve--) | 프로파일의 중심선 곡선 |
...
| [getThickness()](#getThickness--) | 중심선을 따라 적용되는 두께 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setCurve(Curve value)](#setCurve-com.aspose.threed.Curve-) | 프로파일의 중심선 곡선 |
...
| [setThickness(double value)](#setThickness-double-) | 중심선을 따라 적용되는 두께 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
지정된 곡선을 중심선으로 사용하여 새로운 [CenterLineProfile](../../com.aspose.threed/centerlineprofile)을 생성합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | 중심선 곡선 |
| 두께 | double | 중심선을 따라 적용되는 두께 |

...
description: "Shape은 Maya의 클러스터 디포머와 유사하게 제어점 집합에 대한 변형을 설명합니다."
type: docs
weight: 171
url: /ko/java/com.aspose.threed/shape/
---
...
Shape은 Maya의 클러스터 디포머와 유사하게 제어점 집합에 대한 변형을 설명합니다. 예를 들어, 생성된 기하학에 Shape을 추가할 수 있습니다. Shape과 기하학은 동일한 토폴로지 정보를 가지지만 제어점의 위치는 다릅니다. 영향 정도가 달라짐에 따라 기하학은 변형 효과를 수행합니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [Shape()](#Shape--) | 새로운 [Shape](../../com.aspose.threed/shape) 클래스 인스턴스를 초기화합니다. |
| [Shape(String name)](#Shape-java.lang.String-) | 새로운 [Shape](../../com.aspose.threed/shape) 클래스 인스턴스를 초기화합니다. |
## 메서드
...
| [fromControlPoints(Vector3[] controlPoints)](#fromControlPoints-com.aspose.threed.Vector3...-) | 기본 인덱스를 사용하여 지정된 제어점으로 Shape을 생성합니다. |
...
| [getIndices()](#getIndices--) | 인덱스를 가져옵니다. |
...
새로운 [Shape](../../com.aspose.threed/shape) 클래스 인스턴스를 초기화합니다.
...
기본 인덱스를 사용하여 지정된 제어점으로 Shape을 생성합니다.
...
**Returns:**
java.util.List<java.lang.Integer> - 인덱스.
### getName() {#getName--}
```

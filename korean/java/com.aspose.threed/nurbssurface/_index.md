...
description: "NURBS 비균일 유리 기저 스플라인으로 표현되는 표면이며, A는 두 개의  및  로 정의됩니다."
type: docs
weight: 114
url: /ko/java/com.aspose.threed/nurbssurface/
---
...
| 생성자 | 설명 |
| --- | --- |
| [NurbsSurface()](#NurbsSurface--) | [NurbsSurface](../../com.aspose.threed/nurbssurface) 클래스의 새 인스턴스를 초기화합니다. |
| [NurbsSurface(String name)](#NurbsSurface-java.lang.String-) | [NurbsSurface](../../com.aspose.threed/nurbssurface) 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
| [getU()](#getU--) | NURBS 표면의 U 방향을 가져옵니다 |
| [getV()](#getV--) | NURBS 표면의 V 방향을 가져옵니다 |
...
| [toMesh()](#toMesh--) | NURBS 표면을 메시로 변환합니다 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[NurbsSurface](../../com.aspose.threed/nurbssurface) 클래스의 새 인스턴스를 초기화합니다.

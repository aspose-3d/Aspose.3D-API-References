...
description: 파라미터화된 디시.
type: docs
weight: 45
url: /ko/java/com.aspose.threed/dish/
---
...
| 생성자 | 설명 |
| --- | --- |
| [Dish()](#Dish--) | 기본 반경(10) 및 기본 높이(5)로 새로운 Dish 인스턴스를 생성합니다 |
| [Dish(double radius, double height)](#Dish-double-double-) | 지정된 반경과 높이로 새로운 Dish 인스턴스를 생성합니다 |
| [Dish(String name, double radius, double height, int widthSegments, int heightSegments)](#Dish-java.lang.String-double-double-int-int-) | 지정된 반경과 높이로 새로운 Dish 인스턴스를 생성합니다 |
## 메서드
...
| [getHeight()](#getHeight--) | Dish의 높이 |
| [getHeightSegments()](#getHeightSegments--) | 높이 세그먼트를 가져옵니다 |
...
| [setHeight(double value)](#setHeight-double-) | Dish의 높이 |
...
| [setRadius(double value)](#setRadius-double-) | 접시의 반경 |
...
기본 반경(10) 및 기본 높이(5)로 새로운 Dish 인스턴스를 생성합니다
...
지정된 반경과 높이로 새로운 Dish 인스턴스를 생성합니다
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 이름 | java.lang.String | 접시의 이름 |
| 반경 | double | 접시의 반경 |
| 높이 | double | 접시의 높이 |
| widthSegments | int | 접시의 너비 세그먼트 |
| heightSegments | int | 접시의 높이 세그먼트 |

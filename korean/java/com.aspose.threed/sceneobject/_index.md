...
description: "씬 내부에 저장될 객체들의 루트 클래스."
type: docs
weight: 162
url: /ko/java/com.aspose.threed/sceneobject/
---
...
씬 내부에 저장될 객체들의 루트 클래스.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [SceneObject(String name)](#SceneObject-java.lang.String-) | 기본 이름으로 SceneObject를 초기화합니다 |
| [SceneObject()](#SceneObject--) | SceneObject를 초기화합니다. |
## 메서드
...
기본 이름으로 SceneObject를 초기화합니다

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 이름 | java.lang.String | 이 인스턴스의 이름 |

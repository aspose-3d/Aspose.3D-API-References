...
description: 이 클래스는 임의의 곡선으로부터 직접 2D 프로파일을 구성할 수 있게 합니다.
type: docs
weight: 16
url: /ko/java/com.aspose.threed/arbitraryprofile/
---
...
| 생성자 | 설명 |
| --- | --- |
| [ArbitraryProfile()](#ArbitraryProfile--) | 생성자 [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) |
| [ArbitraryProfile(Curve curve)](#ArbitraryProfile-com.aspose.threed.Curve-) | 초기 곡선이 있는 [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) 생성자. |
## 메서드
...
| [getClass()](#getClass--) |  |
| [getCurve()](#getCurve--) | 프로파일을 구성하는 데 사용되는 Curve |
...
| [getHoles()](#getHoles--) | 프로파일의 구멍, 곡선으로도 표현됩니다. |
...
| [setCurve(Curve value)](#setCurve-com.aspose.threed.Curve-) | 프로파일을 구성하는 데 사용되는 Curve |
...
생성자 [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile)
...
초기 곡선이 있는 [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) 생성자.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | 프로파일의 초기 곡선 |
...
프로파일의 구멍, 곡선으로도 표현됩니다.

**Returns:**
java.util.ArrayList<com.aspose.threed.Curve> - 프로파일의 구멍, 곡선으로도 표시됩니다
### getName() {#getName--}
```

...
type: docs
weight: 278
url: /ko/java/com.aspose.threed/extrapolationtype/
---
...
| 필드 | 설명 |
| --- | --- |
| [CONSTANT](#CONSTANT) | 값은 마지막 값과 동일하게 유지됩니다. |
| [CYCLE](#CYCLE) | 반복. |
| [CYCLE_RELATIVE](#CYCLE-RELATIVE) | 이전 패턴을 마지막 값을 기준으로 반복합니다. |
| [GRADIENT](#GRADIENT) | 값은 시간에 따라 동일한 기울기를 유지합니다. |
| [OSCILLATE](#OSCILLATE) | 거울 반사 반복. |
## 메서드

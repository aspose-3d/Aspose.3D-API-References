...
description: PLY 형식입니다.
type: docs
weight: 129
url: /ko/java/com.aspose.threed/plyformat/
---
...
PLY 형식입니다. **예시:** 다음 코드는 PLY 파일에서 메쉬를 디코딩하는 방법을 보여줍니다:
...
| [decode(Stream stream)](#decode-com.aspose.threed.Stream-) | 지정된 스트림에서 포인트 클라우드 또는 메쉬를 디코딩합니다. |
| [decode(Stream stream, PlyLoadOptions opt)](#decode-com.aspose.threed.Stream-com.aspose.threed.PlyLoadOptions-) | 지정된 스트림에서 포인트 클라우드 또는 메쉬를 디코딩합니다. |
| [decode(String fileName)](#decode-java.lang.String-) | 지정된 스트림에서 포인트 클라우드 또는 메쉬를 디코딩합니다. |
| [decode(String fileName, PlyLoadOptions opt)](#decode-java.lang.String-com.aspose.threed.PlyLoadOptions-) | 지정된 스트림에서 포인트 클라우드 또는 메쉬를 디코딩합니다. |
...
| [encode(Entity entity, Stream stream)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-) | 엔티티를 인코딩하고 결과를 스트림에 저장합니다. |
| [encode(Entity entity, Stream stream, PlySaveOptions opt)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-com.aspose.threed.PlySaveOptions-) | 엔티티를 인코딩하고 결과를 스트림에 저장합니다. |
| [encode(Entity entity, String fileName)](#encode-com.aspose.threed.Entity-java.lang.String-) | 엔티티를 인코딩하고 결과를 외부 파일에 저장합니다. |
| [encode(Entity entity, String fileName, PlySaveOptions opt)](#encode-com.aspose.threed.Entity-java.lang.String-com.aspose.threed.PlySaveOptions-) | 엔티티를 인코딩하고 결과를 외부 파일에 저장합니다. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | 입력 스트림 |
...
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | 입력 스트림 |
| opt | [PlyLoadOptions](../../com.aspose.threed/plyloadoptions) | PLY 형식의 로드 옵션 |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| fileName | java.lang.String | 입력 스트림 |
...
엔티티를 인코딩하고 결과를 스트림에 저장합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | 인코딩할 엔터티 |
|  | stream | [Stream](../../com.aspose.threed/stream) | 쓰기 대상 스트림, 이 메서드는 이 스트림을 닫지 않습니다 **Example:** 다음 코드는 메쉬를 PLY 파일로 인코딩하는 방법을 보여줍니다: |
...
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | 인코딩할 엔터티 |
| stream | [Stream](../../com.aspose.threed/stream) | 쓰기 대상 스트림, 이 메서드는 이 스트림을 닫지 않습니다 |
|  | opt | [PlySaveOptions](../../com.aspose.threed/plysaveoptions) | 저장 옵션 **Example:** 다음 코드는 메쉬를 PLY 파일로 인코딩하는 방법을 보여줍니다: |
...
엔티티를 인코딩하고 결과를 외부 파일에 저장합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | 인코딩할 엔터티 |
|  | fileName | java.lang.String | 쓰기 대상 파일 **Example:** 다음 코드는 메쉬를 PLY 파일로 인코딩하는 방법을 보여줍니다: |
...
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | 인코딩할 엔터티 |
| fileName | java.lang.String | 쓰기 대상 파일 |
|  | opt | [PlySaveOptions](../../com.aspose.threed/plysaveoptions) | 저장 옵션 **Example:** 다음 코드는 메쉬를 PLY 파일로 인코딩하는 방법을 보여줍니다: |

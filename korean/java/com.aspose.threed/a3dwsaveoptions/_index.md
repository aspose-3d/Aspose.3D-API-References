...
type: docs
weight: 11
url: /ko/java/com.aspose.threed/a3dwsaveoptions/
---
...
| 생성자 | 설명 |
| --- | --- |
| [A3dwSaveOptions()](#A3dwSaveOptions--) | [A3dwSaveOptions](../../com.aspose.threed/a3dwsaveoptions)의 생성자 |
## 메서드
...
| [getExportMetaData()](#getExportMetaData--) | Scene/Node와 연결된 메타 데이터를 클라이언트에 내보냅니다. 기본값은 true입니다. |
...
| [getMetaDataPrefix()](#getMetaDataPrefix--) | 이 속성이 null이 아니면, 이 접두사로 시작하는 Scene/Node의 속성만 내보내며, 접두사는 제거됩니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEncoding(Charset value)](#setEncoding-java.nio.charset.Charset-) | 텍스트 기반 파일에 대한 기본 인코딩을 설정합니다. |
| [setExportMetaData(boolean value)](#setExportMetaData-boolean-) | Scene/Node와 연결된 메타 데이터를 클라이언트에 내보냅니다. 기본값은 true입니다. |
...
| [setMetaDataPrefix(String value)](#setMetaDataPrefix-java.lang.String-) | 이 속성이 null이 아니면, 이 접두사로 시작하는 Scene/Node의 속성만 내보내며, 접두사는 제거됩니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[A3dwSaveOptions](../../com.aspose.threed/a3dwsaveoptions)의 생성자
...
Scene/Node와 연결된 메타 데이터를 클라이언트에 내보냅니다. 기본값은 true입니다.

**Returns:**
boolean - Scene/Node와 연결된 메타 데이터를 클라이언트에 내보냅니다. 기본값은 true입니다.
...
이 속성이 null이 아니면, 이 접두사로 시작하는 Scene/Node의 속성만 내보내며, 접두사는 제거됩니다.

**Returns:**
java.lang.String - 이 속성이 null이 아니면, 이 접두사로 시작하는 Scene/Node의 속성만 내보내며, 접두사는 제거됩니다.
### hashCode() {#hashCode--}
```

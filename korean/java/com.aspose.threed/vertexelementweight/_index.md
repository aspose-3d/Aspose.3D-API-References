...
description: 지정된 구성 요소에 대한 블렌드 가중치를 정의합니다.
type: docs
weight: 226
url: /ko/java/com.aspose.threed/vertexelementweight/
---
...
| 생성자 | 설명 |
| --- | --- |
| [VertexElementWeight()](#VertexElementWeight--) | [VertexElementWeight](../../com.aspose.threed/vertexelementweight) 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
[VertexElementWeight](../../com.aspose.threed/vertexelementweight) 클래스의 새 인스턴스를 초기화합니다.

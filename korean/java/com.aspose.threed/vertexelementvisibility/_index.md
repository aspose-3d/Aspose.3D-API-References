...
description: 지정된 구성 요소가 보이는지 여부를 정의합니다.
type: docs
weight: 225
url: /ko/java/com.aspose.threed/vertexelementvisibility/
---
...
| 생성자 | 설명 |
| --- | --- |
| [VertexElementVisibility()](#VertexElementVisibility--) | 새로운 [VertexElementVisibility](../../com.aspose.threed/vertexelementvisibility) 클래스 인스턴스를 초기화합니다. |
## 메서드
...
| [copyTo(VertexElementTemplate<T> target)](#copyTo-com.aspose.threed.VertexElementTemplate-T--) | 지정된 요소에 데이터를 복사합니다. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(T[] data)](#setData-T---) | 데이터를 로드합니다. |
...
새로운 [VertexElementVisibility](../../com.aspose.threed/vertexelementvisibility) 클래스 인스턴스를 초기화합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| target | [VertexElementTemplate](../../com.aspose.threed/vertexelementtemplate) | 대상. |

...
description: STL에 대한 저장 옵션
type: docs
weight: 177
url: /ko/java/com.aspose.threed/stlsaveoptions/
---
...
| 생성자 | 설명 |
| --- | --- |
| [StlSaveOptions()](#StlSaveOptions--) | 새 [StlSaveOptions](../../com.aspose.threed/stlsaveoptions) 인스턴스를 초기화합니다. |
| [StlSaveOptions(FileContentType contentType)](#StlSaveOptions-com.aspose.threed.FileContentType-) | 새 [StlSaveOptions](../../com.aspose.threed/stlsaveoptions) 인스턴스를 초기화합니다. |
## 메서드
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | 내보내기 중에 제어점/법선의 좌표계를 뒤집을지 여부를 가져옵니다. |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | 내보내기 중에 제어점/법선의 좌표계를 뒤집을지 여부를 설정합니다. |
...
새 [StlSaveOptions](../../com.aspose.threed/stlsaveoptions) 인스턴스를 초기화합니다.
...
내보내기 중에 제어점/법선의 좌표계를 뒤집을지 여부를 가져옵니다.

**Returns:**
boolean - 내보내기 중에 제어점/법선의 좌표계 뒤집기 여부.
...
내보내기 중에 제어점/법선의 좌표계를 뒤집을지 여부를 설정합니다.

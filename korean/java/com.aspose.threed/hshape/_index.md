...
description: H 또는 I 형태의 정의 매개변수를 제공합니다.
type: docs
weight: 76
url: /ko/java/com.aspose.threed/hshape/
---
...
[HShape](../../com.aspose.threed/hshape)은 'H' 또는 'I' 형태의 정의 매개변수를 제공합니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [HShape()](#HShape--) | [HShape](../../com.aspose.threed/hshape)의 생성자 |
## 메서드
...
| [getBottomFlangeEdgeRadius()](#getBottomFlangeEdgeRadius--) | 하단 플랜지의 상부 가장자리 반경을 가져옵니다. |
| [getBottomFlangeFilletRadius()](#getBottomFlangeFilletRadius--) | 웹과 하부 플랜지 사이의 필렛 반경을 가져옵니다. |
| [getBottomFlangeThickness()](#getBottomFlangeThickness--) | H형의 플랜지 두께를 가져옵니다. |
| [getBottomFlangeWidth()](#getBottomFlangeWidth--) | 너비의 범위를 가져옵니다. |
...
| [getExtent()](#getExtent--) | x 및 y 차원에서 범위를 가져옵니다. |
| [getName()](#getName--) | 이름을 가져옵니다. |
| [getOverallDepth()](#getOverallDepth--) | 깊이의 범위를 가져옵니다. |
...
| [getTopFlangeEdgeRadius()](#getTopFlangeEdgeRadius--) | 상부 플랜지 하단 가장자리의 반경을 가져옵니다. |
| [getTopFlangeFilletRadius()](#getTopFlangeFilletRadius--) | 웹과 상부 플랜지 사이의 필렛 반경을 가져옵니다. |
| [getTopFlangeThickness()](#getTopFlangeThickness--) | 상부 플랜지의 두께를 가져옵니다. |
| [getTopFlangeWidth()](#getTopFlangeWidth--) | 상부 플랜지의 너비를 가져옵니다. |
| [getWebThickness()](#getWebThickness--) | H형 웹의 두께를 가져옵니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setBottomFlangeEdgeRadius(double value)](#setBottomFlangeEdgeRadius-double-) | 하부 플랜지 상단 가장자리의 반경을 설정합니다. |
| [setBottomFlangeFilletRadius(double value)](#setBottomFlangeFilletRadius-double-) | 웹과 하부 플랜지 사이의 필렛 반경을 설정합니다. |
| [setBottomFlangeThickness(double value)](#setBottomFlangeThickness-double-) | H형의 플랜지 두께를 설정합니다. |
| [setBottomFlangeWidth(double value)](#setBottomFlangeWidth-double-) | 너비의 범위를 설정합니다. |
...
| [setOverallDepth(double value)](#setOverallDepth-double-) | 깊이의 범위를 설정합니다. |
...
| [setTopFlangeEdgeRadius(double value)](#setTopFlangeEdgeRadius-double-) | 상부 플랜지 하단 가장자리의 반경을 설정합니다. |
| [setTopFlangeFilletRadius(double value)](#setTopFlangeFilletRadius-double-) | 웹과 상부 플랜지 사이의 필렛 반경을 설정합니다. |
| [setTopFlangeThickness(double value)](#setTopFlangeThickness-double-) | 상부 플랜지의 두께를 설정합니다. |
| [setTopFlangeWidth(double value)](#setTopFlangeWidth-double-) | 상부 플랜지의 너비를 설정합니다. |
| [setWebThickness(double value)](#setWebThickness-double-) | H형 웹의 두께를 설정합니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[HShape](../../com.aspose.threed/hshape)의 생성자
...
하단 플랜지의 상부 가장자리 반경을 가져옵니다.

**Returns:**
double - 하부 플랜지 상단 가장자리의 반경.
...
웹과 하부 플랜지 사이의 필렛 반경을 가져옵니다.

**Returns:**
double - 웹과 하부 플랜지 사이의 필렛 반경.
...
상부 플랜지 하단 가장자리의 반경을 가져옵니다.

**Returns:**
double - 상부 플랜지 하단 가장자리의 반경.
...
웹과 상부 플랜지 사이의 필렛 반경을 가져옵니다.

**Returns:**
double - 웹과 상부 플랜지 사이의 필렛 반경.

...
description: "파라미터화된 토러스."
type: docs
weight: 189
url: /ko/java/com.aspose.threed/torus/
---
...
| 생성자 | 설명 |
| --- | --- |
| [Torus()](#Torus--) | [Torus](../../com.aspose.threed/torus) 클래스의 새 인스턴스를 초기화합니다. |
| [Torus(double radius, double tube)](#Torus-double-double-) | [Torus](../../com.aspose.threed/torus) 클래스의 새 인스턴스를 초기화합니다. |
| [Torus(double radius, double tube, double arc)](#Torus-double-double-double-) | [Torus](../../com.aspose.threed/torus) 클래스의 새 인스턴스를 초기화합니다. |
| [Torus(String name, double radius, double tube, int radialSegments, int tubularSegments, double arc)](#Torus-java.lang.String-double-double-int-int-double-) | [Torus](../../com.aspose.threed/torus) 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
| [getRadius()](#getRadius--) | 토러스의 반경을 가져옵니다. |
| [getReceiveShadows()](#getReceiveShadows--) | 이 기하학이 그림자를 받을 수 있는지 여부를 가져옵니다. |
| [getScene()](#getScene--) | 이 객체가 속한 씬을 가져옵니다. |
| [getTube()](#getTube--) | 튜브의 반경을 가져옵니다. |
| [getTubularSegments()](#getTubularSegments--) | 튜블 세그먼트를 가져옵니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setArc(double value)](#setArc-double-) | 호를 설정합니다. |
...
| [setRadius(double value)](#setRadius-double-) | 토러스의 반경을 설정합니다. |
| [setReceiveShadows(boolean value)](#setReceiveShadows-boolean-) | 이 기하학이 그림자를 받을 수 있는지 여부를 설정합니다. |
| [setTube(double value)](#setTube-double-) | 튜브의 반경을 설정합니다. |
| [setTubularSegments(int value)](#setTubularSegments-int-) | 튜블 세그먼트를 설정합니다. |
...
[Torus](../../com.aspose.threed/torus) 클래스의 새 인스턴스를 초기화합니다.
...
| 반경 | double | 토러스의 반경. |
| tube | double | 토러스 튜브의 반경. |
| radialSegments | int | 방사형 세그먼트. |
| tubularSegments | int | 관형 세그먼트. |
| arc | double | 호. |

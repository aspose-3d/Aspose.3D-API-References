...
description: 폴리라인은 점 집합으로 정의된 경로이며  와 연결된   로 연결되어, 이는 연결된 선분 집합이 될 수도 있음을 의미합니다.
type: docs
weight: 95
url: /ko/java/com.aspose.threed/line/
---
...
폴리라인은 [Geometry.getControlPoints](../../com.aspose.threed/geometry\#getControlPoints) 로 정의된 점 집합을 가진 경로이며, [getSegments](../../com.aspose.threed/line\#getSegments) 로 연결됩니다. 이는 연결된 선분 집합이 될 수도 있음을 의미합니다. 라인은 일반적으로 선형 객체이므로 곡선을 표현할 수 없으며, 곡선을 표현하려면 [NurbsCurve](../../com.aspose.threed/nurbscurve) 를 사용합니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [Line()](#Line--) | 새로운 [Line](../../com.aspose.threed/line) 클래스 인스턴스를 초기화합니다. |
| [Line(String name)](#Line-java.lang.String-) | 새로운 [Line](../../com.aspose.threed/line) 클래스 인스턴스를 초기화합니다. |
## 메서드
...
| [fromPoints(Vector3[] points)](#fromPoints-com.aspose.threed.Vector3...-) | 점 집합으로부터 [Line](../../com.aspose.threed/line) 인스턴스를 생성합니다. |
...
| [getSegments()](#getSegments--) | 라인의 세그먼트를 가져옵니다 |
| [getVisible()](#getVisible--) | 기하학이 보이는지 여부를 가져옵니다. |
| [hashCode()](#hashCode--) |  |
| [makeDefaultIndices()](#makeDefaultIndices--) | 시퀀스 0,1,2,3....[Geometry.getControlPoints](../../com.aspose.threed/geometry\#getControlPoints).Length-1 를 생성하여 [getSegments](../../com.aspose.threed/line\#getSegments) 로 사용하면 ControlPoints 를 단일 라인으로 사용할 수 있습니다. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
새로운 [Line](../../com.aspose.threed/line) 클래스 인스턴스를 초기화합니다.
...
점 집합으로부터 [Line](../../com.aspose.threed/line) 인스턴스를 생성합니다.
...
시퀀스 0,1,2,3....[Geometry.getControlPoints](../../com.aspose.threed/geometry\#getControlPoints).Length-1 를 생성하여 [getSegments](../../com.aspose.threed/line\#getSegments) 로 사용하면 ControlPoints 를 단일 라인으로 사용할 수 있습니다.

...
description: 매개변수로 정의된 IFC 호환 타원 형태.
type: docs
weight: 50
url: /ko/java/com.aspose.threed/ellipseshape/
---
...
매개변수로 정의된 IFC 호환 타원 형태입니다. 프로파일의 중심 위치는 경계 상자의 중앙에 있습니다.
## 생성자
...
| [getSemiAxis1()](#getSemiAxis1--) | x축 방향으로 측정된 타원의 첫 번째 반지름을 가져옵니다. |
| [getSemiAxis2()](#getSemiAxis2--) | y축 방향으로 측정된 타원의 두 번째 반지름을 가져옵니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setSemiAxis1(double value)](#setSemiAxis1-double-) | x축 방향으로 측정된 타원의 첫 번째 반지름을 설정합니다. |
| [setSemiAxis2(double value)](#setSemiAxis2-double-) | y축 방향으로 측정된 타원의 두 번째 반지름을 설정합니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
x축 방향으로 측정된 타원의 첫 번째 반지름을 가져옵니다.

**Returns:**
double - x축 방향으로 측정된 타원의 첫 번째 반지름.
...
y축 방향으로 측정된 타원의 두 번째 반지름을 가져옵니다.

**Returns:**
double - y축 방향으로 측정된 타원의 두 번째 반지름.
### hashCode() {#hashCode--}
```
...
x축 방향으로 측정된 타원의 첫 번째 반지름을 설정합니다.
...
y축 방향으로 측정된 타원의 두 번째 반지름을 설정합니다.

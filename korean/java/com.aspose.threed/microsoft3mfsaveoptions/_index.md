...
description: Microsoft 3MF 파일에 대한 저장 옵션.
type: docs
weight: 105
url: /ko/java/com.aspose.threed/microsoft3mfsaveoptions/
---
...
Microsoft 3MF 파일에 대한 저장 옵션.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [Microsoft3MFSaveOptions()](#Microsoft3MFSaveOptions--) | [Microsoft3MFSaveOptions](../../com.aspose.threed/microsoft3mfsaveoptions)를 생성합니다. |
## 메서드

| 메서드 | 설명 |
| --- | --- |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getBuildAll()](#getBuildAll--) | 장면의 모든 기하학을 인쇄 가능하도록 표시합니다. |
| [getClass()](#getClass--) |  |
| [getEnableCompression()](#getEnableCompression--) | 출력 3mf 파일에 압축을 활성화합니다. 기본값은 true입니다. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBuildAll(boolean value)](#setBuildAll-boolean-) | 장면의 모든 기하학을 인쇄 가능하도록 표시합니다. |
| [setEnableCompression(boolean value)](#setEnableCompression-boolean-) | 출력 3mf 파일에 압축을 활성화합니다. 기본값은 true입니다. |
...
[Microsoft3MFSaveOptions](../../com.aspose.threed/microsoft3mfsaveoptions)를 생성합니다.
...
장면의 모든 기하학을 인쇄 가능하도록 표시합니다. 또는 [Microsoft3MFFormat](../../com.aspose.threed/microsoft3mfformat)으로 노드를 수동으로 인쇄 가능하도록 표시할 수 있습니다. 기본값은 true입니다.

**Returns:**
boolean - 장면의 모든 기하학을 인쇄 가능하도록 표시합니다. 또는 [Microsoft3MFFormat](../../com.aspose.threed/microsoft3mfformat)으로 노드를 수동으로 인쇄 가능하도록 표시할 수 있습니다. 기본값은 true입니다.
### getClass() {#getClass--}
```
...
출력 3mf 파일에 압축을 활성화합니다. 기본값은 true입니다.

**Returns:**
boolean - 출력 3mf 파일에 압축을 활성화합니다. 기본값은 true입니다.

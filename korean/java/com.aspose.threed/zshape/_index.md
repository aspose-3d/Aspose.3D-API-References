...
description: 파라미터로 정의된 IFC 호환 Z형 프로파일.
type: docs
weight: 234
url: /ko/java/com.aspose.threed/zshape/
---
...
파라미터로 정의된 IFC 호환 Z형 프로파일.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [ZShape()](#ZShape--) | 생성자 [ZShape](../../com.aspose.threed/zshape) |
## 메서드
...
| [getEdgeRadius()](#getEdgeRadius--) | 플랜지 가장자리의 반지름을 가져옵니다. |
...
| [getFilletRadius()](#getFilletRadius--) | 플랜지와 웹 사이의 필렛 반지름을 가져옵니다. |
| [getFlangeThickness()](#getFlangeThickness--) | 플랜지의 두께를 가져옵니다. |
...
| [getWebThickness()](#getWebThickness--) | 벽의 두께를 가져옵니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setEdgeRadius(double value)](#setEdgeRadius-double-) | 플랜지 가장자리의 반지름을 설정합니다. |
| [setExcluded(boolean value)](#setExcluded-boolean-) | 내보내기 중에 이 엔터티를 제외할지 여부를 설정합니다. |
| [setFilletRadius(double value)](#setFilletRadius-double-) | 플랜지와 웹 사이의 필렛 반지름을 설정합니다. |
| [setFlangeThickness(double value)](#setFlangeThickness-double-) | 플랜지의 두께를 설정합니다. |
...
| [setWebThickness(double value)](#setWebThickness-double-) | 벽의 두께를 설정합니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
생성자 [ZShape](../../com.aspose.threed/zshape)
...
플랜지 가장자리의 반지름을 가져옵니다.

**Returns:**
double - 플랜지 가장자리의 반지름.
...
플랜지와 웹 사이의 필렛 반지름을 가져옵니다.

**Returns:**
double - 플랜지와 웹 사이의 필렛 반지름.

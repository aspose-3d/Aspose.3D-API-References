...
| [toRadian(double degree)](#toRadian-double-) | 각도를 라디안으로 변환합니다 |
| [toRadian(double x, double y, double z)](#toRadian-double-double-double-) | 벡터를 각도에서 라디안으로 변환합니다 |
| [toRadian(float degree)](#toRadian-float-) | 각도를 라디안으로 변환합니다 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| radian | [Vector3](../../com.aspose.threed/vector3) | 라디안 값. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| x | double | 라디안 값의 x 구성 요소. |
| y | double | 라디안 값의 y 구성 요소. |
| z | double | 라디안 값의 z 구성 요소. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| degree | [Vector3](../../com.aspose.threed/vector3) | 각도 값. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| x | double | 각도 값의 x 구성 요소. |
| y | double | 각도 값의 y 구성 요소. |
| z | double | 각도 값의 z 구성 요소. |

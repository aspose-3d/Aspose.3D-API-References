...
description: 파라미터화된 직사각형 토러스.
type: docs
weight: 146
url: /ko/java/com.aspose.threed/rectangulartorus/
---
...
| 생성자 | 설명 |
| --- | --- |
| [RectangularTorus()](#RectangularTorus--) | 생성자 [RectangularTorus](../../com.aspose.threed/rectangulartorus) |
| [RectangularTorus(String name)](#RectangularTorus-java.lang.String-) | 생성자 [RectangularTorus](../../com.aspose.threed/rectangulartorus) |
## 메서드
...
| [getAngleStart()](#getAngleStart--) | 호의 시작 각도는 라디안으로 측정됩니다. |
| [getArc()](#getArc--) | 호의 전체 각도는 라디안으로 측정됩니다. |
...
| [getHeight()](#getHeight--) | 직사각형 토러스의 높이. |
| [getInnerRadius()](#getInnerRadius--) | 직사각형 토러스의 내부 반경, 기본값은 17입니다. |
| [getName()](#getName--) | 이름을 가져옵니다. |
| [getOuterRadius()](#getOuterRadius--) | 직사각형 토러스의 외부 반경, 기본값은 20입니다. |
...
| [getRadialSegments()](#getRadialSegments--) | 방사형 세그먼트, 기본값은 10입니다. |
...
| [setAngleStart(double value)](#setAngleStart-double-) | 호의 시작 각도는 라디안으로 측정됩니다. |
| [setArc(double value)](#setArc-double-) | 호의 전체 각도는 라디안으로 측정됩니다. |
...
| [setHeight(double value)](#setHeight-double-) | 직사각형 토러스의 높이. |
| [setInnerRadius(double value)](#setInnerRadius-double-) | 직사각형 토러스의 내부 반경, 기본값은 17입니다. |
| [setName(String value)](#setName-java.lang.String-) | 이름을 설정합니다. |
| [setOuterRadius(double value)](#setOuterRadius-double-) | 직사각형 토러스의 외부 반경, 기본값은 20입니다. |
...
| [setRadialSegments(int value)](#setRadialSegments-int-) | 방사형 세그먼트, 기본값은 10입니다. |
| [setReceiveShadows(boolean value)](#setReceiveShadows-boolean-) | 이 기하학이 그림자를 받을 수 있는지 여부를 설정합니다. |
| [toMesh()](#toMesh--) | 이 기본형을 [Mesh](../../com.aspose.threed/mesh)으로 변환합니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
생성자 [RectangularTorus](../../com.aspose.threed/rectangulartorus)
...
호의 시작 각도는 라디안으로 측정됩니다. 기본값은 0입니다.

**Returns:**
double - 호의 시작 각도이며, 라디안으로 측정됩니다. 기본값은 0입니다.
### getArc() {#getArc--}
```
...
호의 전체 각도이며, 라디안으로 측정됩니다. 기본값은 PI입니다.

**Returns:**
double - 호의 전체 각도이며, 라디안으로 측정됩니다. 기본값은 PI입니다.
...
직사각형 토러스의 높이입니다. 기본값은 20입니다.

**Returns:**
double - 직사각형 토러스의 높이입니다. 기본값은 20입니다.
...
직사각형 토러스의 내부 반경, 기본값은 17입니다.

**Returns:**
double - 직사각형 토러스의 내부 반경이며, 기본값은 17입니다.
### getName() {#getName--}
```
...
직사각형 토러스의 외부 반경, 기본값은 20입니다.

**Returns:**
double - 직사각형 토러스의 외부 반경이며, 기본값은 20입니다.
...
이 기본형을 [Mesh](../../com.aspose.threed/mesh)으로 변환합니다.

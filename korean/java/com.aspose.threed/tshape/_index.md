...
description: 파라미터로 정의된 IFC 호환 T형.
type: docs
weight: 182
url: /ko/java/com.aspose.threed/tshape/
---
...
| 생성자 | 설명 |
| --- | --- |
| [TShape()](#TShape--) | 생성자 [TShape](../../com.aspose.threed/tshape) |
## 메서드
...
| [getClass()](#getClass--) |  |
| [getDepth()](#getDepth--) | 웹의 길이를 가져옵니다. |
...
| [getFilletRadius()](#getFilletRadius--) | 웹과 플랜지 사이의 필렛 반경을 가져옵니다. |
| [getFlangeEdgeRadius()](#getFlangeEdgeRadius--) | 플랜지 가장자리의 반경을 가져옵니다. |
| [getFlangeThickness()](#getFlangeThickness--) | 플랜지의 벽 두께를 가져옵니다. |
| [getFlangeWidth()](#getFlangeWidth--) | 플랜지의 길이를 가져옵니다. |
...
| [getWebEdgeRadius()](#getWebEdgeRadius--) | 웹 가장자리의 반경을 가져옵니다. |
| [getWebThickness()](#getWebThickness--) | 웹의 벽 두께를 가져옵니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setDepth(double value)](#setDepth-double-) | 웹의 길이를 설정합니다. |
| [setExcluded(boolean value)](#setExcluded-boolean-) | 내보내기 중에 이 엔터티를 제외할지 여부를 설정합니다. |
| [setFilletRadius(double value)](#setFilletRadius-double-) | 웹과 플랜지 사이의 필렛 반경을 설정합니다. |
| [setFlangeEdgeRadius(double value)](#setFlangeEdgeRadius-double-) | 플랜지 가장자리의 반경을 설정합니다. |
| [setFlangeThickness(double value)](#setFlangeThickness-double-) | 플랜지의 벽 두께를 설정합니다. |
| [setFlangeWidth(double value)](#setFlangeWidth-double-) | 플랜지의 길이를 설정합니다. |
...
| [setWebEdgeRadius(double value)](#setWebEdgeRadius-double-) | 웹 가장자리의 반경을 설정합니다. |
| [setWebThickness(double value)](#setWebThickness-double-) | 웹의 벽 두께를 설정합니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
생성자 [TShape](../../com.aspose.threed/tshape)
...
웹과 플랜지 사이의 필렛 반경을 가져옵니다.

**Returns:**
double - 웹과 플랜지 사이의 필렛 반경.

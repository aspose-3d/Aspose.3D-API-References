...
description: 요소들의 데이터 유형
type: docs
weight: 282
url: /ko/java/com.aspose.threed/indexdatatype/
---
...
요소들의 데이터 유형은 [IIndexBuffer](../../com.aspose.threed/iindexbuffer)
## 필드

| 필드 | 설명 |
| --- | --- |
| [INT16](#INT16) | 인덱스 버퍼의 요소는 16비트 정수입니다 |
| [INT32](#INT32) | 인덱스 버퍼의 요소는 32비트 정수입니다 |
## 메서드

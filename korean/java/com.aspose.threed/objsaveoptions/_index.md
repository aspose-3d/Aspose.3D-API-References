...
description: Wavefront OBJ 파일에 대한 저장 옵션.
type: docs
weight: 116
url: /ko/java/com.aspose.threed/objsaveoptions/
---
...
| 생성자 | 설명 |
| --- | --- |
| [ObjSaveOptions()](#ObjSaveOptions--) | 생성자 [ObjSaveOptions](../../com.aspose.threed/objsaveoptions) |
## 메서드
...
| [getAxisSystem()](#getAxisSystem--) | 내보낸 파일의 축 시스템을 가져옵니다. |
| [getClass()](#getClass--) |  |
| [getEnableMaterials()](#getEnableMaterials--) | 각 객체에 대한 재질 가져오기/내보내기 여부를 가져옵니다. |
...
| [getPointCloud()](#getPointCloud--) | 내보내기가 장면을 포인트 클라우드(위상 구조 없이)로 내보낼지 여부를 나타내는 플래그를 가져옵니다. 기본값은 false입니다. |
| [getSerializeW()](#getSerializeW--) | 모델의 정점 위치에서 W 구성 요소를 직렬화할지 여부를 가져옵니다. |
| [getVerbose()](#getVerbose--) | 각 섹션에 대한 주석 생성 여부를 가져옵니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setAxisSystem(AxisSystem value)](#setAxisSystem-com.aspose.threed.AxisSystem-) | 내보낸 파일의 축 시스템을 설정합니다. |
| [setEnableMaterials(boolean value)](#setEnableMaterials-boolean-) | 각 객체에 대한 재질 가져오기/내보내기 여부를 설정합니다. |
...
| [setPointCloud(boolean value)](#setPointCloud-boolean-) | 내보내기가 장면을 포인트 클라우드(위상 구조 없이)로 내보낼지 여부를 나타내는 플래그를 설정합니다. 기본값은 false입니다. |
| [setSerializeW(boolean value)](#setSerializeW-boolean-) | 모델의 정점 위치에서 W 구성 요소를 직렬화할지 여부를 설정합니다. |
| [setVerbose(boolean value)](#setVerbose-boolean-) | 각 섹션에 대한 주석을 생성할지 여부를 설정합니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
생성자 [ObjSaveOptions](../../com.aspose.threed/objsaveoptions)
...
각 객체에 대한 재질 가져오기/내보내기 여부를 가져옵니다.

**Returns:**
boolean - 각 객체에 대한 재료를 가져오거나 내보낼지 여부
...
내보내기가 장면을 포인트 클라우드(위상 구조 없이)로 내보낼지 여부를 나타내는 플래그를 가져옵니다. 기본값은 false입니다.

**Returns:**
boolean - 내보내기가 장면을 포인트 클라우드(위상 구조 없이)로 내보낼지 여부를 나타내는 플래그이며, 기본값은 false입니다.
...
모델의 정점 위치에서 W 구성 요소를 직렬화할지 여부를 가져옵니다.

**Returns:**
boolean - 모델의 정점 위치에서 W 구성 요소를 직렬화할지 여부.
...
각 섹션에 대한 주석 생성 여부를 가져옵니다.

**Returns:**
boolean - 각 섹션에 대한 주석을 생성할지 여부
### hashCode() {#hashCode--}
```
...
각 객체에 대한 재질 가져오기/내보내기 여부를 설정합니다.
...
내보내기가 장면을 포인트 클라우드(위상 구조 없이)로 내보낼지 여부를 나타내는 플래그를 설정합니다. 기본값은 false입니다.
...
모델의 정점 위치에서 W 구성 요소를 직렬화할지 여부를 설정합니다.

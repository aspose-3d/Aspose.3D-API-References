...
description: "A 는 두 개의   로 정의되는 파라메트릭 모델링 표면이며,  와 유사합니다."
type: docs
weight: 119
url: /ko/java/com.aspose.threed/patch/
---
...
A [Patch](../../com.aspose.threed/patch)는 파라메트릭 모델링 표면으로, [NurbsSurface](../../com.aspose.threed/nurbssurface)와 유사하며, 두 개의 [PatchDirection](../../com.aspose.threed/patchdirection)인 [getU](../../com.aspose.threed/patch\#getU)와 [getV](../../com.aspose.threed/patch\#getV)로 정의됩니다. 그러나 [Patch](../../com.aspose.threed/patch)와 [NurbsSurface](../../com.aspose.threed/nurbssurface)의 차이점은 [PatchDirection](../../com.aspose.threed/patchdirection) 곡선이 [PatchDirectionType.BEZIER](../../com.aspose.threed/patchdirectiontype\#BEZIER), [PatchDirectionType.QUADRATIC\_BEZIER](../../com.aspose.threed/patchdirectiontype\#QUADRATIC-BEZIER), [PatchDirectionType.BASIS\_SPLINE](../../com.aspose.threed/patchdirectiontype\#BASIS-SPLINE), [PatchDirectionType.CARDINAL\_SPLINE](../../com.aspose.threed/patchdirectiontype\#CARDINAL-SPLINE), [PatchDirectionType.LINEAR](../../com.aspose.threed/patchdirectiontype\#LINEAR) 중 하나가 될 수 있다는 점입니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [Patch()](#Patch--) | 새로운 [Patch](../../com.aspose.threed/patch) 클래스 인스턴스를 초기화합니다. |
| [Patch(String name)](#Patch-java.lang.String-) | 새로운 [Patch](../../com.aspose.threed/patch) 클래스 인스턴스를 초기화합니다. |
## 메서드

| 메서드 | 설명 |
| --- | --- |
| [<T>getDeformers2()](#-T-getDeformers2--) | 지정된 변형기 유형으로 모든 변형기를 가져옵니다 |
| [addElement(VertexElement element)](#addElement-com.aspose.threed.VertexElement-) | 기존 정점 요소를 현재 기하에 추가합니다. |
| [createElement(VertexElementType type)](#createElement-com.aspose.threed.VertexElementType-) | 지정된 유형으로 정점 요소를 생성하고 이를 기하에 추가합니다. |
| [createElement(VertexElementType type, MappingMode mappingMode, ReferenceMode referenceMode)](#createElement-com.aspose.threed.VertexElementType-com.aspose.threed.MappingMode-com.aspose.threed.ReferenceMode-) | 지정된 유형으로 정점 요소를 생성하고 이를 기하에 추가합니다. |
...
| [getU()](#getU--) | u 방향을 가져옵니다. |
| [getV()](#getV--) | v 방향을 가져옵니다. |
...
새로운 [Patch](../../com.aspose.threed/patch) 클래스 인스턴스를 초기화합니다.

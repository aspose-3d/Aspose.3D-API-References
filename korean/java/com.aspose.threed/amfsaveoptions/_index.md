...
description: AMF에 대한 저장 옵션
type: docs
weight: 12
url: /ko/java/com.aspose.threed/amfsaveoptions/
---
...
| 생성자 | 설명 |
| --- | --- |
| [AmfSaveOptions()](#AmfSaveOptions--) | 생성자 [AmfSaveOptions](../../com.aspose.threed/amfsaveoptions) |
## 메서드
...
| [getClass()](#getClass--) |  |
| [getEnableCompression()](#getEnableCompression--) | 최종 파일 크기를 줄이기 위해 압축을 사용할지 여부, 기본값은 true입니다. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEnableCompression(boolean value)](#setEnableCompression-boolean-) | 최종 파일 크기를 줄이기 위해 압축을 사용할지 여부, 기본값은 true입니다. |
...
생성자 [AmfSaveOptions](../../com.aspose.threed/amfsaveoptions)
...
최종 파일 크기를 줄이기 위해 압축을 사용할지 여부, 기본값은 true입니다.

**Returns:**
boolean - 최종 파일 크기를 줄이기 위해 압축을 사용할지 여부, 기본값은 true입니다.

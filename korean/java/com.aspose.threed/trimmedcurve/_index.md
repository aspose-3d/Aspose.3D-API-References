...
description: 양쪽 끝에서 기본 곡선을 잘라낸 제한된 곡선.
type: docs
weight: 196
url: /ko/java/com.aspose.threed/trimmedcurve/
---
...
| 생성자 | 설명 |
| --- | --- |
| [TrimmedCurve()](#TrimmedCurve--) | [TrimmedCurve](../../com.aspose.threed/trimmedcurve) 의 생성자. |
## 메서드
...
| [getBasisCurve()](#getBasisCurve--) | 잘라낼 기본 곡선. |
...
| [getFirst()](#getFirst--) | 첫 번째 트리밍 끝점은 Cartesian 점이거나 실수 매개변수일 수 있습니다. |
...
| [getSameDirection()](#getSameDirection--) | 트리밍된 결과가 기본 곡선과 동일한 방향을 사용하는지 여부를 가져옵니다. |
| [getScene()](#getScene--) | 이 객체가 속한 씬을 가져옵니다. |
| [getSecond()](#getSecond--) | 두 번째 트리밍 끝점은 Cartesian 점이거나 실수 매개변수일 수 있습니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setBasisCurve(Curve value)](#setBasisCurve-com.aspose.threed.Curve-) | 잘라낼 기본 곡선. |
...
| [setFirst(EndPoint value)](#setFirst-com.aspose.threed.EndPoint-) | 첫 번째 트리밍 끝점은 Cartesian 점이거나 실수 매개변수일 수 있습니다. |
...
| [setSameDirection(boolean value)](#setSameDirection-boolean-) | 트리밍된 결과가 기본 곡선과 동일한 방향을 사용할지 설정합니다. |
| [setSecond(EndPoint value)](#setSecond-com.aspose.threed.EndPoint-) | 두 번째 트리밍 끝점은 Cartesian 점이거나 실수 매개변수일 수 있습니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[TrimmedCurve](../../com.aspose.threed/trimmedcurve) 의 생성자.
...
첫 번째 트리밍 끝점은 Cartesian 점이거나 실수 매개변수일 수 있습니다.
...
트리밍된 결과가 기본 곡선과 동일한 방향을 사용하는지 여부를 가져옵니다.

**Returns:**
boolean - 트리밍된 결과가 기본 곡선과 동일한 방향을 사용하는지 여부.
### getScene() {#getScene--}
```
...
두 번째 트리밍 끝점은 Cartesian 점이거나 실수 매개변수일 수 있습니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| value | [EndPoint](../../com.aspose.threed/endpoint) | 새 값 |
...
트리밍된 결과가 기본 곡선과 동일한 방향을 사용할지 설정합니다.

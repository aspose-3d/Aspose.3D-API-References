...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 이름 | java.lang.String | enum 유형의 이름 |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 이름 | java.lang.String | 속성 테이블의 이름 |
| clazz | [ClassType](../../com.aspose.threed/classtype) | 새 속성 테이블의 클래스 유형 |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| scene | [Scene](../../com.aspose.threed/scene) | 구조 메타데이터를 찾을 씬 |
...
**Returns:**
java.util.HashMap<java.lang.String,com.aspose.threed.StructuralMetadata.ClassType> - 클래스 정의
### getEnums() {#getEnums--}
```
...
**Returns:**
java.util.HashMap<java.lang.String,com.aspose.threed.StructuralMetadata.EnumType> - enum 유형 정의
...
**Returns:**
java.util.ArrayList<com.aspose.threed.StructuralMetadata.PropertyTable> - 이 메타데이터의 속성 테이블
### hashCode() {#hashCode--}
```

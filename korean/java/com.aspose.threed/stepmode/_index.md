...
type: docs
weight: 304
url: /ko/java/com.aspose.threed/stepmode/
---
...
| 필드 | 설명 |
| --- | --- |
| [NEXT_VALUE](#NEXT-VALUE) | 세그먼트의 곡선 값은 항상 다음 키 프레임의 값을 사용합니다. |
| [PREVIOUS_VALUE](#PREVIOUS-VALUE) | 세그먼트의 곡선 값은 항상 이전 키 프레임의 값을 사용합니다. |
## 메서드
...
세그먼트의 곡선 값은 항상 다음 키 프레임의 값을 사용합니다.
...
세그먼트의 곡선 값은 항상 이전 키 프레임의 값을 사용합니다.

...
description: Aspose.ThreeD 객체의 모든 기본 클래스이며, 모든 하위 클래스는 동적 속성을 지원합니다.
type: docs
weight: 10
url: /ko/java/com.aspose.threed/a3dobject/
---
...
Aspose.ThreeD 모든 객체의 기본 클래스이며, 모든 하위 클래스는 동적 속성을 지원합니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [A3DObject(String name)](#A3DObject-java.lang.String-) | 새 인스턴스를 초기화합니다 [A3DObject](../../com.aspose.threed/a3dobject) 클래스. |
| [A3DObject()](#A3DObject--) | 이름 없이 새 인스턴스를 초기화합니다 [A3DObject](../../com.aspose.threed/a3dobject) 클래스. |
## 메서드
...
새 인스턴스를 초기화합니다 [A3DObject](../../com.aspose.threed/a3dobject) 클래스.
...
이름 없이 새 인스턴스를 초기화합니다 [A3DObject](../../com.aspose.threed/a3dobject) 클래스.

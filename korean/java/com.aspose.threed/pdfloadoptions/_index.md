...
description: PDF 로딩 옵션.
type: docs
weight: 124
url: /ko/java/com.aspose.threed/pdfloadoptions/
---
...
| 생성자 | 설명 |
| --- | --- |
| [PdfLoadOptions()](#PdfLoadOptions--) | [PdfLoadOptions](../../com.aspose.threed/pdfloadoptions) 의 생성자. |
## 메서드
...
| [getPassword()](#getPassword--) | 암호화된 PDF 파일을 해제하는 비밀번호. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setPassword(byte[] value)](#setPassword-byte---) | 암호화된 PDF 파일을 해제하는 비밀번호. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[PdfLoadOptions](../../com.aspose.threed/pdfloadoptions) 의 생성자.
...
암호화된 PDF 파일을 해제하는 비밀번호.

**Returns:**
byte[] - 암호화된 PDF 파일을 해제하는 비밀번호.
### hashCode() {#hashCode--}
```

...
description: スムージンググループは、ポリゴンメッシュ内のポリゴンの集合で、滑らかな表面を形成するように見えるべきものです。
type: docs
weight: 216
url: /ja/java/com.aspose.threed/vertexelementsmoothinggroup/
---
...
| Constructor | 説明 |
| --- | --- |
| [VertexElementSmoothingGroup()](#VertexElementSmoothingGroup--) | 新しい [VertexElementSmoothingGroup](../../com.aspose.threed/vertexelementsmoothinggroup) クラスのインスタンスを初期化します。 |
## Methods
...
新しい [VertexElementSmoothingGroup](../../com.aspose.threed/vertexelementsmoothinggroup) クラスのインスタンスを初期化します。

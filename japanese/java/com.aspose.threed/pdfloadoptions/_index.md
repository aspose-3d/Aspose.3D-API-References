...
description: PDF のロードオプション
type: docs
weight: 124
url: /ja/java/com.aspose.threed/pdfloadoptions/
---
...
| Constructor | 説明 |
| --- | --- |
| [PdfLoadOptions()](#PdfLoadOptions--) | [PdfLoadOptions](../../com.aspose.threed/pdfloadoptions) のコンストラクタ |
## Methods
...
| [getPassword()](#getPassword--) | 暗号化された PDF ファイルを解除するためのパスワードです。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setPassword(byte[] value)](#setPassword-byte---) | 暗号化された PDF ファイルを解除するためのパスワードです。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[PdfLoadOptions](../../com.aspose.threed/pdfloadoptions) のコンストラクタ
...
暗号化された PDF ファイルを解除するためのパスワードです。

**Returns:**
byte[] - 暗号化された PDF ファイルを解除するためのパスワードです。
### hashCode() {#hashCode--}
```

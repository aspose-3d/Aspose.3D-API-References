...
description: STL のロードオプション
type: docs
weight: 176
url: /ja/java/com.aspose.threed/stlloadoptions/
---
...
| Constructor | 説明 |
| --- | --- |
| [StlLoadOptions()](#StlLoadOptions--) | 新しい [StlLoadOptions](../../com.aspose.threed/stlloadoptions) インスタンスを初期化します。 |
| [StlLoadOptions(FileContentType contentType)](#StlLoadOptions-com.aspose.threed.FileContentType-) | 新しい [StlLoadOptions](../../com.aspose.threed/stlloadoptions) インスタンスを初期化します。 |
## Methods
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | インポート時に制御点/法線の座標系を反転するかどうかを取得します。 |
| [getLookupPaths()](#getLookupPaths--) | OBJ のような一部のファイルは外部ファイルに依存しており、検索パスにより Aspose.3D が外部ファイルを読み込むために探すことができます。 |
| [getRecalculateNormal()](#getRecalculateNormal--) | STL ファイルに保存されている法線データを無視し、頂点位置に基づいて法線データを再計算します。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | インポート時に制御点/法線の座標系を反転するかどうかを設定します。 |
...
| [setRecalculateNormal(boolean value)](#setRecalculateNormal-boolean-) | STL ファイルに保存されている法線データを無視し、頂点位置に基づいて法線データを再計算します。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
新しい [StlLoadOptions](../../com.aspose.threed/stlloadoptions) インスタンスを初期化します。
...
**Returns:**
boolean - インポート時に制御点/法線の座標系を反転するかどうか。
...
**Returns:**
boolean - STL ファイルに保存されている法線データを無視し、頂点位置に基づいて法線データを再計算します。デフォルト値は false です。
### hashCode() {#hashCode--}
```

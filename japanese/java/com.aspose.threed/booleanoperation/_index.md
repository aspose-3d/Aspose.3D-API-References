...
description: メッシュのブール演算
type: docs
weight: 268
url: /ja/java/com.aspose.threed/booleanoperation/
---
...
| フィールド | 説明 |
| --- | --- |
| [ADD](#ADD) | 2つのメッシュを追加し、入力の合成（ユニオン）を計算します。 |
| [INTERSECT](#INTERSECT) | 2つのメッシュの交差を計算します。 |
| [SUB](#SUB) | あるメッシュを別のメッシュから減算し、入力の差分を計算します。 |
## Methods
...
あるメッシュを別のメッシュから減算し、入力の差分を計算します。

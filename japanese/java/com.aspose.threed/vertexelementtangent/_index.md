...
description: 指定された成分の接線ベクトルを定義します。
type: docs
weight: 218
url: /ja/java/com.aspose.threed/vertexelementtangent/
---
...
| Constructor | 説明 |
| --- | --- |
| [VertexElementTangent()](#VertexElementTangent--) | 新しい [VertexElementTangent](../../com.aspose.threed/vertexelementtangent) クラスのインスタンスを初期化します。 |
## Methods
...
新しい [VertexElementTangent](../../com.aspose.threed/vertexelementtangent) クラスのインスタンスを初期化します。

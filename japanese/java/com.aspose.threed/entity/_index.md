...
description: すべてのエンティティの基底クラスです。
type: docs
weight: 52
url: /ja/java/com.aspose.threed/entity/
---
...
すべてのエンティティの基底クラスです。Entity は、[Light](../../com.aspose.threed/light) や [Geometry](../../com.aspose.threed/geometry) のようなノードの下に添付される具体的なオブジェクトを表します。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [Entity(String name)](#Entity-java.lang.String-) | [Entity](../../com.aspose.threed/entity) クラスの新しいインスタンスを初期化します。 |
## Methods
...
[Entity](../../com.aspose.threed/entity) クラスの新しいインスタンスを初期化します。

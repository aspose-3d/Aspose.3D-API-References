...
description: 指定された成分のエッジクレーズを定義します
type: docs
weight: 210
url: /ja/java/com.aspose.threed/vertexelementedgecrease/
---
...
| Constructor | 説明 |
| --- | --- |
| [VertexElementEdgeCrease()](#VertexElementEdgeCrease--) | 新しい [VertexElementEdgeCrease](../../com.aspose.threed/vertexelementedgecrease) クラスのインスタンスを初期化します。 |
## Methods
...
新しい [VertexElementEdgeCrease](../../com.aspose.threed/vertexelementedgecrease) クラスのインスタンスを初期化します。

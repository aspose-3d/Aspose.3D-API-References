...
description: レンダーステージ
type: docs
weight: 298
url: /ja/java/com.aspose.threed/renderstage/
---
...
| フィールド | 説明 |
| --- | --- |
| [IDLE](#IDLE) | レンダラーはアイドル状態です |
| [POST_PROCESSING](#POST-PROCESSING) | レンダラーはポストプロセッシング効果をレンダリングしています。 |
| [SCENE](#SCENE) | レンダラーはシーンをレンダリングしています |
| [SHADOW_MAP](#SHADOW-MAP) | レンダラーはシャドウマップをレンダリングしています |
## Methods
...
レンダラーはポストプロセッシング効果をレンダリングしています。

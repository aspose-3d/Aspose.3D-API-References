...
description: 指定されたポリゴンが穴であるかどうかを定義します
type: docs
weight: 211
url: /ja/java/com.aspose.threed/vertexelementhole/
---
...
| Constructor | 説明 |
| --- | --- |
| [VertexElementHole()](#VertexElementHole--) | 新しい [VertexElementHole](../../com.aspose.threed/vertexelementhole) クラスのインスタンスを初期化します。 |
## Methods
...
新しい [VertexElementHole](../../com.aspose.threed/vertexelementhole) クラスのインスタンスを初期化します。

...
type: docs
weight: 293
url: /ja/java/com.aspose.threed/posetype/
---
...
| フィールド | 説明 |
| --- | --- |
| [BIND_POSE](#BIND-POSE) | バインドポーズです。 |
| [SNAPSHOT](#SNAPSHOT) | レストポーズは、バインドポーズのスナップショットであることを意味します。 |
## Methods
...
レストポーズは、バインドポーズのスナップショットであることを意味します。

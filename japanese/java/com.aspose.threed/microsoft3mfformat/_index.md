...
description: "Microsoft 3MF 用のファイル形式インスタンスで、3MF 関連ユーティリティを含みます。"
type: docs
weight: 104
url: /ja/java/com.aspose.threed/microsoft3mfformat/
---
...
Microsoft 3MF 用のファイル形式インスタンスで、3MF 関連ユーティリティを含みます。
## フィールド
...
| [getObjectType(Node node)](#getObjectType-com.aspose.threed.Node-) | 指定されたノードのモデルタイプを取得します。 |
| [getTransformForBuild(Node node)](#getTransformForBuild-com.aspose.threed.Node-) | ビルドで使用されるノードの変換行列を取得します。 |
| [getVersion()](#getVersion--) | ファイル形式のバージョンを取得します |
| [hashCode()](#hashCode--) |  |
| [isBuildable(Node node)](#isBuildable-com.aspose.threed.Node-) | このノードがビルドとしてマークされているか確認します。 |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBuildable(Node node, boolean value, Matrix4 transform)](#setBuildable-com.aspose.threed.Node-boolean-com.aspose.threed.Matrix4-) | ノードをビルド用にマークします。 |
| [setObjectType(Node node, String modelType)](#setObjectType-com.aspose.threed.Node-java.lang.String-) | 指定されたノードのモデルタイプを設定します。 |
...
**Returns:**
java.lang.String - 指定されたノードの 3MF オブジェクトタイプ
...
ビルドで使用されるノードの変換行列を取得します。

**Parameters:**
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | 3MF ビルドの変換行列を取得するノードを指定します。 |
...
このノードがビルドとしてマークされているか確認します。

**Parameters:**
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | チェックするノードを指定します。 |

**Returns:**
boolean - ビルドとしてマークされている場合は True
### notify() {#notify--}
```
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | ビルドとしてマークするノードを指定します。 |
| 値 | boolean |  |
| transform | [Matrix4](../../com.aspose.threed/matrix4) | ビルド内のノードの変換です。 |
...
指定されたノードのモデルタイプを設定します。可能な値: model surface solidsupport support other

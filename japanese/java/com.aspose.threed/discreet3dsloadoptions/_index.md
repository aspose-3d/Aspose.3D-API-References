...
description: 3DSファイルのロードオプション。
type: docs
weight: 43
url: /ja/java/com.aspose.threed/discreet3dsloadoptions/
---
...
| Constructor | 説明 |
| --- | --- |
| [Discreet3dsLoadOptions()](#Discreet3dsLoadOptions--) | [Discreet3dsLoadOptions](../../com.aspose.threed/discreet3dsloadoptions) のコンストラクタ |
## Methods

| Method | 説明 |
| --- | --- |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getApplyAnimationTransform()](#getApplyAnimationTransform--) | アニメーション トラックの最初のフレームで定義された変換を使用するかどうかを取得します。 |
| [getClass()](#getClass--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setApplyAnimationTransform(boolean value)](#setApplyAnimationTransform-boolean-) | アニメーション トラックの最初のフレームで定義された変換を使用するかどうかを設定します。 |
...
[Discreet3dsLoadOptions](../../com.aspose.threed/discreet3dsloadoptions) のコンストラクタ
...
アニメーション トラックの最初のフレームで定義された変換を使用するかどうかを取得します。

**Returns:**
boolean - アニメーション トラックの最初のフレームで定義された変換を使用するかどうか。
### getClass() {#getClass--}
```
...
アニメーション トラックの最初のフレームで定義された変換を使用するかどうかを設定します。

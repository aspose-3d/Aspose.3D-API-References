...
description: 指定された成分のブレンドウェイトを定義します。
type: docs
weight: 226
url: /ja/java/com.aspose.threed/vertexelementweight/
---
...
| Constructor | 説明 |
| --- | --- |
| [VertexElementWeight()](#VertexElementWeight--) | [VertexElementWeight](../../com.aspose.threed/vertexelementweight) クラスの新しいインスタンスを初期化します。 |
## Methods
...
[VertexElementWeight](../../com.aspose.threed/vertexelementweight) クラスの新しいインスタンスを初期化します。

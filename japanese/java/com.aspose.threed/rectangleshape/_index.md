...
description: 角が丸められたIFC互換の矩形形状です。
type: docs
weight: 145
url: /ja/java/com.aspose.threed/rectangleshape/
---
...
| Constructor | 説明 |
| --- | --- |
| [RectangleShape()](#RectangleShape--) | [RectangleShape](../../com.aspose.threed/rectangleshape) のコンストラクタ |
| [RectangleShape(double xdim, double ydim)](#RectangleShape-double-double-) | x および y 軸の指定された寸法で [RectangleShape](../../com.aspose.threed/rectangleshape) のコンストラクタ。 |
## Methods
...
| [getRoundingRadius()](#getRoundingRadius--) | すべての四隅の円弧の半径を取得します（単位は度）。 |
| [getScene()](#getScene--) | このオブジェクトが属するシーンを取得します |
| [getXDim()](#getXDim--) | x 軸方向の矩形の範囲を取得します。デフォルト値は 2.0 です。 |
| [getYDim()](#getYDim--) | y 軸方向の矩形の範囲を取得します。デフォルト値は 2.0 です。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setRoundingRadius(double value)](#setRoundingRadius-double-) | すべての四隅の円弧の半径を設定します（単位は度）。 |
| [setXDim(double value)](#setXDim-double-) | x 軸方向の矩形の範囲を設定します。デフォルト値は 2.0 です。 |
| [setYDim(double value)](#setYDim-double-) | y 軸方向の矩形の範囲を設定します。デフォルト値は 2.0 です。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[RectangleShape](../../com.aspose.threed/rectangleshape) のコンストラクタ
...
x および y 軸の指定された寸法で [RectangleShape](../../com.aspose.threed/rectangleshape) のコンストラクタ。
...
**Returns:**
double - すべての四隅の円弧の半径（単位は度）。デフォルト値は 0.0 です。
### getScene() {#getScene--}
```
...
**Returns:**
double - x 軸方向の矩形の範囲です。デフォルト値は 2.0 です。
### getYDim() {#getYDim--}
```
...
**Returns:**
double - y 軸方向の矩形の範囲です。デフォルト値は 2.0 です。
### hashCode() {#hashCode--}
```

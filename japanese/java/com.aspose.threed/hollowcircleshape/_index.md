...
description: IFC 互換の空洞円形プロファイルです。
type: docs
weight: 78
url: /ja/java/com.aspose.threed/hollowcircleshape/
---
...
| [getWallThickness()](#getWallThickness--) | 外側半径と内側半径の差を取得します。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setWallThickness(double value)](#setWallThickness-double-) | 外側半径と内側半径の差を設定します。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |

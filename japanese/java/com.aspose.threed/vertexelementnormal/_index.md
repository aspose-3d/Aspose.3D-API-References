...
description: 指定された成分の法線ベクトルを定義します。
type: docs
weight: 214
url: /ja/java/com.aspose.threed/vertexelementnormal/
---
...
| Constructor | 説明 |
| --- | --- |
| [VertexElementNormal()](#VertexElementNormal--) | 新しい [VertexElementNormal](../../com.aspose.threed/vertexelementnormal) クラスのインスタンスを初期化します。 |
## Methods
...
新しい [VertexElementNormal](../../com.aspose.threed/vertexelementnormal) クラスのインスタンスを初期化します。

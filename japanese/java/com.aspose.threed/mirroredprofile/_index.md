...
description: IFC 互換のミラープロファイル。
type: docs
weight: 106
url: /ja/java/com.aspose.threed/mirroredprofile/
---
...
IFC 互換のミラープロファイル。 このプロファイルは、ベースプロファイルを y 軸について鏡像化することで新しいプロファイルを定義します。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [MirroredProfile(Profile baseProfile)](#MirroredProfile-com.aspose.threed.Profile-) | 既存のプロファイルから新しい [MirroredProfile](../../com.aspose.threed/mirroredprofile) を構築します。 |
## Methods
...
| [getBaseProfile()](#getBaseProfile--) | 鏡像化されるベースプロファイル。 |
...
既存のプロファイルから新しい [MirroredProfile](../../com.aspose.threed/mirroredprofile) を構築します。

**Parameters:**
| Parameter | Type | 説明 |
| --- | --- | --- |
| baseProfile | [Profile](../../com.aspose.threed/profile) | 鏡像化されるベースプロファイル。 |

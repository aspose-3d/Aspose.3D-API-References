...
type: docs
weight: 33
url: /ja/java/com.aspose.threed/colladasaveoptions/
---
...
| Constructor | 説明 |
| --- | --- |
| [ColladaSaveOptions()](#ColladaSaveOptions--) | [ColladaSaveOptions](../../com.aspose.threed/colladasaveoptions) のコンストラクタ |
## Methods
...
| [getIndented()](#getIndented--) | エクスポートされた XML ドキュメントがインデントされているかどうかを取得します。 |
| [getLookupPaths()](#getLookupPaths--) | OBJ のような一部のファイルは外部ファイルに依存しており、検索パスにより Aspose.3D が外部ファイルを読み込むために探すことができます。 |
| [getTransformStyle()](#getTransformStyle--) | ノード変換のスタイルを取得します |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setIndented(boolean value)](#setIndented-boolean-) | エクスポートされた XML ドキュメントがインデントされているかどうかを設定します。 |
...
| [setTransformStyle(ColladaTransformStyle value)](#setTransformStyle-com.aspose.threed.ColladaTransformStyle-) | ノード変換のスタイルを設定します |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[ColladaSaveOptions](../../com.aspose.threed/colladasaveoptions) のコンストラクタ
...
エクスポートされた XML ドキュメントがインデントされているかどうかを取得します。

**Returns:**
boolean - エクスポートされた XML ドキュメントがインデントされているかどうか。
...
エクスポートされた XML ドキュメントがインデントされているかどうかを設定します。
...
| Parameter | Type | 説明 |
| --- | --- | --- |
| value | [ColladaTransformStyle](../../com.aspose.threed/colladatransformstyle) | 新しい値 |

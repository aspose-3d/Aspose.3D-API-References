...
description: DirectX X ファイルのロードオプション。
type: docs
weight: 233
url: /ja/java/com.aspose.threed/xloadoptions/
---
...
DirectX X ファイルのロードオプション。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [XLoadOptions(FileContentType contentType)](#XLoadOptions-com.aspose.threed.FileContentType-) | [XLoadOptions](../../com.aspose.threed/xloadoptions) のコンストラクタ |
## Methods
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | 座標系を反転させます。デフォルトでは true です。 |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | 座標系を反転させます。デフォルトでは true です。 |
...
[XLoadOptions](../../com.aspose.threed/xloadoptions) のコンストラクタ
...
座標系を反転させます。デフォルトでは true です。

**Returns:**
boolean - 座標系を反転させます。デフォルトでは true です。

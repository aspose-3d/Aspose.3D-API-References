...
description: 視錐台の回転モード
type: docs
weight: 299
url: /ja/java/com.aspose.threed/rotationmode/
---
...
| フィールド | 説明 |
| --- | --- |
| [FIXED_DIRECTION](#FIXED-DIRECTION) | 方向は固定され、視点は方向から計算されます |
| [FIXED_TARGET](#FIXED-TARGET) | ターゲットは固定され、方向は視点ターゲットから計算されます |
## Methods

...
description: 指定された成分の鏡面色を定義します。
type: docs
weight: 217
url: /ja/java/com.aspose.threed/vertexelementspecular/
---
...
| Constructor | 説明 |
| --- | --- |
| [VertexElementSpecular()](#VertexElementSpecular--) | 新しい [VertexElementSpecular](../../com.aspose.threed/vertexelementspecular) クラスのインスタンスを初期化します。 |
## Methods
...
新しい [VertexElementSpecular](../../com.aspose.threed/vertexelementspecular) クラスのインスタンスを初期化します。

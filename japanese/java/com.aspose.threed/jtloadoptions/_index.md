...
description: Siemens JT 用のロードオプションです。
type: docs
weight: 88
url: /ja/java/com.aspose.threed/jtloadoptions/
---
...
| [getLoadPMI()](#getLoadPMI--) | 可能であれば JT ファイルから PMI 情報をロードし、データは [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo) のプロパティ "PMI" として保存されます。 |
| [getLoadProperties()](#getLoadProperties--) | JT のプロパティテーブルからプロパティをロードし、Aspose.3D のプロパティとして扱います。 |
...
| [setLoadPMI(boolean value)](#setLoadPMI-boolean-) | 可能であれば JT ファイルから PMI 情報をロードし、データは [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo) のプロパティ "PMI" として保存されます。 |
| [setLoadProperties(boolean value)](#setLoadProperties-boolean-) | JT のプロパティテーブルからプロパティをロードし、Aspose.3D のプロパティとして扱います。 |
...
可能であれば JT ファイルから PMI 情報をロードし、データは [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo) のプロパティ "PMI" として保存されます。デフォルト値は false です。

**Returns:**
boolean - 可能であれば JT ファイルから PMI 情報をロードし、データは [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo) のプロパティ "PMI" として保存されます。デフォルト値は false です。
...
JT のプロパティテーブルからプロパティをロードし、Aspose.3D のプロパティとして扱います。デフォルト値は false です。

**Returns:**
boolean - JT のプロパティテーブルからプロパティをロードし、Aspose.3D のプロパティとして扱います。デフォルト値は false です。

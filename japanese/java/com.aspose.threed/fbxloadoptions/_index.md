...
description: Fbx フォーマットのロードオプションです。
type: docs
weight: 62
url: /ja/java/com.aspose.threed/fbxloadoptions/
---
...
Fbx フォーマットのロードオプションです。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [FbxLoadOptions(FileFormat format)](#FbxLoadOptions-com.aspose.threed.FileFormat-) | [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions) のコンストラクタ |
| [FbxLoadOptions()](#FbxLoadOptions--) | [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions) のコンストラクタ |
## Methods
...
| [getClass()](#getClass--) |  |
| [getCompatibleMode()](#getCompatibleMode--) | 互換モードを有効にするかどうかを取得します。 |
...
| [getKeepBuiltinGlobalSettings()](#getKeepBuiltinGlobalSettings--) | ネイティブ プロパティ置換が [AssetInfo](../../com.aspose.threed/assetinfo) にある GlobalSettings の組み込みプロパティを保持するかどうかを取得します。 |
| [getLookupPaths()](#getLookupPaths--) | OBJ のような一部のファイルは外部ファイルに依存しており、検索パスにより Aspose.3D が外部ファイルを読み込むために探すことができます。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setCompatibleMode(boolean value)](#setCompatibleMode-boolean-) | 互換モードを有効にするかどうかを設定します。 |
...
| [setKeepBuiltinGlobalSettings(boolean value)](#setKeepBuiltinGlobalSettings-boolean-) | ネイティブ プロパティ置換が [AssetInfo](../../com.aspose.threed/assetinfo) にある GlobalSettings の組み込みプロパティを保持するかどうかを設定します。 |
...
[FbxLoadOptions](../../com.aspose.threed/fbxloadoptions) のコンストラクタ

**Parameters:**
| Parameter | Type | 説明 |
| --- | --- | --- |
| format | [FileFormat](../../com.aspose.threed/fileformat) | [getFileFormat](../../com.aspose.threed/fbxloadoptions\#getFileFormat) のインスタンスで、有効な FBX フォーマットである必要があります。 |
...
互換モードを有効にするかどうかを取得します。互換モードは、Blender でエクスポートされた PBR マテリアルなどの非標準 FBX 定義のサポートを試みます。デフォルト値は false です。

**Returns:**
boolean - 互換モードを有効にするかどうか。互換モードは、Blender でエクスポートされた PBR マテリアルなどの非標準 FBX 定義のサポートを試みます。デフォルト値は false です。
...
ネイティブ プロパティ置換が [AssetInfo](../../com.aspose.threed/assetinfo) にある GlobalSettings の組み込みプロパティを保持するかどうかを取得します。GlobalSettings のすべてのプロパティが必要な場合は true に設定してください。デフォルト値は false です。

**Returns:**
boolean - ネイティブ プロパティ置換が [AssetInfo](../../com.aspose.threed/assetinfo) にある GlobalSettings の組み込みプロパティを保持するかどうか。GlobalSettings のすべてのプロパティが必要な場合は true に設定してください。デフォルト値は false です。
...
互換モードを有効にするかどうかを設定します。互換モードは、Blender でエクスポートされた PBR マテリアルなどの非標準 FBX 定義のサポートを試みます。デフォルト値は false です。
...
ネイティブ プロパティ置換が [AssetInfo](../../com.aspose.threed/assetinfo) にある GlobalSettings の組み込みプロパティを保持するかどうかを設定します。GlobalSettings のすべてのプロパティが必要な場合は true に設定してください。デフォルト値は false です。

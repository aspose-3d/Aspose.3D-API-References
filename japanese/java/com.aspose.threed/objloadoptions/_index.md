...
description: Wavefront OBJ のロードオプション
type: docs
weight: 115
url: /ja/java/com.aspose.threed/objloadoptions/
---
...
| Constructor | 説明 |
| --- | --- |
| [ObjLoadOptions()](#ObjLoadOptions--) | [ObjLoadOptions](../../com.aspose.threed/objloadoptions) のコンストラクタ |
## Methods
...
| [getClass()](#getClass--) |  |
| [getEnableMaterials()](#getEnableMaterials--) | 各オブジェクトのマテリアルをインポートするかどうかを取得します |
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | インポート中に制御点/法線の座標系を反転するかどうかを取得します |
| [getLookupPaths()](#getLookupPaths--) | OBJ のような一部のファイルは外部ファイルに依存しており、検索パスにより Aspose.3D が外部ファイルを読み込むために探すことができます。 |
| [getNormalizeNormal()](#getNormalizeNormal--) | ロード中に法線ベクトルを正規化するかどうかを取得します |
| [getScale()](#getScale--) | x/y/z 軸のスケール、デフォルト値は 1.0 です |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEnableMaterials(boolean value)](#setEnableMaterials-boolean-) | 各オブジェクトのマテリアルをインポートするかどうかを設定します |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | インポート中に制御点/法線の座標系を反転するかどうかを設定します |
...
| [setNormalizeNormal(boolean value)](#setNormalizeNormal-boolean-) | ロード中に法線ベクトルを正規化するかどうかを設定します |
| [setScale(double value)](#setScale-double-) | x/y/z 軸のスケール、デフォルト値は 1.0 です |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[ObjLoadOptions](../../com.aspose.threed/objloadoptions) のコンストラクタ
...
各オブジェクトのマテリアルをインポートするかどうかを取得します

**Returns:**
boolean - 各オブジェクトのマテリアルをインポートするかどうか
...
インポート中に制御点/法線の座標系を反転するかどうかを取得します

**Returns:**
boolean - インポート中に制御点/法線の座標系を反転するかどうか
...
ロード中に法線ベクトルを正規化するかどうかを取得します。デフォルト値は true です。

**Returns:**
boolean - ロード中に法線ベクトルを正規化するかどうか。デフォルト値は true です。
### getScale() {#getScale--}
```
...
x/y/z 軸のスケール、デフォルト値は 1.0 です

**Returns:**
double - x/y/z 軸のスケール、デフォルト値は 1.0
### hashCode() {#hashCode--}
```
...
各オブジェクトのマテリアルをインポートするかどうかを設定します
...
インポート中に制御点/法線の座標系を反転するかどうかを設定します
...
ロード中に法線ベクトルを正規化するかどうかを設定します。デフォルト値は true です。

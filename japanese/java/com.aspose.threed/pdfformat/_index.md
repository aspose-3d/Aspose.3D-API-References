...
description: "Adobe の Portable Document Format の例         以下のコードは、3D PDF ファイルからサポートされているすべての 3D シーンを抽出し、obj 形式で書き出す方法を示しています。"
type: docs
weight: 123
url: /ja/java/com.aspose.threed/pdfformat/
---
...
Adobe の Portable Document Format **Example:** 以下のコードは、3D PDF ファイルからサポートされているすべての 3D シーンを抽出し、obj 形式で書き出す方法を示しています。
...
| [extract(Stream stream)](#extract-com.aspose.threed.Stream-) | PDF ストリームから生の 3D コンテンツを抽出します。 |
| [extract(Stream stream, byte[] password)](#extract-com.aspose.threed.Stream-byte---) | PDF ストリームから生の 3D コンテンツを抽出します。 |
| [extract(String fileName)](#extract-java.lang.String-) | PDF ファイルから生の 3D コンテンツを抽出します。 |
| [extract(String fileName, byte[] password)](#extract-java.lang.String-byte---) | PDF ファイルから生の 3D コンテンツを抽出します。 |
| [extractScene(Stream stream)](#extractScene-com.aspose.threed.Stream-) | PDF ストリームから生の 3D コンテンツを抽出します。 |
| [extractScene(Stream stream, byte[] password)](#extractScene-com.aspose.threed.Stream-byte---) | PDF ストリームから生の 3D コンテンツを抽出します。 |
| [extractScene(String fileName)](#extractScene-java.lang.String-) | PDF ファイルから 3D シーンを抽出します。 |
| [extractScene(String fileName, byte[] password)](#extractScene-java.lang.String-byte---) | PDF ファイルから 3D シーンを抽出します。 |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | 入力 PDF ファイルのストリーム |

**Returns:**
java.util.ArrayList<byte[]> - バイト単位のすべての 3D コンテンツのリスト（Aspose.3D がサポートしていない形式を含む）。**Example:** 以下のコードは、3D PDF ファイルからすべての生 3D コンテンツを抽出し、ファイルに書き出す方法を示しています。
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| fileName | java.lang.String | 入力 PDF ファイルのファイル名 |
...
**Returns:**
java.util.ArrayList<com.aspose.threed.Scene> - Aspose.3D がサポートするデコードされた 3D シーンのリスト **Example:** 以下のコードは、3D PDF ファイルからサポートされているすべての 3D シーンを抽出し、obj 形式で書き出す方法を示しています。

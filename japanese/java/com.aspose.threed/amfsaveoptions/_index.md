...
type: docs
weight: 12
url: /ja/java/com.aspose.threed/amfsaveoptions/
---
...
| Constructor | 説明 |
| --- | --- |
| [AmfSaveOptions()](#AmfSaveOptions--) | [AmfSaveOptions](../../com.aspose.threed/amfsaveoptions) のコンストラクタ |
## Methods
...
| [getClass()](#getClass--) |  |
| [getEnableCompression()](#getEnableCompression--) | 最終ファイルサイズを削減するために圧縮を使用するかどうか、デフォルト値は true です |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEnableCompression(boolean value)](#setEnableCompression-boolean-) | 最終ファイルサイズを削減するために圧縮を使用するかどうか、デフォルト値は true です |
...
[AmfSaveOptions](../../com.aspose.threed/amfsaveoptions) のコンストラクタ
...
最終ファイルサイズを削減するために圧縮を使用するかどうか、デフォルト値は true です

**Returns:**
boolean - 最終ファイルサイズを削減するために圧縮を使用するかどうか、デフォルト値は true です

...
type: docs
weight: 282
url: /ja/java/com.aspose.threed/indexdatatype/
---
...
[IIndexBuffer](../../com.aspose.threed/iindexbuffer) の要素のデータ型
## フィールド

| フィールド | 説明 |
| --- | --- |
| [INT16](#INT16) | インデックスバッファの要素は 16 ビット整数です |
| [INT32](#INT32) | インデックスバッファの要素は 32 ビット整数です |
## メソッド

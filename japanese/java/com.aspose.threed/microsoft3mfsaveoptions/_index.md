...
description: Microsoft 3MF ファイルの保存オプション。
type: docs
weight: 105
url: /ja/java/com.aspose.threed/microsoft3mfsaveoptions/
---
...
Microsoft 3MF ファイルの保存オプション。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [Microsoft3MFSaveOptions()](#Microsoft3MFSaveOptions--) | [Microsoft3MFSaveOptions](../../com.aspose.threed/microsoft3mfsaveoptions) を構築する |
## Methods

| Method | 説明 |
| --- | --- |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getBuildAll()](#getBuildAll--) | シーン内のすべてのジオメトリを印刷可能にマークします。 |
| [getClass()](#getClass--) |  |
| [getEnableCompression()](#getEnableCompression--) | 出力 3mf ファイルで圧縮を有効にします。デフォルト値は true です。 |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBuildAll(boolean value)](#setBuildAll-boolean-) | シーン内のすべてのジオメトリを印刷可能にマークします。 |
| [setEnableCompression(boolean value)](#setEnableCompression-boolean-) | 出力 3mf ファイルで圧縮を有効にします。デフォルト値は true です。 |
...
[Microsoft3MFSaveOptions](../../com.aspose.threed/microsoft3mfsaveoptions) を構築する
...
シーン内のすべてのジオメトリを印刷可能にマークします。あるいは、[Microsoft3MFFormat](../../com.aspose.threed/microsoft3mfformat) を使用してノードを手動で印刷可能にマークすることもできます。デフォルト値は true です。

**Returns:**
boolean - シーン内のすべてのジオメトリを印刷可能にマークします。あるいは、[Microsoft3MFFormat](../../com.aspose.threed/microsoft3mfformat) を使用してノードを手動で印刷可能にマークすることもできます。デフォルト値は true です。
### getClass() {#getClass--}
```
...
出力 3mf ファイルで圧縮を有効にします。デフォルト値は true です。

**Returns:**
boolean - 出力 3mf ファイルで圧縮を有効にします。デフォルト値は true です。

...
description: ファイルコンテンツタイプ
type: docs
weight: 279
url: /ja/java/com.aspose.threed/filecontenttype/
---
...
| フィールド | 説明 |
| --- | --- |
| [ASCII](#ASCII) | ASCII 形式タイプ、例: ASCII FBX、ASCII STL |
| [BINARY](#BINARY) | バイナリ形式タイプ、例: バイナリ FBX、バイナリ STL |
## Methods
...
ASCII 形式タイプ、例: ASCII FBX、ASCII STL

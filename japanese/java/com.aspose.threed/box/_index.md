...
type: docs
weight: 26
url: /ja/java/com.aspose.threed/box/
---
...
| Constructor | 説明 |
| --- | --- |
| [Box()](#Box--) | 新しい [Box](../../com.aspose.threed/box) クラスのインスタンスを初期化します。 |
| [Box(double length, double width, double height)](#Box-double-double-double-) | 新しい [Box](../../com.aspose.threed/box) クラスのインスタンスを初期化します。 |
| [Box(String name, double length, double width, double height, int lengthSegments, int widthSegments, int heightSegments)](#Box-java.lang.String-double-double-double-int-int-int-) | 新しい [Box](../../com.aspose.threed/box) クラスのインスタンスを初期化します。 |
## Methods
...
| [getHeight()](#getHeight--) | y 軸に沿って配置されたボックスの高さを取得します。 |
| [getHeightSegments()](#getHeightSegments--) | 高さセグメントを取得または設定します。 |
| [getLength()](#getLength--) | z 軸に沿って配置されたボックスの長さを取得します。 |
...
| [getWidth()](#getWidth--) | x 軸に沿って配置されたボックスの幅を取得します。 |
...
| [setHeight(double value)](#setHeight-double-) | y軸に沿って配置されたボックスの高さを設定します。 |
| [setHeightSegments(int value)](#setHeightSegments-int-) | 高さセグメントを取得または設定します。 |
| [setLength(double value)](#setLength-double-) | z軸に沿って配置されたボックスの長さを設定します。 |
...
| [setWidth(double value)](#setWidth-double-) | x軸に沿って配置されたボックスの幅を設定します。 |
...
新しい [Box](../../com.aspose.threed/box) クラスのインスタンスを初期化します。
...
| Parameter | Type | 説明 |
| --- | --- | --- |
| 長さ | double | z軸に沿って配置されたボックスの長さ。 |
| 幅 | double | x軸に沿って配置されたボックスの幅。 |
| 高さ | double | y軸に沿って配置されたボックスの高さ。 |
...
y 軸に沿って配置されたボックスの高さを取得します。

**Returns:**
double - y軸に沿って配置されたボックスの高さ。
...
z 軸に沿って配置されたボックスの長さを取得します。

**Returns:**
double - z軸に沿って配置されたボックスの長さ。
...
x 軸に沿って配置されたボックスの幅を取得します。

**Returns:**
double - x軸に沿って配置されたボックスの幅。

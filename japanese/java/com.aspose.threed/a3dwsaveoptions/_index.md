...
type: docs
weight: 11
url: /ja/java/com.aspose.threed/a3dwsaveoptions/
---
...
| Constructor | 説明 |
| --- | --- |
| [A3dwSaveOptions()](#A3dwSaveOptions--) | [A3dwSaveOptions](../../com.aspose.threed/a3dwsaveoptions) のコンストラクタ |
## Methods
...
| [getExportMetaData()](#getExportMetaData--) | Scene/Node に関連付けられたメタデータをクライアントにエクスポートします。デフォルト値は true です |
...
| [getMetaDataPrefix()](#getMetaDataPrefix--) | このプロパティが null でない場合、接頭辞で始まる Scene/Node のプロパティのみがエクスポートされ、接頭辞は削除されます。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEncoding(Charset value)](#setEncoding-java.nio.charset.Charset-) | テキストベースのファイルのデフォルトエンコーディングを設定します。 |
| [setExportMetaData(boolean value)](#setExportMetaData-boolean-) | Scene/Node に関連付けられたメタデータをクライアントにエクスポートします。デフォルト値は true です |
...
| [setMetaDataPrefix(String value)](#setMetaDataPrefix-java.lang.String-) | このプロパティが null でない場合、接頭辞で始まる Scene/Node のプロパティのみがエクスポートされ、接頭辞は削除されます。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[A3dwSaveOptions](../../com.aspose.threed/a3dwsaveoptions) のコンストラクタ
...
Scene/Node に関連付けられたメタデータをクライアントにエクスポートします。デフォルト値は true です

**Returns:**
boolean - Scene/Node に関連付けられたメタデータをクライアントにエクスポートします。デフォルト値は true です
...
このプロパティが null でない場合、接頭辞で始まる Scene/Node のプロパティのみがエクスポートされ、接頭辞は削除されます。

**Returns:**
java.lang.String - このプロパティが null でない場合、接頭辞で始まる Scene/Node のプロパティのみがエクスポートされ、接頭辞は削除されます。
### hashCode() {#hashCode--}
```

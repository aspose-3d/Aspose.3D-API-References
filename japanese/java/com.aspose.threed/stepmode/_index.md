...
description: 補間ステップモード。
type: docs
weight: 304
url: /ja/java/com.aspose.threed/stepmode/
---
...
| フィールド | 説明 |
| --- | --- |
| [NEXT_VALUE](#NEXT-VALUE) | セグメントの曲線値は常に次のキーフレームの値を使用します |
| [PREVIOUS_VALUE](#PREVIOUS-VALUE) | セグメントの曲線値は常に前のキーフレームの値を使用します |
## Methods

...
type: docs
weight: 129
url: /ja/java/com.aspose.threed/plyformat/
---
...
| [decode(Stream stream)](#decode-com.aspose.threed.Stream-) | 指定されたストリームから点群またはメッシュをデコードします。 |
| [decode(Stream stream, PlyLoadOptions opt)](#decode-com.aspose.threed.Stream-com.aspose.threed.PlyLoadOptions-) | 指定されたストリームから点群またはメッシュをデコードします。 |
| [decode(String fileName)](#decode-java.lang.String-) | 指定されたストリームから点群またはメッシュをデコードします。 |
| [decode(String fileName, PlyLoadOptions opt)](#decode-java.lang.String-com.aspose.threed.PlyLoadOptions-) | 指定されたストリームから点群またはメッシュをデコードします。 |
...
| [encode(Entity entity, Stream stream)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-) | エンティティをエンコードし、結果をストリームに保存します。 |
| [encode(Entity entity, Stream stream, PlySaveOptions opt)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-com.aspose.threed.PlySaveOptions-) | エンティティをエンコードし、結果をストリームに保存します。 |
| [encode(Entity entity, String fileName)](#encode-com.aspose.threed.Entity-java.lang.String-) | エンティティをエンコードし、結果を外部ファイルに保存します。 |
| [encode(Entity entity, String fileName, PlySaveOptions opt)](#encode-com.aspose.threed.Entity-java.lang.String-com.aspose.threed.PlySaveOptions-) | エンティティをエンコードし、結果を外部ファイルに保存します。 |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | 入力ストリーム |
...
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | 入力ストリーム |
| opt | [PlyLoadOptions](../../com.aspose.threed/plyloadoptions) | PLY フォーマットのロードオプション |
...
|  | stream | [Stream](../../com.aspose.threed/stream) | 書き込むストリーム（このメソッドはこのストリームを閉じません） **Example:** 次のコードは、メッシュを PLY ファイルにエンコードする方法を示しています: |

...
description: "このシェイプは、Maya のクラスター デフォーマーに似た、制御点の集合に対する変形を記述します。"
type: docs
weight: 171
url: /ja/java/com.aspose.threed/shape/
---
...
このシェイプは、Maya のクラスター デフォーマーに似た、制御点の集合に対する変形を記述します。たとえば、作成したジオメトリにシェイプを追加できます。シェイプとジオメトリは同じトポロジ情報を持ちますが、制御点の位置が異なります。影響度を変えることで、ジオメトリは変形効果を実行します。
## コンストラクタ

| コンストラクタ | 説明 |
| --- | --- |
| [Shape()](#Shape--) | 新しい [Shape](../../com.aspose.threed/shape) クラスのインスタンスを初期化します。 |
| [Shape(String name)](#Shape-java.lang.String-) | 新しい [Shape](../../com.aspose.threed/shape) クラスのインスタンスを初期化します。 |
## メソッド
...
| [fromControlPoints(Vector3[] controlPoints)](#fromControlPoints-com.aspose.threed.Vector3...-) | 指定された制御点とデフォルトインデックスでシェイプを作成します。 |
...
| [getIndices()](#getIndices--) | インデックスを取得します。 |
...
新しい [Shape](../../com.aspose.threed/shape) クラスのインスタンスを初期化します。
...
指定された制御点とデフォルトインデックスでシェイプを作成します。
...
**Returns:**
java.util.List<java.lang.Integer> - インデックスです。
### getName() {#getName--}
```

...
description: 3Dファイルで使用されるメタデータまたはカスタムオブジェクトは、このクラスによって管理されます。
type: docs
weight: 39
url: /ja/java/com.aspose.threed/customobject/
---
...
| Constructor | 説明 |
| --- | --- |
| [CustomObject()](#CustomObject--) | [CustomObject](../../com.aspose.threed/customobject) クラスの新しいインスタンスを初期化します。 |
| [CustomObject(String name)](#CustomObject-java.lang.String-) | [CustomObject](../../com.aspose.threed/customobject) クラスの新しいインスタンスを初期化します。 |
## Methods
...
[CustomObject](../../com.aspose.threed/customobject) クラスの新しいインスタンスを初期化します。

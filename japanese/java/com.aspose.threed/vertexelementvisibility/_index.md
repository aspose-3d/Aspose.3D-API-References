...
description: 指定された成分が表示されるかどうかを定義します
type: docs
weight: 225
url: /ja/java/com.aspose.threed/vertexelementvisibility/
---
...
| Constructor | 説明 |
| --- | --- |
| [VertexElementVisibility()](#VertexElementVisibility--) | 新しい [VertexElementVisibility](../../com.aspose.threed/vertexelementvisibility) クラスのインスタンスを初期化します。 |
## Methods
...
| [copyTo(VertexElementTemplate<T> target)](#copyTo-com.aspose.threed.VertexElementTemplate-T--) | 指定された要素にデータをコピーします。 |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(T[] data)](#setData-T---) | データをロードします。 |
...
新しい [VertexElementVisibility](../../com.aspose.threed/vertexelementvisibility) クラスのインスタンスを初期化します。
...
| Parameter | Type | 説明 |
| --- | --- | --- |
| target | [VertexElementTemplate](../../com.aspose.threed/vertexelementtemplate) | 対象。 |

...
description: "すべての Aspose.ThreeD オブジェクトの基底クラスで、すべてのサブクラスは動的プロパティをサポートします。"
type: docs
weight: 10
...
| コンストラクタ | 説明 |
| --- | --- |
| [A3DObject(String name)](#A3DObject-java.lang.String-) | 新しい [A3DObject](../../com.aspose.threed/a3dobject) クラスのインスタンスを初期化します。 |
| [A3DObject()](#A3DObject--) | 名前なしで新しい [A3DObject](../../com.aspose.threed/a3dobject) クラスのインスタンスを初期化します。 |
## メソッド
...
新しい [A3DObject](../../com.aspose.threed/a3dobject) クラスのインスタンスを初期化します。
...
名前なしで新しい [A3DObject](../../com.aspose.threed/a3dobject) クラスのインスタンスを初期化します。

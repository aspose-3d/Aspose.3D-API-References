...
description: パラメータで定義されたIFC互換の楕円形状。
type: docs
weight: 50
url: /ja/java/com.aspose.threed/ellipseshape/
---
...
パラメータで定義された IFC 互換の楕円形です。プロファイルの中心位置はバウンディングボックスの中心にあります。
## Constructors
...
| [getSemiAxis1()](#getSemiAxis1--) | x 軸方向に測定された楕円の第1半径を取得します。 |
| [getSemiAxis2()](#getSemiAxis2--) | y 軸方向に測定された楕円の第2半径を取得します。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setSemiAxis1(double value)](#setSemiAxis1-double-) | x 軸方向に測定された楕円の第1半径を設定します。 |
| [setSemiAxis2(double value)](#setSemiAxis2-double-) | y 軸方向に測定された楕円の第2半径を設定します。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
x 軸方向に測定された楕円の第1半径を取得します。

**Returns:**
double - x 軸方向に測定された楕円の第1半径です。
...
y 軸方向に測定された楕円の第2半径を取得します。

**Returns:**
double - y 軸方向に測定された楕円の第2半径です。
### hashCode() {#hashCode--}
```

...
メッシュは多数の n 辺ポリゴンで構成されています。 **Example:** メッシュにポリゴンを追加するには:
...
| コンストラクタ | 説明 |
| --- | --- |
| [Mesh()](#Mesh--) | 新しい [Mesh](../../com.aspose.threed/mesh) クラスのインスタンスを初期化します。 |
| [Mesh(String name)](#Mesh-java.lang.String-) | 新しい [Mesh](../../com.aspose.threed/mesh) クラスのインスタンスを初期化します。 |
## メソッド

| メソッド | 説明 |
| --- | --- |
| [<T>getDeformers2()](#-T-getDeformers2--) | 指定されたデフォーマータイプのすべてのデフォーマーを取得します |
| [addControlPoint(double x, double y, double z)](#addControlPoint-double-double-double-) | メッシュに新しい制御点を追加します。これにより効率が向上します。 |
| [addControlPoint(double x, double y, double z, double w)](#addControlPoint-double-double-double-double-) | メッシュに新しい制御点を追加します。これにより効率が向上します。 |
...
新しい [Mesh](../../com.aspose.threed/mesh) クラスのインスタンスを初期化します。
...
メッシュに新しい制御点を追加します。これにより効率が向上します。

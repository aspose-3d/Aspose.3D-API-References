...
description: ポリゴンラスタライズモード
type: docs
weight: 292
url: /ja/java/com.aspose.threed/polygonmode/
---
...
| フィールド | 説明 |
| --- | --- |
| [FILL](#FILL) | ポリゴンの内部が塗りつぶされます。 |
| [LINE](#LINE) | ポリゴンの境界エッジは線分として描画されます。 |
| [POINT](#POINT) | ポリゴンの制御点はポイントとして描画されます。 |
## Methods

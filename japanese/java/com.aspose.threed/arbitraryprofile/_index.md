...
description: このクラスを使用すると、任意の曲線から直接 2D プロファイルを構築できます。
type: docs
weight: 16
url: /ja/java/com.aspose.threed/arbitraryprofile/
---
...
| Constructor | 説明 |
| --- | --- |
| [ArbitraryProfile()](#ArbitraryProfile--) | [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) のコンストラクタ |
| [ArbitraryProfile(Curve curve)](#ArbitraryProfile-com.aspose.threed.Curve-) | [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) のコンストラクタ（初期曲線付き）。 |
## Methods
...
| [getClass()](#getClass--) |  |
| [getCurve()](#getCurve--) | プロファイルの構築に使用される Curve |
...
| [getHoles()](#getHoles--) | プロファイルの穴、曲線としても表現されます |
...
| [setCurve(Curve value)](#setCurve-com.aspose.threed.Curve-) | プロファイルの構築に使用される Curve |
...
[ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) のコンストラクタ
...
[ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) のコンストラクタ（初期曲線付き）。

**Parameters:**
| Parameter | Type | 説明 |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | プロファイルの初期曲線 |
...
プロファイルの穴、曲線としても表現されます

**Returns:**
java.util.ArrayList<com.aspose.threed.Curve> - プロファイルの穴、曲線としても表現されます
### getName() {#getName--}
```

...
description: IFC 互換の空洞長方形形状で、内側と外側の角が丸められています。
type: docs
weight: 79
url: /ja/java/com.aspose.threed/hollowrectangleshape/
---
...
| [getInnerFilletRadius()](#getInnerFilletRadius--) | 内部矩形の内側フィレット半径です。 |
...
| [getWallThickness()](#getWallThickness--) | 矩形の境界と内部の穴との間の厚さです。 |
...
| [setInnerFilletRadius(double value)](#setInnerFilletRadius-double-) | 内部矩形の内側フィレット半径です。 |
...
| [setWallThickness(double value)](#setWallThickness-double-) | 矩形の境界と内部の穴との間の厚さです。 |

...
description: パラメータで定義されたIFC互換のU字形です。
type: docs
weight: 199
url: /ja/java/com.aspose.threed/ushape/
---
...
パラメータで定義されたIFC互換のU字形です。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [UShape()](#UShape--) | [UShape](../../com.aspose.threed/ushape) のコンストラクタ |
## Methods
...
| [getEdgeRadius()](#getEdgeRadius--) | フランジのエッジの半径を取得します。 |
...
| [getWebThickness()](#getWebThickness--) | ウェブの厚さを取得します。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setEdgeRadius(double value)](#setEdgeRadius-double-) | フランジのエッジの半径を設定します。 |
...
| [setWebThickness(double value)](#setWebThickness-double-) | ウェブの厚さを設定します。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[UShape](../../com.aspose.threed/ushape) のコンストラクタ

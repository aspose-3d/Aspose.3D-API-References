...
| コンストラクタ | 説明 |
| --- | --- |
| [BoundingBox(Vector3 minimum, Vector3 maximum)](#BoundingBox-com.aspose.threed.Vector3-com.aspose.threed.Vector3-) | 指定された最小コーナーと最大コーナーで有限バウンディングボックスを初期化する |
| [BoundingBox(double minX, double minY, double minZ, double maxX, double maxY, double maxZ)](#BoundingBox-double-double-double-double-double-double-) | 指定された最小コーナーと最大コーナーで有限バウンディングボックスを初期化する |
...
| [getInfinite()](#getInfinite--) | 無限バウンディングボックス |
| [getMaximum()](#getMaximum--) | バウンディングボックスの最大コーナー |
| [getMinimum()](#getMinimum--) | バウンディングボックスの最小コーナー |
| [getNull()](#getNull--) | ヌルバウンディングボックス |
| [getSize()](#getSize--) | バウンディングボックスのサイズ |
| [hashCode()](#hashCode--) | このインスタンスのハッシュコードを返す |
| [merge(BoundingBox bb)](#merge-com.aspose.threed.BoundingBox-) | 新しいボックスを現在のバウンディングボックスにマージします。 |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| minimum | [Vector3](../../com.aspose.threed/vector3) | 最小コーナー |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| bb | [BoundingBox](../../com.aspose.threed/boundingbox) | マージするバウンディングボックス |

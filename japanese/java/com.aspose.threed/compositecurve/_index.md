...
description: A はいくつかの曲線セグメントで構成されています。
type: docs
weight: 34
url: /ja/java/com.aspose.threed/compositecurve/
---
...
A [CompositeCurve](../../com.aspose.threed/compositecurve) はいくつかの曲線セグメントで構成されています。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [CompositeCurve()](#CompositeCurve--) | [CompositeCurve](../../com.aspose.threed/compositecurve) のコンストラクタ |
## Methods

| Method | 説明 |
| --- | --- |
| [addSegment(Curve curve)](#addSegment-com.aspose.threed.Curve-) | 現在の曲線に新しいセグメントを追加します。 |
| [addSegment(Curve curve, boolean sameDirection)](#addSegment-com.aspose.threed.Curve-boolean-) | 現在の曲線に新しいセグメントを追加します。 |
...
| [getSegments()](#getSegments--) | 曲線のセグメント。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
[CompositeCurve](../../com.aspose.threed/compositecurve) のコンストラクタ
...
現在の曲線に新しいセグメントを追加します。

**Parameters:**
| Parameter | Type | 説明 |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | 追加する曲線 |
...
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | 追加する曲線 |
| sameDirection | boolean | 現在の曲線と同じ方向。 |
...
**Returns:**
java.util.ArrayList<com.aspose.threed.CompositeCurve.Segment> - 曲線のセグメント。
### hashCode() {#hashCode--}
```

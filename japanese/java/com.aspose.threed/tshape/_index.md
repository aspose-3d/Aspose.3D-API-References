...
description: パラメータで定義されたIFC互換のT字形です。
type: docs
weight: 182
url: /ja/java/com.aspose.threed/tshape/
---
...
パラメータで定義されたIFC互換のT字形です。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [TShape()](#TShape--) | [TShape](../../com.aspose.threed/tshape) のコンストラクタ |
## Methods
...
| [getClass()](#getClass--) |  |
| [getDepth()](#getDepth--) | ウェブの長さを取得します。 |
...
| [getFilletRadius()](#getFilletRadius--) | ウェブとフランジの間のフィレット半径を取得します。 |
| [getFlangeEdgeRadius()](#getFlangeEdgeRadius--) | フランジエッジの半径を取得します。 |
| [getFlangeThickness()](#getFlangeThickness--) | フランジの壁厚さを取得します。 |
| [getFlangeWidth()](#getFlangeWidth--) | フランジの長さを取得します。 |
...
| [getWebEdgeRadius()](#getWebEdgeRadius--) | ウェブエッジの半径を取得します。 |
| [getWebThickness()](#getWebThickness--) | ウェブの壁厚さを取得します。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setDepth(double value)](#setDepth-double-) | ウェブの長さを設定します。 |
| [setExcluded(boolean value)](#setExcluded-boolean-) | エクスポート時にこのエンティティを除外するかどうかを設定します。 |
| [setFilletRadius(double value)](#setFilletRadius-double-) | ウェブとフランジの間のフィレット半径を設定します。 |
| [setFlangeEdgeRadius(double value)](#setFlangeEdgeRadius-double-) | フランジエッジの半径を設定します。 |
| [setFlangeThickness(double value)](#setFlangeThickness-double-) | フランジの壁厚さを設定します。 |
| [setFlangeWidth(double value)](#setFlangeWidth-double-) | フランジの長さを設定します。 |
...
| [setWebEdgeRadius(double value)](#setWebEdgeRadius-double-) | ウェブエッジの半径を設定します。 |
| [setWebThickness(double value)](#setWebThickness-double-) | ウェブの壁厚さを設定します。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[TShape](../../com.aspose.threed/tshape) のコンストラクタ
...
ウェブとフランジの間のフィレット半径を取得します。

**Returns:**
double - ウェブとフランジの間のフィレット半径。

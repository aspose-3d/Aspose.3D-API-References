...
description: すべての具体的なテクスチャの基底クラスです。
type: docs
weight: 185
url: /ja/java/com.aspose.threed/texturebase/
---
...
| Constructor | 説明 |
| --- | --- |
| [TextureBase(String name)](#TextureBase-java.lang.String-) | 新しい [TextureBase](../../com.aspose.threed/texturebase) クラスのインスタンスを初期化します。 |
## Methods
...
新しい [TextureBase](../../com.aspose.threed/texturebase) クラスのインスタンスを初期化します。

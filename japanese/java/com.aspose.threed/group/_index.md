...
description: A は . の論理関係を表します。
type: docs
weight: 75
url: /ja/java/com.aspose.threed/group/
---
...
A [Group](../../com.aspose.threed/group) は [Node](../../com.aspose.threed/node) の論理関係を表します。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [Group(String name)](#Group-java.lang.String-) | 新しい [Group](../../com.aspose.threed/group) のインスタンスを作成する |
| [Group()](#Group--) | 新しい [Group](../../com.aspose.threed/group) のインスタンスを作成する |
## Methods
...
| [getClass()](#getClass--) |  |
| [getGroups()](#getGroups--) | サブグループ |
| [getName()](#getName--) | 名前を取得します。 |
| [getNodes()](#getNodes--) | このグループのノード |
| [getParent()](#getParent--) | 現在のグループの親グループ |
...
| [toString()](#toString--) | [Group](../../com.aspose.threed/group) の文字列表現を取得します |
| [wait()](#wait--) |  |
...
新しい [Group](../../com.aspose.threed/group) のインスタンスを作成する

**Parameters:**
| Parameter | Type | 説明 |
| --- | --- | --- |
| name | java.lang.String | グループの名前 |
...
**Returns:**
java.util.List<com.aspose.threed.Group> - サブグループ
### getName() {#getName--}
```
...
**Returns:**
java.util.List<com.aspose.threed.Node> - このグループ内のノード
### getParent() {#getParent--}
```
...
[Group](../../com.aspose.threed/group) の文字列表現を取得します

**Returns:**
java.lang.String - 現在のインスタンスの文字列表現
### wait() {#wait--}
```

...
description: IFC 互換の円形プロファイルで、メッシュを構築するために使用できます。
type: docs
weight: 32
url: /ja/java/com.aspose.threed/circleshape/
---
...
IFC 互換の円形プロファイルで、[LinearExtrusion](../../com.aspose.threed/linearextrusion) を使用してメッシュを構築できます。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [CircleShape()](#CircleShape--) | デフォルト半径 (5) の [CircleShape](../../com.aspose.threed/circleshape) プロファイルを作成します。 |
| [CircleShape(double radius)](#CircleShape-double-) | 指定された半径の [CircleShape](../../com.aspose.threed/circleshape) プロファイルを作成します。 |
## Methods
...
| [getRadius()](#getRadius--) | 円の半径を取得します。 |
...
| [setRadius(double value)](#setRadius-double-) | 円の半径を設定します。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
デフォルト半径 (5) の [CircleShape](../../com.aspose.threed/circleshape) プロファイルを作成します。
...
指定された半径の [CircleShape](../../com.aspose.threed/circleshape) プロファイルを作成します。

...
description: 指定されたコンポーネントの法線ベクトルを定義します
type: docs
weight: 830
url: /ja/net/aspose.threed.entities/vertexelementnormal/
---
## VertexElementNormal class

指定されたコンポーネントの法線ベクトルを定義します。
...
| 名前 | 説明 |
| --- | --- |
| [VertexElementNormal](vertexelementnormal/)() | の新しいインスタンスを初期化します`VertexElementNormal`class. |

...
description: コンクリートを定義するためのヘルパー クラスVertexElement./vertexelement/実装.
type: docs
weight: 780
url: /ja/net/aspose.threed.entities/vertexelementdoublestemplate/
---
## VertexElementDoublesTemplate class

コンクリートを定義するためのヘルパー クラス[`VertexElement`](../vertexelement/)実装.

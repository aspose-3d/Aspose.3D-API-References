...
description: 指定されたコンポーネントのスペキュラ カラーを定義します
type: docs
weight: 860
url: /ja/net/aspose.threed.entities/vertexelementspecular/
---
## VertexElementSpecular class

指定されたコンポーネントのスペキュラ カラーを定義します。
...
| 名前 | 説明 |
| --- | --- |
| [VertexElementSpecular](vertexelementspecular/)() | の新しいインスタンスを初期化します`VertexElementSpecular`class. |

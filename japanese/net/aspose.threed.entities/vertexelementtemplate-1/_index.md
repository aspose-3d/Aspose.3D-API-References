...
type: docs
weight: 880
url: /ja/net/aspose.threed.entities/vertexelementtemplate-1/
---
...
| 名前 | 説明 |
| --- | --- |
| [Data](../../aspose.threed.entities/vertexelementtemplate-1/data/) { get; } | 頂点データを取得 |
...
| 名前 | 説明 |
| --- | --- |
| override [Clear](../../aspose.threed.entities/vertexelementtemplate-1/clear/)() | 直接およびインデックス配列からすべての要素を削除します。 |

...
description: ベース カーブの両端をトリムした境界付きカーブ
type: docs
weight: 750
url: /ja/net/aspose.threed.entities/trimmedcurve/
---
## TrimmedCurve class

ベース カーブの両端をトリムした境界付きカーブ。
...
| 名前 | 説明 |
| --- | --- |
| [TrimmedCurve](trimmedcurve/)() | のコンストラクター`TrimmedCurve` |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [BasisCurve](../../aspose.threed.entities/trimmedcurve/basiscurve/) { get; set; } | トリミングする基準曲線。 |
...
| [First](../../aspose.threed.entities/trimmedcurve/first/) { get; set; } | トリムする最初の終点。デカルト ポイントまたは実数パラメーターを指定できます。 |
...
| [SameDirection](../../aspose.threed.entities/trimmedcurve/samedirection/) { get; set; } | トリミングされた結果がベース カーブの同じ方向を使用するかどうかを取得または設定します。 |
| [Scene](../../aspose.threed/sceneobject/scene/) { get; } | このオブジェクトが属するシーンを取得します |
| [Second](../../aspose.threed.entities/trimmedcurve/second/) { get; set; } | トリムする 2 番目の終点。デカルト ポイントまたは実数パラメーターを指定できます。 |

...
description: 指定したコンポーネントのエッジの折り目を定義します
type: docs
weight: 790
url: /ja/net/aspose.threed.entities/vertexelementedgecrease/
---
## VertexElementEdgeCrease class

指定したコンポーネントのエッジの折り目を定義します
...
| 名前 | 説明 |
| --- | --- |
| [VertexElementEdgeCrease](vertexelementedgecrease/)() | の新しいインスタンスを初期化します`VertexElementEdgeCrease`class. |

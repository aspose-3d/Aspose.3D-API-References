...
description: 指定されたポリゴンが hole かどうかを定義します
type: docs
weight: 800
url: /ja/net/aspose.threed.entities/vertexelementhole/
---
## VertexElementHole class

指定されたポリゴンが hole かどうかを定義します
...
| 名前 | 説明 |
| --- | --- |
| [VertexElementHole](vertexelementhole/)() | の新しいインスタンスを初期化します`VertexElementHole`class. |

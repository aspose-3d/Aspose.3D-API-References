...
description: アンEllipse./ellipse/楕円の形状を形成する点のセットを定義します.
type: docs
weight: 330
url: /ja/net/aspose.threed.entities/ellipse/
---
## Ellipse class

アン`Ellipse`楕円の形状を形成する点のセットを定義します.
...
| 名前 | 説明 |
| --- | --- |
| [Ellipse](ellipse/#constructor)() | のコンストラクター`Ellipse` |
| [Ellipse](ellipse/#constructor_1)(double, double) | のコンストラクター`Ellipse` |
...
| [SemiAxis1](../../aspose.threed.entities/ellipse/semiaxis1/) { get; set; } | X 軸の半径 |
| [SemiAxis2](../../aspose.threed.entities/ellipse/semiaxis2/) { get; set; } | Y 軸上の半径 |

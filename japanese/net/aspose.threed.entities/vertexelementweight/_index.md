...
description: 指定されたコンポーネントのブレンド重量を定義します
type: docs
weight: 960
url: /ja/net/aspose.threed.entities/vertexelementweight/
---
## VertexElementWeight class

指定されたコンポーネントのブレンド重量を定義します。
...
| 名前 | 説明 |
| --- | --- |
| [VertexElementWeight](vertexelementweight/)() | の新しいインスタンスを初期化します`VertexElementWeight`class. |

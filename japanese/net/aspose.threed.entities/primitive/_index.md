...
description: すべてのプリミティブの基本クラス
type: docs
weight: 570
url: /ja/net/aspose.threed.entities/primitive/
---
## Primitive class
...
| 名前 | 説明 |
| --- | --- |
| [Primitive](primitive/)(string) | の新しいインスタンスを初期化します`Primitive`class. |
...
| abstract [ToMesh](../../aspose.threed.entities/primitive/tomesh/)() | 現在のオブジェクトを mesh に変換します |

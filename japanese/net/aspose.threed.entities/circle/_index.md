...
description: ACircle./circle/曲線は円形状のエッジにある点のセットで構成されます.
type: docs
weight: 260
url: /ja/net/aspose.threed.entities/circle/
---
## Circle class

A`Circle`曲線は、円形状のエッジにある点のセットで構成されます.
...
| 名前 | 説明 |
| --- | --- |
| [Circle](circle/#constructor)() | のコンストラクター`Circle` |
| [Circle](circle/#constructor_1)(double) | のコンストラクター`Circle` |
...
| [Radius](../../aspose.threed.entities/circle/radius/) { get; set; } | 円曲線の半径、デフォルト値は 10 |

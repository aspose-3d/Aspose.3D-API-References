...
description: このクラスを使用すると任意の曲線から直接 2D プロファイルを作成できます
type: docs
weight: 1510
url: /ja/net/aspose.threed.profiles/arbitraryprofile/
---
## ArbitraryProfile class

このクラスを使用すると、任意の曲線から直接 2D プロファイルを作成できます。
...
| 名前 | 説明 |
| --- | --- |
| [ArbitraryProfile](arbitraryprofile/#constructor)() | のコンストラクター`ArbitraryProfile` |
| [ArbitraryProfile](arbitraryprofile/#constructor_1)(Curve) | のコンストラクター`ArbitraryProfile`初期曲線付き. |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [Curve](../../aspose.threed.profiles/arbitraryprofile/curve/) { get; set; } | profile の構築に使用されるカーブ |

...
description: IFC 互換のミラー プロファイル このプロファイルはy 軸を中心にベース プロファイルをミラーリングすることにより新しいプロファイルを定義します
type: docs
weight: 1590
url: /ja/net/aspose.threed.profiles/mirroredprofile/
---
## MirroredProfile class

IFC 互換のミラー プロファイル。 このプロファイルは、y 軸を中心にベース プロファイルをミラーリングすることにより、新しいプロファイルを定義します。
...
| 名前 | 説明 |
| --- | --- |
| [MirroredProfile](mirroredprofile/)(Profile) | 新しい`MirroredProfile`既存のプロファイルから. |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [BaseProfile](../../aspose.threed.profiles/mirroredprofile/baseprofile/) { get; } | ミラーリングされる基本プロファイル。 |

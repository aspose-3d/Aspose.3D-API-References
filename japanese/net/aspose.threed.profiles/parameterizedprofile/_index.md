...
description: すべてのパラメーター化されたプロファイルの基本クラス
type: docs
weight: 1600
url: /ja/net/aspose.threed.profiles/parameterizedprofile/
---
## ParameterizedProfile class

すべてのパラメーター化されたプロファイルの基本クラス。
...
| abstract [GetExtent](../../aspose.threed.profiles/parameterizedprofile/getextent/)() | x および y 次元の範囲を取得します。 |

...
description: パラメータで定義された IFC 互換の C 形状プロファイル プロファイルの中心位置は境界ボックスの中心です
type: docs
weight: 1520
url: /ja/net/aspose.threed.profiles/cshape/
---
## CShape class

パラメータで定義された IFC 互換の C 形状プロファイル。 プロファイルの中心位置は境界ボックスの中心です。
...
| 名前 | 説明 |
| --- | --- |
| [CShape](cshape/)() | のコンストラクター`CShape` |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [Depth](../../aspose.threed.profiles/cshape/depth/) { get; set; } | プロファイルの深さを取得または設定します。 |
| [Excluded](../../aspose.threed/entity/excluded/) { get; set; } | エクスポート中にこのエンティティを除外するかどうかを取得または設定します。 |
| [Girth](../../aspose.threed.profiles/cshape/girth/) { get; set; } | 胴回りの長さを取得または設定します。 |
| [InternalFilletRadius](../../aspose.threed.profiles/cshape/internalfilletradius/) { get; set; } | 内部フィレット半径を取得または設定します。 |
...
| [WallThickness](../../aspose.threed.profiles/cshape/wallthickness/) { get; set; } | 壁の厚さを取得または設定します。 |
| [Width](../../aspose.threed.profiles/cshape/width/) { get; set; } | プロファイルの幅を取得または設定します。 |
...
| override [GetExtent](../../aspose.threed.profiles/cshape/getextent/)() | x および y 次元の範囲を取得します。 |

...
description: IFC 互換の中空の長方形で内側と外側の両方の角が丸くなっています
type: docs
weight: 1570
url: /ja/net/aspose.threed.profiles/hollowrectangleshape/
---
## HollowRectangleShape class

IFC 互換の中空の長方形で、内側と外側の両方の角が丸くなっています。
...
| 名前 | 説明 |
| --- | --- |
| [HollowRectangleShape](hollowrectangleshape/)() | デフォルトのコンストラクター。 |
...
| [InnerFilletRadius](../../aspose.threed.profiles/hollowrectangleshape/innerfilletradius/) { get; set; } | 内側の長方形の内側のフィレット半径. |
...
| [RoundingRadius](../../aspose.threed.profiles/rectangleshape/roundingradius/) { get; set; } | 4 つの角すべての円弧の半径を度単位で取得または設定します。 デフォルト値は 0.0 です。 |
| [Scene](../../aspose.threed/sceneobject/scene/) { get; } | このオブジェクトが属するシーンを取得します |
| [WallThickness](../../aspose.threed.profiles/hollowrectangleshape/wallthickness/) { get; set; } | 長方形の境界と内側の穴の間の厚さ |
| [XDim](../../aspose.threed.profiles/rectangleshape/xdim/) { get; set; } | x 軸方向の長方形の範囲を取得または設定します デフォルト値は 2.0 です |
| [YDim](../../aspose.threed.profiles/rectangleshape/ydim/) { get; set; } | y 軸方向の長方形の範囲を取得または設定します デフォルト値は 2.0 です |
...
| override [GetExtent](../../aspose.threed.profiles/rectangleshape/getextent/)() | x および y 次元の範囲を取得します。 |

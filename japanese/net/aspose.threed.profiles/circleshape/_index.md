...
description: IFC 互換の円プロファイルメッシュを構築するために使用できますLinearExtrusion../aspose.threed.entities/linearextrusion/
type: docs
weight: 1530
url: /ja/net/aspose.threed.profiles/circleshape/
---
## CircleShape class

IFC 互換の円プロファイル。メッシュを構築するために使用できます。[`LinearExtrusion`](../../aspose.threed.entities/linearextrusion/)
...
| 名前 | 説明 |
| --- | --- |
| [CircleShape](circleshape/#constructor)() | を構築する`CircleShape`デフォルトの radius(5). のプロファイル |
| [CircleShape](circleshape/#constructor_1)(double) | を構築する`CircleShape`指定された半径のプロファイル. |

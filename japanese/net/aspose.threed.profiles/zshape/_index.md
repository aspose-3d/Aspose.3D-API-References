...
type: docs
weight: 1660
url: /ja/net/aspose.threed.profiles/zshape/
---
## ZShape class
...
| 名前 | 説明 |
| --- | --- |
| [ZShape](zshape/)() | のコンストラクター`ZShape` |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [Depth](../../aspose.threed.profiles/zshape/depth/) { get; set; } | ウェブの長さを取得または設定します。 |
| [EdgeRadius](../../aspose.threed.profiles/zshape/edgeradius/) { get; set; } | フランジ エッジの半径を取得または設定します。 |
| [Excluded](../../aspose.threed/entity/excluded/) { get; set; } | エクスポート中にこのエンティティを除外するかどうかを取得または設定します。 |
| [FilletRadius](../../aspose.threed.profiles/zshape/filletradius/) { get; set; } | フランジとウェブの間のフィレットの半径を取得または設定します。 |
| [FlangeThickness](../../aspose.threed.profiles/zshape/flangethickness/) { get; set; } | フランジの厚さを取得または設定します。 |
| [FlangeWidth](../../aspose.threed.profiles/zshape/flangewidth/) { get; set; } | フランジの長さを取得または設定します。 |
...
| [WebThickness](../../aspose.threed.profiles/zshape/webthickness/) { get; set; } | 壁の厚さを取得または設定します。 |
...
| override [GetExtent](../../aspose.threed.profiles/zshape/getextent/)() | x および y 次元の範囲を取得します。 |

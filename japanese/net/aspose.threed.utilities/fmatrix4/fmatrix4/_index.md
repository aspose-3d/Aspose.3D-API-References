...
description: のインスタンスを初期化しますFMatrix4aspose.threed.utilities/fmatrix4/
type: docs
weight: 10
url: /ja/net/aspose.threed.utilities/fmatrix4/fmatrix4/
---
## FMatrix4(float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float) {#constructor_2}

のインスタンスを初期化します[`FMatrix4`](../)
...
のインスタンスを初期化します[`FMatrix4`](../)から[`Matrix4`](../../matrix4/)インスタンス.

...
description: すべてのエンティティの基本クラス エンティティは次のようなノードの下にアタッチされた具体的なオブジェクトを表しますLight../aspose.threed.entities/light//Geometry../aspose.threed.entities/geometry/.
type: docs
weight: 970
url: /ja/net/aspose.threed/entity/
---
## Entity class

すべてのエンティティの基本クラス。 エンティティは、次のようなノードの下にアタッチされた具体的なオブジェクトを表します[`Light`](../../aspose.threed.entities/light/)/[`Geometry`](../../aspose.threed.entities/geometry/).
...
| 名前 | 説明 |
| --- | --- |
| [Entity](entity/)(string) | の新しいインスタンスを初期化します`Entity`class. |

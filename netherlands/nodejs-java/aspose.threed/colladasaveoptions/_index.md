...
url: /nl/nodejs-java/aspose.threed/colladasaveoptions/
---
## ColladaSaveOptions class

Opslaanopties voor collada
...
| Naam | Beschrijving |
| --- | --- |
| constructor() | Constructor van ColladaSaveOptions |
...
| Naam | Beschrijving |
| --- | --- |
| getIndented() | Geeft of stelt in of het geëxporteerde XML-document is ingesprongen. |
...
| Naam | Beschrijving |
| --- | --- |
| setIndented(value) | Geeft of stelt in of het geëxporteerde XML-document is ingesprongen. |
...
| Naam | Beschrijving |
| --- | --- |
| getTransformStyle() | Geeft of stelt de stijl van knooptransformatie in. De waarde van de eigenschap is ColladaTransformStyle integer-constante. |
...
| Naam | Beschrijving |
| --- | --- |
| setTransformStyle(value) | Geeft of stelt de stijl van knooptransformatie in. De waarde van de eigenschap is ColladaTransformStyle integer-constante. |

...
url: /nl/nodejs-java/aspose.threed/pdfloadoptions/
---
## PdfLoadOptions class

Opties voor het laden van PDF
...
| Naam | Beschrijving |
| --- | --- |
| constructor() | Constructor van PdfLoadOptions |
...
| Naam | Beschrijving |
| --- | --- |
| getPassword() | Het wachtwoord om het versleutelde PDF-bestand te ontgrendelen. |
...
| Naam | Beschrijving |
| --- | --- |
| setPassword(value) | Het wachtwoord om het versleutelde PDF-bestand te ontgrendelen. |

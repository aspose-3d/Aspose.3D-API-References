...
url: /nl/nodejs-java/aspose.threed/fontfile/
---
## FontFile class

Lettertypebestand bevat definities voor glyphs, dit wordt gebruikt om een tekstprofiel te maken.  @hideconstructor
...
| Naam | Beschrijving |
| --- | --- |
| fromFile(fileName) | Laad FontFile van bestandsnaam |

 **Parameters:**

| Naam | Type | Beschrijving |
| --- | --- | --- |
| fileName | String | Pad naar het lettertypebestand |
...
| Naam | Beschrijving |
| --- | --- |
| parse(bytes) | Parse FontFile van bytes |

 **Parameters:**

| Naam | Type | Beschrijving |
| --- | --- | --- |
| bytes | byte[] | Ruwe inhoud van OTF-lettertypebestand |

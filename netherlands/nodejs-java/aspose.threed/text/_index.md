...
url: /nl/nodejs-java/aspose.threed/text/
---
## Text class

Tekstprofiel, dit profiel beschrijft contouren met behulp van lettertype en tekst.
...
| Naam | Beschrijving |
| --- | --- |
| getContent() | Inhoud van de tekst |
...
| Naam | Beschrijving |
| --- | --- |
| setContent(value) | Inhoud van de tekst |
...
| Naam | Beschrijving |
| --- | --- |
| getFont() | Het lettertype van de tekst. |
...
| Naam | Beschrijving |
| --- | --- |
| setFont(value) | Het lettertype van de tekst. |
...
| Naam | Beschrijving |
| --- | --- |
| getFontSize() | Schaal van de lettergrootte. |
...
| Naam | Beschrijving |
| --- | --- |
| setFontSize(value) | Schaal van de lettergrootte. |

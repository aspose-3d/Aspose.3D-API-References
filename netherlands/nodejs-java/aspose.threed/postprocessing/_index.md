...
url: /nl/nodejs-java/aspose.threed/postprocessing/
---
## PostProcessing class

De post-processing-effecten  @hideconstructor
...
| Naam | Beschrijving |
| --- | --- |
| getInput() | Invoer van deze postverwerking |
...
| Naam | Beschrijving |
| --- | --- |
| setInput(value) | Invoer van deze postverwerking |

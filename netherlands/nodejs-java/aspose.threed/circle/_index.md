...
url: /nl/nodejs-java/aspose.threed/circle/
---
## Circle class

Een cirkelcurve bestaat uit een reeks punten langs de rand van de cirkelvorm.
...
| Naam | Beschrijving |
| --- | --- |
| constructor() | Constructor van Circle |
...
| Naam | Beschrijving |
| --- | --- |
| constructor_overload(radius) | Constructor van Circle |

 **Parameters:**

| Naam | Type | Beschrijving |
| --- | --- | --- |
| radius | Number | De straal van de cirkelboog. |
...
| Naam | Beschrijving |
| --- | --- |
| getRadius() | De straal van de cirkelboog, standaardwaarde is 10 |
...
| Naam | Beschrijving |
| --- | --- |
| setRadius(value) | De straal van de cirkelboog, standaardwaarde is 10 |

...
url: /nl/nodejs-java/aspose.threed/entity/
---
## Entity class

De basisklasse van alle entiteiten. Een entiteit vertegenwoordigt een concreet object dat is gekoppeld onder een knoop zoals Light/Geometry.
...
| Naam | Beschrijving |
| --- | --- |
| constructor(name) | Initialiseert een nieuw exemplaar van de Entity-klasse. |

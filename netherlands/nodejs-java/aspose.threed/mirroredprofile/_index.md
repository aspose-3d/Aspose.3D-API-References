...
url: /nl/nodejs-java/aspose.threed/mirroredprofile/
---
## MirroredProfile class

IFC-compatibel spiegelprofiel.  Dit profiel definieert een nieuw profiel door het basisprofiel te spiegelen langs de y-as.
...
| Naam | Beschrijving |
| --- | --- |
| constructor(baseProfile) | Construeer een nieuw MirroredProfile van een bestaand profiel. |

 **Parameters:**

| Naam | Type | Beschrijving |
| --- | --- | --- |
| baseProfile | Profile | Het basisprofiel dat gespiegeld moet worden. |
...
| Naam | Beschrijving |
| --- | --- |
| getBaseProfile() | Het basisprofiel dat gespiegeld moet worden. |

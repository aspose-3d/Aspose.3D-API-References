...
url: /nl/nodejs-java/aspose.threed/customobject/
---
## CustomObject class
...
| Naam | Beschrijving |
| --- | --- |
| constructor() | Initialiseert een nieuw exemplaar van de CustomObject-klasse. |
...
| Naam | Beschrijving |
| --- | --- |
| constructor_overload(name) | Initialiseert een nieuw exemplaar van de CustomObject-klasse. |

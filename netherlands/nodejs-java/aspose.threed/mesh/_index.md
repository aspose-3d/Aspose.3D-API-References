...
url: /nl/nodejs-java/aspose.threed/mesh/
---
## Mesh class

Een mesh bestaat uit vele n-zijdige polygonen.
...
| Naam | Beschrijving |
| --- | --- |
| constructor() | Initialiseert een nieuw exemplaar van de Mesh-klasse. |
...
| Naam | Beschrijving |
| --- | --- |
| constructor_overload(name) | Initialiseert een nieuw exemplaar van de Mesh-klasse. |
...
| Naam | Beschrijving |
| --- | --- |
| getEdges() | Haalt de randen van de Mesh op. Een rand is optioneel in een mesh, dus deze kan leeg zijn. |
...
| Naam | Beschrijving |
| --- | --- |
| getPolygonCount() | Haalt het aantal polygonen op. Het polygonenaantal. |
...
| Naam | Beschrijving |
| --- | --- |
| getPolygons() | Haalt de definitie van de polygonen van de mesh op |
...
| Naam | Beschrijving |
| --- | --- |
| getPolygonSize(index) | Haalt het aantal hoekpunten op van de opgegeven polygon. |
...
| Naam | Beschrijving |
| --- | --- |
| createPolygon(indices, offset, length) | Maakt een nieuwe polygon met alle hoekpunten gedefinieerd in indices. Om een polygon hoekpunt voor hoekpunt te maken, gebruik dan PolygonBuilder. |

 **Parameters:**

| Naam | Type | Beschrijving |
| --- | --- | --- |
| indices | Number[] | Array van de polygon-indexen, elk index wijst naar een controlepunt dat de polygon vormt. |
| offset | Number | De offset van de eerste polygon-index |
| length | Number | De lengte van de indexen |
...
| Naam | Beschrijving |
| --- | --- |
| createPolygon(indices) | Maakt een nieuwe polygon met alle hoekpunten gedefinieerd in indices. Om een polygon hoekpunt voor hoekpunt te maken, gebruik dan PolygonBuilder. |
...
| Naam | Beschrijving |
| --- | --- |
| createPolygon(v1, v2, v3, v4) | Maak een polygon met 4 hoekpunten (quad) |

 **Parameters:**

| Naam | Type | Beschrijving |
| --- | --- | --- |
| v1 | Number | Index van het eerste hoekpunt |
| v2 | Number | Index van het tweede hoekpunt |
| v3 | Number | Index van het derde hoekpunt |
| v4 | Number | Index van het vierde hoekpunt |
...
| Naam | Beschrijving |
| --- | --- |
| createPolygon(v1, v2, v3) | Maak een polygoon met 3 hoekpunten (driehoek) |

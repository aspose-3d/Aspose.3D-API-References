...
url: /nl/nodejs-java/aspose.threed/compositecurve/
---
## CompositeCurve class

Een CompositeCurve bestaat uit verschillende curvesegmenten.
...
| Naam | Beschrijving |
| --- | --- |
| constructor() | Constructor van CompositeCurve |
...
| Naam | Beschrijving |
| --- | --- |
| getSegments() | De segmenten van de curve. |
...
| Naam | Beschrijving |
| --- | --- |
| addSegment(curve, sameDirection) | De |

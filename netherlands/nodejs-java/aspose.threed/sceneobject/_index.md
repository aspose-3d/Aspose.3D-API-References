...
url: /nl/nodejs-java/aspose.threed/sceneobject/
---
## SceneObject class

De basisklasse van objecten die binnen een scène worden opgeslagen.
...
| Naam | Beschrijving |
| --- | --- |
| constructor(name) | Initialiseer een SceneObject met een standaardnaam |
...
| Naam | Beschrijving |
| --- | --- |
| constructor_overload() | Initialiseer een SceneObject. |

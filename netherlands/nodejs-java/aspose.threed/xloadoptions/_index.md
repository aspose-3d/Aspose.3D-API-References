...
url: /nl/nodejs-java/aspose.threed/xloadoptions/
---
## XLoadOptions class
...
| Naam | Beschrijving |
| --- | --- |
| constructor(contentType) | Constructor van XLoadOptions |
...
| Naam | Beschrijving |
| --- | --- |
| getFlipCoordinateSystem() | Draai het coördinatensysteem om, dit is standaard true. |
...
| Naam | Beschrijving |
| --- | --- |
| setFlipCoordinateSystem(value) | Draai het coördinatensysteem om, dit is standaard true. |

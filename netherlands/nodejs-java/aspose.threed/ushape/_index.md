...
url: /nl/nodejs-java/aspose.threed/ushape/
---
## UShape class
...
| Naam | Beschrijving |
| --- | --- |
| constructor() | Constructor van UShape |
...
| Naam | Beschrijving |
| --- | --- |
| getFlangeWidth() | Haalt de lengte van de flange op of stelt deze in. |
...
| Naam | Beschrijving |
| --- | --- |
| setFlangeWidth(value) | Haalt de lengte van de flange op of stelt deze in. |
...
| Naam | Beschrijving |
| --- | --- |
| getWebThickness() | Krijgt of stelt de dikte van het web in. |
...
| Naam | Beschrijving |
| --- | --- |
| setWebThickness(value) | Krijgt of stelt de dikte van het web in. |
...
| Naam | Beschrijving |
| --- | --- |
| getFlangeThickness() | Haalt de dikte van de flange op of stelt deze in. |
...
| Naam | Beschrijving |
| --- | --- |
| setFlangeThickness(value) | Haalt de dikte van de flange op of stelt deze in. |
...
| Naam | Beschrijving |
| --- | --- |
| getFilletRadius() | Haalt de radius van de afronding tussen flange en web op of stelt deze in. |
...
| Naam | Beschrijving |
| --- | --- |
| setFilletRadius(value) | Haalt de radius van de afronding tussen flange en web op of stelt deze in. |
...
| Naam | Beschrijving |
| --- | --- |
| getEdgeRadius() | Krijgt of stelt de straal van de rand in de flensrand in. |
...
| Naam | Beschrijving |
| --- | --- |
| setEdgeRadius(value) | Krijgt of stelt de straal van de rand in de flensrand in. |

...
url: /nl/nodejs-java/aspose.threed/shape/
---
## Shape class
...
| Naam | Beschrijving |
| --- | --- |
| constructor() | Initialiseert een nieuw exemplaar van de Shape-klasse. |
...
| Naam | Beschrijving |
| --- | --- |
| constructor_overload(name) | Initialiseert een nieuw exemplaar van de Shape-klasse. |
...
| Naam | Beschrijving |
| --- | --- |
| getIndices() | Haalt de indexen op. De indexen. |
...
| Naam | Beschrijving |
| --- | --- |
| fromControlPoints(controlPoints) | Maak een vorm met opgegeven controlepunten met standaardindexen. |

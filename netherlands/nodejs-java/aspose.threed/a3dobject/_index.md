...
url: /nl/nodejs-java/aspose.threed/a3dobject/
---
## A3DObject class

De basis‑klasse van alle Aspose.ThreeD‑objecten, alle subklassen zullen dynamische eigenschappen ondersteunen.
...
| Naam | Beschrijving |
| --- | --- |
| constructor(name) | Initialiseert een nieuw exemplaar van de A3DObject-klasse. |
...
| Naam | Beschrijving |
| --- | --- |
| constructor_overload() | Initialiseert een nieuw exemplaar van de A3DObject-klasse zonder naam. |

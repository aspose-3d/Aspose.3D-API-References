...
url: /nl/nodejs-java/aspose.threed/deformer/
---
## Deformer class

Basisklasse voor SkinDeformer en MorphTargetDeformer
...
| Naam | Beschrijving |
| --- | --- |
| constructor(name) | Initialiseert een nieuw exemplaar van de Deformer-klasse. |

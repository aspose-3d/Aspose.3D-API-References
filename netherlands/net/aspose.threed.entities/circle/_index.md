...
description: EENCircle./circle/ curve bestaat uit een reeks punten in de rand van de cirkelvorm.
type: docs
weight: 260
url: /nl/net/aspose.threed.entities/circle/
---
## Circle class

EEN`Circle` curve bestaat uit een reeks punten in de rand van de cirkelvorm.
...
| Naam | Beschrijving |
| --- | --- |
| [Circle](circle/#constructor)() | Constructeur van`Circle` |
| [Circle](circle/#constructor_1)(double) | Constructeur van`Circle` |
...
| [Radius](../../aspose.threed.entities/circle/radius/) { get; set; } | De straal van de cirkelcurve, standaardwaarde is 10 |

...
description: IFCcompatibel Lvormig profiel gedefinieerd door parameters.
type: docs
weight: 1580
url: /nl/net/aspose.threed.profiles/lshape/
---
## LShape class

IFC-compatibel L-vormig profiel gedefinieerd door parameters.
...
| Naam | Beschrijving |
| --- | --- |
| [LShape](lshape/)() | Constructeur van`LShape` |

## Eigenschappen

| Naam | Beschrijving |
| --- | --- |
| [Depth](../../aspose.threed.profiles/lshape/depth/) { get; set; } | Haalt of stelt de diepte van het profiel in. |
| [EdgeRadius](../../aspose.threed.profiles/lshape/edgeradius/) { get; set; } | Haalt of stelt de straal van de rand in. |
...
| [FilletRadius](../../aspose.threed.profiles/lshape/filletradius/) { get; set; } | Haalt de straal van de afronding op of stelt deze in. |
...
| [Thickness](../../aspose.threed.profiles/lshape/thickness/) { get; set; } | Haalt de dikte van de constante muur op of stelt deze in. |
| [Width](../../aspose.threed.profiles/lshape/width/) { get; set; } | Haalt of stelt de breedte van het profiel in. |
...
| override [GetExtent](../../aspose.threed.profiles/lshape/getextent/)() | Haalt het bereik op in x- en y-dimensie. |

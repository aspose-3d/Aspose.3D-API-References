...
type: docs
weight: 60
url: /nl/python-net/aspose.threed.entities/polygonmodifier/merge_mesh/
is_root: false
---
...
# Invoerbestand kan meerdere objecten bevatten
scene = Scene.from_file("input.fbx")
# voeg ze nu samen tot één mesh
merged = PolygonModifier.merge_mesh(scene)
# sla het vervolgens op in een bestand met slechts één mesh

...
type: docs
weight: 80
url: /nl/python-net/aspose.threed.entities/polygonmodifier/split_mesh/
is_root: false
---
...
#  Maak een mesh van een doos (een doos bestaat uit 6 vlakken)
box = Box().to_mesh()
...
#  En specificeer een verschillende materiaalindex voor elk vlak
mat.indices.extend([0, 1, 2, 3, 4, 5 ])
#  Splits het nu in 6 submeshes, we hebben 6 verschillende materialen gespecificeerd voor elk vlak, elk vlak wordt een submesh.
#  We gebruikten het CloneData-beleid, elk vlak krijgt dezelfde controlepuntinformatie of op controlepunten gebaseerde vertex-elementinformatie.
planes = PolygonModifier.split_mesh(box, SplitMeshPolicy.CLONE_DATA)
#  Splits het nu in 2 submeshes, de eerste mesh bevat de vlakken 0/1/2, en de tweede mesh bevat de vlakken 3/4/5.
mat.indices.clear()
mat.indices.extend([0, 0, 0, 1, 1, 1 ])
#  We gebruikten het CompactData-beleid, elk vlak krijgt zijn eigen controlepuntinformatie of op controlepunten gebaseerde vertex-elementinformatie.

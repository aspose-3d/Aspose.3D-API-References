...
description: De puntwolk bevat geen topologie-informatie, maar alleen de controlepunten en de vertex-elementen.
type: docs
weight: 132
url: /nl/java/com.aspose.threed/pointcloud/
---
...
De puntwolk bevat geen topologie-informatie, maar alleen de controlepunten en de vertex-elementen.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [PointCloud(String name)](#PointCloud-java.lang.String-) | Constructor van [PointCloud](../../com.aspose.threed/pointcloud) |
| [PointCloud()](#PointCloud--) | Constructor van [PointCloud](../../com.aspose.threed/pointcloud) |
## Methoden
...
| [fromGeometry(Geometry g)](#fromGeometry-com.aspose.threed.Geometry-) | Maak een nieuwe PointCloud‑instantie aan vanuit een geometrie‑object |
| [fromGeometry(Geometry g, int density)](#fromGeometry-com.aspose.threed.Geometry-int-) | Maak een nieuwe point cloud‑instantie aan vanuit een geometrie‑object. |
...
| [getDimension()](#getDimension--) | Als er een dimensiewaarde aanwezig is voor de point cloud, duidt dit op een georganiseerde point cloud. |
...
| [setDimension(Vector2 value)](#setDimension-com.aspose.threed.Vector2-) | Als er een dimensiewaarde aanwezig is voor de point cloud, duidt dit op een georganiseerde point cloud. |
...
Constructor van [PointCloud](../../com.aspose.threed/pointcloud)

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| naam | java.lang.String | De naam van deze entiteit |
...
Maak een nieuwe PointCloud‑instantie aan vanuit een geometrie‑object
...
Maak een nieuwe point cloud‑instantie aan vanuit een geometrie‑object. Dichtheid is het aantal punten per eenheid driehoek (Een eenheid driehoek is de driehoek met het maximale oppervlak van het mesh).

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| g | [Geometry](../../com.aspose.threed/geometry) | Mesh of andere geometrie‑instantie |
| dichtheid | int | Aantal punten per eenheid driehoek |
...
Als er een dimensiewaarde aanwezig is voor de point cloud, duidt dit op een georganiseerde point cloud. Zonder een gespecificeerde grootte wordt het beschouwd als een ongeorganiseerde point cloud. Een georganiseerde point cloud betekent dat het een beeld‑achtige structuur heeft.

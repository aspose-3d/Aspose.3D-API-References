...
description: Opslagopties voor Google Draco-bestanden
type: docs
weight: 47
url: /nl/java/com.aspose.threed/dracosaveoptions/
---
...
Opslagopties voor Google Draco-bestanden
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [DracoSaveOptions()](#DracoSaveOptions--) | Construeer een standaardconfiguratie voor het opslaan van draco-bestanden. |
## Methoden
...
| [getClass()](#getClass--) |  |
| [getColorBits()](#getColorBits--) | Quantisatietbits voor vertexkleur, standaardwaarde is 10 |
| [getCompressionLevel()](#getCompressionLevel--) | Compressieniveau, standaardwaarde is [DracoCompressionLevel.STANDARD](../../com.aspose.threed/dracocompressionlevel\#STANDARD) |
...
| [getNormalBits()](#getNormalBits--) | Quantisatietbits voor normaalvectoren, standaardwaarde is 10 |
| [getPointCloud()](#getPointCloud--) | Exporteer de scène als puntwolk, standaardwaarde is false. |
| [getPositionBits()](#getPositionBits--) | Quantisatietbits voor positie, standaardwaarde is 14 |
| [getTextureCoordinateBits()](#getTextureCoordinateBits--) | Quantisatietbits voor textuurcoördinaat, standaardwaarde is 12 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setColorBits(int value)](#setColorBits-int-) | Quantisatietbits voor vertexkleur, standaardwaarde is 10 |
| [setCompressionLevel(DracoCompressionLevel value)](#setCompressionLevel-com.aspose.threed.DracoCompressionLevel-) | Compressieniveau, standaardwaarde is [DracoCompressionLevel.STANDARD](../../com.aspose.threed/dracocompressionlevel\#STANDARD) |
...
| [setNormalBits(int value)](#setNormalBits-int-) | Quantisatietbits voor normaalvectoren, standaardwaarde is 10 |
| [setPointCloud(boolean value)](#setPointCloud-boolean-) | Exporteer de scène als puntwolk, standaardwaarde is false. |
| [setPositionBits(int value)](#setPositionBits-int-) | Quantisatietbits voor positie, standaardwaarde is 14 |
| [setTextureCoordinateBits(int value)](#setTextureCoordinateBits-int-) | Quantisatietbits voor textuurcoördinaat, standaardwaarde is 12 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Construeer een standaardconfiguratie voor het opslaan van draco-bestanden.
...
Quantisatietbits voor vertexkleur, standaardwaarde is 10

**Returns:**
int - Quantisatietbits voor vertexkleur, standaardwaarde is 10
...
Compressieniveau, standaardwaarde is [DracoCompressionLevel.STANDARD](../../com.aspose.threed/dracocompressionlevel\#STANDARD)
...
Quantisatietbits voor normaalvectoren, standaardwaarde is 10

**Returns:**
int - Quantisatietbits voor normaalvectoren, standaardwaarde is 10
...
Exporteer de scène als puntwolk, standaardwaarde is false.

**Returns:**
boolean - Exporteer de scène als puntwolk, standaardwaarde is false.
...
Quantisatietbits voor positie, standaardwaarde is 14

**Returns:**
int - Quantisatietbits voor positie, standaardwaarde is 14
...
Quantisatietbits voor textuurcoördinaat, standaardwaarde is 12

**Returns:**
int - Quantisatietbits voor textuurcoördinaat, standaardwaarde is 12
### hashCode() {#hashCode--}
```
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| value | [DracoCompressionLevel](../../com.aspose.threed/dracocompressionlevel) | Nieuwe waarde |

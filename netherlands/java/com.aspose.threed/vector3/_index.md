...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| rhs | [Vector3](../../com.aspose.threed/vector3) | Rechterkantwaarde. |
...
| --- | --- | --- |
| lhs | [Vector3](../../com.aspose.threed/vector3) | De linker vector |
| rhs | double | De rechter double-waarde |
...
**Returns:**
double - Het dotproduct van de twee vectoren.
...
**Returns:**
boolean - Waar als alle componenten identiek gelijk zijn.
### get(int idx) {#get-int-}
```
...
**Returns:**
double - component van de vector op index.
### getClass() {#getClass--}
```
...
**Returns:**
double - de lengte van deze vector.
...
**Returns:**
double - het kwadraat van de lengte.
### getOne() {#getOne--}
```
...
**Returns:**
int - De hashcode van de [Vector3](../../com.aspose.threed/vector3)
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| v | [Vector3](../../com.aspose.threed/vector3) | De oorsprongvector |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| lhs | [Vector3](../../com.aspose.threed/vector3) | Linkerhandwaarde. |
| rhs | [Vector3](../../com.aspose.threed/vector3) | Rechterkantwaarde. |
...
**Returns:**
boolean - Waar als twee vectoren niet gelijk zijn.
...
**Returns:**
java.lang.String - Een java.lang.String die de huidige [Vector3](../../com.aspose.threed/vector3) vertegenwoordigt.
### wait() {#wait--}
```

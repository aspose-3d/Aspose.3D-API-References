...
description: Definieert de vertexvouw voor gespecificeerde componenten
type: docs
weight: 224
url: /nl/java/com.aspose.threed/vertexelementvertexcrease/
---
...
Definieert de vertexvouw voor gespecificeerde componenten
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [VertexElementVertexCrease()](#VertexElementVertexCrease--) | Initialiseert een nieuw exemplaar van de klasse [VertexElementVertexCrease](../../com.aspose.threed/vertexelementvertexcrease). |
## Methoden
...
| [copyTo(VertexElementDoublesTemplate target)](#copyTo-com.aspose.threed.VertexElementDoublesTemplate-) | Kopieert gegevens naar het opgegeven element. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(double[] data)](#setData-double---) | Laad gegevens. |
...
### VertexElementVertexCrease() {#VertexElementVertexCrease--}
```
public VertexElementVertexCrease()
```


Initialiseert een nieuw exemplaar van de klasse [VertexElementVertexCrease](../../com.aspose.threed/vertexelementvertexcrease).
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| target | [VertexElementDoublesTemplate](../../com.aspose.threed/vertexelementdoublestemplate) | Doel. |
...
**Returns:**
java.util.List<java.lang.Double> - de vertex-gegevens

...
description: IFC-compatibele U-vorm gedefinieerd door parameters.
type: docs
weight: 199
url: /nl/java/com.aspose.threed/ushape/
---
...
| --- | --- |
| [UShape()](#UShape--) | Constructor van [UShape](../../com.aspose.threed/ushape) |
## Methoden
...
| [getClass()](#getClass--) |  |
| [getDepth()](#getDepth--) | Haalt de lengte van de web op. |
| [getEdgeRadius()](#getEdgeRadius--) | Haalt de straal van de rand in de flensrand op. |
...
| [getFilletRadius()](#getFilletRadius--) | Haalt de radius van de afronding tussen flank en web op. |
| [getFlangeThickness()](#getFlangeThickness--) | Haalt de dikte van de flank op. |
| [getFlangeWidth()](#getFlangeWidth--) | Haalt de lengte van de flank op. |
...
| [getWebThickness()](#getWebThickness--) | Haalt de dikte van de web op. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setDepth(double value)](#setDepth-double-) | Stelt de lengte van de web in. |
| [setEdgeRadius(double value)](#setEdgeRadius-double-) | Stelt de straal van de rand in de flensrand in. |
| [setExcluded(boolean value)](#setExcluded-boolean-) | Stelt in of deze entiteit moet worden uitgesloten tijdens het exporteren. |
| [setFilletRadius(double value)](#setFilletRadius-double-) | Stelt de radius van de afronding tussen flank en web in. |
| [setFlangeThickness(double value)](#setFlangeThickness-double-) | Stelt de dikte van de flank in. |
| [setFlangeWidth(double value)](#setFlangeWidth-double-) | Stelt de lengte van de flank in. |
...
| [setWebThickness(double value)](#setWebThickness-double-) | Stelt de dikte van de web in. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Constructor van [UShape](../../com.aspose.threed/ushape)
...
Haalt de lengte van de web op.

**Returns:**
double - de lengte van de web.
...
Haalt de straal van de rand in de flensrand op.

**Returns:**
double - de straal van de rand in de flensrand.
...
Haalt de radius van de afronding tussen flank en web op.

**Returns:**
double - de radius van de afronding tussen flank en web.
...
Haalt de dikte van de flank op.

**Returns:**
double - de dikte van de flank.
...
Haalt de lengte van de flank op.

**Returns:**
double - de lengte van de flank.
### getName() {#getName--}
```
...
Haalt de dikte van de web op.

**Returns:**
double - de dikte van de web.
### hashCode() {#hashCode--}
```
...
Stelt de straal van de rand in de flensrand in.
...
Stelt de radius van de afronding tussen flank en web in.
...
Stelt de dikte van de flank in.
...
Stelt de lengte van de flank in.

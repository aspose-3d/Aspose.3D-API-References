...
type: docs
weight: 176
url: /nl/java/com.aspose.threed/stlloadoptions/
---
...
| --- | --- |
| [StlLoadOptions()](#StlLoadOptions--) | Initialiseert een nieuw [StlLoadOptions](../../com.aspose.threed/stlloadoptions) exemplaar. |
| [StlLoadOptions(FileContentType contentType)](#StlLoadOptions-com.aspose.threed.FileContentType-) | Initialiseert een nieuw [StlLoadOptions](../../com.aspose.threed/stlloadoptions) exemplaar. |
## Methoden
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | Haalt op of het coördinatensysteem van controlepunten/normaal moet worden omgekeerd tijdens het importeren. |
...
| [getRecalculateNormal()](#getRecalculateNormal--) | Negeer de normale gegevens die in het STL-bestand zijn opgeslagen en bereken de normale gegevens opnieuw op basis van de vertexpositie. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | Stelt in of het coördinatensysteem van controlepunten/normaal moet worden omgekeerd tijdens het importeren. |
...
| [setRecalculateNormal(boolean value)](#setRecalculateNormal-boolean-) | Negeer de normale gegevens die in het STL-bestand zijn opgeslagen en bereken de normale gegevens opnieuw op basis van de vertexpositie. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initialiseert een nieuw [StlLoadOptions](../../com.aspose.threed/stlloadoptions) exemplaar.
...
Haalt op of het coördinatensysteem van controlepunten/normaal moet worden omgekeerd tijdens het importeren.

**Returns:**
boolean - of het coördinatensysteem van controlepunten/normaal moet worden omgekeerd tijdens het importeren.
...
Negeer de normale gegevens die in het STL-bestand zijn opgeslagen en bereken de normale gegevens opnieuw op basis van de vertexpositie. Standaardwaarde is false

**Returns:**
boolean - Negeer de normale gegevens die in het STL-bestand zijn opgeslagen en bereken de normale gegevens opnieuw op basis van de vertexpositie. Standaardwaarde is false
### hashCode() {#hashCode--}
```
...
Stelt in of het coördinatensysteem van controlepunten/normaal moet worden omgekeerd tijdens het importeren.

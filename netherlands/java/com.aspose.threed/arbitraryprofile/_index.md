...
description: Deze klasse stelt je in staat om een 2D-profiel direct uit een willekeurige curve te construeren.
type: docs
weight: 16
url: /nl/java/com.aspose.threed/arbitraryprofile/
---
...
Deze klasse stelt je in staat om een 2D-profiel direct uit een willekeurige curve te construeren.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [ArbitraryProfile()](#ArbitraryProfile--) | Constructor van [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) |
| [ArbitraryProfile(Curve curve)](#ArbitraryProfile-com.aspose.threed.Curve-) | Constructor van [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) met een initiële curve. |
## Methoden
...
| [getClass()](#getClass--) |  |
| [getCurve()](#getCurve--) | De Curve die wordt gebruikt om het profiel te construeren. |
...
| [getHoles()](#getHoles--) | Gaten van het profiel, ook weergegeven als curve. |
...
| [setCurve(Curve value)](#setCurve-com.aspose.threed.Curve-) | De Curve die wordt gebruikt om het profiel te construeren. |
...
Constructor van [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile)
...
Constructor van [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) met een initiële curve.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Initiële curve van het profiel |
...
De Curve die wordt gebruikt om het profiel te construeren.
...
Gaten van het profiel, ook weergegeven als curve.

**Returns:**
java.util.ArrayList<com.aspose.threed.Curve> - Gaten van het profiel, ook weergegeven als curve
### getName() {#getName--}
```

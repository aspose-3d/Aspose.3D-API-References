...
description: Google Draco-formaat voorbeeld         De volgende code toont hoe een Mesh te coderen en te decoderen naar/van een byte-array
type: docs
weight: 46
url: /nl/java/com.aspose.threed/dracoformat/
---
...
| [decode(byte[] data)](#decode-byte---) | Decodeer de puntwolk of mesh vanuit geheugengegevens |
| [decode(String fileName)](#decode-java.lang.String-) | Decodeer de puntwolk of mesh vanuit opgegeven bestandsnaam |
...
| [encode(Entity entity)](#encode-com.aspose.threed.Entity-) | Encodeer het object naar rauwe Draco-gegevens |
| [encode(Entity entity, DracoSaveOptions options)](#encode-com.aspose.threed.Entity-com.aspose.threed.DracoSaveOptions-) | Encodeer het object naar rauwe Draco-gegevens |
| [encode(Entity entity, Stream stream)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-) | Encodeer het object naar opgegeven stream |
| [encode(Entity entity, Stream stream, DracoSaveOptions options)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-com.aspose.threed.DracoSaveOptions-) | Encodeer het object naar opgegeven stream |
| [encode(Entity entity, String fileName)](#encode-com.aspose.threed.Entity-java.lang.String-) | Encodeer het object naar opgegeven bestand |
| [encode(Entity entity, String fileName, DracoSaveOptions options)](#encode-com.aspose.threed.Entity-java.lang.String-com.aspose.threed.DracoSaveOptions-) | Encodeer het object naar opgegeven bestand |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | Het object dat moet worden gecodeerd |

**Returns:**
byte[] - De gecodeerde draco-gegevens weergegeven in bytes **Example:** De volgende code toont hoe een Mesh te coderen en te decoderen naar/van een byte-array:
...
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | Het object dat moet worden gecodeerd |
| options | [DracoSaveOptions](../../com.aspose.threed/dracosaveoptions) | Extra opties voor het coderen van de puntwolk |
...
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | Het object dat moet worden gecodeerd |
| stream | [Stream](../../com.aspose.threed/stream) | De stream waar gecodeerde data naartoe wordt geschreven |

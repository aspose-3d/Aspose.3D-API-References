...
description: is een oppervlak vertegenwoordigd door NURBSNon-uniform rational basis spline  A  wordt gedefinieerd door twee  en .
type: docs
weight: 114
url: /nl/java/com.aspose.threed/nurbssurface/
---
...
| --- | --- |
| [NurbsSurface()](#NurbsSurface--) | Initialiseert een nieuw exemplaar van de [NurbsSurface](../../com.aspose.threed/nurbssurface) klasse. |
| [NurbsSurface(String name)](#NurbsSurface-java.lang.String-) | Initialiseert een nieuw exemplaar van de [NurbsSurface](../../com.aspose.threed/nurbssurface) klasse. |
## Methoden
...
| [getU()](#getU--) | Haalt de U-richting van het NURBS-oppervlak op |
| [getV()](#getV--) | Haalt de V-richting van het NURBS-oppervlak op |
...
| [toMesh()](#toMesh--) | Converteer het NURBS-oppervlak naar het mesh |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initialiseert een nieuw exemplaar van de [NurbsSurface](../../com.aspose.threed/nurbssurface) klasse.
...
Converteer het NURBS-oppervlak naar het mesh

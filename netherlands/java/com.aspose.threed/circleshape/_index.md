...
description: IFC‑compatibel cirkelprofiel dat kan worden gebruikt om een mesh te construeren via
type: docs
weight: 32
url: /nl/java/com.aspose.threed/circleshape/
---
...
IFC‑compatibel cirkelprofiel, dat kan worden gebruikt om een mesh te construeren via [LinearExtrusion](../../com.aspose.threed/linearextrusion)
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [CircleShape()](#CircleShape--) | Construeer een [CircleShape](../../com.aspose.threed/circleshape) profiel met standaardstraal (5). |
| [CircleShape(double radius)](#CircleShape-double-) | Construeer een [CircleShape](../../com.aspose.threed/circleshape) profiel met opgegeven straal. |
## Methoden
...
| [getRadius()](#getRadius--) | Haalt de straal van de cirkel op. |
...
| [setRadius(double value)](#setRadius-double-) | Stelt de straal van de cirkel in. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Construeer een [CircleShape](../../com.aspose.threed/circleshape) profiel met standaardstraal (5).
...
Construeer een [CircleShape](../../com.aspose.threed/circleshape) profiel met opgegeven straal.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| radius | double | Straal van de cirkel |
...
Haalt de straal van de cirkel op.

**Returns:**
double - de radius van de cirkel.
### getScene() {#getScene--}
```
...
Stelt de straal van de cirkel in.

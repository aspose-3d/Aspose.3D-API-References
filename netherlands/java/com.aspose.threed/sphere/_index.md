...
| [setHeightSegments(int value)](#setHeightSegments-int-) | Stelt de hoogte segmenten in. |
...
| [setPhiLength(double value)](#setPhiLength-double-) | Stelt de lengte van de phi in. |
| [setPhiStart(double value)](#setPhiStart-double-) | Stelt de phi start in. |
...
| [setRadius(double value)](#setRadius-double-) | Stelt de radius van de bol in. |
| [setReceiveShadows(boolean value)](#setReceiveShadows-boolean-) | Stelt in of deze geometrie schaduwen kan ontvangen. |
| [setThetaLength(double value)](#setThetaLength-double-) | Stelt de lengte van de theta in. |
| [setThetaStart(double value)](#setThetaStart-double-) | Stelt de theta start in. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| radius | double | Radius van de bol. |
...
Stelt de lengte van de theta in.

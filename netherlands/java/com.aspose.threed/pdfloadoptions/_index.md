...
description: Opties voor PDF-laden
type: docs
weight: 124
url: /nl/java/com.aspose.threed/pdfloadoptions/
---
...
Opties voor PDF-laden
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [PdfLoadOptions()](#PdfLoadOptions--) | Constructor van [PdfLoadOptions](../../com.aspose.threed/pdfloadoptions) |
## Methoden
...
| [getPassword()](#getPassword--) | Het wachtwoord om het versleutelde PDF-bestand te ontgrendelen. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setPassword(byte[] value)](#setPassword-byte---) | Het wachtwoord om het versleutelde PDF-bestand te ontgrendelen. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Constructor van [PdfLoadOptions](../../com.aspose.threed/pdfloadoptions)
...
Het wachtwoord om het versleutelde PDF-bestand te ontgrendelen.

**Returns:**
byte[] - Het wachtwoord om het versleutelde PDF-bestand te ontgrendelen.
### hashCode() {#hashCode--}
```

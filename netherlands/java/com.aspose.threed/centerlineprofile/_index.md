...
description: IFC-compatibel middellijnprofiel
type: docs
weight: 30
url: /nl/java/com.aspose.threed/centerlineprofile/
---
...
IFC-compatibel middellijnprofiel
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [CenterLineProfile(Curve curve, double thickness)](#CenterLineProfile-com.aspose.threed.Curve-double-) | Construeert een nieuw [CenterLineProfile](../../com.aspose.threed/centerlineprofile) met de opgegeven curve als middellijn. |
| [CenterLineProfile(Curve curve)](#CenterLineProfile-com.aspose.threed.Curve-) | Construeert een nieuw [CenterLineProfile](../../com.aspose.threed/centerlineprofile) met de opgegeven curve als middellijn. |
## Methoden
...
| [getClass()](#getClass--) |  |
| [getCurve()](#getCurve--) | De middellijncurve van het profiel |
...
| [getThickness()](#getThickness--) | Dikte toegepast langs de middellijn |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setCurve(Curve value)](#setCurve-com.aspose.threed.Curve-) | De middellijncurve van het profiel |
...
| [setThickness(double value)](#setThickness-double-) | Dikte toegepast langs de middellijn |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Construeert een nieuw [CenterLineProfile](../../com.aspose.threed/centerlineprofile) met de opgegeven curve als middellijn.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Middellijncurve |
| dikte | double | Dikte toegepast langs de middellijn |
...
De middellijncurve van het profiel
...
Dikte toegepast langs de middellijn

**Returns:**
double - Dikte toegepast langs de middellijn
### hashCode() {#hashCode--}
```

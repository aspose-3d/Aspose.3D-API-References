...
description: Laadopties voor het glTF-formaat
type: docs
weight: 73
url: /nl/java/com.aspose.threed/gltfloadoptions/
---
...
Laadopties voor het glTF-formaat
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [GltfLoadOptions()](#GltfLoadOptions--) | Constructor van [GltfLoadOptions](../../com.aspose.threed/gltfloadoptions) |
## Methoden
...
| [getFlipTexCoordV()](#getFlipTexCoordV--) | Draai de v(t)-coördinaat in de textuurcoördinaat van de mesh, standaardwaarde is true. |
...
| [setFlipTexCoordV(boolean value)](#setFlipTexCoordV-boolean-) | Draai de v(t)-coördinaat in de textuurcoördinaat van de mesh, standaardwaarde is true. |
...
Constructor van [GltfLoadOptions](../../com.aspose.threed/gltfloadoptions)
...
Draai de v(t)-coördinaat in de textuurcoördinaat van de mesh, standaardwaarde is true.

**Returns:**
boolean - Draai de v(t)-coördinaat in de textuurcoördinaat van de mesh, standaardwaarde is true.

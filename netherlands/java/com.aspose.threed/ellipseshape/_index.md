...
description: IFC-compatibele ellipsvorm die gedefinieerd is door parameters.
type: docs
weight: 50
url: /nl/java/com.aspose.threed/ellipseshape/
---
...
IFC-compatibele ellipsvorm die wordt gedefinieerd door parameters. De centrale positie van het profiel bevindt zich in het midden van de omvattende doos.
## Constructors
...
| [getSemiAxis1()](#getSemiAxis1--) | Haalt de eerste straal van de ellips op die gemeten wordt in de richting van de x-as. |
| [getSemiAxis2()](#getSemiAxis2--) | Haalt de tweede straal van de ellips op die gemeten wordt in de richting van de y-as. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setSemiAxis1(double value)](#setSemiAxis1-double-) | Stelt de eerste straal van de ellips in die gemeten wordt in de richting van de x-as. |
| [setSemiAxis2(double value)](#setSemiAxis2-double-) | Stelt de tweede straal van de ellips in die gemeten wordt in de richting van de y-as. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Haalt de eerste straal van de ellips op die gemeten wordt in de richting van de x-as.

**Returns:**
double - de eerste straal van de ellips die gemeten wordt in de richting van de x-as.
...
Haalt de tweede straal van de ellips op die gemeten wordt in de richting van de y-as.

**Returns:**
double - de tweede straal van de ellips die gemeten wordt in de richting van de y-as.
### hashCode() {#hashCode--}
```
...
Stelt de eerste straal van de ellips in die gemeten wordt in de richting van de x-as.
...
Stelt de tweede straal van de ellips in die gemeten wordt in de richting van de y-as.

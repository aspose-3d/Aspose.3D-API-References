...
description: Een gladmakingsgroep is een groep polygonen in een polygoonmesh die een glad oppervlak moet vormen.
type: docs
weight: 216
url: /nl/java/com.aspose.threed/vertexelementsmoothinggroup/
---
...
Een smoothing group is een groep polygonen in een polygonmesh die een glad oppervlak moet vormen. Sommige vroege 3D-modelleringssoftware, zoals 3D Studio Max voor DOS, gebruikte smoothing groups om het opslaan van normale vectoren voor elk mesh‑vertex te vermijden.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [VertexElementSmoothingGroup()](#VertexElementSmoothingGroup--) | Initialiseert een nieuw exemplaar van de [VertexElementSmoothingGroup](../../com.aspose.threed/vertexelementsmoothinggroup) klasse. |
## Methoden
...
| [copyTo(VertexElementIntsTemplate target)](#copyTo-com.aspose.threed.VertexElementIntsTemplate-) | Kopieert gegevens naar het opgegeven element. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(int[] data)](#setData-int---) | Laad gegevens. |
...
Initialiseert een nieuw exemplaar van de [VertexElementSmoothingGroup](../../com.aspose.threed/vertexelementsmoothinggroup) klasse.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| target | [VertexElementIntsTemplate](../../com.aspose.threed/vertexelementintstemplate) | Doel. |
...
**Returns:**
java.util.List<java.lang.Integer> - de vertexgegevens

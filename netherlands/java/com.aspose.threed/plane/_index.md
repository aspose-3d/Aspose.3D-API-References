...
type: docs
weight: 128
url: /nl/java/com.aspose.threed/plane/
---
...
| --- | --- |
| [Plane()](#Plane--) | Initialiseert een nieuw exemplaar van de [Plane](../../com.aspose.threed/plane) met standaardgrootte 1x1. |
| [Plane(double length, double width)](#Plane-double-double-) | Initialiseert een nieuw exemplaar van de [Plane](../../com.aspose.threed/plane). |
| [Plane(String name, double length, double width, int lengthSegments, int widthSegments)](#Plane-java.lang.String-double-double-int-int-) | Initialiseert een nieuw exemplaar van de [Plane](../../com.aspose.threed/plane). |
## Methoden
...
| [getLength()](#getLength--) | Haalt de lengte van het vlak op. |
...
| [getUp()](#getUp--) | Haalt de up vector van het vlak op, standaardwaarde is (0, 1, 0), dit beïnvloedt de generatie van het vlak |
| [getWidth()](#getWidth--) | Haalt de breedte van het vlak op. |
...
| [setLength(double value)](#setLength-double-) | Stelt de lengte van het vlak in. |
...
| [setUp(Vector3 value)](#setUp-com.aspose.threed.Vector3-) | Stelt de up vector van het vlak in, standaardwaarde is (0, 1, 0), dit beïnvloedt de generatie van het vlak |
| [setWidth(double value)](#setWidth-double-) | Stelt de breedte van het vlak in. |
...
Initialiseert een nieuw exemplaar van de [Plane](../../com.aspose.threed/plane) met standaardgrootte 1x1.
...
Initialiseert een nieuw exemplaar van de [Plane](../../com.aspose.threed/plane).

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| length | double | Lengte van het vlak. |
| breedte | double | Breedte van het vlak. |
...
Haalt de lengte van het vlak op.

**Returns:**
double - de lengte van het vlak.
...
Haalt de up vector van het vlak op, standaardwaarde is (0, 1, 0), dit beïnvloedt de generatie van het vlak
...
Haalt de breedte van het vlak op.

**Returns:**
double - de breedte van het vlak.
...
Stelt de lengte van het vlak in.
...
Stelt de up vector van het vlak in, standaardwaarde is (0, 1, 0), dit beïnvloedt de generatie van het vlak
...
Stelt de breedte van het vlak in.

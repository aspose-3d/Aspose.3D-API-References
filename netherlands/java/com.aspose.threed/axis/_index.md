...
description: De coördinaat-as.
type: docs
weight: 265
url: /nl/java/com.aspose.threed/axis/
---
...
| Veld | Beschrijving |
| --- | --- |
| [NEGATIVE_X_AXIS](#NEGATIVE-X-AXIS) | De -X-as. |
| [NEGATIVE_Y_AXIS](#NEGATIVE-Y-AXIS) | De -Y-as. |
| [NEGATIVE_Z_AXIS](#NEGATIVE-Z-AXIS) | De -Z-as. |
| [X_AXIS](#X-AXIS) | De +X-as. |
| [Y_AXIS](#Y-AXIS) | De +Y-as. |
| [Z_AXIS](#Z-AXIS) | De +Z-as. |
## Methoden

...
type: docs
weight: 196
url: /nl/java/com.aspose.threed/trimmedcurve/
---
...
| --- | --- |
| [TrimmedCurve()](#TrimmedCurve--) | Constructor van [TrimmedCurve](../../com.aspose.threed/trimmedcurve) |
## Methoden
...
| [getBasisCurve()](#getBasisCurve--) | De basiscurve die getrimd moet worden. |
...
| [getFirst()](#getFirst--) | Het eerste eindpunt om te trimmen, kan een Cartesiaans punt of een reëel parameter zijn. |
...
| [getSameDirection()](#getSameDirection--) | Bepaalt of het getrimde resultaat dezelfde richting van de basiscurve gebruikt. |
| [getScene()](#getScene--) | Haalt de scène op waartoe dit object behoort |
| [getSecond()](#getSecond--) | Het tweede eindpunt om te trimmen, kan een Cartesiaans punt of een reëel parameter zijn. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setBasisCurve(Curve value)](#setBasisCurve-com.aspose.threed.Curve-) | De basiscurve die getrimd moet worden. |
...
| [setFirst(EndPoint value)](#setFirst-com.aspose.threed.EndPoint-) | Het eerste eindpunt om te trimmen, kan een Cartesiaans punt of een reëel parameter zijn. |
...
| [setSameDirection(boolean value)](#setSameDirection-boolean-) | Stelt in of het getrimde resultaat dezelfde richting van de basiscurve gebruikt. |
| [setSecond(EndPoint value)](#setSecond-com.aspose.threed.EndPoint-) | Het tweede eindpunt om te trimmen, kan een Cartesiaans punt of een reëel parameter zijn. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Constructor van [TrimmedCurve](../../com.aspose.threed/trimmedcurve)
...
De basiscurve die getrimd moet worden.
...
Het eerste eindpunt om te trimmen, kan een Cartesiaans punt of een reëel parameter zijn.
...
Bepaalt of het getrimde resultaat dezelfde richting van de basiscurve gebruikt.

**Returns:**
boolean - of het getrimde resultaat dezelfde richting van de basiscurve gebruikt.
### getScene() {#getScene--}
```
...
Het tweede eindpunt om te trimmen, kan een Cartesiaans punt of een reëel parameter zijn.
...
Stelt in of het getrimde resultaat dezelfde richting van de basiscurve gebruikt.

...
description: Een  is een parametrisch modelleringsoppervlak vergelijkbaar met  en wordt ook gedefinieerd door twee   de  en .
type: docs
weight: 119
url: /nl/java/com.aspose.threed/patch/
---
...
Een [Patch](../../com.aspose.threed/patch) is een parametrisch modelleringsoppervlak, vergelijkbaar met [NurbsSurface](../../com.aspose.threed/nurbssurface), het wordt ook gedefinieerd door twee [PatchDirection](../../com.aspose.threed/patchdirection), de [getU](../../com.aspose.threed/patch\#getU) en [getV](../../com.aspose.threed/patch\#getV). Het verschil tussen [Patch](../../com.aspose.threed/patch) en [NurbsSurface](../../com.aspose.threed/nurbssurface) is dat de [PatchDirection](../../com.aspose.threed/patchdirection) curve een van de volgende kan zijn: [PatchDirectionType.BEZIER](../../com.aspose.threed/patchdirectiontype\#BEZIER), [PatchDirectionType.QUADRATIC\_BEZIER](../../com.aspose.threed/patchdirectiontype\#QUADRATIC-BEZIER), [PatchDirectionType.BASIS\_SPLINE](../../com.aspose.threed/patchdirectiontype\#BASIS-SPLINE), [PatchDirectionType.CARDINAL\_SPLINE](../../com.aspose.threed/patchdirectiontype\#CARDINAL-SPLINE) en [PatchDirectionType.LINEAR](../../com.aspose.threed/patchdirectiontype\#LINEAR).
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [Patch()](#Patch--) | Initialiseert een nieuw exemplaar van de [Patch](../../com.aspose.threed/patch) klasse. |
| [Patch(String name)](#Patch-java.lang.String-) | Initialiseert een nieuw exemplaar van de [Patch](../../com.aspose.threed/patch) klasse. |
## Methoden
...
| [getU()](#getU--) | Haalt de u-richting op. |
| [getV()](#getV--) | Haalt de v-richting op. |
...
Initialiseert een nieuw exemplaar van de [Patch](../../com.aspose.threed/patch) klasse.

...
description: De  wordt voornamelijk gebruikt door CAD-software om de ontwerper te helpen de transformatie van de skeletstructuur te manipuleren; het is meestal nutteloos buiten de CAD-software.
type: docs
weight: 172
url: /nl/java/com.aspose.threed/skeleton/
---
...
De [Skeleton](../../com.aspose.threed/skeleton) wordt voornamelijk gebruikt door CAD-software om de ontwerper te helpen de transformatie van de skeletstructuur te manipuleren; het is meestal nutteloos buiten de CAD-software. Om de skelet-hiërarchie als één object te laten functioneren in CAD-software, moet het bovenste [Skeleton](../../com.aspose.threed/skeleton)‑knooppunt gemarkeerd worden als het root‑knooppunt door [getType](../../com.aspose.threed/skeleton\#getType) in te stellen op [SkeletonType.SKELETON](../../com.aspose.threed/skeletontype\#SKELETON), en alle kinderen in te stellen op [SkeletonType.BONE](../../com.aspose.threed/skeletontype\#BONE)
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [Skeleton()](#Skeleton--) | Initialiseert een nieuw exemplaar van de [Skeleton](../../com.aspose.threed/skeleton) klasse. |
| [Skeleton(String name)](#Skeleton-java.lang.String-) | Initialiseert een nieuw exemplaar van de [Skeleton](../../com.aspose.threed/skeleton) klasse. |
| [Skeleton(String name, SkeletonType type)](#Skeleton-java.lang.String-com.aspose.threed.SkeletonType-) | Initialiseert een nieuw exemplaar van de [Skeleton](../../com.aspose.threed/skeleton) klasse. |
## Methoden
...
| [getSize()](#getSize--) | Haalt de grootte van het ledemaatknooppunt op die wordt gebruikt in CAD-software om de grootte van het bot weer te geven. |
| [getType()](#getType--) | Haalt het type van het skelet op. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setSize(double value)](#setSize-double-) | Stelt de grootte van het ledemaatknooppunt in die wordt gebruikt in CAD-software om de grootte van het bot weer te geven. |
| [setType(SkeletonType value)](#setType-com.aspose.threed.SkeletonType-) | Stelt het type van het skelet in. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initialiseert een nieuw exemplaar van de [Skeleton](../../com.aspose.threed/skeleton) klasse.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| naam | java.lang.String | Naam van entiteit. |
| type | [SkeletonType](../../com.aspose.threed/skeletontype) | Skelettype |
...
Haalt de grootte van het ledemaatknooppunt op die wordt gebruikt in CAD-software om de grootte van het bot weer te geven.

**Returns:**
double - de grootte van het ledemaatknooppunt die wordt gebruikt in CAD-software om de grootte van het bot weer te geven.
### getType() {#getType--}
```
...
Haalt het type van het skelet op.
...
Stelt de grootte van het ledemaatknooppunt in die wordt gebruikt in CAD-software om de grootte van het bot weer te geven.
...
Stelt het type van het skelet in.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| value | [SkeletonType](../../com.aspose.threed/skeletontype) | Nieuwe waarde |

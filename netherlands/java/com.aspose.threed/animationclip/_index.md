...
description: De animatieclip is een verzameling animaties.
type: docs
weight: 14
url: /nl/java/com.aspose.threed/animationclip/
---
...
De animatieclip is een verzameling animaties. De scène kan één of meer animatieclips hebben.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [AnimationClip()](#AnimationClip--) | Initialiseert een nieuw exemplaar van de klasse [AnimationClip](../../com.aspose.threed/animationclip). |
| [AnimationClip(String name)](#AnimationClip-java.lang.String-) | Initialiseert een nieuw exemplaar van de klasse [AnimationClip](../../com.aspose.threed/animationclip). |
## Methoden

| Methode | Beschrijving |
| --- | --- |
| [createAnimationNode(String nodeName)](#createAnimationNode-java.lang.String-) | Een verkorte functie om het animatieknooppunt op de huidige clip te maken en te registreren. |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [findProperty(String propertyName)](#findProperty-java.lang.String-) | Zoekt de eigenschap. |
| [getAnimations()](#getAnimations--) | Haalt de animaties op die in de clip zitten. |
| [getClass()](#getClass--) |  |
| [getDescription()](#getDescription--) | Haalt de beschrijving van deze animatieclip op |
...
| [getStart()](#getStart--) | Haalt de tijd in seconden op van het begin van de clip. |
| [getStop()](#getStop--) | Haalt de tijd in seconden op van het einde van de clip. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setDescription(String value)](#setDescription-java.lang.String-) | Stelt de beschrijving van deze animatieclip in |
...
| [setStart(double value)](#setStart-double-) | Stelt de tijd in seconden van het begin van de clip in. |
| [setStop(double value)](#setStop-double-) | Stelt de tijd in seconden van het einde van de clip in. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initialiseert een nieuw exemplaar van de klasse [AnimationClip](../../com.aspose.threed/animationclip).
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| nodeName | java.lang.String | Naam van nieuw animatieknooppunt |
...
Haalt de animaties op die in de clip zitten.

**Returns:**
java.util.List<com.aspose.threed.AnimationNode> - de animaties die zich in de clip bevinden.
### getClass() {#getClass--}
```
...
Haalt de beschrijving van deze animatieclip op

**Returns:**
java.lang.String - de beschrijving van deze animatieclip
### getName() {#getName--}
```
...
Haalt de tijd in seconden op van het begin van de clip.

**Returns:**
double - de tijd in seconden van het begin van de clip.
### getStop() {#getStop--}
```
...
Haalt de tijd in seconden op van het einde van de clip.

**Returns:**
double - de tijd in seconden van het einde van de clip.
### hashCode() {#hashCode--}
```
...
Stelt de beschrijving van deze animatieclip in
...
Stelt de tijd in seconden van het begin van de clip in.
...
Stelt de tijd in seconden van het einde van de clip in.

...
description: Laadopties voor Siemens JT.
type: docs
weight: 88
url: /nl/java/com.aspose.threed/jtloadoptions/
---
...
| [getLoadPMI()](#getLoadPMI--) | Laad PMI-informatie uit JT-bestand indien mogelijk, de gegevens worden opgeslagen als eigenschap "PMI" van [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). |
| [getLoadProperties()](#getLoadProperties--) | Laad eigenschappen uit de eigentabel van JT als Aspose.3D-eigenschappen. |
...
| [setLoadPMI(boolean value)](#setLoadPMI-boolean-) | Laad PMI-informatie uit JT-bestand indien mogelijk, de gegevens worden opgeslagen als eigenschap "PMI" van [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). |
| [setLoadProperties(boolean value)](#setLoadProperties-boolean-) | Laad eigenschappen uit de eigentabel van JT als Aspose.3D-eigenschappen. |
...
Laad PMI-informatie uit JT-bestand indien mogelijk, de gegevens worden opgeslagen als eigenschap "PMI" van [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). Standaardwaarde is false.

**Returns:**
boolean - Laad PMI-informatie uit JT-bestand indien mogelijk, de gegevens worden opgeslagen als eigenschap "PMI" van [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). Standaardwaarde is false.
...
Laad eigenschappen uit de eigentabel van JT als Aspose.3D-eigenschappen. Standaardwaarde is false.

**Returns:**
boolean - Laad eigenschappen uit de eigentabel van JT als Aspose.3D-eigenschappen. Standaardwaarde is false.

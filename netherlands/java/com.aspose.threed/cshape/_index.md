...
description: "IFC-compatibel C-vormprofiel dat gedefinieerd is door parameters."
type: docs
weight: 27
url: /nl/java/com.aspose.threed/cshape/
---
...
IFC-compatibel C-shape-profiel dat gedefinieerd is door parameters. De centrale positie van het profiel bevindt zich in het midden van de begrenzende doos.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [CShape()](#CShape--) | Constructor van [CShape](../../com.aspose.threed/cshape) |
## Methoden
...
| [getGirth()](#getGirth--) | Haalt de lengte van de omtrek op. |
| [getInternalFilletRadius()](#getInternalFilletRadius--) | Haalt de interne afrondingsstraal op. |
...
| [getWallThickness()](#getWallThickness--) | Haalt de dikte van de wand op. |
...
| [setGirth(double value)](#setGirth-double-) | Stelt de lengte van de omtrek in. |
| [setInternalFilletRadius(double value)](#setInternalFilletRadius-double-) | Stelt de interne afrondingsstraal in. |
...
| [setWallThickness(double value)](#setWallThickness-double-) | Stelt de dikte van de wand in. |
...
Constructor van [CShape](../../com.aspose.threed/cshape)
...
Haalt de lengte van de omtrek op.

**Returns:**
double - de lengte van de omtrek.
...
Haalt de interne afrondingsstraal op.

**Returns:**
double - de interne afrondingsstraal.
### getName() {#getName--}
```
...
Stelt de lengte van de omtrek in.
...
Stelt de interne afrondingsstraal in.

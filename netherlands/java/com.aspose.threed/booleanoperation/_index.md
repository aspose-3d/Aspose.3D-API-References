...
description: Boolean bewerking van meshes
type: docs
weight: 268
url: /nl/java/com.aspose.threed/booleanoperation/
---
...
Mesh's Booleaanse bewerking.
## Velden

| Veld | Beschrijving |
| --- | --- |
| [ADD](#ADD) | Voeg twee meshes toe en bereken de unie van de invoer. |
| [INTERSECT](#INTERSECT) | Bereken de intersectie van twee meshes. |
| [SUB](#SUB) | Trek één mesh af van een andere mesh, bereken het verschil van de invoer. |
## Methoden
...
Voeg twee meshes toe en bereken de unie van de invoer.
...
Trek één mesh af van een andere mesh, bereken het verschil van de invoer.

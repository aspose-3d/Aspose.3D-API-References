...
type: docs
weight: 130
url: /ar/python-net/aspose.threed.utilities/memoryfilesystem/
is_root: false
---
...
# إنشاء خيار حفظ وتحديد نظام الملفات، بحيث يتم كتابة الملف التابع إلى الذاكرة
...
with BytesIO() as ms:
    scene.save(ms, opt)
# تم كتابة test.obj إلى المتغير ms، ويمكننا أيضًا الحصول على محتوى ملف test.mtl عن طريق

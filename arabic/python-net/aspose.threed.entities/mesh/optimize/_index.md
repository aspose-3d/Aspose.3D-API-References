...
type: docs
weight: 170
url: /ar/python-net/aspose.threed.entities/mesh/optimize/
is_root: false
---
...
# تولّد Sphere.ToMesh 117 نقطة تحكم
mesh = Sphere().to_mesh()
# بعد التحسين، لا يتبقّى سوى 86 نقطة تحكم، كما يتم إعادة تعيين فهارس المضلع.

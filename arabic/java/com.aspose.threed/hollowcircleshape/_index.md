...
description: "ملف تعريف دائرة مجوف متوافق مع IFC."
type: docs
weight: 78
url: /ar/java/com.aspose.threed/hollowcircleshape/
---
...
ملف تعريف دائرة مجوف متوافق مع IFC.
## المنشئات
...
| [getWallThickness()](#getWallThickness--) | يحصل على الفرق بين نصف القطر الخارجي والداخلي. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setWallThickness(double value)](#setWallThickness-double-) | يضبط الفرق بين نصف القطر الخارجي والداخلي. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
يحصل على الفرق بين نصف القطر الخارجي والداخلي.

**Returns:**
double - الفرق بين نصف القطر الخارجي والداخلي.
### hashCode() {#hashCode--}
```
...
يضبط الفرق بين نصف القطر الخارجي والداخلي.

...
description: "خيارات التحميل لملف 3DS."
type: docs
weight: 43
url: /ar/java/com.aspose.threed/discreet3dsloadoptions/
---
...
| منشئ | الوصف |
| --- | --- |
| [Discreet3dsLoadOptions()](#Discreet3dsLoadOptions--) | منشئ [Discreet3dsLoadOptions](../../com.aspose.threed/discreet3dsloadoptions) |
## الطرق

| طريقة | الوصف |
| --- | --- |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getApplyAnimationTransform()](#getApplyAnimationTransform--) | يحصل على ما إذا كان سيتم استخدام التحويل المحدد في الإطار الأول لمسار الرسوم المتحركة. |
| [getClass()](#getClass--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setApplyAnimationTransform(boolean value)](#setApplyAnimationTransform-boolean-) | يضبط ما إذا كان سيتم استخدام التحويل المحدد في الإطار الأول لمسار الرسوم المتحركة. |
...
منشئ [Discreet3dsLoadOptions](../../com.aspose.threed/discreet3dsloadoptions)
...
يحصل على ما إذا كان سيتم استخدام التحويل المحدد في الإطار الأول لمسار الرسوم المتحركة.

**Returns:**
منطقي - ما إذا كان سيتم استخدام التحويل المحدد في الإطار الأول لمسار الرسوم المتحركة.
### getClass() {#getClass--}
```
...
يضبط ما إذا كان سيتم استخدام التحويل المحدد في الإطار الأول لمسار الرسوم المتحركة.

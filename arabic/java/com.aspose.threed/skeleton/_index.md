...
description: "يُستخدم الـ  بشكل أساسي من قبل برامج CAD لمساعدة المصمم على تعديل تحويل الهيكل العظمي، وهو عادةً غير مفيد خارج برامج CAD."
type: docs
weight: 172
url: /ar/java/com.aspose.threed/skeleton/
---
...
يُستخدم [Skeleton](../../com.aspose.threed/skeleton) بشكل أساسي من قبل برامج CAD لمساعدة المصمم على تعديل تحويل الهيكل العظمي، وهو عادةً غير مفيد خارج برامج CAD. لجعل تسلسل الهيكل العظمي يعمل ككائن واحد في برنامج CAD، من الضروري تعيين عقدة [Skeleton](../../com.aspose.threed/skeleton) العليا كجذر عن طريق ضبط [getType](../../com.aspose.threed/skeleton\#getType) إلى [SkeletonType.SKELETON](../../com.aspose.threed/skeletontype\#SKELETON)، وتعيين جميع الأطفال إلى [SkeletonType.BONE](../../com.aspose.threed/skeletontype\#BONE).
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [Skeleton()](#Skeleton--) | ينشئ مثيلاً جديداً من الفئة [Skeleton](../../com.aspose.threed/skeleton). |
| [Skeleton(String name)](#Skeleton-java.lang.String-) | ينشئ مثيلاً جديداً من الفئة [Skeleton](../../com.aspose.threed/skeleton). |
| [Skeleton(String name, SkeletonType type)](#Skeleton-java.lang.String-com.aspose.threed.SkeletonType-) | ينشئ مثيلاً جديداً من الفئة [Skeleton](../../com.aspose.threed/skeleton). |
## الطرق
...
| [getSize()](#getSize--) | يحصل على حجم عقدة الطرف المستخدمة في برامج CAD لتمثيل حجم العظم. |
| [getType()](#getType--) | يحصل على نوع الهيكل العظمي. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setSize(double value)](#setSize-double-) | يضبط حجم عقدة الطرف المستخدمة في برامج CAD لتمثيل حجم العظم. |
| [setType(SkeletonType value)](#setType-com.aspose.threed.SkeletonType-) | يضبط نوع الهيكل العظمي. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
ينشئ مثيلاً جديداً من الفئة [Skeleton](../../com.aspose.threed/skeleton).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| الاسم | java.lang.String | اسم الكيان. |
| type | [SkeletonType](../../com.aspose.threed/skeletontype) | نوع الهيكل العظمي |
...
يحصل على حجم عقدة الطرف المستخدمة في برامج CAD لتمثيل حجم العظم.

**Returns:**
double - حجم عقدة الطرف المستخدمة في برامج CAD لتمثيل حجم العظم.
### getType() {#getType--}
```
...
يضبط حجم عقدة الطرف المستخدمة في برامج CAD لتمثيل حجم العظم.
...
يضبط نوع الهيكل العظمي.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| value | [SkeletonType](../../com.aspose.threed/skeletontype) | القيمة الجديدة |

...
description: "ملف تعريف دائرة متوافق مع IFC يمكن استخدامه لإنشاء شبكة عبر"
type: docs
weight: 32
url: /ar/java/com.aspose.threed/circleshape/
---
...
ملف تعريف دائرة متوافق مع IFC، يمكن استخدامه لإنشاء شبكة عبر [LinearExtrusion](../../com.aspose.threed/linearextrusion).
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [CircleShape()](#CircleShape--) | أنشئ ملف تعريف [CircleShape](../../com.aspose.threed/circleshape) بنصف قطر افتراضي (5). |
| [CircleShape(double radius)](#CircleShape-double-) | أنشئ ملف تعريف [CircleShape](../../com.aspose.threed/circleshape) بنصف قطر محدد. |
## الطرق
...
| [getRadius()](#getRadius--) | يحصل على نصف قطر الدائرة. |
...
| [setRadius(double value)](#setRadius-double-) | يضبط نصف قطر الدائرة. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
أنشئ ملف تعريف [CircleShape](../../com.aspose.threed/circleshape) بنصف قطر افتراضي (5).
...
أنشئ ملف تعريف [CircleShape](../../com.aspose.threed/circleshape) بنصف قطر محدد.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| radius | double | نصف قطر الدائرة |
...
يحصل على نصف قطر الدائرة.

**Returns:**
double - نصف قطر الدائرة.
### getScene() {#getScene--}
```

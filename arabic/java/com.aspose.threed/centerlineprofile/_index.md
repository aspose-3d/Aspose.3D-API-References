...
description: "ملف تعريف خط المركز المتوافق مع IFC."
type: docs
weight: 30
url: /ar/java/com.aspose.threed/centerlineprofile/
---
...
| منشئ | الوصف |
| --- | --- |
| [CenterLineProfile(Curve curve, double thickness)](#CenterLineProfile-com.aspose.threed.Curve-double-) | ينشئ كائنًا جديدًا من [CenterLineProfile](../../com.aspose.threed/centerlineprofile) مع المنحنى المحدد كخط مركزي. |
| [CenterLineProfile(Curve curve)](#CenterLineProfile-com.aspose.threed.Curve-) | ينشئ كائنًا جديدًا من [CenterLineProfile](../../com.aspose.threed/centerlineprofile) مع المنحنى المحدد كخط مركزي. |
## الطرق
...
| [getClass()](#getClass--) |  |
| [getCurve()](#getCurve--) | منحنى الخط المركزي للملف الشخصي |
...
| [getThickness()](#getThickness--) | السُمك المطبق على طول الخط المركزي |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setCurve(Curve value)](#setCurve-com.aspose.threed.Curve-) | منحنى الخط المركزي للملف الشخصي |
...
| [setThickness(double value)](#setThickness-double-) | السُمك المطبق على طول الخط المركزي |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
ينشئ كائنًا جديدًا من [CenterLineProfile](../../com.aspose.threed/centerlineprofile) مع المنحنى المحدد كخط مركزي.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | منحنى الخط المركزي |
| السُمك | double | السُمك المطبق على طول الخط المركزي |
...
منحنى الخط المركزي للملف الشخصي
...
السُمك المطبق على طول الخط المركزي

**Returns:**
double - السُمك المطبق على طول الخط المركزي
### hashCode() {#hashCode--}
```

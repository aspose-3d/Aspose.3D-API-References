...
description: "تم الإنشاء بواسطة lexchou في 13/6/2017."
type: docs
weight: 101
url: /ar/java/com.aspose.threed/memorystream/
---
...
تم الإنشاء بواسطة lexchou في 13/6/2017.
## المنشئات
...
| [setCapacity(int cap)](#setCapacity-int-) | يضبط السعة إلى القيمة المحددة |
...
يضبط السعة إلى القيمة المحددة

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| cap | int | السعة الجديدة لتدفق الذاكرة. |

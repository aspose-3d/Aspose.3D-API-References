...
description: "شكل قطع ناقص متوافق مع IFC يتم تعريفه بالمعلمات."
type: docs
weight: 50
url: /ar/java/com.aspose.threed/ellipseshape/
---
...
شكل إهليلجي متوافق مع IFC يتم تعريفه بالمعلمات. موضع المركز للملف التعريفي في مركز صندوق الحدود.
## المنشئات
...
| [getSemiAxis1()](#getSemiAxis1--) | يحصل على نصف القطر الأول للإهليلج المقاس في اتجاه محور x. |
| [getSemiAxis2()](#getSemiAxis2--) | يحصل على نصف القطر الثاني للإهليلج المقاس في اتجاه محور y. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setSemiAxis1(double value)](#setSemiAxis1-double-) | يضبط نصف القطر الأول للإهليلج المقاس في اتجاه محور x. |
| [setSemiAxis2(double value)](#setSemiAxis2-double-) | يضبط نصف القطر الثاني للإهليلج المقاس في اتجاه محور y. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
يحصل على نصف القطر الأول للإهليلج المقاس في اتجاه محور x.

**Returns:**
double - نصف القطر الأول للإهليلج المقاس في اتجاه محور x.
...
يحصل على نصف القطر الثاني للإهليلج المقاس في اتجاه محور y.

**Returns:**
double - نصف القطر الثاني للإهليلج المقاس في اتجاه محور y.
### hashCode() {#hashCode--}
```
...
يضبط نصف القطر الأول للإهليلج المقاس في اتجاه محور x.
...
يضبط نصف القطر الثاني للإهليلج المقاس في اتجاه محور y.

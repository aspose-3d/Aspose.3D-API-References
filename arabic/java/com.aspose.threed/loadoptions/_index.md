...
description: "الفئة الأساسية لتكوين الخيارات في تحميل الملفات لأنواع مختلفة."
type: docs
weight: 97
url: /ar/java/com.aspose.threed/loadoptions/
---
...
الفئة الأساسية لتكوين الخيارات في تحميل الملفات لأنواع مختلفة.
## الطرق

...
description: "A يتكون من عدة مقاطع منحنى."
type: docs
weight: 34
url: /ar/java/com.aspose.threed/compositecurve/
---
...
A [CompositeCurve](../../com.aspose.threed/compositecurve) يتكون من عدة مقاطع منحنى.
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [CompositeCurve()](#CompositeCurve--) | منشئ [CompositeCurve](../../com.aspose.threed/compositecurve) |
## الطرق

| طريقة | الوصف |
| --- | --- |
| [addSegment(Curve curve)](#addSegment-com.aspose.threed.Curve-) | أضف مقطعًا جديدًا إلى المنحنى الحالي. |
| [addSegment(Curve curve, boolean sameDirection)](#addSegment-com.aspose.threed.Curve-boolean-) | أضف مقطعًا جديدًا إلى المنحنى الحالي. |
...
| [getSegments()](#getSegments--) | مقاطع المنحنى. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
منشئ [CompositeCurve](../../com.aspose.threed/compositecurve)
...
أضف مقطعًا جديدًا إلى المنحنى الحالي.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | المنحنى للإضافة |
...
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | المنحنى للإضافة |
| sameDirection | boolean | نفس الاتجاه مع المنحنى الحالي. |
...
**Returns:**
java.util.ArrayList<com.aspose.threed.CompositeCurve.Segment> - مقاطع المنحنى.
### hashCode() {#hashCode--}
```

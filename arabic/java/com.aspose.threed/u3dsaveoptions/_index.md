...
description: "خيارات الحفظ للـ 3D الشامل"
type: docs
weight: 198
url: /ar/java/com.aspose.threed/u3dsaveoptions/
---
...
خيارات الحفظ للـ 3D الشامل
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [U3dSaveOptions()](#U3dSaveOptions--) | منشئ [U3dSaveOptions](../../com.aspose.threed/u3dsaveoptions) |
## الطرق
...
| [getClass()](#getClass--) |  |
| [getEmbedTextures()](#getEmbedTextures--) | تضمين القوام الخارجية في ملف U3D، القيمة الافتراضية هي false. |
| [getEncoding()](#getEncoding--) | يحصل على الترميز الافتراضي للملفات النصية. |
| [getExportNormals()](#getExportNormals--) | يسترجع ما إذا كان سيتم تصدير بيانات العادي. |
| [getExportTextureCoordinates()](#getExportTextureCoordinates--) | يسترجع ما إذا كان سيتم تصدير إحداثيات القوام. |
| [getExportTextures()](#getExportTextures--) | حاول نسخ القوام المستخدمة في المشهد إلى دليل الإخراج. |
| [getExportVertexDiffuse()](#getExportVertexDiffuse--) | يسترجع ما إذا كان سيتم تصدير اللون المنتشر للرأس. |
| [getExportVertexSpecular()](#getExportVertexSpecular--) | يسترجع ما إذا كان سيتم تصدير اللون اللامع للرأس. |
...
| [getMeshCompression()](#getMeshCompression--) | يسترجع ما إذا كان سيتم تمكين ضغط بيانات الشبكة. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEmbedTextures(boolean value)](#setEmbedTextures-boolean-) | تضمين القوام الخارجية في ملف U3D، القيمة الافتراضية هي false. |
| [setEncoding(Charset value)](#setEncoding-java.nio.charset.Charset-) | يضبط الترميز الافتراضي للملفات النصية. |
| [setExportNormals(boolean value)](#setExportNormals-boolean-) | يضبط ما إذا كان سيتم تصدير بيانات العادي. |
| [setExportTextureCoordinates(boolean value)](#setExportTextureCoordinates-boolean-) | يضبط ما إذا كان سيتم تصدير إحداثيات القوام. |
| [setExportTextures(boolean value)](#setExportTextures-boolean-) | حاول نسخ القوام المستخدمة في المشهد إلى دليل الإخراج. |
| [setExportVertexDiffuse(boolean value)](#setExportVertexDiffuse-boolean-) | يضبط ما إذا كان سيتم تصدير اللون المنتشر للرأس. |
| [setExportVertexSpecular(boolean value)](#setExportVertexSpecular-boolean-) | يضبط ما إذا كان سيتم تصدير اللون اللامع للرأس. |
...
| [setMeshCompression(boolean value)](#setMeshCompression-boolean-) | يضبط ما إذا كان سيتم تمكين ضغط بيانات الشبكة. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
منشئ [U3dSaveOptions](../../com.aspose.threed/u3dsaveoptions)
...
تضمين القوام الخارجية في ملف U3D، القيمة الافتراضية هي false.

**Returns:**
boolean - تضمين القوام الخارجية في ملف U3D، القيمة الافتراضية هي false.
...
يسترجع ما إذا كان سيتم تصدير بيانات العادي.

**Returns:**
boolean - ما إذا كان سيتم تصدير بيانات العادي.
...
يسترجع ما إذا كان سيتم تصدير إحداثيات القوام.

**Returns:**
boolean - ما إذا كان سيتم تصدير إحداثيات القوام.
...
يسترجع ما إذا كان سيتم تصدير اللون المنتشر للرأس.

**Returns:**
boolean - ما إذا كان يجب تصدير اللون المنتشر للـ vertex.
...
يسترجع ما إذا كان سيتم تصدير اللون اللامع للرأس.

**Returns:**
boolean - ما إذا كان يجب تصدير اللون الانعكاسي للـ vertex.
...
يسترجع ما إذا كان سيتم تمكين ضغط بيانات الشبكة.

**Returns:**
boolean - ما إذا كان يجب تمكين ضغط بيانات الـ mesh.
### hashCode() {#hashCode--}
```
...
يضبط ما إذا كان سيتم تصدير بيانات العادي.
...
يضبط ما إذا كان سيتم تصدير إحداثيات القوام.
...
يضبط ما إذا كان سيتم تصدير اللون المنتشر للرأس.
...
يضبط ما إذا كان سيتم تصدير اللون اللامع للرأس.
...
يضبط ما إذا كان سيتم تمكين ضغط بيانات الشبكة.

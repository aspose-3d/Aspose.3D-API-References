...
description: "الفئة الأساسية لجميع الكائنات الأولية"
type: docs
weight: 137
url: /ar/java/com.aspose.threed/primitive/
---
...
الفئة الأساسية لجميع الكائنات الأولية
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [Primitive(String name)](#Primitive-java.lang.String-) | ينشئ مثيلًا جديدًا للفئة [Primitive](../../com.aspose.threed/primitive). |
## الطرق
...
ينشئ مثيلًا جديدًا للفئة [Primitive](../../com.aspose.threed/primitive).

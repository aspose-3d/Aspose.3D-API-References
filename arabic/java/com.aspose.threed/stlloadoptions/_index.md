...
description: "خيارات التحميل لتنسيق STL"
type: docs
weight: 176
url: /ar/java/com.aspose.threed/stlloadoptions/
---
...
خيارات التحميل لتنسيق STL
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [StlLoadOptions()](#StlLoadOptions--) | تهيئة كائن جديد من [StlLoadOptions](../../com.aspose.threed/stlloadoptions). |
| [StlLoadOptions(FileContentType contentType)](#StlLoadOptions-com.aspose.threed.FileContentType-) | تهيئة كائن جديد من [StlLoadOptions](../../com.aspose.threed/stlloadoptions). |
## الطرق
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | يحصل على ما إذا كان سيتم عكس نظام إحداثيات نقاط التحكم/العمود أثناء الاستيراد. |
...
| [getRecalculateNormal()](#getRecalculateNormal--) | تجاهل بيانات العمود المخزنة في ملف STL وإعادة حساب بيانات العمود بناءً على موضع الرأس. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | يضبط ما إذا كان سيتم عكس نظام إحداثيات نقاط التحكم/العمود أثناء الاستيراد. |
...
| [setRecalculateNormal(boolean value)](#setRecalculateNormal-boolean-) | تجاهل بيانات العمود المخزنة في ملف STL وإعادة حساب بيانات العمود بناءً على موضع الرأس. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
تهيئة كائن جديد من [StlLoadOptions](../../com.aspose.threed/stlloadoptions).
...
يحصل على ما إذا كان سيتم عكس نظام إحداثيات نقاط التحكم/العمود أثناء الاستيراد.

**Returns:**
boolean - ما إذا كان سيتم عكس نظام إحداثيات نقاط التحكم/العمود أثناء الاستيراد.
...
تجاهل بيانات العمود المخزنة في ملف STL وإعادة حساب بيانات العمود بناءً على موضع الرأس. القيمة الافتراضية هي false

**Returns:**
boolean - تجاهل بيانات العمود المخزنة في ملف STL وإعادة حساب بيانات العمود بناءً على موضع الرأس. القيمة الافتراضية هي false
### hashCode() {#hashCode--}
```
...
يضبط ما إذا كان سيتم عكس نظام إحداثيات نقاط التحكم/العمود أثناء الاستيراد.

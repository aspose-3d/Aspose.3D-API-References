...
description: "يحدد المتجهات المماسية للمكوّنات المحددة."
type: docs
weight: 218
url: /ar/java/com.aspose.threed/vertexelementtangent/
---
...
يحدد المتجهات المماسية للمكوّنات المحددة.
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [VertexElementTangent()](#VertexElementTangent--) | ينشئ مثيلًا جديدًا للفئة [VertexElementTangent](../../com.aspose.threed/vertexelementtangent). |
## الطرق
...
ينشئ مثيلًا جديدًا للفئة [VertexElementTangent](../../com.aspose.threed/vertexelementtangent).

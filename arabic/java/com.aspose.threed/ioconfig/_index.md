...
description: "إعدادات الإدخال/الإخراج للتسلسل/إلغاء التسلسل."
type: docs
weight: 81
url: /ar/java/com.aspose.threed/ioconfig/
---
...
إعدادات الإدخال والإخراج للتسلسل/إلغاء التسلسل. يمكن للمستخدم تحديد تكوينات مفصلة مثل مسار البحث عن التبعيات أو تكوينات متعلقة بالتنسيق هنا
## الطرق

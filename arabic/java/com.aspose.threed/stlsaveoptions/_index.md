...
description: "خيارات الحفظ لتنسيق STL"
type: docs
weight: 177
url: /ar/java/com.aspose.threed/stlsaveoptions/
---
...
خيارات الحفظ لتنسيق STL
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [StlSaveOptions()](#StlSaveOptions--) | يُنشئ مثيلًا جديدًا لـ [StlSaveOptions](../../com.aspose.threed/stlsaveoptions). |
| [StlSaveOptions(FileContentType contentType)](#StlSaveOptions-com.aspose.threed.FileContentType-) | يُنشئ مثيلًا جديدًا لـ [StlSaveOptions](../../com.aspose.threed/stlsaveoptions). |
## الطرق
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | يحصل على ما إذا كان يتم عكس نظام إحداثيات نقاط التحكم/العمود أثناء التصدير. |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | يضبط ما إذا كان يتم عكس نظام إحداثيات نقاط التحكم/العمود أثناء التصدير. |
...
يُنشئ مثيلًا جديدًا لـ [StlSaveOptions](../../com.aspose.threed/stlsaveoptions).
...
يحصل على ما إذا كان يتم عكس نظام إحداثيات نقاط التحكم/العمود أثناء التصدير.

**Returns:**
قيمة منطقية - ما إذا كان يتم عكس نظام إحداثيات نقاط التحكم/العمود أثناء التصدير.
...
يضبط ما إذا كان يتم عكس نظام إحداثيات نقاط التحكم/العمود أثناء التصدير.

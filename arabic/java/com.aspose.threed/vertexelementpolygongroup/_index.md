...
description: "يحدد مجموعة المضلع للمكوّنات المحددة لتجميع المضلع المرتبط معًا."
type: docs
weight: 215
url: /ar/java/com.aspose.threed/vertexelementpolygongroup/
---
...
يحدد مجموعة المضلع للمكوّنات المحددة لتجميع المضلع المرتبط معًا.
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [VertexElementPolygonGroup()](#VertexElementPolygonGroup--) | ينشئ مثيلاً جديداً لفئة [VertexElementPolygonGroup](../../com.aspose.threed/vertexelementpolygongroup). |
## الطرق
...
ينشئ مثيلاً جديداً لفئة [VertexElementPolygonGroup](../../com.aspose.threed/vertexelementpolygongroup).

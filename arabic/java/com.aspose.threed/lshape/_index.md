...
description: "ملف تعريف على شكل L متوافق مع IFC يتم تعريفه بالمعلمات."
type: docs
weight: 91
url: /ar/java/com.aspose.threed/lshape/
---
...
ملف تعريف على شكل L متوافق مع IFC يتم تعريفه بالمعلمات.
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [LShape()](#LShape--) | منشئ لـ [LShape](../../com.aspose.threed/lshape) |
## الطرق
...
| [getClass()](#getClass--) |  |
| [getDepth()](#getDepth--) | يحصل على عمق الملف التعريفي. |
| [getEdgeRadius()](#getEdgeRadius--) | يحصل على نصف قطر الحافة. |
...
| [getFilletRadius()](#getFilletRadius--) | يحصل على نصف قطر الحافة المدورة. |
...
| [getThickness()](#getThickness--) | يحصل على سمك الجدار الثابت. |
| [getWidth()](#getWidth--) | يحصل على عرض الملف. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setDepth(double value)](#setDepth-double-) | يضبط عمق الملف. |
| [setEdgeRadius(double value)](#setEdgeRadius-double-) | يضبط نصف قطر الحافة. |
| [setExcluded(boolean value)](#setExcluded-boolean-) | يضبط ما إذا كان يجب استبعاد هذا الكيان أثناء التصدير. |
| [setFilletRadius(double value)](#setFilletRadius-double-) | يضبط نصف قطر الحافة المدورة. |
...
| [setThickness(double value)](#setThickness-double-) | يضبط سمك الجدار الثابت. |
| [setWidth(double value)](#setWidth-double-) | يضبط عرض الملف. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
منشئ لـ [LShape](../../com.aspose.threed/lshape)
...
يحصل على نصف قطر الحافة.

**Returns:**
double - نصف قطر الحافة.
...
يحصل على نصف قطر الحافة المدورة.

**Returns:**
double - نصف قطر الحافة المدورة.
### getName() {#getName--}
```
...
يحصل على سمك الجدار الثابت.

**Returns:**
double - سمك الجدار الثابت.
### getWidth() {#getWidth--}
```

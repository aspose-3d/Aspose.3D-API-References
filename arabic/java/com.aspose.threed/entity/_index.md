...
description: "الفئة الأساسية لجميع الكيانات."
type: docs
weight: 52
url: /ar/java/com.aspose.threed/entity/
---
...
الفئة الأساسية لجميع الكيانات. تمثل Entity كائنًا ملموسًا يتم إرفاقه تحت عقدة مثل [Light](../../com.aspose.threed/light)/[Geometry](../../com.aspose.threed/geometry).
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [Entity(String name)](#Entity-java.lang.String-) | يُنشئ نسخة جديدة من الفئة [Entity](../../com.aspose.threed/entity). |
## الطرق
...
يُنشئ نسخة جديدة من الفئة [Entity](../../com.aspose.threed/entity).

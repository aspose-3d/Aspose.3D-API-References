...
description: "الفئة الأساسية لجميع الكائنات الهندسية القابلة للتصيير مثل    وغيرها."
type: docs
weight: 71
url: /ar/java/com.aspose.threed/geometry/
---
...
الفئة الأساسية لجميع الكائنات الهندسية القابلة للتصيير (مثل [Mesh](../../com.aspose.threed/mesh)، [NurbsSurface](../../com.aspose.threed/nurbssurface)، [Patch](../../com.aspose.threed/patch) وغيرها).

الفئة الأساسية [Geometry](../../com.aspose.threed/geometry) تدعم:
...
| منشئ | الوصف |
| --- | --- |
| [Geometry(String name)](#Geometry-java.lang.String-) | ينشئ مثيلًا جديدًا من الفئة [Geometry](../../com.aspose.threed/geometry). |
## الطرق
...
ينشئ مثيلًا جديدًا من الفئة [Geometry](../../com.aspose.threed/geometry).

...
description: "الخط المتعدد هو مسار يُعرّف بمجموعة من النقاط مع  ومتصلة بـ   مما يعني أنه يمكن أن يكون أيضًا مجموعة من القطع الخطية المتصلة."
type: docs
weight: 95
url: /ar/java/com.aspose.threed/line/
---
...
الخط المتعدد هو مسار يُعرّف بمجموعة من النقاط باستخدام [Geometry.getControlPoints](../../com.aspose.threed/geometry\#getControlPoints)، ومتصلة بـ [getSegments](../../com.aspose.threed/line\#getSegments)، مما يعني أنه يمكن أن يكون أيضًا مجموعة من القطع الخطية المتصلة. عادةً ما يكون الخط كائنًا خطيًا، مما يعني أنه لا يمكن استخدامه لتمثيل منحنى؛ لتمثيل منحنى، استخدم [NurbsCurve](../../com.aspose.threed/nurbscurve).
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [Line()](#Line--) | ينشئ مثيلاً جديدًا للفئة [Line](../../com.aspose.threed/line). |
| [Line(String name)](#Line-java.lang.String-) | ينشئ مثيلاً جديدًا للفئة [Line](../../com.aspose.threed/line). |
## الطرق
...
| [fromPoints(Vector3[] points)](#fromPoints-com.aspose.threed.Vector3...-) | أنشئ مثيلاً للفئة [Line](../../com.aspose.threed/line) من مجموعة من النقاط. |
...
| [getSegments()](#getSegments--) | يحصل على القطع الخطية للخط |
| [getVisible()](#getVisible--) | يحصل على ما إذا كان الشكل مرئيًا |
| [hashCode()](#hashCode--) |  |
| [makeDefaultIndices()](#makeDefaultIndices--) | أنشئ التسلسل 0,1,2,3....[Geometry.getControlPoints](../../com.aspose.threed/geometry\#getControlPoints).Length-1 إلى [getSegments](../../com.aspose.threed/line\#getSegments) بحيث يمكن استخدام نقاط التحكم كخط واحد. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
ينشئ مثيلاً جديدًا للفئة [Line](../../com.aspose.threed/line).
...
أنشئ مثيلاً للفئة [Line](../../com.aspose.threed/line) من مجموعة من النقاط.
...
يحصل على القطع الخطية للخط

**Returns:**
java.util.List<int[]> - القطع الخطية للخط
...
أنشئ التسلسل 0,1,2,3....[Geometry.getControlPoints](../../com.aspose.threed/geometry\#getControlPoints).Length-1 إلى [getSegments](../../com.aspose.threed/line\#getSegments) بحيث يمكن استخدام نقاط التحكم كخط واحد.

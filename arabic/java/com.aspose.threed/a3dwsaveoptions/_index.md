...
type: docs
weight: 11
url: /ar/java/com.aspose.threed/a3dwsaveoptions/
---
...
| منشئ | الوصف |
| --- | --- |
| [A3dwSaveOptions()](#A3dwSaveOptions--) | منشئ [A3dwSaveOptions](../../com.aspose.threed/a3dwsaveoptions) |
## الطرق
...
| [getExportMetaData()](#getExportMetaData--) | تصدير البيانات الوصفية المرتبطة بالمشهد/العقدة إلى العميل. القيمة الافتراضية هي true |
...
| [getMetaDataPrefix()](#getMetaDataPrefix--) | إذا كانت هذه الخاصية غير فارغة، فسيتم تصدير الخصائص فقط للمشهد/العقدة التي تبدأ بهذا البادئة، وسيتم إزالة البادئة. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEncoding(Charset value)](#setEncoding-java.nio.charset.Charset-) | يضبط الترميز الافتراضي للملفات النصية. |
| [setExportMetaData(boolean value)](#setExportMetaData-boolean-) | تصدير البيانات الوصفية المرتبطة بالمشهد/العقدة إلى العميل. القيمة الافتراضية هي true |
...
| [setMetaDataPrefix(String value)](#setMetaDataPrefix-java.lang.String-) | إذا كانت هذه الخاصية غير فارغة، فسيتم تصدير الخصائص فقط للمشهد/العقدة التي تبدأ بهذا البادئة، وسيتم إزالة البادئة. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
منشئ [A3dwSaveOptions](../../com.aspose.threed/a3dwsaveoptions)
...
تصدير البيانات الوصفية المرتبطة بالمشهد/العقدة إلى العميل. القيمة الافتراضية هي true

**Returns:**
boolean - تصدير البيانات الوصفية المرتبطة بـ Scene/Node إلى العميل. القيمة الافتراضية هي true
...
إذا كانت هذه الخاصية غير فارغة، فسيتم تصدير الخصائص فقط للمشهد/العقدة التي تبدأ بهذا البادئة، وسيتم إزالة البادئة.

**Returns:**
java.lang.String - إذا كانت هذه الخاصية غير فارغة، فسيتم تصدير الخصائص الخاصة بـ Scene/Node التي تبدأ بهذا البادئة فقط، وسيتم إزالة البادئة.
### hashCode() {#hashCode--}
```

...
description: "البيانات الوصفية أو الكائنات المخصصة المستخدمة في ملفات 3D تُدار بواسطة هذه الفئة."
type: docs
weight: 39
url: /ar/java/com.aspose.threed/customobject/
---
...
يتم إدارة البيانات الوصفية أو الكائنات المخصصة المستخدمة في ملفات 3D بواسطة هذه الفئة. يتم حفظ جميع الخصائص المخصصة كخصائص ديناميكية.
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [CustomObject()](#CustomObject--) | تهيء نسخة جديدة من الفئة [CustomObject](../../com.aspose.threed/customobject). |
| [CustomObject(String name)](#CustomObject-java.lang.String-) | تهيء نسخة جديدة من الفئة [CustomObject](../../com.aspose.threed/customobject). |
## الطرق
...
تهيء نسخة جديدة من الفئة [CustomObject](../../com.aspose.threed/customobject).

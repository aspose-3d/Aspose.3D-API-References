...
type: docs
weight: 136
url: /ar/java/com.aspose.threed/postprocessing/
---
...
| [getClass()](#getClass--) |  |
| [getInput()](#getInput--) | إدخال هذه المعالجة اللاحقة |
...
| [setInput(ITextureUnit value)](#setInput-com.aspose.threed.ITextureUnit-) | إدخال هذه المعالجة اللاحقة |

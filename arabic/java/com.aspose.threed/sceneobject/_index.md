...
description: "الفئة الجذرية للكائنات التي سيتم تخزينها داخل المشهد."
type: docs
weight: 162
url: /ar/java/com.aspose.threed/sceneobject/
---
...
| منشئ | الوصف |
| --- | --- |
| [SceneObject(String name)](#SceneObject-java.lang.String-) | تهيئة كائن SceneObject باسم افتراضي |
| [SceneObject()](#SceneObject--) | تهيئة كائن SceneObject. |
## الطرق
...
تهيئة كائن SceneObject باسم افتراضي

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| الاسم | java.lang.String | اسم هذه المثيلة |

...
description: "قناة تقوم بربط حقل مكوّن الخاصية بمجموعة من تسلسلات الإطارات المفتاحية"
type: docs
weight: 13
url: /ar/java/com.aspose.threed/animationchannel/
---
...
القناة تقوم بربط حقل مكوّن الخاصية بمجموعة من تسلسلات الإطارات المفتاحية.
## الطرق
...
| [getClass()](#getClass--) |  |
| [getComponentType()](#getComponentType--) | يحصل على نوع حقل المكوّن |
| [getDefaultValue()](#getDefaultValue--) | يحصل على القيمة الافتراضية للقناة. |
| [getKeyFrames()](#getKeyFrames--) | يحصل على الإطارات المفتاحية لهذا المنحنى. |
| [getKeyframeSequence()](#getKeyframeSequence--) | يحصل على تسلسل الإطار المفتاح المرتبط داخل هذه القناة |
...
| [setDefaultValue(Object value)](#setDefaultValue-java.lang.Object-) | يضبط القيمة الافتراضية للقناة. |
| [setKeyframeSequence(KeyframeSequence value)](#setKeyframeSequence-com.aspose.threed.KeyframeSequence-) | يحصل على تسلسل الإطار المفتاح المرتبط داخل هذه القناة |
...
**Returns:**
java.lang.Class<?> - نوع حقل المكوّن
...
يحصل على القيمة الافتراضية للقناة. إذا لم تكن القناة متصلة بأي تسلسلات إطارات مفتاحية، سيتم استخدام القيمة الافتراضية أثناء تقييم الرسوم المتحركة. سيناريو واقعي: تقوم الرسوم المتحركة بتحريك إحداثي x فقط للعقدة، بينما لا يتغير y و z، وبالتالي سيتم استخدام القيمة الافتراضية أثناء تقييم الترجمة الكاملة.

**Returns:**
java.lang.Object - القيمة الافتراضية للقناة. إذا لم تكن القناة متصلة بأي تسلسلات إطارات مفتاحية، سيتم استخدام القيمة الافتراضية أثناء تقييم الرسوم المتحركة. سيناريو واقعي: تقوم الرسوم المتحركة بتحريك إحداثي x فقط للعقدة، بينما لا يتغير y و z، وبالتالي سيتم استخدام القيمة الافتراضية أثناء تقييم الترجمة الكاملة.
...
يحصل على تسلسل الإطار المفتاح المرتبط داخل هذه القناة
...
يضبط القيمة الافتراضية للقناة. إذا لم تكن القناة متصلة بأي تسلسلات إطارات مفتاحية، سيتم استخدام القيمة الافتراضية أثناء تقييم الرسوم المتحركة. سيناريو واقعي: تقوم الرسوم المتحركة بتحريك إحداثي x فقط للعقدة، بينما لا يتغير y و z، وبالتالي سيتم استخدام القيمة الافتراضية أثناء تقييم الترجمة الكاملة.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| value | [KeyframeSequence](../../com.aspose.threed/keyframesequence) | القيمة الجديدة |

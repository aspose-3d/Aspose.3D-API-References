...
description: "خيارات التحميل لملف wavefront obj"
type: docs
weight: 115
url: /ar/java/com.aspose.threed/objloadoptions/
---
...
خيارات التحميل لملف wavefront obj
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [ObjLoadOptions()](#ObjLoadOptions--) | منشئ [ObjLoadOptions](../../com.aspose.threed/objloadoptions) |
## الطرق
...
| [getClass()](#getClass--) |  |
| [getEnableMaterials()](#getEnableMaterials--) | يحصل على ما إذا كان سيستورد المواد لكل كائن |
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | يحصل على ما إذا كان سيقلب نظام إحداثيات نقاط التحكم/المتجه العمودي أثناء الاستيراد |
...
| [getNormalizeNormal()](#getNormalizeNormal--) | يحصل على ما إذا كان سيطبع المتجه العمودي أثناء التحميل. |
| [getScale()](#getScale--) | المقاييس على المحاور x/y/z، القيمة الافتراضية هي 1.0 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEnableMaterials(boolean value)](#setEnableMaterials-boolean-) | يضبط ما إذا كان سيستورد المواد لكل كائن |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | يضبط ما إذا كان سيقلب نظام إحداثيات نقاط التحكم/المتجه العمودي أثناء الاستيراد |
...
| [setNormalizeNormal(boolean value)](#setNormalizeNormal-boolean-) | يضبط ما إذا كان سيطبع المتجه العمودي أثناء التحميل. |
| [setScale(double value)](#setScale-double-) | المقاييس على المحاور x/y/z، القيمة الافتراضية هي 1.0 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
منشئ [ObjLoadOptions](../../com.aspose.threed/objloadoptions)
...
يحصل على ما إذا كان سيستورد المواد لكل كائن

**Returns:**
منطقي - ما إذا كان سيستورد المواد لكل كائن
...
يحصل على ما إذا كان سيقلب نظام إحداثيات نقاط التحكم/المتجه العمودي أثناء الاستيراد

**Returns:**
منطقي - ما إذا كان سيقلب نظام إحداثيات نقاط التحكم/المتجه العمودي أثناء الاستيراد
...
يحصل على ما إذا كان سيطبع المتجه العمودي أثناء التحميل. القيمة الافتراضية هي true.

**Returns:**
منطقي - ما إذا كان سيطبع المتجه العمودي أثناء التحميل. القيمة الافتراضية هي true.
### getScale() {#getScale--}
```
...
المقاييس على المحاور x/y/z، القيمة الافتراضية هي 1.0

**Returns:**
مضاعف - المقاييس على المحاور x/y/z، القيمة الافتراضية هي 1.0
### hashCode() {#hashCode--}
```
...
يضبط ما إذا كان سيستورد المواد لكل كائن
...
يضبط ما إذا كان سيقلب نظام إحداثيات نقاط التحكم/المتجه العمودي أثناء الاستيراد
...
يضبط ما إذا كان سيطبع المتجه العمودي أثناء التحميل. القيمة الافتراضية هي true.

...
description: "خيارات تحميل PDF"
type: docs
weight: 124
url: /ar/java/com.aspose.threed/pdfloadoptions/
---
...
| منشئ | الوصف |
| --- | --- |
| [PdfLoadOptions()](#PdfLoadOptions--) | منشئ [PdfLoadOptions](../../com.aspose.threed/pdfloadoptions) |
## الطرق
...
| [getPassword()](#getPassword--) | كلمة المرور لفتح ملف PDF المشفر. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setPassword(byte[] value)](#setPassword-byte---) | كلمة المرور لفتح ملف PDF المشفر. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
منشئ [PdfLoadOptions](../../com.aspose.threed/pdfloadoptions)
...
**Returns:**
byte[] - كلمة المرور لفتح ملف PDF المشفر.
### hashCode() {#hashCode--}
```

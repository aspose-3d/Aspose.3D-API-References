...
description: "الشكل يصف التشوه على مجموعة من نقاط التحكم وهو مشابه لمُشَكِّل العنقود في مايا."
type: docs
weight: 171
url: /ar/java/com.aspose.threed/shape/
---
...
الشكل يصف التشوه على مجموعة من نقاط التحكم، وهو مشابه لمُشَكِّل العنقود في مايا. على سبيل المثال، يمكننا إضافة شكل إلى هندسة مُنشأة. والشكل والهندسة لهما نفس المعلومات الطوبولوجية لكن موقع نقاط التحكم مختلف. مع مستويات مختلفة من التأثير، تقوم الهندسة بتطبيق تأثير التشوه.
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [Shape()](#Shape--) | ينشئ مثلاً جديداً من الفئة [Shape](../../com.aspose.threed/shape). |
| [Shape(String name)](#Shape-java.lang.String-) | ينشئ مثلاً جديداً من الفئة [Shape](../../com.aspose.threed/shape). |
## الطرق
...
| [fromControlPoints(Vector3[] controlPoints)](#fromControlPoints-com.aspose.threed.Vector3...-) | إنشاء شكل بنقاط تحكم محددة مع فهارس افتراضية. |
...
| [getIndices()](#getIndices--) | يحصل على الفهارس. |
...
ينشئ مثلاً جديداً من الفئة [Shape](../../com.aspose.threed/shape).
...
إنشاء شكل بنقاط تحكم محددة مع فهارس افتراضية.
...
**Returns:**
java.util.List<java.lang.Integer> - الفهارس.
### getName() {#getName--}
```

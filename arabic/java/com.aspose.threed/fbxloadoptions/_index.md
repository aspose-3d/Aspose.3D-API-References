...
type: docs
weight: 62
url: /ar/java/com.aspose.threed/fbxloadoptions/
---
...
| منشئ | الوصف |
| --- | --- |
| [FbxLoadOptions(FileFormat format)](#FbxLoadOptions-com.aspose.threed.FileFormat-) | منشئ [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions) |
| [FbxLoadOptions()](#FbxLoadOptions--) | منشئ [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions) |
## الطرق
...
| [getClass()](#getClass--) |  |
| [getCompatibleMode()](#getCompatibleMode--) | يحصل على ما إذا كان سيتم تمكين وضع التوافق. |
...
| [getKeepBuiltinGlobalSettings()](#getKeepBuiltinGlobalSettings--) | يحصل على ما إذا كان سيتم الاحتفاظ بالخصائص المدمجة في GlobalSettings التي لها استبدال خاصية أصلي في [AssetInfo](../../com.aspose.threed/assetinfo). |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setCompatibleMode(boolean value)](#setCompatibleMode-boolean-) | يضبط ما إذا كان سيتم تمكين وضع التوافق. |
...
| [setKeepBuiltinGlobalSettings(boolean value)](#setKeepBuiltinGlobalSettings-boolean-) | يضبط ما إذا كان سيتم الاحتفاظ بالخصائص المدمجة في GlobalSettings التي لها استبدال خاصية أصلي في [AssetInfo](../../com.aspose.threed/assetinfo). |
...
منشئ [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions)

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| format | [FileFormat](../../com.aspose.threed/fileformat) | مثال من [getFileFormat](../../com.aspose.threed/fbxloadoptions\#getFileFormat)، يجب أن يكون بتنسيق FBX صالح. |
...
يحصل على ما إذا كان سيتم تمكين وضع التوافق. سيحاول وضع التوافق دعم تعريفات FBX غير القياسية مثل المواد PBR التي يصدرها Blender. القيمة الافتراضية هي false.

**Returns:**
منطقي - ما إذا كان سيتم تمكين وضع التوافق. سيحاول وضع التوافق دعم تعريفات FBX غير القياسية مثل المواد PBR التي يصدرها Blender. القيمة الافتراضية هي false.
...
يحصل على ما إذا كان سيتم الاحتفاظ بالخصائص المدمجة في GlobalSettings التي لها استبدال خاصية أصلي في [AssetInfo](../../com.aspose.threed/assetinfo). اضبط هذا على true إذا كنت تريد الخصائص الكاملة في GlobalSettings. القيمة الافتراضية هي false

**Returns:**
منطقي - ما إذا كان سيتم الاحتفاظ بالخصائص المدمجة في GlobalSettings التي لها استبدال خاصية أصلي في [AssetInfo](../../com.aspose.threed/assetinfo). اضبط هذا على true إذا كنت تريد الخصائص الكاملة في GlobalSettings. القيمة الافتراضية هي false
...
يضبط ما إذا كان سيتم تمكين وضع التوافق. سيحاول وضع التوافق دعم تعريفات FBX غير القياسية مثل المواد PBR التي يصدرها Blender. القيمة الافتراضية هي false.
...
يضبط ما إذا كان سيتم الاحتفاظ بالخصائص المدمجة في GlobalSettings التي لها استبدال خاصية أصلي في [AssetInfo](../../com.aspose.threed/assetinfo). اضبط هذا على true إذا كنت تريد الخصائص الكاملة في GlobalSettings. القيمة الافتراضية هي false

...
description: "خيارات الحفظ لتنسيق AMF"
type: docs
weight: 12
url: /ar/java/com.aspose.threed/amfsaveoptions/
---
...
خيارات الحفظ لتنسيق AMF
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [AmfSaveOptions()](#AmfSaveOptions--) | منشئ [AmfSaveOptions](../../com.aspose.threed/amfsaveoptions) |
## الطرق
...
| [getClass()](#getClass--) |  |
| [getEnableCompression()](#getEnableCompression--) | ما إذا كان يجب استخدام الضغط لتقليل حجم الملف النهائي، القيمة الافتراضية هي true |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEnableCompression(boolean value)](#setEnableCompression-boolean-) | ما إذا كان يجب استخدام الضغط لتقليل حجم الملف النهائي، القيمة الافتراضية هي true |
...
منشئ [AmfSaveOptions](../../com.aspose.threed/amfsaveoptions)
...
ما إذا كان يجب استخدام الضغط لتقليل حجم الملف النهائي، القيمة الافتراضية هي true

**Returns:**
boolean - ما إذا كان يجب استخدام الضغط لتقليل حجم الملف النهائي، القيمة الافتراضية هي true

...
description: "ملف تعريف على شكل Z متوافق مع IFC معرف بالمعلمات."
type: docs
weight: 234
url: /ar/java/com.aspose.threed/zshape/
---
...
ملف تعريف على شكل Z متوافق مع IFC معرف بالمعلمات.
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [ZShape()](#ZShape--) | منشئ [ZShape](../../com.aspose.threed/zshape) |
## الطرق
...
| [getEdgeRadius()](#getEdgeRadius--) | يحصل على نصف قطر حافة الشفة. |
...
| [getWebThickness()](#getWebThickness--) | يحصل على سمك الجدار. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setEdgeRadius(double value)](#setEdgeRadius-double-) | يضبط نصف قطر حافة الشفة. |
...
| [setWebThickness(double value)](#setWebThickness-double-) | يضبط سمك الجدار. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
منشئ [ZShape](../../com.aspose.threed/zshape)
...
يحصل على نصف قطر حافة الشفة.

**Returns:**
double - نصف قطر حافة الشفة.

---
title: "عملية بوليانية"
second_title: "مرجع API لـ Aspose.3D for Java"
description: "عملية بوليانية للشبكات"
type: docs
weight: 268
url: /ar/java/com.aspose.threed/booleanoperation/
---
...
عملية بوليانية للشبكة
## الحقول

| حقل | الوصف |
| --- | --- |
| [ADD](#ADD) | أضف شبكتين واحسب اتحاد المدخلات. |
| [INTERSECT](#INTERSECT) | احسب تقاطع شبكتين. |
| [SUB](#SUB) | اطرح شبكة واحدة من شبكة أخرى، احسب الفرق بين المدخلات. |
## الطرق
...
أضف شبكتين واحسب اتحاد المدخلات.
...
اطرح شبكة واحدة من شبكة أخرى، احسب الفرق بين المدخلات.

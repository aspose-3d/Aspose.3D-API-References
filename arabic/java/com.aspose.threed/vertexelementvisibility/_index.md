...
description: "يحدد ما إذا كانت المكوّنات المحددة مرئية"
type: docs
weight: 225
url: /ar/java/com.aspose.threed/vertexelementvisibility/
---
...
يحدد ما إذا كانت المكوّنات المحددة مرئية
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [VertexElementVisibility()](#VertexElementVisibility--) | ينشئ مثيلاً جديداً من الفئة [VertexElementVisibility](../../com.aspose.threed/vertexelementvisibility). |
## الطرق
...
| [copyTo(VertexElementTemplate<T> target)](#copyTo-com.aspose.threed.VertexElementTemplate-T--) | ينسخ البيانات إلى العنصر المحدد. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(T[] data)](#setData-T---) | تحميل البيانات. |
...
ينشئ مثيلاً جديداً من الفئة [VertexElementVisibility](../../com.aspose.threed/vertexelementvisibility).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| target | [VertexElementTemplate](../../com.aspose.threed/vertexelementtemplate) | الهدف. |

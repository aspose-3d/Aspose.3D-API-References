...
description: "خيارات الحفظ لملف Microsoft 3MF."
type: docs
weight: 105
url: /ar/java/com.aspose.threed/microsoft3mfsaveoptions/
---
...
| منشئ | الوصف |
| --- | --- |
| [Microsoft3MFSaveOptions()](#Microsoft3MFSaveOptions--) | إنشاء [Microsoft3MFSaveOptions](../../com.aspose.threed/microsoft3mfsaveoptions) |
## الطرق

| طريقة | الوصف |
| --- | --- |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getBuildAll()](#getBuildAll--) | ضع علامة على جميع الأشكال الهندسية في المشهد لتكون قابلة للطباعة. |
| [getClass()](#getClass--) |  |
| [getEnableCompression()](#getEnableCompression--) | فعّل الضغط على ملف 3mf الناتج. القيمة الافتراضية هي true |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBuildAll(boolean value)](#setBuildAll-boolean-) | ضع علامة على جميع الأشكال الهندسية في المشهد لتكون قابلة للطباعة. |
| [setEnableCompression(boolean value)](#setEnableCompression-boolean-) | فعّل الضغط على ملف 3mf الناتج. القيمة الافتراضية هي true |
...
إنشاء [Microsoft3MFSaveOptions](../../com.aspose.threed/microsoft3mfsaveoptions)
...
ضع علامة على جميع الأشكال الهندسية في المشهد لتكون قابلة للطباعة. أو يمكنك يدويًا وضع علامة على العقدة لتكون قابلة للطباعة بواسطة [Microsoft3MFFormat](../../com.aspose.threed/microsoft3mfformat). القيمة الافتراضية هي true

**Returns:**
منطقي - ضع علامة على جميع الأشكال الهندسية في المشهد لتكون قابلة للطباعة. أو يمكنك يدويًا وضع علامة على العقدة لتكون قابلة للطباعة بواسطة [Microsoft3MFFormat](../../com.aspose.threed/microsoft3mfformat). القيمة الافتراضية هي true
### getClass() {#getClass--}
```
...
فعّل الضغط على ملف 3mf الناتج. القيمة الافتراضية هي true

**Returns:**
منطقي - فعّل الضغط على ملف 3mf الناتج. القيمة الافتراضية هي true

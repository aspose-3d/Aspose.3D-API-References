...
description: "شكل شبه منحرف متوافق مع IFC معرف بالمعلمات."
type: docs
weight: 193
url: /ar/java/com.aspose.threed/trapeziumshape/
---
...
شكل شبه منحرف متوافق مع IFC معرف بالمعلمات.
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [TrapeziumShape()](#TrapeziumShape--) | منشئ [TrapeziumShape](../../com.aspose.threed/trapeziumshape) |
## الطرق
...
| [getBottomXDim()](#getBottomXDim--) | يحصل على امتداد الخط السفلي المقاس على محور x. |
...
| [getTopXDim()](#getTopXDim--) | يحصل على امتداد الخط العلوي المقاس على محور x. |
| [getTopXOffset()](#getTopXOffset--) | يحصل على الإزاحة من بداية الخط العلوي إلى الخط السفلي. |
| [getYDim()](#getYDim--) | يحصل على المسافة بين الخطين العلوي والسفلي المقاسة على محور y. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setBottomXDim(double value)](#setBottomXDim-double-) | يضبط امتداد الخط السفلي المقاس على محور x. |
...
| [setTopXDim(double value)](#setTopXDim-double-) | يضبط امتداد الخط العلوي المقاس على محور x. |
| [setTopXOffset(double value)](#setTopXOffset-double-) | يضبط الإزاحة من بداية الخط العلوي إلى الخط السفلي. |
| [setYDim(double value)](#setYDim-double-) | يضبط المسافة بين الخطين العلوي والسفلي المقاسة على محور y. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
منشئ [TrapeziumShape](../../com.aspose.threed/trapeziumshape)
...
يحصل على امتداد الخط السفلي المقاس على محور x.

**Returns:**
double - امتداد الخط السفلي المقاس على محور x.
...
يحصل على امتداد الخط العلوي المقاس على محور x.

**Returns:**
double - امتداد الخط العلوي المقاس على محور x.
...
يحصل على الإزاحة من بداية الخط العلوي إلى الخط السفلي.

**Returns:**
double - الإزاحة من بداية الخط العلوي إلى الخط السفلي.
### getYDim() {#getYDim--}
```
...
يحصل على المسافة بين الخطين العلوي والسفلي المقاسة على محور y.

**Returns:**
double - المسافة بين الخطين العلوي والسفلي المقاسة على محور y.
### hashCode() {#hashCode--}
```
...
يضبط امتداد الخط السفلي المقاس على محور x.
...
يضبط امتداد الخط العلوي المقاس على محور x.
...
يضبط الإزاحة من بداية الخط العلوي إلى الخط السفلي.
...
يضبط المسافة بين الخطين العلوي والسفلي المقاسة على محور y.

...
description: "ملف تعريف على شكل C متوافق مع IFC يتم تعريفه بالمعلمات."
type: docs
weight: 27
url: /ar/java/com.aspose.threed/cshape/
---
...
ملف تعريف C-shape المتوافق مع IFC والذي يتم تعريفه بالمعلمات. موضع المركز للملف التعريفي في مركز صندوق الحدود.
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [CShape()](#CShape--) | منشئ [CShape](../../com.aspose.threed/cshape) |
## الطرق
...
| [getGirth()](#getGirth--) | يحصل على طول المحيط. |
| [getInternalFilletRadius()](#getInternalFilletRadius--) | يحصل على نصف قطر الحافة الداخلية. |
...
| [getWallThickness()](#getWallThickness--) | يحصل على سمك الجدار. |
...
| [setGirth(double value)](#setGirth-double-) | يضبط طول المحيط. |
| [setInternalFilletRadius(double value)](#setInternalFilletRadius-double-) | يضبط نصف قطر الحافة الداخلية. |
...
| [setWallThickness(double value)](#setWallThickness-double-) | يضبط سمك الجدار. |
...
منشئ [CShape](../../com.aspose.threed/cshape)
...
يحصل على نصف قطر الحافة الداخلية.

**Returns:**
double - نصف قطر الحافة الداخلية.
### getName() {#getName--}
```

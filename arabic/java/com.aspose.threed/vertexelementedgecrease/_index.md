...
description: "يحدد تجعد الحافة للمكوّنات المحددة"
type: docs
weight: 210
url: /ar/java/com.aspose.threed/vertexelementedgecrease/
---
...
| منشئ | الوصف |
| --- | --- |
| [VertexElementEdgeCrease()](#VertexElementEdgeCrease--) | ينشئ مثيلاً جديداً للفئة [VertexElementEdgeCrease](../../com.aspose.threed/vertexelementedgecrease). |
## الطرق
...
| [copyTo(VertexElementDoublesTemplate target)](#copyTo-com.aspose.threed.VertexElementDoublesTemplate-) | ينسخ البيانات إلى العنصر المحدد. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(double[] data)](#setData-double---) | تحميل البيانات. |
...
ينشئ مثيلاً جديداً للفئة [VertexElementEdgeCrease](../../com.aspose.threed/vertexelementedgecrease).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| target | [VertexElementDoublesTemplate](../../com.aspose.threed/vertexelementdoublestemplate) | الهدف. |
...
**Returns:**
java.util.List<java.lang.Double> - بيانات القمة

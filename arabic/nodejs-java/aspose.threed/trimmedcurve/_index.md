...
url: /ar/nodejs-java/aspose.threed/trimmedcurve/
---
## TrimmedCurve class
...
| الاسم | الوصف |
| --- | --- |
| getBasisCurve() | منحنى الأساس الذي سيتم تقطيعه. |
...
| الاسم | الوصف |
| --- | --- |
| setBasisCurve(value) | منحنى الأساس الذي سيتم تقطيعه. |
...
| الاسم | الوصف |
| --- | --- |
| getFirst() | نقطة النهاية الأولى للتقطيع، يمكن أن تكون نقطة إحداثية أو معامل حقيقي. |
...
| الاسم | الوصف |
| --- | --- |
| setFirst(value) | نقطة النهاية الأولى للتقطيع، يمكن أن تكون نقطة إحداثية أو معامل حقيقي. |
...
| الاسم | الوصف |
| --- | --- |
| getSecond() | النقطة النهائية الثانية للتقليم، يمكن أن تكون نقطة ديكارتية أو معامل حقيقي. |
...
| الاسم | الوصف |
| --- | --- |
| setSecond(value) | النقطة النهائية الثانية للتقليم، يمكن أن تكون نقطة ديكارتية أو معامل حقيقي. |
...
| الاسم | الوصف |
| --- | --- |
| getSameDirection() | يحصل أو يضبط ما إذا كانت النتيجة المقتصة تستخدم نفس اتجاه المنحنى الأساسي. |
...
| الاسم | الوصف |
| --- | --- |
| setSameDirection(value) | يحصل أو يضبط ما إذا كانت النتيجة المقتصة تستخدم نفس اتجاه المنحنى الأساسي. |

...
url: /ar/nodejs-java/aspose.threed/text/
---
## Text class

ملف تعريف النص، يصف هذا الملف تعريفًا للخطوط باستخدام الخط والنص.
...
| الاسم | الوصف |
| --- | --- |
| setFontSize(value) | مقياس حجم الخط. |

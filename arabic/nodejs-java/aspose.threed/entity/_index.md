...
url: /ar/nodejs-java/aspose.threed/entity/
---
## Entity class

الفئة الأساسية لجميع الكيانات. الكيان يمثل كائنًا ملموسًا يتم إرفاقه تحت عقدة مثل Light/Geometry.
...
| الاسم | الوصف |
| --- | --- |
| constructor(name) | يُنشئ مثيلاً جديدًا من الفئة Entity. |

...
url: /ar/nodejs-java/aspose.threed/rectangleshape/
---
...
| الاسم | الوصف |
| --- | --- |
| constructor() | منشئ RectangleShape |
...
| الاسم | الوصف |
| --- | --- |
| getRoundingRadius() | يحصل أو يعيّن نصف قطر الأقواس الدائرية لجميع الزوايا الأربعة، مقاسًا بالدرجات. القيمة الافتراضية هي 0.0 |
...
| الاسم | الوصف |
| --- | --- |
| setRoundingRadius(value) | يحصل أو يعيّن نصف قطر الأقواس الدائرية لجميع الزوايا الأربعة، مقاسًا بالدرجات. القيمة الافتراضية هي 0.0 |
...
| الاسم | الوصف |
| --- | --- |
| getXDim() | يحصل أو يعيّن امتداد المستطيل في اتجاه محور x. القيمة الافتراضية هي 2.0 |
...
| الاسم | الوصف |
| --- | --- |
| setXDim(value) | يحصل أو يعيّن امتداد المستطيل في اتجاه محور x. القيمة الافتراضية هي 2.0 |
...
| الاسم | الوصف |
| --- | --- |
| getYDim() | يحصل أو يعيّن امتداد المستطيل في اتجاه محور y. القيمة الافتراضية هي 2.0 |
...
| الاسم | الوصف |
| --- | --- |
| setYDim(value) | يحصل أو يعيّن امتداد المستطيل في اتجاه محور y. القيمة الافتراضية هي 2.0 |
...
| الاسم | الوصف |
| --- | --- |
| getExtent() | يحصل على الامتداد في بعدي x و y. |

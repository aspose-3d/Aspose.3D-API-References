...
url: /ar/nodejs-java/aspose.threed/amfsaveoptions/
---
...
| الاسم | الوصف |
| --- | --- |
| constructor() | منشئ AmfSaveOptions |
...
| الاسم | الوصف |
| --- | --- |
| getEnableCompression() | ما إذا كان سيتم استخدام الضغط لتقليل حجم الملف النهائي، القيمة الافتراضية هي true |
...
| الاسم | الوصف |
| --- | --- |
| setEnableCompression(value) | ما إذا كان سيتم استخدام الضغط لتقليل حجم الملف النهائي، القيمة الافتراضية هي true |

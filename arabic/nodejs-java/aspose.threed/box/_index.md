...
url: /ar/nodejs-java/aspose.threed/box/
---
## Box class
...
| الاسم | الوصف |
| --- | --- |
| constructor() | ينشئ مثيلاً جديداً من الفئة Box. |
...
| الاسم | الوصف |
| --- | --- |
| constructor_overload(length, width, height) | ينشئ مثيلاً جديداً من الفئة Box. |

 **Parameters:**

| الاسم | النوع | الوصف |
| --- | --- | --- |
| length | Number | طول الصندوق المتجه على المحور z. |
| width | Number | عرض الصندوق المتجه على المحور x. |
| height | Number | ارتفاع الصندوق المتجه على المحور y. |
...
| الاسم | الوصف |
| --- | --- |
| constructor_overload2(name, length, width, height, lengthSegments, widthSegments, heightSegments) | ينشئ مثيلاً جديداً من الفئة Box. |
...
| width | Number | عرض الصندوق المتجه على المحور x. |
| height | Number | ارتفاع الصندوق المتجه على المحور y. |
| lengthSegments | Number | مقاطع الطول. |
| widthSegments | Number | مقاطع العرض. |
...
| الاسم | الوصف |
| --- | --- |
| getLengthSegments() | يحصل أو يضبط مقاطع الطول. |
...
| الاسم | الوصف |
| --- | --- |
| setLengthSegments(value) | يحصل أو يضبط مقاطع الطول. |
...
| الاسم | الوصف |
| --- | --- |
| getWidthSegments() | يحصل أو يضبط مقاطع العرض. |
...
| الاسم | الوصف |
| --- | --- |
| setWidthSegments(value) | يحصل أو يضبط مقاطع العرض. |
...
| الاسم | الوصف |
| --- | --- |
| getHeightSegments() | يحصل أو يضبط مقاطع الارتفاع. |
...
| الاسم | الوصف |
| --- | --- |
| setHeightSegments(value) | يحصل أو يضبط مقاطع الارتفاع. |
...
| الاسم | الوصف |
| --- | --- |
| getLength() | يحصل أو يضبط طول الصندوق المتجه على المحور z. الطول المتجه على المحور z. |
...
| الاسم | الوصف |
| --- | --- |
| setLength(value) | يحصل أو يضبط طول الصندوق المتجه على المحور z. الطول المتجه على المحور z. |
...
| الاسم | الوصف |
| --- | --- |
| getWidth() | يحصل أو يضبط عرض الصندوق المحاذى على محور x. العرض المحاذى على محور x. |
...
| الاسم | الوصف |
| --- | --- |
| setWidth(value) | يحصل أو يضبط عرض الصندوق المحاذى على محور x. العرض المحاذى على محور x. |
...
| الاسم | الوصف |
| --- | --- |
| getHeight() | يحصل أو يضبط ارتفاع الصندوق المحاذى على محور y. الارتفاع المحاذى على محور y. |
...
| الاسم | الوصف |
| --- | --- |
| setHeight(value) | يحصل أو يضبط ارتفاع الصندوق المحاذى على محور y. الارتفاع المحاذى على محور y. |

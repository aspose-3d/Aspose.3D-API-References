...
url: /ar/nodejs-java/aspose.threed/nurbssurface/
---
## NurbsSurface class

NurbsSurface هو سطح يُمثَّل بـ NURBS (Non-uniform rational basis spline)، يُعرّف NurbsSurface باتجاهين NurbsDirectionU و V. يُستخدم المكوّن w في نقطة التحكم كوزن لنقطة التحكم، بغض النظر عن ما إذا كان نوع الاتجاه CurveDimension.TWO_DIMENSIONAL أو CurveDimension.THREE_DIMENSIONAL.
...
| الاسم | الوصف |
| --- | --- |
| constructor() | يُهيئ نسخة جديدة من فئة NurbsSurface. |
...
| الاسم | الوصف |
| --- | --- |
| constructor_overload(name) | يُهيئ نسخة جديدة من فئة NurbsSurface. |
...
| الاسم | الوصف |
| --- | --- |
| getU() | يحصل على اتجاه U لسطح NURBS |
...
| الاسم | الوصف |
| --- | --- |
| getV() | يحصل على اتجاه V لسطح NURBS |
...
| الاسم | الوصف |
| --- | --- |
| toMesh() | تحويل سطح NURBS إلى mesh |

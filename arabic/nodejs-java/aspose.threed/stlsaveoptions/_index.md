...
url: /ar/nodejs-java/aspose.threed/stlsaveoptions/
---
...
| الاسم | الوصف |
| --- | --- |
| constructor() | يقوم بتهيئة نسخة جديدة من StlSaveOptions. |
...
| الاسم | الوصف |
| --- | --- |
| constructor_overload(contentType) | يقوم بتهيئة نسخة جديدة من StlSaveOptions. |
...
| الاسم | الوصف |
| --- | --- |
| getFlipCoordinateSystem() | يحصل أو يضبط ما إذا كان سيتم عكس نظام إحداثيات نقاط التحكم/العمود أثناء التصدير. |
...
| الاسم | الوصف |
| --- | --- |
| setFlipCoordinateSystem(value) | يحصل أو يضبط ما إذا كان سيتم عكس نظام إحداثيات نقاط التحكم/العمود أثناء التصدير. |

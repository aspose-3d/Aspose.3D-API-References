...
url: /ar/nodejs-java/aspose.threed/circleshape/
---
## CircleShape class

ملف تعريف دائرة متوافق مع IFC، يمكن استخدامه لإنشاء شبكة عبر LinearExtrusion.
...
| الاسم | الوصف |
| --- | --- |
| constructor() | إنشاء ملف تعريف CircleShape بنصف قطر افتراضي (5). |
...
| الاسم | الوصف |
| --- | --- |
| constructor_overload(radius) | إنشاء ملف تعريف CircleShape بنصف قطر محدد. |
...
| الاسم | الوصف |
| --- | --- |
| getRadius() | يحصل أو يعيّن نصف قطر الدائرة. |
...
| الاسم | الوصف |
| --- | --- |
| setRadius(value) | يحصل أو يعيّن نصف قطر الدائرة. |

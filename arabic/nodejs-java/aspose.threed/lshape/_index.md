...
url: /ar/nodejs-java/aspose.threed/lshape/
---
## LShape class

ملف تعريف على شكل L متوافق مع IFC يُعرّف بالمعلمات.
...
| الاسم | الوصف |
| --- | --- |
| getThickness() | يحصل أو يضبط سمك الجدار الثابت. |
...
| الاسم | الوصف |
| --- | --- |
| setThickness(value) | يحصل أو يضبط سمك الجدار الثابت. |
...
| الاسم | الوصف |
| --- | --- |
| getFilletRadius() | يحصل أو يضبط نصف قطر الحافة المستديرة. |
...
| الاسم | الوصف |
| --- | --- |
| setFilletRadius(value) | يحصل أو يضبط نصف قطر الحافة المستديرة. |
...
| الاسم | الوصف |
| --- | --- |
| getEdgeRadius() | يحصل أو يضبط نصف قطر الحافة. |
...
| الاسم | الوصف |
| --- | --- |
| setEdgeRadius(value) | يحصل أو يضبط نصف قطر الحافة. |

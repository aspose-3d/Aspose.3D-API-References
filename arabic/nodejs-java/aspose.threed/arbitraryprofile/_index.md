...
url: /ar/nodejs-java/aspose.threed/arbitraryprofile/
---
## ArbitraryProfile class

تتيح لك هذه الفئة إنشاء ملف تعريف ثنائي الأبعاد مباشرةً من منحنى عشوائي.
...
| الاسم | الوصف |
| --- | --- |
| constructor() | منشئ ArbitraryProfile |
...
| الاسم | الوصف |
| --- | --- |
| constructor_overload(curve) | منشئ ArbitraryProfile مع منحنى أولي. |
...
| الاسم | الوصف |
| --- | --- |
| getCurve() | المنحنى المستخدم لإنشاء الملف التعريفي |
...
| الاسم | الوصف |
| --- | --- |
| setCurve(value) | المنحنى المستخدم لإنشاء الملف التعريفي |

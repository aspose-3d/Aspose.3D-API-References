...
url: /ar/nodejs-java/aspose.threed/ellipse/
---
## Ellipse class

Ellipse يحدد مجموعة من النقاط التي تشكل شكل الإهليلج.
...
| الاسم | الوصف |
| --- | --- |
| constructor_overload(semiAxis1, semiAxis2) | منشئ الإهليلج |
...
| الاسم | الوصف |
| --- | --- |
| getSemiAxis1() | نصف القطر على المحور X |
...
| الاسم | الوصف |
| --- | --- |
| setSemiAxis1(value) | نصف القطر على المحور X |
...
| الاسم | الوصف |
| --- | --- |
| getSemiAxis2() | نصف القطر على المحور Y |
...
| الاسم | الوصف |
| --- | --- |
| setSemiAxis2(value) | نصف القطر على المحور Y |

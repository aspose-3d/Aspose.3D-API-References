...
url: /ar/nodejs-java/aspose.threed/sweptareasolid/
---
## SweptAreaSolid class

يقوم الـ SweptAreaSolid بإنشاء هندسة عن طريق مسح ملف تعريف على طول directrix.
...
| الاسم | الوصف |
| --- | --- |
| getShape() | الملف الأساسي لإنشاء الهندسة. |
...
| الاسم | الوصف |
| --- | --- |
| setShape(value) | الملف الأساسي لإنشاء الهندسة. |
...
| الاسم | الوصف |
| --- | --- |
| getDirectrix() | الخط الموجه الذي يتم سحب المنطقة المقطوعة على طوله. |
...
| الاسم | الوصف |
| --- | --- |
| setDirectrix(value) | الخط الموجه الذي يتم سحب المنطقة المقطوعة على طوله. |
...
| الاسم | الوصف |
| --- | --- |
| getStartPoint() | نقطة البداية للخط الموجه. |
...
| الاسم | الوصف |
| --- | --- |
| setStartPoint(value) | نقطة البداية للخط الموجه. |
...
| الاسم | الوصف |
| --- | --- |
| getEndPoint() | نقطة النهاية للخط الموجه. |
...
| الاسم | الوصف |
| --- | --- |
| setEndPoint(value) | نقطة النهاية للخط الموجه. |

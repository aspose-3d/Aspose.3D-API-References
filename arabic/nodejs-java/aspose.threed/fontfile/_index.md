...
url: /ar/nodejs-java/aspose.threed/fontfile/
---
## FontFile class

ملف الخط يحتوي على تعريفات للرموز، يُستخدم هذا لإنشاء ملف تعريف النص.  @hideconstructor
...
| الاسم | الوصف |
| --- | --- |
| fromFile(fileName) | تحميل FontFile من اسم الملف |

 **Parameters:**

| الاسم | النوع | الوصف |
| --- | --- | --- |
| fileName | String | المسار إلى ملف الخط |
...
| الاسم | الوصف |
| --- | --- |
| parse(bytes) | تحليل FontFile من البايتات |

 **Parameters:**

| الاسم | النوع | الوصف |
| --- | --- | --- |
| bytes | byte[] | المحتوى الخام لملف الخط OTF |

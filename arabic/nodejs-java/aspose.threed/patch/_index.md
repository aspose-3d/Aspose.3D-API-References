...
| الاسم | الوصف |
| --- | --- |
| constructor() | يُنشئ مثيلاً جديداً من الفئة Patch. |
...
| الاسم | الوصف |
| --- | --- |
| constructor_overload(name) | يُنشئ مثيلاً جديداً من الفئة Patch. |

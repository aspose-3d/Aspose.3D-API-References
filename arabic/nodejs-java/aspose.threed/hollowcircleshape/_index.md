...
url: /ar/nodejs-java/aspose.threed/hollowcircleshape/
---
## HollowCircleShape class

ملف تعريف دائرة مجوفة متوافق مع IFC.
...
| الاسم | الوصف |
| --- | --- |
| getWallThickness() | يحصل أو يضبط الفرق بين نصف القطر الخارجي والداخلي. |
...
| الاسم | الوصف |
| --- | --- |
| setWallThickness(value) | يحصل أو يضبط الفرق بين نصف القطر الخارجي والداخلي. |

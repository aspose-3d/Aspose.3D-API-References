...
url: /ar/nodejs-java/aspose.threed/transformedcurve/
---
## TransformedCurve class

يمنح TransformedCurve منحنىً موضعًا باستخدام مصفوفة تحويل. يتيح ذلك إجراء تحويل داخل TrimmedCurve أو CompositeCurve.
...
| الاسم | الوصف |
| --- | --- |
| constructor() | المُنشئ لـ TransformedCurve |
...
| الاسم | الوصف |
| --- | --- |
| constructor_overload(basisCurve, transformation) | المُنشئ لـ TransformedCurve |
...
| الاسم | الوصف |
| --- | --- |
| getTransformMatrix() | مصفوفة التحويل. |
...
| الاسم | الوصف |
| --- | --- |
| setTransformMatrix(value) | مصفوفة التحويل. |
...
| الاسم | الوصف |
| --- | --- |
| setBasisCurve(value) | منحنى الأساس. |

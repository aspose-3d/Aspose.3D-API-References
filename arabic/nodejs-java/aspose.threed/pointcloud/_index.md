...
url: /ar/nodejs-java/aspose.threed/pointcloud/
---
## PointCloud class
...
| الاسم | الوصف |
| --- | --- |
| constructor(name) | منشئ الـ PointCloud |
...
| الاسم | الوصف |
| --- | --- |
| constructor_overload() | منشئ الـ PointCloud |
...
| الاسم | الوصف |
| --- | --- |
| fromGeometry(g) | إنشاء نسخة جديدة من PointCloud من كائن هندسي |
...
| الاسم | الوصف |
| --- | --- |
| fromGeometry(g, density) | إنشاء نسخة جديدة من سحابة النقاط من كائن هندسي. الكثافة هي عدد النقاط لكل مثلث وحدة (المثلث الوحدة هو المثلث الذي يمتلك أقصى مساحة سطح من الشبكة) |

 **Parameters:**

| الاسم | النوع | الوصف |
| --- | --- | --- |
| g | الهندسة | شبكة أو نسخة هندسية أخرى |
| الكثافة | Number | عدد النقاط لكل مثلث وحدة |

...
url: /ar/nodejs-java/aspose.threed/mirroredprofile/
---
## MirroredProfile class

ملف تعريف مرآة متوافق مع IFC. هذا الملف يُعرّف ملفًا جديدًا عن طريق عكس الملف الأساسي حول محور y.
...
| الاسم | الوصف |
| --- | --- |
| constructor(baseProfile) | إنشاء MirroredProfile جديد من ملف تعريف موجود. |

 **Parameters:**

| الاسم | النوع | الوصف |
| --- | --- | --- |
| baseProfile | الملف الشخصي | ملف التعريف الأساسي الذي سيتم عكسه. |
...
| الاسم | الوصف |
| --- | --- |
| getBaseProfile() | ملف التعريف الأساسي الذي سيتم عكسه. |

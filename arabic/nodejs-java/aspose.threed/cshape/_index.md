...
url: /ar/nodejs-java/aspose.threed/cshape/
---
## CShape class

ملف تعريف شكل C متوافق مع IFC يتم تعريفه بالمعلمات. موضع المركز للملف التعريفي يقع في مركز صندوق الحدود.
...
| الاسم | الوصف |
| --- | --- |
| getDepth() | يحصل أو يعيّن عمق الملف. |
...
| الاسم | الوصف |
| --- | --- |
| setDepth(value) | يحصل أو يعيّن عمق الملف. |
...
| الاسم | الوصف |
| --- | --- |
| getWidth() | يحصل أو يعيّن عرض الملف. |
...
| الاسم | الوصف |
| --- | --- |
| setWidth(value) | يحصل أو يعيّن عرض الملف. |
...
| الاسم | الوصف |
| --- | --- |
| getGirth() | يحصل أو يعيّن طول المحيط. |
...
| الاسم | الوصف |
| --- | --- |
| setGirth(value) | يحصل أو يعيّن طول المحيط. |
...
| الاسم | الوصف |
| --- | --- |
| getWallThickness() | يحصل أو يعيّن سمك الجدار. |
...
| الاسم | الوصف |
| --- | --- |
| setWallThickness(value) | يحصل أو يعيّن سمك الجدار. |
...
| الاسم | الوصف |
| --- | --- |
| getInternalFilletRadius() | يحصل أو يعيّن نصف قطر الحافة الداخلية. |
...
| الاسم | الوصف |
| --- | --- |
| setInternalFilletRadius(value) | يحصل أو يعيّن نصف قطر الحافة الداخلية. |

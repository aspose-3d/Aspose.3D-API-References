...
url: /ar/nodejs-java/aspose.threed/lambertmaterial/
---
## LambertMaterial class

مادة لنموذج إضاءة لامبرت
...
| الاسم | الوصف |
| --- | --- |
| constructor() | يُهيئ نسخة جديدة من فئة LambertMaterial. |
...
| الاسم | الوصف |
| --- | --- |
| constructor_overload(name) | يُهيئ نسخة جديدة من فئة LambertMaterial. |

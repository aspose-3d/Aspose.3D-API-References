...
url: /ar/nodejs-java/aspose.threed/ushape/
---
## UShape class
...
| الاسم | الوصف |
| --- | --- |
| getDepth() | يحصل أو يعيّن طول الويب. |
...
| الاسم | الوصف |
| --- | --- |
| setDepth(value) | يحصل أو يعيّن طول الويب. |
...
| الاسم | الوصف |
| --- | --- |
| getFlangeWidth() | يحصل أو يعيّن طول الحافة. |
...
| الاسم | الوصف |
| --- | --- |
| setFlangeWidth(value) | يحصل أو يعيّن طول الحافة. |
...
| الاسم | الوصف |
| --- | --- |
| getWebThickness() | يحصل أو يضبط سمك الشبكة. |
...
| الاسم | الوصف |
| --- | --- |
| setWebThickness(value) | يحصل أو يضبط سمك الشبكة. |
...
| الاسم | الوصف |
| --- | --- |
| getFlangeThickness() | يحصل أو يعيّن سمك الحافة. |
...
| الاسم | الوصف |
| --- | --- |
| setFlangeThickness(value) | يحصل أو يعيّن سمك الحافة. |
...
| الاسم | الوصف |
| --- | --- |
| getFilletRadius() | يحصل أو يعيّن نصف قطر القوس بين الحافة والويب. |
...
| الاسم | الوصف |
| --- | --- |
| setFilletRadius(value) | يحصل أو يعيّن نصف قطر القوس بين الحافة والويب. |
...
| الاسم | الوصف |
| --- | --- |
| getEdgeRadius() | يحصل أو يضبط نصف قطر الحافة في حافة الفلانجة. |
...
| الاسم | الوصف |
| --- | --- |
| setEdgeRadius(value) | يحصل أو يضبط نصف قطر الحافة في حافة الفلانجة. |

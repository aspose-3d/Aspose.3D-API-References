...
url: /ar/nodejs-java/aspose.threed/ellipseshape/
---
## EllipseShape class

شكل إهليلجي متوافق مع IFC يتم تعريفه بالمعلمات. موضع المركز للملف التعريفي يقع في مركز صندوق الحدود.
...
| الاسم | الوصف |
| --- | --- |
| getSemiAxis1() | يحصل أو يعيّن نصف القطر الأول للبيضاوي المقاس في اتجاه محور x. |
...
| الاسم | الوصف |
| --- | --- |
| setSemiAxis1(value) | يحصل أو يعيّن نصف القطر الأول للبيضاوي المقاس في اتجاه محور x. |
...
| الاسم | الوصف |
| --- | --- |
| getSemiAxis2() | يحصل أو يضبط نصف القطر الثاني للقطع الناقص الذي يُقاس في اتجاه المحور ص. |
...
| الاسم | الوصف |
| --- | --- |
| setSemiAxis2(value) | يحصل أو يضبط نصف القطر الثاني للقطع الناقص الذي يُقاس في اتجاه المحور ص. |

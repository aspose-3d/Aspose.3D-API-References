...
description: يحدد ما إذا كان المضلع المحدد هو hole
type: docs
weight: 800
url: /ar/net/aspose.threed.entities/vertexelementhole/
---
## VertexElementHole class

يحدد ما إذا كان المضلع المحدد هو hole
...
| اسم | وصف |
| --- | --- |
| [VertexElementHole](vertexelementhole)() | يقوم بتهيئة مثيل جديد لملف[`VertexElementHole`](../vertexelementhole) فئة . |

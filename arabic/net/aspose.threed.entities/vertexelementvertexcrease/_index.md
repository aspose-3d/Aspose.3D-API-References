...
description: يحدد تجعيد الرأس للمكونات المحددة
type: docs
weight: 940
url: /ar/net/aspose.threed.entities/vertexelementvertexcrease/
---
## VertexElementVertexCrease class

يحدد تجعيد الرأس للمكونات المحددة
...
| اسم | وصف |
| --- | --- |
| [VertexElementVertexCrease](vertexelementvertexcrease)() | يقوم بتهيئة مثيل جديد لملف[`VertexElementVertexCrease`](../vertexelementvertexcrease) فئة . |

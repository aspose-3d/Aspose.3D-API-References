...
description: يحتوي TriMesh على بيانات أولية يمكن استخدامها بواسطة وحدة معالجة الرسومات مباشرةً.
type: docs
weight: 730
...
| اسم | وصف |
| --- | --- |
| [TriMesh](trimesh)(string, VertexDeclaration) | تهيئة مثيل[`TriMesh`](../trimesh) |
...
| [UnmergedVerticesCount](../../aspose.threed.entities/trimesh/unmergedverticescount) { get; } | عدد الرؤوس غير المدمجة التي مرت بها[`BeginVertex`](./beginvertex) و[`EndVertex`](./endvertex) . |
...
| اسم | وصف |
| --- | --- |
| static [CopyFrom](../../aspose.threed.entities/trimesh/copyfrom)(TriMesh, VertexDeclaration) | انسخ ملف[`TriMesh`](../trimesh)من الإدخال مع تخطيط رأسي جديد |
| static [FromMesh](../../aspose.threed.entities/trimesh/frommesh#frommesh)(Mesh, bool) | قم بإنشاء TriMesh من كائن شبكة معين ، يعتمد إعلان الرأس على بنية شبكة الإدخال. |
| static [FromMesh](../../aspose.threed.entities/trimesh/frommesh#frommesh_1)(VertexDeclaration, Mesh) | قم بإنشاء TriMesh من كائن شبكة محدد بتخطيط قمة معين. |
| static [FromRawData](../../aspose.threed.entities/trimesh/fromrawdata)(VertexDeclaration, byte[], int[], bool) | إنشاء TriMesh من البيانات الأولية |

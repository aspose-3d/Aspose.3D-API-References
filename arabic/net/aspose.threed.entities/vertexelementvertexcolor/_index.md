...
description: يحدد لون الرأس للمكونات المحددة
type: docs
weight: 930
...
| اسم | وصف |
| --- | --- |
| [VertexElementVertexColor](vertexelementvertexcolor)() | يقوم بتهيئة مثيل جديد لملف[`VertexElementVertexColor`](../vertexelementvertexcolor) فئة . |

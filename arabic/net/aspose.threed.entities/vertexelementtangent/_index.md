...
description: يحدد موجهات الظل للمكونات المحددة.
type: docs
weight: 870
...
يحدد موجهات الظل للمكونات المحددة.
...
| اسم | وصف |
| --- | --- |
| [VertexElementTangent](vertexelementtangent)() | يقوم بتهيئة مثيل جديد لملف[`VertexElementTangent`](../vertexelementtangent) فئة . |

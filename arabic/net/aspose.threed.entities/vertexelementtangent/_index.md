---
title: "الفئة VertexElementTangent."
second_title: "مرجع Aspose.3D for .NET API"
description: "Aspose.ThreeD.Entities.VertexElementTangent فئة. تعرف المتجهات المماسية للمكونات المحددة"
type: docs
weight: 930
url: /ar/net/aspose.threed.entities/vertexelementtangent/
---
## VertexElementTangent class

يحدد المتجهات المماسية للمكونات المحددة.
...
| الاسم | الوصف |
| --- | --- |
| [VertexElementTangent](vertexelementtangent/)() | يُنشئ مثلاً جديداً من الفئة `VertexElementTangent`. |

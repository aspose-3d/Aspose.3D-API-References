...
description: المجال ذي المعلمات .
type: docs
weight: 670
...
| اسم | وصف |
| --- | --- |
| [Sphere](sphere#constructor)() | يقوم بتهيئة مثيل جديد لملف[`Sphere`](../sphere) بنصف قطر افتراضي 1. |
| [Sphere](sphere#constructor_1)(double) | يقوم بتهيئة مثيل جديد لملف[`Sphere`](../sphere) فئة بنصف قطر محدد. |
| [Sphere](sphere#constructor_2)(double, int, int) | يقوم بتهيئة مثيل جديد لملف[`Sphere`](../sphere) فئة بنصف قطر محدد وشرائح عرض وأجزاء ارتفاع. |
| [Sphere](sphere#constructor_3)(string, double, int, int, double, double, double, double) | يقوم بتهيئة مثيل جديد لملف[`Sphere`](../sphere) فئة . |
...
| [HeightSegments](../../aspose.threed.entities/sphere/heightsegments) { get; set; } | الحصول على شرائح الارتفاع أو تعيينها . |
...
| [PhiLength](../../aspose.threed.entities/sphere/philength) { get; set; } | الحصول على أو تحديد طول phi . |
| [PhiStart](../../aspose.threed.entities/sphere/phistart) { get; set; } | الحصول على أو تعيين بداية phi . |
| [Properties](../../aspose.threed/a3dobject/properties) { get; } | الحصول على مجموعة من كافة الخصائص . |
| [Radius](../../aspose.threed.entities/sphere/radius) { get; set; } | الحصول على أو تحديد نصف قطر الكرة. |
...
| [ThetaLength](../../aspose.threed.entities/sphere/thetalength) { get; set; } | الحصول على أو تحديد طول ثيتا. |
| [ThetaStart](../../aspose.threed.entities/sphere/thetastart) { get; set; } | يحصل أو يحدد بداية ثيتا. |
| [WidthSegments](../../aspose.threed.entities/sphere/widthsegments) { get; set; } | الحصول على شرائح العرض أو تعيينها . |
...
| override [ToMesh](../../aspose.threed.entities/sphere/tomesh)() | تحويل الكائن الحالي إلى mesh |

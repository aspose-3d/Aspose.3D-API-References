---
title: "الفئة VertexElementBinormal"
second_title: "مرجع Aspose.3D for .NET API"
description: "الفئة Aspose.ThreeD.Entities.VertexElementBinormal. يحدد المتجهات الثنائية للمكونات المحددة."
type: docs
weight: 830
...
يحدد المتجهات الثنائية للمكونات المحددة.
...
| الاسم | الوصف |
| --- | --- |
| [VertexElementBinormal](vertexelementbinormal/)() | يُهيئ نسخة جديدة من الفئة `VertexElementBinormal`. |

...
description: يحدد المتجهات العادية للمكونات المحددة.
type: docs
weight: 830
...
| اسم | وصف |
| --- | --- |
| [VertexElementNormal](vertexelementnormal)() | يقوم بتهيئة مثيل جديد لملف[`VertexElementNormal`](../vertexelementnormal) فئة . |

---
title: "الفئة VertexElementNormal"
second_title: "مرجع Aspose.3D for .NET API"
description: "الفئة Aspose.ThreeD.Entities.VertexElementNormal. تحدد المتجهات العادية للمكونات المحددة"
type: docs
weight: 890
url: /ar/net/aspose.threed.entities/vertexelementnormal/
---
## VertexElementNormal class

يحدد المتجهات العادية للمكونات المحددة.
...
| الاسم | الوصف |
| --- | --- |
| [VertexElementNormal](vertexelementnormal/)() | ينشئ مثيلًا جديدًا للفئة `VertexElementNormal`. |

...
description: الخط متعدد الخطوط هو مسار محدد بمجموعة من النقاط ذاتControlPoints./geometry/controlpoints  ومتصل بواسطةSegments./line/segments  مما يعني أنه يمكن أيضًا أن يكون مجموعة من مقاطع الخط المتصلة.NurbsCurve./nurbscurve .
type: docs
weight: 420
...
الخط متعدد الخطوط هو مسار محدد بمجموعة من النقاط ذات[`ControlPoints`](../geometry/controlpoints) ، ومتصل بواسطة[`Segments`](./segments) ، مما يعني أنه يمكن أيضًا أن يكون مجموعة من مقاطع الخط المتصلة.[`NurbsCurve`](../nurbscurve) .
...
| اسم | وصف |
| --- | --- |
| [Line](line#constructor)() | يقوم بتهيئة مثيل جديد لملف[`Line`](../line) فئة . |
| [Line](line#constructor_1)(string) | يقوم بتهيئة مثيل جديد لملف[`Line`](../line) فئة . |
...
| [Segments](../../aspose.threed.entities/line/segments) { get; } | يحصل على شرائح السطر |
| [Visible](../../aspose.threed.entities/line/visible) { get; set; } | يحصل أو يحدد إذا كانت الهندسة مرئية |

## طُرق

| اسم | وصف |
| --- | --- |
| static [FromPoints](../../aspose.threed.entities/line/frompoints)(params Vector3[]) | إنشاء أ[`Line`](../line) مثيل من مجموعة من النقاط. |
...
| [MakeDefaultIndices](../../aspose.threed.entities/line/makedefaultindices)() | إنشاء التسلسل 0،1،2،3 ....[`ControlPoints`](../geometry/controlpoints) الطول من 1 إلى[`Segments`](./segments) لذلك يمكن استخدام نقاط التحكم كسطر واحد |

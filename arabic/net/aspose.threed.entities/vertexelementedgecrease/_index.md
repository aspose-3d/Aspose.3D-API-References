---
title: "الفئة VertexElementEdgeCrease"
second_title: "مرجع Aspose.3D for .NET API"
description: "الفئة Aspose.ThreeD.Entities.VertexElementEdgeCrease. تحدد طية الحافة للمكونات المحددة"
type: docs
weight: 850
url: /ar/net/aspose.threed.entities/vertexelementedgecrease/
---
## VertexElementEdgeCrease class

يحدد تجعد الحافة للمكونات المحددة.
...
| الاسم | الوصف |
| --- | --- |
| [VertexElementEdgeCrease](vertexelementedgecrease/)() | يُنشئ مثيلًا جديدًا من الفئة `VertexElementEdgeCrease`. |

## الخصائص

| الاسم | الوصف |
| --- | --- |
| [Data](../../aspose.threed.entities/vertexelementdoublestemplate/data/) { get; } | يحصل على بيانات الرأس |
...
| الاسم | الوصف |
| --- | --- |
| override [Clear](../../aspose.threed.entities/vertexelementdoublestemplate/clear/)() | يزيل جميع العناصر من المصفوفات المباشرة ومصفوفات الفهارس. |
| [CopyTo](../../aspose.threed.entities/vertexelementdoublestemplate/copyto/)(VertexElementDoublesTemplate) | ينسخ البيانات إلى العنصر المحدد |

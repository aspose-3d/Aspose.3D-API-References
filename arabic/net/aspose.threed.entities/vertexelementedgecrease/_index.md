...
description: يحدد تجعد الحافة لمكونات محددة
type: docs
weight: 790
...
يحدد تجعد الحافة لمكونات محددة
...
| اسم | وصف |
| --- | --- |
| [VertexElementEdgeCrease](vertexelementedgecrease)() | يقوم بتهيئة مثيل جديد لملف[`VertexElementEdgeCrease`](../vertexelementedgecrease) فئة . |

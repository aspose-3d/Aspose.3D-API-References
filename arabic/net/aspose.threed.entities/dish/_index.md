...
description: طبق ذو معايير .
type: docs
weight: 320
url: /ar/net/aspose.threed.entities/dish/
---
## Dish class
...
| اسم | وصف |
| --- | --- |
| [Dish](dish#constructor)() | إنشاء مثيل طبق جديد بنصف قطر افتراضي (10) وارتفاع افتراضي (5) |
| [Dish](dish#constructor_1)(double, double) | إنشاء مثيل جديد للطبق بنصف قطر وارتفاع محددين |
| [Dish](dish#constructor_2)(string, double, double, int, int) | إنشاء مثيل جديد للطبق بنصف قطر وارتفاع محددين |
...
| [Height](../../aspose.threed.entities/dish/height) { get; set; } | ارتفاع الطبق |
| [HeightSegments](../../aspose.threed.entities/dish/heightsegments) { get; set; } | الحصول على أو تعيين مقاطع الارتفاع |
...
| [Radius](../../aspose.threed.entities/dish/radius) { get; set; } | نصف قطر الطبق |
...
| [WidthSegments](../../aspose.threed.entities/dish/widthsegments) { get; set; } | الحصول على شرائح العرض أو تعيينها |
...
| override [ToMesh](../../aspose.threed.entities/dish/tomesh)() | تحويل الكائن الحالي إلى mesh |

...
description: الفئة الأساسية لجميع ملفات التعريف ذات المعلمات .
type: docs
weight: 1600
...
الفئة الأساسية لجميع ملفات التعريف ذات المعلمات .
...
| abstract [GetExtent](../../aspose.threed.profiles/parameterizedprofile/getextent)() | الحصول على المدى في البعد x و y . |

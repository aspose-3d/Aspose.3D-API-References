---
title: "الفئة ParameterizedProfile"
second_title: "مرجع Aspose.3D for .NET API"
description: "فئة Aspose.ThreeD.Profiles.ParameterizedProfile. الفئة الأساسية لجميع الملفات المعيّنة"
type: docs
weight: 1780
url: /ar/net/aspose.threed.profiles/parameterizedprofile/
---
## ParameterizedProfile class

الفئة الأساسية لجميع الملفات الشخصية المعيّنة بالمعلمات.
...
| abstract [GetExtent](../../aspose.threed.profiles/parameterizedprofile/getextent/)() | يحصل على الامتداد في بعدي x و y. |

...
description: ملف تعريف شكل Z متوافق مع IFC محدد بواسطة المعلمات.
type: docs
weight: 1660
...
ملف تعريف شكل Z متوافق مع IFC محدد بواسطة المعلمات.
...
| اسم | وصف |
| --- | --- |
| [ZShape](zshape)() | منشئ[`ZShape`](../zshape) |

## الخصائص

| اسم | وصف |
| --- | --- |
| [Depth](../../aspose.threed.profiles/zshape/depth) { get; set; } | الحصول على طول الويب أو تحديده . |
| [EdgeRadius](../../aspose.threed.profiles/zshape/edgeradius) { get; set; } | الحصول على أو تحديد نصف قطر حافة الحافة. |
| [Excluded](../../aspose.threed/entity/excluded) { get; set; } | الحصول على أو تعيين ما إذا كان سيتم استبعاد هذا الكيان أثناء التصدير. |
| [FilletRadius](../../aspose.threed.profiles/zshape/filletradius) { get; set; } | الحصول على أو تحديد نصف قطر الشريحة بين الحافة والويب. |
| [FlangeThickness](../../aspose.threed.profiles/zshape/flangethickness) { get; set; } | الحصول على سمك الشفة أو تحديده . |
| [FlangeWidth](../../aspose.threed.profiles/zshape/flangewidth) { get; set; } | الحصول على أو تحديد طول الحافة . |
...
| [WebThickness](../../aspose.threed.profiles/zshape/webthickness) { get; set; } | الحصول على سمك الجدار أو تحديده. |
...
| override [GetExtent](../../aspose.threed.profiles/zshape/getextent)() | الحصول على المدى في البعد x و y . |

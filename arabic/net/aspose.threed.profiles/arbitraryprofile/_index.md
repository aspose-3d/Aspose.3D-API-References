...
| اسم | وصف |
| --- | --- |
| [ArbitraryProfile](arbitraryprofile#constructor)() | منشئ[`ArbitraryProfile`](../arbitraryprofile) |
| [ArbitraryProfile](arbitraryprofile#constructor_1)(Curve) | منشئ[`ArbitraryProfile`](../arbitraryprofile) مع منحنى أولي . |

## الخصائص

| اسم | وصف |
| --- | --- |
| [Curve](../../aspose.threed.profiles/arbitraryprofile/curve) { get; set; } | المنحنى المستخدم لبناء ملف التعريف |

...
description: "فئة Aspose.ThreeD.Formats.JtLoadOptions. خيارات التحميل لـ Siemens JT"
type: docs
weight: 1310
...
| [LoadPMI](../../aspose.threed.formats/jtloadoptions/loadpmi/) { get; set; } | تحميل معلومات PMI من ملف JT إذا كان ذلك ممكنًا، سيتم حفظ البيانات كخاصية "PMI" لـ [`AssetInfo`](../../aspose.threed/scene/assetinfo/). القيمة الافتراضية هي false. |

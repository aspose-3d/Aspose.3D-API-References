...
description: "Aspose.ThreeD.Formats.SaveOptions الفئة. الفئة الأساسية لتكوين الخيارات عند حفظ الملفات لأنواع مختلفة"
type: docs
weight: 1490
...
الفئة الأساسية لتكوين الخيارات عند حفظ الملفات لأنواع مختلفة.

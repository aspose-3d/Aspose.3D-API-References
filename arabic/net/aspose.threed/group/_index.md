...
description: "الفئة Aspose.ThreeD.Group. تمثل مجموعة Group العلاقات المنطقية لعقدة Node"
type: docs
weight: 1570
...
تمثل `Group` العلاقات المنطقية لـ [`Node`](../node/).
...
| الاسم | الوصف |
| --- | --- |
| [Group](group/)(string) | إنشاء نسخة جديدة من `Group` |

...
description: Tüm parametreli profillerin temel sınıfı.
type: docs
weight: 1600
url: /tr/net/aspose.threed.profiles/parameterizedprofile/
---
## ParameterizedProfile class

Tüm parametreli profillerin temel sınıfı.
...
| abstract [GetExtent](../../aspose.threed.profiles/parameterizedprofile/getextent)() | Kapsamı x ve y boyutunda alır. |

...
description: Parametrelerle tanımlanan IFC uyumlu elips şekli. Profilin merkez konumu sınırlama kutusunun ortasındadır.
type: docs
weight: 1540
url: /tr/net/aspose.threed.profiles/ellipseshape/
---
## EllipseShape class
...
| [SemiAxis1](../../aspose.threed.profiles/ellipseshape/semiaxis1) { get; set; } | x ekseni yönünde ölçülen elipsin ilk yarıçapını alır veya ayarlar. |
| [SemiAxis2](../../aspose.threed.profiles/ellipseshape/semiaxis2) { get; set; } | Y ekseni yönünde ölçülen elipsin ikinci yarıçapını alır veya ayarlar. |
...
| override [GetExtent](../../aspose.threed.profiles/ellipseshape/getextent)() | Kapsamı x ve y boyutunda alır. |

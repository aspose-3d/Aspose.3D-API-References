...
description: Tüm varlıkların temel sınıfı. Varlık aşağıdaki gibi bir düğüm altına eklenen somut bir nesneyi temsil eder.Light../aspose.threed.entities/light/Geometry../aspose.threed.entities/geometry .
type: docs
weight: 970
url: /tr/net/aspose.threed/entity/
---
## Entity class

Tüm varlıkların temel sınıfı. Varlık, aşağıdaki gibi bir düğüm altına eklenen somut bir nesneyi temsil eder.[`Light`](../../aspose.threed.entities/light)/[`Geometry`](../../aspose.threed.entities/geometry) .
...
| İsim | Tanım |
| --- | --- |
| [Entity](entity)(string) | Yeni bir örneğini başlatır[`Entity`](../entity) sınıf. |

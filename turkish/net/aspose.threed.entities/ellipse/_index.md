...
description: BirEllipse./ellipseelips şeklini oluşturan bir dizi nokta tanımlar.
type: docs
weight: 330
url: /tr/net/aspose.threed.entities/ellipse/
---
## Ellipse class

Bir[`Ellipse`](../ellipse)elips şeklini oluşturan bir dizi nokta tanımlar.
...
| İsim | Tanım |
| --- | --- |
| [Ellipse](ellipse#constructor)() | Oluşturucusu[`Ellipse`](../ellipse) |
| [Ellipse](ellipse#constructor_1)(double, double) | Oluşturucusu[`Ellipse`](../ellipse) |
...
| [SemiAxis1](../../aspose.threed.entities/ellipse/semiaxis1) { get; set; } | X eksenindeki yarıçap |
| [SemiAxis2](../../aspose.threed.entities/ellipse/semiaxis2) { get; set; } | Y eksenindeki yarıçap |

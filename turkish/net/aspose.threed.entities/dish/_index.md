...
description: Parametreli çanak.
type: docs
weight: 320
url: /tr/net/aspose.threed.entities/dish/
---
## Dish class
...
| İsim | Tanım |
| --- | --- |
| [Dish](dish#constructor)() | Varsayılan yarıçap(10) ve varsayılan yükseklik(5) ile yeni bir çanak örneği oluşturun |
| [Dish](dish#constructor_1)(double, double) | Belirtilen yarıçap ve yükseklik ile yeni bir çanak örneği oluşturun |
| [Dish](dish#constructor_2)(string, double, double, int, int) | Belirtilen yarıçap ve yükseklik ile yeni bir çanak örneği oluşturun |
...
| [Height](../../aspose.threed.entities/dish/height) { get; set; } | Çanağın yüksekliği |
| [HeightSegments](../../aspose.threed.entities/dish/heightsegments) { get; set; } | Yükseklik segmentlerini alır veya ayarlar |
...
| [Radius](../../aspose.threed.entities/dish/radius) { get; set; } | Çanağın yarıçapı |
...
| [WidthSegments](../../aspose.threed.entities/dish/widthsegments) { get; set; } | Genişlik segmentlerini alır veya ayarlar |
...
| override [ToMesh](../../aspose.threed.entities/dish/tomesh)() | Geçerli nesneyi mesh biçimine dönüştürün |

...
description: Farklı türler için dosya kaydetme seçeneklerini yapılandırmak için temel sınıf
type: docs
weight: 1340
url: /tr/net/aspose.threed.formats/saveoptions/
---
## SaveOptions class

Farklı türler için dosya kaydetme seçeneklerini yapılandırmak için temel sınıf

...
description: AMF için seçenekleri kaydedin
type: docs
weight: 1030
url: /tr/net/aspose.threed.formats/amfsaveoptions/
---
## AmfSaveOptions class

AMF için seçenekleri kaydedin
...
| İsim | Tanım |
| --- | --- |
| [AmfSaveOptions](amfsaveoptions)() | Oluşturucusu[`AmfSaveOptions`](../amfsaveoptions) |

## Özellikleri

| İsim | Tanım |
| --- | --- |
| [EnableCompression](../../aspose.threed.formats/amfsaveoptions/enablecompression) { get; set; } | Son dosya boyutunu küçültmek için sıkıştırma kullanılıp kullanılmayacağı, varsayılan değer true |

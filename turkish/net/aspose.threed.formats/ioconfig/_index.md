...
description: Serileştirme/seri durumdan çıkarma için IO yapılandırması. Kullanıcı bağımlılık arama yolu veya biçimle ilgili yapılandırmalar gibi ayrıntılı yapılandırmaları burada belirtebilir
type: docs
weight: 1180
url: /tr/net/aspose.threed.formats/ioconfig/
---
## IOConfig class
...
| static [FileSystemFactory](../../aspose.threed.formats/ioconfig/filesystemfactory) { get; set; } | FileSystem için fabrika sınıfını alır veya ayarlar. Varsayılan fabrika[`LocalFileSystem`](../../aspose.threed.utilities/localfilesystem) sunucu ortamı için uygun olmayan. |

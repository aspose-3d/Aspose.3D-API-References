...
type: docs
weight: 1250
url: /tr/net/aspose.threed.formats/pdfloadoptions/
---
...
| İsim | Tanım |
| --- | --- |
| [PdfLoadOptions](pdfloadoptions)() | Oluşturucusu[`PdfLoadOptions`](../pdfloadoptions) |
...
| [Password](../../aspose.threed.formats/pdfloadoptions/password) { get; set; } | Şifrelenmiş PDF dosyasının kilidini açmak için parola. |

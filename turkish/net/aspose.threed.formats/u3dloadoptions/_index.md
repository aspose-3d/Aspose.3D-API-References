...
type: docs
weight: 1370
url: /tr/net/aspose.threed.formats/u3dloadoptions/
---
...
| İsim | Tanım |
| --- | --- |
| [U3dLoadOptions](u3dloadoptions)() | Oluşturucusu[`U3dLoadOptions`](../u3dloadoptions) |
...
| [FlipCoordinateSystem](../../aspose.threed.formats/u3dloadoptions/flipcoordinatesystem) { get; set; } | Alma/dışa aktarma sırasında kontrol noktalarının çevirme koordinat sisteminin/normal olup olmadığını alır veya ayarlar. |

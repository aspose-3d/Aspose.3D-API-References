...
type: docs
weight: 1290
url: /tr/net/aspose.threed.formats/plyloadoptions/
---
...
| İsim | Tanım |
| --- | --- |
| [PlyLoadOptions](plyloadoptions)() | Oluşturucusu[`PlyLoadOptions`](../plyloadoptions) |
...
| [FlipCoordinateSystem](../../aspose.threed.formats/plyloadoptions/flipcoordinatesystem) { get; set; } | İçe aktarma/dışa aktarma sırasında kontrol noktalarının/normalin çevirme koordinat sistemini alır veya ayarlar. |

...
description: "Bir  dönüşüm matrisi kullanarak bir eğriye konum verir."
type: docs
weight: 192
url: /tr/java/com.aspose.threed/transformedcurve/
---
...
Bir [TransformedCurve](../../com.aspose.threed/transformedcurve) dönüşüm matrisi kullanarak bir eğriye konum verir. Bu, bir [TrimmedCurve](../../com.aspose.threed/trimmedcurve) veya [CompositeCurve](../../com.aspose.threed/compositecurve) içinde bir dönüşüm gerçekleştirmeyi sağlar.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [TransformedCurve()](#TransformedCurve--) | [TransformedCurve](../../com.aspose.threed/transformedcurve) yapıcısı |
| [TransformedCurve(Curve basisCurve, Matrix4 transformation)](#TransformedCurve-com.aspose.threed.Curve-com.aspose.threed.Matrix4-) | [TransformedCurve](../../com.aspose.threed/transformedcurve) yapıcısı |
## Yöntemler
...
| [getBasisCurve()](#getBasisCurve--) | Temel eğri. |
...
| [getTransformMatrix()](#getTransformMatrix--) | Dönüşüm matrisi. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setBasisCurve(Curve value)](#setBasisCurve-com.aspose.threed.Curve-) | Temel eğri. |
...
| [setTransformMatrix(Matrix4 value)](#setTransformMatrix-com.aspose.threed.Matrix4-) | Dönüşüm matrisi. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[TransformedCurve](../../com.aspose.threed/transformedcurve) yapıcısı

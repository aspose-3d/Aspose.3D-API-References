...
description: "Siemens JT için yükleme seçenekleri"
type: docs
weight: 88
url: /tr/java/com.aspose.threed/jtloadoptions/
---
...
Siemens JT için yükleme seçenekleri
## Yapıcılar
...
| [getLoadPMI()](#getLoadPMI--) | Mümkünse JT dosyasından PMI bilgilerini yükle, veri [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo) özelliği "PMI" olarak kaydedilecektir. |
| [getLoadProperties()](#getLoadProperties--) | JT'nin özellik tablosundan özellikleri Aspose.3D özellikleri olarak yükle. |
...
| [setLoadPMI(boolean value)](#setLoadPMI-boolean-) | Mümkünse JT dosyasından PMI bilgilerini yükle, veri [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo) özelliği "PMI" olarak kaydedilecektir. |
| [setLoadProperties(boolean value)](#setLoadProperties-boolean-) | JT'nin özellik tablosundan özellikleri Aspose.3D özellikleri olarak yükle. |
...
Mümkünse JT dosyasından PMI bilgilerini yükle, veri [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo) özelliği "PMI" olarak kaydedilecektir. Varsayılan değer false'tur.

**Returns:**
boolean - Mümkünse JT dosyasından PMI bilgilerini yükle, veri [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo) özelliği "PMI" olarak kaydedilecektir. Varsayılan değer false'tur.
...
JT'nin özellik tablosundan özellikleri Aspose.3D özellikleri olarak yükle. Varsayılan değer false'tur.

**Returns:**
boolean - JT'nin özellik tablosundan özellikleri Aspose.3D özellikleri olarak yükle. Varsayılan değer false'tur.

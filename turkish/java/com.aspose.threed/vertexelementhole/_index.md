...
description: "Belirtilen çokgenin bir delik olup olmadığını tanımlar"
type: docs
weight: 211
url: /tr/java/com.aspose.threed/vertexelementhole/
---
...
Belirtilen çokgenin bir delik olup olmadığını tanımlar
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [VertexElementHole()](#VertexElementHole--) | Yeni bir [VertexElementHole](../../com.aspose.threed/vertexelementhole) sınıfı örneği başlatır. |
## Yöntemler
...
Yeni bir [VertexElementHole](../../com.aspose.threed/vertexelementhole) sınıfı örneği başlatır.

...
description: "6/13/2017 tarihinde lexchou tarafından oluşturuldu."
type: docs
weight: 101
url: /tr/java/com.aspose.threed/memorystream/
---
...
6/13/2017 tarihinde lexchou tarafından oluşturuldu.
## Yapıcılar
...
| [setCapacity(int cap)](#setCapacity-int-) | Kapasiteyi belirtilen değere ayarlar |
...
| [wrap(OutputStream stream)](#wrap-java.io.OutputStream-) | Bir OutputStream'i Stream olarak sarmalayın, verileri çıkış akışına boşaltmak için akış kapatılmalıdır. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| baytlar | com.aspose.threed.ByteSpan |  |
...
Kapasiteyi belirtilen değere ayarlar

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| kap | int | bellek akışının yeni kapasitesi. |
...
Bir OutputStream'i Stream olarak sarmalayın, verileri çıkış akışına boşaltmak için akış kapatılmalıdır.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| akış | java.io.OutputStream | sarmalanacak çıktı akışı |

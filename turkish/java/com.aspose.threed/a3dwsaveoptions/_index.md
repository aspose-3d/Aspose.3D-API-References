...
description: "A3DW formatı için kaydetme seçenekleri."
type: docs
weight: 11
url: /tr/java/com.aspose.threed/a3dwsaveoptions/
---
...
A3DW formatı için kaydetme seçenekleri.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [A3dwSaveOptions()](#A3dwSaveOptions--) | [A3dwSaveOptions](../../com.aspose.threed/a3dwsaveoptions) yapıcısı |
## Yöntemler
...
| [getExportMetaData()](#getExportMetaData--) | Scene/Node ile ilişkili meta verileri istemciye aktar. Varsayılan değer true. |
...
| [getMetaDataPrefix()](#getMetaDataPrefix--) | Bu özellik null değilse, yalnızca bu önekle başlayan Scene/Node özellikleri aktarılacak ve önek kaldırılacaktır. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEncoding(Charset value)](#setEncoding-java.nio.charset.Charset-) | Metin tabanlı dosyalar için varsayılan kodlamayı ayarlar. |
| [setExportMetaData(boolean value)](#setExportMetaData-boolean-) | Scene/Node ile ilişkili meta verileri istemciye aktar. Varsayılan değer true. |
...
| [setMetaDataPrefix(String value)](#setMetaDataPrefix-java.lang.String-) | Bu özellik null değilse, yalnızca bu önekle başlayan Scene/Node özellikleri aktarılacak ve önek kaldırılacaktır. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[A3dwSaveOptions](../../com.aspose.threed/a3dwsaveoptions) yapıcısı
...
Scene/Node ile ilişkili meta verileri istemciye aktar. Varsayılan değer true.

**Returns:**
boolean - Scene/Node ile ilişkili meta verileri istemciye aktar. Varsayılan değer true.
...
Bu özellik null değilse, yalnızca bu önekle başlayan Scene/Node özellikleri aktarılacak ve önek kaldırılacaktır.

**Returns:**
java.lang.String - Bu özellik null değilse, yalnızca bu önekle başlayan Scene/Node özellikleri aktarılacak ve önek kaldırılacaktır.
### hashCode() {#hashCode--}
```

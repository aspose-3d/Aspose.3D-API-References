...
description: "Bir skin deformer, çalışmak için birden fazla kemik içerir; her kemik, kontrol noktası ağırlıklarıyla geometrinin bir bölümünü harmanlar."
type: docs
weight: 173
url: /tr/java/com.aspose.threed/skindeformer/
---
...
Bir skin deformeri, çalışmak için birden fazla kemik içerir, her kemik kontrol noktalarının ağırlıklarıyla geometrinin bir bölümünü harmanlar.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [SkinDeformer(String name)](#SkinDeformer-java.lang.String-) | Yeni bir [SkinDeformer](../../com.aspose.threed/skindeformer) sınıfı örneği başlatır. |
| [SkinDeformer()](#SkinDeformer--) | Yeni bir [SkinDeformer](../../com.aspose.threed/skindeformer) sınıfı örneği başlatır. |
## Yöntemler
...
| [getBones()](#getBones--) | Skin deformer'ın içerdiği tüm kemikleri alır |
| [getClass()](#getClass--) |  |
...
Yeni bir [SkinDeformer](../../com.aspose.threed/skindeformer) sınıfı örneği başlatır.
...
Skin deformer'ın içerdiği tüm kemikleri alır

**Returns:**
java.util.List<com.aspose.threed.Bone> - skin deformer'ın içerdiği tüm kemikler
### getClass() {#getClass--}
```

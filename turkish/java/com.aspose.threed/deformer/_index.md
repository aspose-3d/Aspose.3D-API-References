...
description: "İçin temel sınıf  ve"
type: docs
weight: 41
url: /tr/java/com.aspose.threed/deformer/
---
...
İçin temel sınıf [SkinDeformer](../../com.aspose.threed/skindeformer) ve [MorphTargetDeformer](../../com.aspose.threed/morphtargetdeformer)
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [Deformer(String name)](#Deformer-java.lang.String-) | Yeni bir [Deformer](../../com.aspose.threed/deformer) sınıfı örneği başlatır. |
## Yöntemler
...
Yeni bir [Deformer](../../com.aspose.threed/deformer) sınıfı örneği başlatır.

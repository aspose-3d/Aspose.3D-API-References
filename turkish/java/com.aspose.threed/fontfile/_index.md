...
description: "Yazı tipi dosyası, glif tanımlarını içerir; bu, metin profili oluşturmak için kullanılır."
type: docs
weight: 68
url: /tr/java/com.aspose.threed/fontfile/
---
...
Yazı tipi dosyası, glif tanımlarını içerir, bu metin profili oluşturmak için kullanılır. **Example:** Aşağıdaki kod, belirtilen yazı tipi dosyasını kullanarak metinden 3B bir ağ oluşturmanın nasıl yapılacağını gösterir.
...
| [fromFile(String fileName)](#fromFile-java.lang.String-) | FontFile'ı dosya adından yükle |
| [getClass()](#getClass--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [parse(byte[] bytes)](#parse-byte---) | FontFile'ı baytlardan ayrıştır |
...
FontFile'ı dosya adından yükle

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| fileName | java.lang.String | Yazı tipi dosyasının yolu |
...
FontFile'ı baytlardan ayrıştır

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| baytlar | byte[] | OTF yazı tipi dosyasının ham içeriği |

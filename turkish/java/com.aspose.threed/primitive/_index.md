...
description: "Tüm primitive'ler için temel sınıf"
type: docs
weight: 137
url: /tr/java/com.aspose.threed/primitive/
---
...
Tüm primitive'ler için temel sınıf
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [Primitive(String name)](#Primitive-java.lang.String-) | Yeni bir [Primitive](../../com.aspose.threed/primitive) sınıfı örneği başlatır. |
## Yöntemler
...
Yeni bir [Primitive](../../com.aspose.threed/primitive) sınıfı örneği başlatır.

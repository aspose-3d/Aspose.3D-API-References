...
description: "Parametrik düzlem."
type: docs
weight: 128
url: /tr/java/com.aspose.threed/plane/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [Plane()](#Plane--) | Varsayılan boyut 1x1 ile yeni bir [Plane](../../com.aspose.threed/plane) örneği başlatır. |
| [Plane(double length, double width)](#Plane-double-double-) | Yeni bir [Plane](../../com.aspose.threed/plane) örneği başlatır. |
| [Plane(String name, double length, double width, int lengthSegments, int widthSegments)](#Plane-java.lang.String-double-double-int-int-) | Yeni bir [Plane](../../com.aspose.threed/plane) örneği başlatır. |
## Yöntemler
...
| [getLength()](#getLength--) | Düzlemin uzunluğunu alır. |
...
| [getUp()](#getUp--) | Düzlemin yukarı vektörünü alır, varsayılan değer (0, 1, 0)'dır, bu düzlemin oluşturulmasını etkiler. |
| [getWidth()](#getWidth--) | Düzlemin genişliğini alır. |
...
| [setLength(double value)](#setLength-double-) | Düzlemin uzunluğunu ayarlar. |
...
| [setUp(Vector3 value)](#setUp-com.aspose.threed.Vector3-) | Düzlemin yukarı vektörünü ayarlar, varsayılan değer (0, 1, 0)'dır, bu düzlemin oluşturulmasını etkiler. |
| [setWidth(double value)](#setWidth-double-) | Düzlemin genişliğini ayarlar. |
...
Varsayılan boyut 1x1 ile yeni bir [Plane](../../com.aspose.threed/plane) örneği başlatır.
...
Yeni bir [Plane](../../com.aspose.threed/plane) örneği başlatır.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| uzunluk | double | Düzlemin uzunluğu. |
| genişlik | double | Düzlemin genişliği. |
...
Düzlemin uzunluğunu alır.

**Returns:**
double - düzlemin uzunluğu.
...
Düzlemin yukarı vektörünü alır, varsayılan değer (0, 1, 0)'dır, bu düzlemin oluşturulmasını etkiler.
...
Düzlemin genişliğini alır.

**Returns:**
double - düzlemin genişliği.
...
Düzlemin yukarı vektörünü ayarlar, varsayılan değer (0, 1, 0)'dır, bu düzlemin oluşturulmasını etkiler.

...
description: "Belirtilen bileşenler için kenar kıvrımını tanımlar"
type: docs
weight: 210
url: /tr/java/com.aspose.threed/vertexelementedgecrease/
---
...
Belirtilen bileşenler için kenar kıvrımını tanımlar
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [VertexElementEdgeCrease()](#VertexElementEdgeCrease--) | Yeni bir [VertexElementEdgeCrease](../../com.aspose.threed/vertexelementedgecrease) sınıfının örneğini başlatır. |
## Yöntemler
...
Yeni bir [VertexElementEdgeCrease](../../com.aspose.threed/vertexelementedgecrease) sınıfının örneğini başlatır.

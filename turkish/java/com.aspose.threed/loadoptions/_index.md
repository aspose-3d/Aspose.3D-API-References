...
description: "Farklı tipler için dosya yüklemede seçenekleri yapılandırmak amacıyla temel sınıf."
type: docs
weight: 97
url: /tr/java/com.aspose.threed/loadoptions/
---
...
Farklı tipler için dosya yüklemede seçenekleri yapılandırmak amacıyla temel sınıf.
## Yöntemler

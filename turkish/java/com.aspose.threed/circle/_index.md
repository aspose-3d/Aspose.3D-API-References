...
description: "Bir eğri, daire şeklinin kenarındaki bir dizi noktadan oluşur."
type: docs
weight: 31
url: /tr/java/com.aspose.threed/circle/
---
...
Bir [Circle](../../com.aspose.threed/circle) eğri, daire şeklinin kenarındaki bir dizi noktadan oluşur.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [Circle()](#Circle--) | Yapıcı [Circle](../../com.aspose.threed/circle) |
| [Circle(double radius)](#Circle-double-) | Yapıcı [Circle](../../com.aspose.threed/circle) |
## Yöntemler
...
| [getRadius()](#getRadius--) | Dairenin eğri yarıçapı, varsayılan değer 10'dur |
...
| [setRadius(double value)](#setRadius-double-) | Dairenin eğri yarıçapı, varsayılan değer 10'dur |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Yapıcı [Circle](../../com.aspose.threed/circle)
...
| --- | --- | --- |
| yarıçap | double | Dairenin eğri yarıçapı. |
...
Dairenin eğri yarıçapı, varsayılan değer 10'dur

**Returns:**
double - Dairenin eğri yarıçapı, varsayılan değer 10'dur
### getScene() {#getScene--}
```

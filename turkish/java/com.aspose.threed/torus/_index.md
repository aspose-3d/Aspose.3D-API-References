...
type: docs
weight: 189
url: /tr/java/com.aspose.threed/torus/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [Torus()](#Torus--) | Yeni bir [Torus](../../com.aspose.threed/torus) sınıfı örneği başlatır. |
| [Torus(double radius, double tube)](#Torus-double-double-) | Yeni bir [Torus](../../com.aspose.threed/torus) sınıfı örneği başlatır. |
| [Torus(double radius, double tube, double arc)](#Torus-double-double-double-) | Yeni bir [Torus](../../com.aspose.threed/torus) sınıfı örneği başlatır. |
| [Torus(String name, double radius, double tube, int radialSegments, int tubularSegments, double arc)](#Torus-java.lang.String-double-double-int-int-double-) | Yeni bir [Torus](../../com.aspose.threed/torus) sınıfı örneği başlatır. |
## Yöntemler
...
| [getArc()](#getArc--) | Yay değerini alır. |
...
| [getRadius()](#getRadius--) | Torusun yarıçapını alır. |
...
| [getTube()](#getTube--) | Tüpün yarıçapını alır. |
| [getTubularSegments()](#getTubularSegments--) | Tübl segmentlerini alır. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setArc(double value)](#setArc-double-) | Yayı ayarlar. |
...
| [setRadius(double value)](#setRadius-double-) | Torusun yarıçapını ayarlar. |
| [setReceiveShadows(boolean value)](#setReceiveShadows-boolean-) | Bu geometrinin gölge alıp almayacağını ayarlar. |
| [setTube(double value)](#setTube-double-) | Tüpün yarıçapını ayarlar. |
| [setTubularSegments(int value)](#setTubularSegments-int-) | Tübl segmentlerini ayarlar. |
...
Yeni bir [Torus](../../com.aspose.threed/torus) sınıfı örneği başlatır.

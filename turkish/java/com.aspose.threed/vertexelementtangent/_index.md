...
description: "Belirtilen bileşenler için teğet vektörleri tanımlar."
type: docs
weight: 218
url: /tr/java/com.aspose.threed/vertexelementtangent/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [VertexElementTangent()](#VertexElementTangent--) | Yeni bir [VertexElementTangent](../../com.aspose.threed/vertexelementtangent) sınıfının örneğini başlatır. |
## Yöntemler
...
Yeni bir [VertexElementTangent](../../com.aspose.threed/vertexelementtangent) sınıfının örneğini başlatır.

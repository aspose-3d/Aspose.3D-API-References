...
description: "Collada için kaydetme seçenekleri"
type: docs
weight: 33
url: /tr/java/com.aspose.threed/colladasaveoptions/
---
...
Collada için kaydetme seçenekleri
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [ColladaSaveOptions()](#ColladaSaveOptions--) | Yapıcı [ColladaSaveOptions](../../com.aspose.threed/colladasaveoptions) |
## Yöntemler
...
| [getIndented()](#getIndented--) | Dışa aktarılan XML belgesinin girintili olup olmadığını alır. |
...
| [getTransformStyle()](#getTransformStyle--) | Düğüm dönüşümünün stilini alır. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setIndented(boolean value)](#setIndented-boolean-) | Dışa aktarılan XML belgesinin girintili olup olmadığını ayarlar. |
...
| [setTransformStyle(ColladaTransformStyle value)](#setTransformStyle-com.aspose.threed.ColladaTransformStyle-) | Düğüm dönüşümünün stilini ayarlar. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Yapıcı [ColladaSaveOptions](../../com.aspose.threed/colladasaveoptions)
...
Dışa aktarılan XML belgesinin girintili olup olmadığını alır.

**Returns:**
boolean - dışa aktarılan XML belgesinin girintili olup olmadığı.
...
Düğüm dönüşümünün stilini alır.
...
Dışa aktarılan XML belgesinin girintili olup olmadığını ayarlar.
...
Düğüm dönüşümünün stilini ayarlar.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| value | [ColladaTransformStyle](../../com.aspose.threed/colladatransformstyle) | Yeni değer |

...
description: "Bu, okuma/yazma işlemlerini belleğe eşler."
type: docs
weight: 95
url: /tr/java/com.aspose.threed/memoryfilesystem/
---
...
Bu [MemoryFileSystem](../../com.aspose.threed/memoryfilesystem), okuma/yazma işlemlerini belleğe eşler. **Örnek:** Aşağıdaki kod, dosyanın belleğe nasıl dışa aktarılacağını gösterir, bağımlı dosyayı MemoryFileSystem kullanarak dahil eder.
...
| [getClass()](#getClass--) |  |
| [getFileContent(String fileName)](#getFileContent-java.lang.String-) | Belirtilen dosyanın ham içeriğini döndürür. |
| [getFileNames()](#getFileNames--) | Bu bellek dosya sistemindeki dosya adları. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Belirtilen dosyanın ham içeriğini döndürür. Belirtilen dosya mevcut değilse java.io.FileNotFoundException fırlatır.

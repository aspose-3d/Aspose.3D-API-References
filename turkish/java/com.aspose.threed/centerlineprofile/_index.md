...
description: "IFC uyumlu merkez hat profili"
type: docs
weight: 30
url: /tr/java/com.aspose.threed/centerlineprofile/
---
...
IFC uyumlu merkez hat profili
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [CenterLineProfile(Curve curve, double thickness)](#CenterLineProfile-com.aspose.threed.Curve-double-) | Belirtilen eğriyi merkez hat olarak kullanarak yeni bir [CenterLineProfile](../../com.aspose.threed/centerlineprofile) oluşturur. |
| [CenterLineProfile(Curve curve)](#CenterLineProfile-com.aspose.threed.Curve-) | Belirtilen eğriyi merkez hat olarak kullanarak yeni bir [CenterLineProfile](../../com.aspose.threed/centerlineprofile) oluşturur. |
## Yöntemler
...
| [getClass()](#getClass--) |  |
| [getCurve()](#getCurve--) | Profilin merkez hat eğrisi |
...
| [getThickness()](#getThickness--) | Merkez hat boyunca uygulanan kalınlık |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setCurve(Curve value)](#setCurve-com.aspose.threed.Curve-) | Profilin merkez hat eğrisi |
...
| [setThickness(double value)](#setThickness-double-) | Merkez hat boyunca uygulanan kalınlık |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Belirtilen eğriyi merkez hat olarak kullanarak yeni bir [CenterLineProfile](../../com.aspose.threed/centerlineprofile) oluşturur.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Merkez hat eğrisi |
| kalınlık | double | Merkez hat boyunca uygulanan kalınlık |
...
Merkez hat boyunca uygulanan kalınlık

**Returns:**
double - Merkez hat boyunca uygulanan kalınlık
### hashCode() {#hashCode--}
```

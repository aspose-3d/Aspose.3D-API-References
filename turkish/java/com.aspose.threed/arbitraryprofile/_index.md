...
description: "Bu sınıf, rastgele bir eğriden doğrudan 2D profil oluşturmanıza olanak tanır."
type: docs
weight: 16
url: /tr/java/com.aspose.threed/arbitraryprofile/
---
...
Bu sınıf, rastgele bir eğriden doğrudan 2D profil oluşturmanıza olanak tanır.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [ArbitraryProfile()](#ArbitraryProfile--) | Yapıcı [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) |
| [ArbitraryProfile(Curve curve)](#ArbitraryProfile-com.aspose.threed.Curve-) | Yapıcı [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) bir başlangıç eğrisi ile. |
## Yöntemler
...
| [getClass()](#getClass--) |  |
| [getCurve()](#getCurve--) | Profil oluşturmak için kullanılan Eğri |
...
| [getHoles()](#getHoles--) | Profilin delikleri, ayrıca eğri olarak temsil edilir |
...
| [setCurve(Curve value)](#setCurve-com.aspose.threed.Curve-) | Profil oluşturmak için kullanılan Eğri |
...
Yapıcı [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile)
...
Yapıcı [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) bir başlangıç eğrisi ile.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Profilin başlangıç eğrisi |
...
Profil oluşturmak için kullanılan Eğri
...
Profilin delikleri, ayrıca eğri olarak temsil edilir

**Returns:**
java.util.ArrayList<com.aspose.threed.Curve> - Profilin delikleri, ayrıca eğri olarak temsil edilir
### getName() {#getName--}
```

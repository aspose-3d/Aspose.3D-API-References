...
description: "Belirtilen bileşenler için özel kullanıcı verilerini tanımlar."
type: docs
weight: 221
url: /tr/java/com.aspose.threed/vertexelementuserdata/
---
...
Belirtilen bileşenler için özel kullanıcı verisi tanımlar. Genellikle özel amaçlı, uygulamaya özgü veridir.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [VertexElementUserData()](#VertexElementUserData--) | Yeni bir [VertexElementUserData](../../com.aspose.threed/vertexelementuserdata) sınıfının bir örneğini başlatır. |
## Yöntemler
...
| [getClass()](#getClass--) |  |
| [getData()](#getData--) | Bu öğeye eklenmiş kullanıcı verisi |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(Object value)](#setData-java.lang.Object-) | Bu öğeye eklenmiş kullanıcı verisi |
...
Yeni bir [VertexElementUserData](../../com.aspose.threed/vertexelementuserdata) sınıfının bir örneğini başlatır.
...
Bu öğeye eklenmiş kullanıcı verisi

**Returns:**
java.lang.Object - Bu öğeye eklenmiş kullanıcı verisi

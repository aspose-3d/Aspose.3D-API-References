...
description: "IFC uyumlu boş daire profili."
type: docs
weight: 78
url: /tr/java/com.aspose.threed/hollowcircleshape/
---
...
| [getWallThickness()](#getWallThickness--) | Dış ve iç yarıçap arasındaki farkı alır. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setWallThickness(double value)](#setWallThickness-double-) | Dış ve iç yarıçap arasındaki farkı ayarlar. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Dış ve iç yarıçap arasındaki farkı alır.

**Returns:**
double - dış ve iç yarıçap arasındaki fark.
### hashCode() {#hashCode--}
```
...
Dış ve iç yarıçap arasındaki farkı ayarlar.

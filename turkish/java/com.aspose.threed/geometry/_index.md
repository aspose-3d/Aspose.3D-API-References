...
description: "Tüm renderlanabilir geometrik nesnelerin temel sınıfı, örneğin    ve benzeri."
type: docs
weight: 71
url: /tr/java/com.aspose.threed/geometry/
---
...
Tüm renderlanabilir geometrik nesnelerin temel sınıfı (örneğin [Mesh](../../com.aspose.threed/mesh), [NurbsSurface](../../com.aspose.threed/nurbssurface), [Patch](../../com.aspose.threed/patch) ve benzeri).

[Geometry](../../com.aspose.threed/geometry) temel sınıfı şunları destekler:
...
| Yapıcı | Açıklama |
| --- | --- |
| [Geometry(String name)](#Geometry-java.lang.String-) | Yeni bir [Geometry](../../com.aspose.threed/geometry) sınıfı örneği başlatır. |
## Yöntemler
...
Yeni bir [Geometry](../../com.aspose.threed/geometry) sınıfı örneği başlatır.

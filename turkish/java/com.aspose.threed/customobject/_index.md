...
description: "3D dosyalarda kullanılan meta veri veya özel nesneler bu sınıf tarafından yönetilir."
type: docs
weight: 39
url: /tr/java/com.aspose.threed/customobject/
---
...
3D dosyalarda kullanılan meta veriler veya özel nesneler bu sınıf tarafından yönetilir. Tüm özel özellikler dinamik özellikler olarak kaydedilir.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [CustomObject()](#CustomObject--) | Yeni bir [CustomObject](../../com.aspose.threed/customobject) sınıfı örneği başlatır. |
| [CustomObject(String name)](#CustomObject-java.lang.String-) | Yeni bir [CustomObject](../../com.aspose.threed/customobject) sınıfı örneği başlatır. |
## Yöntemler
...
Yeni bir [CustomObject](../../com.aspose.threed/customobject) sınıfı örneği başlatır.

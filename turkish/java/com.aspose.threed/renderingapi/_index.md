...
description: "Sıkça kullanılan renderleme API'leri"
type: docs
weight: 269
url: /tr/java/com.aspose.threed/renderingapi/
---
...
Sıkça kullanılan renderleme API'leri
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [ARNOLD](#ARNOLD) | Arnold renderleyicisi |
| [CUSTOM](#CUSTOM) | Özel renderleme API'si |
| [DIRECTX](#DIRECTX) | DirectX |
| [MANTLE](#MANTLE) | AMD Mantle |
| [MENTAL_RAY](#MENTAL-RAY) | MentalRay |
| [METAL](#METAL) | Apple tarafından geliştirilen Metal |
| [NONE](#NONE) | Renderleme API'si yok |
| [OPENGL](#OPENGL) | OpenGL |
| [OPENGLES](#OPENGLES) | OpenGL ES |
| [PREVIEW](#PREVIEW) | PreviewColorAPI, FBX ile uyumlu |
| [RENDER_MAN](#RENDER-MAN) | RenderMan |
| [RENDER_WARE](#RENDER-WARE) | RenderWare |
| [SHADERFX](#SHADERFX) | ShaderFX renderleyicisi |
| [STAGE3D](#STAGE3D) | Adobe Flash'te kullanılan Stage3D |
...
Apple tarafından geliştirilen Metal
...
PreviewColorAPI, FBX ile uyumlu
...
Adobe Flash'te kullanılan Stage3D

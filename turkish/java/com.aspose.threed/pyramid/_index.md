...
type: docs
weight: 142
url: /tr/java/com.aspose.threed/pyramid/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [Pyramid()](#Pyramid--) | Varsayılan alt alan (10, 10) ve varsayılan yükseklik (5) ile yeni bir piramit örneği oluştur |
| [Pyramid(double xbottom, double ybottom, double height)](#Pyramid-double-double-double-) | Belirtilen alt alan ile yeni bir piramit örneği oluştur |
| [Pyramid(double xbottom, double ybottom, double xtop, double ytop, double height)](#Pyramid-double-double-double-double-double-) | Belirtilen alt alan, üst alan ve yükseklik ile yeni bir piramit örneği oluştur. |
| [Pyramid(String name, double xbottom, double ybottom, double xtop, double ytop, double height)](#Pyramid-java.lang.String-double-double-double-double-double-) | Belirtilen alt alan, üst alan ve yükseklik ile yeni bir piramit örneği oluştur. |
## Yöntemler
...
| [getBottomArea()](#getBottomArea--) | Alt kapağın alanı |
| [getBottomOffset()](#getBottomOffset--) | Alt köşeler için ofset |
...
| [getHeight()](#getHeight--) | Piramit yüksekliği |
...
| [getTopArea()](#getTopArea--) | Üst kapağın alanı |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setBottomArea(Vector2 value)](#setBottomArea-com.aspose.threed.Vector2-) | Alt kapağın alanı |
| [setBottomOffset(Vector3 value)](#setBottomOffset-com.aspose.threed.Vector3-) | Alt köşeler için ofset |
...
| [setHeight(double value)](#setHeight-double-) | Piramit yüksekliği |
...
| [setTopArea(Vector2 value)](#setTopArea-com.aspose.threed.Vector2-) | Üst kapağın alanı |
...
Varsayılan alt alan (10, 10) ve varsayılan yükseklik (5) ile yeni bir piramit örneği oluştur
...
Belirtilen alt alan ile yeni bir piramit örneği oluştur

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| xbottom | double | Altın x yönündeki uzunluğu |
| ybottom | double | Altın y yönündeki uzunluğu |
| yükseklik | double | Piramit yüksekliği |
...
Belirtilen alt alan, üst alan ve yükseklik ile yeni bir piramit örneği oluştur.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| xbottom | double | Alt alanın x yönündeki uzunluğu |
| ybottom | double | Alt alanın y yönündeki uzunluğu |
| xtop | double | Üst alanın x yönündeki uzunluğu |
| ytop | double | Üst alanın y yönündeki uzunluğu |
| yükseklik | double | Piramit yüksekliği |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| ad | java.lang.String | Piramit adı |
| xbottom | double | Alt alanın x yönündeki uzunluğu |
| ybottom | double | Alt alanın y yönündeki uzunluğu |
| xtop | double | Üst alanın x yönündeki uzunluğu |
| ytop | double | Üst alanın y yönündeki uzunluğu |

...
description: "Parametreli tabak."
type: docs
weight: 45
url: /tr/java/com.aspose.threed/dish/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [Dish()](#Dish--) | Varsayılan yarıçap(10) ve varsayılan yükseklik(5) ile yeni bir Dish örneği oluştur |
| [Dish(double radius, double height)](#Dish-double-double-) | Belirtilen yarıçap ve yükseklik ile yeni bir Dish örneği oluştur |
| [Dish(String name, double radius, double height, int widthSegments, int heightSegments)](#Dish-java.lang.String-double-double-int-int-) | Belirtilen yarıçap ve yükseklik ile yeni bir Dish örneği oluştur |
## Yöntemler
...
| [getHeight()](#getHeight--) | Dish'in yüksekliği |
...
| [getRadius()](#getRadius--) | Tabak yarıçapı |
...
| [setHeight(double value)](#setHeight-double-) | Dish'in yüksekliği |
...
| [setRadius(double value)](#setRadius-double-) | Tabak yarıçapı |
...
Varsayılan yarıçap(10) ve varsayılan yükseklik(5) ile yeni bir Dish örneği oluştur
...
Belirtilen yarıçap ve yükseklik ile yeni bir Dish örneği oluştur

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| yarıçap | double | Tabak yarıçapı |
| yükseklik | double | Tabak yüksekliği |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| ad | java.lang.String | Tabak adı |
| yarıçap | double | Tabak yarıçapı |
| yükseklik | double | Tabak yüksekliği |
| widthSegments | int | Tabak genişlik segmenti |
| heightSegments | int | Tabak yükseklik segmenti |

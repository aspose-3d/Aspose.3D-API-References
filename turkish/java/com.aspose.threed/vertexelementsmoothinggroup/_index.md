...
description: "Bir pürüzsüzleştirme grubu, pürüzsüz bir yüzey oluşturacak şekilde görünmesi gereken bir çokgen ağındaki çokgen grubudur."
type: docs
weight: 216
url: /tr/java/com.aspose.threed/vertexelementsmoothinggroup/
---
...
Bir smoothing group, pürüzsüz bir yüzey oluşturuyormuş gibi görünmesi gereken bir poligon ağındaki poligonların bir grubudur. DOS için 3D Studio Max gibi bazı erken 3D modelleme yazılımları, her ağ köşesi için normal vektör saklamayı önlemek amacıyla smoothing group kullandı.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [VertexElementSmoothingGroup()](#VertexElementSmoothingGroup--) | Yeni bir [VertexElementSmoothingGroup](../../com.aspose.threed/vertexelementsmoothinggroup) sınıfı örneği başlatır. |
## Yöntemler
...
Yeni bir [VertexElementSmoothingGroup](../../com.aspose.threed/vertexelementsmoothinggroup) sınıfı örneği başlatır.

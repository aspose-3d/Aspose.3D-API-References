...
description: "Şekil, Maya'daki küme çarpıtıcıya benzer bir kontrol noktası kümesindeki deformasyonu tanımlar."
type: docs
weight: 171
url: /tr/java/com.aspose.threed/shape/
---
...
Şekil, Maya'daki küme çarpıtıcıya benzer bir kontrol noktası kümesindeki deformasyonu tanımlar. Örneğin, oluşturulan bir geometriye bir şekil ekleyebiliriz. Şekil ve geometri aynı topolojik bilgiye sahiptir ancak kontrol noktalarının konumları farklıdır. Farklı etki miktarlarıyla, geometri bir deformasyon etkisi gerçekleştirir.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [Shape()](#Shape--) | Yeni bir [Shape](../../com.aspose.threed/shape) sınıfı örneği başlatır. |
| [Shape(String name)](#Shape-java.lang.String-) | Yeni bir [Shape](../../com.aspose.threed/shape) sınıfı örneği başlatır. |
## Yöntemler
...
| [fromControlPoints(Vector3[] controlPoints)](#fromControlPoints-com.aspose.threed.Vector3...-) | Varsayılan indekslerle belirtilen kontrol noktalarına sahip bir şekil oluştur. |
...
| [getIndices()](#getIndices--) | İndeksleri alır. |
...
Yeni bir [Shape](../../com.aspose.threed/shape) sınıfı örneği başlatır.
...
Varsayılan indekslerle belirtilen kontrol noktalarına sahip bir şekil oluştur.
...
**Returns:**
java.util.List<java.lang.Integer> - indeksler.
### getName() {#getName--}
```

...
type: docs
weight: 182
url: /tr/java/com.aspose.threed/tshape/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [TShape()](#TShape--) | Yapıcı [TShape](../../com.aspose.threed/tshape) |
## Yöntemler
...
| [getClass()](#getClass--) |  |
| [getDepth()](#getDepth--) | Web'in uzunluğunu alır. |
...
| [getFilletRadius()](#getFilletRadius--) | Web ile flanş arasındaki yuvarlama yarıçapını alır. |
| [getFlangeEdgeRadius()](#getFlangeEdgeRadius--) | Flanş kenarının yarıçapını alır. |
| [getFlangeThickness()](#getFlangeThickness--) | Flanşın duvar kalınlığını alır. |
| [getFlangeWidth()](#getFlangeWidth--) | Flanşın uzunluğunu alır. |
...
| [getWebEdgeRadius()](#getWebEdgeRadius--) | Web kenarının yarıçapını alır. |
| [getWebThickness()](#getWebThickness--) | Web'in duvar kalınlığını alır. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setDepth(double value)](#setDepth-double-) | Web'in uzunluğunu ayarlar. |
| [setExcluded(boolean value)](#setExcluded-boolean-) | Bu varlığın dışa aktarım sırasında dışlanıp dışlanmayacağını ayarlar. |
| [setFilletRadius(double value)](#setFilletRadius-double-) | Web ile flanş arasındaki yuvarlama yarıçapını ayarlar. |
| [setFlangeEdgeRadius(double value)](#setFlangeEdgeRadius-double-) | Flanş kenarının yarıçapını ayarlar. |
| [setFlangeThickness(double value)](#setFlangeThickness-double-) | Flanşın duvar kalınlığını ayarlar. |
| [setFlangeWidth(double value)](#setFlangeWidth-double-) | Flanşın uzunluğunu ayarlar. |
...
| [setWebEdgeRadius(double value)](#setWebEdgeRadius-double-) | Web kenarının yarıçapını ayarlar. |
| [setWebThickness(double value)](#setWebThickness-double-) | Web'in duvar kalınlığını ayarlar. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Yapıcı [TShape](../../com.aspose.threed/tshape)
...
Web'in uzunluğunu alır.

**Returns:**
double - web'in uzunluğu.
...
Web ile flanş arasındaki yuvarlama yarıçapını alır.

**Returns:**
double - web ile flanş arasındaki yuvarlama yarıçapı.
...
Flanş kenarının yarıçapını alır.

**Returns:**
double - flanş kenarının yarıçapı.
...
Flanşın duvar kalınlığını alır.

**Returns:**
double - flanşın duvar kalınlığı.
...
Flanşın uzunluğunu alır.

**Returns:**
double - flanşın uzunluğu.
### getName() {#getName--}
```
...
Web kenarının yarıçapını alır.

**Returns:**
double - web kenarının yarıçapı.
...
Web'in duvar kalınlığını alır.

**Returns:**
double - web'in duvar kalınlığı.
### hashCode() {#hashCode--}
```
...
Web ile flanş arasındaki yuvarlama yarıçapını ayarlar.
...
Flanş kenarının yarıçapını ayarlar.
...
Flanşın duvar kalınlığını ayarlar.
...
Web kenarının yarıçapını ayarlar.
...
Web'in duvar kalınlığını ayarlar.

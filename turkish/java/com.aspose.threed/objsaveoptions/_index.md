...
description: "Wavefront obj dosyası için kaydetme seçenekleri."
type: docs
weight: 116
url: /tr/java/com.aspose.threed/objsaveoptions/
---
...
Wavefront obj dosyası için kaydetme seçenekleri.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [ObjSaveOptions()](#ObjSaveOptions--) | [ObjSaveOptions](../../com.aspose.threed/objsaveoptions) sınıfının yapıcısı |
## Yöntemler
...
| [getAxisSystem()](#getAxisSystem--) | Dışa aktarılan dosyadaki eksen sistemini alır. |
| [getClass()](#getClass--) |  |
| [getEnableMaterials()](#getEnableMaterials--) | Her nesne için malzeme içe/dışa aktarımının olup olduğunu alır |
...
| [getPointCloud()](#getPointCloud--) | İhracatçının sahneyi nokta bulutu olarak (topolojik yapı olmadan) dışa aktarıp aktarmayacağını belirten bayrağı alır, varsayılan değer false'tur |
| [getSerializeW()](#getSerializeW--) | Modelin vertex konumundaki W bileşeninin serileştirilip serileştirilmeyeceğini alır |
| [getVerbose()](#getVerbose--) | Her bölüm için yorumların oluşturulup oluşturulmayacağını alır |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setAxisSystem(AxisSystem value)](#setAxisSystem-com.aspose.threed.AxisSystem-) | Dışa aktarılan dosyadaki eksen sistemini ayarlar. |
| [setEnableMaterials(boolean value)](#setEnableMaterials-boolean-) | Her nesne için malzeme içe/dışa aktarımının olup olmadığını ayarlar |
...
| [setPointCloud(boolean value)](#setPointCloud-boolean-) | İhracatçının sahneyi nokta bulutu olarak (topolojik yapı olmadan) dışa aktarıp aktarmayacağını belirten bayrağı ayarlar, varsayılan değer false'tur |
| [setSerializeW(boolean value)](#setSerializeW-boolean-) | Modelin köşe konumundaki W bileşeninin serileştirilip serileştirilmeyeceğini ayarlar. |
| [setVerbose(boolean value)](#setVerbose-boolean-) | Her bölüm için yorumların oluşturulup oluşturulmayacağını ayarlar. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[ObjSaveOptions](../../com.aspose.threed/objsaveoptions) sınıfının yapıcısı
...
Dışa aktarılan dosyadaki eksen sistemini alır.
...
Her nesne için malzeme içe/dışa aktarımının olup olduğunu alır

**Returns:**
boolean - her nesne için malzemelerin içe/dışa aktarılıp aktarılmayacağı
...
İhracatçının sahneyi nokta bulutu olarak (topolojik yapı olmadan) dışa aktarıp aktarmayacağını belirten bayrağı alır, varsayılan değer false'tur

**Returns:**
boolean - dışa aktarıcının sahneyi nokta bulutu (topolojik yapı olmadan) olarak dışa aktarıp aktarmayacağı bayrağı, varsayılan değer false
...
Modelin vertex konumundaki W bileşeninin serileştirilip serileştirilmeyeceğini alır

**Returns:**
boolean - modelin köşe konumundaki W bileşeninin serileştirip serileştirilmeyeceği.
...
Her bölüm için yorumların oluşturulup oluşturulmayacağını alır

**Returns:**
boolean - her bölüm için yorumların oluşturulup oluşturulmayacağı.
### hashCode() {#hashCode--}
```
...
Dışa aktarılan dosyadaki eksen sistemini ayarlar.
...
Her nesne için malzeme içe/dışa aktarımının olup olmadığını ayarlar
...
İhracatçının sahneyi nokta bulutu olarak (topolojik yapı olmadan) dışa aktarıp aktarmayacağını belirten bayrağı ayarlar, varsayılan değer false'tur
...
Modelin köşe konumundaki W bileşeninin serileştirilip serileştirilmeyeceğini ayarlar.
...
Her bölüm için yorumların oluşturulup oluşturulmayacağını ayarlar.

...
description: "Anahtar karelerin dizisi, örneklenen bir değerin zaman içindeki dönüşümünü tanımlar."
type: docs
weight: 90
url: /tr/java/com.aspose.threed/keyframesequence/
---
...
Anahtar çerçevelerin dizisi, zaman içinde örneklenen bir değerin dönüşümünü açıklar.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [KeyframeSequence(String name)](#KeyframeSequence-java.lang.String-) | Yeni bir [KeyframeSequence](../../com.aspose.threed/keyframesequence) sınıfının örneğini başlatır. |
| [KeyframeSequence()](#KeyframeSequence--) | Yeni bir [KeyframeSequence](../../com.aspose.threed/keyframesequence) sınıfının örneğini başlatır. |
## Yöntemler
...
Yeni bir [KeyframeSequence](../../com.aspose.threed/keyframesequence) sınıfının örneğini başlatır.

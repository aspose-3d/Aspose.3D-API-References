...
description: "Bir düzlem tarafından bölünmüş sonsuz bir uzayı temsil eder, bu şu şekilde kullanılabilir"
type: docs
weight: 77
url: /tr/java/com.aspose.threed/halfspace/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [HalfSpace()](#HalfSpace--) | Yeni bir [HalfSpace](../../com.aspose.threed/halfspace) örneği oluşturur |
| [HalfSpace(Vector3 normal, Vector3 position)](#HalfSpace-com.aspose.threed.Vector3-com.aspose.threed.Vector3-) | Verilen normal vektör ve kesici düzlem üzerindeki bir konumla yeni bir [HalfSpace](../../com.aspose.threed/halfspace) örneği oluşturur; |
## Yöntemler
...
| [getNormal()](#getNormal--) | Bölünmüş düzlemin normali, düzlem N \* P + D = 0 olarak tanımlanır; burada N Normal ve P düzlem üzerindeki herhangi bir noktadır. |
...
| [getPosition()](#getPosition--) | Bölünmüş düzlem üzerindeki herhangi bir nokta, düzlem N \* P + D = 0 olarak tanımlanır; burada N Normal ve P düzlem üzerindeki herhangi bir noktadır. |
...
| [setNormal(Vector3 value)](#setNormal-com.aspose.threed.Vector3-) | Bölünmüş düzlemin normali, düzlem N \* P + D = 0 olarak tanımlanır; burada N Normal ve P düzlem üzerindeki herhangi bir noktadır. |
...
| [setPosition(Vector3 value)](#setPosition-com.aspose.threed.Vector3-) | Bölünmüş düzlem üzerindeki herhangi bir nokta, düzlem N \* P + D = 0 olarak tanımlanır; burada N Normal ve P düzlem üzerindeki herhangi bir noktadır. |
...
Yeni bir [HalfSpace](../../com.aspose.threed/halfspace) örneği oluşturur
...
Verilen normal vektör ve kesici düzlem üzerindeki bir konumla yeni bir [HalfSpace](../../com.aspose.threed/halfspace) örneği oluşturur;
...
Bölünmüş düzlemin normali, düzlem N \* P + D = 0 olarak tanımlanır; burada N Normal ve P düzlem üzerindeki herhangi bir noktadır.
...
Bölünmüş düzlem üzerindeki herhangi bir nokta, düzlem N \* P + D = 0 olarak tanımlanır; burada N Normal ve P düzlem üzerindeki herhangi bir noktadır.

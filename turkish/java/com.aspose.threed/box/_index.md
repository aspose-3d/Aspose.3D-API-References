...
type: docs
weight: 26
url: /tr/java/com.aspose.threed/box/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [Box()](#Box--) | Yeni bir [Box](../../com.aspose.threed/box) sınıfı örneği başlatır. |
| [Box(double length, double width, double height)](#Box-double-double-double-) | Yeni bir [Box](../../com.aspose.threed/box) sınıfı örneği başlatır. |
| [Box(String name, double length, double width, double height, int lengthSegments, int widthSegments, int heightSegments)](#Box-java.lang.String-double-double-double-int-int-int-) | Yeni bir [Box](../../com.aspose.threed/box) sınıfı örneği başlatır. |
## Yöntemler
...
| [getHeight()](#getHeight--) | Kutunun y ekseninde hizalanmış yüksekliğini alır. |
| [getHeightSegments()](#getHeightSegments--) | Yükseklik segmentlerini alır veya ayarlar. |
| [getLength()](#getLength--) | Kutunun z ekseninde hizalanmış uzunluğunu alır. |
| [getLengthSegments()](#getLengthSegments--) | Uzunluk segmentlerini alır. |
...
| [getWidth()](#getWidth--) | Kutunun x ekseninde hizalanmış genişliğini alır. |
...
| [setHeight(double value)](#setHeight-double-) | Kutunun y ekseninde hizalanmış yüksekliğini ayarlar. |
| [setHeightSegments(int value)](#setHeightSegments-int-) | Yükseklik segmentlerini alır veya ayarlar. |
| [setLength(double value)](#setLength-double-) | Kutunun z ekseninde hizalanmış uzunluğunu ayarlar. |
| [setLengthSegments(int value)](#setLengthSegments-int-) | Uzunluk segmentlerini ayarlar. |
...
| [setWidth(double value)](#setWidth-double-) | Kutunun x ekseninde hizalanmış genişliğini ayarlar. |
...
Yeni bir [Box](../../com.aspose.threed/box) sınıfı örneği başlatır.
...
| --- | --- | --- |
| uzunluk | double | Kutunun z ekseninde hizalanmış uzunluğu. |
| genişlik | double | Kutunun x ekseninde hizalanmış genişliği. |
| yükseklik | double | Kutunun y ekseninde hizalanmış yüksekliği. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| ad | java.lang.String | Kutunun adı. |
| uzunluk | double | Kutunun z ekseninde hizalanmış uzunluğu. |
| genişlik | double | Kutunun x ekseninde hizalanmış genişliği. |
| yükseklik | double | Kutunun y ekseninde hizalanmış yüksekliği. |
| lengthSegments | int | Uzunluk segmentleri. |
...
Kutunun y ekseninde hizalanmış yüksekliğini alır.

**Returns:**
double - kutunun y ekseninde hizalanmış yüksekliği.
...
**Returns:**
int - yükseklik segmentlerini alır veya ayarlar.
### getLength() {#getLength--}
```
...
Kutunun z ekseninde hizalanmış uzunluğunu alır.

**Returns:**
double - kutunun z ekseninde hizalanmış uzunluğu.
...
Uzunluk segmentlerini alır.

**Returns:**
int - uzunluk segmentleri.
### getName() {#getName--}
```
...
Kutunun x ekseninde hizalanmış genişliğini alır.

**Returns:**
double - kutunun x ekseninde hizalanmış genişliği.
...
Kutunun y ekseninde hizalanmış yüksekliğini ayarlar.
...
Kutunun z ekseninde hizalanmış uzunluğunu ayarlar.
...
Kutunun x ekseninde hizalanmış genişliğini ayarlar.

...
description: "Parametrelerle tanımlanan IFC uyumlu elips şekli."
type: docs
weight: 50
url: /tr/java/com.aspose.threed/ellipseshape/
---
...
Parametrelerle tanımlanan IFC uyumlu elips şekli. Profilin merkez konumu, sınırlayıcı kutunun ortasındadır.
## Yapıcılar
...
| [getSemiAxis1()](#getSemiAxis1--) | X ekseni yönünde ölçülen elipsin birinci yarıçapını alır. |
| [getSemiAxis2()](#getSemiAxis2--) | Y ekseni yönünde ölçülen elipsin ikinci yarıçapını alır. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setSemiAxis1(double value)](#setSemiAxis1-double-) | X ekseni yönünde ölçülen elipsin birinci yarıçapını ayarlar. |
| [setSemiAxis2(double value)](#setSemiAxis2-double-) | Y ekseni yönünde ölçülen elipsin ikinci yarıçapını ayarlar. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
X ekseni yönünde ölçülen elipsin birinci yarıçapını alır.

**Returns:**
double - X ekseni yönünde ölçülen elipsin birinci yarıçapı.
...
Y ekseni yönünde ölçülen elipsin ikinci yarıçapını alır.

**Returns:**
double - Y ekseni yönünde ölçülen elipsin ikinci yarıçapı.
### hashCode() {#hashCode--}
```
...
X ekseni yönünde ölçülen elipsin birinci yarıçapını ayarlar.
...
Y ekseni yönünde ölçülen elipsin ikinci yarıçapını ayarlar.

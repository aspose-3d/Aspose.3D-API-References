...
description: "Serileştirme/seriden çıkarma için IO yapılandırması."
type: docs
weight: 81
url: /tr/java/com.aspose.threed/ioconfig/
---
...
Serileştirme/Serileştirme kaldırma için IO yapılandırması. Kullanıcı burada bağımlılık arama yolu veya biçimle ilgili yapılandırmalar gibi ayrıntılı yapılandırmaları belirtebilir
## Yöntemler

...
description: "Bir  birkaç eğri segmentinden oluşur."
type: docs
weight: 34
url: /tr/java/com.aspose.threed/compositecurve/
---
...
Bir [CompositeCurve](../../com.aspose.threed/compositecurve) birkaç eğri segmentinden oluşur.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [CompositeCurve()](#CompositeCurve--) | [CompositeCurve](../../com.aspose.threed/compositecurve) yapıcı |
## Yöntemler

| Yöntem | Açıklama |
| --- | --- |
| [addSegment(Curve curve)](#addSegment-com.aspose.threed.Curve-) | Mevcut eğriye yeni bir segment ekle. |
| [addSegment(Curve curve, boolean sameDirection)](#addSegment-com.aspose.threed.Curve-boolean-) | Mevcut eğriye yeni bir segment ekle. |
...
| [getSegments()](#getSegments--) | Eğrinin segmentleri. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
[CompositeCurve](../../com.aspose.threed/compositecurve) yapıcı
...
Mevcut eğriye yeni bir segment ekle.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Eklenecek eğri |
...
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Eklenecek eğri |
| sameDirection | boolean | Mevcut eğriyle aynı yön. |
...
**Returns:**
java.util.ArrayList<com.aspose.threed.CompositeCurve.Segment> - Eğrinin segmentleri.
### hashCode() {#hashCode--}
```

...
description: "Belirtilen bileşenler için speküler rengi tanımlar."
type: docs
weight: 217
url: /tr/java/com.aspose.threed/vertexelementspecular/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [VertexElementSpecular()](#VertexElementSpecular--) | Yeni bir [VertexElementSpecular](../../com.aspose.threed/vertexelementspecular) sınıfının örneğini başlatır. |
## Yöntemler
...
Yeni bir [VertexElementSpecular](../../com.aspose.threed/vertexelementspecular) sınıfının örneğini başlatır.

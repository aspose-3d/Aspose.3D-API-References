...
description: "PDF yükleme seçenekleri."
type: docs
weight: 124
url: /tr/java/com.aspose.threed/pdfloadoptions/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [PdfLoadOptions()](#PdfLoadOptions--) | Yapıcı [PdfLoadOptions](../../com.aspose.threed/pdfloadoptions) |
## Yöntemler
...
| [getPassword()](#getPassword--) | Şifreli PDF dosyasının kilidini açmak için parola. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setPassword(byte[] value)](#setPassword-byte---) | Şifreli PDF dosyasının kilidini açmak için parola. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Yapıcı [PdfLoadOptions](../../com.aspose.threed/pdfloadoptions)
...
Şifreli PDF dosyasının kilidini açmak için parola.

**Returns:**
byte[] - Şifreli PDF dosyasının kilidini açmak için parola.
### hashCode() {#hashCode--}
```

...
type: docs
weight: 73
url: /tr/java/com.aspose.threed/gltfloadoptions/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [GltfLoadOptions()](#GltfLoadOptions--) | Yapıcı [GltfLoadOptions](../../com.aspose.threed/gltfloadoptions) |
## Yöntemler
...
| [getFlipTexCoordV()](#getFlipTexCoordV--) | Mesh'in doku koordinatındaki v(t) koordinatını ters çevir, varsayılan değer true. |
...
| [setFlipTexCoordV(boolean value)](#setFlipTexCoordV-boolean-) | Mesh'in doku koordinatındaki v(t) koordinatını ters çevir, varsayılan değer true. |
...
Yapıcı [GltfLoadOptions](../../com.aspose.threed/gltfloadoptions)
...
Mesh'in doku koordinatındaki v(t) koordinatını ters çevir, varsayılan değer true.

**Returns:**
boolean - Mesh'in doku koordinatındaki v(t) koordinatını ters çevir, varsayılan değer true.

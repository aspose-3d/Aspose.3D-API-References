...
description: "Microsoft 3MF için 3MF ilgili yardımcı programlarla dosya biçimi örneği."
type: docs
weight: 104
url: /tr/java/com.aspose.threed/microsoft3mfformat/
---
...
Microsoft 3MF için 3MF ilgili yardımcı programlarla dosya biçimi örneği.
## Alanlar
...
| [getObjectType(Node node)](#getObjectType-com.aspose.threed.Node-) | Belirtilen düğüm için model tipini al. |
| [getTransformForBuild(Node node)](#getTransformForBuild-com.aspose.threed.Node-) | Derleme sırasında kullanılan düğüm için dönüşüm matrisini al. |
| [getVersion()](#getVersion--) | Dosya formatı sürümünü alır |
| [hashCode()](#hashCode--) |  |
| [isBuildable(Node node)](#isBuildable-com.aspose.threed.Node-) | Bu düğümün derleme olarak işaretlenip işaretlenmediğini kontrol et. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBuildable(Node node, boolean value, Matrix4 transform)](#setBuildable-com.aspose.threed.Node-boolean-com.aspose.threed.Matrix4-) | Bir düğümü derleme için işaretle. |
| [setObjectType(Node node, String modelType)](#setObjectType-com.aspose.threed.Node-java.lang.String-) | Belirtilen düğüm için model tipini ayarla. |
...
Belirtilen düğüm için model tipini al.
...
**Returns:**
java.lang.String - verilen düğüm için 3MF nesne tipi
...
Derleme sırasında kullanılan düğüm için dönüşüm matrisini al.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | 3MF derlemesi için dönüşüm matrisini alacak düğüm. |
...
Bu düğümün derleme olarak işaretlenip işaretlenmediğini kontrol et.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Kontrol edilecek düğüm |

**Returns:**
boolean - Derleme olarak işaretlendiyse True
### notify() {#notify--}
```
...
Bir düğümü derleme için işaretle.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Derleme olarak işaretlenecek düğüm. |
| değer | boolean |  |
| transform | [Matrix4](../../com.aspose.threed/matrix4) | Derleme içindeki düğümün dönüşümü. |
...
Belirtilen düğüm için model tipini ayarla. Olası değerler: model surface solidsupport support other

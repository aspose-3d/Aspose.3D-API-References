...
description: "Tüm varlıkların temel sınıfı."
type: docs
weight: 52
url: /tr/java/com.aspose.threed/entity/
---
...
Tüm varlıkların temel sınıfı. Entity, [Light](../../com.aspose.threed/light)/[Geometry](../../com.aspose.threed/geometry) gibi bir düğümün altında eklenen somut bir nesneyi temsil eder.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [Entity(String name)](#Entity-java.lang.String-) | [Entity](../../com.aspose.threed/entity) sınıfının yeni bir örneğini başlatır. |
## Yöntemler
...
[Entity](../../com.aspose.threed/entity) sınıfının yeni bir örneğini başlatır.

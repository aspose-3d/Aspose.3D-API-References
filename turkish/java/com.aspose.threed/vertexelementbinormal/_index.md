...
description: "Belirtilen bileşenler için binormal vektörleri tanımlar."
type: docs
weight: 208
url: /tr/java/com.aspose.threed/vertexelementbinormal/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [VertexElementBinormal()](#VertexElementBinormal--) | [VertexElementBinormal](../../com.aspose.threed/vertexelementbinormal) sınıfının yeni bir örneğini başlatır. |
## Yöntemler
...
[VertexElementBinormal](../../com.aspose.threed/vertexelementbinormal) sınıfının yeni bir örneğini başlatır.

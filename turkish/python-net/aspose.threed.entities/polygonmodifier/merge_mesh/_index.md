...
type: docs
weight: 60
url: /tr/python-net/aspose.threed.entities/polygonmodifier/merge_mesh/
is_root: false
---
...
# Giriş dosyası birden fazla nesne içerebilir
scene = Scene.from_file("input.fbx")
# şimdi bunları tek bir ağa birleştir
merged = PolygonModifier.merge_mesh(scene)
# sonra sadece bir ağ içeren bir dosyaya kaydederiz

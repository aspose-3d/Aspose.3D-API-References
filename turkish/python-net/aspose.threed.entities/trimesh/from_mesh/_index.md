...
type: docs
weight: 70
url: /tr/python-net/aspose.threed.entities/trimesh/from_mesh/
is_root: false
---
...
# Bir vertex bildirimi şu şekilde tanımla {FVector3 Position; FVector3 Normal; FVector2 UV}
...
# belirtilen bellek düzenini kullanarak bir ağı üçgen-ağa dönüştür
mesh = Sphere().to_mesh()
triMesh = TriMesh.from_mesh(vd, mesh)
# bunu bir akışa kaydet, 115 vertex * vertex başına 32 bayt
with open("output.bin", "wb") as stream:
    triMesh.write_vertices_to(stream)
    # indeksleri ushort olarak akışa kaydet, 504 indeks * indeks başına 2 bayt

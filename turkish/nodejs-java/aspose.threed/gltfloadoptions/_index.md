...
url: /tr/nodejs-java/aspose.threed/gltfloadoptions/
---
...
| Ad | Açıklama |
| --- | --- |
| constructor() | GltfLoadOptions yapıcı |
...
| Ad | Açıklama |
| --- | --- |
| getFlipTexCoordV() | Mesh'in doku koordinatındaki v(t) koordinatını ters çevir, varsayılan değer true'dur. |
...
| Ad | Açıklama |
| --- | --- |
| setFlipTexCoordV(value) | Mesh'in doku koordinatındaki v(t) koordinatını ters çevir, varsayılan değer true'dur. |

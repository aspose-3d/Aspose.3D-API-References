...
url: /tr/nodejs-java/aspose.threed/sceneobject/
---
## SceneObject class
...
| Ad | Açıklama |
| --- | --- |
| constructor(name) | Varsayılan bir adla bir SceneObject başlatır. |
...
| Ad | Açıklama |
| --- | --- |
| constructor_overload() | Bir SceneObject başlatır. |

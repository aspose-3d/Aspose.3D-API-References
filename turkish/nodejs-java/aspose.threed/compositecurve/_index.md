...
url: /tr/nodejs-java/aspose.threed/compositecurve/
---
## CompositeCurve class

Bir CompositeCurve, birkaç eğri segmentinden oluşur.
...
| Ad | Açıklama |
| --- | --- |
| constructor() | CompositeCurve yapıcı |
...
| Ad | Açıklama |
| --- | --- |
| getSegments() | Eğrinin segmentleri. |
...
| Ad | Açıklama |
| --- | --- |
| addSegment(curve, sameDirection) | Bu |

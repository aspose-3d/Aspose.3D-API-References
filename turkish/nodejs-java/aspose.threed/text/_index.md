...
url: /tr/nodejs-java/aspose.threed/text/
---
## Text class

Metin profili, bu profil yazı tipi ve metin kullanarak konturları tanımlar.
...
| Ad | Açıklama |
| --- | --- |
| setContent(value) | Metnin içeriği |
...
| Ad | Açıklama |
| --- | --- |
| setFont(value) | Metnin yazı tipi. |
...
| Ad | Açıklama |
| --- | --- |
| getFontSize() | Yazı tipi boyutu ölçeği. |
...
| Ad | Açıklama |
| --- | --- |
| setFontSize(value) | Yazı tipi boyutu ölçeği. |

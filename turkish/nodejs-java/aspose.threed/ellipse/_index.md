...
url: /tr/nodejs-java/aspose.threed/ellipse/
---
## Ellipse class

Bir Elips, elips şeklini oluşturan bir nokta kümesi tanımlar.
...
| Ad | Açıklama |
| --- | --- |
| constructor() | Elips'in yapıcı yöntemi |
...
| Ad | Açıklama |
| --- | --- |
| constructor_overload(semiAxis1, semiAxis2) | Elips'in yapıcı yöntemi |
...
| Ad | Açıklama |
| --- | --- |
| getSemiAxis1() | X eksenindeki yarıçap |
...
| Ad | Açıklama |
| --- | --- |
| setSemiAxis1(value) | X eksenindeki yarıçap |
...
| Ad | Açıklama |
| --- | --- |
| getSemiAxis2() | Y eksenindeki yarıçap |
...
| Ad | Açıklama |
| --- | --- |
| setSemiAxis2(value) | Y eksenindeki yarıçap |

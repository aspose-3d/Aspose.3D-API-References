...
url: /tr/nodejs-java/aspose.threed/a3dobject/
---
## A3DObject class
...
| Ad | Açıklama |
| --- | --- |
| constructor(name) | A3DObject sınıfının yeni bir örneğini başlatır. |
...
| Ad | Açıklama |
| --- | --- |
| constructor_overload() | A3DObject sınıfının adı olmayan yeni bir örneğini başlatır. |

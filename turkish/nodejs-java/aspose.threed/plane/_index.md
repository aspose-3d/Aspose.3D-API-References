...
url: /tr/nodejs-java/aspose.threed/plane/
---
## Plane class
...
| Ad | Açıklama |
| --- | --- |
| constructor() | Plane sınıfının varsayılan 1x1 boyutlu yeni bir örneğini başlatır. |
...
| Ad | Açıklama |
| --- | --- |
| constructor_overload(length, width) | Plane sınıfının yeni bir örneğini başlatır. |

 **Parameters:**

| Ad | Tür | Açıklama |
| --- | --- | --- |
| uzunluk | Number | Plane'in uzunluğu. |
| genişlik | Number | Plane'in genişliği. |
...
| Ad | Açıklama |
| --- | --- |
| constructor_overload2(name, length, width, lengthSegments, widthSegments) | Plane sınıfının yeni bir örneğini başlatır. |
...
| uzunluk | Number | Plane'in uzunluğu. |
| genişlik | Number | Plane'in genişliği. |
| lengthSegments | Number | Uzunluk segmentleri. |
| widthSegments | Number | Genişlik segmentleri. |
...
| Ad | Açıklama |
| --- | --- |
| getUp() | Plane'in yukarı vektörünü alır veya ayarlar, varsayılan değer (0, 1, 0)'dır, bu plane'in oluşturulmasını etkiler. |
...
| Ad | Açıklama |
| --- | --- |
| setUp(value) | Plane'in yukarı vektörünü alır veya ayarlar, varsayılan değer (0, 1, 0)'dır, bu plane'in oluşturulmasını etkiler. |
...
| Ad | Açıklama |
| --- | --- |
| getLength() | Plane'in uzunluğunu alır veya ayarlar. Uzunluk. |
...
| Ad | Açıklama |
| --- | --- |
| setLength(value) | Plane'in uzunluğunu alır veya ayarlar. Uzunluk. |
...
| Ad | Açıklama |
| --- | --- |
| getWidth() | Plane'in genişliğini alır veya ayarlar. Genişlik. |
...
| Ad | Açıklama |
| --- | --- |
| setWidth(value) | Plane'in genişliğini alır veya ayarlar. Genişlik. |
...
| Ad | Açıklama |
| --- | --- |
| getLengthSegments() | Uzunluk segmentlerini alır veya ayarlar. Uzunluk segmentleri. |
...
| Ad | Açıklama |
| --- | --- |
| setLengthSegments(value) | Uzunluk segmentlerini alır veya ayarlar. Uzunluk segmentleri. |
...
| Ad | Açıklama |
| --- | --- |
| getWidthSegments() | Genişlik segmentlerini alır veya ayarlar. Genişlik segmentleri. |
...
| Ad | Açıklama |
| --- | --- |
| setWidthSegments(value) | Genişlik segmentlerini alır veya ayarlar. Genişlik segmentleri. |

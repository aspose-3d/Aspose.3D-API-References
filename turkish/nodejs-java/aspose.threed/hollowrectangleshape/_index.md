...
url: /tr/nodejs-java/aspose.threed/hollowrectangleshape/
---
## HollowRectangleShape class

İç ve dış yuvarlatılmış köşelere sahip IFC uyumlu boş dikdörtgen şekil.
...
| Ad | Açıklama |
| --- | --- |
| getWallThickness() | Dikdörtgenin sınırı ile iç delik arasındaki kalınlık |
...
| Ad | Açıklama |
| --- | --- |
| setWallThickness(value) | Dikdörtgenin sınırı ile iç delik arasındaki kalınlık |
...
| Ad | Açıklama |
| --- | --- |
| getInnerFilletRadius() | İç dikdörtgenin iç filet yarıçapı. |
...
| Ad | Açıklama |
| --- | --- |
| setInnerFilletRadius(value) | İç dikdörtgenin iç filet yarıçapı. |

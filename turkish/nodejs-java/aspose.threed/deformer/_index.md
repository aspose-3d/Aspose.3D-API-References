...
url: /tr/nodejs-java/aspose.threed/deformer/
---
## Deformer class

SkinDeformer ve MorphTargetDeformer için temel sınıf
...
| Ad | Açıklama |
| --- | --- |
| constructor(name) | Deformer sınıfının yeni bir örneğini başlatır. |

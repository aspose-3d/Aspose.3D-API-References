...
url: /tr/nodejs-java/aspose.threed/mirroredprofile/
---
## MirroredProfile class

IFC uyumlu ayna profili.  Bu profil, temel profili y ekseni etrafında yansıtılarak yeni bir profil tanımlar.
...
| Ad | Açıklama |
| --- | --- |
| constructor(baseProfile) | Mevcut bir profilden yeni bir MirroredProfile oluşturur. |
...
| Ad | Açıklama |
| --- | --- |
| getBaseProfile() | Yansıtılacak temel profil. |

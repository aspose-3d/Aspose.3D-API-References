...
url: /tr/nodejs-java/aspose.threed/xloadoptions/
---
## XLoadOptions class
...
| Ad | Açıklama |
| --- | --- |
| constructor(contentType) | XLoadOptions yapıcısı |
...
| Ad | Açıklama |
| --- | --- |
| getFlipCoordinateSystem() | Koordinat sistemini ters çevir, bu varsayılan olarak doğrudur |
...
| Ad | Açıklama |
| --- | --- |
| setFlipCoordinateSystem(value) | Koordinat sistemini ters çevir, bu varsayılan olarak doğrudur |

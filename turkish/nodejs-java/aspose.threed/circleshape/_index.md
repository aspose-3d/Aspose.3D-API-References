...
url: /tr/nodejs-java/aspose.threed/circleshape/
---
## CircleShape class

IFC uyumlu daire profili, LinearExtrusion aracılığıyla bir ağ oluşturmak için kullanılabilir.
...
| Ad | Açıklama |
| --- | --- |
| constructor() | Varsayılan yarıçap (5) ile bir CircleShape profili oluşturur. |
...
| Ad | Açıklama |
| --- | --- |
| constructor_overload(radius) | Belirtilen yarıçap ile bir CircleShape profili oluşturur. |
...
| Ad | Açıklama |
| --- | --- |
| getRadius() | Dairenin yarıçapını alır veya ayarlar. |
...
| Ad | Açıklama |
| --- | --- |
| setRadius(value) | Dairenin yarıçapını alır veya ayarlar. |

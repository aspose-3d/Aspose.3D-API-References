...
url: /tr/nodejs-java/aspose.threed/pdfloadoptions/
---
...
| Ad | Açıklama |
| --- | --- |
| constructor() | PdfLoadOptions yapıcı |
...
| Ad | Açıklama |
| --- | --- |
| getPassword() | Şifreli PDF dosyasını açmak için parola. |
...
| Ad | Açıklama |
| --- | --- |
| setPassword(value) | Şifreli PDF dosyasını açmak için parola. |

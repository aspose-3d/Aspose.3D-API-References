...
url: /tr/nodejs-java/aspose.threed/trimmedcurve/
---
## TrimmedCurve class
...
| Ad | Açıklama |
| --- | --- |
| constructor() | TrimmedCurve yapıcı |
...
| Ad | Açıklama |
| --- | --- |
| setBasisCurve(value) | Kesilecek temel eğri. |
...
| Ad | Açıklama |
| --- | --- |
| setFirst(value) | Kesilecek ilk uç nokta, Kartezyen bir nokta veya gerçek bir parametre olabilir. |
...
| Ad | Açıklama |
| --- | --- |
| getSecond() | Kırpılacak ikinci uç nokta, Kartezyen bir nokta veya gerçek bir parametre olabilir. |
...
| Ad | Açıklama |
| --- | --- |
| setSecond(value) | Kırpılacak ikinci uç nokta, Kartezyen bir nokta veya gerçek bir parametre olabilir. |
...
| Ad | Açıklama |
| --- | --- |
| getSameDirection() | Kırpılmış sonucun temel eğrinin aynı yönünü kullanıp kullanmayacağını alır veya ayarlar. |
...
| Ad | Açıklama |
| --- | --- |
| setSameDirection(value) | Kırpılmış sonucun temel eğrinin aynı yönünü kullanıp kullanmayacağını alır veya ayarlar. |

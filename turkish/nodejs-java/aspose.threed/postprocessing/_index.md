...
url: /tr/nodejs-java/aspose.threed/postprocessing/
---
## PostProcessing class

Post işleme efektleri  @hideconstructor
...
| Ad | Açıklama |
| --- | --- |
| getInput() | Bu post-processing'in girişi |
...
| Ad | Açıklama |
| --- | --- |
| setInput(value) | Bu post-processing'in girişi |

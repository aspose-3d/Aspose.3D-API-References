...
url: /tr/nodejs-java/aspose.threed/arbitraryprofile/
---
...
| Ad | Açıklama |
| --- | --- |
| constructor() | ArbitraryProfile yapıcı |
...
| Ad | Açıklama |
| --- | --- |
| constructor_overload(curve) | İlk bir eğri ile ArbitraryProfile yapıcı. |
...
| Ad | Açıklama |
| --- | --- |
| getCurve() | Profili oluşturmak için kullanılan Eğri |
...
| Ad | Açıklama |
| --- | --- |
| setCurve(value) | Profili oluşturmak için kullanılan Eğri |

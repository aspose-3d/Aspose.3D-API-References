...
description: Базовый класс для настройки параметров загрузки файлов для разных типов
type: docs
weight: 1190
url: /ru/net/aspose.threed.formats/loadoptions/
---
## LoadOptions class

Базовый класс для настройки параметров загрузки файлов для разных типов

...
description: Конфигурация вводавывода для сериализации/десериализации. Пользователь может указать подробные конфигурации такие как путь поиска зависимостей Или конфигурации связанные с форматом здесь
type: docs
weight: 1180

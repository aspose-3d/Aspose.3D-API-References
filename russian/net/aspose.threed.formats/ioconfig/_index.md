...
| static [FileSystemFactory](../../aspose.threed.formats/ioconfig/filesystemfactory) { get; set; } | Получает или задает класс фабрики для файловой системы. Фабрика по умолчанию создаст[`LocalFileSystem`](../../aspose.threed.utilities/localfilesystem), которая не подходит для серверной среды. |

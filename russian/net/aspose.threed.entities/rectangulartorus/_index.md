...
description: Параметризованный прямоугольный тор.
type: docs
weight: 600
url: /ru/net/aspose.threed.entities/rectangulartorus/
---
## RectangularTorus class

Параметризованный прямоугольный тор.
...
| Имя | Описание |
| --- | --- |
| [RectangularTorus](rectangulartorus#constructor)() | Конструктор[`RectangularTorus`](../rectangulartorus) |
| [RectangularTorus](rectangulartorus#constructor_1)(string) | Конструктор[`RectangularTorus`](../rectangulartorus) |

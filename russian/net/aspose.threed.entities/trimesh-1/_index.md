...
description: Общая версияTriMesh./trimeshдля пользовательского статического типа вершин
type: docs
weight: 740
...
Общая версия[`TriMesh`](../trimesh)для пользовательского статического типа вершин
...
| [UnmergedVerticesCount](../../aspose.threed.entities/trimesh/unmergedverticescount) { get; } | Количество неслитых вершин, которые прошли[`BeginVertex`](../trimesh/beginvertex)и[`EndVertex`](../trimesh/endvertex). |
...
| Имя | Описание |
| --- | --- |
| static [FromMesh](../../aspose.threed.entities/trimesh`1/frommesh)(Mesh) | Создать TriMesh из заданного объекта сетки с автоматически сгенерированным расположением вершин. |
...
| [VerticesToTypedArray](../../aspose.threed.entities/trimesh`1/verticestotypedarray)() | Преобразование данных вершин в типизированный массив |

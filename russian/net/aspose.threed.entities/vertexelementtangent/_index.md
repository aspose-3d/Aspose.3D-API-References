...
type: docs
weight: 870
url: /ru/net/aspose.threed.entities/vertexelementtangent/
---
...
| Имя | Описание |
| --- | --- |
| [VertexElementTangent](vertexelementtangent)() | Инициализирует новый экземпляр класса[`VertexElementTangent`](../vertexelementtangent). |

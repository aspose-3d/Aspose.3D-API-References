...
description: Получает или устанавливает пошаговый режим клавиши. Если тип интерполяцииConstant  list.dataindex определяет какое значение ключевого кадра будет использоваться во время интерполяции. АPreviousValue означает что будет использоваться значение левого ключевого кадра ANextValueозначает что будет использоваться значение следующего правого ключевого кадра
type: docs
weight: 110

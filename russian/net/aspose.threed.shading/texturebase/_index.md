...
| Имя | Описание |
| --- | --- |
| [TextureBase](texturebase)(string) | Инициализирует новый экземпляр класса[`TextureBase`](../texturebase). |

## Характеристики

| Имя | Описание |
| --- | --- |
| [Alpha](../../aspose.threed.shading/texturebase/alpha) { get; set; } | Получает или устанавливает альфа-значение текстуры по умолчанию Это действительно, когда используется[`AlphaSource`](./alphasource)isPixelAlpha Значение по умолчанию — 1,0, допустимый диапазон значений — от 0 до 1 |

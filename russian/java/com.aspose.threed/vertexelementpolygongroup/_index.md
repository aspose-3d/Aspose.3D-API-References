...
description: Определяет группу полигонов для указанных компонентов, чтобы объединять связанные полигоны вместе.
type: docs
weight: 215
url: /ru/java/com.aspose.threed/vertexelementpolygongroup/
---
...
| --- | --- |
| [VertexElementPolygonGroup()](#VertexElementPolygonGroup--) | Инициализирует новый экземпляр класса [VertexElementPolygonGroup](../../com.aspose.threed/vertexelementpolygongroup). |
## Методы
...
Инициализирует новый экземпляр класса [VertexElementPolygonGroup](../../com.aspose.threed/vertexelementpolygongroup).

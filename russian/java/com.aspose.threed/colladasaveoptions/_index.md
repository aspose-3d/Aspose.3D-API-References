...
description: Параметры сохранения для collada
type: docs
weight: 33
url: /ru/java/com.aspose.threed/colladasaveoptions/
---
...
Параметры сохранения для collada
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [ColladaSaveOptions()](#ColladaSaveOptions--) | Конструктор [ColladaSaveOptions](../../com.aspose.threed/colladasaveoptions) |
## Методы
...
| [getIndented()](#getIndented--) | Получает, отступлен ли экспортируемый XML‑документ. |
...
| [getTransformStyle()](#getTransformStyle--) | Получает стиль преобразования узла |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setIndented(boolean value)](#setIndented-boolean-) | Устанавливает, отступлен ли экспортируемый XML‑документ. |
...
| [setTransformStyle(ColladaTransformStyle value)](#setTransformStyle-com.aspose.threed.ColladaTransformStyle-) | Устанавливает стиль преобразования узла |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Конструктор [ColladaSaveOptions](../../com.aspose.threed/colladasaveoptions)
...
Получает, отступлен ли экспортируемый XML‑документ.

**Returns:**
boolean — отступлен ли экспортируемый XML‑документ.
...
Получает стиль преобразования узла
...
Устанавливает, отступлен ли экспортируемый XML‑документ.
...
Устанавливает стиль преобразования узла

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [ColladaTransformStyle](../../com.aspose.threed/colladatransformstyle) | Новое значение |

...
| generateVertexMapping | boolean | Создайте [Vertex](../../com.aspose.threed/vertex) для каждой вершины, что не требуется только для сериализации/десериализации. |
...
**Returns:**
int - Ёмкость предварительно выделенных вершин.
### getClass() {#getClass--}
```
...
**Returns:**
int - Количество индексов в этом [TriMesh](../../com.aspose.threed/trimesh)
...
**Returns:**
int - Количество неслитых вершин, переданных через [beginVertex](../../com.aspose.threed/trimesh\#beginVertex) и [endVertex](../../com.aspose.threed/trimesh\#endVertex).
...
**Returns:**
int - Количество вершин в этом [TriMesh](../../com.aspose.threed/trimesh)
...
**Returns:**
int - Общий размер всех вершин в байтах
### hashCode() {#hashCode--}
```
...
**Returns:**
double - Значение типа double указанного поля вершины
...
**Returns:**
float - Значение типа float указанного поля вершины

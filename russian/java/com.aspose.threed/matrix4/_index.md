...
description: "Реализация 4x4 матрицы."
type: docs
weight: 100
url: /ru/java/com.aspose.threed/matrix4/
---
...
| --- | --- |
| [Matrix4(Vector4 r0, Vector4 r1, Vector4 r2, Vector4 r3)](#Matrix4-com.aspose.threed.Vector4-com.aspose.threed.Vector4-com.aspose.threed.Vector4-com.aspose.threed.Vector4-) | Создаёт матрицу из 4 строк. |
| [Matrix4(double m00, double m01, double m02, double m03, double m10, double m11, double m12, double m13, double m20, double m21, double m22, double m23, double m30, double m31, double m32, double m33)](#Matrix4-double-double-double-double-double-double-double-double-double-double-double-double-double-double-double-double-) | Инициализирует новый экземпляр [Matrix4](../../com.aspose.threed/matrix4) структуры. |
| [Matrix4(FMatrix4 m)](#Matrix4-com.aspose.threed.FMatrix4-) | Создаёт [Matrix4](../../com.aspose.threed/matrix4) из экземпляра [FMatrix4](../../com.aspose.threed/fmatrix4) |
| [Matrix4(double[] m)](#Matrix4-double---) | Инициализирует новый экземпляр [Matrix4](../../com.aspose.threed/matrix4) структуры. |
| [Matrix4()](#Matrix4--) |  |
## Поля
...
| [decompose(Vector3 translation, Vector3 scaling, Quaternion rotation)](#decompose-com.aspose.threed.Vector3-com.aspose.threed.Vector3-com.aspose.threed.Quaternion-) | Разлагает матрицу преобразования |
| [equals(Object obj)](#equals-java.lang.Object-) |  |
| [getClass()](#getClass--) |  |
| [getDeterminant()](#getDeterminant--) | Получает определитель матрицы |
| [getIdentity()](#getIdentity--) | Получает единичную матрицу |
| [hashCode()](#hashCode--) |  |
| [inverse()](#inverse--) | Инвертирует этот экземпляр |
| [mul(Matrix4 lhs, Matrix4 rhs)](#mul-com.aspose.threed.Matrix4-com.aspose.threed.Matrix4-) | Умножает две матрицы |
| [mul(Matrix4 lhs, Vector3 v)](#mul-com.aspose.threed.Matrix4-com.aspose.threed.Vector3-) | Умножает матрицу и vector3 |
| [mul(Matrix4 lhs, Vector4 v)](#mul-com.aspose.threed.Matrix4-com.aspose.threed.Vector4-) | Умножает матрицу и vector4 |
| [mul(Matrix4 lhs, double v)](#mul-com.aspose.threed.Matrix4-double-) | Умножить матрицу на значение double |
| [normalize()](#normalize--) | Нормализует этот экземпляр. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [rotate(Quaternion q)](#rotate-com.aspose.threed.Quaternion-) | Создаёт матрицу вращения из кватерниона |
| [rotate(double angle, Vector3 axis)](#rotate-double-com.aspose.threed.Vector3-) | Создаёт матрицу вращения по углу вращения и оси |
| [rotateFromEuler(Vector3 eul)](#rotateFromEuler-com.aspose.threed.Vector3-) | Создаёт матрицу вращения из угла Эйлера |
| [rotateFromEuler(double rx, double ry, double rz)](#rotateFromEuler-double-double-double-) | Создаёт матрицу вращения из угла Эйлера |
| [scale(Vector3 s)](#scale-com.aspose.threed.Vector3-) | Создаёт матрицу, масштабирующую вдоль оси x, оси y и оси z. |
| [scale(double s)](#scale-double-) | Создаёт матрицу, масштабирующую вдоль оси x, оси y и оси z. |
| [scale(double sx, double sy, double sz)](#scale-double-double-double-) | Создаёт матрицу, масштабирующую вдоль оси x, оси y и оси z. |
| [setTRS(Vector3 translation, Vector3 rotation, Vector3 scale)](#setTRS-com.aspose.threed.Vector3-com.aspose.threed.Vector3-com.aspose.threed.Vector3-) | Инициализирует матрицу с трансляцией/вращением/масштабом |
| [toArray()](#toArray--) | Преобразует матрицу в массив. |
| [toString()](#toString--) | Возвращает java.lang.String, представляющий текущий [Matrix4](../../com.aspose.threed/matrix4). |
| [translate(Vector3 t)](#translate-com.aspose.threed.Vector3-) | Создаёт матрицу, переводящую вдоль оси x, оси y и оси z |
| [translate(double tx, double ty, double tz)](#translate-double-double-double-) | Создаёт матрицу, переводящую вдоль оси x, оси y и оси z |

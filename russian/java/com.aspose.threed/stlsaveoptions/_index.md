...
type: docs
weight: 177
url: /ru/java/com.aspose.threed/stlsaveoptions/
---
...
| --- | --- |
| [StlSaveOptions()](#StlSaveOptions--) | Инициализирует новый экземпляр [StlSaveOptions](../../com.aspose.threed/stlsaveoptions). |
| [StlSaveOptions(FileContentType contentType)](#StlSaveOptions-com.aspose.threed.FileContentType-) | Инициализирует новый экземпляр [StlSaveOptions](../../com.aspose.threed/stlsaveoptions). |
## Методы
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | Получает, следует ли инвертировать систему координат контрольных точек/нормалей при экспорте. |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | Устанавливает, следует ли инвертировать систему координат контрольных точек/нормалей при экспорте. |
...
Инициализирует новый экземпляр [StlSaveOptions](../../com.aspose.threed/stlsaveoptions).
...
Получает, следует ли инвертировать систему координат контрольных точек/нормалей при экспорте.

**Returns:**
boolean - следует ли инвертировать систему координат контрольных точек/нормалей при экспорте.
...
Устанавливает, следует ли инвертировать систему координат контрольных точек/нормалей при экспорте.

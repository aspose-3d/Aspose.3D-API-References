...
type: docs
weight: 176
url: /ru/java/com.aspose.threed/stlloadoptions/
---
...
| --- | --- |
| [StlLoadOptions()](#StlLoadOptions--) | Инициализирует новый экземпляр [StlLoadOptions](../../com.aspose.threed/stlloadoptions). |
| [StlLoadOptions(FileContentType contentType)](#StlLoadOptions-com.aspose.threed.FileContentType-) | Инициализирует новый экземпляр [StlLoadOptions](../../com.aspose.threed/stlloadoptions). |
## Методы
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | Получает, следует ли инвертировать систему координат контрольных точек/нормалей при импорте. |
...
| [getRecalculateNormal()](#getRecalculateNormal--) | Игнорировать нормальные данные, хранящиеся в файле STL, и пересчитать их на основе позиции вершин. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | Устанавливает, следует ли инвертировать систему координат контрольных точек/нормалей при импорте. |
...
| [setRecalculateNormal(boolean value)](#setRecalculateNormal-boolean-) | Игнорировать нормальные данные, хранящиеся в файле STL, и пересчитать их на основе позиции вершин. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Инициализирует новый экземпляр [StlLoadOptions](../../com.aspose.threed/stlloadoptions).
...
Получает, следует ли инвертировать систему координат контрольных точек/нормалей при импорте.

**Returns:**
boolean - следует ли инвертировать систему координат контрольных точек/нормалей при импорте.
...
Игнорировать нормальные данные, хранящиеся в файле STL, и пересчитать их на основе позиции вершин. Значение по умолчанию — false.

**Returns:**
boolean - Игнорировать нормальные данные, хранящиеся в файле STL, и пересчитать их на основе позиции вершин. Значение по умолчанию — false.
### hashCode() {#hashCode--}
```
...
Устанавливает, следует ли инвертировать систему координат контрольных точек/нормалей при импорте.

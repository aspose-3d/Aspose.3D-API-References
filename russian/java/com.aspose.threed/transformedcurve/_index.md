...
description: "A  дает кривой размещение с использованием матрицы преобразования."
type: docs
weight: 192
url: /ru/java/com.aspose.threed/transformedcurve/
---
...
Объект [TransformedCurve](../../com.aspose.threed/transformedcurve) задает размещение кривой с помощью матрицы преобразования. Это позволяет выполнить преобразование внутри [TrimmedCurve](../../com.aspose.threed/trimmedcurve) или [CompositeCurve](../../com.aspose.threed/compositecurve).
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [TransformedCurve()](#TransformedCurve--) | Конструктор [TransformedCurve](../../com.aspose.threed/transformedcurve) |
| [TransformedCurve(Curve basisCurve, Matrix4 transformation)](#TransformedCurve-com.aspose.threed.Curve-com.aspose.threed.Matrix4-) | Конструктор [TransformedCurve](../../com.aspose.threed/transformedcurve) |
## Методы
...
| [getBasisCurve()](#getBasisCurve--) | Базовая кривая. |
...
| [getTransformMatrix()](#getTransformMatrix--) | Матрица преобразования. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setBasisCurve(Curve value)](#setBasisCurve-com.aspose.threed.Curve-) | Базовая кривая. |
...
| [setTransformMatrix(Matrix4 value)](#setTransformMatrix-com.aspose.threed.Matrix4-) | Матрица преобразования. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Конструктор [TransformedCurve](../../com.aspose.threed/transformedcurve)

...
description: Базовый класс для настройки параметров загрузки файлов разных типов
type: docs
weight: 97
url: /ru/java/com.aspose.threed/loadoptions/
---
...
Базовый класс для настройки параметров загрузки файлов разных типов
## Методы

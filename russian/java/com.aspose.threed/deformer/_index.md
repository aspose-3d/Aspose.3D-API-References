...
type: docs
weight: 41
url: /ru/java/com.aspose.threed/deformer/
---
...
Базовый класс для [SkinDeformer](../../com.aspose.threed/skindeformer) и [MorphTargetDeformer](../../com.aspose.threed/morphtargetdeformer)
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [Deformer(String name)](#Deformer-java.lang.String-) | Инициализирует новый экземпляр класса [Deformer](../../com.aspose.threed/deformer). |
## Методы
...
Инициализирует новый экземпляр класса [Deformer](../../com.aspose.threed/deformer).

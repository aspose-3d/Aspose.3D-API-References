...
description: Шейдерный материал позволяет описать материал с помощью внешнего движка рендеринга или языка шейдеров.
type: docs
weight: 164
url: /ru/java/com.aspose.threed/shadermaterial/
---
...
Материал шейдера позволяет описать материал с помощью внешнего движка рендеринга или языка шейдеров. [ShaderMaterial](../../com.aspose.threed/shadermaterial) использует [ShaderTechnique](../../com.aspose.threed/shadertechnique) для описания конкретных деталей рендеринга, и будет выбран наиболее подходящий в зависимости от конечной платформы рендеринга. Например, ваш экземпляр [ShaderMaterial](../../com.aspose.threed/shadermaterial) может иметь две техники: одна определена в HLSL, другая — в GLSL. На платформе без окна следует использовать GLSL вместо HLSL
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [ShaderMaterial()](#ShaderMaterial--) | Инициализирует новый экземпляр класса [ShaderMaterial](../../com.aspose.threed/shadermaterial). |
| [ShaderMaterial(String name)](#ShaderMaterial-java.lang.String-) | Инициализирует новый экземпляр класса [ShaderMaterial](../../com.aspose.threed/shadermaterial). |
## Поля
...
| [getTechniques()](#getTechniques--) | Получает все доступные техники, определённые в этом материале. |
...
Инициализирует новый экземпляр класса [ShaderMaterial](../../com.aspose.threed/shadermaterial).
...
**Returns:**
java.util.List<com.aspose.threed.ShaderTechnique> - все доступные техники, определённые в этом материале.

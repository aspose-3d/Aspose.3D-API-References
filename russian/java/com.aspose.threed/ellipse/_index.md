...
description: Определяет набор точек, образующих форму эллипса.
type: docs
weight: 49
url: /ru/java/com.aspose.threed/ellipse/
---
...
Эллипс [Ellipse](../../com.aspose.threed/ellipse) определяет набор точек, образующих форму эллипса.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [Ellipse()](#Ellipse--) | Конструктор [Ellipse](../../com.aspose.threed/ellipse) |
| [Ellipse(double semiAxis1, double semiAxis2)](#Ellipse-double-double-) | Конструктор [Ellipse](../../com.aspose.threed/ellipse) |
## Методы
...
| [getSemiAxis1()](#getSemiAxis1--) | Радиус по оси X |
| [getSemiAxis2()](#getSemiAxis2--) | Радиус по оси Y |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setSemiAxis1(double value)](#setSemiAxis1-double-) | Радиус по оси X |
| [setSemiAxis2(double value)](#setSemiAxis2-double-) | Радиус по оси Y |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Конструктор [Ellipse](../../com.aspose.threed/ellipse)
...
| --- | --- | --- |
| semiAxis1 | double | Длина первой полуоси |
| semiAxis2 | double | Длина второй полуоси |

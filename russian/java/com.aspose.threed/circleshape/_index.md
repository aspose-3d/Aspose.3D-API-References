...
description: Круговой профиль, совместимый с IFC, который можно использовать для построения сетки через
type: docs
weight: 32
url: /ru/java/com.aspose.threed/circleshape/
---
...
Круговой профиль, совместимый с IFC, который можно использовать для построения сетки через [LinearExtrusion](../../com.aspose.threed/linearextrusion).
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [CircleShape()](#CircleShape--) | Создайте профиль [CircleShape](../../com.aspose.threed/circleshape) с радиусом по умолчанию (5). |
| [CircleShape(double radius)](#CircleShape-double-) | Создайте профиль [CircleShape](../../com.aspose.threed/circleshape) с указанным радиусом. |
## Методы
...
| [getRadius()](#getRadius--) | Получает радиус круга. |
...
| [setRadius(double value)](#setRadius-double-) | Устанавливает радиус круга. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Создайте профиль [CircleShape](../../com.aspose.threed/circleshape) с радиусом по умолчанию (5).
...
Создайте профиль [CircleShape](../../com.aspose.threed/circleshape) с указанным радиусом.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| radius | double | Радиус круга |

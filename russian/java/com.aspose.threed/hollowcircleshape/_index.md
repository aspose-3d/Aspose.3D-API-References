...
description: Совместимый с IFC полый круговой профиль.
type: docs
weight: 78
url: /ru/java/com.aspose.threed/hollowcircleshape/
---
...
Совместимый с IFC полый круговой профиль.
## Конструкторы
...
| [getWallThickness()](#getWallThickness--) | Получает разницу между внешним и внутренним радиусом. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setWallThickness(double value)](#setWallThickness-double-) | Устанавливает разницу между внешним и внутренним радиусом. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Получает разницу между внешним и внутренним радиусом.

**Returns:**
double - разница между внешним и внутренним радиусом.
### hashCode() {#hashCode--}
```
...
Устанавливает разницу между внешним и внутренним радиусом.

...
description: Совместимая с IFC полая прямоугольная форма с закруглёнными внутренними и внешними углами.
type: docs
weight: 79
url: /ru/java/com.aspose.threed/hollowrectangleshape/
---
...
Совместимая с IFC полая прямоугольная форма с закруглёнными внутренними и внешними углами.
## Конструкторы
...
| [getInnerFilletRadius()](#getInnerFilletRadius--) | Внутренний радиус скругления внутреннего прямоугольника. |
...
| [getRoundingRadius()](#getRoundingRadius--) | Возвращает радиус круглых дуг всех четырёх углов, измеренный в градусах. |
| [getScene()](#getScene--) | Получает сцену, к которой принадлежит этот объект |
| [getWallThickness()](#getWallThickness--) | Толщина между границей прямоугольника и внутренним отверстием |
| [getXDim()](#getXDim--) | Возвращает размер прямоугольника в направлении оси x. Значение по умолчанию — 2.0 |
| [getYDim()](#getYDim--) | Возвращает размер прямоугольника в направлении оси y. Значение по умолчанию — 2.0 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setInnerFilletRadius(double value)](#setInnerFilletRadius-double-) | Внутренний радиус скругления внутреннего прямоугольника. |
...
| [setRoundingRadius(double value)](#setRoundingRadius-double-) | Устанавливает радиус круглых дуг всех четырёх углов, измеренный в градусах. |
| [setWallThickness(double value)](#setWallThickness-double-) | Толщина между границей прямоугольника и внутренним отверстием |
| [setXDim(double value)](#setXDim-double-) | Устанавливает размер прямоугольника в направлении оси x. Значение по умолчанию — 2.0 |
| [setYDim(double value)](#setYDim-double-) | Устанавливает размер прямоугольника в направлении оси y. Значение по умолчанию — 2.0 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
**Returns:**
double — Внутренний радиус скругления внутреннего прямоугольника.
### getName() {#getName--}
```
...
**Returns:**
double — радиус круглых дуг всех четырёх углов, измеренный в градусах. Значение по умолчанию — 0.0
### getScene() {#getScene--}
```
...
**Returns:**
double — Толщина между границей прямоугольника и внутренним отверстием
### getXDim() {#getXDim--}
```
...
**Returns:**
double — размер прямоугольника в направлении оси x. Значение по умолчанию — 2.0
### getYDim() {#getYDim--}
```
...
**Returns:**
double — размер прямоугольника в направлении оси y. Значение по умолчанию — 2.0
### hashCode() {#hashCode--}
```

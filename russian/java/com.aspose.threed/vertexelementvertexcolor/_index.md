...
description: Определяет цвет вершины для указанных компонентов
type: docs
weight: 223
url: /ru/java/com.aspose.threed/vertexelementvertexcolor/
---
...
| --- | --- |
| [VertexElementVertexColor()](#VertexElementVertexColor--) | Создаёт новый экземпляр класса [VertexElementVertexColor](../../com.aspose.threed/vertexelementvertexcolor). |
## Методы
...
Создаёт новый экземпляр класса [VertexElementVertexColor](../../com.aspose.threed/vertexelementvertexcolor).

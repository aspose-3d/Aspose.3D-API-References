...
type: docs
weight: 284
url: /ru/java/com.aspose.threed/lighttype/
---
...
| Поле | Описание |
| --- | --- |
| [AREA](#AREA) | Площадной свет. |
| [DIRECTIONAL](#DIRECTIONAL) | Направленный свет. |
| [POINT](#POINT) | Точечный свет. |
| [SPOT](#SPOT) | Прожекторный свет. |
| [VOLUME](#VOLUME) | Объёмный свет. |
## Методы

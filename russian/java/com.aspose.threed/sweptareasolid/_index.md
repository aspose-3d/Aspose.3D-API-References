...
description: A  создает геометрию, вытягивая профиль вдоль дирекрисы.
type: docs
weight: 181
url: /ru/java/com.aspose.threed/sweptareasolid/
---
...
A [SweptAreaSolid](../../com.aspose.threed/sweptareasolid) создает геометрию, вытягивая профиль вдоль дирекрисы. **Example:** Следующий код показывает, как моделировать твёрдое тело, вытягивая C-образную форму по окружности.
...
| [getClass()](#getClass--) |  |
| [getDirectrix()](#getDirectrix--) | Дирекриса, вдоль которой происходит вытягивание площади. |
| [getEndPoint()](#getEndPoint--) | Конечная точка дирекрисы. |
...
| [getShape()](#getShape--) | Базовый профиль для построения геометрии. |
| [getStartPoint()](#getStartPoint--) | Начальная точка дирекрисы. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setDirectrix(Curve value)](#setDirectrix-com.aspose.threed.Curve-) | Дирекриса, вдоль которой происходит вытягивание площади. |
| [setEndPoint(EndPoint value)](#setEndPoint-com.aspose.threed.EndPoint-) | Конечная точка дирекрисы. |
...
| [setShape(Profile value)](#setShape-com.aspose.threed.Profile-) | Базовый профиль для построения геометрии. |
| [setStartPoint(EndPoint value)](#setStartPoint-com.aspose.threed.EndPoint-) | Начальная точка дирекрисы. |
...
Дирекриса, вдоль которой происходит вытягивание площади.

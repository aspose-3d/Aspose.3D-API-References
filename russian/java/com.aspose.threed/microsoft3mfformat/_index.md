...
description: Экземпляр формата файла Microsoft 3MF с утилитами, связанными с 3MF.
type: docs
weight: 104
url: /ru/java/com.aspose.threed/microsoft3mfformat/
---
...
Экземпляр формата файла Microsoft 3MF с утилитами, связанными с 3MF.
## Поля
...
| [getObjectType(Node node)](#getObjectType-com.aspose.threed.Node-) | Получает тип модели для указанного узла. |
| [getTransformForBuild(Node node)](#getTransformForBuild-com.aspose.threed.Node-) | Получить матрицу преобразования для узла, используемого в сборке. |
| [getVersion()](#getVersion--) | Получает версию формата файла |
| [hashCode()](#hashCode--) |  |
| [isBuildable(Node node)](#isBuildable-com.aspose.threed.Node-) | Проверить, помечен ли этот узел как сборка. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBuildable(Node node, boolean value, Matrix4 transform)](#setBuildable-com.aspose.threed.Node-boolean-com.aspose.threed.Matrix4-) | Пометить узел для сборки. |
| [setObjectType(Node node, String modelType)](#setObjectType-com.aspose.threed.Node-java.lang.String-) | Установить тип модели для указанного узла. |
...
Получает тип модели для указанного узла.
...
**Returns:**
java.lang.String - тип объекта 3MF для данного узла
...
Получить матрицу преобразования для узла, используемого в сборке.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Какой узел использовать для получения матрицы преобразования для сборки 3MF. |
...
Проверить, помечен ли этот узел как сборка.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Какой узел проверять |

**Returns:**
boolean - True, если он помечен как сборка
### notify() {#notify--}
```
...
Пометить узел для сборки.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Какой узел пометить как сборку. |
| значение | boolean |  |
| transform | [Matrix4](../../com.aspose.threed/matrix4) | Преобразование узла в сборке. |
...
Установить тип модели для указанного узла. Возможные значения: model surface solidsupport support other

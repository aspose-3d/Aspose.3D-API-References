...
| Параметр | Тип | Описание |
| --- | --- | --- |
|  | поток | java.io.InputStream | Входной поток, пользователь отвечает за закрытие потока. **Пример:** Следующий код показывает, как создать сцену из потока с источником токена отмены |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| поток | java.io.InputStream | Входной поток, пользователь отвечает за закрытие потока. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
|  | поток | java.io.InputStream | Входной поток, пользователь отвечает за закрытие потока. **Пример:** Следующий код показывает, как открыть сцену из потока |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| поток | java.io.OutputStream | Входной поток, пользователь отвечает за закрытие потока. |

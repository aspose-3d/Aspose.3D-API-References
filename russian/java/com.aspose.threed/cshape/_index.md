...
description: Совместимый с IFC профиль C-образной формы, определяемый параметрами.
type: docs
weight: 27
url: /ru/java/com.aspose.threed/cshape/
---
...
Профиль C-образной формы, совместимый с IFC, определяемый параметрами. Центр профиля находится в центре ограничивающего прямоугольника.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [CShape()](#CShape--) | Конструктор [CShape](../../com.aspose.threed/cshape) |
## Методы
...
| [getClass()](#getClass--) |  |
| [getDepth()](#getDepth--) | Получает глубину профиля. |
...
| [getGirth()](#getGirth--) | Получает длину обхвата. |
| [getInternalFilletRadius()](#getInternalFilletRadius--) | Получает внутренний радиус скругления. |
...
| [getWallThickness()](#getWallThickness--) | Получает толщину стены. |
| [getWidth()](#getWidth--) | Получает ширину профиля. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setDepth(double value)](#setDepth-double-) | Устанавливает глубину профиля. |
| [setExcluded(boolean value)](#setExcluded-boolean-) | Устанавливает, следует ли исключать эту сущность при экспорте. |
| [setGirth(double value)](#setGirth-double-) | Устанавливает длину обхвата. |
| [setInternalFilletRadius(double value)](#setInternalFilletRadius-double-) | Устанавливает внутренний радиус скругления. |
...
| [setWallThickness(double value)](#setWallThickness-double-) | Устанавливает толщину стены. |
| [setWidth(double value)](#setWidth-double-) | Устанавливает ширину профиля. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Конструктор [CShape](../../com.aspose.threed/cshape)
...
Получает глубину профиля.

**Returns:**
double — глубина профиля.
...
Получает длину обхвата.

**Returns:**
double — длина обхвата.
...
Получает внутренний радиус скругления.

**Returns:**
double — внутренний радиус скругления.
### getName() {#getName--}
```
...
Получает толщину стены.

**Returns:**
double — толщина стены.
### getWidth() {#getWidth--}
```
...
Получает ширину профиля.

**Returns:**
double — ширина профиля.
### hashCode() {#hashCode--}
```
...
Устанавливает внутренний радиус скругления.

...
type: docs
weight: 269
url: /ru/java/com.aspose.threed/renderingapi/
---
...
| Поле | Описание |
| --- | --- |
| [ARNOLD](#ARNOLD) | Рендерер Arnold |
| [CUSTOM](#CUSTOM) | Пользовательский API рендеринга |
| [DIRECTX](#DIRECTX) | DirectX |
| [MANTLE](#MANTLE) | AMD Mantle |
| [MENTAL_RAY](#MENTAL-RAY) | MentalRay |
| [METAL](#METAL) | Metal, разработанный Apple |
| [NONE](#NONE) | Отсутствует API рендеринга |
| [OPENGL](#OPENGL) | OpenGL |
| [OPENGLES](#OPENGLES) | OpenGL ES |
| [PREVIEW](#PREVIEW) | PreviewColorAPI, совместимый с FBX |
| [RENDER_MAN](#RENDER-MAN) | RenderMan |
| [RENDER_WARE](#RENDER-WARE) | RenderWare |
| [SHADERFX](#SHADERFX) | Рендерер ShaderFX |
| [STAGE3D](#STAGE3D) | Stage3D, используемый в Adobe Flash |
...
PreviewColorAPI, совместимый с FBX
...
Stage3D, используемый в Adobe Flash

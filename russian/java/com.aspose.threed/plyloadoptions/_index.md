...
description: Параметры загрузки для файлов PLY
type: docs
weight: 130
url: /ru/java/com.aspose.threed/plyloadoptions/
---
...
Параметры загрузки для файлов PLY
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PlyLoadOptions()](#PlyLoadOptions--) | Конструктор [PlyLoadOptions](../../com.aspose.threed/plyloadoptions) |
## Методы
...
Конструктор [PlyLoadOptions](../../com.aspose.threed/plyloadoptions)

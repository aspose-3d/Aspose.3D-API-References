...
description: Определяет нормальные векторы для указанных компонентов.
type: docs
weight: 214
url: /ru/java/com.aspose.threed/vertexelementnormal/
---
...
| --- | --- |
| [VertexElementNormal()](#VertexElementNormal--) | Создаёт новый экземпляр класса [VertexElementNormal](../../com.aspose.threed/vertexelementnormal). |
## Методы
...
Создаёт новый экземпляр класса [VertexElementNormal](../../com.aspose.threed/vertexelementnormal).

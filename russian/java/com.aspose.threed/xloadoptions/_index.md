...
type: docs
weight: 233
url: /ru/java/com.aspose.threed/xloadoptions/
---
...
| --- | --- |
| [XLoadOptions(FileContentType contentType)](#XLoadOptions-com.aspose.threed.FileContentType-) | Конструктор класса [XLoadOptions](../../com.aspose.threed/xloadoptions) |
## Методы
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | Инвертировать систему координат, по умолчанию true. |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | Инвертировать систему координат, по умолчанию true. |
...
Конструктор класса [XLoadOptions](../../com.aspose.threed/xloadoptions)
...
Инвертировать систему координат, по умолчанию true.

**Returns:**
boolean - Инвертировать систему координат, по умолчанию true.

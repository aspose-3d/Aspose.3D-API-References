...
description: Совместимый с IFC профиль центральной линии
type: docs
weight: 30
url: /ru/java/com.aspose.threed/centerlineprofile/
---
...
Совместимый с IFC профиль центральной линии
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [CenterLineProfile(Curve curve, double thickness)](#CenterLineProfile-com.aspose.threed.Curve-double-) | Создаёт новый [CenterLineProfile](../../com.aspose.threed/centerlineprofile) с указанной кривой в качестве центральной линии. |
| [CenterLineProfile(Curve curve)](#CenterLineProfile-com.aspose.threed.Curve-) | Создаёт новый [CenterLineProfile](../../com.aspose.threed/centerlineprofile) с указанной кривой в качестве центральной линии. |
## Методы
...
| [getClass()](#getClass--) |  |
| [getCurve()](#getCurve--) | Кривая центральной линии профиля |
...
| [getThickness()](#getThickness--) | Толщина, применяемая вдоль центральной линии |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setCurve(Curve value)](#setCurve-com.aspose.threed.Curve-) | Кривая центральной линии профиля |
...
| [setThickness(double value)](#setThickness-double-) | Толщина, применяемая вдоль центральной линии |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Создаёт новый [CenterLineProfile](../../com.aspose.threed/centerlineprofile) с указанной кривой в качестве центральной линии.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Кривая центральной линии |
| толщина | double | Толщина, применяемая вдоль центральной линии |
...
Кривая центральной линии профиля
...
Толщина, применяемая вдоль центральной линии

**Returns:**
double - Толщина, применяемая вдоль центральной линии
### hashCode() {#hashCode--}
```

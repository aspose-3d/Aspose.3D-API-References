...
type: docs
weight: 184
url: /ru/java/com.aspose.threed/texture/
---
...
| --- | --- |
| [Texture()](#Texture--) | Инициализирует новый экземпляр класса [Texture](../../com.aspose.threed/texture). |
| [Texture(String name)](#Texture-java.lang.String-) | Инициализирует новый экземпляр класса [Texture](../../com.aspose.threed/texture). |
## Методы
...
| [getClass()](#getClass--) |  |
| [getContent()](#getContent--) | Получает двоичное содержимое текстуры. |
| [getEnableMipMap()](#getEnableMipMap--) | Получает, включён ли mipmap для этой текстуры. |
| [getFileName()](#getFileName--) | Получает связанный файл текстуры. |
...
| [setContent(byte[] value)](#setContent-byte---) | Устанавливает двоичное содержимое текстуры. |
| [setEnableMipMap(boolean value)](#setEnableMipMap-boolean-) | Устанавливает, включён ли mipmap для этой текстуры |
| [setFileName(String value)](#setFileName-java.lang.String-) | Устанавливает связанный файл текстуры. |
...
Инициализирует новый экземпляр класса [Texture](../../com.aspose.threed/texture).
...
Получает двоичное содержимое текстуры. Встроенное содержимое текстуры является необязательным, пользователь должен загрузить текстуру из внешнего файла, если оно отсутствует.

**Returns:**
byte[] - двоичное содержимое текстуры. Встроенное содержимое текстуры является необязательным, пользователь должен загрузить текстуру из внешнего файла, если оно отсутствует.
...
Получает, включён ли mipmap для этой текстуры.

**Returns:**
boolean - включён ли mipmap для этой текстуры
...
Получает связанный файл текстуры.

**Returns:**
java.lang.String - связанный файл текстуры.
...
Устанавливает двоичное содержимое текстуры. Встроенное содержимое текстуры является необязательным, пользователь должен загрузить текстуру из внешнего файла, если оно отсутствует.
...
Устанавливает, включён ли mipmap для этой текстуры
...
Устанавливает связанный файл текстуры.

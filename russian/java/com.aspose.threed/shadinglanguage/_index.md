...
description: "Широко используемые языки шейдеров"
type: docs
weight: 272
url: /ru/java/com.aspose.threed/shadinglanguage/
---
...
| Поле | Описание |
| --- | --- |
| [AGAL](#AGAL) | Язык ассемблера графики Adobe |
| [ARB_ASSEMBLY](#ARB-ASSEMBLY) | Язык ассемблера ARB — это низкоуровневый язык шейдеров, созданный OpenGL Architecture Review Board для стандартизации инструкций GPU. |
| [CGFX](#CGFX) | NVIDIA Cg |
| [DIRECTX_SHADER_ASSEMBLY](#DIRECTX-SHADER-ASSEMBLY) | Язык ассемблера шейдеров DirectX |
| [GELATO](#GELATO) | Язык шейдеров gelato |
| [GLSL](#GLSL) | GLSL |
| [HLSL](#HLSL) | DirectX язык высокоуровневых шейдеров |
| [HOUDINIVEX](#HOUDINIVEX) | Язык шейдеров VEX Houdini |
| [MENTAL_RAY](#MENTAL-RAY) | Язык шейдеров Mental Ray |
| [METAL](#METAL) | Язык шейдеров Metal для iOS |
| [OPEN_SHADING_LANGUAGE](#OPEN-SHADING-LANGUAGE) | Open shading language разрабатывается Sony Pictures Imageworks и используется в их рендерере Arnold. |
| [PSSL](#PSSL) | Язык шейдеров PlayStation |
| [RENDER_MAN](#RENDER-MAN) | Язык шейдеров RenderMan. |
| [SFX](#SFX) | SFX |
## Методы

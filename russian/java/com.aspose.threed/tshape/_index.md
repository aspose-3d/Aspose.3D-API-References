...
description: Совместимая с IFC T-форма, определённая параметрами.
type: docs
weight: 182
url: /ru/java/com.aspose.threed/tshape/
---
...
Совместимая с IFC T-форма, определённая параметрами.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [TShape()](#TShape--) | Конструктор [TShape](../../com.aspose.threed/tshape) |
## Методы
...
| [getClass()](#getClass--) |  |
| [getDepth()](#getDepth--) | Получает длину стенки. |
...
| [getFilletRadius()](#getFilletRadius--) | Получает радиус скругления между стенкой и фланцем. |
| [getFlangeEdgeRadius()](#getFlangeEdgeRadius--) | Получает радиус кромки фланца. |
| [getFlangeThickness()](#getFlangeThickness--) | Получает толщину стенки фланца. |
| [getFlangeWidth()](#getFlangeWidth--) | Получает длину фланца. |
...
| [getWebEdgeRadius()](#getWebEdgeRadius--) | Получает радиус кромки стенки. |
| [getWebThickness()](#getWebThickness--) | Получает толщину стенки. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setDepth(double value)](#setDepth-double-) | Устанавливает длину стенки. |
| [setExcluded(boolean value)](#setExcluded-boolean-) | Устанавливает, следует ли исключать эту сущность при экспорте. |
| [setFilletRadius(double value)](#setFilletRadius-double-) | Устанавливает радиус скругления между стенкой и фланцем. |
| [setFlangeEdgeRadius(double value)](#setFlangeEdgeRadius-double-) | Устанавливает радиус кромки фланца. |
| [setFlangeThickness(double value)](#setFlangeThickness-double-) | Устанавливает толщину стенки фланца. |
| [setFlangeWidth(double value)](#setFlangeWidth-double-) | Устанавливает длину фланца. |
...
| [setWebEdgeRadius(double value)](#setWebEdgeRadius-double-) | Устанавливает радиус кромки стенки. |
| [setWebThickness(double value)](#setWebThickness-double-) | Устанавливает толщину стенки. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Конструктор [TShape](../../com.aspose.threed/tshape)
...
Получает радиус скругления между стенкой и фланцем.

**Returns:**
double - радиус скругления между стенкой и фланцем.
...
Получает радиус кромки фланца.

**Returns:**
double - радиус кромки фланца.
...
Получает толщину стенки фланца.

**Returns:**
double - толщина стенки фланца.
...
Получает радиус кромки стенки.

**Returns:**
double - радиус кромки стенки.
...
Получает толщину стенки.

**Returns:**
double - толщина стенки.
### hashCode() {#hashCode--}
```
...
Устанавливает радиус скругления между стенкой и фланцем.
...
Устанавливает радиус кромки фланца.
...
Устанавливает толщину стенки фланца.
...
Устанавливает радиус кромки стенки.

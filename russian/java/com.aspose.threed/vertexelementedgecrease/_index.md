...
description: Определяет сгиб ребра для указанных компонентов
type: docs
weight: 210
url: /ru/java/com.aspose.threed/vertexelementedgecrease/
---
...
| --- | --- |
| [VertexElementEdgeCrease()](#VertexElementEdgeCrease--) | Создаёт новый экземпляр класса [VertexElementEdgeCrease](../../com.aspose.threed/vertexelementedgecrease). |
## Методы
...
Создаёт новый экземпляр класса [VertexElementEdgeCrease](../../com.aspose.threed/vertexelementedgecrease).

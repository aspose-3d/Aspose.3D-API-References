...
description: Определяет бинормальные векторы для указанных компонентов.
type: docs
weight: 208
url: /ru/java/com.aspose.threed/vertexelementbinormal/
---
...
| --- | --- |
| [VertexElementBinormal()](#VertexElementBinormal--) | Создаёт новый экземпляр класса [VertexElementBinormal](../../com.aspose.threed/vertexelementbinormal). |
## Методы
...
Создаёт новый экземпляр класса [VertexElementBinormal](../../com.aspose.threed/vertexelementbinormal).

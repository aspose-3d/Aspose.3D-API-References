...
description: Этап рендеринга
type: docs
weight: 298
url: /ru/java/com.aspose.threed/renderstage/
---
...
| Поле | Описание |
| --- | --- |
| [IDLE](#IDLE) | Рендерер бездействует |
| [POST_PROCESSING](#POST-PROCESSING) | Рендерер применяет эффекты постобработки. |
| [SCENE](#SCENE) | Рендерер отрисовывает сцену |
| [SHADOW_MAP](#SHADOW-MAP) | Рендерер отрисовывает карту теней |
## Методы
...
Рендерер применяет эффекты постобработки.
...
Рендерер отрисовывает карту теней

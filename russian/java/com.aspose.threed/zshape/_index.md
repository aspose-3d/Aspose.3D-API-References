...
description: Совместимый с IFC профиль Z-образной формы, определённый параметрами.
type: docs
weight: 234
url: /ru/java/com.aspose.threed/zshape/
---
...
Совместимый с IFC профиль Z-образной формы, определённый параметрами.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [ZShape()](#ZShape--) | Конструктор [ZShape](../../com.aspose.threed/zshape) |
## Методы
...
| [getEdgeRadius()](#getEdgeRadius--) | Получает радиус кромки фланца. |
...
| [setEdgeRadius(double value)](#setEdgeRadius-double-) | Устанавливает радиус кромки фланца. |
...
Конструктор [ZShape](../../com.aspose.threed/zshape)

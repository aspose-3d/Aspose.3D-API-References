...
description: "Создано пользователем lexchou 16.06.2017."
type: docs
weight: 66
url: /ru/java/com.aspose.threed/filestream/
---
...
Создано пользователем lexchou 16.06.2017.
## Конструкторы
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| поток | java.io.OutputStream | поток вывода для обёртки |

...
description: Размерность кривых.
type: docs
weight: 275
url: /ru/java/com.aspose.threed/curvedimension/
---
...
| Поле | Описание |
| --- | --- |
| [THREE_DIMENSIONAL](#THREE-DIMENSIONAL) | Кривые представляют собой трехмерные точки. |
| [TWO_DIMENSIONAL](#TWO-DIMENSIONAL) | Кривые представляют собой двумерные точки. |
## Методы
...
Кривые представляют собой трехмерные точки.
...
Кривые представляют собой двумерные точки.

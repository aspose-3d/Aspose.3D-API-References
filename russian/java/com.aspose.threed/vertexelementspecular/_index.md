...
description: Определяет зеркальный цвет для указанных компонентов.
type: docs
weight: 217
url: /ru/java/com.aspose.threed/vertexelementspecular/
---
...
| --- | --- |
| [VertexElementSpecular()](#VertexElementSpecular--) | Инициализирует новый экземпляр класса [VertexElementSpecular](../../com.aspose.threed/vertexelementspecular). |
## Методы
...
Инициализирует новый экземпляр класса [VertexElementSpecular](../../com.aspose.threed/vertexelementspecular).

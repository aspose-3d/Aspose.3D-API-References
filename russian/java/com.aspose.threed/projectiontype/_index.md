...
description: Типы проекций камер.
type: docs
weight: 295
url: /ru/java/com.aspose.threed/projectiontype/
---
...
| Поле | Описание |
| --- | --- |
| [ORTHOGRAPHIC](#ORTHOGRAPHIC) | Камера использует ортографическую проекцию. |
| [PERSPECTIVE](#PERSPECTIVE) | Камера использует перспективную проекцию. |
## Методы
...
Камера использует ортографическую проекцию.
...
Камера использует перспективную проекцию.

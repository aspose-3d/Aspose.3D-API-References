...
description: Профиль зеркала, совместимый с IFC.
type: docs
weight: 106
url: /ru/java/com.aspose.threed/mirroredprofile/
---
...
Совместимый с IFC профиль зеркального отражения. Этот профиль определяет новый профиль, зеркально отражая базовый профиль относительно оси y.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [MirroredProfile(Profile baseProfile)](#MirroredProfile-com.aspose.threed.Profile-) | Создайте новый [MirroredProfile](../../com.aspose.threed/mirroredprofile) из существующего профиля. |
## Методы
...
| [getBaseProfile()](#getBaseProfile--) | Базовый профиль, который будет отражён. |
...
Создайте новый [MirroredProfile](../../com.aspose.threed/mirroredprofile) из существующего профиля.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| baseProfile | [Profile](../../com.aspose.threed/profile) | Базовый профиль, который будет отражён. |
...
Базовый профиль, который будет отражён.

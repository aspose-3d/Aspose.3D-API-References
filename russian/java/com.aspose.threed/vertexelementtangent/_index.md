...
description: Определяет касательные векторы для указанных компонентов.
type: docs
weight: 218
url: /ru/java/com.aspose.threed/vertexelementtangent/
---
...
| --- | --- |
| [VertexElementTangent()](#VertexElementTangent--) | Инициализирует новый экземпляр класса [VertexElementTangent](../../com.aspose.threed/vertexelementtangent). |
## Методы
...
Инициализирует новый экземпляр класса [VertexElementTangent](../../com.aspose.threed/vertexelementtangent).

...
description: Параметры загрузки для Siemens JT
type: docs
weight: 88
url: /ru/java/com.aspose.threed/jtloadoptions/
---
...
Параметры загрузки для Siemens JT
## Конструкторы
...
| [getLoadPMI()](#getLoadPMI--) | Загрузить информацию PMI из файла JT, если возможно; данные будут сохранены как свойство "PMI" объекта [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). |
| [getLoadProperties()](#getLoadProperties--) | Загрузить свойства из таблицы свойств JT как свойства Aspose.3D. |
...
| [setLoadPMI(boolean value)](#setLoadPMI-boolean-) | Загрузить информацию PMI из файла JT, если возможно; данные будут сохранены как свойство "PMI" объекта [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). |
| [setLoadProperties(boolean value)](#setLoadProperties-boolean-) | Загрузить свойства из таблицы свойств JT как свойства Aspose.3D. |
...
Загрузить информацию PMI из файла JT, если возможно; данные будут сохранены как свойство "PMI" объекта [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). Значение по умолчанию — false.

**Returns:**
boolean - Загрузить информацию PMI из файла JT, если возможно; данные будут сохранены как свойство "PMI" объекта [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). Значение по умолчанию — false.
...
Загрузить свойства из таблицы свойств JT как свойства Aspose.3D. Значение по умолчанию — false.

**Returns:**
boolean - Загрузить свойства из таблицы свойств JT как свойства Aspose.3D. Значение по умолчанию — false.

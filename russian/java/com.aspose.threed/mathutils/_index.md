...
| [toRadian(double degree)](#toRadian-double-) | Преобразовать число из градусов в радианы |
| [toRadian(double x, double y, double z)](#toRadian-double-double-double-) | Преобразовать вектор из градусов в радианы |
| [toRadian(float degree)](#toRadian-float-) | Преобразовать число из градусов в радианы |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
**Returns:**
double - Значение между [min, max] **Example:**
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| radian | [Vector3](../../com.aspose.threed/vector3) | Значение в радианах. |
...
**Returns:**
double - Значение в градусах. **Example:**
...
**Returns:**
float - Значение в градусах. **Example:**
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| degree | [Vector3](../../com.aspose.threed/vector3) | Значение в градусах. |
...
**Returns:**
double - Значение в радианах. **Example:**
...
**Returns:**
float - Значение в радианах. **Example:**

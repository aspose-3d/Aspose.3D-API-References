...
description: Совместимая с IFC форма эллипса, определяемая параметрами.
type: docs
weight: 50
url: /ru/java/com.aspose.threed/ellipseshape/
---
...
Эллиптическая форма, совместимая с IFC, определяемая параметрами. Позиция центра профиля находится в центре ограничивающего прямоугольника.
## Конструкторы
...
| [getSemiAxis1()](#getSemiAxis1--) | Возвращает первый радиус эллипса, измеренный в направлении оси x. |
| [getSemiAxis2()](#getSemiAxis2--) | Возвращает второй радиус эллипса, измеренный в направлении оси y. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setSemiAxis1(double value)](#setSemiAxis1-double-) | Устанавливает первый радиус эллипса, измеренный в направлении оси x. |
| [setSemiAxis2(double value)](#setSemiAxis2-double-) | Устанавливает второй радиус эллипса, измеренный в направлении оси y. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Возвращает первый радиус эллипса, измеренный в направлении оси x.

**Returns:**
double — первый радиус эллипса, измеренный в направлении оси x.
...
Возвращает второй радиус эллипса, измеренный в направлении оси y.

**Returns:**
double — второй радиус эллипса, измеренный в направлении оси y.
### hashCode() {#hashCode--}
```
...
Устанавливает первый радиус эллипса, измеренный в направлении оси x.
...
Устанавливает второй радиус эллипса, измеренный в направлении оси y.

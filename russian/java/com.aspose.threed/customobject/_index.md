...
description: "Метаданные или пользовательские объекты, используемые в 3D‑файлах, управляются этим классом."
type: docs
weight: 39
url: /ru/java/com.aspose.threed/customobject/
---
...
Метаданные или пользовательские объекты, используемые в 3D‑файлах, управляются этим классом. Все пользовательские свойства сохраняются как динамические свойства.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [CustomObject()](#CustomObject--) | Инициализирует новый экземпляр класса [CustomObject](../../com.aspose.threed/customobject). |
| [CustomObject(String name)](#CustomObject-java.lang.String-) | Инициализирует новый экземпляр класса [CustomObject](../../com.aspose.threed/customobject). |
## Методы
...
Инициализирует новый экземпляр класса [CustomObject](../../com.aspose.threed/customobject).

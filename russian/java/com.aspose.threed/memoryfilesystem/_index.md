...
description: Этот  будет отображать операции чтения/записи в память.
type: docs
weight: 95
url: /ru/java/com.aspose.threed/memoryfilesystem/
---
...
Этот [MemoryFileSystem](../../com.aspose.threed/memoryfilesystem) будет отображать операции чтения/записи в память. **Example:** Следующий код показывает, как экспортировать файл в память, включая зависимый файл с помощью MemoryFileSystem.
...
| [getClass()](#getClass--) |  |
| [getFileContent(String fileName)](#getFileContent-java.lang.String-) | Возвращает необработанное содержимое указанного файла. |
| [getFileNames()](#getFileNames--) | Имена файлов в этой файловой системе памяти. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Возвращает необработанное содержимое указанного файла. Выбрасывает java.io.FileNotFoundException, если указанный файл не существует.

...
description: Координатная ось.
type: docs
weight: 265
url: /ru/java/com.aspose.threed/axis/
---
...
| Поле | Описание |
| --- | --- |
| [NEGATIVE_X_AXIS](#NEGATIVE-X-AXIS) | Ось -X. |
| [NEGATIVE_Y_AXIS](#NEGATIVE-Y-AXIS) | Ось -Y. |
| [NEGATIVE_Z_AXIS](#NEGATIVE-Z-AXIS) | Ось -Z. |
| [X_AXIS](#X-AXIS) | Ось +X. |
| [Y_AXIS](#Y-AXIS) | Ось +Y. |
| [Z_AXIS](#Z-AXIS) | Ось +Z. |
## Методы

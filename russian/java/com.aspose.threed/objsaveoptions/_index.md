...
description: Параметры сохранения для файла wavefront obj
type: docs
weight: 116
url: /ru/java/com.aspose.threed/objsaveoptions/
---
...
Параметры сохранения для файла wavefront obj
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [ObjSaveOptions()](#ObjSaveOptions--) | Конструктор класса [ObjSaveOptions](../../com.aspose.threed/objsaveoptions). |
## Методы
...
| [getAxisSystem()](#getAxisSystem--) | Получает систему координат в экспортированном файле. |
| [getClass()](#getClass--) |  |
| [getEnableMaterials()](#getEnableMaterials--) | Получает, следует ли импортировать/экспортировать материалы для каждого объекта. |
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | Получает, следует ли инвертировать систему координат контрольных точек/нормалей при импорте/экспорте. |
...
| [getPointCloud()](#getPointCloud--) | Получает флаг, указывающий, должен ли экспортер экспортировать сцену как облако точек (без топологической структуры), значение по умолчанию — false. |
| [getSerializeW()](#getSerializeW--) | Получает, сериализовать ли компонент W в позиции вершины модели. |
| [getVerbose()](#getVerbose--) | Получает, генерировать ли комментарии для каждого раздела. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setAxisSystem(AxisSystem value)](#setAxisSystem-com.aspose.threed.AxisSystem-) | Устанавливает систему координат в экспортированном файле. |
| [setEnableMaterials(boolean value)](#setEnableMaterials-boolean-) | Устанавливает, импортировать/экспортировать материалы для каждого объекта. |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | Устанавливает, следует ли инвертировать систему координат контрольных точек/нормалей при импорте/экспорте. |
...
| [setPointCloud(boolean value)](#setPointCloud-boolean-) | Устанавливает флаг, указывающий, должен ли экспортер экспортировать сцену как облако точек (без топологической структуры), значение по умолчанию — false. |
| [setSerializeW(boolean value)](#setSerializeW-boolean-) | Устанавливает, следует ли сериализовать компонент W в позиции вершины модели. |
| [setVerbose(boolean value)](#setVerbose-boolean-) | Устанавливает, следует ли генерировать комментарии для каждого раздела. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Конструктор класса [ObjSaveOptions](../../com.aspose.threed/objsaveoptions).
...
Получает систему координат в экспортированном файле.
...
Получает, следует ли импортировать/экспортировать материалы для каждого объекта.

**Returns:**
boolean — следует ли импортировать/экспортировать материалы для каждого объекта.
...
Получает, следует ли инвертировать систему координат контрольных точек/нормалей при импорте/экспорте.

**Returns:**
boolean - инвертировать ли систему координат контрольных точек/нормалей при импорте/экспорте.
...
Получает флаг, указывающий, должен ли экспортер экспортировать сцену как облако точек (без топологической структуры), значение по умолчанию — false.

**Returns:**
boolean — флаг, указывающий, должен ли экспортер экспортировать сцену как облако точек (без топологической структуры), значение по умолчанию — false.
...
Получает, сериализовать ли компонент W в позиции вершины модели.

**Returns:**
boolean — следует ли сериализовать компонент W в позиции вершины модели.
...
Получает, генерировать ли комментарии для каждого раздела.

**Returns:**
boolean — следует ли генерировать комментарии для каждого раздела.
### hashCode() {#hashCode--}
```
...
Устанавливает систему координат в экспортированном файле.
...
Устанавливает, импортировать/экспортировать материалы для каждого объекта.
...
Устанавливает, следует ли инвертировать систему координат контрольных точек/нормалей при импорте/экспорте.
...
Устанавливает флаг, указывающий, должен ли экспортер экспортировать сцену как облако точек (без топологической структуры), значение по умолчанию — false.
...
Устанавливает, следует ли сериализовать компонент W в позиции вершины модели.
...
Устанавливает, следует ли генерировать комментарии для каждого раздела.

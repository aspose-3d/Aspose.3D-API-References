...
type: docs
weight: 128
url: /ru/java/com.aspose.threed/plane/
---
...
| --- | --- |
| [Plane()](#Plane--) | Создаёт новый экземпляр [Plane](../../com.aspose.threed/plane) с размером по умолчанию 1x1. |
| [Plane(double length, double width)](#Plane-double-double-) | Создаёт новый экземпляр [Plane](../../com.aspose.threed/plane). |
| [Plane(String name, double length, double width, int lengthSegments, int widthSegments)](#Plane-java.lang.String-double-double-int-int-) | Создаёт новый экземпляр [Plane](../../com.aspose.threed/plane). |
## Методы
...
| [getLength()](#getLength--) | Возвращает длину плоскости. |
...
| [getUp()](#getUp--) | Возвращает вектор вверх плоскости, значение по умолчанию (0, 1, 0), это влияет на генерацию плоскости. |
| [getWidth()](#getWidth--) | Возвращает ширину плоскости. |
...
| [setLength(double value)](#setLength-double-) | Устанавливает длину плоскости. |
...
| [setUp(Vector3 value)](#setUp-com.aspose.threed.Vector3-) | Устанавливает вектор вверх плоскости, значение по умолчанию (0, 1, 0), это влияет на генерацию плоскости. |
| [setWidth(double value)](#setWidth-double-) | Устанавливает ширину плоскости. |
...
Создаёт новый экземпляр [Plane](../../com.aspose.threed/plane) с размером по умолчанию 1x1.
...
Создаёт новый экземпляр [Plane](../../com.aspose.threed/plane).

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| длина | double | Длина плоскости. |
| ширина | double | Ширина плоскости. |
...
Возвращает длину плоскости.

**Returns:**
double - длина плоскости.
...
Возвращает вектор вверх плоскости, значение по умолчанию (0, 1, 0), это влияет на генерацию плоскости.
...
Возвращает ширину плоскости.

**Returns:**
double - ширина плоскости.
...
Устанавливает вектор вверх плоскости, значение по умолчанию (0, 1, 0), это влияет на генерацию плоскости.
...
Устанавливает ширину плоскости.

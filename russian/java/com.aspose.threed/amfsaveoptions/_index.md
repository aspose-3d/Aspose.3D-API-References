...
type: docs
weight: 12
url: /ru/java/com.aspose.threed/amfsaveoptions/
---
...
| --- | --- |
| [AmfSaveOptions()](#AmfSaveOptions--) | Конструктор [AmfSaveOptions](../../com.aspose.threed/amfsaveoptions) |
## Методы
...
| [getClass()](#getClass--) |  |
| [getEnableCompression()](#getEnableCompression--) | Нужно ли использовать сжатие для уменьшения конечного размера файла, значение по умолчанию — true |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEnableCompression(boolean value)](#setEnableCompression-boolean-) | Нужно ли использовать сжатие для уменьшения конечного размера файла, значение по умолчанию — true |
...
Конструктор [AmfSaveOptions](../../com.aspose.threed/amfsaveoptions)
...
Нужно ли использовать сжатие для уменьшения конечного размера файла, значение по умолчанию — true

**Returns:**
boolean - Нужно ли использовать сжатие для уменьшения конечного размера файла, значение по умолчанию — true

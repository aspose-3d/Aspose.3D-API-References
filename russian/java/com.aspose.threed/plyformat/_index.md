...
type: docs
weight: 129
url: /ru/java/com.aspose.threed/plyformat/
---
...
| [decode(Stream stream)](#decode-com.aspose.threed.Stream-) | Декодировать облако точек или сетку из указанного потока. |
| [decode(Stream stream, PlyLoadOptions opt)](#decode-com.aspose.threed.Stream-com.aspose.threed.PlyLoadOptions-) | Декодировать облако точек или сетку из указанного потока. |
| [decode(String fileName)](#decode-java.lang.String-) | Декодировать облако точек или сетку из указанного потока. |
| [decode(String fileName, PlyLoadOptions opt)](#decode-java.lang.String-com.aspose.threed.PlyLoadOptions-) | Декодировать облако точек или сетку из указанного потока. |
...
| [encode(Entity entity, Stream stream)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-) | Кодировать объект и сохранить результат в поток. |
| [encode(Entity entity, Stream stream, PlySaveOptions opt)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-com.aspose.threed.PlySaveOptions-) | Кодировать объект и сохранить результат в поток. |
| [encode(Entity entity, String fileName)](#encode-com.aspose.threed.Entity-java.lang.String-) | Кодировать объект и сохранить результат во внешний файл. |
| [encode(Entity entity, String fileName, PlySaveOptions opt)](#encode-com.aspose.threed.Entity-java.lang.String-com.aspose.threed.PlySaveOptions-) | Кодировать объект и сохранить результат во внешний файл. |
...
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | Входной поток |
...
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | Входной поток |
| opt | [PlyLoadOptions](../../com.aspose.threed/plyloadoptions) | Опция загрузки формата PLY |
...
|  | stream | [Stream](../../com.aspose.threed/stream) | Поток для записи, этот метод не закроет этот поток **Example:** Следующий код показывает, как закодировать сетку в файл PLY: |

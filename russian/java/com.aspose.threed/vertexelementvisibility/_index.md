...
description: Определяет, видимы ли указанные компоненты
type: docs
weight: 225
url: /ru/java/com.aspose.threed/vertexelementvisibility/
---
...
Определяет, видимы ли указанные компоненты
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [VertexElementVisibility()](#VertexElementVisibility--) | Создаёт новый экземпляр класса [VertexElementVisibility](../../com.aspose.threed/vertexelementvisibility). |
## Методы
...
| [copyTo(VertexElementTemplate<T> target)](#copyTo-com.aspose.threed.VertexElementTemplate-T--) | Копирует данные в указанный элемент |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(T[] data)](#setData-T---) | Загрузить данные |
...
Создаёт новый экземпляр класса [VertexElementVisibility](../../com.aspose.threed/vertexelementvisibility).
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| target | [VertexElementTemplate](../../com.aspose.threed/vertexelementtemplate) | Цель. |
...
**Returns:**
java.util.List<T> - данные вершины

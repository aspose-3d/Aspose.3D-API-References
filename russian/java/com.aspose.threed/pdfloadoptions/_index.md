...
type: docs
weight: 124
url: /ru/java/com.aspose.threed/pdfloadoptions/
---
...
| --- | --- |
| [PdfLoadOptions()](#PdfLoadOptions--) | Конструктор [PdfLoadOptions](../../com.aspose.threed/pdfloadoptions) |
## Методы
...
| [getPassword()](#getPassword--) | Пароль для разблокировки зашифрованного PDF‑файла. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setPassword(byte[] value)](#setPassword-byte---) | Пароль для разблокировки зашифрованного PDF‑файла. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Конструктор [PdfLoadOptions](../../com.aspose.threed/pdfloadoptions)
...
Пароль для разблокировки зашифрованного PDF‑файла.

**Returns:**
byte[] - Пароль для разблокировки зашифрованного PDF‑файла.
### hashCode() {#hashCode--}
```

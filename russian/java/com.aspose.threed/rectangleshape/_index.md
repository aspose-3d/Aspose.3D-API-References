...
description: Прямоугольная форма, совместимая с IFC, со скруглёнными углами.
type: docs
weight: 145
url: /ru/java/com.aspose.threed/rectangleshape/
---
...
| --- | --- |
| [RectangleShape()](#RectangleShape--) | Конструктор [RectangleShape](../../com.aspose.threed/rectangleshape) |
| [RectangleShape(double xdim, double ydim)](#RectangleShape-double-double-) | Конструктор [RectangleShape](../../com.aspose.threed/rectangleshape) с указанными размерами по осям x и y. |
## Методы
...
Конструктор [RectangleShape](../../com.aspose.threed/rectangleshape)
...
Конструктор [RectangleShape](../../com.aspose.threed/rectangleshape) с указанными размерами по осям x и y.

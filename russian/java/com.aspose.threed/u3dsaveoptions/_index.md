...
type: docs
weight: 198
url: /ru/java/com.aspose.threed/u3dsaveoptions/
---
...
| --- | --- |
| [U3dSaveOptions()](#U3dSaveOptions--) | Конструктор [U3dSaveOptions](../../com.aspose.threed/u3dsaveoptions) |
## Методы
...
| [getClass()](#getClass--) |  |
| [getEmbedTextures()](#getEmbedTextures--) | Встраивание внешних текстур в файл U3D, значение по умолчанию — false. |
| [getEncoding()](#getEncoding--) | Получает кодировку по умолчанию для текстовых файлов. |
| [getExportNormals()](#getExportNormals--) | Получает, следует ли экспортировать данные нормалей. |
| [getExportTextureCoordinates()](#getExportTextureCoordinates--) | Получает, следует ли экспортировать координаты текстур. |
| [getExportTextures()](#getExportTextures--) | Пытается скопировать текстуры, используемые в сцене, в выходной каталог. |
| [getExportVertexDiffuse()](#getExportVertexDiffuse--) | Получает, следует ли экспортировать диффузный цвет вершины. |
| [getExportVertexSpecular()](#getExportVertexSpecular--) | Получает, следует ли экспортировать зеркальный цвет вершины. |
...
| [getMeshCompression()](#getMeshCompression--) | Получает, следует ли включить сжатие данных сетки. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEmbedTextures(boolean value)](#setEmbedTextures-boolean-) | Встраивание внешних текстур в файл U3D, значение по умолчанию — false. |
| [setEncoding(Charset value)](#setEncoding-java.nio.charset.Charset-) | Устанавливает кодировку по умолчанию для текстовых файлов. |
| [setExportNormals(boolean value)](#setExportNormals-boolean-) | Устанавливает, следует ли экспортировать данные нормалей. |
| [setExportTextureCoordinates(boolean value)](#setExportTextureCoordinates-boolean-) | Устанавливает, следует ли экспортировать координаты текстур. |
...
| [setExportVertexDiffuse(boolean value)](#setExportVertexDiffuse-boolean-) | Устанавливает, следует ли экспортировать диффузный цвет вершины. |
| [setExportVertexSpecular(boolean value)](#setExportVertexSpecular-boolean-) | Устанавливает, следует ли экспортировать зеркальный цвет вершины. |
...
| [setMeshCompression(boolean value)](#setMeshCompression-boolean-) | Устанавливает, следует ли включить сжатие данных сетки. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Конструктор [U3dSaveOptions](../../com.aspose.threed/u3dsaveoptions)
...
Встраивание внешних текстур в файл U3D, значение по умолчанию — false.

**Returns:**
boolean - Встраивание внешних текстур в файл U3D, значение по умолчанию — false.
...
Получает, следует ли экспортировать данные нормалей.

**Returns:**
boolean - следует ли экспортировать данные нормалей.
...
Получает, следует ли экспортировать координаты текстур.

**Returns:**
boolean - следует ли экспортировать координаты текстур.
...
Получает, следует ли экспортировать диффузный цвет вершины.

**Returns:**
boolean - экспортировать диффузный цвет вершины.
...
Получает, следует ли экспортировать зеркальный цвет вершины.

**Returns:**
boolean - экспортировать спекулярный цвет вершины.
...
Получает, следует ли включить сжатие данных сетки.

**Returns:**
boolean - включить сжатие данных сетки.
### hashCode() {#hashCode--}
```
...
Устанавливает, следует ли экспортировать данные нормалей.
...
Устанавливает, следует ли экспортировать координаты текстур.
...
Устанавливает, следует ли экспортировать диффузный цвет вершины.
...
Устанавливает, следует ли экспортировать зеркальный цвет вершины.
...
Устанавливает, следует ли включить сжатие данных сетки.

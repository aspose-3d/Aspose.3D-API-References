...
description: Совместимая с IFC U-форма, определённая параметрами.
type: docs
weight: 199
url: /ru/java/com.aspose.threed/ushape/
---
...
Совместимая с IFC U-форма, определённая параметрами.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [UShape()](#UShape--) | Конструктор класса [UShape](../../com.aspose.threed/ushape) |
## Методы
...
| [getEdgeRadius()](#getEdgeRadius--) | Получает радиус кромки в кромке фланца. |
...
| [getFilletRadius()](#getFilletRadius--) | Получает радиус скругления между фланцем и стенкой. |
| [getFlangeThickness()](#getFlangeThickness--) | Получает толщину фланца. |
...
| [setEdgeRadius(double value)](#setEdgeRadius-double-) | Устанавливает радиус кромки в кромке фланца. |
| [setExcluded(boolean value)](#setExcluded-boolean-) | Устанавливает, следует ли исключать эту сущность при экспорте. |
| [setFilletRadius(double value)](#setFilletRadius-double-) | Устанавливает радиус скругления между фланцем и стенкой. |
| [setFlangeThickness(double value)](#setFlangeThickness-double-) | Устанавливает толщину фланца. |
...
Конструктор класса [UShape](../../com.aspose.threed/ushape)
...
Получает радиус кромки в кромке фланца.

**Returns:**
double — радиус кромки в кромке фланца.
...
Получает радиус скругления между фланцем и стенкой.

**Returns:**
double - радиус скругления между фланцем и стенкой.
...
Получает толщину фланца.

**Returns:**
double - толщина фланца.
...
Устанавливает радиус кромки в кромке фланца.
...
Устанавливает радиус скругления между фланцем и стенкой.

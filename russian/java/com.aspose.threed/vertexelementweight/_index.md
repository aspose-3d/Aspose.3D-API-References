...
description: Определяет вес смешивания для указанных компонентов.
type: docs
weight: 226
url: /ru/java/com.aspose.threed/vertexelementweight/
---
...
| --- | --- |
| [VertexElementWeight()](#VertexElementWeight--) | Инициализирует новый экземпляр класса [VertexElementWeight](../../com.aspose.threed/vertexelementweight). |
## Методы
...
Инициализирует новый экземпляр класса [VertexElementWeight](../../com.aspose.threed/vertexelementweight).

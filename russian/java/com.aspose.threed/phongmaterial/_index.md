...
description: Материал для модели освещения Blinn-Phong.
type: docs
weight: 126
url: /ru/java/com.aspose.threed/phongmaterial/
---
...
| --- | --- |
| [PhongMaterial()](#PhongMaterial--) | Инициализирует новый экземпляр класса [PhongMaterial](../../com.aspose.threed/phongmaterial). |
| [PhongMaterial(String name)](#PhongMaterial-java.lang.String-) | Инициализирует новый экземпляр класса [PhongMaterial](../../com.aspose.threed/phongmaterial). |
## Поля
...
| [getReflectionColor()](#getReflectionColor--) | Получает цвет отражения. |
| [getReflectionFactor()](#getReflectionFactor--) | Получает затухание цвета отражения. |
| [getShininess()](#getShininess--) | Получает степень блеска, это контролирует размер спекулярного блика. |
| [getSpecularColor()](#getSpecularColor--) | Получает спекулярный цвет. |
| [getSpecularFactor()](#getSpecularFactor--) | Получает спекулярный коэффициент. |
...
| [setReflectionColor(Vector3 value)](#setReflectionColor-com.aspose.threed.Vector3-) | Устанавливает цвет отражения. |
| [setReflectionFactor(double value)](#setReflectionFactor-double-) | Устанавливает затухание цвета отражения. |
| [setShininess(double value)](#setShininess-double-) | Устанавливает блеск, это контролирует размер спекулярного блика. |
| [setSpecularColor(Vector3 value)](#setSpecularColor-com.aspose.threed.Vector3-) | Устанавливает спекулярный цвет. |
| [setSpecularFactor(double value)](#setSpecularFactor-double-) | Устанавливает спекулярный коэффициент. |
...
Инициализирует новый экземпляр класса [PhongMaterial](../../com.aspose.threed/phongmaterial).
...
**Returns:**
double — затухание цвета отражения.
...
**Returns:**
double — блеск, это контролирует размер спекулярного блика. Формула спекуляра: SpecularColor \* SpecularFactor \* (N dot H) ^ Shininess
...
**Returns:**
double — спекулярный коэффициент. Формула спекуляра: SpecularColor \* SpecularFactor \* (N dot H) ^ Shininess

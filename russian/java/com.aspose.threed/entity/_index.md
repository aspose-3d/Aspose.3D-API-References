...
description: Базовый класс всех сущностей.
type: docs
weight: 52
url: /ru/java/com.aspose.threed/entity/
---
...
Базовый класс всех сущностей. Entity представляет конкретный объект, прикреплённый к узлу, например [Light](../../com.aspose.threed/light)/[Geometry](../../com.aspose.threed/geometry).
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [Entity(String name)](#Entity-java.lang.String-) | Инициализирует новый экземпляр класса [Entity](../../com.aspose.threed/entity). |
## Методы
...
Инициализирует новый экземпляр класса [Entity](../../com.aspose.threed/entity).

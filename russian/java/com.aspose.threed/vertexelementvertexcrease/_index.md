...
description: Определяет сгиб вершины для указанных компонентов
type: docs
weight: 224
url: /ru/java/com.aspose.threed/vertexelementvertexcrease/
---
...
Определяет сгиб вершины для указанных компонентов
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [VertexElementVertexCrease()](#VertexElementVertexCrease--) | Инициализирует новый экземпляр класса [VertexElementVertexCrease](../../com.aspose.threed/vertexelementvertexcrease). |
## Методы
...
| [copyTo(VertexElementDoublesTemplate target)](#copyTo-com.aspose.threed.VertexElementDoublesTemplate-) | Копирует данные в указанный элемент |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(double[] data)](#setData-double---) | Загрузить данные |
...
Инициализирует новый экземпляр класса [VertexElementVertexCrease](../../com.aspose.threed/vertexelementvertexcrease).
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| target | [VertexElementDoublesTemplate](../../com.aspose.threed/vertexelementdoublestemplate) | Цель. |
...
**Returns:**
java.util.List<java.lang.Double> - данные вершины

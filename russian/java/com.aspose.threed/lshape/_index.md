...
description: Совместимый с IFC L-образный профиль, определяемый параметрами.
type: docs
weight: 91
url: /ru/java/com.aspose.threed/lshape/
---
...
Совместимый с IFC L-образный профиль, определяемый параметрами.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [LShape()](#LShape--) | Конструктор [LShape](../../com.aspose.threed/lshape) |
## Методы
...
| [getEdgeRadius()](#getEdgeRadius--) | Получает радиус ребра. |
...
| [getFilletRadius()](#getFilletRadius--) | Получает радиус скругления. |
...
| [getThickness()](#getThickness--) | Получает толщину постоянной стенки. |
...
| [setEdgeRadius(double value)](#setEdgeRadius-double-) | Устанавливает радиус ребра. |
| [setExcluded(boolean value)](#setExcluded-boolean-) | Устанавливает, следует ли исключать эту сущность при экспорте. |
| [setFilletRadius(double value)](#setFilletRadius-double-) | Устанавливает радиус скругления. |
...
| [setThickness(double value)](#setThickness-double-) | Устанавливает толщину постоянной стенки. |
...
Конструктор [LShape](../../com.aspose.threed/lshape)
...
Получает радиус скругления.

**Returns:**
double — радиус скругления.
### getName() {#getName--}
```
...
Получает толщину постоянной стенки.

**Returns:**
double — толщина постоянной стенки.
### getWidth() {#getWidth--}
```
...
Устанавливает толщину постоянной стенки.

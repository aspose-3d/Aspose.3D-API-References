...
description: Пример Adobe Portable Document Format         Следующий код показывает, как извлечь все поддерживаемые 3D‑сцены из 3D‑PDF файла и записать их в формат obj.
type: docs
weight: 123
url: /ru/java/com.aspose.threed/pdfformat/
---
...
| [extract(Stream stream)](#extract-com.aspose.threed.Stream-) | Извлечь необработанное 3D‑содержимое из PDF‑потока. |
| [extract(Stream stream, byte[] password)](#extract-com.aspose.threed.Stream-byte---) | Извлечь необработанное 3D‑содержимое из PDF‑потока. |
| [extract(String fileName)](#extract-java.lang.String-) | Извлечь необработанное 3D‑содержимое из PDF‑файла. |
| [extract(String fileName, byte[] password)](#extract-java.lang.String-byte---) | Извлечь необработанное 3D‑содержимое из PDF‑файла. |
| [extractScene(Stream stream)](#extractScene-com.aspose.threed.Stream-) | Извлечь необработанное 3D‑содержимое из PDF‑потока. |
| [extractScene(Stream stream, byte[] password)](#extractScene-com.aspose.threed.Stream-byte---) | Извлечь необработанное 3D‑содержимое из PDF‑потока. |
| [extractScene(String fileName)](#extractScene-java.lang.String-) | Извлечь 3D‑сцены из PDF‑файла. |
| [extractScene(String fileName, byte[] password)](#extractScene-java.lang.String-byte---) | Извлечь 3D‑сцены из PDF‑файла. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | Поток входного PDF‑файла |

**Returns:**
java.util.ArrayList<byte[]> - Список всех 3D‑содержимых в байтах, включая форматы, которые Aspose.3D не поддерживает. **Пример:** Следующий код показывает, как извлечь все необработанные 3D‑содержимые из 3D‑PDF файла и записать их в файлы.
...
**Returns:**
java.util.ArrayList<com.aspose.threed.Scene> - Список декодированных 3D‑сцен, поддерживаемых Aspose.3D **Пример:** Следующий код показывает, как извлечь все поддерживаемые 3D‑сцены из 3D PDF‑файла и записать их в формат obj.

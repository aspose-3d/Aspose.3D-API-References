...
type: docs
weight: 279
url: /ru/java/com.aspose.threed/filecontenttype/
---
...
| Поле | Описание |
| --- | --- |
| [ASCII](#ASCII) | Тип формата ASCII, например ASCII FBX, ASCII STL |
| [BINARY](#BINARY) | Тип формата Binary, например binary FBX, binary STL |
## Методы
...
Тип формата ASCII, например ASCII FBX, ASCII STL
...
Тип формата Binary, например binary FBX, binary STL

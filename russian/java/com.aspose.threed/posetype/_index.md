...
type: docs
weight: 293
url: /ru/java/com.aspose.threed/posetype/
---
...
| Поле | Описание |
| --- | --- |
| [BIND_POSE](#BIND-POSE) | Связанная поза. |
| [SNAPSHOT](#SNAPSHOT) | Остальная поза, означает, что это снимок связанной позы. |
## Методы
...
Остальная поза, означает, что это снимок связанной позы.

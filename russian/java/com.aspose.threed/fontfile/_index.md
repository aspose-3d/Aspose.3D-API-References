...
description: "Файл шрифта содержит определения глифов, он используется для создания текстового профиля."
type: docs
weight: 68
url: /ru/java/com.aspose.threed/fontfile/
---
...
Файл шрифта содержит определения глифов, он используется для создания текстового профиля. **Example:** Следующий код показывает, как создать 3D‑модель из текста, используя указанный файл шрифта.
...
| [fromFile(String fileName)](#fromFile-java.lang.String-) | Загрузить FontFile из имени файла |
| [getClass()](#getClass--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [parse(byte[] bytes)](#parse-byte---) | Разобрать FontFile из байтов |
...
Загрузить FontFile из имени файла

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| fileName | java.lang.String | Путь к файлу шрифта |

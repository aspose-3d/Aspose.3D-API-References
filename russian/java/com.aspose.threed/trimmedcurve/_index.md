...
description: Ограниченная кривая, обрезающая базовую кривую с обеих сторон.
type: docs
weight: 196
url: /ru/java/com.aspose.threed/trimmedcurve/
---
...
Ограниченная кривая, обрезающая базовую кривую с обеих сторон.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [TrimmedCurve()](#TrimmedCurve--) | Конструктор [TrimmedCurve](../../com.aspose.threed/trimmedcurve) |
## Методы
...
| [getBasisCurve()](#getBasisCurve--) | Базовая кривая для обрезки. |
...
| [getFirst()](#getFirst--) | Первой конечной точкой для обрезки может быть декартова точка или вещественный параметр. |
...
| [getSameDirection()](#getSameDirection--) | Получает, использует ли результат обрезки то же направление базовой кривой. |
| [getScene()](#getScene--) | Получает сцену, к которой принадлежит этот объект |
| [getSecond()](#getSecond--) | Второй конечной точкой для обрезки может быть декартова точка или вещественный параметр. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setBasisCurve(Curve value)](#setBasisCurve-com.aspose.threed.Curve-) | Базовая кривая для обрезки. |
...
| [setFirst(EndPoint value)](#setFirst-com.aspose.threed.EndPoint-) | Первой конечной точкой для обрезки может быть декартова точка или вещественный параметр. |
...
| [setSameDirection(boolean value)](#setSameDirection-boolean-) | Устанавливает, использует ли результат обрезки то же направление базовой кривой. |
| [setSecond(EndPoint value)](#setSecond-com.aspose.threed.EndPoint-) | Второй конечной точкой для обрезки может быть декартова точка или вещественный параметр. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Конструктор [TrimmedCurve](../../com.aspose.threed/trimmedcurve)
...
Первой конечной точкой для обрезки может быть декартова точка или вещественный параметр.
...
Получает, использует ли результат обрезки то же направление базовой кривой.

**Returns:**
boolean — использует ли результат обрезки то же направление базовой кривой.
### getScene() {#getScene--}
```
...
Второй конечной точкой для обрезки может быть декартова точка или вещественный параметр.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Curve](../../com.aspose.threed/curve) | Новое значение |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [EndPoint](../../com.aspose.threed/endpoint) | Новое значение |
...
Устанавливает, использует ли результат обрезки то же направление базовой кривой.

...
type: docs
weight: 45
url: /ru/java/com.aspose.threed/dish/
---
...
| --- | --- |
| [Dish()](#Dish--) | Создать новый экземпляр Dish со стандартным радиусом (10) и стандартной высотой (5) |
| [Dish(double radius, double height)](#Dish-double-double-) | Создать новый экземпляр Dish с указанными радиусом и высотой |
| [Dish(String name, double radius, double height, int widthSegments, int heightSegments)](#Dish-java.lang.String-double-double-int-int-) | Создать новый экземпляр Dish с указанными радиусом и высотой |
## Методы
...
| [getHeight()](#getHeight--) | Высота Dish |
...
| [getRadius()](#getRadius--) | Радиус блюда |
...
| [setHeight(double value)](#setHeight-double-) | Высота Dish |
...
| [setRadius(double value)](#setRadius-double-) | Радиус блюда |
...
Создать новый экземпляр Dish со стандартным радиусом (10) и стандартной высотой (5)
...
Создать новый экземпляр Dish с указанными радиусом и высотой

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| radius | double | Радиус блюда |
| высота | double | Высота блюда |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| имя | java.lang.String | Название блюда |
| radius | double | Радиус блюда |
| высота | double | Высота блюда |
| widthSegments | int | Сегмент ширины блюда |
| heightSegments | int | Сегмент высоты блюда |

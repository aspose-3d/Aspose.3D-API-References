...
description: A  — параметрическая моделирующая поверхность, похожая на  , также определяемая двумя   , а именно  и .
type: docs
weight: 119
url: /ru/java/com.aspose.threed/patch/
---
...
A [Patch](../../com.aspose.threed/patch) — параметрическая моделирующая поверхность, похожая на [NurbsSurface](../../com.aspose.threed/nurbssurface), также определяется двумя [PatchDirection](../../com.aspose.threed/patchdirection): [getU](../../com.aspose.threed/patch\#getU) и [getV](../../com.aspose.threed/patch\#getV). Но различие между [Patch](../../com.aspose.threed/patch) и [NurbsSurface](../../com.aspose.threed/nurbssurface) заключается в том, что кривая [PatchDirection](../../com.aspose.threed/patchdirection) может быть одной из [PatchDirectionType.BEZIER](../../com.aspose.threed/patchdirectiontype\#BEZIER), [PatchDirectionType.QUADRATIC\_BEZIER](../../com.aspose.threed/patchdirectiontype\#QUADRATIC-BEZIER), [PatchDirectionType.BASIS\_SPLINE](../../com.aspose.threed/patchdirectiontype\#BASIS-SPLINE), [PatchDirectionType.CARDINAL\_SPLINE](../../com.aspose.threed/patchdirectiontype\#CARDINAL-SPLINE) и [PatchDirectionType.LINEAR](../../com.aspose.threed/patchdirectiontype\#LINEAR).
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [Patch()](#Patch--) | Инициализирует новый экземпляр класса [Patch](../../com.aspose.threed/patch). |
| [Patch(String name)](#Patch-java.lang.String-) | Инициализирует новый экземпляр класса [Patch](../../com.aspose.threed/patch). |
## Методы
...
| [getU()](#getU--) | Получает направление u. |
| [getV()](#getV--) | Получает направление v. |
...
Инициализирует новый экземпляр класса [Patch](../../com.aspose.threed/patch).

...
type: docs
weight: 162
url: /ru/java/com.aspose.threed/sceneobject/
---
...
| --- | --- |
| [SceneObject(String name)](#SceneObject-java.lang.String-) | Инициализировать объект SceneObject с именем по умолчанию |
| [SceneObject()](#SceneObject--) | Инициализировать объект SceneObject. |
## Методы
...
Инициализировать объект SceneObject с именем по умолчанию

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| имя | java.lang.String | Имя этого экземпляра |
...
Инициализировать объект SceneObject.

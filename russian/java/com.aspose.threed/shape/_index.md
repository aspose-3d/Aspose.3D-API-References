...
description: Форма описывает деформацию набора контрольных точек, аналогичную кластерному деформеру в Maya.
type: docs
weight: 171
url: /ru/java/com.aspose.threed/shape/
---
...
Форма описывает деформацию набора контрольных точек, аналогичную кластерному деформеру в Maya. Например, мы можем добавить форму к созданной геометрии. При этом форма и геометрия имеют одинаковую топологическую информацию, но различаются положением контрольных точек. При различном уровне влияния геометрия осуществляет эффект деформации.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [Shape()](#Shape--) | Инициализирует новый экземпляр класса [Shape](../../com.aspose.threed/shape). |
| [Shape(String name)](#Shape-java.lang.String-) | Инициализирует новый экземпляр класса [Shape](../../com.aspose.threed/shape). |
## Методы
...
| [fromControlPoints(Vector3[] controlPoints)](#fromControlPoints-com.aspose.threed.Vector3...-) | Создайте форму с указанными контрольными точками и индексами по умолчанию. |
...
| [getIndices()](#getIndices--) | Получает индексы. |
...
Инициализирует новый экземпляр класса [Shape](../../com.aspose.threed/shape).
...
Создайте форму с указанными контрольными точками и индексами по умолчанию.
...
**Returns:**
java.util.List<java.lang.Integer> — индексы.
### getName() {#getName--}
```

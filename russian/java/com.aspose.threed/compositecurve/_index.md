...
description: "A состоит из нескольких сегментов кривой."
type: docs
weight: 34
url: /ru/java/com.aspose.threed/compositecurve/
---
...
A [CompositeCurve](../../com.aspose.threed/compositecurve) состоит из нескольких сегментов кривой.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [CompositeCurve()](#CompositeCurve--) | Конструктор [CompositeCurve](../../com.aspose.threed/compositecurve) |
## Методы

| Метод | Описание |
| --- | --- |
| [addSegment(Curve curve)](#addSegment-com.aspose.threed.Curve-) | Добавить новый сегмент к текущей кривой. |
| [addSegment(Curve curve, boolean sameDirection)](#addSegment-com.aspose.threed.Curve-boolean-) | Добавить новый сегмент к текущей кривой. |
...
| [getSegments()](#getSegments--) | Сегменты кривой. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Конструктор [CompositeCurve](../../com.aspose.threed/compositecurve)
...
Добавить новый сегмент к текущей кривой.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Кривая для добавления |
...
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Кривая для добавления |
| sameDirection | boolean | То же направление, что и у текущей кривой. |
...
**Returns:**
java.util.ArrayList<com.aspose.threed.CompositeCurve.Segment> - Сегменты кривой.
### hashCode() {#hashCode--}
```

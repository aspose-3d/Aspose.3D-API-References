...
description: Определяет индекс материала для указанных компонентов.
type: docs
weight: 213
url: /ru/java/com.aspose.threed/vertexelementmaterial/
---
...
Определяет индекс материала для указанных компонентов. Узел может иметь несколько материалов, [VertexElementMaterial](../../com.aspose.threed/vertexelementmaterial) используется для рендеринга разных частей геометрии разными материалами. **Пример:** Следующий код показывает, как назначить разные материалы разным граням коробки.
...
| --- | --- |
| [VertexElementMaterial()](#VertexElementMaterial--) | Инициализирует новый экземпляр класса [VertexElementMaterial](../../com.aspose.threed/vertexelementmaterial). |
## Методы
...
Инициализирует новый экземпляр класса [VertexElementMaterial](../../com.aspose.threed/vertexelementmaterial).

...
type: docs
weight: 73
url: /ru/java/com.aspose.threed/gltfloadoptions/
---
...
| --- | --- |
| [GltfLoadOptions()](#GltfLoadOptions--) | Конструктор [GltfLoadOptions](../../com.aspose.threed/gltfloadoptions) |
## Методы
...
| [getFlipTexCoordV()](#getFlipTexCoordV--) | Инвертировать координату v(t) в текстурных координатах сетки, значение по умолчанию — true. |
...
| [setFlipTexCoordV(boolean value)](#setFlipTexCoordV-boolean-) | Инвертировать координату v(t) в текстурных координатах сетки, значение по умолчанию — true. |
...
Конструктор [GltfLoadOptions](../../com.aspose.threed/gltfloadoptions)
...
Инвертировать координату v(t) в текстурных координатах сетки, значение по умолчанию — true.

**Returns:**
boolean - Инвертировать координату v(t) в текстурных координатах сетки, значение по умолчанию — true.

...
description: Этот класс позволяет напрямую построить 2D‑профиль из произвольной кривой.
type: docs
weight: 16
url: /ru/java/com.aspose.threed/arbitraryprofile/
---
...
Этот класс позволяет напрямую построить 2D‑профиль из произвольной кривой.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [ArbitraryProfile()](#ArbitraryProfile--) | Конструктор [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) |
| [ArbitraryProfile(Curve curve)](#ArbitraryProfile-com.aspose.threed.Curve-) | Конструктор [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) с начальной кривой. |
## Методы
...
| [getClass()](#getClass--) |  |
| [getCurve()](#getCurve--) | Кривая, используемая для построения профиля |
...
| [getHoles()](#getHoles--) | Отверстия профиля, также представленные в виде кривой. |
...
| [setCurve(Curve value)](#setCurve-com.aspose.threed.Curve-) | Кривая, используемая для построения профиля |
...
Конструктор [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile)
...
Конструктор [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) с начальной кривой.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Начальная кривая профиля |
...
Отверстия профиля, также представленные в виде кривой.

**Returns:**
java.util.ArrayList<com.aspose.threed.Curve> - Дыры профиля, также представленные как кривая
### getName() {#getName--}
```

...
description: Базовый класс для настройки параметров сохранения файлов для различных типов.
type: docs
weight: 160
url: /ru/java/com.aspose.threed/saveoptions/
---
...
Базовый класс для настройки параметров сохранения файлов для различных типов.
## Методы

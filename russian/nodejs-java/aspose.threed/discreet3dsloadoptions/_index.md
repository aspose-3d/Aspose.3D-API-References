...
url: /ru/nodejs-java/aspose.threed/discreet3dsloadoptions/
---
...
| Имя | Описание |
| --- | --- |
| constructor() | Конструктор Discreet3dsLoadOptions |
...
| Имя | Описание |
| --- | --- |
| getApplyAnimationTransform() | Получает или задаёт, использовать ли трансформацию, определённую в первом кадре анимационной дорожки. |
...
| Имя | Описание |
| --- | --- |
| setApplyAnimationTransform(value) | Получает или задаёт, использовать ли трансформацию, определённую в первом кадре анимационной дорожки. |

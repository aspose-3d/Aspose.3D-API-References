...
url: /ru/nodejs-java/aspose.threed/zshape/
---
## ZShape class

Профиль Z‑формы, совместимый с IFC, определённый параметрами.
...
| Имя | Описание |
| --- | --- |
| constructor() | Конструктор ZShape. |
...
| Имя | Описание |
| --- | --- |
| getWebThickness() | Получает или задаёт толщину стены. |
...
| Имя | Описание |
| --- | --- |
| setWebThickness(value) | Получает или задаёт толщину стены. |
...
| Имя | Описание |
| --- | --- |
| getEdgeRadius() | Получает или задаёт радиус кромки фланца. |
...
| Имя | Описание |
| --- | --- |
| setEdgeRadius(value) | Получает или задаёт радиус кромки фланца. |

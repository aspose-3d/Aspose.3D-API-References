...
url: /ru/nodejs-java/aspose.threed/mirroredprofile/
---
## MirroredProfile class

Совместимый с IFC профиль зеркального отражения. Этот профиль определяет новый профиль, отражая базовый профиль относительно оси y.
...
| Имя | Описание |
| --- | --- |
| constructor(baseProfile) | Создает новый MirroredProfile из существующего профиля. |

 **Parameters:**

| Имя | Тип | Описание |
| --- | --- | --- |
| baseProfile | Профиль | Базовый профиль, который будет отражён. |
...
| Имя | Описание |
| --- | --- |
| getBaseProfile() | Базовый профиль, который будет отражён. |

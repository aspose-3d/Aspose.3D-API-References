...
url: /ru/nodejs-java/aspose.threed/amfsaveoptions/
---
...
| Имя | Описание |
| --- | --- |
| constructor() | Конструктор AmfSaveOptions |
...
| Имя | Описание |
| --- | --- |
| getEnableCompression() | Определяет, использовать ли сжатие для уменьшения конечного размера файла, значение по умолчанию true. |
...
| Имя | Описание |
| --- | --- |
| setEnableCompression(value) | Определяет, использовать ли сжатие для уменьшения конечного размера файла, значение по умолчанию true. |

...
url: /ru/nodejs-java/aspose.threed/entity/
---
## Entity class

Базовый класс всех сущностей. Entity представляет конкретный объект, прикреплённый к узлу, например Light/Geometry.
...
| Имя | Описание |
| --- | --- |
| constructor(name) | Инициализирует новый экземпляр класса Entity. |

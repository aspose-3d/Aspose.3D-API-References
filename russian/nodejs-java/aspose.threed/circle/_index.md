...
url: /ru/nodejs-java/aspose.threed/circle/
---
## Circle class

Кривая круга состоит из набора точек на границе круглой формы.
...
| Имя | Описание |
| --- | --- |
| constructor() | Конструктор Circle |
...
| Имя | Описание |
| --- | --- |
| constructor_overload(radius) | Конструктор Circle |

 **Parameters:**

| Имя | Тип | Описание |
| --- | --- | --- |
| radius | Number | Радиус кривой круга. |
...
| Имя | Описание |
| --- | --- |
| getRadius() | Радиус кривой круга, значение по умолчанию — 10 |
...
| Имя | Описание |
| --- | --- |
| setRadius(value) | Радиус кривой круга, значение по умолчанию — 10 |

...
| Имя | Описание |
| --- | --- |
| constructor() | Инициализирует новый экземпляр класса NurbsSurface. |
...
| Имя | Описание |
| --- | --- |
| constructor_overload(name) | Инициализирует новый экземпляр класса NurbsSurface. |
...
| Имя | Описание |
| --- | --- |
| getU() | Получает направление U поверхности NURBS |
...
| Имя | Описание |
| --- | --- |
| getV() | Получает направление V поверхности NURBS |
...
| Имя | Описание |
| --- | --- |
| toMesh() | Преобразует поверхность NURBS в меш |

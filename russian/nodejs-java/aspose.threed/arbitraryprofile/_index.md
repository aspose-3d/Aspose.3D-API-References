...
url: /ru/nodejs-java/aspose.threed/arbitraryprofile/
---
## ArbitraryProfile class

Этот класс позволяет создавать 2D профиль напрямую из произвольной кривой.
...
| Имя | Описание |
| --- | --- |
| constructor() | Конструктор ArbitraryProfile |
...
| Имя | Описание |
| --- | --- |
| constructor_overload(curve) | Конструктор ArbitraryProfile с начальной кривой. |
...
| Имя | Описание |
| --- | --- |
| getCurve() | Кривая, используемая для построения профиля |
...
| Имя | Описание |
| --- | --- |
| setCurve(value) | Кривая, используемая для построения профиля |

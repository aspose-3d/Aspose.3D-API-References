...
url: /ru/nodejs-java/aspose.threed/a3dobject/
---
## A3DObject class
...
| Имя | Описание |
| --- | --- |
| constructor(name) | Инициализирует новый экземпляр класса A3DObject. |
...
| Имя | Описание |
| --- | --- |
| constructor_overload() | Инициализирует новый экземпляр класса A3DObject без имени. |

...
url: /ru/nodejs-java/aspose.threed/sweptareasolid/
---
## SweptAreaSolid class

SweptAreaSolid создает геометрию, вытягивая профиль вдоль директиксы.
...
| Имя | Описание |
| --- | --- |
| getShape() | Базовый профиль для построения геометрии. |
...
| Имя | Описание |
| --- | --- |
| setShape(value) | Базовый профиль для построения геометрии. |
...
| Имя | Описание |
| --- | --- |
| getDirectrix() | Прямая, вдоль которой выметается площадь. |
...
| Имя | Описание |
| --- | --- |
| setDirectrix(value) | Прямая, вдоль которой выметается площадь. |
...
| Имя | Описание |
| --- | --- |
| getStartPoint() | Начальная точка директрисы. |
...
| Имя | Описание |
| --- | --- |
| setStartPoint(value) | Начальная точка директрисы. |
...
| Имя | Описание |
| --- | --- |
| getEndPoint() | Конечная точка директрисы. |
...
| Имя | Описание |
| --- | --- |
| setEndPoint(value) | Конечная точка директрисы. |

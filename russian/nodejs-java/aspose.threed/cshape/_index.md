...
url: /ru/nodejs-java/aspose.threed/cshape/
---
## CShape class

Совместимый с IFC профиль C-образной формы, определяемый параметрами. Центр профиля находится в центре ограничивающего бокса.
...
| Имя | Описание |
| --- | --- |
| constructor() | Конструктор CShape |
...
| Имя | Описание |
| --- | --- |
| getDepth() | Получает или задает глубину профиля. |
...
| Имя | Описание |
| --- | --- |
| setDepth(value) | Получает или задает глубину профиля. |
...
| Имя | Описание |
| --- | --- |
| getWidth() | Получает или задает ширину профиля. |
...
| Имя | Описание |
| --- | --- |
| setWidth(value) | Получает или задает ширину профиля. |
...
| Имя | Описание |
| --- | --- |
| getGirth() | Получает или задает длину обхвата. |
...
| Имя | Описание |
| --- | --- |
| setGirth(value) | Получает или задает длину обхвата. |
...
| Имя | Описание |
| --- | --- |
| getWallThickness() | Получает или задает толщину стенки. |
...
| Имя | Описание |
| --- | --- |
| setWallThickness(value) | Получает или задает толщину стенки. |
...
| Имя | Описание |
| --- | --- |
| getInternalFilletRadius() | Получает или задает внутренний радиус скругления. |
...
| Имя | Описание |
| --- | --- |
| setInternalFilletRadius(value) | Получает или задает внутренний радиус скругления. |

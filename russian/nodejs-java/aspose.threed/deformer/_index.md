...
url: /ru/nodejs-java/aspose.threed/deformer/
---
## Deformer class

Базовый класс для SkinDeformer и MorphTargetDeformer
...
| Имя | Описание |
| --- | --- |
| constructor(name) | Инициализирует новый экземпляр класса Deformer. |

...
url: /ru/nodejs-java/aspose.threed/transformedcurve/
---
## TransformedCurve class

TransformedCurve размещает кривую, используя матрицу преобразования.  Это позволяет выполнить преобразование внутри TrimmedCurve или CompositeCurve.
...
| Имя | Описание |
| --- | --- |
| constructor() | Конструктор TransformedCurve |
...
| Имя | Описание |
| --- | --- |
| constructor_overload(basisCurve, transformation) | Конструктор TransformedCurve |
...
| Имя | Описание |
| --- | --- |
| getTransformMatrix() | Матрица преобразования. |
...
| Имя | Описание |
| --- | --- |
| setTransformMatrix(value) | Матрица преобразования. |
...
| Имя | Описание |
| --- | --- |
| setBasisCurve(value) | Базовая кривая. |

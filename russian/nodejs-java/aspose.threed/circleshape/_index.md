...
url: /ru/nodejs-java/aspose.threed/circleshape/
---
## CircleShape class

Совместимый с IFC профиль круга, который можно использовать для построения сетки через LinearExtrusion
...
| Имя | Описание |
| --- | --- |
| constructor() | Создаёт профиль CircleShape с радиусом по умолчанию (5). |
...
| Имя | Описание |
| --- | --- |
| constructor_overload(radius) | Создаёт профиль CircleShape с указанным радиусом. |
...
| Имя | Описание |
| --- | --- |
| getRadius() | Получает или задаёт радиус круга. |
...
| Имя | Описание |
| --- | --- |
| setRadius(value) | Получает или задаёт радиус круга. |

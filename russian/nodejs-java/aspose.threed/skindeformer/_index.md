...
url: /ru/nodejs-java/aspose.threed/skindeformer/
---
## SkinDeformer class

Skin deformer содержит несколько костей, каждая кость смешивает часть геометрии по весам контрольных точек.
...
| Имя | Описание |
| --- | --- |
| constructor(name) | Инициализирует новый экземпляр класса SkinDeformer. |
...
| Имя | Описание |
| --- | --- |
| constructor_overload() | Инициализирует новый экземпляр класса SkinDeformer. |
...
| Имя | Описание |
| --- | --- |
| getBones() | Получает все кости, содержащиеся в деформаторе кожи |

...
url: /ru/nodejs-java/aspose.threed/hollowcircleshape/
---
## HollowCircleShape class

Профиль полого круга, совместимый с IFC.
...
| Имя | Описание |
| --- | --- |
| getWallThickness() | Получает или задает разницу между внешним и внутренним радиусом. |
...
| Имя | Описание |
| --- | --- |
| setWallThickness(value) | Получает или задает разницу между внешним и внутренним радиусом. |

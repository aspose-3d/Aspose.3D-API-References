...
url: /ru/nodejs-java/aspose.threed/lshape/
---
## LShape class

Совместимый с IFC профиль L-образной формы, определяемый параметрами.
...
| Имя | Описание |
| --- | --- |
| constructor() | Конструктор LShape |
...
| Имя | Описание |
| --- | --- |
| getThickness() | Получает или задает толщину постоянной стенки. |
...
| Имя | Описание |
| --- | --- |
| setThickness(value) | Получает или задает толщину постоянной стенки. |
...
| Имя | Описание |
| --- | --- |
| getFilletRadius() | Получает или задает радиус скругления. |
...
| Имя | Описание |
| --- | --- |
| setFilletRadius(value) | Получает или задает радиус скругления. |
...
| Имя | Описание |
| --- | --- |
| getEdgeRadius() | Получает или задает радиус кромки. |
...
| Имя | Описание |
| --- | --- |
| setEdgeRadius(value) | Получает или задает радиус кромки. |

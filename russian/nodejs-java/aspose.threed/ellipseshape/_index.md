...
url: /ru/nodejs-java/aspose.threed/ellipseshape/
---
## EllipseShape class

Совместимая с IFC форма эллипса, определяемая параметрами. Центр профиля находится в центре ограничивающего бокса.
...
| Имя | Описание |
| --- | --- |
| getSemiAxis1() | Получает или задает первый радиус эллипса, измеренный в направлении оси x. |
...
| Имя | Описание |
| --- | --- |
| setSemiAxis1(value) | Получает или задает первый радиус эллипса, измеренный в направлении оси x. |
...
| Имя | Описание |
| --- | --- |
| getSemiAxis2() | Получает или задает второй радиус эллипса, измеренный в направлении оси y. |
...
| Имя | Описание |
| --- | --- |
| setSemiAxis2(value) | Получает или задает второй радиус эллипса, измеренный в направлении оси y. |

...
url: /ru/nodejs-java/aspose.threed/compositecurve/
---
## CompositeCurve class

CompositeCurve состоит из нескольких сегментов кривой.
...
| Имя | Описание |
| --- | --- |
| constructor() | Конструктор CompositeCurve |
...
| Имя | Описание |
| --- | --- |
| addSegment(curve, sameDirection) | Эта |

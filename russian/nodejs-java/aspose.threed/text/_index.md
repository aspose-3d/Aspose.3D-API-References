...
url: /ru/nodejs-java/aspose.threed/text/
---
## Text class

Текстовый профиль, этот профиль описывает контуры с использованием шрифта и текста.
...
| Имя | Описание |
| --- | --- |
| setContent(value) | Содержание текста |
...
| Имя | Описание |
| --- | --- |
| getFontSize() | Масштаб размера шрифта. |
...
| Имя | Описание |
| --- | --- |
| setFontSize(value) | Масштаб размера шрифта. |

...
url: /ru/nodejs-java/aspose.threed/plane/
---
## Plane class
...
| Имя | Описание |
| --- | --- |
| constructor() | Инициализирует новый экземпляр Plane с размером по умолчанию 1x1. |
...
| Имя | Описание |
| --- | --- |
| constructor_overload(length, width) | Инициализирует новый экземпляр Plane. |

 **Parameters:**

| Имя | Тип | Описание |
| --- | --- | --- |
| длина | Number | Длина плоскости. |
| ширина | Number | Ширина плоскости. |
...
| Имя | Описание |
| --- | --- |
| constructor_overload2(name, length, width, lengthSegments, widthSegments) | Инициализирует новый экземпляр Plane. |
...
| длина | Number | Длина плоскости. |
| ширина | Number | Ширина плоскости. |
| lengthSegments | Number | Сегменты длины. |
| widthSegments | Number | Сегменты ширины. |
...
| Имя | Описание |
| --- | --- |
| getUp() | Получает или задает вектор вверх плоскости, значение по умолчанию (0, 1, 0), это влияет на генерацию плоскости |
...
| Имя | Описание |
| --- | --- |
| setUp(value) | Получает или задает вектор вверх плоскости, значение по умолчанию (0, 1, 0), это влияет на генерацию плоскости |
...
| Имя | Описание |
| --- | --- |
| getLength() | Получает или задает длину плоскости. Длина. |
...
| Имя | Описание |
| --- | --- |
| setLength(value) | Получает или задает длину плоскости. Длина. |
...
| Имя | Описание |
| --- | --- |
| getWidth() | Получает или задает ширину плоскости. Ширина. |
...
| Имя | Описание |
| --- | --- |
| setWidth(value) | Получает или задает ширину плоскости. Ширина. |
...
| Имя | Описание |
| --- | --- |
| getLengthSegments() | Получает или задает сегменты длины. Сегменты длины. |
...
| Имя | Описание |
| --- | --- |
| setLengthSegments(value) | Получает или задает сегменты длины. Сегменты длины. |

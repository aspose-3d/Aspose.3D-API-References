...
type: docs
weight: 170
url: /ru/python-net/aspose.threed.entities/mesh/optimize/
is_root: false
---
...
# Sphere.ToMesh генерирует 117 контрольных точек
mesh = Sphere().to_mesh()
# После оптимизации осталось только 86 контрольных точек, индексы полигонов также переименованы.

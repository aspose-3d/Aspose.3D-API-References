...
type: docs
weight: 380
url: /ru/python-net/aspose.threed.entities/sweptareasolid/
is_root: false
---
...
| :- | :- |
| [`__init__(self)`](/3d/python-net/aspose.threed.entities/sweptareasolid/__init__/#) | Initialize an SceneObject. |
...
| [`remove_property(self, property)`](/3d/python-net/aspose.threed.entities/sweptareasolid/remove_property/#system.string) | Remove the specified property identified by name |
| [`get_property(self, property)`](/3d/python-net/aspose.threed.entities/sweptareasolid/get_property/#system.string) | Get the value of specified property |
| [`set_property(self, property, value)`](/3d/python-net/aspose.threed.entities/sweptareasolid/set_property/#system.string-system.object) | Sets the value of specified property |
| [`find_property(self, property_name)`](/3d/python-net/aspose.threed.entities/sweptareasolid/find_property/#system.string) | Finds the property.

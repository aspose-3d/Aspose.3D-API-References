...
type: docs
weight: 10
url: /ru/python-net/aspose.threed.entities/
is_root: false
---
...
| Class | Description |
| :- | :- |
| [`BooleanOperand`](/3d/python-net/aspose.threed.entities/booleanoperand) | This class encapsulates the transformed mesh as Boolean operation's operand. |
| [`BooleanOperator`](/3d/python-net/aspose.threed.entities/booleanoperator) | Boolean operator allows you to apply Boolean operation on two [`IMeshConvertible`](/3d/python-net/aspose.threed.entities/imeshconvertible) instances. |
...
| [`HalfSpace`](/3d/python-net/aspose.threed.entities/halfspace) | [`HalfSpace`](/3d/python-net/aspose.threed.entities/halfspace) represents a infinity space which is split by a plane, this can be used with [`BooleanOperator`](/3d/python-net/aspose.threed.entities/booleanoperator) |

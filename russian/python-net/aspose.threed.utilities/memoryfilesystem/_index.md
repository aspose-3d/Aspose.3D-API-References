...
type: docs
weight: 130
url: /ru/python-net/aspose.threed.utilities/memoryfilesystem/
is_root: false
---
...
with BytesIO() as ms:
    scene.save(ms, opt)
# файл test.obj был записан в переменную ms, и мы также можем получить содержимое файла test.mtl с помощью

...
type: docs
weight: 90
url: /ru/python-net/aspose.threed.profiles/hollowrectangleshape/
is_root: false
---
...
| [`remove_property(self, property)`](/3d/python-net/aspose.threed.profiles/hollowrectangleshape/remove_property/#system.string) | Remove the specified property identified by name |
| [`get_property(self, property)`](/3d/python-net/aspose.threed.profiles/hollowrectangleshape/get_property/#system.string) | Get the value of specified property |
| [`set_property(self, property, value)`](/3d/python-net/aspose.threed.profiles/hollowrectangleshape/set_property/#system.string-system.object) | Sets the value of specified property |
| [`find_property(self, property_name)`](/3d/python-net/aspose.threed.profiles/hollowrectangleshape/find_property/#system.string) | Finds the property.

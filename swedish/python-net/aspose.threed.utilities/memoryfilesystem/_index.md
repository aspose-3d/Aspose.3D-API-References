...
type: docs
weight: 130
url: /sv/python-net/aspose.threed.utilities/memoryfilesystem/
is_root: false
---
...
# skapa en scen med material
scene = Scene()
scene.root_node.create_child_node(Box()).material = LambertMaterial()
# skapa ett spara‑alternativ och ange filsystemet, så den beroende filen skrivs till minnet
opt = FileFormat.WAVEFRONT_OBJ.create_save_options()
mfs = MemoryFileSystem()
opt.file_system = mfs
# obj:ets materialfilnamn är associerat med obj:ets filnamn, så vi behöver ett explicit namn.
opt.file_name = "test.obj"
with BytesIO() as ms:
    scene.save(ms, opt)
# test.obj skrevs till variabeln ms, och vi kan också få innehållet i test.mtl‑filen genom

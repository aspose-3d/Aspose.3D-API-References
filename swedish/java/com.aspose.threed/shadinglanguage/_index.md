...
description: Vanligt använda skuggningsspråk
type: docs
weight: 272
url: /sv/java/com.aspose.threed/shadinglanguage/
---
...
Vanligt använda skuggningsspråk
## Fält

| Fält | Beskrivning |
| --- | --- |
| [AGAL](#AGAL) | Adobe Graphics Assembly Language |
| [ARB_ASSEMBLY](#ARB-ASSEMBLY) | ARB assembly language är ett låg-nivå skuggningsspråk skapat av OpenGL Architecture Review Board för att standardisera GPU-instruktioner. |
| [CGFX](#CGFX) | NVIDIA Cg |
| [DIRECTX_SHADER_ASSEMBLY](#DIRECTX-SHADER-ASSEMBLY) | Den DirectX shader assembly language |
| [GELATO](#GELATO) | Det gelato shading language |
| [GLSL](#GLSL) | GLSL |
...
| [OPEN_SHADING_LANGUAGE](#OPEN-SHADING-LANGUAGE) | Open shading language är utvecklat av Sony Pictures Imageworks och används i dess Arnold-renderare. |
...
ARB assembly language är ett låg-nivå skuggningsspråk skapat av OpenGL Architecture Review Board för att standardisera GPU-instruktioner.
...
Den DirectX shader assembly language
...
Open shading language är utvecklat av Sony Pictures Imageworks och används i dess Arnold-renderare.

...
description: "4x4-matrisimplementation."
type: docs
weight: 100
url: /sv/java/com.aspose.threed/matrix4/
---
...
| --- | --- |
| [Matrix4(Vector4 r0, Vector4 r1, Vector4 r2, Vector4 r3)](#Matrix4-com.aspose.threed.Vector4-com.aspose.threed.Vector4-com.aspose.threed.Vector4-com.aspose.threed.Vector4-) | Skapar matris från 4 rader. |
| [Matrix4(double m00, double m01, double m02, double m03, double m10, double m11, double m12, double m13, double m20, double m21, double m22, double m23, double m30, double m31, double m32, double m33)](#Matrix4-double-double-double-double-double-double-double-double-double-double-double-double-double-double-double-double-) | Initierar en ny instans av strukturen [Matrix4](../../com.aspose.threed/matrix4). |
| [Matrix4(FMatrix4 m)](#Matrix4-com.aspose.threed.FMatrix4-) | Konstruera [Matrix4](../../com.aspose.threed/matrix4) från en [FMatrix4](../../com.aspose.threed/fmatrix4)-instans |
| [Matrix4(double[] m)](#Matrix4-double---) | Initierar en ny instans av strukturen [Matrix4](../../com.aspose.threed/matrix4). |
| [Matrix4()](#Matrix4--) |  |
## Fält
...
| --- | --- |
| [clone()](#clone--) |  |
| [concatenate(Matrix4 m2)](#concatenate-com.aspose.threed.Matrix4-) | Konkatenar de två matriserna |
| [copyFrom(Matrix4 src)](#copyFrom-com.aspose.threed.Matrix4-) |  |
| [decompose(Vector3 translation, Vector3 scaling, Quaternion rotation)](#decompose-com.aspose.threed.Vector3-com.aspose.threed.Vector3-com.aspose.threed.Quaternion-) | Dekomponera transformationsmatrisen. |
| [equals(Object obj)](#equals-java.lang.Object-) |  |
| [getClass()](#getClass--) |  |
| [getDeterminant()](#getDeterminant--) | Hämtar determinanten för matrisen. |
| [getIdentity()](#getIdentity--) | Hämtar identitetsmatrisen. |
| [hashCode()](#hashCode--) |  |
| [inverse()](#inverse--) | Beräknar inversen av denna instans. |
| [mul(Matrix4 lhs, Matrix4 rhs)](#mul-com.aspose.threed.Matrix4-com.aspose.threed.Matrix4-) | Multiplicera de två matriserna |
| [mul(Matrix4 lhs, Vector3 v)](#mul-com.aspose.threed.Matrix4-com.aspose.threed.Vector3-) | Multiplicera matrisen och vector3 |
| [mul(Matrix4 lhs, Vector4 v)](#mul-com.aspose.threed.Matrix4-com.aspose.threed.Vector4-) | Multiplicera matrisen och vector4 |
| [mul(Matrix4 lhs, double v)](#mul-com.aspose.threed.Matrix4-double-) | Multiplicera matrisen med ett dubbelvärde. |
| [normalize()](#normalize--) | Normaliserar detta objekt. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [rotate(Quaternion q)](#rotate-com.aspose.threed.Quaternion-) | Skapa en rotationsmatris från en kvaternion |
| [rotate(double angle, Vector3 axis)](#rotate-double-com.aspose.threed.Vector3-) | Skapa en rotationsmatris med rotationsvinkel och axel |
| [rotateFromEuler(Vector3 eul)](#rotateFromEuler-com.aspose.threed.Vector3-) | Skapa en rotationsmatris från Euler-vinkel |
| [rotateFromEuler(double rx, double ry, double rz)](#rotateFromEuler-double-double-double-) | Skapa en rotationsmatris från Euler-vinkel |
| [scale(Vector3 s)](#scale-com.aspose.threed.Vector3-) | Skapar en matris som skalar längs x-axeln, y-axeln och z-axeln. |
| [scale(double s)](#scale-double-) | Skapar en matris som skalar längs x-axeln, y-axeln och z-axeln. |
| [scale(double sx, double sy, double sz)](#scale-double-double-double-) | Skapar en matris som skalar längs x-axeln, y-axeln och z-axeln. |
| [setTRS(Vector3 translation, Vector3 rotation, Vector3 scale)](#setTRS-com.aspose.threed.Vector3-com.aspose.threed.Vector3-com.aspose.threed.Vector3-) | Initierar matrisen med translation/rotation/skala |
| [toArray()](#toArray--) | Konverterar matris till array. |
| [toString()](#toString--) | Returnerar en java.lang.String som representerar den aktuella [Matrix4](../../com.aspose.threed/matrix4). |
| [translate(Vector3 t)](#translate-com.aspose.threed.Vector3-) | Skapar en matris som översätter längs x-axeln, y-axeln och z-axeln |
| [translate(double tx, double ty, double tz)](#translate-double-double-double-) | Skapar en matris som översätter längs x-axeln, y-axeln och z-axeln |
| [transpose()](#transpose--) | Transponera denna instans. |
| [wait()](#wait--) |  |

...
type: docs
weight: 129
url: /sv/java/com.aspose.threed/plyformat/
---
...
| [decode(Stream stream)](#decode-com.aspose.threed.Stream-) | Avkoda ett punktmoln eller mesh från den angivna strömmen. |
| [decode(Stream stream, PlyLoadOptions opt)](#decode-com.aspose.threed.Stream-com.aspose.threed.PlyLoadOptions-) | Avkoda ett punktmoln eller mesh från den angivna strömmen. |
| [decode(String fileName)](#decode-java.lang.String-) | Avkoda ett punktmoln eller mesh från den angivna strömmen. |
| [decode(String fileName, PlyLoadOptions opt)](#decode-java.lang.String-com.aspose.threed.PlyLoadOptions-) | Avkoda ett punktmoln eller mesh från den angivna strömmen. |
...
| [encode(Entity entity, Stream stream)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-) | Koda enheten och spara resultatet i strömmen. |
| [encode(Entity entity, Stream stream, PlySaveOptions opt)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-com.aspose.threed.PlySaveOptions-) | Koda enheten och spara resultatet i strömmen. |
| [encode(Entity entity, String fileName)](#encode-com.aspose.threed.Entity-java.lang.String-) | Koda enheten och spara resultatet i en extern fil. |
| [encode(Entity entity, String fileName, PlySaveOptions opt)](#encode-com.aspose.threed.Entity-java.lang.String-com.aspose.threed.PlySaveOptions-) | Koda enheten och spara resultatet i en extern fil. |
...
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | Inmatningsströmmen |
...
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | Inmatningsströmmen |
| opt | [PlyLoadOptions](../../com.aspose.threed/plyloadoptions) | Laddningsalternativet för PLY-formatet |
...
|  | stream | [Stream](../../com.aspose.threed/stream) | Strömmen att skriva till, den här metoden kommer inte att stänga denna ström **Exempel:** Följande kod visar hur man kodar ett mesh till en PLY-fil: |

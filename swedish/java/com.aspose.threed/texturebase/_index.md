...
description: Basklass för alla konkreta texturer.
type: docs
weight: 185
url: /sv/java/com.aspose.threed/texturebase/
---
...
Basklass för alla konkreta texturer. Texture definierar utseendet och känslan hos en geometrisk yta.
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [TextureBase(String name)](#TextureBase-java.lang.String-) | Initierar en ny instans av klassen [TextureBase](../../com.aspose.threed/texturebase). |
## Metoder
...
Initierar en ny instans av klassen [TextureBase](../../com.aspose.threed/texturebase).

...
description: Frustumens rotationsläge
type: docs
weight: 299
url: /sv/java/com.aspose.threed/rotationmode/
---
...
Frustumets rotationsläge
## Fält

| Fält | Beskrivning |
| --- | --- |
| [FIXED_DIRECTION](#FIXED-DIRECTION) | Riktning är fast, 'look at' beräknas utifrån riktningen |
| [FIXED_TARGET](#FIXED-TARGET) | Mål är fast, riktning beräknas utifrån 'look at'-målet |
## Metoder
...
Riktning är fast, 'look at' beräknas utifrån riktningen
...
Mål är fast, riktning beräknas utifrån 'look at'-målet

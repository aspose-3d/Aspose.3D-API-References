...
description: Kamerors projektionstyper.
type: docs
weight: 295
url: /sv/java/com.aspose.threed/projectiontype/
---
...
| Fält | Beskrivning |
| --- | --- |
| [ORTHOGRAPHIC](#ORTHOGRAPHIC) | Kameran använder ortografisk projektion. |
| [PERSPECTIVE](#PERSPECTIVE) | Kameran använder perspektivprojektion. |
## Metoder
...
Kameran använder ortografisk projektion.
...
Kameran använder perspektivprojektion.

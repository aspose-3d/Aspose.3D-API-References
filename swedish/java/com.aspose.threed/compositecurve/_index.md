...
description: "En består av flera kurvsegment."
type: docs
weight: 34
url: /sv/java/com.aspose.threed/compositecurve/
---
...
En [CompositeCurve](../../com.aspose.threed/compositecurve) består av flera kurvsegment.
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [CompositeCurve()](#CompositeCurve--) | Konstruktor för [CompositeCurve](../../com.aspose.threed/compositecurve) |
## Metoder

| Metod | Beskrivning |
| --- | --- |
| [addSegment(Curve curve)](#addSegment-com.aspose.threed.Curve-) | Lägg till ett nytt segment till den aktuella kurvan. |
| [addSegment(Curve curve, boolean sameDirection)](#addSegment-com.aspose.threed.Curve-boolean-) | Lägg till ett nytt segment till den aktuella kurvan. |
...
| [getSegments()](#getSegments--) | Segmenten i kurvan. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Konstruktor för [CompositeCurve](../../com.aspose.threed/compositecurve)
...
Lägg till ett nytt segment till den aktuella kurvan.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Kurvan att lägga till |
...
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Kurvan att lägga till |
| sameDirection | boolean | Samma riktning som den aktuella kurvan. |
...
**Returns:**
java.util.ArrayList<com.aspose.threed.CompositeCurve.Segment> - Segmenten i kurvan.
### hashCode() {#hashCode--}
```

...
| --- | --- |
| [PbrMaterial()](#PbrMaterial--) | Skapa en standard PBR-materialinstans |
| [PbrMaterial(Vector3 albedo)](#PbrMaterial-com.aspose.threed.Vector3-) | Skapa ett standard PBR-material med angivet albedo-färvvärde. |
## Fält
...
| [fromMaterial(Material material)](#fromMaterial-com.aspose.threed.Material-) | Tillåt konvertering av annat material till PbrMaterial **Example:** |
| [getAlbedo()](#getAlbedo--) | Hämtar basfärgen på materialet |
| [getAlbedoTexture()](#getAlbedoTexture--) | Hämtar texturen för albedo |
| [getClass()](#getClass--) |  |
...
| [getMetallicFactor()](#getMetallicFactor--) | Hämtar metalligheten hos materialet, värde 1 betyder att materialet är en metall och värde 0 betyder att materialet är ett dielektrikum. |
| [getMetallicRoughness()](#getMetallicRoughness--) | Hämtar texturen för metallic (i R-kanal) och roughness (i G-kanal) |
| [getName()](#getName--) | Hämtar namnet. |
| [getNormalTexture()](#getNormalTexture--) | Hämtar texturen för normalmappning |
| [getOcclusionFactor()](#getOcclusionFactor--) | Hämtar faktorn för ambient occlusion |
| [getOcclusionTexture()](#getOcclusionTexture--) | Hämtar texturen för ambient occlusion |
...
| [getRoughnessFactor()](#getRoughnessFactor--) | Hämtar roughness hos materialet, värde 1 betyder att materialet är helt grovt och värde 0 betyder att materialet är helt slätt |
| [getSpecularTexture()](#getSpecularTexture--) | Hämtar texturen för specular color |
...
| [setAlbedo(Vector3 value)](#setAlbedo-com.aspose.threed.Vector3-) | Ställer in basfärgen på materialet |

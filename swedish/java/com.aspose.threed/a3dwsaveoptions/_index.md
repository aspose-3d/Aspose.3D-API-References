...
type: docs
weight: 11
url: /sv/java/com.aspose.threed/a3dwsaveoptions/
---
...
| --- | --- |
| [A3dwSaveOptions()](#A3dwSaveOptions--) | Konstruktor för [A3dwSaveOptions](../../com.aspose.threed/a3dwsaveoptions) |
## Metoder
...
| [getExportMetaData()](#getExportMetaData--) | Exportera metadata som är associerad med Scene/Node till klienten. Standardvärdet är true |
...
| [getMetaDataPrefix()](#getMetaDataPrefix--) | Om den här egenskapen är icke‑null, exporteras endast egenskaperna för Scene/Node som börjar med detta prefix, och prefixet tas bort. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEncoding(Charset value)](#setEncoding-java.nio.charset.Charset-) | Ställer in standardkodningen för textbaserade filer. |
| [setExportMetaData(boolean value)](#setExportMetaData-boolean-) | Exportera metadata som är associerad med Scene/Node till klienten. Standardvärdet är true |
...
| [setMetaDataPrefix(String value)](#setMetaDataPrefix-java.lang.String-) | Om den här egenskapen är icke‑null, exporteras endast egenskaperna för Scene/Node som börjar med detta prefix, och prefixet tas bort. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Konstruktor för [A3dwSaveOptions](../../com.aspose.threed/a3dwsaveoptions)
...
Exportera metadata som är associerad med Scene/Node till klienten. Standardvärdet är true

**Returns:**
boolean - Exportera metadata som är associerad med Scene/Node till klienten. Standardvärdet är true
...
Om den här egenskapen är icke‑null, exporteras endast egenskaperna för Scene/Node som börjar med detta prefix, och prefixet tas bort.

**Returns:**
java.lang.String - Om den här egenskapen är icke‑null, exporteras endast egenskaperna för Scene/Node som börjar med detta prefix, och prefixet tas bort.
### hashCode() {#hashCode--}
```

...
description: IFC‑kompatibel cirkelprofil som kan användas för att konstruera ett mesh via
type: docs
weight: 32
url: /sv/java/com.aspose.threed/circleshape/
---
...
IFC‑kompatibel cirkelprofil, som kan användas för att konstruera ett mesh via [LinearExtrusion](../../com.aspose.threed/linearextrusion).
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [CircleShape()](#CircleShape--) | Skapa en [CircleShape](../../com.aspose.threed/circleshape)-profil med standardradie (5). |
| [CircleShape(double radius)](#CircleShape-double-) | Skapa en [CircleShape](../../com.aspose.threed/circleshape)-profil med angiven radie. |
## Metoder
...
| [getRadius()](#getRadius--) | Hämtar radien på cirkeln. |
...
| [setRadius(double value)](#setRadius-double-) | Ställer in radien på cirkeln. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Skapa en [CircleShape](../../com.aspose.threed/circleshape)-profil med standardradie (5).
...
Skapa en [CircleShape](../../com.aspose.threed/circleshape)-profil med angiven radie.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| radius | double | Radie på cirkeln |
...
Hämtar radien på cirkeln.

**Returns:**
double - radien på cirkeln.
### getScene() {#getScene--}
```

...
description: "Parametriserad pyramid."
type: docs
weight: 142
url: /sv/java/com.aspose.threed/pyramid/
---
...
| --- | --- |
| [Pyramid()](#Pyramid--) | Skapa en ny pyramideinstans med standard bottenarea(10, 10) och standardhöjd(5) |
| [Pyramid(double xbottom, double ybottom, double height)](#Pyramid-double-double-double-) | Skapa en ny pyramideinstans med angiven bottenarea |
| [Pyramid(double xbottom, double ybottom, double xtop, double ytop, double height)](#Pyramid-double-double-double-double-double-) | Skapa en ny pyramideinstans med angiven bottenarea, topområde och höjd. |
| [Pyramid(String name, double xbottom, double ybottom, double xtop, double ytop, double height)](#Pyramid-java.lang.String-double-double-double-double-double-) | Skapa en ny pyramideinstans med angiven bottenarea, topområde och höjd. |
## Metoder
...
| [getBottomArea()](#getBottomArea--) | Area för bottenlocket |
| [getBottomOffset()](#getBottomOffset--) | Offset för bottenhörnpunkter |
...
| [getHeight()](#getHeight--) | Höjd på pyramiden |
...
| [getTopArea()](#getTopArea--) | Area för topplocket |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setBottomArea(Vector2 value)](#setBottomArea-com.aspose.threed.Vector2-) | Area för bottenlocket |
| [setBottomOffset(Vector3 value)](#setBottomOffset-com.aspose.threed.Vector3-) | Offset för bottenhörnpunkter |
...
| [setHeight(double value)](#setHeight-double-) | Höjd på pyramiden |
...
| [setTopArea(Vector2 value)](#setTopArea-com.aspose.threed.Vector2-) | Area för topplocket |
...
Skapa en ny pyramideinstans med standard bottenarea(10, 10) och standardhöjd(5)
...
Skapa en ny pyramideinstans med angiven bottenarea

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| xbottom | double | Längden i x-riktning för botten |
| ybottom | double | Längden i y-riktning för botten |
| höjd | double | Höjden på pyramiden |
...
Skapa en ny pyramideinstans med angiven bottenarea, topområde och höjd.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| xbottom | double | Längden i x-riktning för bottenområdet |
| ybottom | double | Längden i y-riktning för bottenområdet |
| xtop | double | Längden i x-riktning för topområdet |
| ytop | double | Längden i y-riktning för topområdet |
| höjd | double | Höjden på pyramiden |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| namn | java.lang.String | Namnet på pyramiden |
| xbottom | double | Längden i x-riktning för bottenområdet |
| ybottom | double | Längden i y-riktning för bottenområdet |
| xtop | double | Längden i x-riktning för topområdet |
| ytop | double | Längden i y-riktning för topområdet |

...
description: En kurva består av en uppsättning punkter på kanten av cirkelns form.
type: docs
weight: 31
url: /sv/java/com.aspose.threed/circle/
---
...
En [Cirkel](../../com.aspose.threed/circle) kurva består av en uppsättning punkter på kanten av cirkelns form.
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [Circle()](#Circle--) | Konstruktor för [Circle](../../com.aspose.threed/circle) |
| [Circle(double radius)](#Circle-double-) | Konstruktor för [Circle](../../com.aspose.threed/circle) |
## Metoder
...
| [getRadius()](#getRadius--) | Radien för cirkelkurvan, standardvärdet är 10 |
...
| [setRadius(double value)](#setRadius-double-) | Radien för cirkelkurvan, standardvärdet är 10 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Konstruktor för [Circle](../../com.aspose.threed/circle)
...
| --- | --- | --- |
| radius | double | Radien för cirkelkurvan. |
...
Radien för cirkelkurvan, standardvärdet är 10

**Returns:**
double - Radien för cirkelkurvan, standardvärdet är 10
### getScene() {#getScene--}
```

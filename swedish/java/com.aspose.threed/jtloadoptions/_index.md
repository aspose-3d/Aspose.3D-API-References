...
description: Läsalternativ för Siemens JT
type: docs
weight: 88
url: /sv/java/com.aspose.threed/jtloadoptions/
---
...
| [getLoadPMI()](#getLoadPMI--) | Läs in PMI-information från JT-fil om möjligt, data kommer att sparas som egenskapen "PMI" av [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). |
| [getLoadProperties()](#getLoadProperties--) | Läs in egenskaper från JTs egenskapstabell som Aspose.3D-egenskaper. |
...
| [setLoadPMI(boolean value)](#setLoadPMI-boolean-) | Läs in PMI-information från JT-fil om möjligt, data kommer att sparas som egenskapen "PMI" av [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). |
| [setLoadProperties(boolean value)](#setLoadProperties-boolean-) | Läs in egenskaper från JTs egenskapstabell som Aspose.3D-egenskaper. |
...
Läs in PMI-information från JT-fil om möjligt, data kommer att sparas som egenskapen "PMI" av [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). Standardvärdet är falskt.

**Returns:**
boolean - Läs in PMI-information från JT-fil om möjligt, data kommer att sparas som egenskapen "PMI" av [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). Standardvärdet är falskt.
...
Läs in egenskaper från JTs egenskapstabell som Aspose.3D-egenskaper. Standardvärdet är falskt.

**Returns:**
boolean - Läs in egenskaper från JTs egenskapstabell som Aspose.3D-egenskaper. Standardvärdet är falskt.

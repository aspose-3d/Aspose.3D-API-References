...
type: docs
weight: 16
url: /sv/java/com.aspose.threed/arbitraryprofile/
---
...
| --- | --- |
| [ArbitraryProfile()](#ArbitraryProfile--) | Konstruktor för [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) |
| [ArbitraryProfile(Curve curve)](#ArbitraryProfile-com.aspose.threed.Curve-) | Konstruktor för [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) med en initial kurva. |
## Metoder
...
| [getClass()](#getClass--) |  |
| [getCurve()](#getCurve--) | Kurvan som används för att konstruera profilen |
...
| [getHoles()](#getHoles--) | Hål i profilen, även representerade som kurva |
...
| [setCurve(Curve value)](#setCurve-com.aspose.threed.Curve-) | Kurvan som används för att konstruera profilen |
...
Konstruktor för [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile)
...
Konstruktor för [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) med en initial kurva.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Initial kurva för profilen |
...
Hål i profilen, även representerade som kurva

**Returns:**
java.util.ArrayList<com.aspose.threed.Curve> - Hål i profilen, även representerade som kurva
### getName() {#getName--}
```

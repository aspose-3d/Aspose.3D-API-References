...
description: "Sparaalternativen vid PDF-export."
type: docs
weight: 125
url: /sv/java/com.aspose.threed/pdfsaveoptions/
---
...
| --- | --- |
| [PdfSaveOptions()](#PdfSaveOptions--) | Konstruktor för [PdfSaveOptions](../../com.aspose.threed/pdfsaveoptions) |
## Metoder

| Metod | Beskrivning |
| --- | --- |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getAuxiliaryColor()](#getAuxiliaryColor--) | Hämtar den hjälpfärgen som ska användas vid rendering av 3D-innehållet. |
| [getBackgroundColor()](#getBackgroundColor--) | Bakgrundsfärg för 3D-vyn i PDF-filen. |
| [getClass()](#getClass--) |  |
| [getEmbedTextures()](#getEmbedTextures--) | Bädda in externa texturer i PDF-filen, standardvärdet är falskt. |
...
| [getFaceColor()](#getFaceColor--) | Hämtar ansiktsfärgen som ska användas vid rendering av 3D-innehållet. |
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | Hämtar om koordinatsystemet för scenen ska vändas under export. |
| [getLightingScheme()](#getLightingScheme--) | LightingScheme specificerar belysningen som ska tillämpas på 3D-konstverk. |
...
| [getRenderMode()](#getRenderMode--) | Renderläge specificerar stilen som 3D-konstverket renderas i. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAuxiliaryColor(Vector3 value)](#setAuxiliaryColor-com.aspose.threed.Vector3-) | Ställer in den hjälpfärg som ska användas vid rendering av 3D-innehållet. |
| [setBackgroundColor(Vector3 value)](#setBackgroundColor-com.aspose.threed.Vector3-) | Bakgrundsfärg för 3D-vyn i PDF-filen. |
| [setEmbedTextures(boolean value)](#setEmbedTextures-boolean-) | Bädda in externa texturer i PDF-filen, standardvärdet är falskt. |
...
| [setFaceColor(Vector3 value)](#setFaceColor-com.aspose.threed.Vector3-) | Ställer in ansiktsfärgen som ska användas vid rendering av 3D-innehållet. |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | Ställer in att vända koordinatsystemet för scenen under export. |
| [setLightingScheme(PdfLightingScheme value)](#setLightingScheme-com.aspose.threed.PdfLightingScheme-) | LightingScheme specificerar belysningen som ska tillämpas på 3D-konstverk. |
...
| [setRenderMode(PdfRenderMode value)](#setRenderMode-com.aspose.threed.PdfRenderMode-) | Renderläge specificerar stilen som 3D-konstverket renderas i. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Konstruktor för [PdfSaveOptions](../../com.aspose.threed/pdfsaveoptions)
...
Hämtar den hjälpfärg som ska användas vid rendering av 3D-innehållet. Tolkningen av denna färg beror på [getRenderMode](../../com.aspose.threed/pdfsaveoptions\#getRenderMode)
...
**Returns:**
boolesk - Bädda in externa texturer i PDF-filen, standardvärdet är falskt.
...
Hämtar ansiktsfärgen som ska användas vid rendering av 3D-innehållet. Detta är endast relevant när [getRenderMode](../../com.aspose.threed/pdfsaveoptions\#getRenderMode) har värdet Illustration.
...
**Returns:**
boolesk - att vända koordinatsystemet för scenen under export.
...
Ställer in den hjälpfärg som ska användas vid rendering av 3D-innehållet. Tolkningen av denna färg beror på [getRenderMode](../../com.aspose.threed/pdfsaveoptions\#getRenderMode)
...
Ställer in ansiktsfärgen som ska användas vid rendering av 3D-innehållet. Detta är endast relevant när [getRenderMode](../../com.aspose.threed/pdfsaveoptions\#getRenderMode) har värdet Illustration.

...
description: definierar hur kartläggningsinformation lagras och refereras av.
type: docs
weight: 296
url: /sv/java/com.aspose.threed/referencemode/
---
...
| Fält | Beskrivning |
| --- | --- |
| [DIRECT](#DIRECT) | Data refereras direkt |
| [INDEX](#INDEX) | Data refereras via index |
| [INDEX_TO_DIRECT](#INDEX-TO-DIRECT) | Data refereras via index, och sedan nås via index i data-listan för [VertexElement](../../com.aspose.threed/vertexelement). |
## Metoder
...
Data refereras via index, och sedan nås via index i data-listan för [VertexElement](../../com.aspose.threed/vertexelement).

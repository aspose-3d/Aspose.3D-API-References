...
description: representerar ett oändligt utrymme som delas av ett plan, detta kan användas med
type: docs
weight: 77
url: /sv/java/com.aspose.threed/halfspace/
---
...
| --- | --- |
| [HalfSpace()](#HalfSpace--) | Skapar en ny instans av [HalfSpace](../../com.aspose.threed/halfspace) |
| [HalfSpace(Vector3 normal, Vector3 position)](#HalfSpace-com.aspose.threed.Vector3-com.aspose.threed.Vector3-) | Skapar en ny instans av [HalfSpace](../../com.aspose.threed/halfspace) med given normalvektor och en position på skärplanet; |
## Metoder
...
| [getNormal()](#getNormal--) | Normalen för delningsplanet, planet definieras som N \* P + D = 0 där N är normal och P är någon punkt på planet. |
...
| [getPosition()](#getPosition--) | Den valfria punkten på delningsplanet, planet definieras som N \* P + D = 0 där N är normal och P är någon punkt på planet. |
...
| [setNormal(Vector3 value)](#setNormal-com.aspose.threed.Vector3-) | Normalen för delningsplanet, planet definieras som N \* P + D = 0 där N är normal och P är någon punkt på planet. |
...
| [setPosition(Vector3 value)](#setPosition-com.aspose.threed.Vector3-) | Den valfria punkten på delningsplanet, planet definieras som N \* P + D = 0 där N är normal och P är någon punkt på planet. |
...
Skapar en ny instans av [HalfSpace](../../com.aspose.threed/halfspace)
...
Skapar en ny instans av [HalfSpace](../../com.aspose.threed/halfspace) med given normalvektor och en position på skärplanet;
...
Normalen för delningsplanet, planet definieras som N \* P + D = 0 där N är normal och P är någon punkt på planet.
...
Den valfria punkten på delningsplanet, planet definieras som N \* P + D = 0 där N är normal och P är någon punkt på planet.

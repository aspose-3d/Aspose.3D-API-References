...
description: Definierar om angivna komponenter är synliga
type: docs
weight: 225
url: /sv/java/com.aspose.threed/vertexelementvisibility/
---
...
| --- | --- |
| [VertexElementVisibility()](#VertexElementVisibility--) | Initierar en ny instans av klassen [VertexElementVisibility](../../com.aspose.threed/vertexelementvisibility). |
## Metoder
...
| [copyTo(VertexElementTemplate<T> target)](#copyTo-com.aspose.threed.VertexElementTemplate-T--) | Kopierar data till angivet element. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(T[] data)](#setData-T---) | Läs in data. |
...
Initierar en ny instans av klassen [VertexElementVisibility](../../com.aspose.threed/vertexelementvisibility).
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| target | [VertexElementTemplate](../../com.aspose.threed/vertexelementtemplate) | Mål. |

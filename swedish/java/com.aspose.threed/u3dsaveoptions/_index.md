...
description: Sparalternativ för universell 3D
type: docs
weight: 198
url: /sv/java/com.aspose.threed/u3dsaveoptions/
---
...
Sparalternativ för universell 3D
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [U3dSaveOptions()](#U3dSaveOptions--) | Konstruktor för [U3dSaveOptions](../../com.aspose.threed/u3dsaveoptions) |
## Metoder
...
| [getClass()](#getClass--) |  |
| [getEmbedTextures()](#getEmbedTextures--) | Bädda in de externa texturerna i U3D-filen, standardvärdet är falskt. |
| [getEncoding()](#getEncoding--) | Hämtar standardkodningen för textbaserade filer. |
| [getExportNormals()](#getExportNormals--) | Hämtar om normaldata ska exporteras. |
| [getExportTextureCoordinates()](#getExportTextureCoordinates--) | Hämtar om texturkoordinater ska exporteras. |
| [getExportTextures()](#getExportTextures--) | Försök att kopiera texturer som används i scenen till utmatningskatalogen. |
| [getExportVertexDiffuse()](#getExportVertexDiffuse--) | Hämtar om vertexens diffusa färg ska exporteras. |
| [getExportVertexSpecular()](#getExportVertexSpecular--) | Hämtar om vertexens spekulära färg ska exporteras. |
...
| [getMeshCompression()](#getMeshCompression--) | Hämtar om mesh-datakomprimering ska aktiveras. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEmbedTextures(boolean value)](#setEmbedTextures-boolean-) | Bädda in de externa texturerna i U3D-filen, standardvärdet är falskt. |
| [setEncoding(Charset value)](#setEncoding-java.nio.charset.Charset-) | Ställer in standardkodningen för textbaserade filer. |
| [setExportNormals(boolean value)](#setExportNormals-boolean-) | Ställer in om normaldata ska exporteras. |
| [setExportTextureCoordinates(boolean value)](#setExportTextureCoordinates-boolean-) | Ställer in om texturkoordinater ska exporteras. |
...
| [setExportVertexDiffuse(boolean value)](#setExportVertexDiffuse-boolean-) | Ställer in om vertexens diffusa färg ska exporteras. |
| [setExportVertexSpecular(boolean value)](#setExportVertexSpecular-boolean-) | Ställer in om vertexens spekulära färg ska exporteras. |
...
| [setMeshCompression(boolean value)](#setMeshCompression-boolean-) | Ställer in om mesh-datakomprimering ska aktiveras. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Konstruktor för [U3dSaveOptions](../../com.aspose.threed/u3dsaveoptions)
...
Bädda in de externa texturerna i U3D-filen, standardvärdet är falskt.

**Returns:**
boolean - Bädda in de externa texturerna i U3D-filen, standardvärdet är falskt.
...
Hämtar om normaldata ska exporteras.

**Returns:**
boolean - om normaldata ska exporteras.
...
Hämtar om texturkoordinater ska exporteras.

**Returns:**
boolean - om texturkoordinater ska exporteras.
...
Hämtar om vertexens diffusa färg ska exporteras.

**Returns:**
boolean - om vertexens diffusa färg ska exporteras.
...
Hämtar om vertexens spekulära färg ska exporteras.

**Returns:**
boolean - om vertexens spekulära färg ska exporteras.
...
Hämtar om mesh-datakomprimering ska aktiveras.

**Returns:**
boolean - om mesh-datakomprimering ska aktiveras.
### hashCode() {#hashCode--}
```
...
Ställer in om normaldata ska exporteras.
...
Ställer in om texturkoordinater ska exporteras.
...
Ställer in om vertexens diffusa färg ska exporteras.
...
Ställer in om vertexens spekulära färg ska exporteras.
...
Ställer in om mesh-datakomprimering ska aktiveras.

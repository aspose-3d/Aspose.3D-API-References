...
description: Formen beskriver deformationen på en uppsättning kontrollpunkter som liknar cluster-deformern i Maya.
type: docs
weight: 171
url: /sv/java/com.aspose.threed/shape/
---
...
Formen beskriver deformationen på en uppsättning kontrollpunkter, vilket liknar cluster-deformern i Maya. Till exempel kan vi lägga till en form till en skapad geometri. Formen och geometrin har samma topologiska information men olika positioner för kontrollpunkterna. Med varierande mängder påverkan utför geometrin en deformationseffekt.
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [Shape()](#Shape--) | Initierar en ny instans av klassen [Shape](../../com.aspose.threed/shape). |
| [Shape(String name)](#Shape-java.lang.String-) | Initierar en ny instans av klassen [Shape](../../com.aspose.threed/shape). |
## Metoder
...
| [fromControlPoints(Vector3[] controlPoints)](#fromControlPoints-com.aspose.threed.Vector3...-) | Skapa en form med angivna kontrollpunkter med standardindex. |
...
| [getIndices()](#getIndices--) | Hämtar indexen. |
...
Initierar en ny instans av klassen [Shape](../../com.aspose.threed/shape).
...
Skapa en form med angivna kontrollpunkter med standardindex.
...
**Returns:**
java.util.List<java.lang.Integer> - indexen.
### getName() {#getName--}
```

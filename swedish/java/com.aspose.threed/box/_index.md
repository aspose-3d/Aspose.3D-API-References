...
type: docs
weight: 26
url: /sv/java/com.aspose.threed/box/
---
...
| --- | --- |
| [Box()](#Box--) | Initierar en ny instans av klassen [Box](../../com.aspose.threed/box). |
| [Box(double length, double width, double height)](#Box-double-double-double-) | Initierar en ny instans av klassen [Box](../../com.aspose.threed/box). |
| [Box(String name, double length, double width, double height, int lengthSegments, int widthSegments, int heightSegments)](#Box-java.lang.String-double-double-double-int-int-int-) | Initierar en ny instans av klassen [Box](../../com.aspose.threed/box). |
## Metoder
...
| [getHeight()](#getHeight--) | Hämtar höjden på lådan som är inriktad på y-axeln. |
| [getHeightSegments()](#getHeightSegments--) | hämtar eller anger höjdsegmenten. |
| [getLength()](#getLength--) | Hämtar längden på lådan som är inriktad på z-axeln. |
...
| [getWidth()](#getWidth--) | Hämtar bredden på lådan som är inriktad på x-axeln. |
...
| [setHeight(double value)](#setHeight-double-) | Ställer in höjden på lådan som är justerad i y-axeln. |
| [setHeightSegments(int value)](#setHeightSegments-int-) | hämtar eller anger höjdsegmenten. |
| [setLength(double value)](#setLength-double-) | Ställer in längden på lådan som är justerad i z-axeln. |
...
| [setWidth(double value)](#setWidth-double-) | Ställer in bredden på lådan som är justerad i x-axeln. |
...
Initierar en ny instans av klassen [Box](../../com.aspose.threed/box).
...
| --- | --- | --- |
| length | double | Längden på lådan som är justerad i z-axeln. |
| bredd | double | Bredden på lådan som är justerad i x-axeln. |
| höjd | double | Höjden på lådan som är justerad i y-axeln. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| namn | java.lang.String | Namn på lådan. |
| length | double | Längden på lådan som är justerad i z-axeln. |
| bredd | double | Bredden på lådan som är justerad i x-axeln. |
| höjd | double | Höjden på lådan som är justerad i y-axeln. |
...
Hämtar höjden på lådan som är inriktad på y-axeln.

**Returns:**
double - höjden på lådan som är justerad i y-axeln.
...
hämtar eller anger höjdsegmenten.

**Returns:**
int - hämtar eller ställer in höjdsegmenten.
### getLength() {#getLength--}
```
...
Hämtar längden på lådan som är inriktad på z-axeln.

**Returns:**
double - längden på lådan som är justerad i z-axeln.
...
Hämtar bredden på lådan som är inriktad på x-axeln.

**Returns:**
double - bredden på lådan som är justerad i x-axeln.
...
Ställer in höjden på lådan som är justerad i y-axeln.
...
Ställer in längden på lådan som är justerad i z-axeln.
...
Ställer in bredden på lådan som är justerad i x-axeln.

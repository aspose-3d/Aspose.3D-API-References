...
description: IFC-kompatibel ihålig rektangulär form med både inre/yttre avrundade hörn.
type: docs
weight: 79
url: /sv/java/com.aspose.threed/hollowrectangleshape/
---
...
| [getInnerFilletRadius()](#getInnerFilletRadius--) | Den inre avrundningsradien för den inre rektangeln. |
...
| [getRoundingRadius()](#getRoundingRadius--) | Hämtar radien för de cirkulära bågarna i alla fyra hörnen, mätt i grader. |
| [getScene()](#getScene--) | Hämtar scenen som detta objekt tillhör |
| [getWallThickness()](#getWallThickness--) | Tjockleken mellan rektangelns gräns och det inre hålet |
| [getXDim()](#getXDim--) | Hämtar omfattningen av rektangeln i x‑axelns riktning Standardvärdet är 2.0 |
| [getYDim()](#getYDim--) | Hämtar omfattningen av rektangeln i y‑axelns riktning Standardvärdet är 2.0 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setInnerFilletRadius(double value)](#setInnerFilletRadius-double-) | Den inre avrundningsradien för den inre rektangeln. |
...
| [setRoundingRadius(double value)](#setRoundingRadius-double-) | Ställer in radien för de cirkulära bågarna i alla fyra hörnen, mätt i grader. |
| [setWallThickness(double value)](#setWallThickness-double-) | Tjockleken mellan rektangelns gräns och det inre hålet |
| [setXDim(double value)](#setXDim-double-) | Ställer in omfattningen av rektangeln i x‑axelns riktning Standardvärdet är 2.0 |
| [setYDim(double value)](#setYDim-double-) | Ställer in omfattningen av rektangeln i y‑axelns riktning Standardvärdet är 2.0 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Den inre avrundningsradien för den inre rektangeln.

**Returns:**
double - Den inre avrundningsradien för den inre rektangeln.
### getName() {#getName--}
```
...
Hämtar radien för de cirkulära bågarna i alla fyra hörnen, mätt i grader. Standardvärdet är 0.0

**Returns:**
double - radien för de cirkulära bågarna i alla fyra hörnen, mätt i grader. Standardvärdet är 0.0
### getScene() {#getScene--}
```
...
**Returns:**
double - Tjockleken mellan rektangelns gräns och det inre hålet
### getXDim() {#getXDim--}
```
...
Hämtar omfattningen av rektangeln i x‑axelns riktning Standardvärdet är 2.0

**Returns:**
double - omfattningen av rektangeln i x‑axelns riktning Standardvärdet är 2.0
### getYDim() {#getYDim--}
```
...
Hämtar omfattningen av rektangeln i y‑axelns riktning Standardvärdet är 2.0

**Returns:**
double - omfattningen av rektangeln i y‑axelns riktning Standardvärdet är 2.0
### hashCode() {#hashCode--}
```
...
Ställer in radien för de cirkulära bågarna i alla fyra hörnen, mätt i grader. Standardvärdet är 0.0
...
Ställer in omfattningen av rektangeln i x‑axelns riktning Standardvärdet är 2.0
...
Ställer in omfattningen av rektangeln i y‑axelns riktning Standardvärdet är 2.0

...
type: docs
weight: 199
url: /sv/java/com.aspose.threed/ushape/
---
...
| --- | --- |
| [UShape()](#UShape--) | Konstruktor för [UShape](../../com.aspose.threed/ushape) |
## Metoder
...
| [getEdgeRadius()](#getEdgeRadius--) | Hämtar radien på kanten i flänsens kant. |
...
| [getFilletRadius()](#getFilletRadius--) | Hämtar radien på avrundningen mellan fläns och webb. |
| [getFlangeThickness()](#getFlangeThickness--) | Hämtar tjockleken på flänsen. |
...
| [getWebThickness()](#getWebThickness--) | Hämtar tjockleken på webben. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setEdgeRadius(double value)](#setEdgeRadius-double-) | Ställer in radien på kanten i flänsens kant. |
| [setExcluded(boolean value)](#setExcluded-boolean-) | Ställer in om denna enhet ska exkluderas vid export. |
| [setFilletRadius(double value)](#setFilletRadius-double-) | Ställer in radien på avrundningen mellan fläns och webb. |
| [setFlangeThickness(double value)](#setFlangeThickness-double-) | Ställer in tjockleken på flänsen. |
...
| [setWebThickness(double value)](#setWebThickness-double-) | Ställer in tjockleken på webben. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Konstruktor för [UShape](../../com.aspose.threed/ushape)
...
Hämtar radien på kanten i flänsens kant.

**Returns:**
double - radien på kanten i flänsens kant.
...
Hämtar radien på avrundningen mellan fläns och webb.

**Returns:**
double - radien på avrundningen mellan fläns och webb.
...
Hämtar tjockleken på flänsen.

**Returns:**
double - tjockleken på flänsen.
...
Hämtar tjockleken på webben.

**Returns:**
double - tjockleken på webben.
### hashCode() {#hashCode--}
```
...
Ställer in radien på kanten i flänsens kant.
...
Ställer in radien på avrundningen mellan fläns och webb.
...
Ställer in tjockleken på flänsen.
...
Ställer in tjockleken på webben.

...
description: är en yta som representeras av NURBSNon-uniform rational basis spline  A  är definierad av två  och .
type: docs
weight: 114
url: /sv/java/com.aspose.threed/nurbssurface/
---
...
| --- | --- |
| [NurbsSurface()](#NurbsSurface--) | Initierar en ny instans av klassen [NurbsSurface](../../com.aspose.threed/nurbssurface). |
| [NurbsSurface(String name)](#NurbsSurface-java.lang.String-) | Initierar en ny instans av klassen [NurbsSurface](../../com.aspose.threed/nurbssurface). |
## Metoder
...
| [getU()](#getU--) | Hämtar NURBS-ytans U-riktning |
| [getV()](#getV--) | Hämtar NURBS-ytans V-riktning |
...
| [toMesh()](#toMesh--) | Konvertera NURBS-ytan till meshen |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initierar en ny instans av klassen [NurbsSurface](../../com.aspose.threed/nurbssurface).
...
Konvertera NURBS-ytan till meshen

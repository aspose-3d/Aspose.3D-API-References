...
| drawOperation | [DrawOperation](../../com.aspose.threed/drawoperation) | Ritningsoperation |
...
| --- | --- | --- |
| parameters | [RenderParameters](../../com.aspose.threed/renderparameters) | Renderingsparametrar för att skapa rendertexturen |
| mål | int | Hur många färgutgångsmål |
| bredd | int | Bredden på rendertexturen |
| höjd | int | Höjden på rendertexturen |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| parameters | [RenderParameters](../../com.aspose.threed/renderparameters) | Renderingsparametrar för att skapa renderingsfönstret |
| handle | [WindowHandle](../../com.aspose.threed/windowhandle) | Handtaget för fönstret som ska renderas |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| shaderSource | [ShaderSource](../../com.aspose.threed/shadersource) | Shaderns källkod |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| textureType | [TextureType](../../com.aspose.threed/texturetype) | Typ av textur |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| storlek | int | Storleken på den uniforma bufferten |

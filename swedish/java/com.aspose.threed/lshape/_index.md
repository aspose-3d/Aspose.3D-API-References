...
type: docs
weight: 91
url: /sv/java/com.aspose.threed/lshape/
---
...
| --- | --- |
| [LShape()](#LShape--) | Konstruktor för [LShape](../../com.aspose.threed/lshape) |
## Metoder
...
| [getEdgeRadius()](#getEdgeRadius--) | Hämtar radien på kanten. |
...
| [getFilletRadius()](#getFilletRadius--) | Hämtar radien på avrundningen. |
...
| [getThickness()](#getThickness--) | Hämtar tjockleken på den konstanta väggen. |
...
| [setEdgeRadius(double value)](#setEdgeRadius-double-) | Ställer in radien på kanten. |
| [setExcluded(boolean value)](#setExcluded-boolean-) | Ställer in om denna enhet ska exkluderas vid export. |
| [setFilletRadius(double value)](#setFilletRadius-double-) | Ställer in radien på avrundningen. |
...
| [setThickness(double value)](#setThickness-double-) | Ställer in tjockleken på den konstanta väggen. |
...
Konstruktor för [LShape](../../com.aspose.threed/lshape)
...
Hämtar radien på kanten.

**Returns:**
double - radien på kanten.
...
Hämtar radien på avrundningen.

**Returns:**
double - radien på avrundningen.
### getName() {#getName--}
```
...
Hämtar tjockleken på den konstanta väggen.

**Returns:**
double - tjockleken på den konstanta väggen.
### getWidth() {#getWidth--}
```
...
Ställer in radien på avrundningen.
...
Ställer in tjockleken på den konstanta väggen.

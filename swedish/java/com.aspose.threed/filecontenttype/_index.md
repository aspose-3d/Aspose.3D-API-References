...
type: docs
weight: 279
url: /sv/java/com.aspose.threed/filecontenttype/
---
...
| Fält | Beskrivning |
| --- | --- |
| [ASCII](#ASCII) | ASCII-formattyp, såsom ASCII FBX, ASCII STL |
| [BINARY](#BINARY) | Binär formattyp, såsom binär FBX, binär STL |
## Metoder
...
ASCII-formattyp, såsom ASCII FBX, ASCII STL
...
Binär formattyp, såsom binär FBX, binär STL

...
description: Läsalternativ för STL
type: docs
weight: 176
url: /sv/java/com.aspose.threed/stlloadoptions/
---
...
| --- | --- |
| [StlLoadOptions()](#StlLoadOptions--) | Initierar en ny [StlLoadOptions](../../com.aspose.threed/stlloadoptions) instans. |
| [StlLoadOptions(FileContentType contentType)](#StlLoadOptions-com.aspose.threed.FileContentType-) | Initierar en ny [StlLoadOptions](../../com.aspose.threed/stlloadoptions) instans. |
## Metoder
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | Hämtar om koordinatsystemet för kontrollpunkter/normaler ska vändas vid import. |
...
| [getRecalculateNormal()](#getRecalculateNormal--) | Ignorera normaldata som lagras i STL-filen och beräkna om normaldata baserat på vertexpositionen. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | Ställer in om koordinatsystemet för kontrollpunkter/normaler ska vändas vid import. |
...
| [setRecalculateNormal(boolean value)](#setRecalculateNormal-boolean-) | Ignorera normaldata som lagras i STL-filen och beräkna om normaldata baserat på vertexpositionen. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initierar en ny [StlLoadOptions](../../com.aspose.threed/stlloadoptions) instans.
...
Hämtar om koordinatsystemet för kontrollpunkter/normaler ska vändas vid import.

**Returns:**
boolean - om koordinatsystemet för kontrollpunkter/normaler ska vändas vid import.
...
Ignorera normaldata som lagras i STL-filen och beräkna om normaldata baserat på vertexpositionen. Standardvärdet är false

**Returns:**
boolean - Ignorera normaldata som lagras i STL-filen och beräkna om normaldata baserat på vertexpositionen. Standardvärdet är false
### hashCode() {#hashCode--}
```
...
Ställer in om koordinatsystemet för kontrollpunkter/normaler ska vändas vid import.

...
type: docs
weight: 12
url: /sv/java/com.aspose.threed/amfsaveoptions/
---
...
| --- | --- |
| [AmfSaveOptions()](#AmfSaveOptions--) | Konstruktor för [AmfSaveOptions](../../com.aspose.threed/amfsaveoptions) |
## Metoder
...
| [getClass()](#getClass--) |  |
| [getEnableCompression()](#getEnableCompression--) | Om komprimering ska användas för att minska den slutliga filstorleken, standardvärdet är true |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEnableCompression(boolean value)](#setEnableCompression-boolean-) | Om komprimering ska användas för att minska den slutliga filstorleken, standardvärdet är true |
...
Konstruktor för [AmfSaveOptions](../../com.aspose.threed/amfsaveoptions)
...
Om komprimering ska användas för att minska den slutliga filstorleken, standardvärdet är true

**Returns:**
boolean - Om komprimering ska användas för att minska den slutliga filstorleken, standardvärdet är true

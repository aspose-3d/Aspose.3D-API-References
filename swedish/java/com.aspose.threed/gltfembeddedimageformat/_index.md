...
type: docs
weight: 281
url: /sv/java/com.aspose.threed/gltfembeddedimageformat/
---
...
| Fält | Beskrivning |
| --- | --- |
| [JPEG](#JPEG) | Alla icke-stödda bildformat kommer att konverteras till jpeg om möjligt. |
| [NO_CHANGE](#NO-CHANGE) | Konvertera inte bilden och behåll den som den är. |
| [PNG](#PNG) | Alla icke-stödda bildformat kommer att konverteras till png om möjligt. |
## Metoder
...
Alla icke-stödda bildformat kommer att konverteras till jpeg om möjligt.
...
Konvertera inte bilden och behåll den som den är.
...
Alla icke-stödda bildformat kommer att konverteras till png om möjligt.

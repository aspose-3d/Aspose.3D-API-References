...
type: docs
weight: 278
url: /sv/java/com.aspose.threed/extrapolationtype/
---
...
| Fält | Beskrivning |
| --- | --- |
| [CONSTANT](#CONSTANT) | Värdet kommer att behålla samma värde som det föregående värdet |
| [CYCLE](#CYCLE) | Upprepningen. |
| [CYCLE_RELATIVE](#CYCLE-RELATIVE) | Upprepa föregående mönster baserat på det sista värdet |
| [GRADIENT](#GRADIENT) | Värdet kommer att behålla samma lutning över tid |
| [OSCILLATE](#OSCILLATE) | Spegelupprepningen. |
## Metoder
...
Värdet kommer att behålla samma värde som det föregående värdet
...
Upprepa föregående mönster baserat på det sista värdet
...
Värdet kommer att behålla samma lutning över tid

...
description: Alternativ för PDF-inläsning
type: docs
weight: 124
url: /sv/java/com.aspose.threed/pdfloadoptions/
---
...
| --- | --- |
| [PdfLoadOptions()](#PdfLoadOptions--) | Konstruktor för [PdfLoadOptions](../../com.aspose.threed/pdfloadoptions) |
## Metoder
...
| [getPassword()](#getPassword--) | Lösenordet för att låsa upp den krypterade PDF-filen. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setPassword(byte[] value)](#setPassword-byte---) | Lösenordet för att låsa upp den krypterade PDF-filen. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Konstruktor för [PdfLoadOptions](../../com.aspose.threed/pdfloadoptions)
...
**Returns:**
byte[] - Lösenordet för att låsa upp den krypterade PDF-filen.
### hashCode() {#hashCode--}
```

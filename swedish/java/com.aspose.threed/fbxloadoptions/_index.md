...
description: Läsalternativ för Fbx-format.
type: docs
weight: 62
url: /sv/java/com.aspose.threed/fbxloadoptions/
---
...
| --- | --- |
| [FbxLoadOptions(FileFormat format)](#FbxLoadOptions-com.aspose.threed.FileFormat-) | Konstruktor för [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions) |
| [FbxLoadOptions()](#FbxLoadOptions--) | Konstruktor för [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions) |
## Metoder
...
| [getClass()](#getClass--) |  |
| [getCompatibleMode()](#getCompatibleMode--) | Hämtar om kompatibel läge ska aktiveras. |
...
| [getKeepBuiltinGlobalSettings()](#getKeepBuiltinGlobalSettings--) | Hämtar om de inbyggda egenskaperna i GlobalSettings som har en inbyggd ersättning i [AssetInfo](../../com.aspose.threed/assetinfo) ska behållas. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setCompatibleMode(boolean value)](#setCompatibleMode-boolean-) | Ställer in om kompatibel läge ska aktiveras. |
...
| [setKeepBuiltinGlobalSettings(boolean value)](#setKeepBuiltinGlobalSettings-boolean-) | Ställer in om de inbyggda egenskaperna i GlobalSettings som har en inbyggd ersättning i [AssetInfo](../../com.aspose.threed/assetinfo) ska behållas. |
...
Konstruktor för [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions)

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| format | [FileFormat](../../com.aspose.threed/fileformat) | Instans av [getFileFormat](../../com.aspose.threed/fbxloadoptions\#getFileFormat), den bör vara ett giltigt FBX-format. |
...
Hämtar om kompatibel läge ska aktiveras. Kompatibelt läge kommer att försöka stödja icke‑standard FBX‑definitioner såsom PBR‑material exporterade av Blender. Standardvärdet är falskt.

**Returns:**
boolean - om kompatibel läge ska aktiveras. Kompatibelt läge kommer att försöka stödja icke‑standard FBX‑definitioner såsom PBR‑material exporterade av Blender. Standardvärdet är falskt.
...
Hämtar om de inbyggda egenskaperna i GlobalSettings som har en inbyggd ersättning i [AssetInfo](../../com.aspose.threed/assetinfo) ska behållas. Sätt detta till true om du vill ha de fullständiga egenskaperna i GlobalSettings. Standardvärdet är falskt

**Returns:**
boolean - om de inbyggda egenskaperna i GlobalSettings som har en inbyggd ersättning i [AssetInfo](../../com.aspose.threed/assetinfo) ska behållas. Sätt detta till true om du vill ha de fullständiga egenskaperna i GlobalSettings. Standardvärdet är falskt
...
Ställer in om kompatibel läge ska aktiveras. Kompatibelt läge kommer att försöka stödja icke‑standard FBX‑definitioner såsom PBR‑material exporterade av Blender. Standardvärdet är falskt.
...
Ställer in om de inbyggda egenskaperna i GlobalSettings som har en inbyggd ersättning i [AssetInfo](../../com.aspose.threed/assetinfo) ska behållas. Sätt detta till true om du vill ha de fullständiga egenskaperna i GlobalSettings. Standardvärdet är falskt

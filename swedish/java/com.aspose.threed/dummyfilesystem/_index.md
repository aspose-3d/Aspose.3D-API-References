...
type: docs
weight: 46
url: /sv/java/com.aspose.threed/dummyfilesystem/
---
...
Läs-/skrivoperationer är dummyoperationer. **Example:** Följande kod visar hur man exporterar filen till minnet och ignorerar all beroende filgenerering.

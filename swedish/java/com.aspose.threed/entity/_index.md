...
description: Bas-klassen för alla entiteter.
type: docs
weight: 52
url: /sv/java/com.aspose.threed/entity/
---
...
Bas-klassen för alla enheter. Entity representerar ett konkret objekt som är fäst under en nod som [Light](../../com.aspose.threed/light)/[Geometry](../../com.aspose.threed/geometry).
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [Entity(String name)](#Entity-java.lang.String-) | Initierar en ny instans av klassen [Entity](../../com.aspose.threed/entity). |
## Metoder
...
Initierar en ny instans av klassen [Entity](../../com.aspose.threed/entity).

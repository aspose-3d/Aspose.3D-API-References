...
description: "Textprofil den här profilen beskriver konturer med hjälp av teckensnitt och text."
type: docs
weight: 183
url: /sv/java/com.aspose.threed/text/
---
...
Textprofil, den här profilen beskriver konturer med hjälp av teckensnitt och text. **Exempel:** Följande kod visar hur man skapar ett 3D-nät från text med en angiven teckensnittsfil.
...
| [getClass()](#getClass--) |  |
| [getContent()](#getContent--) | Innehållet i texten |
...
| [getFont()](#getFont--) | Teckensnittet för texten. |
| [getFontSize()](#getFontSize--) | Teckensnittsstorleksskala. |
...
| [setContent(String value)](#setContent-java.lang.String-) | Innehållet i texten |
| [setExcluded(boolean value)](#setExcluded-boolean-) | Ställer in om denna enhet ska exkluderas vid export. |
| [setFont(FontFile value)](#setFont-com.aspose.threed.FontFile-) | Teckensnittet för texten. |
| [setFontSize(float value)](#setFontSize-float-) | Teckensnittsstorleksskala. |
...
**Returns:**
java.lang.String - Innehållet i texten **Exempel:** Följande kod visar hur man skapar ett 3D-nät från text med en angiven teckensnittsfil.
...
Teckensnittsstorleksskala.

**Returns:**
float - Teckensnittsstorleksskala. **Exempel:** Följande kod visar hur man skapar ett 3D-nät från text med en angiven teckensnittsfil.
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
|  | värde | java.lang.String | Nytt värde **Exempel:** Följande kod visar hur man skapar ett 3D-nät från text med en angiven teckensnittsfil. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
|  | value | [FontFile](../../com.aspose.threed/fontfile) | Nytt värde **Exempel:** Följande kod visar hur man skapar ett 3D-nät från text med en angiven teckensnittsfil. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
|  | värde | float | Nytt värde **Exempel:** Följande kod visar hur man skapar ett 3D-nät från text med en angiven teckensnittsfil. |

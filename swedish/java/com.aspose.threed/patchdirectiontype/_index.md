...
description: "Typer av patch-riktningar."
type: docs
weight: 287
url: /sv/java/com.aspose.threed/patchdirectiontype/
---
...
| Fält | Beskrivning |
| --- | --- |
|  | [BASIS_SPLINE](#BASIS-SPLINE) | [Patch-riktningen är en basis-spline.][] |


[The patch direction is a basis spline.]: https://en.wikipedia.org/wiki/B-spline |
|  | [BEZIER](#BEZIER) | [Patch-riktningen är en Bézier-kurva.][] |
...
|  | [LINEAR](#LINEAR) | [Patch-riktningen är en linjär kurva.][] |


[The patch direction is a linear curve.]: https://en.wikipedia.org/wiki/B%C3%A9zier_curve#Linear_curves |
| [QUADRATIC_BEZIER](#QUADRATIC-BEZIER) | Den kvadratiska Bézier-patchen. |
## Metoder
...
cardinal patch. [Patch-riktningen är en cardinal-spline.][]
...
Den kvadratiska Bézier-patchen. [Patch-riktningen är en kvadratisk kurva.][]

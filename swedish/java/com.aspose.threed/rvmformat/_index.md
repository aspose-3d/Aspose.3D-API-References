...
type: docs
weight: 156
url: /sv/java/com.aspose.threed/rvmformat/
---
...
| [hashCode()](#hashCode--) |  |
| [loadAttributes(Scene scene, Stream stream)](#loadAttributes-com.aspose.threed.Scene-com.aspose.threed.Stream-) | Läs in attributen från angiven ström |
| [loadAttributes(Scene scene, Stream stream, String prefix)](#loadAttributes-com.aspose.threed.Scene-com.aspose.threed.Stream-java.lang.String-) | Läs in attributen från angiven ström |
| [loadAttributes(Scene scene, String fileName)](#loadAttributes-com.aspose.threed.Scene-java.lang.String-) | Läs in attributen från angivet filnamn |
| [loadAttributes(Scene scene, String fileName, String prefix)](#loadAttributes-com.aspose.threed.Scene-java.lang.String-java.lang.String-) | Läs in attributen från angivet filnamn |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Läs in attributen från angiven ström

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| scene | [Scene](../../com.aspose.threed/scene) | Scenen där attributen kommer att tillämpas på |
| stream | [Stream](../../com.aspose.threed/stream) | Strömmen som innehåller attributen |
...
| scene | [Scene](../../com.aspose.threed/scene) | Scenen där attributen kommer att tillämpas på |
| stream | [Stream](../../com.aspose.threed/stream) | Strömmen som innehåller attributen |
| prefix | java.lang.String | Prefixet för attributen som används för att undvika namnkonflikter, standardvärdet är "rvm:" |
...
Läs in attributen från angivet filnamn

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| scene | [Scene](../../com.aspose.threed/scene) | Scenen där attributen kommer att tillämpas på |
| fileName | java.lang.String | Filens namn som innehåller attributen |

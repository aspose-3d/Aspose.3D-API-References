...
type: docs
weight: 268
url: /sv/java/com.aspose.threed/booleanoperation/
---
...
Meshens booleska operation
## Fält

| Fält | Beskrivning |
| --- | --- |
| [ADD](#ADD) | Lägg till två meshar och beräkna unionen av indata. |
| [INTERSECT](#INTERSECT) | Beräkna skärningen av två meshar. |
| [SUB](#SUB) | Subtrahera ett mesh från ett annat mesh, beräkna skillnaden mellan indata. |
## Metoder
...
Lägg till två meshar och beräkna unionen av indata.
...
Beräkna skärningen av två meshar.
...
Subtrahera ett mesh från ett annat mesh, beräkna skillnaden mellan indata.

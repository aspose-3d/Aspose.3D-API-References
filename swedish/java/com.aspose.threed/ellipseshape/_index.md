...
description: IFC-kompatibel ellipsform som definieras av parametrar.
type: docs
weight: 50
url: /sv/java/com.aspose.threed/ellipseshape/
---
...
| [getSemiAxis1()](#getSemiAxis1--) | Hämtar den första radien av ellipsen som mäts i x-axelns riktning. |
| [getSemiAxis2()](#getSemiAxis2--) | Hämtar den andra radien av ellipsen som mäts i y-axelns riktning. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setSemiAxis1(double value)](#setSemiAxis1-double-) | Ställer in den första radien av ellipsen som mäts i x-axelns riktning. |
| [setSemiAxis2(double value)](#setSemiAxis2-double-) | Ställer in den andra radien av ellipsen som mäts i y-axelns riktning. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Hämtar den första radien av ellipsen som mäts i x-axelns riktning.

**Returns:**
double - den första radien av ellipsen som mäts i x-axelns riktning.
...
Hämtar den andra radien av ellipsen som mäts i y-axelns riktning.

**Returns:**
double - den andra radien av ellipsen som mäts i y-axelns riktning.
### hashCode() {#hashCode--}
```
...
Ställer in den första radien av ellipsen som mäts i x-axelns riktning.
...
Ställer in den andra radien av ellipsen som mäts i y-axelns riktning.

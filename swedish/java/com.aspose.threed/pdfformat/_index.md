...
description: Adobes Portable Document Format-exempel         Följande kod visar hur man extraherar alla stödjade 3D‑scener från en 3D‑PDF‑fil och skriver dem till OBJ‑format.
type: docs
weight: 123
url: /sv/java/com.aspose.threed/pdfformat/
---
...
Adobes Portable Document Format **Exempel:** Följande kod visar hur man extraherar alla stödda 3D-scener från en 3D PDF-fil och skriver dem till obj-format.
...
| [extract(Stream stream)](#extract-com.aspose.threed.Stream-) | Extrahera rå 3D‑innehåll från PDF‑ström. |
| [extract(Stream stream, byte[] password)](#extract-com.aspose.threed.Stream-byte---) | Extrahera rå 3D‑innehåll från PDF‑ström. |
| [extract(String fileName)](#extract-java.lang.String-) | Extrahera rå 3D‑innehåll från PDF‑fil. |
| [extract(String fileName, byte[] password)](#extract-java.lang.String-byte---) | Extrahera rå 3D‑innehåll från PDF‑fil. |
| [extractScene(Stream stream)](#extractScene-com.aspose.threed.Stream-) | Extrahera rå 3D‑innehåll från PDF‑ström. |
| [extractScene(Stream stream, byte[] password)](#extractScene-com.aspose.threed.Stream-byte---) | Extrahera rå 3D‑innehåll från PDF‑ström. |
| [extractScene(String fileName)](#extractScene-java.lang.String-) | Extrahera 3D‑scener från PDF‑fil. |
| [extractScene(String fileName, byte[] password)](#extractScene-java.lang.String-byte---) | Extrahera 3D‑scener från PDF‑fil. |
...
Extrahera rå 3D‑innehåll från PDF‑ström.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | Ström av inmatnings‑PDF‑fil |

**Returns:**
java.util.ArrayList<byte[]> - En lista över allt 3D‑innehåll i byte, inklusive de format som Aspose.3D inte stöder. **Example:** Följande kod visar hur man extraherar allt rått 3D‑innehåll från en 3D‑PDF‑fil och skriver dem till filer.
...
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | Ström av inmatnings‑PDF‑fil |
| lösenord | byte[] | Lösenord för PDF-filen |
...
Extrahera rå 3D‑innehåll från PDF‑fil.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| fileName | java.lang.String | Filnamn för inmatnings-PDF-filen |
...
**Returns:**
java.util.ArrayList<com.aspose.threed.Scene> - Lista över avkodade 3D-scener som stöds av Aspose.3D **Exempel:** Följande kod visar hur man extraherar alla stödda 3D-scener från en 3D PDF-fil och skriver dem till obj-format.

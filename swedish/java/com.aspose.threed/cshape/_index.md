...
description: IFC-kompatibel C-form profil som definieras av parametrar.
type: docs
weight: 27
url: /sv/java/com.aspose.threed/cshape/
---
...
IFC-kompatibel C-shape-profil som definieras av parametrar. Profilens mittposition är i mitten av den omgivande lådan.
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [CShape()](#CShape--) | Konstruktor för [CShape](../../com.aspose.threed/cshape) |
## Metoder
...
| [getClass()](#getClass--) |  |
| [getDepth()](#getDepth--) | Hämtar djupet på profilen. |
...
| [getGirth()](#getGirth--) | Hämtar längden på omkretsen. |
| [getInternalFilletRadius()](#getInternalFilletRadius--) | Hämtar den interna avrundningsradien. |
...
| [getWallThickness()](#getWallThickness--) | Hämtar väggens tjocklek. |
| [getWidth()](#getWidth--) | Hämtar profilens bredd. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setDepth(double value)](#setDepth-double-) | Ställer in djupet på profilen. |
| [setExcluded(boolean value)](#setExcluded-boolean-) | Ställer in om denna enhet ska exkluderas vid export. |
| [setGirth(double value)](#setGirth-double-) | Ställer in längden på omkretsen. |
| [setInternalFilletRadius(double value)](#setInternalFilletRadius-double-) | Ställer in den interna avrundningsradien. |
...
| [setWallThickness(double value)](#setWallThickness-double-) | Ställer in väggens tjocklek. |
| [setWidth(double value)](#setWidth-double-) | Ställer in profilens bredd. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Konstruktor för [CShape](../../com.aspose.threed/cshape)
...
Hämtar djupet på profilen.

**Returns:**
double - djupet på profilen.
...
Hämtar längden på omkretsen.

**Returns:**
double - längden på omkretsen.
...
Hämtar den interna avrundningsradien.

**Returns:**
double - den interna avrundningsradien.
### getName() {#getName--}
```
...
Hämtar väggens tjocklek.

**Returns:**
double - väggens tjocklek.
### getWidth() {#getWidth--}
```
...
Hämtar profilens bredd.

**Returns:**
double - profilens bredd.
### hashCode() {#hashCode--}
```
...
Ställer in längden på omkretsen.
...
Ställer in den interna avrundningsradien.

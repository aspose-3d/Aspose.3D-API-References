...
description: "Alternativ för  och"
type: docs
weight: 83
url: /sv/java/com.aspose.threed/imagerenderoptions/
---
...
Alternativ för [Scene](../../com.aspose.threed/scene) och [Scene](../../com.aspose.threed/scene)
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [ImageRenderOptions()](#ImageRenderOptions--) | Initiera en instans av [ImageRenderOptions](../../com.aspose.threed/imagerenderoptions) |
## Metoder
...
| [getAssetDirectories()](#getAssetDirectories--) | Kataloger som lagrade externa resurser(liknande texturer) |
| [getBackgroundColor()](#getBackgroundColor--) | Bakgrundsfärgen för renderingsresultatet. |
| [getClass()](#getClass--) |  |
| [getEnableShadows()](#getEnableShadows--) | Hämtar om skuggor ska renderas. |
...
| [setAssetDirectories(ArrayList<String> value)](#setAssetDirectories-java.util.ArrayList-java.lang.String--) | Kataloger som lagrade externa resurser(liknande texturer) |
| [setBackgroundColor(Vector3 value)](#setBackgroundColor-com.aspose.threed.Vector3-) | Bakgrundsfärgen för renderingsresultatet. |
| [setEnableShadows(boolean value)](#setEnableShadows-boolean-) | Ställer in om skuggor ska renderas. |
...
Initiera en instans av [ImageRenderOptions](../../com.aspose.threed/imagerenderoptions)
...
Kataloger som lagrade externa resurser(liknande texturer)

**Returns:**
java.util.ArrayList<java.lang.String> - Kataloger som lagrade externa resurser(liknande texturer)
...
Hämtar om skuggor ska renderas.

**Returns:**
boolean - om skuggor ska renderas.
### getName() {#getName--}
```
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| värde | java.util.ArrayList<java.lang.String> | Nytt värde |
...
Ställer in om skuggor ska renderas.

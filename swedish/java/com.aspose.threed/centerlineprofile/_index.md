...
description: "IFC-kompatibel mittlinjeprofil"
type: docs
weight: 30
url: /sv/java/com.aspose.threed/centerlineprofile/
---
...
IFC-kompatibel mittlinjeprofil
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [CenterLineProfile(Curve curve, double thickness)](#CenterLineProfile-com.aspose.threed.Curve-double-) | Skapar en ny [CenterLineProfile](../../com.aspose.threed/centerlineprofile) med specificerad kurva som mittlinje. |
| [CenterLineProfile(Curve curve)](#CenterLineProfile-com.aspose.threed.Curve-) | Skapar en ny [CenterLineProfile](../../com.aspose.threed/centerlineprofile) med specificerad kurva som mittlinje. |
## Metoder
...
| [getClass()](#getClass--) |  |
| [getCurve()](#getCurve--) | Mittlinjekurvan för profilen |
...
| [getThickness()](#getThickness--) | Tjocklek som tillämpas längs mittlinjen |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setCurve(Curve value)](#setCurve-com.aspose.threed.Curve-) | Mittlinjekurvan för profilen |
...
| [setThickness(double value)](#setThickness-double-) | Tjocklek som tillämpas längs mittlinjen |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Skapar en ny [CenterLineProfile](../../com.aspose.threed/centerlineprofile) med specificerad kurva som mittlinje.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Mittlinjekurva |
| tjocklek | double | Tjocklek som tillämpas längs mittlinjen |
...
Tjocklek som tillämpas längs mittlinjen

**Returns:**
double - Tjocklek som tillämpas längs mittlinjen
### hashCode() {#hashCode--}
```

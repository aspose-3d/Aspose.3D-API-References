...
| [toRadian(double degree)](#toRadian-double-) | Konvertera ett tal från grader till radian. |
| [toRadian(double x, double y, double z)](#toRadian-double-double-double-) | Konvertera en vektor från grader till radian. |
| [toRadian(float degree)](#toRadian-float-) | Konvertera ett tal från grader till radian. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| val | double | Värde att begränsa. |
| min | double | Minimalt värde. |
| max | double | Maximalt värde. |

**Returns:**
double - Värdet mellan [min, max] **Exempel:**
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| radian | [Vector3](../../com.aspose.threed/vector3) | Radianvärdet. |
...
**Returns:**
double - Värdet i grader. **Exempel:**
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| x | double | x-komponenten i radianvärdet. |
| y | double | y-komponenten i radianvärdet. |
| z | double | z-komponenten i radianvärdet. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| radian | float | Radianvärdet. |

**Returns:**
float - Värdet i grader. **Exempel:**
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| degree | [Vector3](../../com.aspose.threed/vector3) | Gradvärdet. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| grad | double | Gradvärdet. |

**Returns:**
double - Värdet i radian. **Exempel:**
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| x | double | x-komponenten i gradvärdet. |
| y | double | y-komponenten i gradvärdet. |
| z | double | z-komponenten i gradvärdet. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| grad | float | Gradvärdet. |

**Returns:**
float - Värdet i radian. **Exempel:**

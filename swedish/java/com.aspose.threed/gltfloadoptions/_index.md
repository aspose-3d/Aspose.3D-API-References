...
description: Läsalternativ för glTF-format
type: docs
weight: 73
url: /sv/java/com.aspose.threed/gltfloadoptions/
---
...
| --- | --- |
| [GltfLoadOptions()](#GltfLoadOptions--) | Konstruktor för [GltfLoadOptions](../../com.aspose.threed/gltfloadoptions) |
## Metoder
...
| [getFlipTexCoordV()](#getFlipTexCoordV--) | Vänd v(t)-koordinaten i meshens texturkoordinat, standardvärdet är true. |
...
| [setFlipTexCoordV(boolean value)](#setFlipTexCoordV-boolean-) | Vänd v(t)-koordinaten i meshens texturkoordinat, standardvärdet är true. |
...
Konstruktor för [GltfLoadOptions](../../com.aspose.threed/gltfloadoptions)
...
Vänd v(t)-koordinaten i meshens texturkoordinat, standardvärdet är true.

**Returns:**
boolean - Vänd v(t)-koordinaten i meshens texturkoordinat, standardvärdet är true.

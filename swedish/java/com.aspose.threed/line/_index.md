...
description: En polylinje är en bana som definieras av en uppsättning punkter med  och som är kopplad med   vilket betyder att den också kan vara en uppsättning sammankopplade linjesegment.
type: docs
weight: 95
url: /sv/java/com.aspose.threed/line/
---
...
En polylinje är en bana som definieras av en uppsättning punkter med [Geometry.getControlPoints](../../com.aspose.threed/geometry\#getControlPoints), och som är kopplad med [getSegments](../../com.aspose.threed/line\#getSegments), vilket betyder att den också kan vara en uppsättning sammankopplade linjesegment. Linjen är vanligtvis ett linjärt objekt, vilket betyder att den inte kan användas för att representera en kurva; för att representera en kurva används [NurbsCurve](../../com.aspose.threed/nurbscurve).
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [Line()](#Line--) | Initierar en ny instans av klassen [Line](../../com.aspose.threed/line). |
| [Line(String name)](#Line-java.lang.String-) | Initierar en ny instans av klassen [Line](../../com.aspose.threed/line). |
## Metoder
...
| [fromPoints(Vector3[] points)](#fromPoints-com.aspose.threed.Vector3...-) | Konstruera en [Line](../../com.aspose.threed/line)-instans från en uppsättning punkter. |
...
| [getSegments()](#getSegments--) | Hämtar segmenten för linjen |
| [getVisible()](#getVisible--) | Hämtar om geometrin är synlig |
| [hashCode()](#hashCode--) |  |
| [makeDefaultIndices()](#makeDefaultIndices--) | Generera sekvensen 0,1,2,3....[Geometry.getControlPoints](../../com.aspose.threed/geometry\#getControlPoints).Length-1 till [getSegments](../../com.aspose.threed/line\#getSegments) så att ControlPoints kan användas som en enda linje |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Initierar en ny instans av klassen [Line](../../com.aspose.threed/line).
...
Konstruera en [Line](../../com.aspose.threed/line)-instans från en uppsättning punkter.
...
Hämtar segmenten för linjen

**Returns:**
java.util.List<int[]> - segmenten för linjen
...
Generera sekvensen 0,1,2,3....[Geometry.getControlPoints](../../com.aspose.threed/geometry\#getControlPoints).Length-1 till [getSegments](../../com.aspose.threed/line\#getSegments) så att ControlPoints kan användas som en enda linje

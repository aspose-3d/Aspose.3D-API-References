...
description: Filformatinstans för Microsoft 3MF med 3MF-relaterade verktyg.
type: docs
weight: 104
url: /sv/java/com.aspose.threed/microsoft3mfformat/
---
...
| [getObjectType(Node node)](#getObjectType-com.aspose.threed.Node-) | Hämtar modelltypen för angiven nod. |
| [getTransformForBuild(Node node)](#getTransformForBuild-com.aspose.threed.Node-) | Hämta transformmatris för nod som används i byggprocessen. |
| [getVersion()](#getVersion--) | Hämtar filformatversion |
| [hashCode()](#hashCode--) |  |
| [isBuildable(Node node)](#isBuildable-com.aspose.threed.Node-) | Kontrollera om denna nod är markerad som en byggnod. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBuildable(Node node, boolean value, Matrix4 transform)](#setBuildable-com.aspose.threed.Node-boolean-com.aspose.threed.Matrix4-) | Markera en nod för byggning. |
| [setObjectType(Node node, String modelType)](#setObjectType-com.aspose.threed.Node-java.lang.String-) | Ställ in modelltypen för angiven nod. |
...
**Returns:**
java.lang.String - 3MF:s objekttyp för given nod
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Vilken nod som transformmatrisen ska hämtas för i 3MF-byggprocessen. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Vilken nod som ska kontrolleras |

**Returns:**
boolean - True om den är markerad som en byggnod
### notify() {#notify--}
```
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Vilken nod som ska markeras som en byggnod. |
| värde | boolean |  |
| transform | [Matrix4](../../com.aspose.threed/matrix4) | Transformen för noden i byggprocessen. |

...
description: En slätningsgrupp är en grupp av polygoner i ett polygonnät som bör framstå som en slät yta.
type: docs
weight: 216
url: /sv/java/com.aspose.threed/vertexelementsmoothinggroup/
---
...
En jämningsgrupp är en grupp av polygoner i ett polygonnät som ska framstå som en slät yta. Viss tidig 3D-modelleringsprogramvara som 3D Studio Max för DOS använde jämningsgrupp för att undvika lagring av normalvektor för varje nätvertex.
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [VertexElementSmoothingGroup()](#VertexElementSmoothingGroup--) | Initierar en ny instans av klassen [VertexElementSmoothingGroup](../../com.aspose.threed/vertexelementsmoothinggroup). |
## Metoder
...
| [copyTo(VertexElementIntsTemplate target)](#copyTo-com.aspose.threed.VertexElementIntsTemplate-) | Kopierar data till angivet element. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(int[] data)](#setData-int---) | Läs in data. |
...
Initierar en ny instans av klassen [VertexElementSmoothingGroup](../../com.aspose.threed/vertexelementsmoothinggroup).
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| target | [VertexElementIntsTemplate](../../com.aspose.threed/vertexelementintstemplate) | Mål. |
...
**Returns:**
java.util.List<java.lang.Integer> - vertexdata

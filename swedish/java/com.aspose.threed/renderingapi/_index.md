...
description: "Vanligt använda renderings-API:er"
type: docs
weight: 269
url: /sv/java/com.aspose.threed/renderingapi/
---
...
Vanligt använda renderings-API:er
## Fält

| Fält | Beskrivning |
| --- | --- |
| [ARNOLD](#ARNOLD) | Arnold-renderare |
| [CUSTOM](#CUSTOM) | Anpassat renderings-API |
| [DIRECTX](#DIRECTX) | DirectX |
| [MANTLE](#MANTLE) | AMD Mantle |
| [MENTAL_RAY](#MENTAL-RAY) | MentalRay |
| [METAL](#METAL) | Metal utvecklat av Apple |
| [NONE](#NONE) | Inget renderings-API |
| [OPENGL](#OPENGL) | OpenGL |
| [OPENGLES](#OPENGLES) | OpenGL ES |
| [PREVIEW](#PREVIEW) | PreviewColorAPI, kompatibel med FBX |
| [RENDER_MAN](#RENDER-MAN) | RenderMan |
| [RENDER_WARE](#RENDER-WARE) | RenderWare |
| [SHADERFX](#SHADERFX) | ShaderFX-renderare |
| [STAGE3D](#STAGE3D) | Stage3D används i Adobe Flash |
...
PreviewColorAPI, kompatibel med FBX

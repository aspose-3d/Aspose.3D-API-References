...
description: Sparaalternativ för STL
type: docs
weight: 177
url: /sv/java/com.aspose.threed/stlsaveoptions/
---
...
| --- | --- |
| [StlSaveOptions()](#StlSaveOptions--) | Initierar en ny instans av [StlSaveOptions](../../com.aspose.threed/stlsaveoptions). |
| [StlSaveOptions(FileContentType contentType)](#StlSaveOptions-com.aspose.threed.FileContentType-) | Initierar en ny instans av [StlSaveOptions](../../com.aspose.threed/stlsaveoptions). |
## Metoder
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | Hämtar om koordinatsystemet för kontrollpunkter/normaler ska vändas vid export. |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | Ställer in om koordinatsystemet för kontrollpunkter/normaler ska vändas vid export. |
...
Initierar en ny instans av [StlSaveOptions](../../com.aspose.threed/stlsaveoptions).
...
Hämtar om koordinatsystemet för kontrollpunkter/normaler ska vändas vid export.

**Returns:**
boolean - huruvida koordinatsystemet för kontrollpunkter/normaler ska vändas vid export.
...
Ställer in om koordinatsystemet för kontrollpunkter/normaler ska vändas vid export.

...
description: Basklass för alla primitiver
type: docs
weight: 570
url: /sv/net/aspose.threed.entities/primitive/
---
## Primitive class

Basklass för alla primitiver
...
| namn | Beskrivning |
| --- | --- |
| [Primitive](primitive)(string) | Initierar en ny instans av[`Primitive`](../primitive) class. |
...
| abstract [ToMesh](../../aspose.threed.entities/primitive/tomesh)() | Konvertera aktuellt objekt till mesh |

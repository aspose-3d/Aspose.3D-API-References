...
IFC-kompatibel ihålig rektangulär form med både inre och yttre rundade hörn.
...
| [InnerFilletRadius](../../aspose.threed.profiles/hollowrectangleshape/innerfilletradius) { get; set; } | Innerkälradien för den inre rektangeln. |
...
| [WallThickness](../../aspose.threed.profiles/hollowrectangleshape/wallthickness) { get; set; } | Tjockleken mellan rektangelns gräns och det inre hålet |

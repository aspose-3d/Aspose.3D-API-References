...
| namn | Beskrivning |
| --- | --- |
| [ZShape](zshape)() | Konstruktör av[`ZShape`](../zshape) |

## Egenskaper

| namn | Beskrivning |
| --- | --- |
| [Depth](../../aspose.threed.profiles/zshape/depth) { get; set; } | Hämtar eller ställer in längden på webben. |
| [EdgeRadius](../../aspose.threed.profiles/zshape/edgeradius) { get; set; } | Hämtar eller ställer in radien för flänskanten. |
| [Excluded](../../aspose.threed/entity/excluded) { get; set; } | Hämtar eller ställer in om den här entiteten ska exkluderas under export. |
| [FilletRadius](../../aspose.threed.profiles/zshape/filletradius) { get; set; } | Får eller ställer in kälradien mellan fläns och liv. |
| [FlangeThickness](../../aspose.threed.profiles/zshape/flangethickness) { get; set; } | Hämtar eller ställer in tjockleken på flänsen. |
| [FlangeWidth](../../aspose.threed.profiles/zshape/flangewidth) { get; set; } | Hämtar eller ställer in längden på flänsen. |
...
| [WebThickness](../../aspose.threed.profiles/zshape/webthickness) { get; set; } | Får eller ställer in tjockleken på väggen. |
...
| override [GetExtent](../../aspose.threed.profiles/zshape/getextent)() | Får utsträckningen i x- och y-dimension. |

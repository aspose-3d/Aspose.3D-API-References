...
description: IFCkompatibel Tform definierad av parametrar.
type: docs
weight: 1630
url: /sv/net/aspose.threed.profiles/tshape/
---
## TShape class
...
| namn | Beskrivning |
| --- | --- |
| [TShape](tshape)() | Konstruktör av[`TShape`](../tshape) |

## Egenskaper

| namn | Beskrivning |
| --- | --- |
| [Depth](../../aspose.threed.profiles/tshape/depth) { get; set; } | Hämtar eller ställer in längden på webben. |
| [Excluded](../../aspose.threed/entity/excluded) { get; set; } | Hämtar eller ställer in om den här entiteten ska exkluderas under export. |
| [FilletRadius](../../aspose.threed.profiles/tshape/filletradius) { get; set; } | Får eller ställer in kälradien mellan väv och fläns. |
| [FlangeEdgeRadius](../../aspose.threed.profiles/tshape/flangeedgeradius) { get; set; } | Hämtar eller ställer in radien för flänskanten. |
| [FlangeThickness](../../aspose.threed.profiles/tshape/flangethickness) { get; set; } | Får eller ställer in väggtjockleken på flänsen. |
| [FlangeWidth](../../aspose.threed.profiles/tshape/flangewidth) { get; set; } | Hämtar eller ställer in längden på flänsen. |
...
| [WebEdgeRadius](../../aspose.threed.profiles/tshape/webedgeradius) { get; set; } | Hämtar eller ställer in webbkantens radie. |
| [WebThickness](../../aspose.threed.profiles/tshape/webthickness) { get; set; } | Hämtar eller ställer in väggtjockleken på banan. |
...
| override [GetExtent](../../aspose.threed.profiles/tshape/getextent)() | Får utsträckningen i x- och y-dimension. |

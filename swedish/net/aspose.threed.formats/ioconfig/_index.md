...
| static [FileSystemFactory](../../aspose.threed.formats/ioconfig/filesystemfactory) { get; set; } | Hämtar eller ställer in fabriksklassen för FileSystem. Standardfabriken kommer att skapa[`LocalFileSystem`](../../aspose.threed.utilities/localfilesystem) som inte är lämplig för servermiljö. |

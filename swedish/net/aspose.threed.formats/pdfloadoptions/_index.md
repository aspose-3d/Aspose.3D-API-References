...
description: Alternativ för PDF loading
type: docs
weight: 1250
url: /sv/net/aspose.threed.formats/pdfloadoptions/
---
## PdfLoadOptions class

Alternativ för PDF loading
...
| namn | Beskrivning |
| --- | --- |
| [PdfLoadOptions](pdfloadoptions)() | Konstruktör av[`PdfLoadOptions`](../pdfloadoptions) |
...
| [Password](../../aspose.threed.formats/pdfloadoptions/password) { get; set; } | Lösenordet för att låsa upp den krypterade PDF-filen. |

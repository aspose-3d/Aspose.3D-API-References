...
description: Ladda alternativ för universell 3d
type: docs
weight: 1370
url: /sv/net/aspose.threed.formats/u3dloadoptions/
---
## U3dLoadOptions class

Ladda alternativ för universell 3d
...
| namn | Beskrivning |
| --- | --- |
| [U3dLoadOptions](u3dloadoptions)() | Konstruktör av[`U3dLoadOptions`](../u3dloadoptions) |
...
| [FlipCoordinateSystem](../../aspose.threed.formats/u3dloadoptions/flipcoordinatesystem) { get; set; } | Hämtar eller ställer in om vändningskoordinatsystem för kontrollpunkter/normalt under import/export. |

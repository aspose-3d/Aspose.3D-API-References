...
Ladda alternativ för PLY-filer
...
| namn | Beskrivning |
| --- | --- |
| [PlyLoadOptions](plyloadoptions)() | Konstruktör av[`PlyLoadOptions`](../plyloadoptions) |
...
| [FlipCoordinateSystem](../../aspose.threed.formats/plyloadoptions/flipcoordinatesystem) { get; set; } | Hämtar eller ställer in flip-koordinatsystem för kontrollpunkter/normalt under import/export. |

...
url: /nodejs-java/aspose.threed/circleshape/
---
## CircleShape class
...
| Name | Description |
| --- | --- |
| constructor() | Construct a CircleShape profile with default radius(5). | 
...
| Name | Description |
| --- | --- |
| constructor_overload(radius) | Construct a CircleShape profile with specified radius. | 

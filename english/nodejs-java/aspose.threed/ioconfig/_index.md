...
url: /nodejs-java/aspose.threed/ioconfig/
---
## IOConfig class

  IO config for serialization/deserialization.  User can specify detailed configurations like dependency look-up path  Or format-related configs here  @hideconstructor
...
| Name | Description |
| --- | --- |
| getFileSystemFactory() | Gets or sets the factory class for FileSystem. The default factory will create LocalFileSystem which is not suitable for server environment. | 
...
| Name | Description |
| --- | --- |
| setFileSystemFactory(value) | Gets or sets the factory class for FileSystem. The default factory will create LocalFileSystem which is not suitable for server environment. | 

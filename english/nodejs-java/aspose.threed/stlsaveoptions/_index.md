...
url: /nodejs-java/aspose.threed/stlsaveoptions/
---
...
| Name | Description |
| --- | --- |
| constructor() | Initializes of a new StlSaveOptions instance. | 
...
| Name | Description |
| --- | --- |
| constructor_overload(contentType) | Initializes of a new StlSaveOptions instance. | 
...
| Name | Description |
| --- | --- |
| getFlipCoordinateSystem() | Gets or sets whether flip coordinate system of control points/normal during exporting. | 
...
| Name | Description |
| --- | --- |
| setFlipCoordinateSystem(value) | Gets or sets whether flip coordinate system of control points/normal during exporting. | 

...
url: /nodejs-java/aspose.threed/mirroredprofile/
---
...
| Name | Description |
| --- | --- |
| constructor(baseProfile) | Construct a new MirroredProfile from an existing profile. | 
...
| Name | Description |
| --- | --- |
| getBaseProfile() | The base profile to be mirrored. | 

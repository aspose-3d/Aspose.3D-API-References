...
url: /nodejs-java/aspose.threed/gltfloadoptions/
---
...
| Name | Description |
| --- | --- |
| constructor() | Constructor of GltfLoadOptions | 
...
| Name | Description |
| --- | --- |
| getFlipTexCoordV() | Flip the v(t) coordinate in mesh's texture coordinate, default value is true. | 
...
| Name | Description |
| --- | --- |
| setFlipTexCoordV(value) | Flip the v(t) coordinate in mesh's texture coordinate, default value is true. | 

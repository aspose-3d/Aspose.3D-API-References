...
url: /nodejs-java/aspose.threed/sweptareasolid/
---
...
| Name | Description |
| --- | --- |
| setShape(value) | The base profile to construct the geometry. | 
...
| Name | Description |
| --- | --- |
| setDirectrix(value) | The directrix that the swept area sweeping along with. | 
...
| Name | Description |
| --- | --- |
| setStartPoint(value) | The start point of the directrix. | 
...
| Name | Description |
| --- | --- |
| setEndPoint(value) | The end point of the directrix. | 

...
url: /nodejs-java/aspose.threed/amfsaveoptions/
---
...
| Name | Description |
| --- | --- |
| constructor() | Constructor of AmfSaveOptions | 
...
| Name | Description |
| --- | --- |
| getEnableCompression() | Whether to use compression to reduce the final file size, default value is true | 
...
| Name | Description |
| --- | --- |
| setEnableCompression(value) | Whether to use compression to reduce the final file size, default value is true | 

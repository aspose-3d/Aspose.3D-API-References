...
| --- | --- |
| [Box()](#Box--) | Initializes a new instance of the [Box](../../com.aspose.threed/box) class. |
| [Box(double length, double width, double height)](#Box-double-double-double-) | Initializes a new instance of the [Box](../../com.aspose.threed/box) class. |
| [Box(String name, double length, double width, double height, int lengthSegments, int widthSegments, int heightSegments)](#Box-java.lang.String-double-double-double-int-int-int-) | Initializes a new instance of the [Box](../../com.aspose.threed/box) class. |
## Methods
...
Initializes a new instance of the [Box](../../com.aspose.threed/box) class.
...
**Returns:**
double - the height of the box aligned in y-axis.
...
**Returns:**
int - gets or sets the height segments.
### getLength() {#getLength--}
```
...
**Returns:**
double - the length of the box aligned in z-axis.
...
**Returns:**
double - the width of the box aligned in x-axis.

...
| [getInnerFilletRadius()](#getInnerFilletRadius--) | The inner fillet radius of the inner rectangle. |
...
| [getWallThickness()](#getWallThickness--) | The thickness between the boundary of the rectangle and the inner hole |
...
| [setInnerFilletRadius(double value)](#setInnerFilletRadius-double-) | The inner fillet radius of the inner rectangle. |
...
| [setWallThickness(double value)](#setWallThickness-double-) | The thickness between the boundary of the rectangle and the inner hole |
...
**Returns:**
double - The inner fillet radius of the inner rectangle.
### getName() {#getName--}
```
...
**Returns:**
double - The thickness between the boundary of the rectangle and the inner hole
### getXDim() {#getXDim--}
```

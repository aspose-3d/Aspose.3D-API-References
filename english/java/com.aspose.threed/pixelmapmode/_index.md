...
| Field | Description |
| --- | --- |
| [READ_ONLY](#READ-ONLY) | The pixels are mapped only for reading. |
| [READ_WRITE](#READ-WRITE) | The pixels are mapped for both reading and writing. |
| [WRITE_ONLY](#WRITE-ONLY) | The pixels are mapped only for writing. |
## Methods

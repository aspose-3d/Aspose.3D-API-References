...
| [getLoadPMI()](#getLoadPMI--) | Load PMI information from JT file if possible, the data will be saved as property "PMI" of [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). |
| [getLoadProperties()](#getLoadProperties--) | Load properties from JT's property table as Aspose.3D properties. |
...
| [setLoadPMI(boolean value)](#setLoadPMI-boolean-) | Load PMI information from JT file if possible, the data will be saved as property "PMI" of [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). |
| [setLoadProperties(boolean value)](#setLoadProperties-boolean-) | Load properties from JT's property table as Aspose.3D properties. |
...
**Returns:**
boolean - Load PMI information from JT file if possible, the data will be saved as property "PMI" of [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). Default value is false.
...
**Returns:**
boolean - Load properties from JT's property table as Aspose.3D properties. Default value is false.

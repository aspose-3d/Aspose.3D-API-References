...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | Sets whether flip coordinate system of control points/normal during importing |
...
**Returns:**
boolean - whether import materials for each object
...
**Returns:**
boolean - whether flip coordinate system of control points/normal during importing
...
**Returns:**
boolean - whether to normalize the normal vector during the loading. Default value is true.
### getScale() {#getScale--}
```
...
**Returns:**
double - Scales on x/y/z axis, default value is 1.0
### hashCode() {#hashCode--}
```

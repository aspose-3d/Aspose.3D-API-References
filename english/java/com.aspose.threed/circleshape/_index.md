...
IFC compatible circle profile, which can be used to construct a mesh through [LinearExtrusion](../../com.aspose.threed/linearextrusion)
## Constructors

| Constructor | Description |
| --- | --- |
| [CircleShape()](#CircleShape--) | Construct a [CircleShape](../../com.aspose.threed/circleshape) profile with default radius(5). |
| [CircleShape(double radius)](#CircleShape-double-) | Construct a [CircleShape](../../com.aspose.threed/circleshape) profile with specified radius. |
## Methods
...
Construct a [CircleShape](../../com.aspose.threed/circleshape) profile with default radius(5).
...
Construct a [CircleShape](../../com.aspose.threed/circleshape) profile with specified radius.

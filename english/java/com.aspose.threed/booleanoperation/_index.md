...
| Field | Description |
| --- | --- |
| [ADD](#ADD) | Add two meshes and calculate the union of the inputs. |
| [INTERSECT](#INTERSECT) | Calculate the intersection of two meshes. |
| [SUB](#SUB) | Subtract one mesh from another mesh, calculate the difference of the inputs. |
## Methods

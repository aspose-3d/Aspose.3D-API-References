...
| --- | --- |
| [PdfLoadOptions()](#PdfLoadOptions--) | Constructor of [PdfLoadOptions](../../com.aspose.threed/pdfloadoptions) |
## Methods
...
| [getPassword()](#getPassword--) | The password to unlock the encrypted PDF file. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setPassword(byte[] value)](#setPassword-byte---) | The password to unlock the encrypted PDF file. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Constructor of [PdfLoadOptions](../../com.aspose.threed/pdfloadoptions)
...
**Returns:**
byte[] - The password to unlock the encrypted PDF file.
### hashCode() {#hashCode--}
```

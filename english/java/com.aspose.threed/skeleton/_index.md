...
The [Skeleton](../../com.aspose.threed/skeleton) is mainly used by CAD software to help designer to manipulate the transformation of skeletal structure, it's usually useless outside the CAD softwares. To make the skeleton hierarchy acts like one object in CAD software, it's necessary to mark the top [Skeleton](../../com.aspose.threed/skeleton) node as the root one by setting [getType](../../com.aspose.threed/skeleton\#getType) to [SkeletonType.SKELETON](../../com.aspose.threed/skeletontype\#SKELETON), and all children set to [SkeletonType.BONE](../../com.aspose.threed/skeletontype\#BONE)
## Constructors

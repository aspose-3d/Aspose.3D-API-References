...
| [BindPoint](../com.aspose.threed/bindpoint) | A com.aspose.threed.BindPoint is usually created on an object's property, some property types contains multiple component fields(like a Vector3 field), com.aspose.threed.BindPoint will generate channel for each component field and connects the field to one or more keyframe sequence instance(s) through the channels. |
...
| [BonePose](../com.aspose.threed/bonepose) | The com.aspose.threed.BonePose contains the transformation matrix for a bone node |
| [BoundingBox](../com.aspose.threed/boundingbox) | The axis-aligned bounding box |
| [BoundingBox2D](../com.aspose.threed/boundingbox2d) | The axis-aligned bounding box for com.aspose.threed.Vector2 |
...
| [Circle](../com.aspose.threed/circle) | A com.aspose.threed.Circle curve consists of a set of points in the edge of the circle shape. |
| [CircleShape](../com.aspose.threed/circleshape) | IFC compatible circle profile, which can be used to construct a mesh through com.aspose.threed.LinearExtrusion |
| [ColladaSaveOptions](../com.aspose.threed/colladasaveoptions) | Save options for collada |
| [CompositeCurve](../com.aspose.threed/compositecurve) | A com.aspose.threed.CompositeCurve is consisting of several curve segments. |
...
| [Deformer](../com.aspose.threed/deformer) | Base class for com.aspose.threed.SkinDeformer and com.aspose.threed.MorphTargetDeformer |
| [DescriptorSetUpdater](../com.aspose.threed/descriptorsetupdater) | This class allows to update the com.aspose.threed.IDescriptorSet in a chain operation. |
...
| [Ellipse](../com.aspose.threed/ellipse) | An com.aspose.threed.Ellipse defines a set of points that form the shape of ellipse. |
...
| [Frustum](../com.aspose.threed/frustum) | The base class of com.aspose.threed.Camera and com.aspose.threed.Light |
| [GLSLSource](../com.aspose.threed/glslsource) | The source code of shaders in GLSL |
| [Geometry](../com.aspose.threed/geometry) | The base class of all renderable geometric objects (like com.aspose.threed.Mesh, com.aspose.threed.NurbsSurface, com.aspose.threed.Patch and etc.). |
| [GlobalTransform](../com.aspose.threed/globaltransform) | Global transform is similar to com.aspose.threed.Transform but it's immutable while it represents the final evaluated transformation. |
...
| [HShape](../com.aspose.threed/hshape) | The com.aspose.threed.HShape provides the defining parameters of an 'H' or 'I' shape. |
...
| [ImageRenderOptions](../com.aspose.threed/imagerenderoptions) | Options for com.aspose.threed.Scene and com.aspose.threed.Scene |
...
| [Line](../com.aspose.threed/line) | A polyline is a path defined by a set of points with com.aspose.threed.Geometry\#getControlPoints, and connected by com.aspose.threed.Line\#getSegments, which means it can also be a set of connected line segments. |
...
| [LocalFileSystem](../com.aspose.threed/localfilesystem) | The com.aspose.threed.LocalFileSystem will maps the read/write operations to local directory. |
...
| [MemoryFileSystem](../com.aspose.threed/memoryfilesystem) | The com.aspose.threed.MemoryFileSystem will maps the read/write operations to memory. |
...
| [Patch](../com.aspose.threed/patch) | A com.aspose.threed.Patch is a parametric modeling surface, similar to com.aspose.threed.NurbsSurface, it's also defined by two com.aspose.threed.PatchDirection, the com.aspose.threed.Patch\#getU and com.aspose.threed.Patch\#getV. |
...
| [PolygonBuilder](../com.aspose.threed/polygonbuilder) | A helper class to build polygon for com.aspose.threed.Mesh |
...
| [Skeleton](../com.aspose.threed/skeleton) | The com.aspose.threed.Skeleton is mainly used by CAD software to help designer to manipulate the transformation of skeletal structure, it's usually useless outside the CAD softwares. |
...
| [SweptAreaSolid](../com.aspose.threed/sweptareasolid) | A com.aspose.threed.SweptAreaSolid constructs a geometry by sweeping a profile along a directrix. |
...
| [TextureSlot](../com.aspose.threed/textureslot) | Texture slot in com.aspose.threed.Material, can be enumerated through material instance. |
...
| [TransformBuilder](../com.aspose.threed/transformbuilder) | The com.aspose.threed.TransformBuilder is used to build transform matrix by a chain of transformations. |
| [TransformedCurve](../com.aspose.threed/transformedcurve) | A com.aspose.threed.TransformedCurve gives a curve a placement by using a transformation matrix. |
...
| [Vertex](../com.aspose.threed/vertex) | Vertex reference, used to access the raw vertex in com.aspose.threed.TriMesh. |
...
| [VertexElementDoublesTemplate](../com.aspose.threed/vertexelementdoublestemplate) | A helper class for defining concrete com.aspose.threed.VertexElement implementations. |
...
| [VertexElementIntsTemplate](../com.aspose.threed/vertexelementintstemplate) | A helper class for defining concrete com.aspose.threed.VertexElement implementations. |
...
| [VertexElementTemplate<T>](../com.aspose.threed/vertexelementtemplate) | A helper class for defining concrete com.aspose.threed.VertexElement implementations. |
...
| [VertexElementVector4](../com.aspose.threed/vertexelementvector4) | A helper class for defining concrete com.aspose.threed.VertexElement implementations. |
...
| [Viewport](../com.aspose.threed/viewport) | A com.aspose.threed.IRenderTarget contains at least one viewport for rendering the scene. |
...
| --- | --- |
| [FileSystemFactory](../com.aspose.threed/filesystemfactory) | com.aspose.threed.SaveOptions and com.aspose.threed.LoadOptions will create a com.aspose.threed.LocalFileSystem for default. |
...
| [IMeshConvertible](../com.aspose.threed/imeshconvertible) | Entities that implemented this interface can be converted to com.aspose.threed.Mesh |
...
| [ITextureUnit](../com.aspose.threed/itextureunit) | com.aspose.threed.ITextureUnit represents a texture in the memory that shared between GPU and CPU and can be sampled by the shader, where the com.aspose.threed.Texture only represents a reference to an external file. |
...
| [IndexDataType](../com.aspose.threed/indexdatatype) | The data type of the elements in com.aspose.threed.IIndexBuffer |
...
| [ReferenceMode](../com.aspose.threed/referencemode) | com.aspose.threed.ReferenceMode defines how mapping information is stored and referenced by. |
...
| [TextureMapping](../com.aspose.threed/texturemapping) | The texture mapping type for com.aspose.threed.VertexElementUV Describes which kind of texture mapping is used. |
| [TextureType](../com.aspose.threed/texturetype) | The type of the com.aspose.threed.ITextureUnit |

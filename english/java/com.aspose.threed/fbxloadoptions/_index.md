...
| --- | --- |
| [FbxLoadOptions(FileFormat format)](#FbxLoadOptions-com.aspose.threed.FileFormat-) | Constructor of [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions) |
| [FbxLoadOptions()](#FbxLoadOptions--) | Constructor of [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions) |
## Methods
...
| [getClass()](#getClass--) |  |
| [getCompatibleMode()](#getCompatibleMode--) | Gets whether to enable compatible mode. |
...
| [getKeepBuiltinGlobalSettings()](#getKeepBuiltinGlobalSettings--) | Gets whether to keep the builtin properties in GlobalSettings which have a native property replacement in [AssetInfo](../../com.aspose.threed/assetinfo). |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setCompatibleMode(boolean value)](#setCompatibleMode-boolean-) | Sets whether to enable compatible mode. |
...
| [setKeepBuiltinGlobalSettings(boolean value)](#setKeepBuiltinGlobalSettings-boolean-) | Sets whether to keep the builtin properties in GlobalSettings which have a native property replacement in [AssetInfo](../../com.aspose.threed/assetinfo). |
...
Constructor of [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions)

**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| format | [FileFormat](../../com.aspose.threed/fileformat) | Instance of [getFileFormat](../../com.aspose.threed/fbxloadoptions\#getFileFormat), it should be a valid FBX format. |
...
Gets whether to enable compatible mode. Compatible mode will try to support non-standard FBX definitions like PBR materials exported by Blender. Default value is false.

**Returns:**
boolean - whether to enable compatible mode. Compatible mode will try to support non-standard FBX definitions like PBR materials exported by Blender. Default value is false.
...
Gets whether to keep the builtin properties in GlobalSettings which have a native property replacement in [AssetInfo](../../com.aspose.threed/assetinfo). Set this to true if you want the full properties in GlobalSettings Default value is false

**Returns:**
boolean - whether to keep the builtin properties in GlobalSettings which have a native property replacement in [AssetInfo](../../com.aspose.threed/assetinfo). Set this to true if you want the full properties in GlobalSettings Default value is false
...
Sets whether to enable compatible mode. Compatible mode will try to support non-standard FBX definitions like PBR materials exported by Blender. Default value is false.
...
Sets whether to keep the builtin properties in GlobalSettings which have a native property replacement in [AssetInfo](../../com.aspose.threed/assetinfo). Set this to true if you want the full properties in GlobalSettings Default value is false

...
| --- | --- |
| [MirroredProfile(Profile baseProfile)](#MirroredProfile-com.aspose.threed.Profile-) | Construct a new [MirroredProfile](../../com.aspose.threed/mirroredprofile) from an existing profile. |
## Methods
...
| [getBaseProfile()](#getBaseProfile--) | The base profile to be mirrored. |
...
Construct a new [MirroredProfile](../../com.aspose.threed/mirroredprofile) from an existing profile.

**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| baseProfile | [Profile](../../com.aspose.threed/profile) | The base profile to be mirrored. |

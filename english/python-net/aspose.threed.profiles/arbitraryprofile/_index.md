...
type: docs
weight: 10
url: /aspose.threed.profiles/arbitraryprofile/
is_root: false
---
...
| :- | :- |
| [__init__](/3d/python-net/aspose.threed.profiles/arbitraryprofile/__init__/#) | Constructor of [`ArbitraryProfile`](/3d/python-net/aspose.threed.profiles/arbitraryprofile) |
| [__init__](/3d/python-net/aspose.threed.profiles/arbitraryprofile/__init__/#aspose.threed.entities.Curve) | Constructor of [`ArbitraryProfile`](/3d/python-net/aspose.threed.profiles/arbitraryprofile) with an initial curve. |
...
| Method | Description |
| :- | :- |
| [remove_property](/3d/python-net/aspose.threed.profiles/arbitraryprofile/remove_property/#aspose.threed.Property) | Removes a dynamic property. |
| [remove_property](/3d/python-net/aspose.threed.profiles/arbitraryprofile/remove_property/#str) | Remove the specified property identified by name |
| [get_property](/3d/python-net/aspose.threed.profiles/arbitraryprofile/get_property/#str) | Get the value of specified property |
| [set_property](/3d/python-net/aspose.threed.profiles/arbitraryprofile/set_property/#str-any) | Sets the value of specified property |
| [find_property](/3d/python-net/aspose.threed.profiles/arbitraryprofile/find_property/#str) | Finds the property.<br/>It can be a dynamic property (Created by CreateDynamicProperty/SetProperty) <br/>or native property(Identified by its name) |

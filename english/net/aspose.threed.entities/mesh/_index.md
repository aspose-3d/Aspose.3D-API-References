...
| [CreatePolygon](../../aspose.threed.entities/mesh/createpolygon)(int[]) | Creates a new polygon with all vertices defined in *indices*. To create polygon vertex by vertex, please use [`PolygonBuilder`](../polygonbuilder). |
| [CreatePolygon](../../aspose.threed.entities/mesh/createpolygon)(int, int, int) | Create a polygon with 3 vertices(triangle) |
| [CreatePolygon](../../aspose.threed.entities/mesh/createpolygon)(int[], int, int) | Creates a new polygon with all vertices defined in *indices*. To create polygon vertex by vertex, please use [`PolygonBuilder`](../polygonbuilder). |
| [CreatePolygon](../../aspose.threed.entities/mesh/createpolygon)(int, int, int, int) | Create a polygon with 4 vertices(quad) |

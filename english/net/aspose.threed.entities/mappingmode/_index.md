...
Determines how the element is mapped to a surface. The [`MappingMode`](../mappingmode) defined how [`VertexElement`](../vertexelement) is mapped to the surface of geometry.

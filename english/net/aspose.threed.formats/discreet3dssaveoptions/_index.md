...
| Name | Description |
| --- | --- |
| [Discreet3dsSaveOptions](discreet3dssaveoptions)() | Constructor of [`Discreet3dsSaveOptions`](../discreet3dssaveoptions) |

## Properties

| Name | Description |
| --- | --- |
| [DuplicatedNameCounterBase](duplicatednamecounterbase) { get; set; } | The counter used by generating new name for duplicated names, default value is 2. |
| [DuplicatedNameCounterFormat](duplicatednamecounterformat) { get; set; } | The format of the duplicated counter, default value is empty string. |
| [DuplicatedNameSeparator](duplicatednameseparator) { get; set; } | The separator between object's name and the duplicated counter, default value is "_". When scene contains objects that use the same name, Aspose.3D 3DS exporter will generate a different name for the object. For example there's two nodes named "Box", the first node will have a name "Box", and the second node will get a new name "Box_2" using the default configuration. |
...
| [ExportCamera](exportcamera) { get; set; } | Gets or sets whether export all cameras in the scene. |
| [ExportLight](exportlight) { get; set; } | Gets or sets whether export all lights in the scene. |
...
| [MasterScale](masterscale) { get; set; } | Gets or sets the master scale used in exporting. |

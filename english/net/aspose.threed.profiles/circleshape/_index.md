...
| Name | Description |
| --- | --- |
| [CircleShape](circleshape/#constructor)() | Construct a `CircleShape` profile with default radius(5). |
| [CircleShape](circleshape/#constructor_1)(double) | Construct a `CircleShape` profile with specified radius. |

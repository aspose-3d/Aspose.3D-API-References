...
description: Profilo a forma di C compatibile IFC definito dai parametri. La posizione centrale del profilo è al centro del riquadro di delimitazione.
type: docs
weight: 1520
url: /it/net/aspose.threed.profiles/cshape/
---
## CShape class

Profilo a forma di C compatibile IFC definito dai parametri. La posizione centrale del profilo è al centro del riquadro di delimitazione.
...
| Nome | Descrizione |
| --- | --- |
| [CShape](cshape)() | Costruttore di[`CShape`](../cshape) |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [Depth](../../aspose.threed.profiles/cshape/depth) { get; set; } | Ottiene o imposta la profondità del profilo. |
| [Excluded](../../aspose.threed/entity/excluded) { get; set; } | Ottiene o imposta se escludere questa entità durante l'esportazione. |
| [Girth](../../aspose.threed.profiles/cshape/girth) { get; set; } | Ottiene o imposta la lunghezza della circonferenza. |
| [InternalFilletRadius](../../aspose.threed.profiles/cshape/internalfilletradius) { get; set; } | Ottiene o imposta il raggio di raccordo interno. |
...
| [WallThickness](../../aspose.threed.profiles/cshape/wallthickness) { get; set; } | Ottiene o imposta lo spessore del muro. |
| [Width](../../aspose.threed.profiles/cshape/width) { get; set; } | Ottiene o imposta la larghezza del profilo. |
...
| override [GetExtent](../../aspose.threed.profiles/cshape/getextent)() | Ottiene l'estensione nella dimensione xey. |

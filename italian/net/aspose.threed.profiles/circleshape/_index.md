...
description: Profilo circolare compatibile IFC che può essere utilizzato per costruire una mesh attraversoLinearExtrusion../aspose.threed.entities/linearextrusion
type: docs
weight: 1530
url: /it/net/aspose.threed.profiles/circleshape/
---
## CircleShape class

Profilo circolare compatibile IFC, che può essere utilizzato per costruire una mesh attraverso[`LinearExtrusion`](../../aspose.threed.entities/linearextrusion)
...
| Nome | Descrizione |
| --- | --- |
| [CircleShape](circleshape#constructor)() | Costruisci a[`CircleShape`](../circleshape) profilo con raggio predefinito(5). |
| [CircleShape](circleshape#constructor_1)(double) | Costruisci a[`CircleShape`](../circleshape) profilo con raggio specificato. |
...
| [Radius](../../aspose.threed.profiles/circleshape/radius) { get; set; } | Ottiene o imposta il raggio del cerchio. |
...
| override [GetExtent](../../aspose.threed.profiles/circleshape/getextent)() | Ottiene l'estensione nella dimensione xey. |

...
description: Profilo a forma Z compatibile IFC definito dai parametri.
type: docs
weight: 1660
url: /it/net/aspose.threed.profiles/zshape/
---
## ZShape class
...
| Nome | Descrizione |
| --- | --- |
| [ZShape](zshape)() | Costruttore di[`ZShape`](../zshape) |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [Depth](../../aspose.threed.profiles/zshape/depth) { get; set; } | Ottiene o imposta la lunghezza del web. |
| [EdgeRadius](../../aspose.threed.profiles/zshape/edgeradius) { get; set; } | Ottiene o imposta il raggio del bordo della flangia. |
| [Excluded](../../aspose.threed/entity/excluded) { get; set; } | Ottiene o imposta se escludere questa entità durante l'esportazione. |
| [FilletRadius](../../aspose.threed.profiles/zshape/filletradius) { get; set; } | Ottiene o imposta il raggio del raccordo tra flangia e anima. |
| [FlangeThickness](../../aspose.threed.profiles/zshape/flangethickness) { get; set; } | Ottiene o imposta lo spessore della flangia. |
| [FlangeWidth](../../aspose.threed.profiles/zshape/flangewidth) { get; set; } | Ottiene o imposta la lunghezza della flangia. |
...
| [WebThickness](../../aspose.threed.profiles/zshape/webthickness) { get; set; } | Ottiene o imposta lo spessore del muro. |
...
| override [GetExtent](../../aspose.threed.profiles/zshape/getextent)() | Ottiene l'estensione nella dimensione xey. |

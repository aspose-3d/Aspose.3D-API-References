...
description: Profilo specchio compatibile IFC. Questo profilo definisce un nuovo profilo specchiando il profilo di base attorno allasse y.
type: docs
weight: 1590
url: /it/net/aspose.threed.profiles/mirroredprofile/
---
## MirroredProfile class

Profilo specchio compatibile IFC. Questo profilo definisce un nuovo profilo specchiando il profilo di base attorno all'asse y.
...
| Nome | Descrizione |
| --- | --- |
| [MirroredProfile](mirroredprofile)(Profile) | Costruisci un nuovo[`MirroredProfile`](../mirroredprofile) da un profilo esistente. |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [BaseProfile](../../aspose.threed.profiles/mirroredprofile/baseprofile) { get; } | Il profilo di base da specchiare. |

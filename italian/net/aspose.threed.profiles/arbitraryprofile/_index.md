...
type: docs
weight: 1510
url: /it/net/aspose.threed.profiles/arbitraryprofile/
---
...
| Nome | Descrizione |
| --- | --- |
| [ArbitraryProfile](arbitraryprofile#constructor)() | Costruttore di[`ArbitraryProfile`](../arbitraryprofile) |
| [ArbitraryProfile](arbitraryprofile#constructor_1)(Curve) | Costruttore di[`ArbitraryProfile`](../arbitraryprofile) con una curva iniziale. |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [Curve](../../aspose.threed.profiles/arbitraryprofile/curve) { get; set; } | La curva utilizzata per costruire il profilo |

...
description: Forma ellittica compatibile IFC definita dai parametri. La posizione centrale del profilo è al centro del riquadro di delimitazione.
type: docs
weight: 1540
url: /it/net/aspose.threed.profiles/ellipseshape/
---
## EllipseShape class

Forma ellittica compatibile IFC definita dai parametri. La posizione centrale del profilo è al centro del riquadro di delimitazione.
...
| Nome | Descrizione |
| --- | --- |
| [EllipseShape](ellipseshape)() | Default_Costruttore |
...
| [SemiAxis1](../../aspose.threed.profiles/ellipseshape/semiaxis1) { get; set; } | Ottiene o imposta il primo raggio dell'ellisse misurato nella direzione dell'asse x. |
| [SemiAxis2](../../aspose.threed.profiles/ellipseshape/semiaxis2) { get; set; } | Ottiene o imposta il secondo raggio dell'ellisse misurato nella direzione dell'asse y. |
...
| override [GetExtent](../../aspose.threed.profiles/ellipseshape/getextent)() | Ottiene l'estensione nella dimensione xey. |

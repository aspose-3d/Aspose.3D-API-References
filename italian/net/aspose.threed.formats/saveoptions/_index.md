...
description: La classe base per configurare le opzioni nel salvataggio dei file per diversi tipi
type: docs
weight: 1340
url: /it/net/aspose.threed.formats/saveoptions/
---
## SaveOptions class

La classe base per configurare le opzioni nel salvataggio dei file per diversi tipi

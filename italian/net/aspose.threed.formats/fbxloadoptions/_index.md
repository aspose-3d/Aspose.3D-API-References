...
description: Carica opzioni per il formato Fbx.
type: docs
weight: 1110
url: /it/net/aspose.threed.formats/fbxloadoptions/
---
## FbxLoadOptions class

Carica opzioni per il formato Fbx.
...
| Nome | Descrizione |
| --- | --- |
| [FbxLoadOptions](fbxloadoptions#constructor)() | Costruttore di[`FbxLoadOptions`](../fbxloadoptions) |
| [FbxLoadOptions](fbxloadoptions#constructor_1)(FileFormat) | Costruttore di[`FbxLoadOptions`](../fbxloadoptions) |
...
| [KeepBuiltinGlobalSettings](../../aspose.threed.formats/fbxloadoptions/keepbuiltinglobalsettings) { get; set; } | Ottiene o imposta se mantenere le proprietà integrate in GlobalSettings che hanno una sostituzione di proprietà nativa in[`AssetInfo`](../../aspose.threed/assetinfo) . Impostalo su true se vuoi le proprietà complete in GlobalSettings Il valore predefinito è false |

...
description: Opzioni per il caricamento del PDF
type: docs
weight: 1250
url: /it/net/aspose.threed.formats/pdfloadoptions/
---
## PdfLoadOptions class

Opzioni per il caricamento del PDF
...
| Nome | Descrizione |
| --- | --- |
| [PdfLoadOptions](pdfloadoptions)() | Costruttore di[`PdfLoadOptions`](../pdfloadoptions) |
...
| [Password](../../aspose.threed.formats/pdfloadoptions/password) { get; set; } | La password per sbloccare il file PDF crittografato. |

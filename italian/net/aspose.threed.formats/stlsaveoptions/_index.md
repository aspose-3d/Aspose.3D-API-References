...
description: Salva opzioni per STL
type: docs
weight: 1360
url: /it/net/aspose.threed.formats/stlsaveoptions/
---
## StlSaveOptions class

Salva opzioni per STL
...
| Nome | Descrizione |
| --- | --- |
| [StlSaveOptions](stlsaveoptions#constructor)() | Inizializza di un nuovo[`StlSaveOptions`](../stlsaveoptions) istanza. |
| [StlSaveOptions](stlsaveoptions#constructor_1)(FileContentType) | Inizializza di un nuovo[`StlSaveOptions`](../stlsaveoptions) istanza. |
...
| [FlipCoordinateSystem](../../aspose.threed.formats/stlsaveoptions/flipcoordinatesystem) { get; set; } | Ottiene o imposta se capovolgere il sistema di coordinate dei punti di controllo/normali durante l'esportazione. |

...
description: Un TriMesh contiene dati grezzi che possono essere utilizzati direttamente dalla GPU. Questa classe è unutilità per aiutare a costruire una mesh che contiene solo dati per vertice.
type: docs
weight: 730
url: /it/net/aspose.threed.entities/trimesh/
---
## TriMesh class
...
| Nome | Descrizione |
| --- | --- |
| [TriMesh](trimesh)(string, VertexDeclaration) | Inizializza un'istanza di[`TriMesh`](../trimesh) |
...
| [UnmergedVerticesCount](../../aspose.threed.entities/trimesh/unmergedverticescount) { get; } | Il conteggio dei vertici non uniti che sono passati[`BeginVertex`](./beginvertex) e[`EndVertex`](./endvertex) . |
...
| Nome | Descrizione |
| --- | --- |
| static [CopyFrom](../../aspose.threed.entities/trimesh/copyfrom)(TriMesh, VertexDeclaration) | Copia il[`TriMesh`](../trimesh)dall'input con il nuovo layout dei vertici |
| static [FromMesh](../../aspose.threed.entities/trimesh/frommesh#frommesh)(Mesh, bool) | Crea un TriMesh da un dato oggetto mesh, la dichiarazione dei vertici si basa sulla struttura della mesh di input. |
| static [FromMesh](../../aspose.threed.entities/trimesh/frommesh#frommesh_1)(VertexDeclaration, Mesh) | Crea un TriMesh da un dato oggetto mesh con un dato layout dei vertici. |
| static [FromRawData](../../aspose.threed.entities/trimesh/fromrawdata)(VertexDeclaration, byte[], int[], bool) | Crea TriMesh da dati grezzi |

...
description: IlSkeleton./skeletonviene utilizzato principalmente dal software CAD per aiutare il progettista a manipolare la trasformazione della struttura scheletrica di solito è inutile al di fuori dei software CAD. Per fare in modo che la gerarchia dello scheletro agisca come un oggetto nel software CAD è necessario contrassegnare la parte superioreSkeleton./skeleton nodo come quello principale impostandoType./skeleton/type aSkeleton  e tutti i bambini impostati suBone
type: docs
weight: 650
url: /it/net/aspose.threed.entities/skeleton/
---
## Skeleton class

Il[`Skeleton`](../skeleton)viene utilizzato principalmente dal software CAD per aiutare il progettista a manipolare la trasformazione della struttura scheletrica, di solito è inutile al di fuori dei software CAD. Per fare in modo che la gerarchia dello scheletro agisca come un oggetto nel software CAD, è necessario contrassegnare la parte superiore[`Skeleton`](../skeleton) nodo come quello principale impostando[`Type`](./type) aSkeleton , e tutti i bambini impostati suBone
...
| Nome | Descrizione |
| --- | --- |
| [Skeleton](skeleton#constructor)() | Inizializza una nuova istanza di[`Skeleton`](../skeleton) classe. |
| [Skeleton](skeleton#constructor_1)(string) | Inizializza una nuova istanza di[`Skeleton`](../skeleton) classe. |
...
| [Size](../../aspose.threed.entities/skeleton/size) { get; set; } | Ottiene o imposta la dimensione del nodo dell'arto utilizzata nel software CAD per rappresentare la dimensione dell'osso. |
| [Type](../../aspose.threed.entities/skeleton/type) { get; set; } | Ottiene o imposta il tipo dello scheletro. |

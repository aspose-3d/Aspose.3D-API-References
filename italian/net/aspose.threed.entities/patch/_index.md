...
description: APatch./patch è una superficie di modellazione parametrica simile aNurbsSurface./nurbssurface  è anche definito da due PatchDirection./patchdirection  ilU./patch/u eV./patch/v . Ma differenza traPatch./patch eNurbsSurface./nurbssurface è che ilPatchDirection./patchdirection la curva può essere una diBezier QuadraticBezier BasisSpline CardinalSpline eLinear
type: docs
weight: 500
url: /it/net/aspose.threed.entities/patch/
---
## Patch class

A[`Patch`](../patch) è una superficie di modellazione parametrica, simile a[`NurbsSurface`](../nurbssurface) , è anche definito da due [`PatchDirection`](../patchdirection) , il[`U`](./u) e[`V`](./v) . Ma differenza tra[`Patch`](../patch) e[`NurbsSurface`](../nurbssurface) è che il[`PatchDirection`](../patchdirection) la curva può essere una diBezier ,QuadraticBezier ,BasisSpline ,CardinalSpline eLinear
...
| Nome | Descrizione |
| --- | --- |
| [Patch](patch#constructor)() | Inizializza una nuova istanza di[`Patch`](../patch) classe. |
| [Patch](patch#constructor_1)(string) | Inizializza una nuova istanza di[`Patch`](../patch) classe. |
...
| [U](../../aspose.threed.entities/patch/u) { get; } | Ottiene la direzione u. |
| [V](../../aspose.threed.entities/patch/v) { get; } | Ottiene la direzione v. |

...
description: ACircle./circle la curva consiste in un insieme di punti nel bordo della forma del cerchio.
type: docs
weight: 260
url: /it/net/aspose.threed.entities/circle/
---
## Circle class

A[`Circle`](../circle) la curva consiste in un insieme di punti nel bordo della forma del cerchio.
...
| Nome | Descrizione |
| --- | --- |
| [Circle](circle#constructor)() | Costruttore di[`Circle`](../circle) |
| [Circle](circle#constructor_1)(double) | Costruttore di[`Circle`](../circle) |
...
| [Radius](../../aspose.threed.entities/circle/radius) { get; set; } | Il raggio della curva del cerchio, il valore predefinito è 10 |

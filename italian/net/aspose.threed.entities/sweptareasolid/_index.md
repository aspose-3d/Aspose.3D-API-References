...
description: ASweptAreaSolid./sweptareasolid costruisce una geometria facendo scorrere un profilo lungo una direttrice.
type: docs
weight: 690
url: /it/net/aspose.threed.entities/sweptareasolid/
---
## SweptAreaSolid class

A[`SweptAreaSolid`](../sweptareasolid) costruisce una geometria facendo scorrere un profilo lungo una direttrice.
...
| Nome | Descrizione |
| --- | --- |
| [SweptAreaSolid](sweptareasolid)() | Default_Costruttore |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [Directrix](../../aspose.threed.entities/sweptareasolid/directrix) { get; set; } | La direttrice con cui l'area spazzata ha spazzato via. |
| [EndPoint](../../aspose.threed.entities/sweptareasolid/endpoint) { get; set; } | Il punto finale della direttrice. |
...
| [Shape](../../aspose.threed.entities/sweptareasolid/shape) { get; set; } | Il profilo di base per costruire la geometria. |
| [StartPoint](../../aspose.threed.entities/sweptareasolid/startpoint) { get; set; } | Il punto iniziale della direttrice. |
...
| [ToMesh](../../aspose.threed.entities/sweptareasolid/tomesh)() | Converti l'oggetto corrente in mesh |

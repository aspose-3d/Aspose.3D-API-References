...
description: La classe base di tutte le entità. Entity rappresenta un oggetto concreto che è attaccato sotto un nodo comeLight../aspose.threed.entities/light/Geometry../aspose.threed.entities/geometry .
type: docs
weight: 970
url: /it/net/aspose.threed/entity/
---
## Entity class

La classe base di tutte le entità. Entity rappresenta un oggetto concreto che è attaccato sotto un nodo come[`Light`](../../aspose.threed.entities/light)/[`Geometry`](../../aspose.threed.entities/geometry) .
...
| Nome | Descrizione |
| --- | --- |
| [Entity](entity)(string) | Inizializza una nuova istanza di[`Entity`](../entity) classe. |

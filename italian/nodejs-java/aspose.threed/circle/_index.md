...
url: /it/nodejs-java/aspose.threed/circle/
---
## Circle class

Una curva Circle è composta da un insieme di punti sul bordo della forma circolare.
...
| Nome | Descrizione |
| --- | --- |
| constructor() | Costruttore di Circle |
...
| Nome | Descrizione |
| --- | --- |
| constructor_overload(radius) | Costruttore di Circle |

 **Parameters:**

| Nome | Tipo | Descrizione |
| --- | --- | --- |
| raggio | Numero | Il raggio della curva del cerchio. |
...
| Nome | Descrizione |
| --- | --- |
| getRadius() | Il raggio della curva del cerchio, il valore predefinito è 10 |
...
| Nome | Descrizione |
| --- | --- |
| setRadius(value) | Il raggio della curva del cerchio, il valore predefinito è 10 |

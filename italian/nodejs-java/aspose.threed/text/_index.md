...
url: /it/nodejs-java/aspose.threed/text/
---
## Text class

Profilo di testo, questo profilo descrive i contorni usando caratteri e testo.
...
| Nome | Descrizione |
| --- | --- |
| getContent() | Contenuto del testo |
...
| Nome | Descrizione |
| --- | --- |
| setContent(value) | Contenuto del testo |
...
| Nome | Descrizione |
| --- | --- |
| setFont(value) | Il font del testo. |
...
| Nome | Descrizione |
| --- | --- |
| getFontSize() | Scala della dimensione del font. |
...
| Nome | Descrizione |
| --- | --- |
| setFontSize(value) | Scala della dimensione del font. |

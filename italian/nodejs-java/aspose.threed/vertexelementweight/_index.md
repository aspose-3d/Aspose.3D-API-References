...
url: /it/nodejs-java/aspose.threed/vertexelementweight/
---
## VertexElementWeight class

Definisce il peso di fusione per le componenti specificate.
...
| Nome | Descrizione |
| --- | --- |
| constructor() | Inizializza una nuova istanza della classe VertexElementWeight. |

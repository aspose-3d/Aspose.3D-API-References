...
url: /it/nodejs-java/aspose.threed/ellipse/
---
## Ellipse class

Un'Ellisse definisce un insieme di punti che formano la forma di un'ellisse.
...
| Nome | Descrizione |
| --- | --- |
| constructor() | Costruttore di Ellisse |
...
| Nome | Descrizione |
| --- | --- |
| constructor_overload(semiAxis1, semiAxis2) | Costruttore di Ellisse |
...
| Nome | Descrizione |
| --- | --- |
| getSemiAxis1() | Raggio sull'asse X |
...
| Nome | Descrizione |
| --- | --- |
| setSemiAxis1(value) | Raggio sull'asse X |
...
| Nome | Descrizione |
| --- | --- |
| getSemiAxis2() | Raggio sull'asse Y |
...
| Nome | Descrizione |
| --- | --- |
| setSemiAxis2(value) | Raggio sull'asse Y |

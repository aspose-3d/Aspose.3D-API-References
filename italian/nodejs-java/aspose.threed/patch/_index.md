...
url: /it/nodejs-java/aspose.threed/patch/
---
## Patch class

Un Patch è una superficie di modellazione parametrica, simile a NurbsSurface, è anche definita da due PatchDirection, l'U e la V. Ma la differenza tra Patch e NurbsSurface è che la curva PatchDirection può essere una di PatchDirectionType.BEZIER, PatchDirectionType.QUADRATIC_BEZIER, PatchDirectionType.BASIS_SPLINE, PatchDirectionType.CARDINAL_SPLINE e PatchDirectionType.LINEAR
...
| Nome | Descrizione |
| --- | --- |
| constructor() | Inizializza una nuova istanza della classe Patch. |
...
| Nome | Descrizione |
| --- | --- |
| constructor_overload(name) | Inizializza una nuova istanza della classe Patch. |
...
| Nome | Descrizione |
| --- | --- |
| getU() | Restituisce la direzione u. |
...
| Nome | Descrizione |
| --- | --- |
| getV() | Restituisce la direzione v. Il v. |

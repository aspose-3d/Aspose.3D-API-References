...
url: /it/nodejs-java/aspose.threed/vertexelementspecular/
---
## VertexElementSpecular class

Definisce il colore speculare per le componenti specificate.
...
| Nome | Descrizione |
| --- | --- |
| constructor() | Inizializza una nuova istanza della classe VertexElementSpecular. |

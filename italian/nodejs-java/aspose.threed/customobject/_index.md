...
url: /it/nodejs-java/aspose.threed/customobject/
---
## CustomObject class
...
| Nome | Descrizione |
| --- | --- |
| constructor() | Inizializza una nuova istanza della classe CustomObject. |
...
| Nome | Descrizione |
| --- | --- |
| constructor_overload(name) | Inizializza una nuova istanza della classe CustomObject. |

...
url: /it/nodejs-java/aspose.threed/zshape/
---
## ZShape class

Profilo a forma Z compatibile IFC definito dai parametri.
...
| Nome | Descrizione |
| --- | --- |
| constructor() | Costruttore di ZShape |
...
| Nome | Descrizione |
| --- | --- |
| getWebThickness() | Restituisce o imposta lo spessore della parete. |
...
| Nome | Descrizione |
| --- | --- |
| setWebThickness(value) | Restituisce o imposta lo spessore della parete. |
...
| Nome | Descrizione |
| --- | --- |
| getEdgeRadius() | Restituisce o imposta il raggio del bordo dell'aletta. |
...
| Nome | Descrizione |
| --- | --- |
| setEdgeRadius(value) | Restituisce o imposta il raggio del bordo dell'aletta. |

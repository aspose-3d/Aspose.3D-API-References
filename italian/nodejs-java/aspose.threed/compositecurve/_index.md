...
url: /it/nodejs-java/aspose.threed/compositecurve/
---
## CompositeCurve class

Un CompositeCurve è composto da diversi segmenti di curva.
...
| Nome | Descrizione |
| --- | --- |
| constructor() | Costruttore di CompositeCurve |
...
| Nome | Descrizione |
| --- | --- |
| getSegments() | I segmenti della curva. |
...
| Nome | Descrizione |
| --- | --- |
| addSegment(curve, sameDirection) | Il |

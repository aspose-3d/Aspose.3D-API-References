...
url: /it/nodejs-java/aspose.threed/vertexelementbinormal/
---
## VertexElementBinormal class

Definisce i vettori binormali per le componenti specificate.
...
| Nome | Descrizione |
| --- | --- |
| constructor() | Inizializza una nuova istanza della classe VertexElementBinormal. |

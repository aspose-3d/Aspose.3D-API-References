...
url: /it/nodejs-java/aspose.threed/entity/
---
## Entity class

La classe base di tutte le entità. Un'entità rappresenta un oggetto concreto che è collegato sotto un nodo come Light/Geometry.
...
| Nome | Descrizione |
| --- | --- |
| constructor(name) | Inizializza una nuova istanza della classe Entity. |

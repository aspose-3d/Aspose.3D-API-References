...
url: /it/nodejs-java/aspose.threed/vertexelementvertexcolor/
---
## VertexElementVertexColor class

Definisce il colore del vertice per le componenti specificate
...
| Nome | Descrizione |
| --- | --- |
| constructor() | Inizializza una nuova istanza della classe VertexElementVertexColor. |

...
url: /it/nodejs-java/aspose.threed/vertexelementnormal/
---
## VertexElementNormal class

Definisce i vettori normali per le componenti specificate.
...
| Nome | Descrizione |
| --- | --- |
| constructor() | Inizializza una nuova istanza della classe VertexElementNormal. |

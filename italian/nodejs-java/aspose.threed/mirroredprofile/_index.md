...
url: /it/nodejs-java/aspose.threed/mirroredprofile/
---
## MirroredProfile class

Profilo a specchio compatibile IFC.  Questo profilo definisce un nuovo profilo specchiando il profilo base rispetto all'asse y.
...
| Nome | Descrizione |
| --- | --- |
| constructor(baseProfile) | Crea un nuovo MirroredProfile da un profilo esistente. |

 **Parameters:**

| Nome | Tipo | Descrizione |
| --- | --- | --- |
| baseProfile | Profilo | Il profilo base da rispecchiare. |
...
| Nome | Descrizione |
| --- | --- |
| getBaseProfile() | Il profilo base da rispecchiare. |

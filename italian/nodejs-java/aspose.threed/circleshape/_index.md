...
url: /it/nodejs-java/aspose.threed/circleshape/
---
## CircleShape class

Profilo circolare compatibile IFC, che può essere usato per costruire una mesh tramite LinearExtrusion
...
| Nome | Descrizione |
| --- | --- |
| constructor() | Crea un profilo CircleShape con raggio predefinito (5). |
...
| Nome | Descrizione |
| --- | --- |
| constructor_overload(radius) | Crea un profilo CircleShape con raggio specificato. |
...
| Nome | Descrizione |
| --- | --- |
| getRadius() | Restituisce o imposta il raggio del cerchio. |
...
| Nome | Descrizione |
| --- | --- |
| setRadius(value) | Restituisce o imposta il raggio del cerchio. |

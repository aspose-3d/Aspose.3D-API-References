...
url: /it/nodejs-java/aspose.threed/vertexelementedgecrease/
---
## VertexElementEdgeCrease class

Definisce la piega del bordo per le componenti specificate
...
| Nome | Descrizione |
| --- | --- |
| constructor() | Inizializza una nuova istanza della classe VertexElementEdgeCrease. |

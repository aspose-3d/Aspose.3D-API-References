...
url: /it/nodejs-java/aspose.threed/xloadoptions/
---
## XLoadOptions class
...
| Nome | Descrizione |
| --- | --- |
| constructor(contentType) | Costruttore di XLoadOptions |
...
| Nome | Descrizione |
| --- | --- |
| getFlipCoordinateSystem() | Capovolge il sistema di coordinate, è true per impostazione predefinita |
...
| Nome | Descrizione |
| --- | --- |
| setFlipCoordinateSystem(value) | Capovolge il sistema di coordinate, è true per impostazione predefinita |

...
url: /it/nodejs-java/aspose.threed/deformer/
---
## Deformer class

Classe base per SkinDeformer e MorphTargetDeformer
...
| Nome | Descrizione |
| --- | --- |
| constructor(name) | Inizializza una nuova istanza della classe Deformer. |

...
url: /it/nodejs-java/aspose.threed/ellipseshape/
---
## EllipseShape class

Forma ellittica compatibile con IFC definita da parametri. La posizione centrale del profilo è al centro della bounding box.
...
| Nome | Descrizione |
| --- | --- |
| getSemiAxis1() | Ottiene o imposta il primo raggio dell'ellisse misurato nella direzione dell'asse x. |
...
| Nome | Descrizione |
| --- | --- |
| setSemiAxis1(value) | Ottiene o imposta il primo raggio dell'ellisse misurato nella direzione dell'asse x. |
...
| Nome | Descrizione |
| --- | --- |
| getSemiAxis2() | Ottiene o imposta il secondo raggio dell'ellisse misurato nella direzione dell'asse y. |
...
| Nome | Descrizione |
| --- | --- |
| setSemiAxis2(value) | Ottiene o imposta il secondo raggio dell'ellisse misurato nella direzione dell'asse y. |

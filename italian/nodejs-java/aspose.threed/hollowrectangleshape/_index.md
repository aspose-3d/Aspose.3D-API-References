...
url: /it/nodejs-java/aspose.threed/hollowrectangleshape/
---
## HollowRectangleShape class

Forma rettangolare cava compatibile IFC con angoli arrotondati interni/esterni.
...
| Nome | Descrizione |
| --- | --- |
| getWallThickness() | Lo spessore tra il bordo del rettangolo e il foro interno |
...
| Nome | Descrizione |
| --- | --- |
| setWallThickness(value) | Lo spessore tra il bordo del rettangolo e il foro interno |
...
| Nome | Descrizione |
| --- | --- |
| getInnerFilletRadius() | Il raggio di raccordo interno del rettangolo interno. |
...
| Nome | Descrizione |
| --- | --- |
| setInnerFilletRadius(value) | Il raggio di raccordo interno del rettangolo interno. |

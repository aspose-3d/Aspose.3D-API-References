...
url: /it/nodejs-java/aspose.threed/transformedcurve/
---
## TransformedCurve class

Una TransformedCurve assegna una posizione a una curva usando una matrice di trasformazione.  Questo consente di eseguire una trasformazione all'interno di una TrimmedCurve o CompositeCurve.
...
| Nome | Descrizione |
| --- | --- |
| constructor() | Il costruttore di TransformedCurve |
...
| Nome | Descrizione |
| --- | --- |
| constructor_overload(basisCurve, transformation) | Il costruttore di TransformedCurve |
...
| Nome | Descrizione |
| --- | --- |
| getTransformMatrix() | La matrice di trasformazione. |
...
| Nome | Descrizione |
| --- | --- |
| setTransformMatrix(value) | La matrice di trasformazione. |
...
| Nome | Descrizione |
| --- | --- |
| getBasisCurve() | La curva di base. |
...
| Nome | Descrizione |
| --- | --- |
| setBasisCurve(value) | La curva di base. |

...
url: /it/nodejs-java/aspose.threed/vertexelementpolygongroup/
---
## VertexElementPolygonGroup class

Definisce il gruppo di poligoni per le componenti specificate per raggruppare insieme i poligoni correlati.
...
| Nome | Descrizione |
| --- | --- |
| constructor() | Inizializza una nuova istanza della classe VertexElementPolygonGroup. |

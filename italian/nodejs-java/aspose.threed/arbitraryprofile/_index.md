...
url: /it/nodejs-java/aspose.threed/arbitraryprofile/
---
...
| Nome | Descrizione |
| --- | --- |
| constructor() | Costruttore di ArbitraryProfile |
...
| Nome | Descrizione |
| --- | --- |
| constructor_overload(curve) | Costruttore di ArbitraryProfile con una curva iniziale. |
...
| Nome | Descrizione |
| --- | --- |
| getCurve() | La Curva usata per costruire il profilo |
...
| Nome | Descrizione |
| --- | --- |
| setCurve(value) | La Curva usata per costruire il profilo |

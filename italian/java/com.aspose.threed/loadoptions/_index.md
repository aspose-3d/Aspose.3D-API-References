...
description: La classe base per configurare le opzioni di caricamento dei file per diversi tipi.
type: docs
weight: 97
url: /it/java/com.aspose.threed/loadoptions/
---
...
La classe base per configurare le opzioni di caricamento dei file per diversi tipi.
## Metodi

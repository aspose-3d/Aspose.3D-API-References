...
description: "A  rappresenta le relazioni logiche di ."
type: docs
weight: 75
url: /it/java/com.aspose.threed/group/
---
...
A [Group](../../com.aspose.threed/group) rappresenta le relazioni logiche di [Node](../../com.aspose.threed/node).
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [Group(String name)](#Group-java.lang.String-) | Crea una nuova istanza di [Group](../../com.aspose.threed/group) |
| [Group()](#Group--) | Crea una nuova istanza di [Group](../../com.aspose.threed/group) |
## Metodi
...
| [getClass()](#getClass--) |  |
| [getGroups()](#getGroups--) | Sotto-gruppi |
| [getName()](#getName--) | Ottiene il nome. |
| [getNodes()](#getNodes--) | I nodi in questo gruppo |
| [getParent()](#getParent--) | Gruppo genitore del gruppo corrente |
...
| [toString()](#toString--) | Ottiene la rappresentazione stringa di [Group](../../com.aspose.threed/group) |
| [wait()](#wait--) |  |
...
Crea una nuova istanza di [Group](../../com.aspose.threed/group)

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| nome | java.lang.String | Nome del gruppo |
...
**Returns:**
java.util.List<com.aspose.threed.Group> - Sotto-gruppi
### getName() {#getName--}
```
...
**Returns:**
java.util.List<com.aspose.threed.Node> - I nodi in questo gruppo
### getParent() {#getParent--}
```
...
Gruppo genitore del gruppo corrente
...
Ottiene la rappresentazione stringa di [Group](../../com.aspose.threed/group)

**Returns:**
java.lang.String - La rappresentazione stringa dell'istanza corrente
### wait() {#wait--}
```

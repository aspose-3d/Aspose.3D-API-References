...
| [negative(Vector3 v)](#negative-com.aspose.threed.Vector3-) | Sovraccarico dell'operatore per - |
| [normalize()](#normalize--) | Normalizza questa istanza. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [op_eq(Vector3 lhs, Vector3 rhs)](#op-eq-com.aspose.threed.Vector3-com.aspose.threed.Vector3-) | Operatore di uguaglianza per Vector3 |
| [op_ne(Vector3 lhs, Vector3 rhs)](#op-ne-com.aspose.threed.Vector3-com.aspose.threed.Vector3-) | Operatore di disuguaglianza per Vector3 |
| [set(double newX, double newY, double newZ)](#set-double-double-double-) | Imposta il componente x/y/z in una sola chiamata. |
| [set(int idx, double value)](#set-int-double-) | Imposta il componente del vettore per indice. |
| [sin()](#sin--) | Calcola il seno su ogni componente |
| [sub(Vector3 lhs, Vector3 rhs)](#sub-com.aspose.threed.Vector3-com.aspose.threed.Vector3-) | Sovraccarico dell'operatore per - (meno) |
| [toString()](#toString--) | Restituisce una java.lang.String che rappresenta l'attuale [Vector3](../../com.aspose.threed/vector3). |
| [wait()](#wait--) |  |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| vec | [FVector3](../../com.aspose.threed/fvector3) | La coordinata x. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| lhs | [Vector3](../../com.aspose.threed/vector3) | Il vettore sinistro |
| rhs | [Vector3](../../com.aspose.threed/vector3) | Il vettore destro |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| dir | [Vector3](../../com.aspose.threed/vector3) | Il vettore direzione con cui confrontare |

**Returns:**
double - angolo interno in radianti
...
| --- | --- | --- |
| dir | [Vector3](../../com.aspose.threed/vector3) | Il vettore direzione con cui confrontare |
| up | [Vector3](../../com.aspose.threed/vector3) | Il vettore up del piano condiviso dalle due direzioni |
...
Operatore di uguaglianza per Vector3
...
Operatore di disuguaglianza per Vector3
...
Imposta il componente x/y/z in una sola chiamata.
...
Imposta il componente del vettore per indice.
...
Sovraccarico dell'operatore per - (meno)
...
Restituisce una java.lang.String che rappresenta l'attuale [Vector3](../../com.aspose.threed/vector3).

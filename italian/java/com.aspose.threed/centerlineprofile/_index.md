...
description: Profilo di linea centrale compatibile con IFC
type: docs
weight: 30
url: /it/java/com.aspose.threed/centerlineprofile/
---
...
Profilo di linea centrale compatibile con IFC
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [CenterLineProfile(Curve curve, double thickness)](#CenterLineProfile-com.aspose.threed.Curve-double-) | Crea un nuovo [CenterLineProfile](../../com.aspose.threed/centerlineprofile) con la curva specificata come linea centrale. |
| [CenterLineProfile(Curve curve)](#CenterLineProfile-com.aspose.threed.Curve-) | Crea un nuovo [CenterLineProfile](../../com.aspose.threed/centerlineprofile) con la curva specificata come linea centrale. |
## Metodi
...
| [getClass()](#getClass--) |  |
| [getCurve()](#getCurve--) | La curva della linea centrale del profilo |
...
| [getThickness()](#getThickness--) | Spessore applicato lungo la linea centrale |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setCurve(Curve value)](#setCurve-com.aspose.threed.Curve-) | La curva della linea centrale del profilo |
...
| [setThickness(double value)](#setThickness-double-) | Spessore applicato lungo la linea centrale |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Crea un nuovo [CenterLineProfile](../../com.aspose.threed/centerlineprofile) con la curva specificata come linea centrale.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Curva della linea centrale |
| spessore | double | Spessore applicato lungo la linea centrale |
...
La curva della linea centrale del profilo
...
Spessore applicato lungo la linea centrale

**Returns:**
double - Spessore applicato lungo la linea centrale
### hashCode() {#hashCode--}
```

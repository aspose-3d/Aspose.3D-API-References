...
description: è una superficie rappresentata da NURBSNon-uniform rational basis spline  A  è definita da due  e .
type: docs
weight: 114
url: /it/java/com.aspose.threed/nurbssurface/
---
...
| --- | --- |
| [NurbsSurface()](#NurbsSurface--) | Inizializza una nuova istanza della classe [NurbsSurface](../../com.aspose.threed/nurbssurface). |
| [NurbsSurface(String name)](#NurbsSurface-java.lang.String-) | Inizializza una nuova istanza della classe [NurbsSurface](../../com.aspose.threed/nurbssurface). |
## Metodi
...
| [getU()](#getU--) | Ottiene la direzione U della superficie NURBS |
| [getV()](#getV--) | Ottiene la direzione V della superficie NURBS |
...
| [toMesh()](#toMesh--) | Converti la superficie NURBS nella mesh |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Inizializza una nuova istanza della classe [NurbsSurface](../../com.aspose.threed/nurbssurface).

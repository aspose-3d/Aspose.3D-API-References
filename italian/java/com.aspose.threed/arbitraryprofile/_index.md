...
description: "Questa classe consente di costruire un profilo 2D direttamente da una curva arbitraria."
type: docs
weight: 16
url: /it/java/com.aspose.threed/arbitraryprofile/
---
...
Questa classe consente di costruire un profilo 2D direttamente da una curva arbitraria.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [ArbitraryProfile()](#ArbitraryProfile--) | Costruttore di [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) |
| [ArbitraryProfile(Curve curve)](#ArbitraryProfile-com.aspose.threed.Curve-) | Costruttore di [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) con una curva iniziale. |
## Metodi
...
| [getClass()](#getClass--) |  |
| [getCurve()](#getCurve--) | La curva usata per costruire il profilo |
...
| [getHoles()](#getHoles--) | Fori del profilo, rappresentati anche come curva |
...
| [setCurve(Curve value)](#setCurve-com.aspose.threed.Curve-) | La curva usata per costruire il profilo |
...
Costruttore di [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile)
...
Costruttore di [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) con una curva iniziale.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Curva iniziale del profilo |
...
La curva usata per costruire il profilo
...
Fori del profilo, rappresentati anche come curva

**Returns:**
java.util.ArrayList<com.aspose.threed.Curve> - Fori del profilo, rappresentati anche come curva
### getName() {#getName--}
```

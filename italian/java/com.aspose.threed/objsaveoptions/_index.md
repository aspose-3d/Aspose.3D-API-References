...
description: Opzioni di salvataggio per file wavefront obj
type: docs
weight: 116
url: /it/java/com.aspose.threed/objsaveoptions/
---
...
Opzioni di salvataggio per file wavefront obj
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [ObjSaveOptions()](#ObjSaveOptions--) | Costruttore di [ObjSaveOptions](../../com.aspose.threed/objsaveoptions) |
## Metodi
...
| [getAxisSystem()](#getAxisSystem--) | Ottiene il sistema di assi nel file esportato. |
| [getClass()](#getClass--) |  |
| [getEnableMaterials()](#getEnableMaterials--) | Ottiene se importare/esportare i materiali per ogni oggetto |
...
| [getPointCloud()](#getPointCloud--) | Ottiene il flag che indica se l'esportatore deve esportare la scena come nuvola di punti (senza struttura topologica), il valore predefinito è false. |
| [getSerializeW()](#getSerializeW--) | Ottiene se serializzare la componente W nella posizione dei vertici del modello. |
| [getVerbose()](#getVerbose--) | Ottiene se generare commenti per ogni sezione. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setAxisSystem(AxisSystem value)](#setAxisSystem-com.aspose.threed.AxisSystem-) | Imposta il sistema di assi nel file esportato. |
| [setEnableMaterials(boolean value)](#setEnableMaterials-boolean-) | Imposta se importare/esportare i materiali per ogni oggetto. |
...
| [setPointCloud(boolean value)](#setPointCloud-boolean-) | Imposta il flag che indica se l'esportatore deve esportare la scena come nuvola di punti (senza struttura topologica), il valore predefinito è false. |
| [setSerializeW(boolean value)](#setSerializeW-boolean-) | Imposta se serializzare il componente W nella posizione del vertice del modello. |
| [setVerbose(boolean value)](#setVerbose-boolean-) | Imposta se generare commenti per ogni sezione |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Costruttore di [ObjSaveOptions](../../com.aspose.threed/objsaveoptions)
...
Ottiene il sistema di assi nel file esportato.
...
Ottiene se importare/esportare i materiali per ogni oggetto

**Returns:**
boolean - se importare/esportare i materiali per ogni oggetto
...
Ottiene il flag che indica se l'esportatore deve esportare la scena come nuvola di punti (senza struttura topologica), il valore predefinito è false.

**Returns:**
boolean - il flag se l'esportatore deve esportare la scena come nuvola di punti (senza struttura topologica), il valore predefinito è false
...
Ottiene se serializzare la componente W nella posizione dei vertici del modello.

**Returns:**
boolean - se serializzare il componente W nella posizione del vertice del modello.
...
Ottiene se generare commenti per ogni sezione.

**Returns:**
boolean - se generare commenti per ogni sezione
### hashCode() {#hashCode--}
```
...
Imposta il sistema di assi nel file esportato.
...
Imposta se importare/esportare i materiali per ogni oggetto.
...
Imposta il flag che indica se l'esportatore deve esportare la scena come nuvola di punti (senza struttura topologica), il valore predefinito è false.
...
Imposta se serializzare il componente W nella posizione del vertice del modello.
...
Imposta se generare commenti per ogni sezione

...
description: Opzioni di caricamento per wavefront obj
type: docs
weight: 115
url: /it/java/com.aspose.threed/objloadoptions/
---
...
Opzioni di caricamento per wavefront obj
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [ObjLoadOptions()](#ObjLoadOptions--) | Costruttore di [ObjLoadOptions](../../com.aspose.threed/objloadoptions) |
## Metodi
...
| [getClass()](#getClass--) |  |
| [getEnableMaterials()](#getEnableMaterials--) | Restituisce se importare i materiali per ogni oggetto |
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | Restituisce se invertire il sistema di coordinate dei control points/normal durante l'importazione |
...
| [getNormalizeNormal()](#getNormalizeNormal--) | Restituisce se normalizzare il vettore normale durante il caricamento. |
| [getScale()](#getScale--) | Scala sugli assi x/y/z, il valore predefinito è 1.0 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEnableMaterials(boolean value)](#setEnableMaterials-boolean-) | Imposta se importare i materiali per ogni oggetto |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | Imposta se invertire il sistema di coordinate dei control points/normal durante l'importazione |
...
| [setNormalizeNormal(boolean value)](#setNormalizeNormal-boolean-) | Imposta se normalizzare il vettore normale durante il caricamento. |
| [setScale(double value)](#setScale-double-) | Scala sugli assi x/y/z, il valore predefinito è 1.0 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Costruttore di [ObjLoadOptions](../../com.aspose.threed/objloadoptions)
...
Restituisce se importare i materiali per ogni oggetto

**Returns:**
boolean - se importare i materiali per ogni oggetto
...
Restituisce se invertire il sistema di coordinate dei control points/normal durante l'importazione

**Returns:**
boolean - se invertire il sistema di coordinate dei control points/normal durante l'importazione
...
Restituisce se normalizzare il vettore normale durante il caricamento. Il valore predefinito è true.

**Returns:**
boolean - se normalizzare il vettore normale durante il caricamento. Il valore predefinito è true.
### getScale() {#getScale--}
```
...
Scala sugli assi x/y/z, il valore predefinito è 1.0

**Returns:**
double - Scala sugli assi x/y/z, il valore predefinito è 1.0
### hashCode() {#hashCode--}
```
...
Imposta se importare i materiali per ogni oggetto
...
Imposta se invertire il sistema di coordinate dei control points/normal durante l'importazione
...
Imposta se normalizzare il vettore normale durante il caricamento. Il valore predefinito è true.

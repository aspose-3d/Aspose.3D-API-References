...
type: docs
weight: 182
url: /it/java/com.aspose.threed/tshape/
---
...
| --- | --- |
| [TShape()](#TShape--) | Costruttore di [TShape](../../com.aspose.threed/tshape) |
## Metodi
...
| [getClass()](#getClass--) |  |
| [getDepth()](#getDepth--) | Ottiene la lunghezza del web. |
...
| [getFilletRadius()](#getFilletRadius--) | Ottiene il raggio dello smusso tra il web e la flangia. |
| [getFlangeEdgeRadius()](#getFlangeEdgeRadius--) | Ottiene il raggio del bordo della flangia. |
| [getFlangeThickness()](#getFlangeThickness--) | Ottiene lo spessore della parete della flangia. |
...
| [getWebEdgeRadius()](#getWebEdgeRadius--) | Ottiene il raggio del bordo del web. |
| [getWebThickness()](#getWebThickness--) | Ottiene lo spessore della parete del web. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setDepth(double value)](#setDepth-double-) | Imposta la lunghezza del web. |
| [setExcluded(boolean value)](#setExcluded-boolean-) | Imposta se escludere questa entità durante l'esportazione. |
| [setFilletRadius(double value)](#setFilletRadius-double-) | Imposta il raggio dello smusso tra il web e la flangia. |
| [setFlangeEdgeRadius(double value)](#setFlangeEdgeRadius-double-) | Imposta il raggio del bordo della flangia. |
| [setFlangeThickness(double value)](#setFlangeThickness-double-) | Imposta lo spessore della parete della flangia. |
...
| [setWebEdgeRadius(double value)](#setWebEdgeRadius-double-) | Imposta il raggio del bordo del web. |
| [setWebThickness(double value)](#setWebThickness-double-) | Imposta lo spessore della parete del web. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Costruttore di [TShape](../../com.aspose.threed/tshape)
...
Ottiene la lunghezza del web.

**Returns:**
double - la lunghezza del web.
...
Ottiene il raggio dello smusso tra il web e la flangia.

**Returns:**
double - il raggio dello smusso tra il web e la flangia.
...
Ottiene il raggio del bordo della flangia.

**Returns:**
double - il raggio del bordo della flangia.
...
Ottiene lo spessore della parete della flangia.

**Returns:**
double - lo spessore della parete della flangia.
...
Ottiene il raggio del bordo del web.

**Returns:**
double - il raggio del bordo del web.
...
Ottiene lo spessore della parete del web.

**Returns:**
double - lo spessore della parete del web.
### hashCode() {#hashCode--}
```
...
Imposta il raggio dello smusso tra il web e la flangia.
...
Imposta il raggio del bordo della flangia.
...
Imposta lo spessore della parete della flangia.
...
Imposta il raggio del bordo del web.
...
Imposta lo spessore della parete del web.

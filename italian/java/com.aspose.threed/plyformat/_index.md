...
type: docs
weight: 129
url: /it/java/com.aspose.threed/plyformat/
---
...
Il formato PLY. **Example:** Il codice seguente mostra come decodificare una mesh da un file PLY:
...
| [decode(Stream stream)](#decode-com.aspose.threed.Stream-) | Decodifica una nuvola di punti o una mesh dallo stream specificato. |
| [decode(Stream stream, PlyLoadOptions opt)](#decode-com.aspose.threed.Stream-com.aspose.threed.PlyLoadOptions-) | Decodifica una nuvola di punti o una mesh dallo stream specificato. |
| [decode(String fileName)](#decode-java.lang.String-) | Decodifica una nuvola di punti o una mesh dallo stream specificato. |
| [decode(String fileName, PlyLoadOptions opt)](#decode-java.lang.String-com.aspose.threed.PlyLoadOptions-) | Decodifica una nuvola di punti o una mesh dallo stream specificato. |
...
| [encode(Entity entity, Stream stream)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-) | Codifica l'entità e salva il risultato nello stream. |
| [encode(Entity entity, Stream stream, PlySaveOptions opt)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-com.aspose.threed.PlySaveOptions-) | Codifica l'entità e salva il risultato nello stream. |
| [encode(Entity entity, String fileName)](#encode-com.aspose.threed.Entity-java.lang.String-) | Codifica l'entità e salva il risultato in un file esterno. |
| [encode(Entity entity, String fileName, PlySaveOptions opt)](#encode-com.aspose.threed.Entity-java.lang.String-com.aspose.threed.PlySaveOptions-) | Codifica l'entità e salva il risultato in un file esterno. |
...
Decodifica una nuvola di punti o una mesh dallo stream specificato.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | Il flusso di input |
...
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | Il flusso di input |
| opt | [PlyLoadOptions](../../com.aspose.threed/plyloadoptions) | L'opzione di caricamento del formato PLY |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| fileName | java.lang.String | Il flusso di input |
...
|  | stream | [Stream](../../com.aspose.threed/stream) | Il flusso su cui scrivere, questo metodo non chiuderà questo flusso **Example:** Il codice seguente mostra come codificare una mesh in un file PLY: |
...
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | L'entità da codificare |
| stream | [Stream](../../com.aspose.threed/stream) | Il flusso su cui scrivere, questo metodo non chiuderà questo flusso |
|  | opt | [PlySaveOptions](../../com.aspose.threed/plysaveoptions) | Opzioni di salvataggio **Example:** Il codice seguente mostra come codificare una mesh in un file PLY: |
...
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | L'entità da codificare |
|  | fileName | java.lang.String | Il file su cui scrivere **Example:** Il codice seguente mostra come codificare una mesh in un file PLY: |
...
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | L'entità da codificare |
| fileName | java.lang.String | Il file su cui scrivere |
|  | opt | [PlySaveOptions](../../com.aspose.threed/plysaveoptions) | Opzioni di salvataggio **Example:** Il codice seguente mostra come codificare una mesh in un file PLY: |

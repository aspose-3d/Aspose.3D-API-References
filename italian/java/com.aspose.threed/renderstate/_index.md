...
| [setPolygonMode(PolygonMode value)](#setPolygonMode-com.aspose.threed.PolygonMode-) | Imposta la modalità di rendering del poligono. |
...
| [setStencilMask(int value)](#setStencilMask-int-) | Imposta la maschera che viene ANData sia al valore di riferimento sia al valore di stencil memorizzato quando il test è completato. |
| [setStencilReference(int value)](#setStencilReference-int-) | Imposta il valore di riferimento per il test dello stencil. |
...
| --- | --- | --- |
| other | [RenderState](../../com.aspose.threed/renderstate) | Un altro stato di rendering da confrontare. |
...
**Returns:**
boolean - Abilita o disabilita la miscelazione dei frammenti.
...
**Returns:**
boolean - Abilita o disabilita il culling delle facce.
...
**Returns:**
int - quale faccia verrà eliminata.
...
**Returns:**
boolean - Abilita o disabilita la scrittura della profondità.
...
**Returns:**
boolean - Abilita o disabilita il test di profondità.
...
**Returns:**
boolean - Abilita o disabilita il test dello scissor.
...
**Returns:**
int - la maschera che viene ANData sia al valore di riferimento sia al valore di stencil memorizzato quando il test è completato.
...
**Returns:**
int - il valore di riferimento per il test dello stencil.
...
**Returns:**
boolean - Abilita o disabilita il test dello stencil.
### hashCode() {#hashCode--}
```
public int hashCode()
```
...
Imposta la modalità di rendering del poligono.
...
Imposta la maschera che viene ANData sia al valore di riferimento sia al valore di stencil memorizzato quando il test è completato.
...
Imposta il valore di riferimento per il test dello stencil.

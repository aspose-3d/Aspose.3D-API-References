...
description: Piatto parametrizzato.
type: docs
weight: 45
url: /it/java/com.aspose.threed/dish/
---
...
| --- | --- |
| [Dish()](#Dish--) | Crea una nuova istanza di Dish con raggio predefinito (10) e altezza predefinita (5) |
| [Dish(double radius, double height)](#Dish-double-double-) | Crea una nuova istanza di Dish con raggio e altezza specificati |
| [Dish(String name, double radius, double height, int widthSegments, int heightSegments)](#Dish-java.lang.String-double-double-int-int-) | Crea una nuova istanza di Dish con raggio e altezza specificati |
## Metodi
...
| [getHeight()](#getHeight--) | Altezza del dish |
| [getHeightSegments()](#getHeightSegments--) | Ottiene i segmenti di altezza |
...
| [getRadius()](#getRadius--) | Raggio del piatto |
...
| [setHeight(double value)](#setHeight-double-) | Altezza del dish |
...
| [setRadius(double value)](#setRadius-double-) | Raggio del piatto |
...
Crea una nuova istanza di Dish con raggio predefinito (10) e altezza predefinita (5)
...
Crea una nuova istanza di Dish con raggio e altezza specificati

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| radius | double | Il raggio del piatto |
| altezza | double | L'altezza del piatto |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| nome | java.lang.String | Il nome del piatto |
| radius | double | Il raggio del piatto |
| altezza | double | L'altezza del piatto |
| widthSegments | int | Il segmento di larghezza del piatto |
| heightSegments | int | Il segmento di altezza del piatto |

...
description: La classe radice degli oggetti che saranno memorizzati all'interno di una scena.
type: docs
weight: 162
url: /it/java/com.aspose.threed/sceneobject/
---
...
La classe radice degli oggetti che saranno memorizzati all'interno di una scena.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [SceneObject(String name)](#SceneObject-java.lang.String-) | Inizializza un SceneObject con un nome predefinito |
| [SceneObject()](#SceneObject--) | Inizializza un SceneObject. |
## Metodi
...
Inizializza un SceneObject con un nome predefinito

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| nome | java.lang.String | Il nome di questa istanza |

...
description: Opzioni per il caricamento PDF
type: docs
weight: 124
url: /it/java/com.aspose.threed/pdfloadoptions/
---
...
Opzioni per il caricamento PDF
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [PdfLoadOptions()](#PdfLoadOptions--) | Costruttore di [PdfLoadOptions](../../com.aspose.threed/pdfloadoptions) |
## Metodi
...
| [getPassword()](#getPassword--) | La password per sbloccare il file PDF crittografato. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setPassword(byte[] value)](#setPassword-byte---) | La password per sbloccare il file PDF crittografato. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Costruttore di [PdfLoadOptions](../../com.aspose.threed/pdfloadoptions)
...
**Returns:**
byte[] - La password per sbloccare il file PDF crittografato.
### hashCode() {#hashCode--}
```

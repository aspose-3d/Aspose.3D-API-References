...
description: Opzioni di caricamento per file 3DS.
type: docs
weight: 43
url: /it/java/com.aspose.threed/discreet3dsloadoptions/
---
...
Opzioni di caricamento per file 3DS.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [Discreet3dsLoadOptions()](#Discreet3dsLoadOptions--) | Costruttore di [Discreet3dsLoadOptions](../../com.aspose.threed/discreet3dsloadoptions) |
## Metodi

| Metodo | Descrizione |
| --- | --- |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getApplyAnimationTransform()](#getApplyAnimationTransform--) | Ottiene se utilizzare la trasformazione definita nel primo fotogramma della traccia di animazione. |
| [getClass()](#getClass--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setApplyAnimationTransform(boolean value)](#setApplyAnimationTransform-boolean-) | Imposta se utilizzare la trasformazione definita nel primo fotogramma della traccia di animazione. |
...
Costruttore di [Discreet3dsLoadOptions](../../com.aspose.threed/discreet3dsloadoptions)
...
Ottiene se utilizzare la trasformazione definita nel primo fotogramma della traccia di animazione.

**Returns:**
boolean - se utilizzare la trasformazione definita nel primo fotogramma della traccia di animazione.
### getClass() {#getClass--}
```
...
Imposta se utilizzare la trasformazione definita nel primo fotogramma della traccia di animazione.

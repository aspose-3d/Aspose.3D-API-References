...
type: docs
weight: 91
url: /it/java/com.aspose.threed/lshape/
---
...
| --- | --- |
| [LShape()](#LShape--) | Costruttore di [LShape](../../com.aspose.threed/lshape) |
## Metodi
...
| [getEdgeRadius()](#getEdgeRadius--) | Restituisce il raggio del bordo. |
...
| [getFilletRadius()](#getFilletRadius--) | Restituisce il raggio della raccordatura. |
...
| [getThickness()](#getThickness--) | Restituisce lo spessore della parete costante. |
...
| [setEdgeRadius(double value)](#setEdgeRadius-double-) | Imposta il raggio del bordo. |
| [setExcluded(boolean value)](#setExcluded-boolean-) | Imposta se escludere questa entità durante l'esportazione. |
| [setFilletRadius(double value)](#setFilletRadius-double-) | Imposta il raggio della raccordatura. |
...
| [setThickness(double value)](#setThickness-double-) | Imposta lo spessore della parete costante. |
...
Costruttore di [LShape](../../com.aspose.threed/lshape)
...
Restituisce il raggio del bordo.

**Returns:**
double - il raggio del bordo.
...
Restituisce il raggio della raccordatura.

**Returns:**
double - il raggio della raccordatura.
### getName() {#getName--}
```
...
Restituisce lo spessore della parete costante.

**Returns:**
double - lo spessore della parete costante.
### getWidth() {#getWidth--}
```
...
Imposta il raggio della raccordatura.
...
Imposta lo spessore della parete costante.

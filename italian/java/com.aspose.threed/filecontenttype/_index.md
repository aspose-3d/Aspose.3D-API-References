...
type: docs
weight: 279
url: /it/java/com.aspose.threed/filecontenttype/
---
...
| Campo | Descrizione |
| --- | --- |
| [ASCII](#ASCII) | Tipo di formato ASCII, come ASCII FBX, ASCII STL |
| [BINARY](#BINARY) | Tipo di formato binario, come binary FBX, binary STL |
## Metodi
...
Tipo di formato ASCII, come ASCII FBX, ASCII STL
...
Tipo di formato binario, come binary FBX, binary STL

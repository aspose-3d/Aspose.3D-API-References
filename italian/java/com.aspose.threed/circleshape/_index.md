...
description: Profilo circolare compatibile IFC che può essere usato per costruire una mesh tramite
type: docs
weight: 32
url: /it/java/com.aspose.threed/circleshape/
---
...
Profilo circolare compatibile IFC, che può essere usato per costruire una mesh tramite [LinearExtrusion](../../com.aspose.threed/linearextrusion)
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [CircleShape()](#CircleShape--) | Costruisci un profilo [CircleShape](../../com.aspose.threed/circleshape) con raggio predefinito (5). |
| [CircleShape(double radius)](#CircleShape-double-) | Costruisci un profilo [CircleShape](../../com.aspose.threed/circleshape) con raggio specificato. |
## Metodi
...
| [getRadius()](#getRadius--) | Restituisce il raggio del cerchio. |
...
| [setRadius(double value)](#setRadius-double-) | Imposta il raggio del cerchio. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Costruisci un profilo [CircleShape](../../com.aspose.threed/circleshape) con raggio predefinito (5).
...
Costruisci un profilo [CircleShape](../../com.aspose.threed/circleshape) con raggio specificato.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| radius | double | Raggio del cerchio |

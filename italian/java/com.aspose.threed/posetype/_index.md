...
type: docs
weight: 293
url: /it/java/com.aspose.threed/posetype/
---
...
| Campo | Descrizione |
| --- | --- |
| [BIND_POSE](#BIND-POSE) | La bind pose. |
| [SNAPSHOT](#SNAPSHOT) | La posa di riposo, indica che è un'istantanea della bind pose. |
## Metodi
...
La posa di riposo, indica che è un'istantanea della bind pose.

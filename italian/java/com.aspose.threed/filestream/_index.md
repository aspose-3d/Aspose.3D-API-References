...
description: "Creato da lexchou il 16/06/2017."
type: docs
weight: 66
url: /it/java/com.aspose.threed/filestream/
---
...
Creato da lexchou il 16/06/2017.
## Costruttori
...
| [wrap(OutputStream stream)](#wrap-java.io.OutputStream-) | Avvolgi un OutputStream come Stream, lo stream deve essere chiuso per svuotare i dati nello stream di output. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| byte | com.aspose.threed.ByteSpan |  |
...
Avvolgi un OutputStream come Stream, lo stream deve essere chiuso per svuotare i dati nello stream di output.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| flusso | java.io.OutputStream | output stream da avvolgere |

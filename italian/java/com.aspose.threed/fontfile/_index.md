...
description: "Il file di font contiene le definizioni dei glifi; questo è usato per creare il profilo di testo."
type: docs
weight: 68
url: /it/java/com.aspose.threed/fontfile/
---
...
| [fromFile(String fileName)](#fromFile-java.lang.String-) | Carica FontFile dal nome del file |
| [getClass()](#getClass--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [parse(byte[] bytes)](#parse-byte---) | Analizza FontFile da byte |

...
description: Opzioni di caricamento per STL
type: docs
weight: 176
url: /it/java/com.aspose.threed/stlloadoptions/
---
...
Opzioni di caricamento per STL
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [StlLoadOptions()](#StlLoadOptions--) | Inizializza una nuova istanza di [StlLoadOptions](../../com.aspose.threed/stlloadoptions). |
| [StlLoadOptions(FileContentType contentType)](#StlLoadOptions-com.aspose.threed.FileContentType-) | Inizializza una nuova istanza di [StlLoadOptions](../../com.aspose.threed/stlloadoptions). |
## Metodi
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | Ottiene se invertire il sistema di coordinate dei punti di controllo/normali durante l'importazione. |
...
| [getRecalculateNormal()](#getRecalculateNormal--) | Ignora i dati normali memorizzati nel file STL e ricalcola i dati normali in base alla posizione dei vertici. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | Imposta se invertire il sistema di coordinate dei punti di controllo/normali durante l'importazione. |
...
| [setRecalculateNormal(boolean value)](#setRecalculateNormal-boolean-) | Ignora i dati normali memorizzati nel file STL e ricalcola i dati normali in base alla posizione dei vertici. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Inizializza una nuova istanza di [StlLoadOptions](../../com.aspose.threed/stlloadoptions).
...
Ottiene se invertire il sistema di coordinate dei punti di controllo/normali durante l'importazione.

**Returns:**
boolean - se invertire il sistema di coordinate dei punti di controllo/normali durante l'importazione.
...
Ignora i dati normali memorizzati nel file STL e ricalcola i dati normali in base alla posizione dei vertici. Il valore predefinito è false

**Returns:**
boolean - Ignora i dati normali memorizzati nel file STL e ricalcola i dati normali in base alla posizione dei vertici. Il valore predefinito è false
### hashCode() {#hashCode--}
```
...
Imposta se invertire il sistema di coordinate dei punti di controllo/normali durante l'importazione.

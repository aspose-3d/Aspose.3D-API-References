...
description: L'asse di coordinate.
type: docs
weight: 265
url: /it/java/com.aspose.threed/axis/
---
...
L'asse di coordinate.
## Campi

| Campo | Descrizione |
| --- | --- |
| [NEGATIVE_X_AXIS](#NEGATIVE-X-AXIS) | L'asse -X. |
| [NEGATIVE_Y_AXIS](#NEGATIVE-Y-AXIS) | L'asse -Y. |
| [NEGATIVE_Z_AXIS](#NEGATIVE-Z-AXIS) | L'asse -Z. |
| [X_AXIS](#X-AXIS) | L'asse +X. |
| [Y_AXIS](#Y-AXIS) | L'asse +Y. |
| [Z_AXIS](#Z-AXIS) | L'asse +Z. |
## Metodi

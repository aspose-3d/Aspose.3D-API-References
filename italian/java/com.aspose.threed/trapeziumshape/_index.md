...
description: Forma a trapezio compatibile IFC definita da parametri.
type: docs
weight: 193
url: /it/java/com.aspose.threed/trapeziumshape/
---
...
| --- | --- |
| [TrapeziumShape()](#TrapeziumShape--) | Costruttore di [TrapeziumShape](../../com.aspose.threed/trapeziumshape) |
## Metodi
...
| [getBottomXDim()](#getBottomXDim--) | Restituisce l'estensione della linea inferiore misurata lungo l'asse x. |
...
| [getTopXDim()](#getTopXDim--) | Restituisce l'estensione della linea superiore misurata lungo l'asse x. |
| [getTopXOffset()](#getTopXOffset--) | Restituisce lo spostamento dall'inizio della linea superiore alla linea inferiore. |
| [getYDim()](#getYDim--) | Restituisce la distanza tra le linee superiore e inferiore misurata lungo l'asse y. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setBottomXDim(double value)](#setBottomXDim-double-) | Imposta l'estensione della linea inferiore misurata lungo l'asse x. |
...
| [setTopXDim(double value)](#setTopXDim-double-) | Imposta l'estensione della linea superiore misurata lungo l'asse x. |
| [setTopXOffset(double value)](#setTopXOffset-double-) | Imposta lo spostamento dall'inizio della linea superiore alla linea inferiore. |
| [setYDim(double value)](#setYDim-double-) | Imposta la distanza tra le linee superiore e inferiore misurata lungo l'asse y. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Costruttore di [TrapeziumShape](../../com.aspose.threed/trapeziumshape)
...
Restituisce l'estensione della linea inferiore misurata lungo l'asse x.

**Returns:**
double - l'estensione della linea inferiore misurata lungo l'asse x.
...
Restituisce l'estensione della linea superiore misurata lungo l'asse x.

**Returns:**
double - l'estensione della linea superiore misurata lungo l'asse x.
...
Restituisce lo spostamento dall'inizio della linea superiore alla linea inferiore.

**Returns:**
double - lo spostamento dall'inizio della linea superiore alla linea inferiore.
### getYDim() {#getYDim--}
```
...
Restituisce la distanza tra le linee superiore e inferiore misurata lungo l'asse y.

**Returns:**
double - la distanza tra le linee superiore e inferiore misurata lungo l'asse y.
### hashCode() {#hashCode--}
```
...
Imposta l'estensione della linea inferiore misurata lungo l'asse x.
...
Imposta l'estensione della linea superiore misurata lungo l'asse x.
...
Imposta lo spostamento dall'inizio della linea superiore alla linea inferiore.
...
Imposta la distanza tra le linee superiore e inferiore misurata lungo l'asse y.

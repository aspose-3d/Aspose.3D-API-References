...
description: Operazione booleana Meshs
type: docs
weight: 268
url: /it/java/com.aspose.threed/booleanoperation/
---
...
Operazione booleana della mesh
## Campi

| Campo | Descrizione |
| --- | --- |
| [ADD](#ADD) | Aggiungi due mesh e calcola l'unione degli input. |
| [INTERSECT](#INTERSECT) | Calcola l'intersezione di due mesh. |
| [SUB](#SUB) | Sottrai un mesh da un altro mesh, calcola la differenza degli input. |
## Metodi
...
Aggiungi due mesh e calcola l'unione degli input.
...
Sottrai un mesh da un altro mesh, calcola la differenza degli input.

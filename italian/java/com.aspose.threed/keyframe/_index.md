...
**Returns:**
float - tensione usata nello spline TCB
### getTime() {#getTime--}
```
...
**Returns:**
double - la posizione temporale del fotogramma chiave list.data[index], misurata in secondi.
...
**Returns:**
boolean - la tangente è indipendente dal tempo
### getValue() {#getValue--}
```
...
**Returns:**
float - il valore del fotogramma chiave.
### hashCode() {#hashCode--}
```
...
Imposta la modalità di step della chiave. Se il tipo di interpolazione è [Interpolation.CONSTANT](../../com.aspose.threed/interpolation\#CONSTANT), list.data[index] decide quale valore del fotogramma chiave verrà usato durante l'interpolazione. Un [StepMode.PREVIOUS\_VALUE](../../com.aspose.threed/stepmode\#PREVIOUS-VALUE) indica che verrà usato il valore del fotogramma chiave a sinistra. Un [StepMode.NEXT\_VALUE](../../com.aspose.threed/stepmode\#NEXT-VALUE) indica che verrà usato il valore del fotogramma chiave a destra.
...
Imposta la modalità di peso della tangente della chiave. La tangente in uscita o la successiva tangente in ingresso possono essere personalizzate selezionando il corretto [WeightedMode](../../com.aspose.threed/weightedmode)

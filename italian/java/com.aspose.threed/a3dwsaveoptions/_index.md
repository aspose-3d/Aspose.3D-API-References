...
type: docs
weight: 11
url: /it/java/com.aspose.threed/a3dwsaveoptions/
---
...
| --- | --- |
| [A3dwSaveOptions()](#A3dwSaveOptions--) | Costruttore di [A3dwSaveOptions](../../com.aspose.threed/a3dwsaveoptions) |
## Metodi
...
| [getExportMetaData()](#getExportMetaData--) | Esporta i metadati associati a Scene/Node al client. Il valore predefinito è true |
...
| [getMetaDataPrefix()](#getMetaDataPrefix--) | Se questa proprietà è non nulla, verranno esportate solo le proprietà di Scene/Node che iniziano con questo prefisso, e il prefisso verrà rimosso. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEncoding(Charset value)](#setEncoding-java.nio.charset.Charset-) | Imposta la codifica predefinita per i file di testo. |
| [setExportMetaData(boolean value)](#setExportMetaData-boolean-) | Esporta i metadati associati a Scene/Node al client. Il valore predefinito è true |
...
| [setMetaDataPrefix(String value)](#setMetaDataPrefix-java.lang.String-) | Se questa proprietà è non nulla, verranno esportate solo le proprietà di Scene/Node che iniziano con questo prefisso, e il prefisso verrà rimosso. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Costruttore di [A3dwSaveOptions](../../com.aspose.threed/a3dwsaveoptions)
...
Esporta i metadati associati a Scene/Node al client. Il valore predefinito è true

**Returns:**
boolean - Esporta i metadati associati a Scene/Node al client. Il valore predefinito è true
...
Se questa proprietà è non nulla, verranno esportate solo le proprietà di Scene/Node che iniziano con questo prefisso, e il prefisso verrà rimosso.

**Returns:**
java.lang.String - Se questa proprietà è non nulla, verranno esportate solo le proprietà di Scene/Node che iniziano con questo prefisso, e il prefisso verrà rimosso.
### hashCode() {#hashCode--}
```

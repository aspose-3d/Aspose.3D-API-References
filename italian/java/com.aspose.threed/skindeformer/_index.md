...
description: Un skin deformer contiene più ossa per funzionare; ogni osso fonde una parte della geometria tramite i pesi dei punti di controllo.
type: docs
weight: 173
url: /it/java/com.aspose.threed/skindeformer/
---
...
Un deformatore di pelle contiene più ossa per funzionare, ogni osso mescola una parte della geometria in base ai pesi dei punti di controllo.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [SkinDeformer(String name)](#SkinDeformer-java.lang.String-) | Inizializza una nuova istanza della classe [SkinDeformer](../../com.aspose.threed/skindeformer). |
| [SkinDeformer()](#SkinDeformer--) | Inizializza una nuova istanza della classe [SkinDeformer](../../com.aspose.threed/skindeformer). |
## Metodi
...
| [getBones()](#getBones--) | Ottiene tutte le ossa che il skin deformer contiene |
| [getClass()](#getClass--) |  |
...
Inizializza una nuova istanza della classe [SkinDeformer](../../com.aspose.threed/skindeformer).
...
Ottiene tutte le ossa che il skin deformer contiene

**Returns:**
java.util.List<com.aspose.threed.Bone> - tutte le ossa che il skin deformer contiene
### getClass() {#getClass--}
```

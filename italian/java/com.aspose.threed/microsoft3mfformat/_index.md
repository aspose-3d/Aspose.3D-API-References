...
description: Istanza del formato file per Microsoft 3MF con utility correlate al 3MF.
type: docs
weight: 104
url: /it/java/com.aspose.threed/microsoft3mfformat/
---
...
Istanza del formato file per Microsoft 3MF con utility correlate al 3MF.
## Campi
...
| [getObjectType(Node node)](#getObjectType-com.aspose.threed.Node-) | Restituisce il tipo di modello per il nodo specificato. |
| [getTransformForBuild(Node node)](#getTransformForBuild-com.aspose.threed.Node-) | Ottieni la matrice di trasformazione per il nodo utilizzato nella costruzione. |
| [getVersion()](#getVersion--) | Restituisce la versione del formato file |
| [hashCode()](#hashCode--) |  |
| [isBuildable(Node node)](#isBuildable-com.aspose.threed.Node-) | Verifica se questo nodo è contrassegnato come costruzione. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBuildable(Node node, boolean value, Matrix4 transform)](#setBuildable-com.aspose.threed.Node-boolean-com.aspose.threed.Matrix4-) | Contrassegna un nodo per la costruzione. |
| [setObjectType(Node node, String modelType)](#setObjectType-com.aspose.threed.Node-java.lang.String-) | Imposta il tipo di modello per il nodo specificato. |
...
Restituisce il tipo di modello per il nodo specificato.
...
**Returns:**
java.lang.String - tipo di oggetto 3MF per il nodo dato
...
Ottieni la matrice di trasformazione per il nodo utilizzato nella costruzione.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Quale nodo utilizzare per ottenere la matrice di trasformazione per la costruzione 3MF. |
...
Verifica se questo nodo è contrassegnato come costruzione.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Quale nodo verificare |

**Returns:**
boolean - True se è contrassegnato come costruzione
### notify() {#notify--}
```
...
Contrassegna un nodo per la costruzione.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Quale nodo contrassegnare come costruzione. |
| valore | boolean |  |
| transform | [Matrix4](../../com.aspose.threed/matrix4) | La trasformazione del nodo nella costruzione. |
...
Imposta il tipo di modello per il nodo specificato. Valori possibili: model surface solidsupport support other

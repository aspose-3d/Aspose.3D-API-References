...
description: Un materiale shader consente di descrivere il materiale tramite un motore di rendering esterno o un linguaggio shader.
type: docs
weight: 164
url: /it/java/com.aspose.threed/shadermaterial/
---
...
Un materiale shader consente di descrivere il materiale tramite un motore di rendering esterno o un linguaggio shader. [ShaderMaterial](../../com.aspose.threed/shadermaterial) utilizza [ShaderTechnique](../../com.aspose.threed/shadertechnique) per descrivere i dettagli concreti del rendering, e quello più adatto verrà usato in base alla piattaforma di rendering finale. Ad esempio, la tua istanza di [ShaderMaterial](../../com.aspose.threed/shadermaterial) può avere due tecniche, una definita in HLSL e un'altra definita in GLSL. Su piattaforme non Windows il GLSL dovrebbe essere usato al posto dell'HLSL
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [ShaderMaterial()](#ShaderMaterial--) | Inizializza una nuova istanza della classe [ShaderMaterial](../../com.aspose.threed/shadermaterial). |
| [ShaderMaterial(String name)](#ShaderMaterial-java.lang.String-) | Inizializza una nuova istanza della classe [ShaderMaterial](../../com.aspose.threed/shadermaterial). |
## Campi
...
| [getTechniques()](#getTechniques--) | Restituisce tutte le tecniche disponibili definite in questo materiale. |
...
Inizializza una nuova istanza della classe [ShaderMaterial](../../com.aspose.threed/shadermaterial).
...
Restituisce tutte le tecniche disponibili definite in questo materiale.

**Returns:**
java.util.List<com.aspose.threed.ShaderTechnique> - tutte le tecniche disponibili definite in questo materiale.

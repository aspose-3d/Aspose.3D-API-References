...
description: "Tipi di direzioni del patch."
type: docs
weight: 287
url: /it/java/com.aspose.threed/patchdirectiontype/
---
...
Tipi di direzione del patch.
## Campi

| Campo | Descrizione |
| --- | --- |
|  | [BASIS_SPLINE](#BASIS-SPLINE) | [La direzione del patch è una spline di base.][] |


[The patch direction is a basis spline.]: https://en.wikipedia.org/wiki/B-spline |
|  | [BEZIER](#BEZIER) | [La direzione del patch è una curva Bezier.][] |
...
|  | [LINEAR](#LINEAR) | [La direzione del patch è una curva lineare.][] |


[The patch direction is a linear curve.]: https://en.wikipedia.org/wiki/B%C3%A9zier_curve#Linear_curves |
| [QUADRATIC_BEZIER](#QUADRATIC-BEZIER) | Il patch bezier quadratico. |
## Metodi
...
patch cardinal. [La direzione del patch è una spline cardinali.][]
...
Il patch bezier quadratico. [La direzione del patch è una curva quadratica.][]

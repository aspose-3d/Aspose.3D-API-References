...
type: docs
weight: 189
url: /it/java/com.aspose.threed/torus/
---
...
| --- | --- |
| [Torus()](#Torus--) | Inizializza una nuova istanza della classe [Torus](../../com.aspose.threed/torus). |
| [Torus(double radius, double tube)](#Torus-double-double-) | Inizializza una nuova istanza della classe [Torus](../../com.aspose.threed/torus). |
| [Torus(double radius, double tube, double arc)](#Torus-double-double-double-) | Inizializza una nuova istanza della classe [Torus](../../com.aspose.threed/torus). |
| [Torus(String name, double radius, double tube, int radialSegments, int tubularSegments, double arc)](#Torus-java.lang.String-double-double-int-int-double-) | Inizializza una nuova istanza della classe [Torus](../../com.aspose.threed/torus). |
## Metodi
...
| [getRadius()](#getRadius--) | Ottiene il raggio del torus. |
...
| [getTube()](#getTube--) | Ottiene il raggio del tubo. |
| [getTubularSegments()](#getTubularSegments--) | Ottiene i segmenti tubolari. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setArc(double value)](#setArc-double-) | Imposta l'arco. |
...
| [setRadius(double value)](#setRadius-double-) | Imposta il raggio del torus. |
| [setReceiveShadows(boolean value)](#setReceiveShadows-boolean-) | Imposta se questa geometria può ricevere ombra. |
| [setTube(double value)](#setTube-double-) | Imposta il raggio del tubo. |
| [setTubularSegments(int value)](#setTubularSegments-int-) | Imposta i segmenti tubolari. |
...
Inizializza una nuova istanza della classe [Torus](../../com.aspose.threed/torus).
...
| --- | --- | --- |
| radius | double | Il raggio del torus. |
| tubo | double | Il raggio del tubo del torus. |
...
| radius | double | Il raggio del torus. |
| tubo | double | Il raggio del tubo del torus. |
| radialSegments | int | Segmenti radiali. |
| tubularSegments | int | Segmenti tubolari. |
| arco | double | Arco. |
...
Ottiene il raggio del torus.

**Returns:**
double - il raggio del toro.
...
Ottiene il raggio del tubo.

**Returns:**
double - il raggio del tubo.
...
Ottiene i segmenti tubolari.

**Returns:**
int - i segmenti tubolari.
### hashCode() {#hashCode--}
```

...
description: Opzioni di salvataggio per AMF
type: docs
weight: 12
url: /it/java/com.aspose.threed/amfsaveoptions/
---
...
Opzioni di salvataggio per AMF
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [AmfSaveOptions()](#AmfSaveOptions--) | Costruttore di [AmfSaveOptions](../../com.aspose.threed/amfsaveoptions) |
## Metodi
...
| [getClass()](#getClass--) |  |
| [getEnableCompression()](#getEnableCompression--) | Indica se utilizzare la compressione per ridurre la dimensione finale del file, il valore predefinito è true |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEnableCompression(boolean value)](#setEnableCompression-boolean-) | Indica se utilizzare la compressione per ridurre la dimensione finale del file, il valore predefinito è true |
...
Costruttore di [AmfSaveOptions](../../com.aspose.threed/amfsaveoptions)
...
Indica se utilizzare la compressione per ridurre la dimensione finale del file, il valore predefinito è true

**Returns:**
boolean - Indica se utilizzare la compressione per ridurre la dimensione finale del file, il valore predefinito è true

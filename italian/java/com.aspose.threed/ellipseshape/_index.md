...
description: Forma ellittica compatibile con IFC definita da parametri.
type: docs
weight: 50
url: /it/java/com.aspose.threed/ellipseshape/
---
...
Forma ellittica compatibile IFC definita da parametri. La posizione centrale del profilo è al centro della bounding box.
## Costruttori
...
| [getSemiAxis1()](#getSemiAxis1--) | Restituisce il primo raggio dell'ellisse misurato nella direzione dell'asse x. |
| [getSemiAxis2()](#getSemiAxis2--) | Restituisce il secondo raggio dell'ellisse misurato nella direzione dell'asse y. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setSemiAxis1(double value)](#setSemiAxis1-double-) | Imposta il primo raggio dell'ellisse misurato nella direzione dell'asse x. |
| [setSemiAxis2(double value)](#setSemiAxis2-double-) | Imposta il secondo raggio dell'ellisse misurato nella direzione dell'asse y. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Restituisce il primo raggio dell'ellisse misurato nella direzione dell'asse x.

**Returns:**
double - il primo raggio dell'ellisse misurato nella direzione dell'asse x.
...
Restituisce il secondo raggio dell'ellisse misurato nella direzione dell'asse y.

**Returns:**
double - il secondo raggio dell'ellisse misurato nella direzione dell'asse y.
### hashCode() {#hashCode--}
```
...
Imposta il primo raggio dell'ellisse misurato nella direzione dell'asse x.
...
Imposta il secondo raggio dell'ellisse misurato nella direzione dell'asse y.

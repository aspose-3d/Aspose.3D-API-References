...
description: "API di rendering comunemente utilizzate"
type: docs
weight: 269
url: /it/java/com.aspose.threed/renderingapi/
---
...
API di rendering comunemente utilizzate
## Campi

| Campo | Descrizione |
| --- | --- |
| [ARNOLD](#ARNOLD) | Renderer Arnold |
| [CUSTOM](#CUSTOM) | API di rendering personalizzate |
| [DIRECTX](#DIRECTX) | DirectX |
| [MANTLE](#MANTLE) | AMD Mantle |
| [MENTAL_RAY](#MENTAL-RAY) | MentalRay |
| [METAL](#METAL) | Metal sviluppato da Apple |
| [NONE](#NONE) | Nessuna API di rendering |
| [OPENGL](#OPENGL) | OpenGL |
| [OPENGLES](#OPENGLES) | OpenGL ES |
| [PREVIEW](#PREVIEW) | PreviewColorAPI, compatibile con FBX |
| [RENDER_MAN](#RENDER-MAN) | RenderMan |
| [RENDER_WARE](#RENDER-WARE) | RenderWare |
| [SHADERFX](#SHADERFX) | Renderer ShaderFX |
| [STAGE3D](#STAGE3D) | Stage3D utilizzato in Adobe Flash |
...
API di rendering personalizzate
...
PreviewColorAPI, compatibile con FBX
...
Stage3D utilizzato in Adobe Flash

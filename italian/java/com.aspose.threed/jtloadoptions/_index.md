...
description: Opzioni di caricamento per Siemens JT
type: docs
weight: 88
url: /it/java/com.aspose.threed/jtloadoptions/
---
...
Opzioni di caricamento per Siemens JT
## Costruttori
...
| [getLoadPMI()](#getLoadPMI--) | Carica le informazioni PMI dal file JT se possibile, i dati saranno salvati come proprietà "PMI" di [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). |
| [getLoadProperties()](#getLoadProperties--) | Carica le proprietà dalla tabella delle proprietà di JT come proprietà Aspose.3D. |
...
| [setLoadPMI(boolean value)](#setLoadPMI-boolean-) | Carica le informazioni PMI dal file JT se possibile, i dati saranno salvati come proprietà "PMI" di [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). |
| [setLoadProperties(boolean value)](#setLoadProperties-boolean-) | Carica le proprietà dalla tabella delle proprietà di JT come proprietà Aspose.3D. |
...
Carica le informazioni PMI dal file JT se possibile, i dati saranno salvati come proprietà "PMI" di [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). Il valore predefinito è false.

**Returns:**
boolean - Carica le informazioni PMI dal file JT se possibile, i dati saranno salvati come proprietà "PMI" di [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). Il valore predefinito è false.
...
Carica le proprietà dalla tabella delle proprietà di JT come proprietà Aspose.3D. Il valore predefinito è false.

**Returns:**
boolean - Carica le proprietà dalla tabella delle proprietà di JT come proprietà Aspose.3D. Il valore predefinito è false.

...
description: Esempio di Adobe Portable Document Format Il codice seguente mostra come estrarre tutte le scene 3D supportate da un file PDF 3D e scriverle in formato obj.
type: docs
weight: 123
url: /it/java/com.aspose.threed/pdfformat/
---
...
Formato Portable Document di Adobe **Esempio:** Il codice seguente mostra come estrarre tutte le scene 3D supportate da un file PDF 3D e scriverle nel formato obj.
...
| [extract(Stream stream)](#extract-com.aspose.threed.Stream-) | Estrai contenuto 3D grezzo dallo stream PDF. |
| [extract(Stream stream, byte[] password)](#extract-com.aspose.threed.Stream-byte---) | Estrai contenuto 3D grezzo dallo stream PDF. |
| [extract(String fileName)](#extract-java.lang.String-) | Estrai contenuto 3D grezzo da un file PDF. |
| [extract(String fileName, byte[] password)](#extract-java.lang.String-byte---) | Estrai contenuto 3D grezzo da un file PDF. |
| [extractScene(Stream stream)](#extractScene-com.aspose.threed.Stream-) | Estrai contenuto 3D grezzo dallo stream PDF. |
| [extractScene(Stream stream, byte[] password)](#extractScene-com.aspose.threed.Stream-byte---) | Estrai contenuto 3D grezzo dallo stream PDF. |
| [extractScene(String fileName)](#extractScene-java.lang.String-) | Estrai scene 3D da un file PDF. |
| [extractScene(String fileName, byte[] password)](#extractScene-java.lang.String-byte---) | Estrai scene 3D da un file PDF. |
...
Estrai contenuto 3D grezzo dallo stream PDF.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | Stream del file PDF di input |

**Returns:**
java.util.ArrayList<byte[]> - Un elenco di tutti i contenuti 3D in byte, inclusi i formati che Aspose.3D non supporta. **Example:** Il codice seguente mostra come estrarre tutti i contenuti 3D grezzi da un file PDF 3D e scriverli in file.
...
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | Stream del file PDF di input |
| password | byte[] | Password del file PDF |
...
Estrai contenuto 3D grezzo da un file PDF.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| fileName | java.lang.String | Nome del file PDF di input |
...
**Returns:**
java.util.ArrayList<com.aspose.threed.Scene> - Elenco delle scene 3D decodificate supportate da Aspose.3D **Esempio:** Il codice seguente mostra come estrarre tutte le scene 3D supportate da un file PDF 3D e scriverle in formato obj.
...
Estrai scene 3D da un file PDF.

...
description: La classe base per configurare le opzioni di salvataggio dei file per diversi tipi
type: docs
weight: 160
url: /it/java/com.aspose.threed/saveoptions/
---
...
La classe base per configurare le opzioni di salvataggio dei file per diversi tipi
## Metodi

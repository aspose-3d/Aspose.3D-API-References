...
description: Definisce il gruppo di poligoni per i componenti specificati per raggruppare insieme i poligoni correlati.
type: docs
weight: 215
url: /it/java/com.aspose.threed/vertexelementpolygongroup/
---
...
Definisce il gruppo di poligoni per i componenti specificati per raggruppare insieme i poligoni correlati.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [VertexElementPolygonGroup()](#VertexElementPolygonGroup--) | Inizializza una nuova istanza della classe [VertexElementPolygonGroup](../../com.aspose.threed/vertexelementpolygongroup). |
## Metodi
...
| [copyTo(VertexElementIntsTemplate target)](#copyTo-com.aspose.threed.VertexElementIntsTemplate-) | Copia i dati nell'elemento specificato. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(int[] data)](#setData-int---) | Carica dati |
...
Inizializza una nuova istanza della classe [VertexElementPolygonGroup](../../com.aspose.threed/vertexelementpolygongroup).
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| target | [VertexElementIntsTemplate](../../com.aspose.threed/vertexelementintstemplate) | Obiettivo. |
...
**Returns:**
java.util.List<java.lang.Integer> - i dati del vertice

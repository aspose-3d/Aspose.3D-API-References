...
type: docs
weight: 225
url: /it/java/com.aspose.threed/vertexelementvisibility/
---
...
| --- | --- |
| [VertexElementVisibility()](#VertexElementVisibility--) | Inizializza una nuova istanza della classe [VertexElementVisibility](../../com.aspose.threed/vertexelementvisibility). |
## Metodi
...
| [copyTo(VertexElementTemplate<T> target)](#copyTo-com.aspose.threed.VertexElementTemplate-T--) | Copia i dati nell'elemento specificato. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(T[] data)](#setData-T---) | Carica dati |
...
Inizializza una nuova istanza della classe [VertexElementVisibility](../../com.aspose.threed/vertexelementvisibility).
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| target | [VertexElementTemplate](../../com.aspose.threed/vertexelementtemplate) | Obiettivo. |
...
**Returns:**
java.util.List<T> - i dati del vertice

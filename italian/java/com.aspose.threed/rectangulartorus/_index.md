...
type: docs
weight: 146
url: /it/java/com.aspose.threed/rectangulartorus/
---
...
| --- | --- |
| [RectangularTorus()](#RectangularTorus--) | Costruttore di [RectangularTorus](../../com.aspose.threed/rectangulartorus) |
| [RectangularTorus(String name)](#RectangularTorus-java.lang.String-) | Costruttore di [RectangularTorus](../../com.aspose.threed/rectangulartorus) |
## Metodi
...
| [getAngleStart()](#getAngleStart--) | L'angolo iniziale dell'arco, misurato in radianti. |
| [getArc()](#getArc--) | L'angolo totale dell'arco, misurato in radianti. |
...
| [getHeight()](#getHeight--) | L'altezza del toroide rettangolare. |
| [getInnerRadius()](#getInnerRadius--) | Il raggio interno del toroide rettangolare. Valore predefinito è 17 |
| [getName()](#getName--) | Ottiene il nome. |
| [getOuterRadius()](#getOuterRadius--) | Il raggio esterno del toroide rettangolare. Valore predefinito è 20 |
...
| [getRadialSegments()](#getRadialSegments--) | I segmenti radiali, valore predefinito è 10 |
...
| [setAngleStart(double value)](#setAngleStart-double-) | L'angolo iniziale dell'arco, misurato in radianti. |
| [setArc(double value)](#setArc-double-) | L'angolo totale dell'arco, misurato in radianti. |
...
| [setHeight(double value)](#setHeight-double-) | L'altezza del toroide rettangolare. |
| [setInnerRadius(double value)](#setInnerRadius-double-) | Il raggio interno del toroide rettangolare. Valore predefinito è 17 |
| [setName(String value)](#setName-java.lang.String-) | Imposta il nome. |
| [setOuterRadius(double value)](#setOuterRadius-double-) | Il raggio esterno del toroide rettangolare. Valore predefinito è 20 |
...
| [setRadialSegments(int value)](#setRadialSegments-int-) | I segmenti radiali, valore predefinito è 10 |
| [setReceiveShadows(boolean value)](#setReceiveShadows-boolean-) | Imposta se questa geometria può ricevere ombra. |
| [toMesh()](#toMesh--) | Converti questo primitivo in [Mesh](../../com.aspose.threed/mesh) |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Costruttore di [RectangularTorus](../../com.aspose.threed/rectangulartorus)
...
L'angolo iniziale dell'arco, misurato in radianti. Valore predefinito è 0

**Returns:**
double - L'angolo iniziale dell'arco, misurato in radianti. Il valore predefinito è 0
### getArc() {#getArc--}
```
...
**Returns:**
double - L'angolo totale dell'arco, misurato in radianti. Il valore predefinito è PI
...
**Returns:**
double - L'altezza del toro rettangolare. Il valore predefinito è 20
...
Il raggio interno del toroide rettangolare. Valore predefinito è 17

**Returns:**
double - Il raggio interno del toro rettangolare. Il valore predefinito è 17
### getName() {#getName--}
```
...
Il raggio esterno del toroide rettangolare. Valore predefinito è 20

**Returns:**
double - Il raggio esterno del toro rettangolare. Il valore predefinito è 20
...
I segmenti radiali, valore predefinito è 10

**Returns:**
int - I segmenti radiali, il valore predefinito è 10
...
Converti questo primitivo in [Mesh](../../com.aspose.threed/mesh)

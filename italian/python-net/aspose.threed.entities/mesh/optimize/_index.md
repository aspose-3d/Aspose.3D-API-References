...
type: docs
weight: 170
url: /it/python-net/aspose.threed.entities/mesh/optimize/
is_root: false
---
...
# Sphere.ToMesh genera 117 punti di controllo
mesh = Sphere().to_mesh()
# Dopo l'ottimizzazione, ci sono solo 86 punti di controllo, gli indici dei poligoni sono anche rimappati.

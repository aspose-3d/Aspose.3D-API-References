...
type: docs
weight: 50
url: /it/python-net/aspose.threed.entities/circle/
is_root: false
---
...
| :- | :- |
| [`__init__(self)`](/3d/python-net/aspose.threed.entities/circle/__init__/#) | Constructor of [`Circle`](/3d/python-net/aspose.threed.entities/circle) |
| [`__init__(self, radius)`](/3d/python-net/aspose.threed.entities/circle/__init__/#float) | Constructor of [`Circle`](/3d/python-net/aspose.threed.entities/circle) |
...
| Method | Description |
| :- | :- |
| [`remove_property(self, property)`](/3d/python-net/aspose.threed.entities/circle/remove_property/#aspose.threed.property) | Removes a dynamic property. |
| [`remove_property(self, property)`](/3d/python-net/aspose.threed.entities/circle/remove_property/#system.string) | Remove the specified property identified by name |
| [`get_property(self, property)`](/3d/python-net/aspose.threed.entities/circle/get_property/#system.string) | Get the value of specified property |
| [`set_property(self, property, value)`](/3d/python-net/aspose.threed.entities/circle/set_property/#system.string-system.object) | Sets the value of specified property |
| [`find_property(self, property_name)`](/3d/python-net/aspose.threed.entities/circle/find_property/#system.string) | Finds the property.
<br/>It can be a dynamic property (Created by CreateDynamicProperty/SetProperty) 
<br/>or native property(Identified by its name) |
| [`get_bounding_box(self)`](/3d/python-net/aspose.threed.entities/circle/get_bounding_box/#) | Gets the bounding box of current entity in its object space coordinate system. |
| [`get_entity_renderer_key(self)`](/3d/python-net/aspose.threed.entities/circle/get_entity_renderer_key/#) | Gets the key of the entity renderer registered in the renderer |

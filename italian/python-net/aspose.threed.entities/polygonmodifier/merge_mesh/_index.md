...
type: docs
weight: 60
url: /it/python-net/aspose.threed.entities/polygonmodifier/merge_mesh/
is_root: false
---
...
# Il file di input può contenere più oggetti
scene = Scene.from_file("input.fbx")
# ora uniscili in una singola mesh
merged = PolygonModifier.merge_mesh(scene)
# poi lo salviamo in un file con una sola mesh

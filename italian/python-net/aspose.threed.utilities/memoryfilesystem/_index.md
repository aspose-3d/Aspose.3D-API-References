...
type: docs
weight: 130
url: /it/python-net/aspose.threed.utilities/memoryfilesystem/
is_root: false
---
...
with BytesIO() as ms:
    scene.save(ms, opt)
# Il test.obj è stato scritto nella variabile ms, e possiamo anche ottenere il contenuto del file test.mtl tramite

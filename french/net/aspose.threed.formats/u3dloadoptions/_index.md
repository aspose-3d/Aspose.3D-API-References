...
description: Options de chargement pour 3d universel
type: docs
weight: 1370
url: /fr/net/aspose.threed.formats/u3dloadoptions/
---
## U3dLoadOptions class

Options de chargement pour 3d universel
...
| Nom | La description |
| --- | --- |
| [U3dLoadOptions](u3dloadoptions)() | Constructeur de[`U3dLoadOptions`](../u3dloadoptions) |
...
| [FlipCoordinateSystem](../../aspose.threed.formats/u3dloadoptions/flipcoordinatesystem) { get; set; } | Obtient ou définit si le système de coordonnées d'inversion des points de contrôle/normal lors de l'importation/exportation. |

...
description: Charger les options pour les fichiers PLY
type: docs
weight: 1290
url: /fr/net/aspose.threed.formats/plyloadoptions/
---
## PlyLoadOptions class

Charger les options pour les fichiers PLY
...
| Nom | La description |
| --- | --- |
| [PlyLoadOptions](plyloadoptions)() | Constructeur de[`PlyLoadOptions`](../plyloadoptions) |
...
| [FlipCoordinateSystem](../../aspose.threed.formats/plyloadoptions/flipcoordinatesystem) { get; set; } | Obtient ou définit le système de coordonnées d'inversion des points de contrôle/de la normale lors de l'importation/exportation. |

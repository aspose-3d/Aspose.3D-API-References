...
| Nom | La description |
| --- | --- |
| [Shape](shape#constructor)() | Initialise une nouvelle instance du[`Shape`](../shape) classe. |
| [Shape](shape#constructor_1)(string) | Initialise une nouvelle instance du[`Shape`](../shape) classe. |
...
| [Indices](../../aspose.threed.entities/shape/indices) { get; } | Obtient les indices. |
...
| Nom | La description |
| --- | --- |
| static [FromControlPoints](../../aspose.threed.entities/shape/fromcontrolpoints)(params Vector3[]) | Créer une forme avec des points de contrôle spécifiés avec des indices par défaut. |

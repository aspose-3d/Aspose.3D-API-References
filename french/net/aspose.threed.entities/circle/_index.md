...
description: ACircle./circle courbe se compose dun ensemble de points dans le bord de la forme du cercle.
type: docs
weight: 260
url: /fr/net/aspose.threed.entities/circle/
---
## Circle class

A[`Circle`](../circle) courbe se compose d'un ensemble de points dans le bord de la forme du cercle.
...
| Nom | La description |
| --- | --- |
| [Circle](circle#constructor)() | Constructeur de[`Circle`](../circle) |
| [Circle](circle#constructor_1)(double) | Constructeur de[`Circle`](../circle) |
...
| [Radius](../../aspose.threed.entities/circle/radius) { get; set; } | Le rayon de la courbe circulaire, la valeur par défaut est 10 |

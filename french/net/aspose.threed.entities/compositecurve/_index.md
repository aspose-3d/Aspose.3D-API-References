...
description: ACompositeCurve./compositecurve se compose de plusieurs segments de courbe.
type: docs
weight: 270
url: /fr/net/aspose.threed.entities/compositecurve/
---
## CompositeCurve class

A[`CompositeCurve`](../compositecurve) se compose de plusieurs segments de courbe.
...
| Nom | La description |
| --- | --- |
| [CompositeCurve](compositecurve)() | Constructeur de[`CompositeCurve`](../compositecurve) |
...
| [Segments](../../aspose.threed.entities/compositecurve/segments) { get; } | Les segments de la courbe. |

## Méthodes

| Nom | La description |
| --- | --- |
| [AddSegment](../../aspose.threed.entities/compositecurve/addsegment)(Curve, bool) | Le |

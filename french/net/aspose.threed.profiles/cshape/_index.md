...
description: Profil en forme de C compatible IFC défini par des paramètres. La position centrale du profil est au centre de la boîte englobante.
type: docs
weight: 1520
url: /fr/net/aspose.threed.profiles/cshape/
---
## CShape class

Profil en forme de C compatible IFC défini par des paramètres. La position centrale du profil est au centre de la boîte englobante.
...
| Nom | La description |
| --- | --- |
| [CShape](cshape)() | Constructeur de[`CShape`](../cshape) |

## Propriétés

| Nom | La description |
| --- | --- |
| [Depth](../../aspose.threed.profiles/cshape/depth) { get; set; } | Obtient ou définit la profondeur du profil. |
| [Excluded](../../aspose.threed/entity/excluded) { get; set; } | Obtient ou définit s'il faut exclure cette entité lors de l'exportation. |
| [Girth](../../aspose.threed.profiles/cshape/girth) { get; set; } | Obtient ou définit la longueur de la circonférence. |
| [InternalFilletRadius](../../aspose.threed.profiles/cshape/internalfilletradius) { get; set; } | Obtient ou définit le rayon de congé interne. |
...
| [WallThickness](../../aspose.threed.profiles/cshape/wallthickness) { get; set; } | Obtient ou définit l'épaisseur du mur. |
| [Width](../../aspose.threed.profiles/cshape/width) { get; set; } | Obtient ou définit la largeur du profil. |
...
| override [GetExtent](../../aspose.threed.profiles/cshape/getextent)() | Obtient l'étendue dans les dimensions x et y. |

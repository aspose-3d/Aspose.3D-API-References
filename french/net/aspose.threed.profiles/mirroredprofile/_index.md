...
description: Profil miroir compatible IFC. Ce profil définit un nouveau profil en reflétant le profil de base autour de laxe y.
type: docs
weight: 1590
url: /fr/net/aspose.threed.profiles/mirroredprofile/
---
...
| Nom | La description |
| --- | --- |
| [MirroredProfile](mirroredprofile)(Profile) | Construire un nouveau[`MirroredProfile`](../mirroredprofile) à partir d'un profil existant. |

## Propriétés

| Nom | La description |
| --- | --- |
| [BaseProfile](../../aspose.threed.profiles/mirroredprofile/baseprofile) { get; } | Le profil de base à mettre en miroir. |

...
description: Profil de cercle compatible IFC qui peut être utilisé pour construire un maillage à traversLinearExtrusion../aspose.threed.entities/linearextrusion
type: docs
weight: 1530
url: /fr/net/aspose.threed.profiles/circleshape/
---
## CircleShape class

Profil de cercle compatible IFC, qui peut être utilisé pour construire un maillage à travers[`LinearExtrusion`](../../aspose.threed.entities/linearextrusion)
...
| Nom | La description |
| --- | --- |
| [CircleShape](circleshape#constructor)() | Construire un[`CircleShape`](../circleshape) profil avec rayon par défaut (5). |
| [CircleShape](circleshape#constructor_1)(double) | Construire un[`CircleShape`](../circleshape) profil avec rayon spécifié. |

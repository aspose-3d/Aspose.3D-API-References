...
description: Cette classe vous permet de construire un profil 2D directement à partir dune courbe arbitraire.
type: docs
weight: 1510
url: /fr/net/aspose.threed.profiles/arbitraryprofile/
---
...
| Nom | La description |
| --- | --- |
| [ArbitraryProfile](arbitraryprofile#constructor)() | Constructeur de[`ArbitraryProfile`](../arbitraryprofile) |
| [ArbitraryProfile](arbitraryprofile#constructor_1)(Curve) | Constructeur de[`ArbitraryProfile`](../arbitraryprofile) avec une courbe initiale. |

## Propriétés

| Nom | La description |
| --- | --- |
| [Curve](../../aspose.threed.profiles/arbitraryprofile/curve) { get; set; } | La courbe utilisée pour construire le profil |

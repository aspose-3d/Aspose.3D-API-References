...
description: "représente un espace infini qui est divisé par un plan, cela peut être utilisé avec"
type: docs
weight: 77
url: /fr/java/com.aspose.threed/halfspace/
---
...
| --- | --- |
| [HalfSpace()](#HalfSpace--) | Construit une nouvelle instance de [HalfSpace](../../com.aspose.threed/halfspace) |
| [HalfSpace(Vector3 normal, Vector3 position)](#HalfSpace-com.aspose.threed.Vector3-com.aspose.threed.Vector3-) | Construit une nouvelle instance de [HalfSpace](../../com.aspose.threed/halfspace) avec le vecteur normal donné et une position sur le plan de coupe ; |
## Méthodes
...
| [getNormal()](#getNormal--) | La normale du plan de division, le plan est défini comme N \* P + D = 0 où N est la normale et P est n'importe quel point du plan. |
...
| [getPosition()](#getPosition--) | Le point quelconque sur le plan de division, le plan est défini comme N \* P + D = 0 où N est la normale et P est n'importe quel point du plan. |
...
| [setNormal(Vector3 value)](#setNormal-com.aspose.threed.Vector3-) | La normale du plan de division, le plan est défini comme N \* P + D = 0 où N est la normale et P est n'importe quel point du plan. |
...
| [setPosition(Vector3 value)](#setPosition-com.aspose.threed.Vector3-) | Le point quelconque sur le plan de division, le plan est défini comme N \* P + D = 0 où N est la normale et P est n'importe quel point du plan. |
...
Construit une nouvelle instance de [HalfSpace](../../com.aspose.threed/halfspace)
...
Construit une nouvelle instance de [HalfSpace](../../com.aspose.threed/halfspace) avec le vecteur normal donné et une position sur le plan de coupe ;
...
La normale du plan de division, le plan est défini comme N \* P + D = 0 où N est la normale et P est n'importe quel point du plan.
...
Le point quelconque sur le plan de division, le plan est défini comme N \* P + D = 0 où N est la normale et P est n'importe quel point du plan.

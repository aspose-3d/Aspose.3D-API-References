...
description: "Instance de format de fichier pour Microsoft 3MF avec des utilitaires liés à 3MF."
type: docs
weight: 104
url: /fr/java/com.aspose.threed/microsoft3mfformat/
---
...
Instance de format de fichier pour Microsoft 3MF avec des utilitaires liés à 3MF.
## Champs
...
| [getObjectType(Node node)](#getObjectType-com.aspose.threed.Node-) | Obtient le type de modèle pour le nœud spécifié. |
| [getTransformForBuild(Node node)](#getTransformForBuild-com.aspose.threed.Node-) | Obtient la matrice de transformation pour le nœud utilisé dans la construction. |
| [getVersion()](#getVersion--) | Obtient la version du format de fichier |
| [hashCode()](#hashCode--) |  |
| [isBuildable(Node node)](#isBuildable-com.aspose.threed.Node-) | Vérifie si ce nœud est marqué comme une construction. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBuildable(Node node, boolean value, Matrix4 transform)](#setBuildable-com.aspose.threed.Node-boolean-com.aspose.threed.Matrix4-) | Marque un nœud pour la construction. |
| [setObjectType(Node node, String modelType)](#setObjectType-com.aspose.threed.Node-java.lang.String-) | Définit le type de modèle pour le nœud spécifié. |
...
Obtient le type de modèle pour le nœud spécifié.
...
**Returns:**
java.lang.String - type d'objet 3MF pour le nœud donné
...
Obtient la matrice de transformation pour le nœud utilisé dans la construction.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Quel nœud obtenir la matrice de transformation pour la construction 3MF. |
...
Vérifie si ce nœud est marqué comme une construction.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Quel nœud vérifier |

**Returns:**
boolean - True si il est marqué comme une construction
### notify() {#notify--}
```
...
Marque un nœud pour la construction.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Quel nœud marquer comme une construction. |
| valeur | boolean |  |
| transform | [Matrix4](../../com.aspose.threed/matrix4) | La transformation du nœud dans la construction. |
...
Définit le type de modèle pour le nœud spécifié. Valeur possible : model surface solidsupport support other

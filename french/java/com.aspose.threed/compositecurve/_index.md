...
description: "Un  est composé de plusieurs segments de courbe."
type: docs
weight: 34
url: /fr/java/com.aspose.threed/compositecurve/
---
...
Un [CompositeCurve](../../com.aspose.threed/compositecurve) est composé de plusieurs segments de courbe.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [CompositeCurve()](#CompositeCurve--) | Constructeur de [CompositeCurve](../../com.aspose.threed/compositecurve) |
## Méthodes

| Méthode | Description |
| --- | --- |
| [addSegment(Curve curve)](#addSegment-com.aspose.threed.Curve-) | Ajouter un nouveau segment à la courbe actuelle. |
| [addSegment(Curve curve, boolean sameDirection)](#addSegment-com.aspose.threed.Curve-boolean-) | Ajouter un nouveau segment à la courbe actuelle. |
...
| [getSegments()](#getSegments--) | Les segments de la courbe. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Constructeur de [CompositeCurve](../../com.aspose.threed/compositecurve)
...
Ajouter un nouveau segment à la courbe actuelle.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | La courbe à ajouter |
...
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | La courbe à ajouter |
| sameDirection | boolean | Même direction que la courbe actuelle. |
...
**Returns:**
java.util.ArrayList<com.aspose.threed.CompositeCurve.Segment> - Les segments de la courbe.
### hashCode() {#hashCode--}
```

...
description: "Options d'enregistrement pour le fichier wavefront obj"
type: docs
weight: 116
url: /fr/java/com.aspose.threed/objsaveoptions/
---
...
Options d'enregistrement pour le fichier wavefront obj
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [ObjSaveOptions()](#ObjSaveOptions--) | Constructeur de [ObjSaveOptions](../../com.aspose.threed/objsaveoptions) |
## Méthodes
...
| [getAxisSystem()](#getAxisSystem--) | Obtient le système d'axes dans le fichier exporté. |
| [getClass()](#getClass--) |  |
| [getEnableMaterials()](#getEnableMaterials--) | Obtient si les matériaux d'import/export sont appliqués à chaque objet |
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | Obtient si le système de coordonnées des points de contrôle/normales est inversé lors de l'importation/exportation. |
...
| [getPointCloud()](#getPointCloud--) | Obtient le drapeau indiquant si l'exportateur doit exporter la scène sous forme de nuage de points (sans structure topologique), la valeur par défaut est false |
| [getSerializeW()](#getSerializeW--) | Obtient si le composant W doit être sérialisé dans la position des sommets du modèle |
| [getVerbose()](#getVerbose--) | Obtient si des commentaires sont générés pour chaque section |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setAxisSystem(AxisSystem value)](#setAxisSystem-com.aspose.threed.AxisSystem-) | Définit le système d'axes dans le fichier exporté. |
| [setEnableMaterials(boolean value)](#setEnableMaterials-boolean-) | Définit si les matériaux d'import/export sont appliqués à chaque objet |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | Définit si le système de coordonnées des points de contrôle/normales est inversé lors de l'importation/exportation. |
...
| [setPointCloud(boolean value)](#setPointCloud-boolean-) | Définit le drapeau indiquant si l'exportateur doit exporter la scène sous forme de nuage de points (sans structure topologique), la valeur par défaut est false |
| [setSerializeW(boolean value)](#setSerializeW-boolean-) | Définit s'il faut sérialiser le composant W dans la position des sommets du modèle. |
| [setVerbose(boolean value)](#setVerbose-boolean-) | Définit s'il faut générer des commentaires pour chaque section |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Constructeur de [ObjSaveOptions](../../com.aspose.threed/objsaveoptions)
...
Obtient si les matériaux d'import/export sont appliqués à chaque objet

**Returns:**
booléen - s'il faut importer/exporter les matériaux pour chaque objet
...
Obtient si le système de coordonnées des points de contrôle/normales est inversé lors de l'importation/exportation.

**Returns:**
booléen - indique si le système de coordonnées des points de contrôle/normales est inversé lors de l'importation/exportation.
...
Obtient le drapeau indiquant si l'exportateur doit exporter la scène sous forme de nuage de points (sans structure topologique), la valeur par défaut est false

**Returns:**
booléen - le drapeau indiquant si l'exportateur doit exporter la scène sous forme de nuage de points (sans structure topologique), la valeur par défaut est false
...
Obtient si le composant W doit être sérialisé dans la position des sommets du modèle

**Returns:**
booléen - s'il faut sérialiser le composant W dans la position des sommets du modèle.
...
Obtient si des commentaires sont générés pour chaque section

**Returns:**
booléen - s'il faut générer des commentaires pour chaque section
### hashCode() {#hashCode--}
```
...
Définit si les matériaux d'import/export sont appliqués à chaque objet
...
Définit si le système de coordonnées des points de contrôle/normales est inversé lors de l'importation/exportation.
...
Définit le drapeau indiquant si l'exportateur doit exporter la scène sous forme de nuage de points (sans structure topologique), la valeur par défaut est false
...
Définit s'il faut sérialiser le composant W dans la position des sommets du modèle.
...
Définit s'il faut générer des commentaires pour chaque section

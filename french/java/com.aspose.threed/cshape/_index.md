...
description: "Profil en forme de C compatible IFC défini par des paramètres."
type: docs
weight: 27
url: /fr/java/com.aspose.threed/cshape/
---
...
Profil C-shape compatible IFC défini par des paramètres. La position centrale du profil se trouve au centre de la boîte englobante.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [CShape()](#CShape--) | Constructeur de [CShape](../../com.aspose.threed/cshape) |
## Méthodes
...
| [getGirth()](#getGirth--) | Obtient la longueur du girth. |
| [getInternalFilletRadius()](#getInternalFilletRadius--) | Obtient le rayon du congé interne. |
...
| [getWallThickness()](#getWallThickness--) | Obtient l'épaisseur du mur. |
...
| [setGirth(double value)](#setGirth-double-) | Définit la longueur du girth. |
| [setInternalFilletRadius(double value)](#setInternalFilletRadius-double-) | Définit le rayon du congé interne. |
...
| [setWallThickness(double value)](#setWallThickness-double-) | Définit l'épaisseur du mur. |
...
Constructeur de [CShape](../../com.aspose.threed/cshape)
...
Obtient la longueur du girth.

**Returns:**
double - la longueur du girth.
...
Obtient le rayon du congé interne.

**Returns:**
double - le rayon du congé interne.
### getName() {#getName--}
```
...
Définit le rayon du congé interne.

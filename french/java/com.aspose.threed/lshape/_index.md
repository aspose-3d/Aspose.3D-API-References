...
type: docs
weight: 91
url: /fr/java/com.aspose.threed/lshape/
---
...
| --- | --- |
| [LShape()](#LShape--) | Constructeur de [LShape](../../com.aspose.threed/lshape) |
## Méthodes
...
| [getClass()](#getClass--) |  |
| [getDepth()](#getDepth--) | Obtient la profondeur du profil. |
| [getEdgeRadius()](#getEdgeRadius--) | Obtient le rayon du bord. |
...
| [getFilletRadius()](#getFilletRadius--) | Obtient le rayon de l'arrondi. |
...
| [getThickness()](#getThickness--) | Obtient l'épaisseur du mur constant. |
| [getWidth()](#getWidth--) | Obtient la largeur du profil. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setDepth(double value)](#setDepth-double-) | Définit la profondeur du profil. |
| [setEdgeRadius(double value)](#setEdgeRadius-double-) | Définit le rayon du bord. |
| [setExcluded(boolean value)](#setExcluded-boolean-) | Définit si l'entité doit être exclue lors de l'exportation. |
| [setFilletRadius(double value)](#setFilletRadius-double-) | Définit le rayon de l'arrondi. |
...
| [setThickness(double value)](#setThickness-double-) | Définit l'épaisseur du mur constant. |
| [setWidth(double value)](#setWidth-double-) | Définit la largeur du profil. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Constructeur de [LShape](../../com.aspose.threed/lshape)
...
Obtient la profondeur du profil.

**Returns:**
double - la profondeur du profil.
...
Obtient le rayon du bord.

**Returns:**
double - le rayon du bord.
...
Obtient le rayon de l'arrondi.

**Returns:**
double - le rayon de l'arrondi.
### getName() {#getName--}
```
...
Obtient l'épaisseur du mur constant.

**Returns:**
double - l'épaisseur du mur constant.
### getWidth() {#getWidth--}
```
...
Définit la profondeur du profil.
...
Définit l'épaisseur du mur constant.

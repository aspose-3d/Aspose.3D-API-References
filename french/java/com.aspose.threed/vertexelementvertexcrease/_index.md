...
description: "Définit le pli du sommet pour les composants spécifiés"
type: docs
weight: 224
url: /fr/java/com.aspose.threed/vertexelementvertexcrease/
---
...
| --- | --- |
| [VertexElementVertexCrease()](#VertexElementVertexCrease--) | Initialise une nouvelle instance de la classe [VertexElementVertexCrease](../../com.aspose.threed/vertexelementvertexcrease). |
## Méthodes
...
| [copyTo(VertexElementDoublesTemplate target)](#copyTo-com.aspose.threed.VertexElementDoublesTemplate-) | Copie les données vers l'élément spécifié. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(double[] data)](#setData-double---) | Charge les données. |
...
Initialise une nouvelle instance de la classe [VertexElementVertexCrease](../../com.aspose.threed/vertexelementvertexcrease).
...
| Paramètre | Type | Description |
| --- | --- | --- |
| target | [VertexElementDoublesTemplate](../../com.aspose.threed/vertexelementdoublestemplate) | Cible. |
...
**Returns:**
java.util.List<java.lang.Double> - les données du sommet

...
description: "Options d'enregistrement pour STL"
type: docs
weight: 177
url: /fr/java/com.aspose.threed/stlsaveoptions/
---
...
Options d'enregistrement pour STL
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [StlSaveOptions()](#StlSaveOptions--) | Initialise une nouvelle instance de [StlSaveOptions](../../com.aspose.threed/stlsaveoptions). |
| [StlSaveOptions(FileContentType contentType)](#StlSaveOptions-com.aspose.threed.FileContentType-) | Initialise une nouvelle instance de [StlSaveOptions](../../com.aspose.threed/stlsaveoptions). |
## Méthodes
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | Obtient si le système de coordonnées doit être inversé pour les points de contrôle/normales lors de l'exportation. |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | Définit si le système de coordonnées doit être inversé pour les points de contrôle/normales lors de l'exportation. |
...
Initialise une nouvelle instance de [StlSaveOptions](../../com.aspose.threed/stlsaveoptions).
...
Obtient si le système de coordonnées doit être inversé pour les points de contrôle/normales lors de l'exportation.

**Returns:**
booléen - indique si le système de coordonnées des points de contrôle/normales doit être inversé lors de l'exportation.
...
Définit si le système de coordonnées doit être inversé pour les points de contrôle/normales lors de l'exportation.

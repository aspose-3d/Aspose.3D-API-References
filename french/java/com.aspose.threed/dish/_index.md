...
description: "Plat paramétré."
type: docs
weight: 45
url: /fr/java/com.aspose.threed/dish/
---
...
| --- | --- |
| [Dish()](#Dish--) | Créer une nouvelle instance de dish avec un rayon par défaut (10) et une hauteur par défaut (5) |
| [Dish(double radius, double height)](#Dish-double-double-) | Créer une nouvelle instance de dish avec le rayon et la hauteur spécifiés |
| [Dish(String name, double radius, double height, int widthSegments, int heightSegments)](#Dish-java.lang.String-double-double-int-int-) | Créer une nouvelle instance de dish avec le rayon et la hauteur spécifiés |
## Méthodes
...
| [getHeight()](#getHeight--) | Hauteur du dish |
...
| [getRadius()](#getRadius--) | Rayon du plat |
...
| [setHeight(double value)](#setHeight-double-) | Hauteur du dish |
...
| [setRadius(double value)](#setRadius-double-) | Rayon du plat |
...
Créer une nouvelle instance de dish avec un rayon par défaut (10) et une hauteur par défaut (5)
...
Créer une nouvelle instance de dish avec le rayon et la hauteur spécifiés

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| radius | double | Le rayon du plat |
| hauteur | double | La hauteur du plat |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| nom | java.lang.String | Le nom du plat |
| radius | double | Le rayon du plat |
| hauteur | double | La hauteur du plat |
| widthSegments | int | Le segment de largeur du plat |
| heightSegments | int | Le segment de hauteur du plat |

...
description: "Options de chargement pour le format glTF"
type: docs
weight: 73
url: /fr/java/com.aspose.threed/gltfloadoptions/
---
...
Options de chargement pour le format glTF
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [GltfLoadOptions()](#GltfLoadOptions--) | Constructeur de [GltfLoadOptions](../../com.aspose.threed/gltfloadoptions) |
## Méthodes
...
| [getFlipTexCoordV()](#getFlipTexCoordV--) | Inverser la coordonnée v(t) dans les coordonnées de texture du maillage, la valeur par défaut est true. |
...
| [setFlipTexCoordV(boolean value)](#setFlipTexCoordV-boolean-) | Inverser la coordonnée v(t) dans les coordonnées de texture du maillage, la valeur par défaut est true. |
...
Constructeur de [GltfLoadOptions](../../com.aspose.threed/gltfloadoptions)
...
Inverser la coordonnée v(t) dans les coordonnées de texture du maillage, la valeur par défaut est true.

**Returns:**
booléen - Inverser la coordonnée v(t) dans les coordonnées de texture du maillage, la valeur par défaut est true.

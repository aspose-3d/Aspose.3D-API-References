...
description: "Forme en T compatible IFC définie par des paramètres."
type: docs
weight: 182
url: /fr/java/com.aspose.threed/tshape/
---
...
Forme en T compatible IFC définie par des paramètres.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [TShape()](#TShape--) | Constructeur de [TShape](../../com.aspose.threed/tshape) |
## Méthodes
...
| [getFilletRadius()](#getFilletRadius--) | Obtient le rayon du congé entre le web et la bride. |
| [getFlangeEdgeRadius()](#getFlangeEdgeRadius--) | Obtient le rayon du bord de la bride. |
| [getFlangeThickness()](#getFlangeThickness--) | Obtient l'épaisseur de paroi de la bride. |
...
| [getWebEdgeRadius()](#getWebEdgeRadius--) | Obtient le rayon du bord du web. |
| [getWebThickness()](#getWebThickness--) | Obtient l'épaisseur de paroi du web. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFilletRadius(double value)](#setFilletRadius-double-) | Définit le rayon du congé entre le web et la bride. |
| [setFlangeEdgeRadius(double value)](#setFlangeEdgeRadius-double-) | Définit le rayon du bord de la bride. |
| [setFlangeThickness(double value)](#setFlangeThickness-double-) | Définit l'épaisseur de paroi de la bride. |
...
| [setWebEdgeRadius(double value)](#setWebEdgeRadius-double-) | Définit le rayon du bord du web. |
| [setWebThickness(double value)](#setWebThickness-double-) | Définit l'épaisseur de paroi du web. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Constructeur de [TShape](../../com.aspose.threed/tshape)
...
Obtient le rayon du congé entre le web et la bride.

**Returns:**
double - le rayon du congé entre le web et la bride.
...
Obtient le rayon du bord de la bride.

**Returns:**
double - le rayon du bord de la bride.
...
Obtient l'épaisseur de paroi de la bride.

**Returns:**
double - l'épaisseur de paroi de la bride.
...
Obtient le rayon du bord du web.

**Returns:**
double - le rayon du bord du web.
...
Obtient l'épaisseur de paroi du web.

**Returns:**
double - l'épaisseur de paroi du web.
### hashCode() {#hashCode--}
```
...
Définit le rayon du congé entre le web et la bride.
...
Définit le rayon du bord de la bride.
...
Définit l'épaisseur de paroi de la bride.
...
Définit le rayon du bord du web.
...
Définit l'épaisseur de paroi du web.

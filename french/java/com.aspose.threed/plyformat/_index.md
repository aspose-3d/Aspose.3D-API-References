...
type: docs
weight: 129
url: /fr/java/com.aspose.threed/plyformat/
---
...
| [decode(Stream stream)](#decode-com.aspose.threed.Stream-) | Décode un nuage de points ou un maillage depuis le flux spécifié. |
| [decode(Stream stream, PlyLoadOptions opt)](#decode-com.aspose.threed.Stream-com.aspose.threed.PlyLoadOptions-) | Décode un nuage de points ou un maillage depuis le flux spécifié. |
| [decode(String fileName)](#decode-java.lang.String-) | Décode un nuage de points ou un maillage depuis le flux spécifié. |
| [decode(String fileName, PlyLoadOptions opt)](#decode-java.lang.String-com.aspose.threed.PlyLoadOptions-) | Décode un nuage de points ou un maillage depuis le flux spécifié. |
...
| [encode(Entity entity, Stream stream)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-) | Encode l'entité et enregistre le résultat dans le flux. |
| [encode(Entity entity, Stream stream, PlySaveOptions opt)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-com.aspose.threed.PlySaveOptions-) | Encode l'entité et enregistre le résultat dans le flux. |
| [encode(Entity entity, String fileName)](#encode-com.aspose.threed.Entity-java.lang.String-) | Encode l'entité et enregistre le résultat dans un fichier externe. |
| [encode(Entity entity, String fileName, PlySaveOptions opt)](#encode-com.aspose.threed.Entity-java.lang.String-com.aspose.threed.PlySaveOptions-) | Encode l'entité et enregistre le résultat dans un fichier externe. |
...
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | Le flux d'entrée |
...
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | Le flux d'entrée |
| opt | [PlyLoadOptions](../../com.aspose.threed/plyloadoptions) | L'option de chargement du format PLY |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| fileName | java.lang.String | Le flux d'entrée |
...
|  | stream | [Stream](../../com.aspose.threed/stream) | Le flux d'écriture, cette méthode ne fermera pas ce flux **Exemple:** Le code suivant montre comment encoder un maillage dans un fichier PLY : |

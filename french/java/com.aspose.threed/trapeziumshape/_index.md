...
description: "Forme trapézoïdale compatible IFC définie par des paramètres."
type: docs
weight: 193
url: /fr/java/com.aspose.threed/trapeziumshape/
---
...
Forme trapézoïdale compatible IFC définie par des paramètres.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [TrapeziumShape()](#TrapeziumShape--) | Constructeur de [TrapeziumShape](../../com.aspose.threed/trapeziumshape) |
## Méthodes
...
| [getBottomXDim()](#getBottomXDim--) | Obtient l'étendue de la ligne inférieure mesurée le long de l'axe x. |
...
| [getTopXDim()](#getTopXDim--) | Obtient l'étendue de la ligne supérieure mesurée le long de l'axe x. |
| [getTopXOffset()](#getTopXOffset--) | Obtient le décalage du début de la ligne supérieure à la ligne inférieure. |
| [getYDim()](#getYDim--) | Obtient la distance entre les lignes supérieure et inférieure mesurée le long de l'axe y. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setBottomXDim(double value)](#setBottomXDim-double-) | Définit l'étendue de la ligne inférieure mesurée le long de l'axe x. |
...
| [setTopXDim(double value)](#setTopXDim-double-) | Définit l'étendue de la ligne supérieure mesurée le long de l'axe x. |
| [setTopXOffset(double value)](#setTopXOffset-double-) | Définit le décalage du début de la ligne supérieure à la ligne inférieure. |
| [setYDim(double value)](#setYDim-double-) | Définit la distance entre les lignes supérieure et inférieure mesurée le long de l'axe y. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Constructeur de [TrapeziumShape](../../com.aspose.threed/trapeziumshape)
...
Obtient l'étendue de la ligne inférieure mesurée le long de l'axe x.

**Returns:**
double - l'étendue de la ligne inférieure mesurée le long de l'axe x.
...
Obtient l'étendue de la ligne supérieure mesurée le long de l'axe x.

**Returns:**
double - l'étendue de la ligne supérieure mesurée le long de l'axe x.
...
Obtient le décalage du début de la ligne supérieure à la ligne inférieure.

**Returns:**
double - le décalage du début de la ligne supérieure à la ligne inférieure.
### getYDim() {#getYDim--}
```
...
Obtient la distance entre les lignes supérieure et inférieure mesurée le long de l'axe y.

**Returns:**
double - la distance entre les lignes supérieure et inférieure mesurée le long de l'axe y.
### hashCode() {#hashCode--}
```
...
Définit l'étendue de la ligne inférieure mesurée le long de l'axe x.
...
Définit l'étendue de la ligne supérieure mesurée le long de l'axe x.
...
Définit le décalage du début de la ligne supérieure à la ligne inférieure.
...
Définit la distance entre les lignes supérieure et inférieure mesurée le long de l'axe y.

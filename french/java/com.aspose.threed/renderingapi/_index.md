...
description: "API de rendu couramment utilisées"
type: docs
weight: 269
url: /fr/java/com.aspose.threed/renderingapi/
---
...
API de rendu couramment utilisées
## Champs

| Champ | Description |
| --- | --- |
| [ARNOLD](#ARNOLD) | Moteur de rendu Arnold |
| [CUSTOM](#CUSTOM) | API de rendu personnalisée |
| [DIRECTX](#DIRECTX) | DirectX |
| [MANTLE](#MANTLE) | AMD Mantle |
| [MENTAL_RAY](#MENTAL-RAY) | MentalRay |
| [METAL](#METAL) | Metal développé par Apple |
| [NONE](#NONE) | Aucune API de rendu |
| [OPENGL](#OPENGL) | OpenGL |
| [OPENGLES](#OPENGLES) | OpenGL ES |
| [PREVIEW](#PREVIEW) | PreviewColorAPI, compatible avec FBX |
| [RENDER_MAN](#RENDER-MAN) | RenderMan |
| [RENDER_WARE](#RENDER-WARE) | RenderWare |
| [SHADERFX](#SHADERFX) | Moteur de rendu ShaderFX |
| [STAGE3D](#STAGE3D) | Stage3D utilisé dans Adobe Flash |
...
PreviewColorAPI, compatible avec FBX
...
Stage3D utilisé dans Adobe Flash

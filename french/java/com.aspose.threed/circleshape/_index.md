...
description: "Profil circulaire compatible IFC qui peut être utilisé pour construire un maillage via"
type: docs
weight: 32
url: /fr/java/com.aspose.threed/circleshape/
---
...
Profil circulaire compatible IFC, qui peut être utilisé pour construire un maillage via [LinearExtrusion](../../com.aspose.threed/linearextrusion)
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [CircleShape()](#CircleShape--) | Construit un profil [CircleShape](../../com.aspose.threed/circleshape) avec un rayon par défaut (5). |
| [CircleShape(double radius)](#CircleShape-double-) | Construit un profil [CircleShape](../../com.aspose.threed/circleshape) avec le rayon spécifié. |
## Méthodes
...
Construit un profil [CircleShape](../../com.aspose.threed/circleshape) avec un rayon par défaut (5).
...
Construit un profil [CircleShape](../../com.aspose.threed/circleshape) avec le rayon spécifié.

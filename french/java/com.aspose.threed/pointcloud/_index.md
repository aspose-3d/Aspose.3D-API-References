...
description: "Le nuage de points ne contient aucune information de topologie, seulement les points de contrôle et les éléments de sommet."
type: docs
weight: 132
url: /fr/java/com.aspose.threed/pointcloud/
---
...
| --- | --- |
| [PointCloud(String name)](#PointCloud-java.lang.String-) | Constructeur de [PointCloud](../../com.aspose.threed/pointcloud) |
| [PointCloud()](#PointCloud--) | Constructeur de [PointCloud](../../com.aspose.threed/pointcloud) |
## Méthodes
...
| [fromGeometry(Geometry g)](#fromGeometry-com.aspose.threed.Geometry-) | Créer une nouvelle instance de PointCloud à partir d'un objet géométrique |
| [fromGeometry(Geometry g, int density)](#fromGeometry-com.aspose.threed.Geometry-int-) | Créer une nouvelle instance de nuage de points à partir d'un objet géométrique. |
...
| [getDimension()](#getDimension--) | Si une valeur de dimension est présente pour le nuage de points, cela indique un nuage de points organisé. |
...
| [setDimension(Vector2 value)](#setDimension-com.aspose.threed.Vector2-) | Si une valeur de dimension est présente pour le nuage de points, cela indique un nuage de points organisé. |
...
Constructeur de [PointCloud](../../com.aspose.threed/pointcloud)

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| nom | java.lang.String | Le nom de cette entité |
...
Créer une nouvelle instance de PointCloud à partir d'un objet géométrique
...
Créer une nouvelle instance de nuage de points à partir d'un objet géométrique. La densité est le nombre de points par triangle unité (Le triangle unité est le triangle avec la surface maximale du maillage)

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| g | [Geometry](../../com.aspose.threed/geometry) | Instance de maillage ou autre géométrie |
| densité | int | Nombre de points par triangle unité |
...
Si une valeur de dimension est présente pour le nuage de points, cela indique un nuage de points organisé. Sans taille spécifiée, il est considéré comme un nuage de points non organisé. Un nuage de points organisé signifie qu'il possède une structure similaire à une image.

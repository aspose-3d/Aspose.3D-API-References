...
description: "L'opérateur booléen vous permet d'appliquer une opération booléenne sur deux instances."
type: docs
weight: 23
url: /fr/java/com.aspose.threed/booleanoperator/
---
...
L'opérateur booléen vous permet d'appliquer une opération booléenne sur deux instances de [IMeshConvertible](../../com.aspose.threed/imeshconvertible).
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [BooleanOperator()](#BooleanOperator--) | Constructeur de [BooleanOperator](../../com.aspose.threed/booleanoperator) |
| [BooleanOperator(BooleanOperation operation, A3DObject first, A3DObject second)](#BooleanOperator-com.aspose.threed.BooleanOperation-com.aspose.threed.A3DObject-com.aspose.threed.A3DObject-) | Construit une nouvelle instance de [BooleanOperator](../../com.aspose.threed/booleanoperator) avec deux opérandes |
## Méthodes
...
| [getFirst()](#getFirst--) | Le premier opérande de l'opérateur booléen |
| [getName()](#getName--) | Obtient le nom. |
| [getOperator()](#getOperator--) | L'opérateur booléen utilisé dans l'opération pour créer le maillage résultant. |
...
| [getSecond()](#getSecond--) | Le deuxième opérande de l'opérateur booléen |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFirst(BooleanOperand value)](#setFirst-com.aspose.threed.BooleanOperand-) | Le premier opérande de l'opérateur booléen |
| [setName(String value)](#setName-java.lang.String-) | Définit le nom. |
| [setOperator(BooleanOperation value)](#setOperator-com.aspose.threed.BooleanOperation-) | L'opérateur booléen utilisé dans l'opération pour créer le maillage résultant. |
...
| [setSecond(BooleanOperand value)](#setSecond-com.aspose.threed.BooleanOperand-) | Le deuxième opérande de l'opérateur booléen |
| [toMesh()](#toMesh--) | Effectuer l'opération booléenne sur deux opérandes |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Constructeur de [BooleanOperator](../../com.aspose.threed/booleanoperator)
...
Construit une nouvelle instance de [BooleanOperator](../../com.aspose.threed/booleanoperator) avec deux opérandes

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| operation | [BooleanOperation](../../com.aspose.threed/booleanoperation) | Type d'opération booléenne |
| first | [A3DObject](../../com.aspose.threed/a3dobject) | Instance de [IMeshConvertible](../../com.aspose.threed/imeshconvertible), [HalfSpace](../../com.aspose.threed/halfspace) ou [Node](../../com.aspose.threed/node) |
| second | [A3DObject](../../com.aspose.threed/a3dobject) | Instance de [IMeshConvertible](../../com.aspose.threed/imeshconvertible), [HalfSpace](../../com.aspose.threed/halfspace) ou [Node](../../com.aspose.threed/node) |
...
Le premier opérande de l'opérateur booléen
...
L'opérateur booléen utilisé dans l'opération pour créer le maillage résultant.
...
Le deuxième opérande de l'opérateur booléen
...
| Paramètre | Type | Description |
| --- | --- | --- |
| value | [BooleanOperand](../../com.aspose.threed/booleanoperand) | Nouvelle valeur |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| value | [BooleanOperation](../../com.aspose.threed/booleanoperation) | Nouvelle valeur |
...
Effectuer l'opération booléenne sur deux opérandes

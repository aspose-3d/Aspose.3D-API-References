...
description: "Le  est principalement utilisé par les logiciels CAO pour aider le concepteur à manipuler la transformation de la structure squelettique, il est généralement inutile en dehors des logiciels CAO."
type: docs
weight: 172
url: /fr/java/com.aspose.threed/skeleton/
---
...
Le [Skeleton](../../com.aspose.threed/skeleton) est principalement utilisé par les logiciels CAO pour aider le concepteur à manipuler la transformation de la structure squelettique, il est généralement inutile en dehors des logiciels CAO. Pour que la hiérarchie du squelette se comporte comme un seul objet dans le logiciel CAO, il est nécessaire de marquer le nœud supérieur [Skeleton](../../com.aspose.threed/skeleton) comme racine en définissant [getType](../../com.aspose.threed/skeleton\#getType) sur [SkeletonType.SKELETON](../../com.aspose.threed/skeletontype\#SKELETON), et tous les enfants sur [SkeletonType.BONE](../../com.aspose.threed/skeletontype\#BONE).
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [Skeleton()](#Skeleton--) | Initialise une nouvelle instance de la classe [Skeleton](../../com.aspose.threed/skeleton). |
| [Skeleton(String name)](#Skeleton-java.lang.String-) | Initialise une nouvelle instance de la classe [Skeleton](../../com.aspose.threed/skeleton). |
| [Skeleton(String name, SkeletonType type)](#Skeleton-java.lang.String-com.aspose.threed.SkeletonType-) | Initialise une nouvelle instance de la classe [Skeleton](../../com.aspose.threed/skeleton). |
## Méthodes
...
| [getSize()](#getSize--) | Obtient la taille du nœud de membre utilisée dans les logiciels CAO pour représenter la taille de l'os. |
| [getType()](#getType--) | Obtient le type du squelette. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setSize(double value)](#setSize-double-) | Définit la taille du nœud de membre utilisée dans les logiciels CAO pour représenter la taille de l'os. |
| [setType(SkeletonType value)](#setType-com.aspose.threed.SkeletonType-) | Définit le type du squelette. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initialise une nouvelle instance de la classe [Skeleton](../../com.aspose.threed/skeleton).
...
| Paramètre | Type | Description |
| --- | --- | --- |
| nom | java.lang.String | Nom de l'entité. |
| type | [SkeletonType](../../com.aspose.threed/skeletontype) | Type de squelette |
...
Obtient la taille du nœud de membre utilisée dans les logiciels CAO pour représenter la taille de l'os.

**Returns:**
double - la taille du nœud de membre utilisée dans les logiciels CAO pour représenter la taille de l'os.
### getType() {#getType--}
```
...
Définit la taille du nœud de membre utilisée dans les logiciels CAO pour représenter la taille de l'os.
...
Définit le type du squelette.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| value | [SkeletonType](../../com.aspose.threed/skeletontype) | Nouvelle valeur |

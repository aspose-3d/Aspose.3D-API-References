...
description: "Cette classe vous permet de construire un profil 2D directement à partir d'une courbe arbitraire."
type: docs
weight: 16
url: /fr/java/com.aspose.threed/arbitraryprofile/
---
...
Cette classe vous permet de construire un profil 2D directement à partir d'une courbe arbitraire.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [ArbitraryProfile()](#ArbitraryProfile--) | Constructeur de [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) |
| [ArbitraryProfile(Curve curve)](#ArbitraryProfile-com.aspose.threed.Curve-) | Constructeur de [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) avec une courbe initiale. |
## Méthodes
...
| [getClass()](#getClass--) |  |
| [getCurve()](#getCurve--) | La Curve utilisée pour construire le profil |
...
| [getHoles()](#getHoles--) | Trous du profil, également représentés comme courbe |
...
| [setCurve(Curve value)](#setCurve-com.aspose.threed.Curve-) | La Curve utilisée pour construire le profil |
...
Constructeur de [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile)
...
Constructeur de [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) avec une courbe initiale.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Courbe initiale du profil |
...
La Curve utilisée pour construire le profil
...
Trous du profil, également représentés comme courbe

**Returns:**
java.util.ArrayList<com.aspose.threed.Curve> - Trous du profil, également représentés sous forme de courbe
### getName() {#getName--}
```

...
description: "est une surface représentée par NURBS (Non-uniform rational basis spline). A est défini par deux et ."
type: docs
weight: 114
url: /fr/java/com.aspose.threed/nurbssurface/
---
...
| --- | --- |
| [NurbsSurface()](#NurbsSurface--) | Initialise une nouvelle instance de la classe [NurbsSurface](../../com.aspose.threed/nurbssurface). |
| [NurbsSurface(String name)](#NurbsSurface-java.lang.String-) | Initialise une nouvelle instance de la classe [NurbsSurface](../../com.aspose.threed/nurbssurface). |
## Méthodes
...
| [getU()](#getU--) | Obtient la direction U de la surface NURBS |
| [getV()](#getV--) | Obtient la direction V de la surface NURBS |
...
| [toMesh()](#toMesh--) | Convertit la surface NURBS en maillage |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initialise une nouvelle instance de la classe [NurbsSurface](../../com.aspose.threed/nurbssurface).
...
Convertit la surface NURBS en maillage

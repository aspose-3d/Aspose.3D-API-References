...
description: "Forme rectangulaire creuse compatible IFC avec des coins arrondis intérieurs/extérieurs."
type: docs
weight: 79
url: /fr/java/com.aspose.threed/hollowrectangleshape/
---
...
| [getInnerFilletRadius()](#getInnerFilletRadius--) | Le rayon du congé intérieur du rectangle interne. |
...
| [getWallThickness()](#getWallThickness--) | L'épaisseur entre la bordure du rectangle et le trou intérieur |
...
| [setInnerFilletRadius(double value)](#setInnerFilletRadius-double-) | Le rayon du congé intérieur du rectangle interne. |
...
| [setWallThickness(double value)](#setWallThickness-double-) | L'épaisseur entre la bordure du rectangle et le trou intérieur |
...
Le rayon du congé intérieur du rectangle interne.

**Returns:**
double - Le rayon du congé intérieur du rectangle interne.
### getName() {#getName--}
```
...
L'épaisseur entre la bordure du rectangle et le trou intérieur

**Returns:**
double - L'épaisseur entre la bordure du rectangle et le trou intérieur
### getXDim() {#getXDim--}
```

...
description: "Une courbe consiste en un ensemble de points sur le bord de la forme circulaire."
type: docs
weight: 31
url: /fr/java/com.aspose.threed/circle/
---
...
Une courbe [Circle](../../com.aspose.threed/circle) consiste en un ensemble de points sur le bord de la forme circulaire.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [Circle()](#Circle--) | Constructeur de [Circle](../../com.aspose.threed/circle) |
| [Circle(double radius)](#Circle-double-) | Constructeur de [Circle](../../com.aspose.threed/circle) |
## Méthodes
...
| [getRadius()](#getRadius--) | Le rayon de la courbe du cercle, la valeur par défaut est 10 |
...
| [setRadius(double value)](#setRadius-double-) | Le rayon de la courbe du cercle, la valeur par défaut est 10 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Constructeur de [Circle](../../com.aspose.threed/circle)
...
| --- | --- | --- |
| radius | double | Le rayon de la courbe du cercle. |
...
Le rayon de la courbe du cercle, la valeur par défaut est 10

**Returns:**
double - Le rayon de la courbe du cercle, la valeur par défaut est 10
### getScene() {#getScene--}
```

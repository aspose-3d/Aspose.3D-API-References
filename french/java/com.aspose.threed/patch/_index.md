...
description: "Un  est une surface de modélisation paramétrique similaire à  ; elle est également définie par deux   le  et ."
type: docs
weight: 119
url: /fr/java/com.aspose.threed/patch/
---
...
Un [Patch](../../com.aspose.threed/patch) est une surface de modélisation paramétrique, similaire à [NurbsSurface](../../com.aspose.threed/nurbssurface), elle est également définie par deux [PatchDirection](../../com.aspose.threed/patchdirection), le [getU](../../com.aspose.threed/patch\#getU) et le [getV](../../com.aspose.threed/patch\#getV). Mais la différence entre [Patch](../../com.aspose.threed/patch) et [NurbsSurface](../../com.aspose.threed/nurbssurface) est que la courbe [PatchDirection](../../com.aspose.threed/patchdirection) peut être l'une des [PatchDirectionType.BEZIER](../../com.aspose.threed/patchdirectiontype\#BEZIER), [PatchDirectionType.QUADRATIC_BEZIER](../../com.aspose.threed/patchdirectiontype\#QUADRATIC-BEZIER), [PatchDirectionType.BASIS_SPLINE](../../com.aspose.threed/patchdirectiontype\#BASIS-SPLINE), [PatchDirectionType.CARDINAL_SPLINE](../../com.aspose.threed/patchdirectiontype\#CARDINAL-SPLINE) et [PatchDirectionType.LINEAR](../../com.aspose.threed/patchdirectiontype\#LINEAR)
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [Patch()](#Patch--) | Initialise une nouvelle instance de la classe [Patch](../../com.aspose.threed/patch). |
| [Patch(String name)](#Patch-java.lang.String-) | Initialise une nouvelle instance de la classe [Patch](../../com.aspose.threed/patch). |
## Méthodes
...
| [getU()](#getU--) | Obtient la direction u. |
| [getV()](#getV--) | Obtient la direction v. |
...
Initialise une nouvelle instance de la classe [Patch](../../com.aspose.threed/patch).

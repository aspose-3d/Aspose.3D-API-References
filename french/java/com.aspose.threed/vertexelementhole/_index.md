...
description: "Définit si le polygone spécifié est un trou"
type: docs
weight: 211
url: /fr/java/com.aspose.threed/vertexelementhole/
---
...
| --- | --- |
| [VertexElementHole()](#VertexElementHole--) | Initialise une nouvelle instance de la classe [VertexElementHole](../../com.aspose.threed/vertexelementhole). |
## Méthodes
...
| [copyTo(VertexElementTemplate<T> target)](#copyTo-com.aspose.threed.VertexElementTemplate-T--) | Copie les données vers l'élément spécifié. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(T[] data)](#setData-T---) | Charge les données. |
...
Initialise une nouvelle instance de la classe [VertexElementHole](../../com.aspose.threed/vertexelementhole).
...
| Paramètre | Type | Description |
| --- | --- | --- |
| target | [VertexElementTemplate](../../com.aspose.threed/vertexelementtemplate) | Cible. |
...
**Returns:**
java.util.List<T> - les données de sommet

...
description: "Options d'enregistrement pour AMF"
type: docs
weight: 12
url: /fr/java/com.aspose.threed/amfsaveoptions/
---
...
Options d'enregistrement pour AMF
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [AmfSaveOptions()](#AmfSaveOptions--) | Constructeur de [AmfSaveOptions](../../com.aspose.threed/amfsaveoptions) |
## Méthodes
...
| [getClass()](#getClass--) |  |
| [getEnableCompression()](#getEnableCompression--) | Indique s'il faut utiliser la compression pour réduire la taille finale du fichier, la valeur par défaut est vraie |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEnableCompression(boolean value)](#setEnableCompression-boolean-) | Indique s'il faut utiliser la compression pour réduire la taille finale du fichier, la valeur par défaut est vraie |
...
Constructeur de [AmfSaveOptions](../../com.aspose.threed/amfsaveoptions)
...
Indique s'il faut utiliser la compression pour réduire la taille finale du fichier, la valeur par défaut est vraie

**Returns:**
boolean - Indique s'il faut utiliser la compression pour réduire la taille finale du fichier, la valeur par défaut est vraie

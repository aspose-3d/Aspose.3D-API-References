...
description: "Options d'enregistrement pour collada"
type: docs
weight: 33
url: /fr/java/com.aspose.threed/colladasaveoptions/
---
...
Options d'enregistrement pour collada
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [ColladaSaveOptions()](#ColladaSaveOptions--) | Constructeur de [ColladaSaveOptions](../../com.aspose.threed/colladasaveoptions) |
## Méthodes
...
| [getIndented()](#getIndented--) | Obtient si le document XML exporté est indenté. |
...
| [getTransformStyle()](#getTransformStyle--) | Obtient le style de transformation du nœud |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setIndented(boolean value)](#setIndented-boolean-) | Définit si le document XML exporté doit être indenté. |
...
| [setTransformStyle(ColladaTransformStyle value)](#setTransformStyle-com.aspose.threed.ColladaTransformStyle-) | Définit le style de transformation du nœud |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Constructeur de [ColladaSaveOptions](../../com.aspose.threed/colladasaveoptions)
...
Obtient si le document XML exporté est indenté.

**Returns:**
booléen - indique si le document XML exporté est indenté.
...
Obtient le style de transformation du nœud
...
Définit si le document XML exporté doit être indenté.
...
Définit le style de transformation du nœud

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| value | [ColladaTransformStyle](../../com.aspose.threed/colladatransformstyle) | Nouvelle valeur |

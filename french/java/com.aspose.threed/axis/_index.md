...
description: "L'axe de coordonnées."
type: docs
weight: 265
url: /fr/java/com.aspose.threed/axis/
---
...
| Champ | Description |
| --- | --- |
| [NEGATIVE_X_AXIS](#NEGATIVE-X-AXIS) | L'axe -X. |
| [NEGATIVE_Y_AXIS](#NEGATIVE-Y-AXIS) | L'axe -Y. |
| [NEGATIVE_Z_AXIS](#NEGATIVE-Z-AXIS) | L'axe -Z. |
| [X_AXIS](#X-AXIS) | L'axe +X. |
| [Y_AXIS](#Y-AXIS) | L'axe +Y. |
| [Z_AXIS](#Z-AXIS) | L'axe +Z. |
## Méthodes

...
type: docs
weight: 124
url: /fr/java/com.aspose.threed/pdfloadoptions/
---
...
| --- | --- |
| [PdfLoadOptions()](#PdfLoadOptions--) | Constructeur de [PdfLoadOptions](../../com.aspose.threed/pdfloadoptions) |
## Méthodes
...
| [getPassword()](#getPassword--) | Le mot de passe pour déverrouiller le fichier PDF chiffré. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setPassword(byte[] value)](#setPassword-byte---) | Le mot de passe pour déverrouiller le fichier PDF chiffré. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Constructeur de [PdfLoadOptions](../../com.aspose.threed/pdfloadoptions)
...
Le mot de passe pour déverrouiller le fichier PDF chiffré.

**Returns:**
byte[] - Le mot de passe pour déverrouiller le fichier PDF chiffré.
### hashCode() {#hashCode--}
```

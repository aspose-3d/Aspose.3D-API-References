...
description: "Options de chargement pour Siemens JT"
type: docs
weight: 88
url: /fr/java/com.aspose.threed/jtloadoptions/
---
...
Options de chargement pour Siemens JT
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [JtLoadOptions()](#JtLoadOptions--) |  |
## Méthodes
...
| [getLoadPMI()](#getLoadPMI--) | Charge les informations PMI à partir du fichier JT si possible, les données seront enregistrées en tant que propriété \"PMI\" de [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). |
| [getLoadProperties()](#getLoadProperties--) | Charge les propriétés depuis la table de propriétés du JT en tant que propriétés Aspose.3D. |
...
| [setLoadPMI(boolean value)](#setLoadPMI-boolean-) | Charge les informations PMI à partir du fichier JT si possible, les données seront enregistrées en tant que propriété \"PMI\" de [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). |
| [setLoadProperties(boolean value)](#setLoadProperties-boolean-) | Charge les propriétés depuis la table de propriétés du JT en tant que propriétés Aspose.3D. |
...
```
### getLoadPMI() {#getLoadPMI--}
```
public boolean getLoadPMI()
```


Charge les informations PMI à partir du fichier JT si possible, les données seront enregistrées en tant que propriété \"PMI\" de [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). La valeur par défaut est false.

**Returns:**
boolean - Charge les informations PMI à partir du fichier JT si possible, les données seront enregistrées en tant que propriété \"PMI\" de [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). La valeur par défaut est false.
...
Charge les propriétés depuis la table de propriétés du JT en tant que propriétés Aspose.3D. La valeur par défaut est false.

**Returns:**
boolean - Charge les propriétés depuis la table de propriétés du JT en tant que propriétés Aspose.3D. La valeur par défaut est false.

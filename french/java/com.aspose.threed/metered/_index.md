...
type: docs
weight: 103
url: /fr/java/com.aspose.threed/metered/
---
...
Définit la clé publique et privée mesurée. Si vous achetez une licence à usage mesuré, au démarrage de l'application, cette API doit être appelée, normalement, cela suffit. Cependant, si le téléchargement des données de consommation échoue constamment et dépasse 24 heures, la licence sera mise en statut d'évaluation ; pour éviter ce cas, vous devez vérifier régulièrement le statut de la licence, et s'il est en statut d'évaluation, appeler à nouveau cette API.

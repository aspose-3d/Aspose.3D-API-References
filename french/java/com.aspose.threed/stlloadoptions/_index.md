...
description: "Options de chargement pour STL"
type: docs
weight: 176
url: /fr/java/com.aspose.threed/stlloadoptions/
---
...
| --- | --- |
| [StlLoadOptions()](#StlLoadOptions--) | Initialise une nouvelle instance de [StlLoadOptions](../../com.aspose.threed/stlloadoptions). |
| [StlLoadOptions(FileContentType contentType)](#StlLoadOptions-com.aspose.threed.FileContentType-) | Initialise une nouvelle instance de [StlLoadOptions](../../com.aspose.threed/stlloadoptions). |
## Méthodes
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | Obtient si le système de coordonnées des points de contrôle/normales doit être inversé lors de l'importation. |
...
| [getRecalculateNormal()](#getRecalculateNormal--) | Ignore les données de normales stockées dans le fichier STL et recalculer les normales en fonction de la position des sommets. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | Définit si le système de coordonnées des points de contrôle/normales doit être inversé lors de l'importation. |
...
| [setRecalculateNormal(boolean value)](#setRecalculateNormal-boolean-) | Ignore les données de normales stockées dans le fichier STL et recalculer les normales en fonction de la position des sommets. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initialise une nouvelle instance de [StlLoadOptions](../../com.aspose.threed/stlloadoptions).
...
Obtient si le système de coordonnées des points de contrôle/normales doit être inversé lors de l'importation.

**Returns:**
boolean - si le système de coordonnées des points de contrôle/normales doit être inversé lors de l'importation.
...
Ignore les données de normales stockées dans le fichier STL et recalculer les normales en fonction de la position des sommets. La valeur par défaut est false.

**Returns:**
boolean - Ignore les données de normales stockées dans le fichier STL et recalculer les normales en fonction de la position des sommets. La valeur par défaut est false.
### hashCode() {#hashCode--}
```
...
Définit si le système de coordonnées des points de contrôle/normales doit être inversé lors de l'importation.

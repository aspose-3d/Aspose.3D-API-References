...
description: "Forme d'ellipse compatible IFC définie par des paramètres."
type: docs
weight: 50
url: /fr/java/com.aspose.threed/ellipseshape/
---
...
| [getSemiAxis1()](#getSemiAxis1--) | Obtient le premier rayon de l'ellipse mesuré dans la direction de l'axe x. |
| [getSemiAxis2()](#getSemiAxis2--) | Obtient le deuxième rayon de l'ellipse mesuré dans la direction de l'axe y. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setSemiAxis1(double value)](#setSemiAxis1-double-) | Définit le premier rayon de l'ellipse mesuré dans la direction de l'axe x. |
| [setSemiAxis2(double value)](#setSemiAxis2-double-) | Définit le deuxième rayon de l'ellipse mesuré dans la direction de l'axe y. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Obtient le premier rayon de l'ellipse mesuré dans la direction de l'axe x.

**Returns:**
double - le premier rayon de l'ellipse mesuré dans la direction de l'axe x.
...
Obtient le deuxième rayon de l'ellipse mesuré dans la direction de l'axe y.

**Returns:**
double - le deuxième rayon de l'ellipse mesuré dans la direction de l'axe y.
### hashCode() {#hashCode--}
```
...
Définit le premier rayon de l'ellipse mesuré dans la direction de l'axe x.
...
Définit le deuxième rayon de l'ellipse mesuré dans la direction de l'axe y.

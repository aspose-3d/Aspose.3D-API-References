...
description: "Options de chargement pour wavefront obj"
type: docs
weight: 115
url: /fr/java/com.aspose.threed/objloadoptions/
---
...
Options de chargement pour wavefront obj
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [ObjLoadOptions()](#ObjLoadOptions--) | Constructeur de [ObjLoadOptions](../../com.aspose.threed/objloadoptions) |
## Méthodes
...
| [getClass()](#getClass--) |  |
| [getEnableMaterials()](#getEnableMaterials--) | Obtient si les matériaux sont importés pour chaque objet |
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | Obtient si le système de coordonnées des points de contrôle/normales est inversé lors de l'importation |
...
| [getNormalizeNormal()](#getNormalizeNormal--) | Obtient si le vecteur normal doit être normalisé pendant le chargement. |
| [getScale()](#getScale--) | Échelles sur les axes x/y/z, la valeur par défaut est 1.0 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEnableMaterials(boolean value)](#setEnableMaterials-boolean-) | Définit si les matériaux sont importés pour chaque objet |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | Définit si le système de coordonnées des points de contrôle/normales est inversé lors de l'importation |
...
| [setNormalizeNormal(boolean value)](#setNormalizeNormal-boolean-) | Définit si le vecteur normal doit être normalisé pendant le chargement. |
| [setScale(double value)](#setScale-double-) | Échelles sur les axes x/y/z, la valeur par défaut est 1.0 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Constructeur de [ObjLoadOptions](../../com.aspose.threed/objloadoptions)
...
Obtient si les matériaux sont importés pour chaque objet

**Returns:**
booléen - si les matériaux sont importés pour chaque objet
...
Obtient si le système de coordonnées des points de contrôle/normales est inversé lors de l'importation

**Returns:**
booléen - si le système de coordonnées des points de contrôle/normales est inversé lors de l'importation
...
Obtient si le vecteur normal doit être normalisé pendant le chargement. La valeur par défaut est vraie.

**Returns:**
booléen - si le vecteur normal doit être normalisé pendant le chargement. La valeur par défaut est vraie.
### getScale() {#getScale--}
```
...
Échelles sur les axes x/y/z, la valeur par défaut est 1.0

**Returns:**
double - Échelles sur les axes x/y/z, la valeur par défaut est 1.0
### hashCode() {#hashCode--}
```
...
Définit si les matériaux sont importés pour chaque objet
...
Définit si le système de coordonnées des points de contrôle/normales est inversé lors de l'importation
...
Définit si le vecteur normal doit être normalisé pendant le chargement. La valeur par défaut est vraie.

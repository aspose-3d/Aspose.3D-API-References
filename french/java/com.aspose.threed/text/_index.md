...
description: "Profil texte ce profil décrit les contours en utilisant la police et le texte."
type: docs
weight: 183
url: /fr/java/com.aspose.threed/text/
---
...
Profil texte, ce profil décrit les contours en utilisant la police et le texte. **Exemple:** Le code suivant montre comment créer un maillage 3D à partir de texte en utilisant le fichier de police spécifié.
...
| [getClass()](#getClass--) |  |
| [getContent()](#getContent--) | Contenu du texte |
...
| [getFont()](#getFont--) | La police du texte. |
| [getFontSize()](#getFontSize--) | Échelle de taille de police. |
...
| [setContent(String value)](#setContent-java.lang.String-) | Contenu du texte |
| [setExcluded(boolean value)](#setExcluded-boolean-) | Définit si l'entité doit être exclue lors de l'exportation. |
| [setFont(FontFile value)](#setFont-com.aspose.threed.FontFile-) | La police du texte. |
| [setFontSize(float value)](#setFontSize-float-) | Échelle de taille de police. |
...
**Returns:**
java.lang.String - Contenu du texte **Exemple:** Le code suivant montre comment créer un maillage 3D à partir de texte en utilisant le fichier de police spécifié.
...
Échelle de taille de police.

**Returns:**
float - Échelle de taille de police. **Exemple:** Le code suivant montre comment créer un maillage 3D à partir de texte en utilisant le fichier de police spécifié.
...
| Paramètre | Type | Description |
| --- | --- | --- |
|  | valeur | java.lang.String | Nouvelle valeur **Exemple:** Le code suivant montre comment créer un maillage 3D à partir de texte en utilisant le fichier de police spécifié. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
|  | value | [FontFile](../../com.aspose.threed/fontfile) | Nouvelle valeur **Exemple:** Le code suivant montre comment créer un maillage 3D à partir de texte en utilisant le fichier de police spécifié. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
|  | valeur | float | Nouvelle valeur **Exemple:** Le code suivant montre comment créer un maillage 3D à partir de texte en utilisant le fichier de police spécifié. |

...
type: docs
weight: 128
url: /fr/java/com.aspose.threed/plane/
---
...
| --- | --- |
| [Plane()](#Plane--) | Initialise une nouvelle instance du [Plane](../../com.aspose.threed/plane) avec une taille par défaut de 1x1. |
| [Plane(double length, double width)](#Plane-double-double-) | Initialise une nouvelle instance du [Plane](../../com.aspose.threed/plane). |
| [Plane(String name, double length, double width, int lengthSegments, int widthSegments)](#Plane-java.lang.String-double-double-int-int-) | Initialise une nouvelle instance du [Plane](../../com.aspose.threed/plane). |
## Méthodes
...
| [getLength()](#getLength--) | Obtient la longueur du plan. |
...
| [getUp()](#getUp--) | Obtient le vecteur up du plan, la valeur par défaut est (0, 1, 0), cela affecte la génération du plan |
| [getWidth()](#getWidth--) | Obtient la largeur du plan. |
...
| [setLength(double value)](#setLength-double-) | Définit la longueur du plan. |
...
| [setUp(Vector3 value)](#setUp-com.aspose.threed.Vector3-) | Définit le vecteur up du plan, la valeur par défaut est (0, 1, 0), cela affecte la génération du plan |
| [setWidth(double value)](#setWidth-double-) | Définit la largeur du plan. |
...
Initialise une nouvelle instance du [Plane](../../com.aspose.threed/plane) avec une taille par défaut de 1x1.
...
Initialise une nouvelle instance du [Plane](../../com.aspose.threed/plane).

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| longueur | double | Longueur du plan. |
| largeur | double | Largeur du plan. |
...
Obtient la longueur du plan.

**Returns:**
double - la longueur du plan.
...
Obtient le vecteur up du plan, la valeur par défaut est (0, 1, 0), cela affecte la génération du plan
...
Obtient la largeur du plan.

**Returns:**
double - la largeur du plan.
...
Définit le vecteur up du plan, la valeur par défaut est (0, 1, 0), cela affecte la génération du plan

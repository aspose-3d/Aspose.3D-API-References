...
type: docs
weight: 293
url: /fr/java/com.aspose.threed/posetype/
---
...
| Champ | Description |
| --- | --- |
| [BIND_POSE](#BIND-POSE) | La pose de liaison. |
| [SNAPSHOT](#SNAPSHOT) | La pose de repos, signifie qu'il s'agit d'un instantané de la pose de liaison. |
## Méthodes
...
La pose de repos, signifie qu'il s'agit d'un instantané de la pose de liaison.

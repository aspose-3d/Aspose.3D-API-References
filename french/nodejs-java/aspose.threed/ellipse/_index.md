...
url: /fr/nodejs-java/aspose.threed/ellipse/
---
## Ellipse class

Une ellipse définit un ensemble de points qui forment la forme d'une ellipse.
...
| Nom | Description |
| --- | --- |
| constructor() | Constructeur de Ellipse |
...
| Nom | Description |
| --- | --- |
| constructor_overload(semiAxis1, semiAxis2) | Constructeur de Ellipse |
...
| Nom | Description |
| --- | --- |
| getSemiAxis1() | Rayon sur l'axe X |
...
| Nom | Description |
| --- | --- |
| setSemiAxis1(value) | Rayon sur l'axe X |
...
| Nom | Description |
| --- | --- |
| getSemiAxis2() | Rayon sur l'axe Y |
...
| Nom | Description |
| --- | --- |
| setSemiAxis2(value) | Rayon sur l'axe Y |

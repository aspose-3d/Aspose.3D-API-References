...
| Nom | Description |
| --- | --- |
| getFirst() | Le premier point d'extrémité à découper, peut être un point cartésien ou un paramètre réel. |
...
| Nom | Description |
| --- | --- |
| setFirst(value) | Le premier point d'extrémité à découper, peut être un point cartésien ou un paramètre réel. |
...
| Nom | Description |
| --- | --- |
| getSecond() | Le deuxième point d'extrémité à rogner peut être un point cartésien ou un paramètre réel. |
...
| Nom | Description |
| --- | --- |
| setSecond(value) | Le deuxième point d'extrémité à rogner peut être un point cartésien ou un paramètre réel. |
...
| Nom | Description |
| --- | --- |
| getSameDirection() | Obtient ou définit si le résultat rogné utilise la même direction de la courbe de base. |
...
| Nom | Description |
| --- | --- |
| setSameDirection(value) | Obtient ou définit si le résultat rogné utilise la même direction de la courbe de base. |

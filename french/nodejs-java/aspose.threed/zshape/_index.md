...
url: /fr/nodejs-java/aspose.threed/zshape/
---
## ZShape class

Profil en forme de Z compatible IFC défini par des paramètres.
...
| Nom | Description |
| --- | --- |
| constructor() | Constructeur de ZShape |
...
| Nom | Description |
| --- | --- |
| getWebThickness() | Obtient ou définit l'épaisseur du mur. |
...
| Nom | Description |
| --- | --- |
| setWebThickness(value) | Obtient ou définit l'épaisseur du mur. |
...
| Nom | Description |
| --- | --- |
| getFlangeThickness() | Obtient ou définit l'épaisseur de l'aile. |
...
| Nom | Description |
| --- | --- |
| setFlangeThickness(value) | Obtient ou définit l'épaisseur de l'aile. |
...
| Nom | Description |
| --- | --- |
| getFilletRadius() | Obtient ou définit le rayon du congé entre l'aile et l'âme. |
...
| Nom | Description |
| --- | --- |
| setFilletRadius(value) | Obtient ou définit le rayon du congé entre l'aile et l'âme. |
...
| Nom | Description |
| --- | --- |
| getEdgeRadius() | Obtient ou définit le rayon du bord de l'aile. |
...
| Nom | Description |
| --- | --- |
| setEdgeRadius(value) | Obtient ou définit le rayon du bord de l'aile. |

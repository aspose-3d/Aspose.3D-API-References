...
| Nom | Description |
| --- | --- |
| getRenderMode() | Le mode de rendu spécifie le style dans lequel l'œuvre 3D est rendue. La valeur de la propriété est la constante entière PdfRenderMode. |
...
| Nom | Description |
| --- | --- |
| setRenderMode(value) | Le mode de rendu spécifie le style dans lequel l'œuvre 3D est rendue. La valeur de la propriété est la constante entière PdfRenderMode. |
...
| Nom | Description |
| --- | --- |
| getLightingScheme() | LightingScheme spécifie l'éclairage à appliquer à l'œuvre 3D. La valeur de la propriété est la constante entière PdfLightingScheme. |
...
| Nom | Description |
| --- | --- |
| setLightingScheme(value) | LightingScheme spécifie l'éclairage à appliquer à l'œuvre 3D. La valeur de la propriété est la constante entière PdfLightingScheme. |
...
| Nom | Description |
| --- | --- |
| getFaceColor() | Obtient ou définit la couleur de face à utiliser lors du rendu du contenu 3D. Ceci n'est pertinent que lorsque le RenderMode a une valeur d'Illustration. |
...
| Nom | Description |
| --- | --- |
| setFaceColor(value) | Obtient ou définit la couleur de face à utiliser lors du rendu du contenu 3D. Ceci n'est pertinent que lorsque le RenderMode a une valeur d'Illustration. |
...
| Nom | Description |
| --- | --- |
| getEmbedTextures() | Intégrez les textures externes dans le fichier PDF, la valeur par défaut est false. |
...
| Nom | Description |
| --- | --- |
| setEmbedTextures(value) | Intégrez les textures externes dans le fichier PDF, la valeur par défaut est false. |

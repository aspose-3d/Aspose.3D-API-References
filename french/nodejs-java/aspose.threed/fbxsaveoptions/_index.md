...
| Nom | Description |
| --- | --- |
| constructor_overload(contentType) | Initialiser un FbxSaveOptions en utilisant la dernière version prise en charge. |
...
| Nom | Description |
| --- | --- |
| getReusePrimitiveMesh() | Réutiliser le maillage pour les primitives avec les mêmes paramètres, cela réduira considérablement la taille du fichier FBX lorsque la scène est construite à partir d'un grand nombre de formes primitives (comme importées depuis des fichiers CAD). La valeur par défaut est false. |
...
| Nom | Description |
| --- | --- |
| setReusePrimitiveMesh(value) | Réutiliser le maillage pour les primitives avec les mêmes paramètres, cela réduira considérablement la taille du fichier FBX lorsque la scène est construite à partir d'un grand nombre de formes primitives (comme importées depuis des fichiers CAD). La valeur par défaut est false. |
...
| Nom | Description |
| --- | --- |
| getEnableCompression() | Compression des grandes données binaires dans le fichier FBX (par ex. données d'animation, points de contrôle, données d'éléments de sommet, indices), la valeur par défaut est true. |
...
| Nom | Description |
| --- | --- |
| setEnableCompression(value) | Compression des grandes données binaires dans le fichier FBX (par ex. données d'animation, points de contrôle, données d'éléments de sommet, indices), la valeur par défaut est true. |
...
| Nom | Description |
| --- | --- |
| getFoldRepeatedCurveData() | Obtient ou définit si les données de courbe répétées sont réutilisées en augmentant le compteur de références de la dernière donnée ; true si les données de courbe répétées sont regroupées, sinon false. |
...
| Nom | Description |
| --- | --- |
| getVideoForTexture() | Obtient ou définit si une instance Video est générée pour la Texture lors de l'exportation en FBX. |
...
| Nom | Description |
| --- | --- |
| setVideoForTexture(value) | Obtient ou définit si une instance Video est générée pour la Texture lors de l'exportation en FBX. |
...
| Nom | Description |
| --- | --- |
| getEmbedTextures() | Obtient ou définit si la texture doit être incorporée dans le fichier de sortie final. L'exportateur FBX tentera de trouver les données brutes de la texture dans le système de fichiers et d'incorporer le fichier dans le FBX final. La valeur par défaut est false. |
...
| Nom | Description |
| --- | --- |
| setEmbedTextures(value) | Obtient ou définit si la texture doit être incorporée dans le fichier de sortie final. L'exportateur FBX tentera de trouver les données brutes de la texture dans le système de fichiers et d'incorporer le fichier dans le FBX final. La valeur par défaut est false. |

...
url: /fr/nodejs-java/aspose.threed/mirroredprofile/
---
## MirroredProfile class

Profil miroir compatible IFC. Ce profil définit un nouveau profil en reflétant le profil de base par rapport à l'axe y.
...
| Nom | Description |
| --- | --- |
| constructor(baseProfile) | Construit un nouveau MirroredProfile à partir d'un profil existant. |

 **Parameters:**

| Nom | Type | Description |
| --- | --- | --- |
| baseProfile | Profil | Le profil de base à refléter. |
...
| Nom | Description |
| --- | --- |
| getBaseProfile() | Le profil de base à refléter. |

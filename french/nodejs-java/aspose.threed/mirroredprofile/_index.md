...
Profil miroir compatible IFC.  Ce profil définit un nouveau profil en reflétant le profil de base autour de l’axe y.
...
| --- | --- | --- |
| baseProfile | Profile | Le profil de base à refléter. |

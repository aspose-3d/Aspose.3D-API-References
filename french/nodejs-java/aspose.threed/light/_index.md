...
| Nom | Description |
| --- | --- |
| getCastLight() | Obtient ou définit si l'instance de lumière actuelle peut éclairer d'autres objets. |
...
| Nom | Description |
| --- | --- |
| setCastLight(value) | Obtient ou définit si l'instance de lumière actuelle peut éclairer d'autres objets. |
...
| Nom | Description |
| --- | --- |
| getFalloff() | Obtient ou définit l'angle du cône d'atténuation (en degrés). |
...
| Nom | Description |
| --- | --- |
| setFalloff(value) | Obtient ou définit l'angle du cône d'atténuation (en degrés). |

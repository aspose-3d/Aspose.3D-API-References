...
url: /fr/nodejs-java/aspose.threed/rectangulartorus/
---
...
| Nom | Description |
| --- | --- |
| constructor() | Constructeur de RectangularTorus |
...
| Nom | Description |
| --- | --- |
| constructor_overload(name) | Constructeur de RectangularTorus |
...
| Nom | Description |
| --- | --- |
| getInnerRadius() | Le rayon interne du tore rectangulaire Valeur par défaut : 17 |
...
| Nom | Description |
| --- | --- |
| setInnerRadius(value) | Le rayon interne du tore rectangulaire Valeur par défaut : 17 |
...
| Nom | Description |
| --- | --- |
| getOuterRadius() | Le rayon externe du tore rectangulaire Valeur par défaut : 20 |
...
| Nom | Description |
| --- | --- |
| setOuterRadius(value) | Le rayon externe du tore rectangulaire Valeur par défaut : 20 |
...
| Nom | Description |
| --- | --- |
| getHeight() | La hauteur du tore rectangulaire. Valeur par défaut : 20 |
...
| Nom | Description |
| --- | --- |
| setHeight(value) | La hauteur du tore rectangulaire. Valeur par défaut : 20 |
...
| Nom | Description |
| --- | --- |
| getArc() | L'angle total de l'arc, mesuré en radians. Valeur par défaut : PI |
...
| Nom | Description |
| --- | --- |
| setArc(value) | L'angle total de l'arc, mesuré en radians. Valeur par défaut : PI |
...
| Nom | Description |
| --- | --- |
| getAngleStart() | L'angle de départ de l'arc, mesuré en radians. Valeur par défaut : 0 |
...
| Nom | Description |
| --- | --- |
| setAngleStart(value) | L'angle de départ de l'arc, mesuré en radians. Valeur par défaut : 0 |
...
| Nom | Description |
| --- | --- |
| getRadialSegments() | Les segments radiaux, valeur par défaut : 10 |
...
| Nom | Description |
| --- | --- |
| setRadialSegments(value) | Les segments radiaux, valeur par défaut : 10 |

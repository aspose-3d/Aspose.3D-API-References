...
| Nom | Description |
| --- | --- |
| constructor() | Initialise une nouvelle instance de la classe Patch. |
...
| Nom | Description |
| --- | --- |
| constructor_overload(name) | Initialise une nouvelle instance de la classe Patch. |
...
| Nom | Description |
| --- | --- |
| getV() | Obtient la direction v. Le v. |

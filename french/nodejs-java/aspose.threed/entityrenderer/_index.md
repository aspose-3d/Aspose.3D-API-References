...
| --- | --- | --- |
| key | String | La clé du entity renderer |
...
| Nom | Description |
| --- | --- |
| resetSceneCache() | La scène a changé ou a été supprimée, il faut libérer les ressources de rendu au niveau de la scène dans celle-ci |
...
| Nom | Description |
| --- | --- |
| frameBegin(renderer, renderQueue) | Commencer le rendu d'une trame |

 **Parameters:**

| Nom | Type | Description |
| --- | --- | --- |
| renderer | Renderer | Renderer actuel |
...
| Nom | Description |
| --- | --- |
| frameEnd(renderer, renderQueue) | Termine le rendu d'une trame |
...
| Nom | Type | Description |
| --- | --- | --- |
| renderer | Renderer | L'instance du renderer actuel |
...
| Nom | Description |
| --- | --- |
| renderEntity(renderer, commandList, node, renderableResource, subEntity) | Chaque tâche de rendu poussée dans le com.aspose.threed.IRenderQueue aura un appel RenderEntity correspondant pour exécuter le travail de rendu concret. |
...
| subEntity | Nombre | L'index de la sous-entité qui a été passé à IRenderQueue |
...
| Nom | Description |
| --- | --- |
| dispose() | Le rendu d'entité est en cours de disposition, libérez les ressources partagées. |

...
| Nom | Description |
| --- | --- |
| encode(entity, fileName) | Encodez l'entité et enregistrez le résultat dans un fichier externe. |
...
| Nom | Description |
| --- | --- |
| encode(entity, fileName, opt) | Encodez l'entité et enregistrez le résultat dans un fichier externe. |
...
| entity | Entity | L'entité à encoder |
| fileName | String | Le fichier dans lequel écrire |
| opt | PlySaveOptions | Options d'enregistrement |
...
| Nom | Description |
| --- | --- |
| decode(fileName) | Décodez un nuage de points ou un maillage depuis le flux spécifié. |
...
| Nom | Description |
| --- | --- |
| decode(fileName, opt) | Décodez un nuage de points ou un maillage depuis le flux spécifié. |

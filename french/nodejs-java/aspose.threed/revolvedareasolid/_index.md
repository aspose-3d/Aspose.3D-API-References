...
| Nom | Description |
| --- | --- |
| getAngleStart() | Obtient ou définit l'angle de départ de la procédure de rotation, mesuré en radians, la valeur par défaut est 0. |
...
| Nom | Description |
| --- | --- |
| setAngleStart(value) | Obtient ou définit l'angle de départ de la procédure de rotation, mesuré en radians, la valeur par défaut est 0. |
...
| Nom | Description |
| --- | --- |
| getAngleEnd() | Obtient ou définit l'angle de fin de la procédure de rotation, mesuré en radians, la valeur par défaut est pi. |
...
| Nom | Description |
| --- | --- |
| setAngleEnd(value) | Obtient ou définit l'angle de fin de la procédure de rotation, mesuré en radians, la valeur par défaut est pi. |
...
| Nom | Description |
| --- | --- |
| getOrigin() | Obtient ou définit le point d'origine de la rotation, la valeur par défaut est (0, 0, 0). |
...
| Nom | Description |
| --- | --- |
| setOrigin(value) | Obtient ou définit le point d'origine de la rotation, la valeur par défaut est (0, 0, 0). |
...
| Nom | Description |
| --- | --- |
| getShape() | Obtient ou définit le profil de base utilisé pour la rotation. |
...
| Nom | Description |
| --- | --- |
| setShape(value) | Obtient ou définit le profil de base utilisé pour la rotation. |
...
| Nom | Description |
| --- | --- |
| toMesh() | Convertir le RevolvedAreaSolid en maillage. |

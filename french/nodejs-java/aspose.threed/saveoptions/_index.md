...
url: /fr/nodejs-java/aspose.threed/saveoptions/
---
## SaveOptions class

La classe de base pour configurer les options d'enregistrement de fichiers pour différents types  @hideconstructor

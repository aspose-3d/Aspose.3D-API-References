...
url: /fr/nodejs-java/aspose.threed/a3dwsaveoptions/
---
...
| Nom | Description |
| --- | --- |
| constructor() | Constructeur de A3dwSaveOptions |
...
| Nom | Description |
| --- | --- |
| getExportMetaData() | Exportation des métadonnées associées à la scène/noeud vers le client, la valeur par défaut est true |
...
| Nom | Description |
| --- | --- |
| setExportMetaData(value) | Exportation des métadonnées associées à la scène/noeud vers le client, la valeur par défaut est true |
...
| Nom | Description |
| --- | --- |
| getMetaDataPrefix() | Si cette propriété n'est pas nulle, seules les propriétés de Scene/Node qui commencent par ce préfixe seront exportées, et le préfixe sera supprimé. |
...
| Nom | Description |
| --- | --- |
| setMetaDataPrefix(value) | Si cette propriété n'est pas nulle, seules les propriétés de Scene/Node qui commencent par ce préfixe seront exportées, et le préfixe sera supprimé. |

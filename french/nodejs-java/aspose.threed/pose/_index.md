...
La pose est utilisée pour stocker la matrice de transformation lorsque la géométrie est skinnée.  La pose est un ensemble de BonePose, chaque BonePose enregistre les informations concrètes de transformation du nœud osseux.
...
| Nom | Description |
| --- | --- |
| addBonePose(node, matrix, localMatrix) | Enregistre la matrice de transformation de la pose pour le nœud osseux donné. |
...
| Nom | Description |
| --- | --- |
| addBonePose(node, matrix) | Enregistre la matrice de transformation de la pose pour le nœud d'os donné. La matrice de transformation globale est implicite. |

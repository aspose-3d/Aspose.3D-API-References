...
| Nom | Description |
| --- | --- |
| getInnerFilletRadius() | Le rayon du congé intérieur du rectangle intérieur. |
...
| Nom | Description |
| --- | --- |
| setInnerFilletRadius(value) | Le rayon du congé intérieur du rectangle intérieur. |
...
| Nom | Description |
| --- | --- |
| getRoundingRadius() | Obtient ou définit le rayon des arcs circulaires des quatre coins, mesuré en degrés. La valeur par défaut est 0.0 |
...
| Nom | Description |
| --- | --- |
| setRoundingRadius(value) | Obtient ou définit le rayon des arcs circulaires des quatre coins, mesuré en degrés. La valeur par défaut est 0.0 |

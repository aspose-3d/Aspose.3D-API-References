...
| Nom | Description |
| --- | --- |
| constructor() | Initialise une nouvelle instance du Plane avec une taille par défaut de 1x1. |
...
| Nom | Description |
| --- | --- |
| constructor_overload(length, width) | Initialise une nouvelle instance du Plane. |

 **Parameters:**

| Nom | Type | Description |
| --- | --- | --- |
| length | Nombre | Longueur du Plane. |
| largeur | Nombre | Largeur du Plane. |
...
| Nom | Description |
| --- | --- |
| constructor_overload2(name, length, width, lengthSegments, widthSegments) | Initialise une nouvelle instance du Plane. |
...
| Nom | Description |
| --- | --- |
| getUp() | Obtient ou définit le vecteur up du Plane, la valeur par défaut est (0, 1, 0), cela affecte la génération du Plane |
...
| Nom | Description |
| --- | --- |
| setUp(value) | Obtient ou définit le vecteur up du Plane, la valeur par défaut est (0, 1, 0), cela affecte la génération du Plane |
...
| Nom | Description |
| --- | --- |
| getLength() | Obtient ou définit la longueur du Plane. La longueur. |
...
| Nom | Description |
| --- | --- |
| setLength(value) | Obtient ou définit la longueur du Plane. La longueur. |
...
| Nom | Description |
| --- | --- |
| getWidth() | Obtient ou définit la largeur du Plane. La largeur. |
...
| Nom | Description |
| --- | --- |
| setWidth(value) | Obtient ou définit la largeur du Plane. La largeur. |

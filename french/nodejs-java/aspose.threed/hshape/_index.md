...
url: /fr/nodejs-java/aspose.threed/hshape/
---
## HShape class

Le HShape fournit les paramètres définissant une forme en 'H' ou en 'I'.
...
| Nom | Description |
| --- | --- |
| constructor() | Constructeur de HShape |
...
| Nom | Description |
| --- | --- |
| getOverallDepth() | Obtient ou définit l'étendue de la profondeur. |
...
| Nom | Description |
| --- | --- |
| setOverallDepth(value) | Obtient ou définit l'étendue de la profondeur. |
...
| Nom | Description |
| --- | --- |
| getBottomFlangeWidth() | Obtient ou définit l'étendue de la largeur. |
...
| Nom | Description |
| --- | --- |
| setBottomFlangeWidth(value) | Obtient ou définit l'étendue de la largeur. |
...
| Nom | Description |
| --- | --- |
| getTopFlangeWidth() | Obtient ou définit la largeur de la bride supérieure. |
...
| Nom | Description |
| --- | --- |
| setTopFlangeWidth(value) | Obtient ou définit la largeur de la bride supérieure. |
...
| Nom | Description |
| --- | --- |
| getTopFlangeThickness() | Obtient ou définit l'épaisseur de la bride supérieure. |
...
| Nom | Description |
| --- | --- |
| setTopFlangeThickness(value) | Obtient ou définit l'épaisseur de la bride supérieure. |
...
| Nom | Description |
| --- | --- |
| getTopFlangeEdgeRadius() | Obtient ou définit le rayon des bords inférieurs de la bride supérieure. |
...
| Nom | Description |
| --- | --- |
| setTopFlangeEdgeRadius(value) | Obtient ou définit le rayon des bords inférieurs de la bride supérieure. |
...
| Nom | Description |
| --- | --- |
| getTopFlangeFilletRadius() | Obtient ou définit le rayon du congé entre l'âme et la bride supérieure. |
...
| Nom | Description |
| --- | --- |
| setTopFlangeFilletRadius(value) | Obtient ou définit le rayon du congé entre l'âme et la bride supérieure. |
...
| Nom | Description |
| --- | --- |
| getBottomFlangeThickness() | Obtient ou définit l'épaisseur de l'aile de la forme en H. |
...
| Nom | Description |
| --- | --- |
| setBottomFlangeThickness(value) | Obtient ou définit l'épaisseur de l'aile de la forme en H. |
...
| Nom | Description |
| --- | --- |
| getWebThickness() | Obtient ou définit l'épaisseur de la traverse de la forme en H. |
...
| Nom | Description |
| --- | --- |
| setWebThickness(value) | Obtient ou définit l'épaisseur de la traverse de la forme en H. |
...
| Nom | Description |
| --- | --- |
| getBottomFlangeFilletRadius() | Obtient ou définit le rayon du congé entre la traverse et l'aile inférieure. |
...
| Nom | Description |
| --- | --- |
| setBottomFlangeFilletRadius(value) | Obtient ou définit le rayon du congé entre la traverse et l'aile inférieure. |
...
| Nom | Description |
| --- | --- |
| getBottomFlangeEdgeRadius() | Obtient ou définit le rayon des bords supérieurs de l'aile inférieure. |
...
| Nom | Description |
| --- | --- |
| setBottomFlangeEdgeRadius(value) | Obtient ou définit le rayon des bords supérieurs de l'aile inférieure. |

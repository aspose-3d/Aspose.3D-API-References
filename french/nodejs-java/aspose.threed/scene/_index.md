...
Une scène est un objet de niveau supérieur qui contient les nœuds, les géométries, les matériaux, les textures, l'animation, les poses, les sous‑scènes, etc.  Une scène peut avoir des sous‑scènes, agissant comme un support multi‑document dans des fichiers tels que collada/blender/fbx.  La hiérarchie des nœuds peut être accédée via RootNodeLibrary, qui est utilisé pour garder une référence des objets détachés pendant la sérialisation (comme les métadonnées ou les objets personnalisés) afin qu'il puisse être utilisé comme une bibliothèque.
...
| Nom | Type | Description |
| --- | --- | --- |
| parentScene | Scene | La scène parente. |
...
| Nom | Description |
| --- | --- |
| getSubScenes() | Récupère toutes les sous‑scènes |
...
| Nom | Description |
| --- | --- |
| getLibrary() | Les objets qui ne sont pas directement utilisés dans la hiérarchie de la scène peuvent être définis dans Library. Ceci est utile lorsque vous utilisez des sous‑scènes et placez des composants réutilisables sous les sous‑scènes. |
...
| Nom | Description |
| --- | --- |
| open(fileName, options) | Ouvre la scène depuis le chemin donné en utilisant le format de fichier spécifié. |
...
| Nom | Description |
| --- | --- |
| open(fileName) | Ouvre la scène depuis le chemin donné |
...
| Nom | Description |
| --- | --- |
| depuisFichier(fileName) | Ouvre la scène depuis le chemin donné |
...
| Nom | Description |
| --- | --- |
| save(fileName) | Enregistre la scène vers le chemin spécifié en utilisant le format de fichier spécifié. |
...
| Nom | Description |
| --- | --- |
| save(fileName, format) | Enregistre la scène vers le chemin spécifié en utilisant le format de fichier spécifié. |
...
| Nom | Description |
| --- | --- |
| save(fileName, options) | Enregistre la scène vers le chemin spécifié en utilisant le format de fichier spécifié. |
...
| Nom | Description |
| --- | --- |
| render(camera, fileName) | Rendu de la scène dans un fichier externe depuis la perspective de la caméra donnée. La taille de sortie par défaut est 1024x768 et le format de sortie est png |

 **Parameters:**

| Nom | Type | Description |
| --- | --- | --- |
| camera | Camera | Depuis quelle perspective de caméra rendre la scène |
...
| Nom | Description |
| --- | --- |
| render(camera, fileName, size, format) | Rendu de la scène dans un fichier externe depuis la perspective de la caméra donnée. |
...
| camera | Camera | Depuis quelle perspective de caméra rendre la scène |
| fileName | String | Le nom du fichier de sortie |
| size | Vector2 | La taille de l'image rendue finale |
...
| Nom | Description |
| --- | --- |
| render(camera, fileName, size, format, options) | Rendu de la scène dans un fichier externe depuis la perspective de la caméra donnée. |

...
url: /fr/nodejs-java/aspose.threed/objloadoptions/
---
...
| Nom | Description |
| --- | --- |
| constructor() | Constructeur de ObjLoadOptions |
...
| Nom | Description |
| --- | --- |
| getFlipCoordinateSystem() | Obtient ou définit si le système de coordonnées des points de contrôle/normales doit être inversé lors de l'importation. |
...
| Nom | Description |
| --- | --- |
| setFlipCoordinateSystem(value) | Obtient ou définit si le système de coordonnées des points de contrôle/normales doit être inversé lors de l'importation. |
...
| Nom | Description |
| --- | --- |
| getEnableMaterials() | Obtient ou définit si les matériaux doivent être importés pour chaque objet. |
...
| Nom | Description |
| --- | --- |
| setEnableMaterials(value) | Obtient ou définit si les matériaux doivent être importés pour chaque objet. |
...
| Nom | Description |
| --- | --- |
| getScale() | Échelles sur les axes x/y/z, la valeur par défaut est 1.0. |
...
| Nom | Description |
| --- | --- |
| setScale(value) | Échelles sur les axes x/y/z, la valeur par défaut est 1.0. |
...
| Nom | Description |
| --- | --- |
| getNormalizeNormal() | Obtient ou définit si le vecteur normal doit être normalisé pendant le chargement. La valeur par défaut est true. |
...
| Nom | Description |
| --- | --- |
| setNormalizeNormal(value) | Obtient ou définit si le vecteur normal doit être normalisé pendant le chargement. La valeur par défaut est true. |

...
| Nom | Description |
| --- | --- |
| getEntity() | Obtient ou définit la première entité attachée à ce nœud, si définie, les autres entités seront supprimées. L'entité du nœud. |
...
| Nom | Description |
| --- | --- |
| setEntity(value) | Obtient ou définit la première entité attachée à ce nœud, si définie, les autres entités seront supprimées. L'entité du nœud. |
...
| Nom | Description |
| --- | --- |
| getExcluded() | Obtient ou définit s'il faut exclure ce nœud et tous les nœuds enfants/entités lors de l'exportation. |
...
| Nom | Description |
| --- | --- |
| setExcluded(value) | Obtient ou définit s'il faut exclure ce nœud et tous les nœuds enfants/entités lors de l'exportation. |
...
| nodeName | String | Le nom du nouveau nœud enfant |
| entity | Entity | Entité par défaut attachée au nœud |
| material | Matériau | Le matériau attaché au nœud |
...
| Nom | Type | Description |
| --- | --- | --- |
| visiteur | NodeVisitor | Rappel du visiteur pour visiter le nœud |
...
| Nom | Description |
| --- | --- |
| addEntity(entity) | Ajoute une entité au nœud. |
...
| Nom | Description |
| --- | --- |
| addChildNode(node) | Ajoute un nœud enfant à ce nœud |
...
| Nom | Description |
| --- | --- |
| selectSingleObject(path) | Sélectionne un seul objet sous le nœud actuel en utilisant une syntaxe de requête similaire à XPath. |
...
| Nom | Description |
| --- | --- |
| selectObjects(path) | Sélectionne plusieurs objets sous le nœud actuel en utilisant une syntaxe de requête similaire à XPath. |

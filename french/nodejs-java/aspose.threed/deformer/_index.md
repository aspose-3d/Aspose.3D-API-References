...
url: /fr/nodejs-java/aspose.threed/deformer/
---
## Deformer class

Classe de base pour SkinDeformer et MorphTargetDeformer
...
| Nom | Description |
| --- | --- |
| constructor(name) | Initialise une nouvelle instance de la classe Deformer. |

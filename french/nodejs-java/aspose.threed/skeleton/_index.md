...
| Nom | Description |
| --- | --- |
| getSize() | Obtient ou définit la taille du nœud du membre utilisée dans les logiciels de CAO pour représenter la taille de l'os. |
...
| Nom | Description |
| --- | --- |
| setSize(value) | Obtient ou définit la taille du nœud du membre utilisée dans les logiciels de CAO pour représenter la taille de l'os. |

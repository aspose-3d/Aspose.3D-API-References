...
| Nom | Description |
| --- | --- |
| getGenerateMaterials() | Génère des matériaux avec des couleurs aléatoires pour chaque objet de la scène si la table des couleurs n'est pas exportée dans le fichier RVM. La valeur par défaut est true |
...
| Nom | Description |
| --- | --- |
| setGenerateMaterials(value) | Génère des matériaux avec des couleurs aléatoires pour chaque objet de la scène si la table des couleurs n'est pas exportée dans le fichier RVM. La valeur par défaut est true |
...
| Nom | Description |
| --- | --- |
| getDishLongitudeSegments() | Obtient ou définit le nombre de segments de longitude du dish, la valeur par défaut est 12 |
...
| Nom | Description |
| --- | --- |
| setDishLongitudeSegments(value) | Obtient ou définit le nombre de segments de longitude du dish, la valeur par défaut est 12 |
...
| Nom | Description |
| --- | --- |
| getDishLatitudeSegments() | Obtient ou définit le nombre de segments de latitude du dish, la valeur par défaut est 8 |
...
| Nom | Description |
| --- | --- |
| setDishLatitudeSegments(value) | Obtient ou définit le nombre de segments de latitude du dish, la valeur par défaut est 8 |

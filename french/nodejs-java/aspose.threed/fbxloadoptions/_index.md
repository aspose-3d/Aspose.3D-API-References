...
| Nom | Description |
| --- | --- |
| getKeepBuiltinGlobalSettings() | Obtient ou définit si l'on doit conserver les propriétés intégrées dans GlobalSettings qui ont un remplacement de propriété native dans AssetInfo. Réglez ceci sur true si vous souhaitez les propriétés complètes dans GlobalSettings. La valeur par défaut est false. |
...
| Nom | Description |
| --- | --- |
| setKeepBuiltinGlobalSettings(value) | Obtient ou définit si l'on doit conserver les propriétés intégrées dans GlobalSettings qui ont un remplacement de propriété native dans AssetInfo. Réglez ceci sur true si vous souhaitez les propriétés complètes dans GlobalSettings. La valeur par défaut est false. |

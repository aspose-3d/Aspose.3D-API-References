...
| Nom | Description |
| --- | --- |
| getSlices() | Les tranches de la géométrie extrudée torsadée, la valeur par défaut est 1. |
...
| Nom | Description |
| --- | --- |
| setSlices(value) | Les tranches de la géométrie extrudée torsadée, la valeur par défaut est 1. |
...
| Nom | Description |
| --- | --- |
| getCenter() | Si cette valeur est false, la plage Z de l'extrusion linéaire est de 0 à height, sinon la plage est de -height/2 à height/2. |
...
| Nom | Description |
| --- | --- |
| setCenter(value) | Si cette valeur est false, la plage Z de l'extrusion linéaire est de 0 à height, sinon la plage est de -height/2 à height/2. |
...
| Nom | Description |
| --- | --- |
| getTwist() | Le nombre de degrés à travers lesquels la forme est extrudée. |
...
| Nom | Description |
| --- | --- |
| setTwist(value) | Le nombre de degrés à travers lesquels la forme est extrudée. |

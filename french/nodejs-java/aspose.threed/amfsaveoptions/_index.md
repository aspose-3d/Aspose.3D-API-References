...
url: /fr/nodejs-java/aspose.threed/amfsaveoptions/
---
...
| Nom | Description |
| --- | --- |
| constructor() | Constructeur de AmfSaveOptions |
...
| Nom | Description |
| --- | --- |
| getEnableCompression() | Indique s'il faut utiliser la compression pour réduire la taille finale du fichier, la valeur par défaut est vraie |
...
| Nom | Description |
| --- | --- |
| setEnableCompression(value) | Indique s'il faut utiliser la compression pour réduire la taille finale du fichier, la valeur par défaut est vraie |

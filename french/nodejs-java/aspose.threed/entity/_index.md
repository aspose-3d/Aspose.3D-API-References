...
url: /fr/nodejs-java/aspose.threed/entity/
---
## Entity class

La classe de base de toutes les entités. Entity représente un objet concret qui est attaché sous un nœud tel que Light/Geometry.
...
| Nom | Description |
| --- | --- |
| constructor(name) | Initialise une nouvelle instance de la classe Entity. |

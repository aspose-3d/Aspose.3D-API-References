...
Une transformation contient des informations qui permettent d'accéder à la translation/échelle/rotation de l'objet ou à la matrice de transformation avec un coût minimal.  Elle est utilisée par la transformation locale.  @hideconstructor
...
| Nom | Description |
| --- | --- |
| getGeometricScaling() | Obtient ou définit la mise à l'échelle géométrique. La transformation géométrique n'affecte que les entités attachées et laisse les nœuds enfants inchangés. Elle sera fusionnée comme transformation locale lors de l'exportation de la transformation géométrique vers des types de fichiers qui ne la prennent pas en charge. |
...
| Nom | Description |
| --- | --- |
| setGeometricScaling(value) | Obtient ou définit la mise à l'échelle géométrique. La transformation géométrique n'affecte que les entités attachées et laisse les nœuds enfants inchangés. Elle sera fusionnée comme transformation locale lors de l'exportation de la transformation géométrique vers des types de fichiers qui ne la prennent pas en charge. |
...
| Nom | Description |
| --- | --- |
| getPreRotation() | Obtient ou définit la pré-rotation exprimée en degrés |
...
| Nom | Description |
| --- | --- |
| setPreRotation(value) | Obtient ou définit la pré-rotation exprimée en degrés |
...
| Nom | Description |
| --- | --- |
| getPostRotation() | Obtient ou définit la post-rotation exprimée en degrés |
...
| Nom | Description |
| --- | --- |
| setPostRotation(value) | Obtient ou définit la post-rotation exprimée en degrés |
...
| Nom | Description |
| --- | --- |
| getEulerAngles() | Obtient ou définit la rotation exprimée en angles d'Euler, mesurée en degrés |
...
| Nom | Description |
| --- | --- |
| setEulerAngles(value) | Obtient ou définit la rotation exprimée en angles d'Euler, mesurée en degrés |
...
| Nom | Description |
| --- | --- |
| getRotation() | Obtient ou définit la rotation exprimée en quaternion. |
...
| Nom | Description |
| --- | --- |
| setRotation(value) | Obtient ou définit la rotation exprimée en quaternion. |
...
| Nom | Description |
| --- | --- |
| getTransformMatrix() | Obtient ou définit la matrice de transformation. L'affectation à celle-ci réinitialisera la Translation, l'Échelle et la Rotation, la GeometricRotation, la GeometricScaling et la GeometricTranslation ne seront pas affectées. |
...
| Nom | Description |
| --- | --- |
| setTransformMatrix(value) | Obtient ou définit la matrice de transformation. L'affectation à celle-ci réinitialisera la Translation, l'Échelle et la Rotation, la GeometricRotation, la GeometricScaling et la GeometricTranslation ne seront pas affectées. |
...
| Nom | Description |
| --- | --- |
| setGeometricScaling(sx, sy, sz) | Définit la mise à l'échelle géométrique. La transformation géométrique n'affecte que les entités attachées et laisse les nœuds enfants inchangés. Elle sera fusionnée comme transformation locale lors de l'exportation de la transformation géométrique vers des types de fichiers qui ne la prennent pas en charge. |

...
url: /fr/nodejs-java/aspose.threed/transformedcurve/
---
## TransformedCurve class

Une TransformedCurve place une courbe en utilisant une matrice de transformation.  Cela permet d'effectuer une transformation à l'intérieur d'une TrimmedCurve ou d'une CompositeCurve.
...
| Nom | Description |
| --- | --- |
| constructor() | Le constructeur de TransformedCurve |
...
| Nom | Description |
| --- | --- |
| constructor_overload(basisCurve, transformation) | Le constructeur de TransformedCurve |
...
| Nom | Description |
| --- | --- |
| getTransformMatrix() | La matrice de transformation. |
...
| Nom | Description |
| --- | --- |
| setTransformMatrix(value) | La matrice de transformation. |
...
| Nom | Description |
| --- | --- |
| getBasisCurve() | La courbe de base. |
...
| Nom | Description |
| --- | --- |
| setBasisCurve(value) | La courbe de base. |

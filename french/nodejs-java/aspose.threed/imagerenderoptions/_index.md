...
| Nom | Description |
| --- | --- |
| getBackgroundColor() | La couleur d'arrière-plan du rendu. |
...
| Nom | Description |
| --- | --- |
| setBackgroundColor(value) | La couleur d'arrière-plan du rendu. |
...
| Nom | Description |
| --- | --- |
| getAssetDirectories() | Répertoires contenant les actifs externes (comme les textures). |

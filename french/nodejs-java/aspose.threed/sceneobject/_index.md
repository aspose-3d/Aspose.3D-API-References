...
url: /fr/nodejs-java/aspose.threed/sceneobject/
---
## SceneObject class
...
| Nom | Description |
| --- | --- |
| constructor(name) | Initialise un SceneObject avec un nom par défaut. |
...
| Nom | Description |
| --- | --- |
| constructor_overload() | Initialise un SceneObject. |

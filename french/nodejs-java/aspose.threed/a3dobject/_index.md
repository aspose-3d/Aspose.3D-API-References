...
url: /fr/nodejs-java/aspose.threed/a3dobject/
---
## A3DObject class
...
| Nom | Description |
| --- | --- |
| constructor(name) | Initialise une nouvelle instance de la classe A3DObject. |
...
| Nom | Description |
| --- | --- |
| constructor_overload() | Initialise une nouvelle instance de la classe A3DObject sans nom. |

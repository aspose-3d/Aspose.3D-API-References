...
url: /fr/nodejs-java/aspose.threed/tshape/
---
## TShape class
...
| Nom | Description |
| --- | --- |
| constructor() | Constructeur de TShape |
...
| Nom | Description |
| --- | --- |
| getDepth() | Obtient ou définit la longueur de la traverse. |
...
| Nom | Description |
| --- | --- |
| setDepth(value) | Obtient ou définit la longueur de la traverse. |
...
| Nom | Description |
| --- | --- |
| getFlangeWidth() | Obtient ou définit la longueur de l'aile. |
...
| Nom | Description |
| --- | --- |
| setFlangeWidth(value) | Obtient ou définit la longueur de l'aile. |
...
| Nom | Description |
| --- | --- |
| getWebThickness() | Obtient ou définit l'épaisseur de paroi de la traverse. |
...
| Nom | Description |
| --- | --- |
| setWebThickness(value) | Obtient ou définit l'épaisseur de paroi de la traverse. |
...
| Nom | Description |
| --- | --- |
| getFlangeThickness() | Obtient ou définit l'épaisseur de paroi de l'aile. |
...
| Nom | Description |
| --- | --- |
| setFlangeThickness(value) | Obtient ou définit l'épaisseur de paroi de l'aile. |
...
| Nom | Description |
| --- | --- |
| getFilletRadius() | Obtient ou définit le rayon du congé entre l'âme et la bride. |
...
| Nom | Description |
| --- | --- |
| setFilletRadius(value) | Obtient ou définit le rayon du congé entre l'âme et la bride. |
...
| Nom | Description |
| --- | --- |
| getFlangeEdgeRadius() | Obtient ou définit le rayon du bord de la bride. |
...
| Nom | Description |
| --- | --- |
| setFlangeEdgeRadius(value) | Obtient ou définit le rayon du bord de la bride. |
...
| Nom | Description |
| --- | --- |
| getWebEdgeRadius() | Obtient ou définit le rayon du bord de l'âme. |
...
| Nom | Description |
| --- | --- |
| setWebEdgeRadius(value) | Obtient ou définit le rayon du bord de l'âme. |

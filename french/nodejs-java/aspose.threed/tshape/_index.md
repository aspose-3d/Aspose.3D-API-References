...
| Nom | Description |
| --- | --- |
| getDepth() | Obtient ou définit la longueur de l'âme. |
...
| Nom | Description |
| --- | --- |
| setDepth(value) | Obtient ou définit la longueur de l'âme. |
...
| Nom | Description |
| --- | --- |
| getWebThickness() | Obtient ou définit l'épaisseur de paroi de l'âme. |
...
| Nom | Description |
| --- | --- |
| setWebThickness(value) | Obtient ou définit l'épaisseur de paroi de l'âme. |
...
| Nom | Description |
| --- | --- |
| getFilletRadius() | Obtient ou définit le rayon du congé entre l'âme et l'aile. |
...
| Nom | Description |
| --- | --- |
| setFilletRadius(value) | Obtient ou définit le rayon du congé entre l'âme et l'aile. |
...
| Nom | Description |
| --- | --- |
| getFlangeEdgeRadius() | Obtient ou définit le rayon du bord de l'aile. |
...
| Nom | Description |
| --- | --- |
| setFlangeEdgeRadius(value) | Obtient ou définit le rayon du bord de l'aile. |
...
| Nom | Description |
| --- | --- |
| getWebEdgeRadius() | Obtient ou définit le rayon du bord web. |
...
| Nom | Description |
| --- | --- |
| setWebEdgeRadius(value) | Obtient ou définit le rayon du bord web. |

...
Cette classe vous permet de créer un profil 2D directement à partir d'une courbe arbitraire.
...
| Nom | Description |
| --- | --- |
| getCurve() | La Courbe utilisée pour construire le profil |
...
| Nom | Description |
| --- | --- |
| setCurve(value) | La Courbe utilisée pour construire le profil |

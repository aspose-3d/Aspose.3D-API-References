...
url: /fr/nodejs-java/aspose.threed/arbitraryprofile/
---
...
| Nom | Description |
| --- | --- |
| constructor() | Constructeur de ArbitraryProfile |
...
| Nom | Description |
| --- | --- |
| constructor_overload(curve) | Constructeur de ArbitraryProfile avec une courbe initiale. |
...
| Nom | Description |
| --- | --- |
| getCurve() | La Curve utilisée pour construire le profil |
...
| Nom | Description |
| --- | --- |
| setCurve(value) | La Curve utilisée pour construire le profil |

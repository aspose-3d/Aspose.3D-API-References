...
url: /fr/nodejs-java/aspose.threed/pbrmaterial/
---
## PbrMaterial class
...
| Nom | Description |
| --- | --- |
| constructor() | Construit une instance de matériau PBR par défaut |
...
| Nom | Description |
| --- | --- |
| constructor_overload(albedo) | Construit un matériau PBR par défaut avec la valeur de couleur albedo spécifiée. |

 **Parameters:**

| Nom | Type | Description |
| --- | --- | --- |
| albedo | Vector3 | La valeur de couleur albedo par défaut |
...
| Nom | Description |
| --- | --- |
| getSpecularTexture() | Obtient ou définit la texture pour la couleur spéculaire |
...
| Nom | Description |
| --- | --- |
| setSpecularTexture(value) | Obtient ou définit la texture pour la couleur spéculaire |
...
| Nom | Description |
| --- | --- |
| getAlbedoTexture() | Obtient ou définit la texture pour l'albedo |
...
| Nom | Description |
| --- | --- |
| setAlbedoTexture(value) | Obtient ou définit la texture pour l'albedo |
...
| Nom | Description |
| --- | --- |
| getAlbedo() | Obtient ou définit la couleur de base du matériau |
...
| Nom | Description |
| --- | --- |
| setAlbedo(value) | Obtient ou définit la couleur de base du matériau |
...
| Nom | Description |
| --- | --- |
| getOcclusionTexture() | Obtient ou définit la texture pour l'occlusion ambiante |
...
| Nom | Description |
| --- | --- |
| setOcclusionTexture(value) | Obtient ou définit la texture pour l'occlusion ambiante |
...
| Nom | Description |
| --- | --- |
| getOcclusionFactor() | Obtient ou définit le facteur d'occlusion ambiante |
...
| Nom | Description |
| --- | --- |
| setOcclusionFactor(value) | Obtient ou définit le facteur d'occlusion ambiante |
...
| Nom | Description |
| --- | --- |
| getMetallicFactor() | Obtient ou définit la métallisation du matériau, une valeur de 1 signifie que le matériau est un métal et une valeur de 0 signifie que le matériau est un diélectrique. |
...
| Nom | Description |
| --- | --- |
| setMetallicFactor(value) | Obtient ou définit la métallisation du matériau, une valeur de 1 signifie que le matériau est un métal et une valeur de 0 signifie que le matériau est un diélectrique. |
...
| Nom | Description |
| --- | --- |
| getRoughnessFactor() | Obtient ou définit la rugosité du matériau, une valeur de 1 signifie que le matériau est complètement rugueux et une valeur de 0 signifie que le matériau est complètement lisse. |
...
| Nom | Description |
| --- | --- |
| setRoughnessFactor(value) | Obtient ou définit la rugosité du matériau, une valeur de 1 signifie que le matériau est complètement rugueux et une valeur de 0 signifie que le matériau est complètement lisse. |
...
| Nom | Description |
| --- | --- |
| getMetallicRoughness() | Obtient ou définit la texture pour le métallique (dans le canal R) et la rugosité (dans le canal G) |
...
| Nom | Description |
| --- | --- |
| setMetallicRoughness(value) | Obtient ou définit la texture pour le métallique (dans le canal R) et la rugosité (dans le canal G) |
...
| Nom | Description |
| --- | --- |
| fromMaterial(material) | Autorise la conversion d'un autre matériau en PbrMaterial |

 **Parameters:**

| Nom | Type | Description |
| --- | --- | --- |
| matière | Matériau | null |

...
| Nom | Description |
| --- | --- |
| depuisFichier(fileName) | Chargez FontFile à partir du nom de fichier |
...
| Nom | Description |
| --- | --- |
| parse(bytes) | Analysez FontFile à partir des octets |

 **Parameters:**

| Nom | Type | Description |
| --- | --- | --- |
| octets | byte[] | Contenu brut du fichier de police OTF |

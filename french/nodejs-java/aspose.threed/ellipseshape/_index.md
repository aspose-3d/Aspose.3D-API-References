...
url: /fr/nodejs-java/aspose.threed/ellipseshape/
---
## EllipseShape class

Forme d'ellipse compatible IFC définie par des paramètres. La position centrale du profil se trouve au centre de la boîte englobante.
...
| Nom | Description |
| --- | --- |
| getSemiAxis1() | Obtient ou définit le premier rayon de l'ellipse mesuré dans la direction de l'axe x. |
...
| Nom | Description |
| --- | --- |
| setSemiAxis1(value) | Obtient ou définit le premier rayon de l'ellipse mesuré dans la direction de l'axe x. |
...
| Nom | Description |
| --- | --- |
| getSemiAxis2() | Obtient ou définit le deuxième rayon de l'ellipse mesuré dans la direction de l'axe y. |
...
| Nom | Description |
| --- | --- |
| setSemiAxis2(value) | Obtient ou définit le deuxième rayon de l'ellipse mesuré dans la direction de l'axe y. |

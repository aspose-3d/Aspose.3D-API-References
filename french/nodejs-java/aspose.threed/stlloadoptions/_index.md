...
| Nom | Description |
| --- | --- |
| getFlipCoordinateSystem() | Obtient ou définit s'il faut inverser le système de coordonnées des points de contrôle/normales lors de l'importation. |
...
| Nom | Description |
| --- | --- |
| setFlipCoordinateSystem(value) | Obtient ou définit s'il faut inverser le système de coordonnées des points de contrôle/normales lors de l'importation. |
...
| Nom | Description |
| --- | --- |
| getRecalculateNormal() | Ignorer les données de normales stockées dans le fichier STL et recalculer les normales en fonction de la position des sommets. La valeur par défaut est false. |
...
| Nom | Description |
| --- | --- |
| setRecalculateNormal(value) | Ignorer les données de normales stockées dans le fichier STL et recalculer les normales en fonction de la position des sommets. La valeur par défaut est false. |

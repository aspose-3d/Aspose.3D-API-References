...
url: /fr/nodejs-java/aspose.threed/stlsaveoptions/
---
...
| Nom | Description |
| --- | --- |
| constructor() | Initialise une nouvelle instance de StlSaveOptions. |
...
| Nom | Description |
| --- | --- |
| constructor_overload(contentType) | Initialise une nouvelle instance de StlSaveOptions. |
...
| Nom | Description |
| --- | --- |
| getFlipCoordinateSystem() | Obtient ou définit si le système de coordonnées des points de contrôle/normales doit être inversé lors de l'exportation. |
...
| Nom | Description |
| --- | --- |
| setFlipCoordinateSystem(value) | Obtient ou définit si le système de coordonnées des points de contrôle/normales doit être inversé lors de l'exportation. |

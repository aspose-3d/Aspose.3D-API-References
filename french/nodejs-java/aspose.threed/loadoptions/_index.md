...
url: /fr/nodejs-java/aspose.threed/loadoptions/
---
## LoadOptions class

La classe de base pour configurer les options de chargement de fichiers selon différents types  @hideconstructor

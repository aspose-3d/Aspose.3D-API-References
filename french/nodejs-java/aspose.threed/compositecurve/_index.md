...
url: /fr/nodejs-java/aspose.threed/compositecurve/
---
## CompositeCurve class

Un CompositeCurve se compose de plusieurs segments de courbe.
...
| Nom | Description |
| --- | --- |
| constructor() | Constructeur de CompositeCurve |
...
| Nom | Description |
| --- | --- |
| getSegments() | Les segments de la courbe. |
...
| Nom | Description |
| --- | --- |
| addSegment(curve, sameDirection) | Le |

...
| Nom | Description |
| --- | --- |
| getProjectionType() | Obtient ou définit le type de projection de la caméra. Par défaut, la projection en perspective est utilisée. La valeur de la propriété est la constante entière ProjectionType. |
...
| Nom | Description |
| --- | --- |
| setProjectionType(value) | Obtient ou définit le type de projection de la caméra. Par défaut, la projection en perspective est utilisée. La valeur de la propriété est la constante entière ProjectionType. |
...
| Nom | Description |
| --- | --- |
| setRotationMode(value) | Obtient ou définit le mode d'orientation du frustum. Cette propriété ne fonctionne que lorsque Target est nul. Si la valeur est RotationMode.FIXED_TARGET, la direction est toujours calculée par la propriété LookAt. Sinon, LookAt est toujours calculé par la Direction. La valeur de la propriété est la constante entière RotationMode. |
...
| Nom | Description |
| --- | --- |
| getAspect() | Obtient ou définit le rapport d'aspect du frustum |
...
| Nom | Description |
| --- | --- |
| setAspect(value) | Obtient ou définit le rapport d'aspect du frustum |
...
| Nom | Description |
| --- | --- |
| getOrthoHeight() | Obtient ou définit la hauteur lorsque le frustum est en projection orthographique. |
...
| Nom | Description |
| --- | --- |
| setOrthoHeight(value) | Obtient ou définit la hauteur lorsque le frustum est en projection orthographique. |
...
| Nom | Description |
| --- | --- |
| getDirection() | Obtient ou définit la direction vers laquelle la caméra regarde. Les modifications de cette propriété affecteront également les propriétés LookAt et Target. |
...
| Nom | Description |
| --- | --- |
| setDirection(value) | Obtient ou définit la direction vers laquelle la caméra regarde. Les modifications de cette propriété affecteront également les propriétés LookAt et Target. |
...
| Nom | Description |
| --- | --- |
| moveForward(distance) | Déplace la caméra vers l'avant dans sa direction ou vers la cible. |

 **Parameters:**

| Nom | Type | Description |
| --- | --- | --- |
| distance | Nombre | Quelle distance avancer |

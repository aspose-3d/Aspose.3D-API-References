...
url: /fr/nodejs-java/aspose.threed/gltfloadoptions/
---
...
| Nom | Description |
| --- | --- |
| constructor() | Constructeur de GltfLoadOptions |
...
| Nom | Description |
| --- | --- |
| getFlipTexCoordV() | Inverser la coordonnée v(t) dans les coordonnées de texture du maillage, la valeur par défaut est true. |
...
| Nom | Description |
| --- | --- |
| setFlipTexCoordV(value) | Inverser la coordonnée v(t) dans les coordonnées de texture du maillage, la valeur par défaut est true. |

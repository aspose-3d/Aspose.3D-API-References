...
Options d'enregistrement pour l'exportation de la scène au format PLY.
...
| Nom | Description |
| --- | --- |
| getPointCloud() | Exporte la scène en nuage de points, la valeur par défaut est false. |
...
| Nom | Description |
| --- | --- |
| setPointCloud(value) | Exporte la scène en nuage de points, la valeur par défaut est false. |
...
| Nom | Description |
| --- | --- |
| getFlipCoordinate() | Inverse les coordonnées lors de l'enregistrement de la scène, la valeur par défaut est true. |
...
| Nom | Description |
| --- | --- |
| setFlipCoordinate(value) | Inverse les coordonnées lors de l'enregistrement de la scène, la valeur par défaut est true. |

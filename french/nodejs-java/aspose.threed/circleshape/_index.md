...
url: /fr/nodejs-java/aspose.threed/circleshape/
---
## CircleShape class

Profil circulaire compatible IFC, qui peut être utilisé pour construire un maillage via LinearExtrusion
...
| Nom | Description |
| --- | --- |
| constructor() | Construit un profil CircleShape avec un rayon par défaut de 5. |
...
| Nom | Description |
| --- | --- |
| constructor_overload(radius) | Construit un profil CircleShape avec un rayon spécifié. |
...
| Nom | Description |
| --- | --- |
| getRadius() | Obtient ou définit le rayon du cercle. |
...
| Nom | Description |
| --- | --- |
| setRadius(value) | Obtient ou définit le rayon du cercle. |

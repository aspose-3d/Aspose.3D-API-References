...
| Nom | Description |
| --- | --- |
| constructor() | Construit un profil CircleShape avec un rayon par défaut (5). |
...
| Nom | Description |
| --- | --- |
| constructor_overload(radius) | Construit un profil CircleShape avec le rayon spécifié. |

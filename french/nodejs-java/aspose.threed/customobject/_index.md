...
url: /fr/nodejs-java/aspose.threed/customobject/
---
## CustomObject class

Les métadonnées ou objets personnalisés utilisés dans les fichiers 3D sont gérés par cette classe. Toutes les propriétés personnalisées sont enregistrées en tant que propriétés dynamiques.
...
| Nom | Description |
| --- | --- |
| constructor() | Initialise une nouvelle instance de la classe CustomObject. |
...
| Nom | Description |
| --- | --- |
| constructor_overload(name) | Initialise une nouvelle instance de la classe CustomObject. |

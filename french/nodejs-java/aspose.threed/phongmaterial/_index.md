...
| Nom | Description |
| --- | --- |
| getShininess() | Obtient ou définit la brillance, cela contrôle la taille du point lumineux spéculaire. La formule du spéculaire : SpecularColor SpecularFactor (N dot H) ^ Shininess La brillance. |
...
| Nom | Description |
| --- | --- |
| setShininess(value) | Obtient ou définit la brillance, cela contrôle la taille du point lumineux spéculaire. La formule du spéculaire : SpecularColor SpecularFactor (N dot H) ^ Shininess La brillance. |

...
url: /fr/nodejs-java/aspose.threed/colladasaveoptions/
---
...
| Nom | Description |
| --- | --- |
| constructor() | Constructeur de ColladaSaveOptions |
...
| Nom | Description |
| --- | --- |
| getIndented() | Obtient ou définit si le document XML exporté est indenté. |
...
| Nom | Description |
| --- | --- |
| setIndented(value) | Obtient ou définit si le document XML exporté est indenté. |
...
| Nom | Description |
| --- | --- |
| getTransformStyle() | Obtient ou définit le style de transformation des nœuds. La valeur de la propriété est la constante entière ColladaTransformStyle. |
...
| Nom | Description |
| --- | --- |
| setTransformStyle(value) | Obtient ou définit le style de transformation des nœuds. La valeur de la propriété est la constante entière ColladaTransformStyle. |

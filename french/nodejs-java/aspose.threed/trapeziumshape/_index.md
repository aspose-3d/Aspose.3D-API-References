...
url: /fr/nodejs-java/aspose.threed/trapeziumshape/
---
...
| Nom | Description |
| --- | --- |
| constructor() | Constructeur de TrapeziumShape |
...
| Nom | Description |
| --- | --- |
| getBottomXDim() | Obtient ou définit l'étendue de la ligne inférieure mesurée le long de l'axe x. |
...
| Nom | Description |
| --- | --- |
| setBottomXDim(value) | Obtient ou définit l'étendue de la ligne inférieure mesurée le long de l'axe x. |
...
| Nom | Description |
| --- | --- |
| getTopXDim() | Obtient ou définit l'étendue de la ligne supérieure mesurée le long de l'axe x. |
...
| Nom | Description |
| --- | --- |
| setTopXDim(value) | Obtient ou définit l'étendue de la ligne supérieure mesurée le long de l'axe x. |
...
| Nom | Description |
| --- | --- |
| getYDim() | Obtient ou définit la distance entre les lignes supérieure et inférieure mesurée le long de l'axe y. |
...
| Nom | Description |
| --- | --- |
| setYDim(value) | Obtient ou définit la distance entre les lignes supérieure et inférieure mesurée le long de l'axe y. |
...
| Nom | Description |
| --- | --- |
| getTopXOffset() | Obtient ou définit le décalage du début de la ligne supérieure à la ligne inférieure. |
...
| Nom | Description |
| --- | --- |
| setTopXOffset(value) | Obtient ou définit le décalage du début de la ligne supérieure à la ligne inférieure. |

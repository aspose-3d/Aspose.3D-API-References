...
| Nom | Description |
| --- | --- |
| getFlipCoordinateSystem() | Inverser le système de coordonnées, c'est true par défaut |
...
| Nom | Description |
| --- | --- |
| setFlipCoordinateSystem(value) | Inverser le système de coordonnées, c'est true par défaut |

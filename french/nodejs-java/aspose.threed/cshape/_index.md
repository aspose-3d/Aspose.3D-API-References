...
url: /fr/nodejs-java/aspose.threed/cshape/
---
## CShape class

Profil en forme de C compatible IFC défini par des paramètres.  La position centrale du profil se trouve au centre de la boîte englobante.
...
| Nom | Description |
| --- | --- |
| constructor() | Constructeur de CShape |
...
| Nom | Description |
| --- | --- |
| getGirth() | Obtient ou définit la longueur du girth. |
...
| Nom | Description |
| --- | --- |
| setGirth(value) | Obtient ou définit la longueur du girth. |
...
| Nom | Description |
| --- | --- |
| getWallThickness() | Obtient ou définit l'épaisseur du mur. |
...
| Nom | Description |
| --- | --- |
| setWallThickness(value) | Obtient ou définit l'épaisseur du mur. |
...
| Nom | Description |
| --- | --- |
| getInternalFilletRadius() | Obtient ou définit le rayon de congé interne. |
...
| Nom | Description |
| --- | --- |
| setInternalFilletRadius(value) | Obtient ou définit le rayon de congé interne. |

...
url: /fr/nodejs-java/aspose.threed/hollowcircleshape/
---
...
| Nom | Description |
| --- | --- |
| getWallThickness() | Obtient ou définit la différence entre le rayon extérieur et le rayon intérieur. |
...
| Nom | Description |
| --- | --- |
| setWallThickness(value) | Obtient ou définit la différence entre le rayon extérieur et le rayon intérieur. |

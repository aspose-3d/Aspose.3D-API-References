...
url: /fr/nodejs-java/aspose.threed/circle/
---
## Circle class

Une courbe circulaire se compose d'un ensemble de points sur le bord de la forme circulaire.
...
| Nom | Description |
| --- | --- |
| constructor() | Constructeur de Circle |
...
| Nom | Description |
| --- | --- |
| constructor_overload(radius) | Constructeur de Circle |

 **Parameters:**

| Nom | Type | Description |
| --- | --- | --- |
| radius | Number | Le rayon de la courbe du cercle. |
...
| Nom | Description |
| --- | --- |
| getRadius() | Le rayon de la courbe du cercle, la valeur par défaut est 10 |
...
| Nom | Description |
| --- | --- |
| setRadius(value) | Le rayon de la courbe du cercle, la valeur par défaut est 10 |

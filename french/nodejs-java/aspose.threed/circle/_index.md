...
Une courbe circulaire consiste en un ensemble de points sur le bord de la forme du cercle.
...
| Nom | Description |
| --- | --- |
| constructor() | Constructeur de Cercle |
...
| Nom | Description |
| --- | --- |
| constructor_overload(radius) | Constructeur de Cercle |

 **Parameters:**

| Nom | Type | Description |
| --- | --- | --- |
| rayon | Nombre | Le rayon de la courbe du cercle. |

...
| Nom | Description |
| --- | --- |
| getPrettyPrint() | Le contenu JSON du fichier GLTF est indenté pour la lecture humaine, la valeur par défaut est false |
...
| Nom | Description |
| --- | --- |
| setPrettyPrint(value) | Le contenu JSON du fichier GLTF est indenté pour la lecture humaine, la valeur par défaut est false |
...
| Nom | Description |
| --- | --- |
| getEmbedAssets() | Intégrer tous les actifs externes en base64 dans un seul fichier en mode ASCII, la valeur par défaut est false. |
...
| Nom | Description |
| --- | --- |
| setEmbedAssets(value) | Intégrer tous les actifs externes en base64 dans un seul fichier en mode ASCII, la valeur par défaut est false. |
...
| Nom | Description |
| --- | --- |
| getFlipTexCoordV() | Inverser le composant v(t) des coordonnées de texture, la valeur par défaut est true. |
...
| Nom | Description |
| --- | --- |
| setFlipTexCoordV(value) | Inverser le composant v(t) des coordonnées de texture, la valeur par défaut est true. |
...
| Nom | Description |
| --- | --- |
| getBufferFile() | Le nom du fichier du tampon externe utilisé pour stocker les données binaires. Si ce fichier n'est pas spécifié, Aspose.3D générera un nom pour vous. Ceci est ignoré lors de l'exportation glTF en mode binaire. |
...
| Nom | Description |
| --- | --- |
| setBufferFile(value) | Le nom du fichier du tampon externe utilisé pour stocker les données binaires. Si ce fichier n'est pas spécifié, Aspose.3D générera un nom pour vous. Ceci est ignoré lors de l'exportation glTF en mode binaire. |

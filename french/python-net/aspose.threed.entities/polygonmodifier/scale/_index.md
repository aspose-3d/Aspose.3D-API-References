...
type: docs
weight: 70
url: /fr/python-net/aspose.threed.entities/polygonmodifier/scale/
is_root: false
---
...
# Charger un fichier de test pour le redimensionnement
scene = Scene.from_file("input.fbx")
# mettre à l'échelle toutes les géométries 10 fois.

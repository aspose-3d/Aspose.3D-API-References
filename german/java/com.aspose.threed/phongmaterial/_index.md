...
description: Material für das Blinn‑Phong‑Shading‑Modell.
type: docs
weight: 126
url: /de/java/com.aspose.threed/phongmaterial/
---
...
| --- | --- |
| [PhongMaterial()](#PhongMaterial--) | Initialisiert eine neue Instanz der [PhongMaterial](../../com.aspose.threed/phongmaterial)-Klasse. |
| [PhongMaterial(String name)](#PhongMaterial-java.lang.String-) | Initialisiert eine neue Instanz der [PhongMaterial](../../com.aspose.threed/phongmaterial)-Klasse. |
## Felder
...
| [getReflectionColor()](#getReflectionColor--) | Liefert die Reflexionsfarbe. |
| [getReflectionFactor()](#getReflectionFactor--) | Liefert die Dämpfung der Reflexionsfarbe. |
| [getShininess()](#getShininess--) | Liefert den Glanzgrad, der die Größe des spekularen Glanzpunkts steuert. |
| [getSpecularColor()](#getSpecularColor--) | Liefert die Spiegelungsfarbe. |
| [getSpecularFactor()](#getSpecularFactor--) | Liefert den Spiegelungsfaktor. |
...
| [setReflectionColor(Vector3 value)](#setReflectionColor-com.aspose.threed.Vector3-) | Setzt die Reflexionsfarbe. |
| [setReflectionFactor(double value)](#setReflectionFactor-double-) | Legt die Dämpfung der Reflexionsfarbe fest. |
| [setShininess(double value)](#setShininess-double-) | Legt den Glanzgrad fest, dies steuert die Größe des spekularen Highlights. |
| [setSpecularColor(Vector3 value)](#setSpecularColor-com.aspose.threed.Vector3-) | Legt die specular-Farbe fest. |
| [setSpecularFactor(double value)](#setSpecularFactor-double-) | Legt den specular-Faktor fest. |
...
Initialisiert eine neue Instanz der [PhongMaterial](../../com.aspose.threed/phongmaterial)-Klasse.
...
**Returns:**
double - die Dämpfung der Reflexionsfarbe.
...
**Returns:**
double - der Glanzgrad, dies steuert die Größe des spekularen Highlights. Die Formel für specular: SpecularColor \* SpecularFactor \* (N dot H) ^ Shininess
...
**Returns:**
double - der specular-Faktor. Die Formel für specular: SpecularColor \* SpecularFactor \* (N dot H) ^ Shininess

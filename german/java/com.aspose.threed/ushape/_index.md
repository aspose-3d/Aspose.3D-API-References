...
type: docs
weight: 199
url: /de/java/com.aspose.threed/ushape/
---
...
| --- | --- |
| [UShape()](#UShape--) | Konstruktor von [UShape](../../com.aspose.threed/ushape) |
## Methoden
...
| [getEdgeRadius()](#getEdgeRadius--) | Ermittelt den Radius der Kante in der Flanschkante. |
...
| [getWebThickness()](#getWebThickness--) | Ermittelt die Dicke des Webs. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setEdgeRadius(double value)](#setEdgeRadius-double-) | Setzt den Radius der Kante in der Flanschkante. |
...
| [setWebThickness(double value)](#setWebThickness-double-) | Setzt die Dicke des Webs. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Konstruktor von [UShape](../../com.aspose.threed/ushape)
...
Ermittelt den Radius der Kante in der Flanschkante.

**Returns:**
double – der Radius der Kante in der Flanschkante.
...
Ermittelt die Dicke des Webs.

**Returns:**
double – die Dicke des Webs.
### hashCode() {#hashCode--}
```
...
Setzt den Radius der Kante in der Flanschkante.

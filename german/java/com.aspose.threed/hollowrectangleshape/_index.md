...
description: IFC-kompatible hohle rechteckige Form mit sowohl inneren als auch äußeren abgerundeten Ecken.
type: docs
weight: 79
url: /de/java/com.aspose.threed/hollowrectangleshape/
---
...
| [getInnerFilletRadius()](#getInnerFilletRadius--) | Der innere Rundungsradius des inneren Rechtecks. |
...
| [getWallThickness()](#getWallThickness--) | Die Dicke zwischen der Begrenzung des Rechtecks und dem inneren Loch |
...
| [setInnerFilletRadius(double value)](#setInnerFilletRadius-double-) | Der innere Rundungsradius des inneren Rechtecks. |
...
| [setWallThickness(double value)](#setWallThickness-double-) | Die Dicke zwischen der Begrenzung des Rechtecks und dem inneren Loch |
...
Der innere Rundungsradius des inneren Rechtecks.

**Returns:**
double - Der innere Rundungsradius des inneren Rechtecks.
### getName() {#getName--}
```
...
**Returns:**
double - Die Dicke zwischen der Begrenzung des Rechtecks und dem inneren Loch
### getXDim() {#getXDim--}
```

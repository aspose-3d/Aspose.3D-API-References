...
description: Definiert die Vertex-Falte für die angegebenen Komponenten.
type: docs
weight: 224
url: /de/java/com.aspose.threed/vertexelementvertexcrease/
---
...
| --- | --- |
| [VertexElementVertexCrease()](#VertexElementVertexCrease--) | Initialisiert eine neue Instanz der Klasse [VertexElementVertexCrease](../../com.aspose.threed/vertexelementvertexcrease). |
## Methoden
...
| [copyTo(VertexElementDoublesTemplate target)](#copyTo-com.aspose.threed.VertexElementDoublesTemplate-) | Kopiert Daten in das angegebene Element. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(double[] data)](#setData-double---) | Daten laden |
...
Initialisiert eine neue Instanz der Klasse [VertexElementVertexCrease](../../com.aspose.threed/vertexelementvertexcrease).
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| target | [VertexElementDoublesTemplate](../../com.aspose.threed/vertexelementdoublestemplate) | Ziel. |
...
**Returns:**
java.util.List<java.lang.Double> - die Vertex-Daten

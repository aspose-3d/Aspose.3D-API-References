...
description: Patch-Richtungsarten.
type: docs
weight: 287
url: /de/java/com.aspose.threed/patchdirectiontype/
---
...
Patch‑Richtungsarten.
## Felder

| Feld | Beschreibung |
| --- | --- |
|  | [BASIS_SPLINE](#BASIS-SPLINE) | [Die Patch-Richtung ist ein Basis-Spline.][] |


[The patch direction is a basis spline.]: https://en.wikipedia.org/wiki/B-spline |
|  | [BEZIER](#BEZIER) | [Die Patch-Richtung ist eine Bezier-Kurve.][] |


[The patch direction is a Bezier curve.]: https://en.wikipedia.org/wiki/B%C3%A9zier_curve |
| [CARDINAL_SPLINE](#CARDINAL-SPLINE) | Kardinal-Patch. |
|  | [LINEAR](#LINEAR) | [Die Patch-Richtung ist eine lineare Kurve.][] |


[The patch direction is a linear curve.]: https://en.wikipedia.org/wiki/B%C3%A9zier_curve#Linear_curves |
| [QUADRATIC_BEZIER](#QUADRATIC-BEZIER) | Der quadratische Bezier-Patch. |
## Methoden
...
Kardinal-Patch. [Die Patch-Richtung ist ein Kardinal-Spline.][]
...
Der quadratische Bezier-Patch. [Die Patch-Richtung ist eine quadratische Kurve.][]

...
description: Eine Glättungsgruppe ist eine Gruppe von Polygonen in einem Polygonnetz, die eine glatte Oberfläche bilden sollen.
type: docs
weight: 216
url: /de/java/com.aspose.threed/vertexelementsmoothinggroup/
---
...
Eine Glättungsgruppe ist eine Gruppe von Polygonen in einem Polygonnetz, die eine glatte Oberfläche bilden soll. Einige frühe 3D‑Modellierungsprogramme wie 3D Studio Max für DOS verwendeten Glättungsgruppen, um das Speichern von Normalenvektoren für jeden Netz‑Vertex zu vermeiden.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [VertexElementSmoothingGroup()](#VertexElementSmoothingGroup--) | Initialisiert eine neue Instanz der Klasse [VertexElementSmoothingGroup](../../com.aspose.threed/vertexelementsmoothinggroup). |
## Methoden
...
Initialisiert eine neue Instanz der Klasse [VertexElementSmoothingGroup](../../com.aspose.threed/vertexelementsmoothinggroup).

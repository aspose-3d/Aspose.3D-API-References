...
type: docs
weight: 26
url: /de/java/com.aspose.threed/box/
---
...
| --- | --- |
| [Box()](#Box--) | Initialisiert eine neue Instanz der Klasse [Box](../../com.aspose.threed/box). |
| [Box(double length, double width, double height)](#Box-double-double-double-) | Initialisiert eine neue Instanz der Klasse [Box](../../com.aspose.threed/box). |
| [Box(String name, double length, double width, double height, int lengthSegments, int widthSegments, int heightSegments)](#Box-java.lang.String-double-double-double-int-int-int-) | Initialisiert eine neue Instanz der Klasse [Box](../../com.aspose.threed/box). |
## Methoden
...
| [getHeight()](#getHeight--) | Liefert die Höhe der Box, ausgerichtet entlang der y-Achse. |
| [getHeightSegments()](#getHeightSegments--) | Liefert oder setzt die Höhensegmente. |
| [getLength()](#getLength--) | Liefert die Länge der Box, ausgerichtet entlang der z-Achse. |
...
| [getWidth()](#getWidth--) | Liefert die Breite der Box, ausgerichtet entlang der x-Achse. |
...
| [setHeight(double value)](#setHeight-double-) | Legt die Höhe der Box fest, die entlang der y-Achse ausgerichtet ist. |
| [setHeightSegments(int value)](#setHeightSegments-int-) | Liefert oder setzt die Höhensegmente. |
| [setLength(double value)](#setLength-double-) | Legt die Länge der Box fest, die entlang der z-Achse ausgerichtet ist. |
...
| [setWidth(double value)](#setWidth-double-) | Legt die Breite der Box fest, die entlang der x-Achse ausgerichtet ist. |
| [setWidthSegments(int value)](#setWidthSegments-int-) | Legt die Breitenabschnitte fest |
...
Initialisiert eine neue Instanz der Klasse [Box](../../com.aspose.threed/box).
...
**Returns:**
double - die Höhe der Box, die entlang der y-Achse ausgerichtet ist.
...
**Returns:**
int - gibt oder setzt die Höhenabschnitte.
### getLength() {#getLength--}
```
...
**Returns:**
double - die Länge der Box, die entlang der z-Achse ausgerichtet ist.
...
**Returns:**
double - die Breite der Box, die entlang der x-Achse ausgerichtet ist.

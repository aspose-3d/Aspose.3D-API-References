...
description: IFC-kompatible Ellipsenform, die durch Parameter definiert wird.
type: docs
weight: 50
url: /de/java/com.aspose.threed/ellipseshape/
---
...
IFC-kompatible Ellipsenform, die durch Parameter definiert ist. Die zentrale Position des Profils befindet sich in der Mitte der Begrenzungsbox.
## Konstruktoren
...
| [getSemiAxis1()](#getSemiAxis1--) | Gibt den ersten Radius der Ellipse zurück, gemessen in Richtung der x-Achse. |
| [getSemiAxis2()](#getSemiAxis2--) | Gibt den zweiten Radius der Ellipse zurück, gemessen in Richtung der y-Achse. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setSemiAxis1(double value)](#setSemiAxis1-double-) | Setzt den ersten Radius der Ellipse, gemessen in Richtung der x-Achse. |
| [setSemiAxis2(double value)](#setSemiAxis2-double-) | Setzt den zweiten Radius der Ellipse, gemessen in Richtung der y-Achse. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Gibt den ersten Radius der Ellipse zurück, gemessen in Richtung der x-Achse.

**Returns:**
double - der erste Radius der Ellipse, gemessen in Richtung der x-Achse.
...
Gibt den zweiten Radius der Ellipse zurück, gemessen in Richtung der y-Achse.

**Returns:**
double - der zweite Radius der Ellipse, gemessen in Richtung der y-Achse.
### hashCode() {#hashCode--}
```
...
Setzt den ersten Radius der Ellipse, gemessen in Richtung der x-Achse.
...
Setzt den zweiten Radius der Ellipse, gemessen in Richtung der y-Achse.

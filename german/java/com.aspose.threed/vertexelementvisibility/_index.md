...
description: Definiert, ob die angegebenen Komponenten sichtbar sind.
type: docs
weight: 225
url: /de/java/com.aspose.threed/vertexelementvisibility/
---
...
| --- | --- |
| [VertexElementVisibility()](#VertexElementVisibility--) | Initialisiert eine neue Instanz der Klasse [VertexElementVisibility](../../com.aspose.threed/vertexelementvisibility). |
## Methoden
...
| [copyTo(VertexElementTemplate<T> target)](#copyTo-com.aspose.threed.VertexElementTemplate-T--) | Kopiert Daten in das angegebene Element. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(T[] data)](#setData-T---) | Daten laden |
...
### VertexElementVisibility() {#VertexElementVisibility--}
```
public VertexElementVisibility()
```


Initialisiert eine neue Instanz der Klasse [VertexElementVisibility](../../com.aspose.threed/vertexelementvisibility).
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| target | [VertexElementTemplate](../../com.aspose.threed/vertexelementtemplate) | Ziel. |
...
**Returns:**
java.util.List<T> - die Scheitelpunktdaten

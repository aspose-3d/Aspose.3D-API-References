...
description: IFC-kompatibles Hohlkreisbprofil.
type: docs
weight: 78
url: /de/java/com.aspose.threed/hollowcircleshape/
---
...
IFC-kompatibles Hohlkreisbprofil.
## Konstruktoren
...
| [getWallThickness()](#getWallThickness--) | Liefert die Differenz zwischen dem äußeren und dem inneren Radius. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setWallThickness(double value)](#setWallThickness-double-) | Setzt die Differenz zwischen dem äußeren und dem inneren Radius. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Liefert die Differenz zwischen dem äußeren und dem inneren Radius.

**Returns:**
double - die Differenz zwischen dem äußeren und dem inneren Radius.
### hashCode() {#hashCode--}
```
...
Setzt die Differenz zwischen dem äußeren und dem inneren Radius.

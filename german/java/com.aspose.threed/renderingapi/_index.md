...
description: Häufig verwendete Rendering-APIs
type: docs
weight: 269
url: /de/java/com.aspose.threed/renderingapi/
---
...
Häufig verwendete Rendering-APIs
## Felder

| Feld | Beschreibung |
| --- | --- |
| [ARNOLD](#ARNOLD) | Arnold-Renderer |
| [CUSTOM](#CUSTOM) | Benutzerdefinierte Rendering-API |
| [DIRECTX](#DIRECTX) | DirectX |
| [MANTLE](#MANTLE) | AMD Mantle |
| [MENTAL_RAY](#MENTAL-RAY) | MentalRay |
| [METAL](#METAL) | Metal, entwickelt von Apple |
| [NONE](#NONE) | Keine Rendering-API |
| [OPENGL](#OPENGL) | OpenGL |
| [OPENGLES](#OPENGLES) | OpenGL ES |
| [PREVIEW](#PREVIEW) | PreviewColorAPI, kompatibel mit FBX |
| [RENDER_MAN](#RENDER-MAN) | RenderMan |
| [RENDER_WARE](#RENDER-WARE) | RenderWare |
| [SHADERFX](#SHADERFX) | ShaderFX-Renderer |
| [STAGE3D](#STAGE3D) | Stage3D, verwendet in Adobe Flash |
...
Benutzerdefinierte Rendering-API
...
PreviewColorAPI, kompatibel mit FBX
...
Stage3D, verwendet in Adobe Flash

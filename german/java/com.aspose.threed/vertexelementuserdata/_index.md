...
description: Definiert benutzerdefinierte Benutzerdaten für die angegebenen Komponenten.
type: docs
weight: 221
url: /de/java/com.aspose.threed/vertexelementuserdata/
---
...
Definiert benutzerdefinierte Daten für angegebene Komponenten. Normalerweise handelt es sich um anwendungsspezifische Daten für einen speziellen Zweck.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [VertexElementUserData()](#VertexElementUserData--) | Initialisiert eine neue Instanz der [VertexElementUserData](../../com.aspose.threed/vertexelementuserdata)-Klasse. |
## Methoden
...
| [getClass()](#getClass--) |  |
| [getData()](#getData--) | Die Benutzerdaten, die an diesem Element angehängt sind |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setData(Object value)](#setData-java.lang.Object-) | Die Benutzerdaten, die an diesem Element angehängt sind |
...
Initialisiert eine neue Instanz der [VertexElementUserData](../../com.aspose.threed/vertexelementuserdata)-Klasse.
...
Die Benutzerdaten, die an diesem Element angehängt sind

**Returns:**
java.lang.Object - Die Benutzerdaten, die an diesem Element angehängt sind

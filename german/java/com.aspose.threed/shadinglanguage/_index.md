...
description: Häufig verwendete Shading-Sprachen
type: docs
weight: 272
url: /de/java/com.aspose.threed/shadinglanguage/
---
...
| [ARB_ASSEMBLY](#ARB-ASSEMBLY) | Die ARB-Assemblersprache ist eine Low-Level-Shading-Sprache, die vom OpenGL Architecture Review Board erstellt wurde, um GPU-Anweisungen zu standardisieren. |
| [CGFX](#CGFX) | NVIDIA Cg |
| [DIRECTX_SHADER_ASSEMBLY](#DIRECTX-SHADER-ASSEMBLY) | Die DirectX-Shader-Assemblersprache |
| [GELATO](#GELATO) | Die Gelato-Shading-Sprache |
| [GLSL](#GLSL) | Das GLSL |
...
| [OPEN_SHADING_LANGUAGE](#OPEN-SHADING-LANGUAGE) | Open Shading Language wurde von Sony Pictures Imageworks entwickelt und wird in dessen Arnold-Renderer verwendet. |

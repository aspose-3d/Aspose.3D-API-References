...
type: docs
weight: 293
url: /de/java/com.aspose.threed/posetype/
---
...
| Feld | Beschreibung |
| --- | --- |
| [BIND_POSE](#BIND-POSE) | Die Bindpose. |
| [SNAPSHOT](#SNAPSHOT) | Die Restpose, bedeutet, dass es ein Schnappschuss der Bindpose ist. |
## Methoden
...
Die Restpose, bedeutet, dass es ein Schnappschuss der Bindpose ist.

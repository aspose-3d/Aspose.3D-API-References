...
description: IFC-kompatibles Kreisprofil, das zur Erstellung eines Meshes verwendet werden kann über
type: docs
weight: 32
url: /de/java/com.aspose.threed/circleshape/
---
...
IFC-kompatibles Kreisprofil, das zur Erstellung eines Meshes über [LinearExtrusion](../../com.aspose.threed/linearextrusion) verwendet werden kann.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [CircleShape()](#CircleShape--) | Erstelle ein [CircleShape](../../com.aspose.threed/circleshape)-Profil mit dem Standardradius (5). |
| [CircleShape(double radius)](#CircleShape-double-) | Erstelle ein [CircleShape](../../com.aspose.threed/circleshape)-Profil mit angegebenem Radius. |
## Methoden
...
| [getRadius()](#getRadius--) | Liefert den Radius des Kreises. |
...
| [setRadius(double value)](#setRadius-double-) | Setzt den Radius des Kreises. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Erstelle ein [CircleShape](../../com.aspose.threed/circleshape)-Profil mit dem Standardradius (5).
...
Erstelle ein [CircleShape](../../com.aspose.threed/circleshape)-Profil mit angegebenem Radius.

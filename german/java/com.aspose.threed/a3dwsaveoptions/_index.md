...
type: docs
weight: 11
url: /de/java/com.aspose.threed/a3dwsaveoptions/
---
...
| --- | --- |
| [A3dwSaveOptions()](#A3dwSaveOptions--) | Konstruktor von [A3dwSaveOptions](../../com.aspose.threed/a3dwsaveoptions) |
## Methoden
...
| [getExportMetaData()](#getExportMetaData--) | Exportiere Metadaten, die mit Szene/Knoten verbunden sind, zum Client Standardwert ist true |
...
| [getMetaDataPrefix()](#getMetaDataPrefix--) | Wenn diese Eigenschaft nicht null ist, werden nur die Eigenschaften von Szene/Knoten, die mit diesem Präfix beginnen, exportiert, und das Präfix wird entfernt. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEncoding(Charset value)](#setEncoding-java.nio.charset.Charset-) | Setzt die Standardkodierung für textbasierte Dateien. |
| [setExportMetaData(boolean value)](#setExportMetaData-boolean-) | Exportiere Metadaten, die mit Szene/Knoten verbunden sind, zum Client Standardwert ist true |
...
| [setMetaDataPrefix(String value)](#setMetaDataPrefix-java.lang.String-) | Wenn diese Eigenschaft nicht null ist, werden nur die Eigenschaften von Szene/Knoten, die mit diesem Präfix beginnen, exportiert, und das Präfix wird entfernt. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Konstruktor von [A3dwSaveOptions](../../com.aspose.threed/a3dwsaveoptions)
...
Exportiere Metadaten, die mit Szene/Knoten verbunden sind, zum Client Standardwert ist true

**Returns:**
boolean - Exportiere Metadaten, die mit Szene/Knoten verbunden sind, zum Client Standardwert ist true
...
Wenn diese Eigenschaft nicht null ist, werden nur die Eigenschaften von Szene/Knoten, die mit diesem Präfix beginnen, exportiert, und das Präfix wird entfernt.

**Returns:**
java.lang.String - Wenn diese Eigenschaft nicht null ist, werden nur die Eigenschaften von Szene/Knoten, die mit diesem Präfix beginnen, exportiert, und das Präfix wird entfernt.
### hashCode() {#hashCode--}
```

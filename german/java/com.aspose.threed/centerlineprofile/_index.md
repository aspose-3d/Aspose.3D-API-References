...
description: IFC-kompatibles Mittellinienprofil
type: docs
weight: 30
url: /de/java/com.aspose.threed/centerlineprofile/
---
...
IFC-kompatibles Mittellinienprofil
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [CenterLineProfile(Curve curve, double thickness)](#CenterLineProfile-com.aspose.threed.Curve-double-) | Konstruiert ein neues [CenterLineProfile](../../com.aspose.threed/centerlineprofile) mit der angegebenen Kurve als Mittellinie. |
| [CenterLineProfile(Curve curve)](#CenterLineProfile-com.aspose.threed.Curve-) | Konstruiert ein neues [CenterLineProfile](../../com.aspose.threed/centerlineprofile) mit der angegebenen Kurve als Mittellinie. |
## Methoden
...
| [getClass()](#getClass--) |  |
| [getCurve()](#getCurve--) | Die Mittellinienkurve des Profils |
...
| [getThickness()](#getThickness--) | Dicke, die entlang der Mittellinie angewendet wird |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setCurve(Curve value)](#setCurve-com.aspose.threed.Curve-) | Die Mittellinienkurve des Profils |
...
| [setThickness(double value)](#setThickness-double-) | Dicke, die entlang der Mittellinie angewendet wird |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Konstruiert ein neues [CenterLineProfile](../../com.aspose.threed/centerlineprofile) mit der angegebenen Kurve als Mittellinie.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Mittellinienkurve |
| Dicke | double | Dicke, die entlang der Mittellinie angewendet wird |
...
Die Mittellinienkurve des Profils
...
Dicke, die entlang der Mittellinie angewendet wird

**Returns:**
double - Dicke, die entlang der Mittellinie angewendet wird
### hashCode() {#hashCode--}
```

...
type: docs
weight: 193
url: /de/java/com.aspose.threed/trapeziumshape/
---
...
| --- | --- |
| [TrapeziumShape()](#TrapeziumShape--) | Konstruktor von [TrapeziumShape](../../com.aspose.threed/trapeziumshape) |
## Methoden
...
| [getBottomXDim()](#getBottomXDim--) | Gibt die Ausdehnung der unteren Linie entlang der x-Achse zurück. |
...
| [getTopXDim()](#getTopXDim--) | Gibt die Ausdehnung der oberen Linie entlang der x-Achse zurück. |
| [getTopXOffset()](#getTopXOffset--) | Gibt den Versatz vom Anfang der oberen Linie zur unteren Linie zurück. |
| [getYDim()](#getYDim--) | Gibt den Abstand zwischen der oberen und unteren Linie entlang der y-Achse zurück. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setBottomXDim(double value)](#setBottomXDim-double-) | Setzt die Ausdehnung der unteren Linie entlang der x-Achse. |
...
| [setTopXDim(double value)](#setTopXDim-double-) | Setzt die Ausdehnung der oberen Linie entlang der x-Achse. |
| [setTopXOffset(double value)](#setTopXOffset-double-) | Setzt den Versatz vom Anfang der oberen Linie zur unteren Linie. |
| [setYDim(double value)](#setYDim-double-) | Setzt den Abstand zwischen der oberen und unteren Linie entlang der y-Achse. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Konstruktor von [TrapeziumShape](../../com.aspose.threed/trapeziumshape)
...
Gibt die Ausdehnung der unteren Linie entlang der x-Achse zurück.

**Returns:**
double - die Ausdehnung der unteren Linie entlang der x-Achse.
...
Gibt die Ausdehnung der oberen Linie entlang der x-Achse zurück.

**Returns:**
double - die Ausdehnung der oberen Linie entlang der x-Achse.
...
Gibt den Versatz vom Anfang der oberen Linie zur unteren Linie zurück.

**Returns:**
double - der Versatz vom Anfang der oberen Linie zur unteren Linie.
### getYDim() {#getYDim--}
```
...
Gibt den Abstand zwischen der oberen und unteren Linie entlang der y-Achse zurück.

**Returns:**
double - der Abstand zwischen der oberen und unteren Linie entlang der y-Achse.
### hashCode() {#hashCode--}
```
...
Setzt die Ausdehnung der unteren Linie entlang der x-Achse.
...
Setzt die Ausdehnung der oberen Linie entlang der x-Achse.
...
Setzt den Versatz vom Anfang der oberen Linie zur unteren Linie.
...
Setzt den Abstand zwischen der oberen und unteren Linie entlang der y-Achse.

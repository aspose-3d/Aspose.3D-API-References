...
description: Ladeoptionen für Siemens JT
type: docs
weight: 88
url: /de/java/com.aspose.threed/jtloadoptions/
---
...
| [getLoadPMI()](#getLoadPMI--) | Lade PMI-Informationen aus der JT-Datei, falls möglich; die Daten werden als Eigenschaft "PMI" von [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo) gespeichert. |
| [getLoadProperties()](#getLoadProperties--) | Lade Eigenschaften aus der Property-Tabelle von JT als Aspose.3D-Eigenschaften. |
...
| [setLoadPMI(boolean value)](#setLoadPMI-boolean-) | Lade PMI-Informationen aus der JT-Datei, falls möglich; die Daten werden als Eigenschaft "PMI" von [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo) gespeichert. |
| [setLoadProperties(boolean value)](#setLoadProperties-boolean-) | Lade Eigenschaften aus der Property-Tabelle von JT als Aspose.3D-Eigenschaften. |
...
Lade PMI-Informationen aus der JT-Datei, falls möglich; die Daten werden als Eigenschaft "PMI" von [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo) gespeichert. Standardwert ist false.

**Returns:**
boolean - Lade PMI-Informationen aus der JT-Datei, falls möglich; die Daten werden als Eigenschaft "PMI" von [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo) gespeichert. Standardwert ist false.
...
Lade Eigenschaften aus der Property-Tabelle von JT als Aspose.3D-Eigenschaften. Standardwert ist false.

**Returns:**
boolean - Lade Eigenschaften aus der Property-Tabelle von JT als Aspose.3D-Eigenschaften. Standardwert ist false.

...
description: Die Punktwolke enthält keine Topologieinformationen, sondern nur die Kontrollpunkte und die Vertex-Elemente.
type: docs
weight: 132
url: /de/java/com.aspose.threed/pointcloud/
---
...
| --- | --- |
| [PointCloud(String name)](#PointCloud-java.lang.String-) | Konstruktor von [PointCloud](../../com.aspose.threed/pointcloud) |
| [PointCloud()](#PointCloud--) | Konstruktor von [PointCloud](../../com.aspose.threed/pointcloud) |
## Methoden
...
| [fromGeometry(Geometry g)](#fromGeometry-com.aspose.threed.Geometry-) | Erstelle eine neue PointCloud-Instanz aus einem Geometrieobjekt |
| [fromGeometry(Geometry g, int density)](#fromGeometry-com.aspose.threed.Geometry-int-) | Erstelle eine neue Punktwolken-Instanz aus einem Geometrieobjekt. |
...
| [getDimension()](#getDimension--) | Wenn ein Dimensionswert für die Punktwolke vorhanden ist, weist dies auf eine organisierte Punktwolke hin. |
...
| [setDimension(Vector2 value)](#setDimension-com.aspose.threed.Vector2-) | Wenn ein Dimensionswert für die Punktwolke vorhanden ist, weist dies auf eine organisierte Punktwolke hin. |
...
Konstruktor von [PointCloud](../../com.aspose.threed/pointcloud)
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| g | [Geometry](../../com.aspose.threed/geometry) | Mesh oder andere Geometrie-Instanz |

...
description: Diese Klasse ermöglicht es Ihnen, ein 2D‑Profil direkt aus einer beliebigen Kurve zu erstellen.
type: docs
weight: 16
url: /de/java/com.aspose.threed/arbitraryprofile/
---
...
Diese Klasse ermöglicht es Ihnen, ein 2D‑Profil direkt aus einer beliebigen Kurve zu erstellen.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [ArbitraryProfile()](#ArbitraryProfile--) | Konstruktor von [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) |
| [ArbitraryProfile(Curve curve)](#ArbitraryProfile-com.aspose.threed.Curve-) | Konstruktor von [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) mit einer Anfangskurve. |
## Methoden
...
| [getClass()](#getClass--) |  |
| [getCurve()](#getCurve--) | Die Kurve, die zum Erstellen des Profils verwendet wird |
...
| [getHoles()](#getHoles--) | Löcher des Profils, ebenfalls als Kurve dargestellt |
...
| [setCurve(Curve value)](#setCurve-com.aspose.threed.Curve-) | Die Kurve, die zum Erstellen des Profils verwendet wird |
...
Konstruktor von [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile)
...
Konstruktor von [ArbitraryProfile](../../com.aspose.threed/arbitraryprofile) mit einer Anfangskurve.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Anfangskurve des Profils |
...
Die Kurve, die zum Erstellen des Profils verwendet wird
...
Löcher des Profils, ebenfalls als Kurve dargestellt

**Returns:**
java.util.ArrayList<com.aspose.threed.Curve> - Löcher des Profils, ebenfalls als Kurve dargestellt
### getName() {#getName--}
```

...
type: docs
weight: 12
url: /de/java/com.aspose.threed/amfsaveoptions/
---
...
| --- | --- |
| [AmfSaveOptions()](#AmfSaveOptions--) | Konstruktor von [AmfSaveOptions](../../com.aspose.threed/amfsaveoptions) |
## Methoden
...
| [getClass()](#getClass--) |  |
| [getEnableCompression()](#getEnableCompression--) | Ob Kompression verwendet werden soll, um die endgültige Dateigröße zu reduzieren, Standardwert ist true |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setEnableCompression(boolean value)](#setEnableCompression-boolean-) | Ob Kompression verwendet werden soll, um die endgültige Dateigröße zu reduzieren, Standardwert ist true |
...
Konstruktor von [AmfSaveOptions](../../com.aspose.threed/amfsaveoptions)
...
Ob Kompression verwendet werden soll, um die endgültige Dateigröße zu reduzieren, Standardwert ist true

**Returns:**
boolean - Ob Kompression verwendet werden soll, um die endgültige Dateigröße zu reduzieren, Standardwert ist true

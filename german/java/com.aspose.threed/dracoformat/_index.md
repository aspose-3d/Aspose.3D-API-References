...
description: Google‑Draco‑Format Beispiel         Der folgende Code zeigt, wie man ein Mesh in ein Byte‑Array kodiert und daraus dekodiert.
type: docs
weight: 46
url: /de/java/com.aspose.threed/dracoformat/
---
...
Google Draco-Format **Beispiel:** Der folgende Code zeigt, wie ein Mesh in ein Byte-Array kodiert und daraus dekodiert wird:
...
| [decode(byte[] data)](#decode-byte---) | Dekodieren Sie die Punktwolke oder das Mesh aus dem Speicherinhalt. |
| [decode(String fileName)](#decode-java.lang.String-) | Dekodieren Sie die Punktwolke oder das Mesh aus dem angegebenen Dateinamen. |
...
| [encode(Entity entity)](#encode-com.aspose.threed.Entity-) | Kodieren Sie das Objekt in rohe Draco‑Daten. |
| [encode(Entity entity, DracoSaveOptions options)](#encode-com.aspose.threed.Entity-com.aspose.threed.DracoSaveOptions-) | Kodieren Sie das Objekt in rohe Draco‑Daten. |
| [encode(Entity entity, Stream stream)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-) | Kodieren Sie das Objekt in den angegebenen Stream. |
| [encode(Entity entity, Stream stream, DracoSaveOptions options)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-com.aspose.threed.DracoSaveOptions-) | Kodieren Sie das Objekt in den angegebenen Stream. |
| [encode(Entity entity, String fileName)](#encode-com.aspose.threed.Entity-java.lang.String-) | Kodieren Sie das Objekt in die angegebene Datei. |
| [encode(Entity entity, String fileName, DracoSaveOptions options)](#encode-com.aspose.threed.Entity-java.lang.String-com.aspose.threed.DracoSaveOptions-) | Kodieren Sie das Objekt in die angegebene Datei. |
...
Dekodieren Sie die Punktwolke oder das Mesh aus dem Speicherinhalt.
...
Dekodieren Sie die Punktwolke oder das Mesh aus dem angegebenen Dateinamen.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| fileName | java.lang.String | Der Dateiname enthält die drc‑Datei. |
...
Kodieren Sie das Objekt in rohe Draco‑Daten.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | Das zu kodierende Objekt. |

**Returns:**
byte[] - Die kodierten Draco‑Daten, dargestellt in Bytes **Beispiel:** Der folgende Code zeigt, wie man ein Mesh in ein Byte‑Array kodiert und daraus dekodiert:
...
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | Das zu kodierende Objekt. |
| options | [DracoSaveOptions](../../com.aspose.threed/dracosaveoptions) | Zusätzliche Optionen für die Kodierung der Punktwolke. |
...
Kodieren Sie das Objekt in den angegebenen Stream.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | Das zu kodierende Objekt. |
| stream | [Stream](../../com.aspose.threed/stream) | Der Stream, in den die kodierten Daten geschrieben werden. |
...
Kodieren Sie das Objekt in die angegebene Datei.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | Das zu kodierende Objekt. |
| fileName | java.lang.String | Der zu schreibende Dateiname. |

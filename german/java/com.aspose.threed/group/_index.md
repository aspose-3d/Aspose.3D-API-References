...
description: A  stellt die logischen Beziehungen von . dar.
type: docs
weight: 75
url: /de/java/com.aspose.threed/group/
---
...
A [Group](../../com.aspose.threed/group) stellt die logischen Beziehungen von [Node](../../com.aspose.threed/node) dar.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [Group(String name)](#Group-java.lang.String-) | Erstelle eine neue Instanz von [Group](../../com.aspose.threed/group) |
| [Group()](#Group--) | Erstelle eine neue Instanz von [Group](../../com.aspose.threed/group) |
## Methoden
...
| [getClass()](#getClass--) |  |
| [getGroups()](#getGroups--) | Untergruppen |
| [getName()](#getName--) | Liefert den Namen. |
| [getNodes()](#getNodes--) | Die Knoten in dieser Gruppe |
| [getParent()](#getParent--) | Elterngruppe der aktuellen Gruppe |
...
| [toString()](#toString--) | Ruft die Zeichenkettenrepräsentation von [Group](../../com.aspose.threed/group) ab. |
| [wait()](#wait--) |  |
...
Erstelle eine neue Instanz von [Group](../../com.aspose.threed/group)

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Name | java.lang.String | Name der Gruppe |
...
**Returns:**
java.util.List<com.aspose.threed.Group> - Untergruppen
### getName() {#getName--}
```
...
Die Knoten in dieser Gruppe

**Returns:**
java.util.List<com.aspose.threed.Node> - Die Knoten in dieser Gruppe
### getParent() {#getParent--}
```
...
Elterngruppe der aktuellen Gruppe
...
Ruft die Zeichenkettenrepräsentation von [Group](../../com.aspose.threed/group) ab.

**Returns:**
java.lang.String - Die Zeichenkettenrepräsentation der aktuellen Instanz
### wait() {#wait--}
```

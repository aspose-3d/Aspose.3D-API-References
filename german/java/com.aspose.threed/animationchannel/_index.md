...
description: Ein Kanal ordnet das Komponentenfeld einer Eigenschaft einer Menge von Keyframe‑Sequenzen zu
type: docs
weight: 13
url: /de/java/com.aspose.threed/animationchannel/
---
...
| [getClass()](#getClass--) |  |
| [getComponentType()](#getComponentType--) | Ermittelt den Typ des Komponentenfeldes |
| [getDefaultValue()](#getDefaultValue--) | Ermittelt den Standardwert des Kanals. |
| [getKeyFrames()](#getKeyFrames--) | Gibt die Keyframes dieser Kurve zurück. |
| [getKeyframeSequence()](#getKeyframeSequence--) | Ermittelt die zugehörige Keyframe‑Sequenz in diesem Kanal |
...
| [setDefaultValue(Object value)](#setDefaultValue-java.lang.Object-) | Setzt den Standardwert des Kanals. |
| [setKeyframeSequence(KeyframeSequence value)](#setKeyframeSequence-com.aspose.threed.KeyframeSequence-) | Ermittelt die zugehörige Keyframe‑Sequenz in diesem Kanal |
...
**Returns:**
java.lang.Class<?> - der Typ des Komponentenfeldes
...
**Returns:**
java.lang.Object - der Standardwert des Kanals. Wenn ein Kanal keine verbundenen Keyframe‑Sequenzen hat, wird der Standardwert während der Animationsauswertung verwendet. Ein konkretes Szenario: Die Animation animiert nur die x‑Koordinate eines Knotens, die y‑ und z‑Koordinaten werden nicht geändert, dann wird der Standardwert während der vollständigen Übersetzungsauswertung verwendet.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| value | [KeyframeSequence](../../com.aspose.threed/keyframesequence) | Neuer Wert |

...
description: ist eine Oberfläche, die durch NURBS (Nicht-uniforme rationale Basis-Spline) dargestellt wird. A ist definiert durch zwei  und .
type: docs
weight: 114
url: /de/java/com.aspose.threed/nurbssurface/
---
...
| --- | --- |
| [NurbsSurface()](#NurbsSurface--) | Initialisiert eine neue Instanz der Klasse [NurbsSurface](../../com.aspose.threed/nurbssurface). |
| [NurbsSurface(String name)](#NurbsSurface-java.lang.String-) | Initialisiert eine neue Instanz der Klasse [NurbsSurface](../../com.aspose.threed/nurbssurface). |
## Methoden
...
| [getU()](#getU--) | Liefert die U-Richtung der NURBS-Oberfläche |
| [getV()](#getV--) | Liefert die V-Richtung der NURBS-Oberfläche |
...
| [toMesh()](#toMesh--) | Konvertiert die NURBS-Oberfläche in das Mesh |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initialisiert eine neue Instanz der Klasse [NurbsSurface](../../com.aspose.threed/nurbssurface).

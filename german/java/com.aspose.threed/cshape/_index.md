...
description: IFC-kompatibles C-förmiges Profil, das durch Parameter definiert wird.
type: docs
weight: 27
url: /de/java/com.aspose.threed/cshape/
---
...
| [getGirth()](#getGirth--) | Liefert die Länge des Umfangs. |
| [getInternalFilletRadius()](#getInternalFilletRadius--) | Liefert den internen Rundungsradius. |
...
| [getWallThickness()](#getWallThickness--) | Liefert die Wanddicke. |
...
| [setGirth(double value)](#setGirth-double-) | Setzt die Länge des Umfangs. |
| [setInternalFilletRadius(double value)](#setInternalFilletRadius-double-) | Setzt den internen Rundungsradius. |
...
| [setWallThickness(double value)](#setWallThickness-double-) | Setzt die Wanddicke. |
...
Liefert die Länge des Umfangs.

**Returns:**
double - die Länge des Umfangs.
...
Liefert den internen Rundungsradius.

**Returns:**
double - der interne Rundungsradius.
### getName() {#getName--}
```
...
Liefert die Wanddicke.

**Returns:**
double - die Wanddicke.
### getWidth() {#getWidth--}
```
...
Setzt den internen Rundungsradius.

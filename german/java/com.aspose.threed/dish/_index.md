...
description: Parametrisierte Schüssel.
type: docs
weight: 45
url: /de/java/com.aspose.threed/dish/
---
...
| --- | --- |
| [Dish()](#Dish--) | Erstelle eine neue Dish-Instanz mit dem Standardradius (10) und der Standardhöhe (5) |
| [Dish(double radius, double height)](#Dish-double-double-) | Erstelle eine neue Schüssel-Instanz mit angegebenem Radius und Höhe |
| [Dish(String name, double radius, double height, int widthSegments, int heightSegments)](#Dish-java.lang.String-double-double-int-int-) | Erstelle eine neue Schüssel-Instanz mit angegebenem Radius und Höhe |
## Methoden
...
| [getHeight()](#getHeight--) | Höhe der Schüssel |
| [getHeightSegments()](#getHeightSegments--) | Ruft die Höhensegmente ab |
...
| [getRadius()](#getRadius--) | Radius des Gerichts |
...
| [setHeight(double value)](#setHeight-double-) | Höhe der Schüssel |
| [setHeightSegments(int value)](#setHeightSegments-int-) | Setzt die Höhensegmente |
...
| [setRadius(double value)](#setRadius-double-) | Radius des Gerichts |
...
Erstelle eine neue Dish-Instanz mit dem Standardradius (10) und der Standardhöhe (5)
...
Erstelle eine neue Schüssel-Instanz mit angegebenem Radius und Höhe

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| radius | double | Der Radius des Gerichts |
| height | double | Die Höhe des Gerichts |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Name | java.lang.String | Der Name des Gerichts |
| radius | double | Der Radius des Gerichts |
| height | double | Die Höhe des Gerichts |
| widthSegments | int | Das Breitensegment des Gerichts |
| heightSegments | int | Das Höhensegment des Gerichts |

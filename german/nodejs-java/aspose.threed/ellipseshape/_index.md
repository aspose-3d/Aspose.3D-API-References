...
url: /de/nodejs-java/aspose.threed/ellipseshape/
---
## EllipseShape class

IFC-kompatible Ellipsenform, die durch Parameter definiert ist. Die Mittelpunktposition des Profils befindet sich in der Mitte des Begrenzungsrahmens.
...
| Name | Beschreibung |
| --- | --- |
| getSemiAxis1() | Liest oder setzt den ersten Radius der Ellipse, gemessen in Richtung der x-Achse. |
...
| Name | Beschreibung |
| --- | --- |
| setSemiAxis1(value) | Liest oder setzt den ersten Radius der Ellipse, gemessen in Richtung der x-Achse. |
...
| Name | Beschreibung |
| --- | --- |
| getSemiAxis2() | Liest oder setzt den zweiten Radius der Ellipse, gemessen in Richtung der y-Achse. |
...
| Name | Beschreibung |
| --- | --- |
| setSemiAxis2(value) | Liest oder setzt den zweiten Radius der Ellipse, gemessen in Richtung der y-Achse. |

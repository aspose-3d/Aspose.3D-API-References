...
url: /de/nodejs-java/aspose.threed/stlsaveoptions/
---
...
| Name | Beschreibung |
| --- | --- |
| constructor() | Initialisiert eine neue Instanz von StlSaveOptions. |
...
| Name | Beschreibung |
| --- | --- |
| constructor_overload(contentType) | Initialisiert eine neue Instanz von StlSaveOptions. |
...
| Name | Beschreibung |
| --- | --- |
| getFlipCoordinateSystem() | Liest oder setzt, ob das Koordinatensystem von Kontrollpunkten/Normalen beim Exportieren umgekehrt wird. |
...
| Name | Beschreibung |
| --- | --- |
| setFlipCoordinateSystem(value) | Liest oder setzt, ob das Koordinatensystem von Kontrollpunkten/Normalen beim Exportieren umgekehrt wird. |

...
url: /de/nodejs-java/aspose.threed/arbitraryprofile/
---
...
| Name | Beschreibung |
| --- | --- |
| constructor() | Konstruktor von ArbitraryProfile |
...
| Name | Beschreibung |
| --- | --- |
| constructor_overload(curve) | Konstruktor von ArbitraryProfile mit einer Anfangskurve. |
...
| Name | Beschreibung |
| --- | --- |
| getCurve() | Die Kurve, die zum Erstellen des Profils verwendet wird |
...
| Name | Beschreibung |
| --- | --- |
| setCurve(value) | Die Kurve, die zum Erstellen des Profils verwendet wird |

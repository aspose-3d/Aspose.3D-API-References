...
url: /de/nodejs-java/aspose.threed/circleshape/
---
## CircleShape class

IFC‑kompatibles Kreisprofil, das zur Erstellung eines Meshes mittels LinearExtrusion verwendet werden kann.
...
| Name | Beschreibung |
| --- | --- |
| constructor() | Erstellt ein CircleShape-Profil mit dem Standardradius (5). |
...
| Name | Beschreibung |
| --- | --- |
| constructor_overload(radius) | Erstellt ein CircleShape-Profil mit angegebenem Radius. |
...
| Name | Beschreibung |
| --- | --- |
| getRadius() | Liest oder setzt den Radius des Kreises. |
...
| Name | Beschreibung |
| --- | --- |
| setRadius(value) | Liest oder setzt den Radius des Kreises. |

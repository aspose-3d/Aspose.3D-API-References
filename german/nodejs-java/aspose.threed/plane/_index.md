...
url: /de/nodejs-java/aspose.threed/plane/
---
## Plane class
...
| Name | Beschreibung |
| --- | --- |
| constructor() | Initialisiert eine neue Instanz von Plane mit der Standardgröße 1×1. |
...
| Name | Beschreibung |
| --- | --- |
| constructor_overload(length, width) | Initialisiert eine neue Instanz der Ebene. |

 **Parameters:**

| Name | Typ | Beschreibung |
| --- | --- | --- |
| Länge | Number | Länge der Ebene. |
| Breite | Number | Breite der Ebene. |
...
| Name | Beschreibung |
| --- | --- |
| constructor_overload2(name, length, width, lengthSegments, widthSegments) | Initialisiert eine neue Instanz der Ebene. |
...
| Name | Beschreibung |
| --- | --- |
| getUp() | Liest oder setzt den Aufwärtsvektor der Ebene, Standardwert ist (0, 1, 0), dies beeinflusst die Erzeugung der Ebene |
...
| Name | Beschreibung |
| --- | --- |
| setUp(value) | Liest oder setzt den Aufwärtsvektor der Ebene, Standardwert ist (0, 1, 0), dies beeinflusst die Erzeugung der Ebene |
...
| Name | Beschreibung |
| --- | --- |
| getLength() | Liest oder setzt die Länge der Ebene. Die Länge. |
...
| Name | Beschreibung |
| --- | --- |
| setLength(value) | Liest oder setzt die Länge der Ebene. Die Länge. |
...
| Name | Beschreibung |
| --- | --- |
| getWidth() | Liest oder setzt die Breite der Ebene. Die Breite. |
...
| Name | Beschreibung |
| --- | --- |
| setWidth(value) | Liest oder setzt die Breite der Ebene. Die Breite. |
...
| Name | Beschreibung |
| --- | --- |
| getLengthSegments() | Liest oder setzt die Längensegmente. Die Längensegmente. |
...
| Name | Beschreibung |
| --- | --- |
| setLengthSegments(value) | Liest oder setzt die Längensegmente. Die Längensegmente. |

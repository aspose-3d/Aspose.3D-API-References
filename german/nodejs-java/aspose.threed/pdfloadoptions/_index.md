...
url: /de/nodejs-java/aspose.threed/pdfloadoptions/
---
...
| Name | Beschreibung |
| --- | --- |
| constructor() | Konstruktor von PdfLoadOptions |
...
| Name | Beschreibung |
| --- | --- |
| getPassword() | Das Passwort, um die verschlüsselte PDF-Datei zu entsperren. |
...
| Name | Beschreibung |
| --- | --- |
| setPassword(value) | Das Passwort, um die verschlüsselte PDF-Datei zu entsperren. |

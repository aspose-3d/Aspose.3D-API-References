...
url: /de/nodejs-java/aspose.threed/nurbssurface/
---
## NurbsSurface class

NurbsSurface ist eine Oberfläche, die durch NURBS (Non-uniform rational basis spline) dargestellt wird,  Eine NurbsSurface wird durch zwei NurbsDirectionU und V definiert.  Die w-Komponente im Kontrollpunkt wird als Gewicht des Kontrollpunkts verwendet, unabhängig davon, ob der Richtungstyp CurveDimension.TWO_DIMENSIONAL oder CurveDimension.THREE_DIMENSIONAL ist.
...
| Name | Beschreibung |
| --- | --- |
| constructor() | Initialisiert eine neue Instanz der Klasse NurbsSurface. |
...
| Name | Beschreibung |
| --- | --- |
| constructor_overload(name) | Initialisiert eine neue Instanz der Klasse NurbsSurface. |

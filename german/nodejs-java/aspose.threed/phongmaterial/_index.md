...
url: /de/nodejs-java/aspose.threed/phongmaterial/
---
## PhongMaterial class
...
| Name | Beschreibung |
| --- | --- |
| constructor() | Initialisiert eine neue Instanz der Klasse PhongMaterial. |
...
| Name | Beschreibung |
| --- | --- |
| constructor_overload(name) | Initialisiert eine neue Instanz der Klasse PhongMaterial. |
...
| Name | Beschreibung |
| --- | --- |
| getSpecularColor() | Liest oder setzt die Specularfarbe. |
...
| Name | Beschreibung |
| --- | --- |
| setSpecularColor(value) | Liest oder setzt die Specularfarbe. |
...
| Name | Beschreibung |
| --- | --- |
| getSpecularFactor() | Liest oder setzt den Specularfaktor. Die Formel für specular: SpecularColor SpecularFactor (N dot H) ^ Shininess |
...
| Name | Beschreibung |
| --- | --- |
| setSpecularFactor(value) | Liest oder setzt den Specularfaktor. Die Formel für specular: SpecularColor SpecularFactor (N dot H) ^ Shininess |
...
| Name | Beschreibung |
| --- | --- |
| getShininess() | Liest oder setzt den Glanzgrad, dies steuert die Größe des specular-Highlights. Die Formel für specular: SpecularColor SpecularFactor (N dot H) ^ Shininess Der Glanzgrad. |
...
| Name | Beschreibung |
| --- | --- |
| setShininess(value) | Liest oder setzt den Glanzgrad, dies steuert die Größe des specular-Highlights. Die Formel für specular: SpecularColor SpecularFactor (N dot H) ^ Shininess Der Glanzgrad. |
...
| Name | Beschreibung |
| --- | --- |
| getReflectionColor() | Liest oder setzt die Reflexionsfarbe. Die Reflexion. |
...
| Name | Beschreibung |
| --- | --- |
| setReflectionColor(value) | Liest oder setzt die Reflexionsfarbe. Die Reflexion. |
...
| Name | Beschreibung |
| --- | --- |
| getReflectionFactor() | Liest oder setzt die Dämpfung der Reflexionsfarbe. Der Reflexionsfaktor. |
...
| Name | Beschreibung |
| --- | --- |
| setReflectionFactor(value) | Liest oder setzt die Dämpfung der Reflexionsfarbe. Der Reflexionsfaktor. |

...
url: /de/nodejs-java/aspose.threed/text/
---
## Text class

Textprofil, dieses Profil beschreibt Konturen mittels Schriftart und Text.
...
| Name | Beschreibung |
| --- | --- |
| setContent(value) | Inhalt des Textes |
...
| Name | Beschreibung |
| --- | --- |
| setFont(value) | Die Schriftart des Textes. |
...
| Name | Beschreibung |
| --- | --- |
| setFontSize(value) | Schriftgrößen‑Skala. |

...
url: /de/nodejs-java/aspose.threed/gltfloadoptions/
---
...
| Name | Beschreibung |
| --- | --- |
| constructor() | Konstruktor von GltfLoadOptions |
...
| Name | Beschreibung |
| --- | --- |
| getFlipTexCoordV() | Vertausche die v(t)-Koordinate in den Texturkoordinaten des Meshes, Standardwert ist true. |
...
| Name | Beschreibung |
| --- | --- |
| setFlipTexCoordV(value) | Vertausche die v(t)-Koordinate in den Texturkoordinaten des Meshes, Standardwert ist true. |

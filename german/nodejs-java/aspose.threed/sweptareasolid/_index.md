...
url: /de/nodejs-java/aspose.threed/sweptareasolid/
---
## SweptAreaSolid class

Ein SweptAreaSolid konstruiert eine Geometrie, indem er ein Profil entlang einer Direktrixe sweepet.
...
| Name | Beschreibung |
| --- | --- |
| getShape() | Das Basisprofil zur Konstruktion der Geometrie. |
...
| Name | Beschreibung |
| --- | --- |
| setShape(value) | Das Basisprofil zur Konstruktion der Geometrie. |
...
| Name | Beschreibung |
| --- | --- |
| getDirectrix() | Die Direktrix, entlang der die geschwenkte Fläche verläuft. |
...
| Name | Beschreibung |
| --- | --- |
| setDirectrix(value) | Die Direktrix, entlang der die geschwenkte Fläche verläuft. |
...
| Name | Beschreibung |
| --- | --- |
| getStartPoint() | Der Startpunkt der Direktrix. |
...
| Name | Beschreibung |
| --- | --- |
| setStartPoint(value) | Der Startpunkt der Direktrix. |
...
| Name | Beschreibung |
| --- | --- |
| getEndPoint() | Der Endpunkt der Direktrix. |
...
| Name | Beschreibung |
| --- | --- |
| setEndPoint(value) | Der Endpunkt der Direktrix. |

...
url: /de/nodejs-java/aspose.threed/a3dobject/
---
## A3DObject class
...
| Name | Beschreibung |
| --- | --- |
| constructor(name) | Initialisiert eine neue Instanz der Klasse A3DObject. |
...
| Name | Beschreibung |
| --- | --- |
| constructor_overload() | Initialisiert eine neue Instanz der Klasse A3DObject ohne Namen. |

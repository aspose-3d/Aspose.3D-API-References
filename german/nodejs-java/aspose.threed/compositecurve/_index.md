...
url: /de/nodejs-java/aspose.threed/compositecurve/
---
## CompositeCurve class

Eine CompositeCurve besteht aus mehreren Kurvensegmenten.
...
| Name | Beschreibung |
| --- | --- |
| constructor() | Konstruktor von CompositeCurve |
...
| Name | Beschreibung |
| --- | --- |
| getSegments() | Die Segmente der Kurve. |
...
| Name | Beschreibung |
| --- | --- |
| addSegment(curve, sameDirection) | Der |

...
url: /de/nodejs-java/aspose.threed/hollowcircleshape/
---
...
| Name | Beschreibung |
| --- | --- |
| getWallThickness() | Liest oder setzt die Differenz zwischen dem äußeren und dem inneren Radius. |
...
| Name | Beschreibung |
| --- | --- |
| setWallThickness(value) | Liest oder setzt die Differenz zwischen dem äußeren und dem inneren Radius. |

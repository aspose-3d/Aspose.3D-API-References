...
url: /de/nodejs-java/aspose.threed/amfsaveoptions/
---
...
| Name | Beschreibung |
| --- | --- |
| constructor() | Konstruktor von AmfSaveOptions |
...
| Name | Beschreibung |
| --- | --- |
| getEnableCompression() | Ob Kompression verwendet werden soll, um die endgültige Dateigröße zu reduzieren, Standardwert ist true |
...
| Name | Beschreibung |
| --- | --- |
| setEnableCompression(value) | Ob Kompression verwendet werden soll, um die endgültige Dateigröße zu reduzieren, Standardwert ist true |

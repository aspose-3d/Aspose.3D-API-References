...
url: /de/nodejs-java/aspose.threed/mirroredprofile/
---
...
| Name | Beschreibung |
| --- | --- |
| constructor(baseProfile) | Erstelle ein neues MirroredProfile aus einem bestehenden Profil. |

 **Parameters:**

| Name | Typ | Beschreibung |
| --- | --- | --- |
| baseProfile | Profil | Das Basisprofil, das gespiegelt werden soll. |

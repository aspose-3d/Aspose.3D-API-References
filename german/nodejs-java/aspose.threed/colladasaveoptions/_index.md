...
url: /de/nodejs-java/aspose.threed/colladasaveoptions/
---
...
| Name | Beschreibung |
| --- | --- |
| constructor() | Konstruktor von ColladaSaveOptions |
...
| Name | Beschreibung |
| --- | --- |
| getIndented() | Liest oder setzt, ob das exportierte XML-Dokument eingerückt ist. |
...
| Name | Beschreibung |
| --- | --- |
| setIndented(value) | Liest oder setzt, ob das exportierte XML-Dokument eingerückt ist. |
...
| Name | Beschreibung |
| --- | --- |
| getTransformStyle() | Liest oder setzt den Stil der Knoten-Transformation. Der Wert der Eigenschaft ist die Ganzzahlkonstante ColladaTransformStyle. |
...
| Name | Beschreibung |
| --- | --- |
| setTransformStyle(value) | Liest oder setzt den Stil der Knoten-Transformation. Der Wert der Eigenschaft ist die Ganzzahlkonstante ColladaTransformStyle. |

...
url: /de/nodejs-java/aspose.threed/rectangulartorus/
---
...
| Name | Beschreibung |
| --- | --- |
| constructor() | Konstruktor von RectangularTorus |
...
| Name | Beschreibung |
| --- | --- |
| constructor_overload(name) | Konstruktor von RectangularTorus |
...
| Name | Beschreibung |
| --- | --- |
| setInnerRadius(value) | Der innere Radius des rechteckigen Torus, Standardwert ist 17 |
...
| Name | Beschreibung |
| --- | --- |
| setOuterRadius(value) | Der äußere Radius des rechteckigen Torus, Standardwert ist 20 |
...
| Name | Beschreibung |
| --- | --- |
| getHeight() | Die Höhe des rechteckigen Torus. Standardwert ist 20 |
...
| Name | Beschreibung |
| --- | --- |
| setHeight(value) | Die Höhe des rechteckigen Torus. Standardwert ist 20 |
...
| Name | Beschreibung |
| --- | --- |
| getArc() | Der Gesamtwinkel des Bogens, gemessen in Radiant. Standardwert ist PI |
...
| Name | Beschreibung |
| --- | --- |
| setArc(value) | Der Gesamtwinkel des Bogens, gemessen in Radiant. Standardwert ist PI |
...
| Name | Beschreibung |
| --- | --- |
| getAngleStart() | Der Startwinkel des Bogens, gemessen in Radiant. Standardwert ist 0 |
...
| Name | Beschreibung |
| --- | --- |
| setAngleStart(value) | Der Startwinkel des Bogens, gemessen in Radiant. Standardwert ist 0 |
...
| Name | Beschreibung |
| --- | --- |
| setRadialSegments(value) | Die radialen Segmente, Standardwert ist 10 |

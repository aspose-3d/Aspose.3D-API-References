...
url: /de/nodejs-java/aspose.threed/ushape/
---
## UShape class
...
| Name | Beschreibung |
| --- | --- |
| constructor() | Konstruktor von UShape |
...
| Name | Beschreibung |
| --- | --- |
| getDepth() | Liest oder setzt die Länge des web. |
...
| Name | Beschreibung |
| --- | --- |
| setDepth(value) | Liest oder setzt die Länge des web. |
...
| Name | Beschreibung |
| --- | --- |
| getFlangeWidth() | Liest oder setzt die Länge des flange. |
...
| Name | Beschreibung |
| --- | --- |
| setFlangeWidth(value) | Liest oder setzt die Länge des flange. |
...
| Name | Beschreibung |
| --- | --- |
| getWebThickness() | Liest oder setzt die Dicke des Netzes. |
...
| Name | Beschreibung |
| --- | --- |
| setWebThickness(value) | Liest oder setzt die Dicke des Netzes. |
...
| Name | Beschreibung |
| --- | --- |
| getFlangeThickness() | Liest oder setzt die Dicke des Flansches. |
...
| Name | Beschreibung |
| --- | --- |
| setFlangeThickness(value) | Liest oder setzt die Dicke des Flansches. |
...
| Name | Beschreibung |
| --- | --- |
| getFilletRadius() | Liest oder setzt den Radius der Rundung zwischen Flansch und Steg. |
...
| Name | Beschreibung |
| --- | --- |
| setFilletRadius(value) | Liest oder setzt den Radius der Rundung zwischen Flansch und Steg. |
...
| Name | Beschreibung |
| --- | --- |
| getEdgeRadius() | Liest oder setzt den Radius der Kante im Flanschrand. |
...
| Name | Beschreibung |
| --- | --- |
| setEdgeRadius(value) | Liest oder setzt den Radius der Kante im Flanschrand. |

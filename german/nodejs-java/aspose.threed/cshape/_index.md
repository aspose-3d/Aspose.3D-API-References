...
url: /de/nodejs-java/aspose.threed/cshape/
---
## CShape class

IFC‑kompatibles C‑Form‑Profil, das durch Parameter definiert wird.  Die zentrale Position des Profils liegt im Zentrum der Begrenzungsbox.
...
| Name | Beschreibung |
| --- | --- |
| constructor() | Konstruktor von CShape |
...
| Name | Beschreibung |
| --- | --- |
| getDepth() | Liest oder setzt die Tiefe des Profils. |
...
| Name | Beschreibung |
| --- | --- |
| setDepth(value) | Liest oder setzt die Tiefe des Profils. |
...
| Name | Beschreibung |
| --- | --- |
| getWidth() | Liest oder setzt die Breite des Profils. |
...
| Name | Beschreibung |
| --- | --- |
| setWidth(value) | Liest oder setzt die Breite des Profils. |
...
| Name | Beschreibung |
| --- | --- |
| getGirth() | Liest oder setzt die Länge des Umfangs. |
...
| Name | Beschreibung |
| --- | --- |
| setGirth(value) | Liest oder setzt die Länge des Umfangs. |
...
| Name | Beschreibung |
| --- | --- |
| getWallThickness() | Liest oder setzt die Dicke der Wand. |
...
| Name | Beschreibung |
| --- | --- |
| setWallThickness(value) | Liest oder setzt die Dicke der Wand. |
...
| Name | Beschreibung |
| --- | --- |
| getInternalFilletRadius() | Liest oder setzt den internen Rundungsradius. |
...
| Name | Beschreibung |
| --- | --- |
| setInternalFilletRadius(value) | Liest oder setzt den internen Rundungsradius. |

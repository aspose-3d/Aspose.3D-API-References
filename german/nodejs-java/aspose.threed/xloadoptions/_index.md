...
url: /de/nodejs-java/aspose.threed/xloadoptions/
---
## XLoadOptions class
...
| Name | Beschreibung |
| --- | --- |
| Konstruktor(contentType) | Konstruktor von XLoadOptions |
...
| Name | Beschreibung |
| --- | --- |
| setFlipCoordinateSystem(value) | Koordinatensystem umkehren, dies ist standardmäßig true |

...
url: /de/nodejs-java/aspose.threed/zshape/
---
## ZShape class
...
| Name | Beschreibung |
| --- | --- |
| constructor() | Konstruktor von ZShape |
...
| Name | Beschreibung |
| --- | --- |
| getWebThickness() | Liest oder setzt die Dicke der Wand. |
...
| Name | Beschreibung |
| --- | --- |
| setWebThickness(value) | Liest oder setzt die Dicke der Wand. |
...
| Name | Beschreibung |
| --- | --- |
| getEdgeRadius() | Liest oder setzt den Radius der Flanschkante. |
...
| Name | Beschreibung |
| --- | --- |
| setEdgeRadius(value) | Liest oder setzt den Radius der Flanschkante. |

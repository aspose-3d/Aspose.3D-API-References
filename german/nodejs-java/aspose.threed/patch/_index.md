...
| Name | Beschreibung |
| --- | --- |
| constructor() | Initialisiert eine neue Instanz der Klasse Patch. |
...
| Name | Beschreibung |
| --- | --- |
| constructor_overload(name) | Initialisiert eine neue Instanz der Klasse Patch. |
...
| Name | Beschreibung |
| --- | --- |
| getV() | Liest die v-Richtung. Das v. |

...
url: /de/nodejs-java/aspose.threed/transformedcurve/
---
## TransformedCurve class

Eine **TransformedCurve** gibt einer Kurve eine Platzierung, indem sie eine Transformationsmatrix verwendet.  Dies ermöglicht eine Transformation innerhalb einer **TrimmedCurve** oder **CompositeCurve**.
...
| Name | Beschreibung |
| --- | --- |
| constructor() | Der Konstruktor von TransformedCurve |
...
| Name | Beschreibung |
| --- | --- |
| constructor_overload(basisCurve, transformation) | Der Konstruktor von TransformedCurve |
...
| Name | Beschreibung |
| --- | --- |
| getTransformMatrix() | Die Transformationsmatrix. |
...
| Name | Beschreibung |
| --- | --- |
| setTransformMatrix(value) | Die Transformationsmatrix. |
...
| Name | Beschreibung |
| --- | --- |
| setBasisCurve(value) | Die Basis‑Kurve. |

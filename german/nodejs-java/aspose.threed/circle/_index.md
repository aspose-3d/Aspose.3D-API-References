...
url: /de/nodejs-java/aspose.threed/circle/
---
## Circle class

Eine Kreis‑Kurve besteht aus einer Menge von Punkten am Rand der Kreisform.
...
| Name | Beschreibung |
| --- | --- |
| constructor() | Konstruktor von Circle |
...
| Name | Beschreibung |
| --- | --- |
| constructor_overload(radius) | Konstruktor von Circle |

 **Parameters:**

| Name | Typ | Beschreibung |
| --- | --- | --- |
| radius | Number | Der Radius der Kreis-Kurve. |
...
| Name | Beschreibung |
| --- | --- |
| getRadius() | Der Radius der Kreis-Kurve, Standardwert ist 10 |
...
| Name | Beschreibung |
| --- | --- |
| setRadius(value) | Der Radius der Kreis-Kurve, Standardwert ist 10 |

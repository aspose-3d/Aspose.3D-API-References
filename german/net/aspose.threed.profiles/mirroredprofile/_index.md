...
IFC-kompatibles Spiegelprofil. Dieses Profil definiert ein neues Profil durch Spiegeln des Basisprofils um die y-Achse.
...
| Name | Beschreibung |
| --- | --- |
| [MirroredProfile](mirroredprofile)(Profile) | Konstruieren Sie eine neue[`MirroredProfile`](../mirroredprofile) aus einem bestehenden Profil. |

## Eigenschaften

| Name | Beschreibung |
| --- | --- |
| [BaseProfile](../../aspose.threed.profiles/mirroredprofile/baseprofile) { get; } | Das zu spiegelnde Basisprofil. |

...
| Name | Beschreibung |
| --- | --- |
| [TShape](tshape)() | Konstrukteur von[`TShape`](../tshape) |

## Eigenschaften

| Name | Beschreibung |
| --- | --- |
| [Depth](../../aspose.threed.profiles/tshape/depth) { get; set; } | Holt oder setzt die Länge des Webs. |
...
| [FilletRadius](../../aspose.threed.profiles/tshape/filletradius) { get; set; } | Ruft den Rundungsradius zwischen Steg und Flansch ab oder legt ihn fest. |
| [FlangeEdgeRadius](../../aspose.threed.profiles/tshape/flangeedgeradius) { get; set; } | Ruft den Radius der Flanschkante ab oder legt ihn fest. |
| [FlangeThickness](../../aspose.threed.profiles/tshape/flangethickness) { get; set; } | Ruft die Wandstärke des Flansches ab oder legt sie fest. |
| [FlangeWidth](../../aspose.threed.profiles/tshape/flangewidth) { get; set; } | Holt oder setzt die Länge des Flansches. |
...
| [WebEdgeRadius](../../aspose.threed.profiles/tshape/webedgeradius) { get; set; } | Holt oder setzt den Radius der Bahnkante. |
| [WebThickness](../../aspose.threed.profiles/tshape/webthickness) { get; set; } | Ruft die Wandstärke des Stegs ab oder legt sie fest. |
...
| override [GetExtent](../../aspose.threed.profiles/tshape/getextent)() | Ruft die Ausdehnung in x- und y-Dimension ab. |

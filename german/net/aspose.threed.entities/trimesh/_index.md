...
description: Ein TriMesh enthält Rohdaten die von der GPU direkt verwendet werden können. Diese Klasse ist ein Dienstprogramm das beim Erstellen eines Netzes hilft das nur Daten pro Scheitelpunkt enthält.
type: docs
weight: 730
url: /de/net/aspose.threed.entities/trimesh/
---
## TriMesh class
...
| Name | Beschreibung |
| --- | --- |
| [TriMesh](trimesh)(string, VertexDeclaration) | Initialisiert eine Instanz von[`TriMesh`](../trimesh) |
...
| [UnmergedVerticesCount](../../aspose.threed.entities/trimesh/unmergedverticescount) { get; } | Die Anzahl der nicht zusammengeführten Scheitelpunkte, die vorbeigegangen sind[`BeginVertex`](./beginvertex) und[`EndVertex`](./endvertex) . |
...
| Name | Beschreibung |
| --- | --- |
| static [CopyFrom](../../aspose.threed.entities/trimesh/copyfrom)(TriMesh, VertexDeclaration) | Kopieren Sie die[`TriMesh`](../trimesh)aus der Eingabe mit neuem Scheitelpunkt layout |
| static [FromMesh](../../aspose.threed.entities/trimesh/frommesh#frommesh)(Mesh, bool) | Erstellt ein TriMesh aus einem gegebenen Netzobjekt, die Vertex-Deklaration basiert auf der Struktur des Eingabenetzes. |
| static [FromMesh](../../aspose.threed.entities/trimesh/frommesh#frommesh_1)(VertexDeclaration, Mesh) | Erstellen Sie ein TriMesh aus einem gegebenen Mesh-Objekt mit einem gegebenen Scheitelpunkt-Layout. |
| static [FromRawData](../../aspose.threed.entities/trimesh/fromrawdata)(VertexDeclaration, byte[], int[], bool) | TriMesh aus Rohdaten erstellen |

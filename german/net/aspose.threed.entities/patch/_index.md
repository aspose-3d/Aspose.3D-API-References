...
description: APatch./patch ist eine parametrische Modellierungsoberfläche ähnlich wieNurbsSurface./nurbssurface  es wird auch durch zwei definiertPatchDirection./patchdirection  dasU./patch/u undV./patch/v . Aber Unterschied zwischenPatch./patch undNurbsSurface./nurbssurface Ist das dasPatchDirection./patchdirection Kurve kann eine davon seinBezier QuadraticBezier BasisSpline CardinalSpline undLinear
type: docs
weight: 500
url: /de/net/aspose.threed.entities/patch/
---
## Patch class

A[`Patch`](../patch) ist eine parametrische Modellierungsoberfläche, ähnlich wie[`NurbsSurface`](../nurbssurface) , es wird auch durch zwei definiert[`PatchDirection`](../patchdirection) , das[`U`](./u) und[`V`](./v) . Aber Unterschied zwischen[`Patch`](../patch) und[`NurbsSurface`](../nurbssurface) Ist das das[`PatchDirection`](../patchdirection) Kurve kann eine davon seinBezier ,QuadraticBezier ,BasisSpline ,CardinalSpline undLinear
...
| Name | Beschreibung |
| --- | --- |
| [Patch](patch#constructor)() | Initialisiert eine neue Instanz von[`Patch`](../patch) Klasse. |
| [Patch](patch#constructor_1)(string) | Initialisiert eine neue Instanz von[`Patch`](../patch) Klasse. |
...
| [U](../../aspose.threed.entities/patch/u) { get; } | Ruft die u-Richtung ab. |
| [V](../../aspose.threed.entities/patch/v) { get; } | Ruft die v-Richtung ab. |

...
type: docs
weight: 590
url: /de/net/aspose.threed.entities/pyramid/
---
## Pyramid class
...
| Name | Beschreibung |
| --- | --- |
| [Pyramid](pyramid#constructor)() | Konstruieren Sie eine neue Pyramideninstanz mit standardmäßiger unterer Fläche (10, 10) und standardmäßiger Höhe (5) |
| [Pyramid](pyramid#constructor_1)(double, double, double) | Konstruieren Sie eine neue Pyramideninstanz mit dem angegebenen unteren Bereich |
| [Pyramid](pyramid#constructor_2)(double, double, double, double, double) | Konstruieren Sie eine neue Pyramideninstanz mit angegebenem unteren und oberen Bereich und Höhe. |
| [Pyramid](pyramid#constructor_3)(string, double, double, double, double, double) | Konstruieren Sie eine neue Pyramideninstanz mit angegebenem unteren und oberen Bereich und Höhe. |

## Eigenschaften

| Name | Beschreibung |
| --- | --- |
| [BottomArea](../../aspose.threed.entities/pyramid/bottomarea) { get; set; } | Bereich der unteren Kappe |
| [BottomOffset](../../aspose.threed.entities/pyramid/bottomoffset) { get; set; } | Versatz für untere Scheitelpunkte |
...
| [Height](../../aspose.threed.entities/pyramid/height) { get; set; } | Höhe der Pyramide |
...
| [TopArea](../../aspose.threed.entities/pyramid/toparea) { get; set; } | Bereich der oberen Kappe |
...
| override [ToMesh](../../aspose.threed.entities/pyramid/tomesh)() | Aktuelles Objekt in mesh umwandeln |

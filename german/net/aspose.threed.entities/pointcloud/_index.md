...
description: Die Punktwolke enthält keine Topologieinformationen sondern nur die Kontrollpunkte und die Vertexelemente.
type: docs
weight: 540
url: /de/net/aspose.threed.entities/pointcloud/
---
## PointCloud class

Die Punktwolke enthält keine Topologieinformationen, sondern nur die Kontrollpunkte und die Vertexelemente.
...
| Name | Beschreibung |
| --- | --- |
| [PointCloud](pointcloud#constructor)() | Konstrukteur von[`PointCloud`](../pointcloud) |
| [PointCloud](pointcloud#constructor_1)(string) | Konstrukteur von[`PointCloud`](../pointcloud) |
...
| Name | Beschreibung |
| --- | --- |
| static [FromGeometry](../../aspose.threed.entities/pointcloud/fromgeometry#fromgeometry)(Geometry) | Erstellen Sie eine neue PointCloud-Instanz aus einem Geometrieobjekt |
| static [FromGeometry](../../aspose.threed.entities/pointcloud/fromgeometry#fromgeometry_1)(Geometry, int) | Erstellen Sie eine neue Punktwolkeninstanz aus einem Geometrieobjekt. Dichte ist die Anzahl der Punkte pro Einheitsdreieck (Einheitsdreieck ist das Dreieck mit maximaler Oberfläche aus dem Netz) |
...
| override [GetEntityRendererKey](../../aspose.threed.entities/pointcloud/getentityrendererkey)() | Ruft den Schlüssel des Entity-Renderers ab, der im Renderer registriert ist |

...
| [Decode](../../aspose.threed.formats/dracoformat/decode#decode)(byte[]) | Decodieren der Punktwolke oder des Netzes aus Speicherdaten |
| [Decode](../../aspose.threed.formats/dracoformat/decode#decode_1)(string) | Dekodieren Sie die Punktwolke oder das Netz aus dem angegebenen Dateinamen |
| [Encode](../../aspose.threed.formats/dracoformat/encode#encode)(Entity, DracoSaveOptions) | Codieren Sie die Entität in Draco-Rohdaten |
| [Encode](../../aspose.threed.formats/dracoformat/encode#encode_1)(Entity, Stream, DracoSaveOptions) | Codieren Sie die Entität in den angegebenen Stream |
| [Encode](../../aspose.threed.formats/dracoformat/encode#encode_2)(Entity, string, DracoSaveOptions) | Codieren Sie die Entität in die angegebene Datei |

...
type: docs
weight: 170
url: /de/python-net/aspose.threed.entities/mesh/optimize/
is_root: false
---
...
# Sphere.ToMesh erzeugt 117 Kontrollpunkte
mesh = Sphere().to_mesh()
# Nach der Optimierung gibt es nur noch 86 Kontrollpunkte, Polygonindizes werden ebenfalls neu zugeordnet.

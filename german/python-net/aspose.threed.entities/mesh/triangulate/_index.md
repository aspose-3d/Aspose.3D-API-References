...
type: docs
weight: 210
url: /de/python-net/aspose.threed.entities/mesh/triangulate/
is_root: false
---
...
# Das Ebenen-Mesh hat nur ein Polygon mit 4 Kontrollpunkten
mesh = Plane().to_mesh()
# Nach der Triangulierung wird das Rechteck des neuen Meshes zu 2 Dreiecken.

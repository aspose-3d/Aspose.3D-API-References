...
url: /id/nodejs-java/aspose.threed/transformedcurve/
---
## TransformedCurve class

TransformedCurve memberikan penempatan pada sebuah kurva dengan menggunakan matriks transformasi.  Ini memungkinkan melakukan transformasi di dalam TrimmedCurve atau CompositeCurve.
...
| Nama | Deskripsi |
| --- | --- |
| constructor() | Konstruktor dari TransformedCurve |
...
| Nama | Deskripsi |
| --- | --- |
| constructor_overload(basisCurve, transformation) | Konstruktor dari TransformedCurve |
...
| Nama | Deskripsi |
| --- | --- |
| getTransformMatrix() | Matriks transformasi. |
...
| Nama | Deskripsi |
| --- | --- |
| setTransformMatrix(value) | Matriks transformasi. |
...
| Nama | Deskripsi |
| --- | --- |
| setBasisCurve(value) | Kurva dasar. |

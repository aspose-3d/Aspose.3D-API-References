...
url: /id/nodejs-java/aspose.threed/xloadoptions/
---
## XLoadOptions class

Opsi Load untuk file DirectX X.
...
| Nama | Deskripsi |
| --- | --- |
| constructor(contentType) | Konstruktor XLoadOptions |
...
| Nama | Deskripsi |
| --- | --- |
| getFlipCoordinateSystem() | Balikkan sistem koordinat, ini bernilai true secara default |
...
| Nama | Deskripsi |
| --- | --- |
| setFlipCoordinateSystem(value) | Balikkan sistem koordinat, ini bernilai true secara default |

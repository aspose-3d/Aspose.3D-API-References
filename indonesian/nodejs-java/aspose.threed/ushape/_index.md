...
url: /id/nodejs-java/aspose.threed/ushape/
---
## UShape class

Bentuk U yang kompatibel dengan IFC didefinisikan oleh parameter.
...
| Nama | Deskripsi |
| --- | --- |
| constructor() | Konstruktor UShape |
...
| Nama | Deskripsi |
| --- | --- |
| getWebThickness() | Mendapatkan atau mengatur ketebalan web. |
...
| Nama | Deskripsi |
| --- | --- |
| setWebThickness(value) | Mendapatkan atau mengatur ketebalan web. |
...
| Nama | Deskripsi |
| --- | --- |
| getFlangeThickness() | Mendapatkan atau mengatur ketebalan flange. |
...
| Nama | Deskripsi |
| --- | --- |
| setFlangeThickness(value) | Mendapatkan atau mengatur ketebalan flange. |
...
| Nama | Deskripsi |
| --- | --- |
| getFilletRadius() | Mendapatkan atau mengatur radius fillet antara flange dan web. |
...
| Nama | Deskripsi |
| --- | --- |
| setFilletRadius(value) | Mendapatkan atau mengatur radius fillet antara flange dan web. |
...
| Nama | Deskripsi |
| --- | --- |
| getEdgeRadius() | Mendapatkan atau mengatur radius tepi pada tepi flange. |
...
| Nama | Deskripsi |
| --- | --- |
| setEdgeRadius(value) | Mendapatkan atau mengatur radius tepi pada tepi flange. |

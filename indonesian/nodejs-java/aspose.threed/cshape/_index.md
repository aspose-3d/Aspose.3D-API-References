...
url: /id/nodejs-java/aspose.threed/cshape/
---
## CShape class
...
| Nama | Deskripsi |
| --- | --- |
| constructor() | Konstruktor CShape |
...
| Nama | Deskripsi |
| --- | --- |
| getGirth() | Mendapatkan atau mengatur panjang keliling. |
...
| Nama | Deskripsi |
| --- | --- |
| setGirth(value) | Mendapatkan atau mengatur panjang keliling. |
...
| Nama | Deskripsi |
| --- | --- |
| getWallThickness() | Mendapatkan atau mengatur ketebalan dinding. |
...
| Nama | Deskripsi |
| --- | --- |
| setWallThickness(value) | Mendapatkan atau mengatur ketebalan dinding. |
...
| Nama | Deskripsi |
| --- | --- |
| getInternalFilletRadius() | Mendapatkan atau mengatur radius fillet internal. |
...
| Nama | Deskripsi |
| --- | --- |
| setInternalFilletRadius(value) | Mendapatkan atau mengatur radius fillet internal. |

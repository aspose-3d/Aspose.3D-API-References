...
url: /id/nodejs-java/aspose.threed/pdfloadoptions/
---
...
| Nama | Deskripsi |
| --- | --- |
| constructor() | Konstruktor dari PdfLoadOptions |
...
| Nama | Deskripsi |
| --- | --- |
| getPassword() | Kata sandi untuk membuka file PDF terenkripsi. |
...
| Nama | Deskripsi |
| --- | --- |
| setPassword(value) | Kata sandi untuk membuka file PDF terenkripsi. |

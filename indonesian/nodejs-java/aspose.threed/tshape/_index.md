...
url: /id/nodejs-java/aspose.threed/tshape/
---
## TShape class
...
| Nama | Deskripsi |
| --- | --- |
| constructor() | Konstruktor dari TShape |
...
| Nama | Deskripsi |
| --- | --- |
| getDepth() | Mendapatkan atau mengatur panjang web. |
...
| Nama | Deskripsi |
| --- | --- |
| setDepth(value) | Mendapatkan atau mengatur panjang web. |
...
| Nama | Deskripsi |
| --- | --- |
| getFlangeWidth() | Mendapatkan atau mengatur panjang flange. |
...
| Nama | Deskripsi |
| --- | --- |
| setFlangeWidth(value) | Mendapatkan atau mengatur panjang flange. |
...
| Nama | Deskripsi |
| --- | --- |
| getWebThickness() | Mendapatkan atau mengatur ketebalan dinding web. |
...
| Nama | Deskripsi |
| --- | --- |
| setWebThickness(value) | Mendapatkan atau mengatur ketebalan dinding web. |
...
| Nama | Deskripsi |
| --- | --- |
| getFlangeThickness() | Mendapatkan atau mengatur ketebalan dinding flange. |
...
| Nama | Deskripsi |
| --- | --- |
| setFlangeThickness(value) | Mendapatkan atau mengatur ketebalan dinding flange. |
...
| Nama | Deskripsi |
| --- | --- |
| getFilletRadius() | Mendapatkan atau mengatur radius fillet antara web dan flange. |
...
| Nama | Deskripsi |
| --- | --- |
| setFilletRadius(value) | Mendapatkan atau mengatur radius fillet antara web dan flange. |
...
| Nama | Deskripsi |
| --- | --- |
| getFlangeEdgeRadius() | Mendapatkan atau mengatur radius tepi flange. |
...
| Nama | Deskripsi |
| --- | --- |
| setFlangeEdgeRadius(value) | Mendapatkan atau mengatur radius tepi flange. |
...
| Nama | Deskripsi |
| --- | --- |
| getWebEdgeRadius() | Mendapatkan atau mengatur radius tepi web. |
...
| Nama | Deskripsi |
| --- | --- |
| setWebEdgeRadius(value) | Mendapatkan atau mengatur radius tepi web. |

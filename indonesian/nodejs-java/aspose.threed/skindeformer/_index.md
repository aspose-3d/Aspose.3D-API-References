...
url: /id/nodejs-java/aspose.threed/skindeformer/
---
## SkinDeformer class

Skin deformer berisi beberapa tulang untuk bekerja, setiap tulang menggabungkan bagian dari geometri berdasarkan bobot titik kontrol.
...
| Nama | Deskripsi |
| --- | --- |
| constructor(name) | Menginisialisasi sebuah instance baru dari kelas SkinDeformer. |
...
| Nama | Deskripsi |
| --- | --- |
| constructor_overload() | Menginisialisasi sebuah instance baru dari kelas SkinDeformer. |
...
| Nama | Deskripsi |
| --- | --- |
| getBones() | Mengambil semua tulang yang dimiliki oleh skin deformer |

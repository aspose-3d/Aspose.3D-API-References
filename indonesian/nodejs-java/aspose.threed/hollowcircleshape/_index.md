...
url: /id/nodejs-java/aspose.threed/hollowcircleshape/
---
## HollowCircleShape class

Profil lingkaran berongga kompatibel IFC.
...
| Nama | Deskripsi |
| --- | --- |
| getWallThickness() | Mendapatkan atau mengatur selisih antara radius luar dan dalam. |
...
| Nama | Deskripsi |
| --- | --- |
| setWallThickness(value) | Mendapatkan atau mengatur selisih antara radius luar dan dalam. |

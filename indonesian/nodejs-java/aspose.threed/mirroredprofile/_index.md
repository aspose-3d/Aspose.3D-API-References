...
url: /id/nodejs-java/aspose.threed/mirroredprofile/
---
## MirroredProfile class

Profil cermin yang kompatibel dengan IFC. Profil ini mendefinisikan profil baru dengan mencerminkan profil dasar terhadap sumbu y.
...
| Nama | Deskripsi |
| --- | --- |
| constructor(baseProfile) | Membuat MirroredProfile baru dari profil yang ada. |
...
| Nama | Deskripsi |
| --- | --- |
| getBaseProfile() | Profil dasar yang akan dicerminkan. |

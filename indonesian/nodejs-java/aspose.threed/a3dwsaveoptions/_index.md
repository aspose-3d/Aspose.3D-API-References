...
url: /id/nodejs-java/aspose.threed/a3dwsaveoptions/
---
...
| Nama | Deskripsi |
| --- | --- |
| constructor() | Konstruktor dari A3dwSaveOptions |
...
| Nama | Deskripsi |
| --- | --- |
| getExportMetaData() | Ekspor metadata yang terkait dengan Scene/Node ke klien Nilai default adalah true |
...
| Nama | Deskripsi |
| --- | --- |
| setExportMetaData(value) | Ekspor metadata yang terkait dengan Scene/Node ke klien Nilai default adalah true |
...
| Nama | Deskripsi |
| --- | --- |
| getMetaDataPrefix() | Jika properti ini tidak null, hanya properti dari Scene/Node yang dimulai dengan awalan ini yang akan diekspor, dan awalan tersebut akan dihapus. |
...
| Nama | Deskripsi |
| --- | --- |
| setMetaDataPrefix(value) | Jika properti ini tidak null, hanya properti dari Scene/Node yang dimulai dengan awalan ini yang akan diekspor, dan awalan tersebut akan dihapus. |

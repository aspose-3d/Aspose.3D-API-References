...
url: /id/nodejs-java/aspose.threed/circleshape/
---
## CircleShape class

Profil lingkaran kompatibel IFC, yang dapat digunakan untuk membangun mesh melalui LinearExtrusion
...
| Nama | Deskripsi |
| --- | --- |
| constructor() | Membuat profil CircleShape dengan radius default(5). |
...
| Nama | Deskripsi |
| --- | --- |
| constructor_overload(radius) | Membuat profil CircleShape dengan radius yang ditentukan. |
...
| Nama | Deskripsi |
| --- | --- |
| getRadius() | Mendapatkan atau mengatur radius lingkaran. |
...
| Nama | Deskripsi |
| --- | --- |
| setRadius(value) | Mendapatkan atau mengatur radius lingkaran. |

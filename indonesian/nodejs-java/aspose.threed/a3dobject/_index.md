...
url: /id/nodejs-java/aspose.threed/a3dobject/
---
## A3DObject class

Kelas dasar semua objek Aspose.ThreeD, semua subkelas akan mendukung properti dinamis.
...
| Nama | Deskripsi |
| --- | --- |
| constructor(name) | Menginisialisasi instance baru dari kelas A3DObject. |
...
| Nama | Deskripsi |
| --- | --- |
| constructor_overload() | Menginisialisasi instance baru dari kelas A3DObject tanpa nama. |

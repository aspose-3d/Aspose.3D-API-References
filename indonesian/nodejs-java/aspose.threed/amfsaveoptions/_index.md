...
url: /id/nodejs-java/aspose.threed/amfsaveoptions/
---
...
| Nama | Deskripsi |
| --- | --- |
| constructor() | Konstruktor dari AmfSaveOptions |
...
| Nama | Deskripsi |
| --- | --- |
| getEnableCompression() | Apakah akan menggunakan kompresi untuk mengurangi ukuran file akhir, nilai default adalah true |
...
| Nama | Deskripsi |
| --- | --- |
| setEnableCompression(value) | Apakah akan menggunakan kompresi untuk mengurangi ukuran file akhir, nilai default adalah true |

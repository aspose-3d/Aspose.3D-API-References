...
url: /id/nodejs-java/aspose.threed/trapeziumshape/
---
## TrapeziumShape class

Bentuk Trapezium yang kompatibel dengan IFC didefinisikan oleh parameter.
...
| Nama | Deskripsi |
| --- | --- |
| constructor() | Konstruktor dari TrapeziumShape |
...
| Nama | Deskripsi |
| --- | --- |
| getBottomXDim() | Mendapatkan atau mengatur panjang garis bawah yang diukur sepanjang sumbu x. |
...
| Nama | Deskripsi |
| --- | --- |
| setBottomXDim(value) | Mendapatkan atau mengatur panjang garis bawah yang diukur sepanjang sumbu x. |
...
| Nama | Deskripsi |
| --- | --- |
| getTopXDim() | Mendapatkan atau mengatur rentang garis atas yang diukur sepanjang sumbu x. |
...
| Nama | Deskripsi |
| --- | --- |
| setTopXDim(value) | Mendapatkan atau mengatur rentang garis atas yang diukur sepanjang sumbu x. |
...
| Nama | Deskripsi |
| --- | --- |
| getYDim() | Mendapatkan atau mengatur jarak antara garis atas dan bawah yang diukur sepanjang sumbu y. |
...
| Nama | Deskripsi |
| --- | --- |
| setYDim(value) | Mendapatkan atau mengatur jarak antara garis atas dan bawah yang diukur sepanjang sumbu y. |
...
| Nama | Deskripsi |
| --- | --- |
| getTopXOffset() | Mendapatkan atau mengatur offset dari awal garis atas ke garis bawah. |
...
| Nama | Deskripsi |
| --- | --- |
| setTopXOffset(value) | Mendapatkan atau mengatur offset dari awal garis atas ke garis bawah. |

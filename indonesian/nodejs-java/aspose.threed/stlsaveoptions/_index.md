...
url: /id/nodejs-java/aspose.threed/stlsaveoptions/
---
...
| Nama | Deskripsi |
| --- | --- |
| constructor() | Menginisialisasi instance baru StlSaveOptions. |
...
| Nama | Deskripsi |
| --- | --- |
| constructor_overload(contentType) | Menginisialisasi instance baru StlSaveOptions. |
...
| Nama | Deskripsi |
| --- | --- |
| getFlipCoordinateSystem() | Mendapatkan atau mengatur apakah membalik sistem koordinat titik kontrol/normal selama ekspor. |
...
| Nama | Deskripsi |
| --- | --- |
| setFlipCoordinateSystem(value) | Mendapatkan atau mengatur apakah membalik sistem koordinat titik kontrol/normal selama ekspor. |

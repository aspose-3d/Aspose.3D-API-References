...
url: /id/nodejs-java/aspose.threed/colladasaveoptions/
---
...
| Nama | Deskripsi |
| --- | --- |
| constructor() | Konstruktor ColladaSaveOptions |
...
| Nama | Deskripsi |
| --- | --- |
| getIndented() | Mendapatkan atau mengatur apakah dokumen XML yang diekspor diindentasi. |
...
| Nama | Deskripsi |
| --- | --- |
| setIndented(value) | Mendapatkan atau mengatur apakah dokumen XML yang diekspor diindentasi. |
...
| Nama | Deskripsi |
| --- | --- |
| getTransformStyle() | Mendapatkan atau mengatur gaya transformasi node. Nilai properti adalah konstanta integer ColladaTransformStyle. |
...
| Nama | Deskripsi |
| --- | --- |
| setTransformStyle(value) | Mendapatkan atau mengatur gaya transformasi node. Nilai properti adalah konstanta integer ColladaTransformStyle. |

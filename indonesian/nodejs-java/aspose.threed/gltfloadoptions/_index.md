...
url: /id/nodejs-java/aspose.threed/gltfloadoptions/
---
...
| Nama | Deskripsi |
| --- | --- |
| constructor() | Konstruktor dari GltfLoadOptions |
...
| Nama | Deskripsi |
| --- | --- |
| getFlipTexCoordV() | Balikkan koordinat v(t) dalam koordinat tekstur mesh, nilai default adalah true. |
...
| Nama | Deskripsi |
| --- | --- |
| setFlipTexCoordV(value) | Balikkan koordinat v(t) dalam koordinat tekstur mesh, nilai default adalah true. |

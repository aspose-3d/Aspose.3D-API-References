...
url: /id/nodejs-java/aspose.threed/postprocessing/
---
## PostProcessing class

Efek pasca‑pemrosesan  @hideconstructor
...
| Nama | Deskripsi |
| --- | --- |
| getInput() | Input dari pemrosesan pasca ini |
...
| Nama | Deskripsi |
| --- | --- |
| setInput(value) | Input dari pemrosesan pasca ini |

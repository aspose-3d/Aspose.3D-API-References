...
url: /id/nodejs-java/aspose.threed/customobject/
---
## CustomObject class
...
| Nama | Deskripsi |
| --- | --- |
| constructor() | Menginisialisasi sebuah instance baru dari kelas CustomObject. |
...
| Nama | Deskripsi |
| --- | --- |
| constructor_overload(name) | Menginisialisasi sebuah instance baru dari kelas CustomObject. |

...
url: /id/nodejs-java/aspose.threed/arbitraryprofile/
---
## ArbitraryProfile class

Kelas ini memungkinkan Anda membuat profil 2D langsung dari kurva sewenang-wenang.
...
| Nama | Deskripsi |
| --- | --- |
| constructor() | Konstruktor ArbitraryProfile |
...
| Nama | Deskripsi |
| --- | --- |
| constructor_overload(curve) | Konstruktor ArbitraryProfile dengan kurva awal. |
...
| Nama | Deskripsi |
| --- | --- |
| getCurve() | Kurva yang digunakan untuk membangun profil |
...
| Nama | Deskripsi |
| --- | --- |
| setCurve(value) | Kurva yang digunakan untuk membangun profil |

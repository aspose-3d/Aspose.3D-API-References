...
url: /id/nodejs-java/aspose.threed/sweptareasolid/
---
## SweptAreaSolid class

SweptAreaSolid membangun geometri dengan menyapu sebuah profil sepanjang direktiks.
...
| Nama | Deskripsi |
| --- | --- |
| getShape() | Profil dasar untuk membangun geometri. |
...
| Nama | Deskripsi |
| --- | --- |
| setShape(value) | Profil dasar untuk membangun geometri. |
...
| Nama | Deskripsi |
| --- | --- |
| getDirectrix() | Direktriks yang dilalui oleh area yang diputar. |
...
| Nama | Deskripsi |
| --- | --- |
| setDirectrix(value) | Direktriks yang dilalui oleh area yang diputar. |
...
| Nama | Deskripsi |
| --- | --- |
| getStartPoint() | Titik awal dari directrix. |
...
| Nama | Deskripsi |
| --- | --- |
| setStartPoint(value) | Titik awal dari directrix. |
...
| Nama | Deskripsi |
| --- | --- |
| getEndPoint() | Titik akhir dari directrix. |
...
| Nama | Deskripsi |
| --- | --- |
| setEndPoint(value) | Titik akhir dari directrix. |

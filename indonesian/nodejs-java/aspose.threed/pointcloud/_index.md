...
url: /id/nodejs-java/aspose.threed/pointcloud/
---
## PointCloud class

Awan titik tidak berisi informasi topologi tetapi hanya titik kontrol dan elemen vertex.
...
| Nama | Deskripsi |
| --- | --- |
| constructor(name) | Konstruktor PointCloud |
...
| Nama | Deskripsi |
| --- | --- |
| constructor_overload() | Konstruktor PointCloud |
...
| Nama | Deskripsi |
| --- | --- |
| fromGeometry(g) | Buat instance PointCloud baru dari objek geometri |
...
| Nama | Deskripsi |
| --- | --- |
| fromGeometry(g, density) | Buat instance point cloud baru dari objek geometri. Density adalah jumlah titik per segitiga unit (Segitiga unit adalah segitiga dengan luas permukaan maksimum dari mesh) |

 **Parameters:**

| Nama | Tipe | Deskripsi |
| --- | --- | --- |
| g | Geometri | Instansi Mesh atau geometri lainnya |
| density | Angka | Jumlah titik per segitiga unit |

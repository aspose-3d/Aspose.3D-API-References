...
url: /id/nodejs-java/aspose.threed/deformer/
---
## Deformer class

Kelas dasar untuk SkinDeformer dan MorphTargetDeformer
...
| Nama | Deskripsi |
| --- | --- |
| constructor(name) | Menginisialisasi sebuah instance baru dari kelas Deformer. |

...
url: /id/nodejs-java/aspose.threed/entity/
---
## Entity class

Kelas dasar untuk semua entitas. Entitas mewakili objek konkret yang terpasang di bawah node seperti Light/Geometry.
...
| Nama | Deskripsi |
| --- | --- |
| constructor(name) | Menginisialisasi sebuah instance baru dari kelas Entity. |

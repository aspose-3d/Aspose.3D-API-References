...
url: /id/nodejs-java/aspose.threed/lshape/
---
## LShape class

Profil L-shape yang kompatibel dengan IFC yang didefinisikan oleh parameter.
...
| Nama | Deskripsi |
| --- | --- |
| constructor() | Konstruktor LShape |
...
| Nama | Deskripsi |
| --- | --- |
| getDepth() | Mendapatkan atau mengatur kedalaman profil. |
...
| Nama | Deskripsi |
| --- | --- |
| setDepth(value) | Mendapatkan atau mengatur kedalaman profil. |
...
| Nama | Deskripsi |
| --- | --- |
| getWidth() | Mendapatkan atau mengatur lebar profil. |
...
| Nama | Deskripsi |
| --- | --- |
| setWidth(value) | Mendapatkan atau mengatur lebar profil. |
...
| Nama | Deskripsi |
| --- | --- |
| getThickness() | Mendapatkan atau mengatur ketebalan dinding konstan. |
...
| Nama | Deskripsi |
| --- | --- |
| setThickness(value) | Mendapatkan atau mengatur ketebalan dinding konstan. |
...
| Nama | Deskripsi |
| --- | --- |
| getFilletRadius() | Mendapatkan atau mengatur jari-jari fillet. |
...
| Nama | Deskripsi |
| --- | --- |
| setFilletRadius(value) | Mendapatkan atau mengatur jari-jari fillet. |
...
| Nama | Deskripsi |
| --- | --- |
| getEdgeRadius() | Mendapatkan atau mengatur jari-jari tepi. |
...
| Nama | Deskripsi |
| --- | --- |
| setEdgeRadius(value) | Mendapatkan atau mengatur jari-jari tepi. |

...
url: /id/nodejs-java/aspose.threed/ellipseshape/
---
## EllipseShape class

Bentuk elips yang kompatibel dengan IFC yang didefinisikan oleh parameter. Posisi pusat profil berada di tengah kotak pembatas.
...
| Nama | Deskripsi |
| --- | --- |
| getSemiAxis1() | Mendapatkan atau mengatur radius pertama dari elips yang diukur dalam arah sumbu x. |
...
| Nama | Deskripsi |
| --- | --- |
| setSemiAxis1(value) | Mendapatkan atau mengatur radius pertama dari elips yang diukur dalam arah sumbu x. |
...
| Nama | Deskripsi |
| --- | --- |
| getSemiAxis2() | Mendapatkan atau mengatur radius kedua dari elips yang diukur dalam arah sumbu y. |
...
| Nama | Deskripsi |
| --- | --- |
| setSemiAxis2(value) | Mendapatkan atau mengatur radius kedua dari elips yang diukur dalam arah sumbu y. |

...
url: /id/nodejs-java/aspose.threed/compositecurve/
---
## CompositeCurve class

CompositeCurve adalah kumpulan beberapa segmen kurva.
...
| Nama | Deskripsi |
| --- | --- |
| constructor() | Konstruktor CompositeCurve |
...
| Nama | Deskripsi |
| --- | --- |
| addSegment(curve, sameDirection) | The |

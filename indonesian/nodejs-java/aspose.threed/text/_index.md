...
url: /id/nodejs-java/aspose.threed/text/
---
## Text class

Profil teks, profil ini menggambarkan kontur menggunakan font dan teks.
...
| Nama | Deskripsi |
| --- | --- |
| setFontSize(value) | Skala ukuran font. |

...
description: "Instansi format file untuk Microsoft 3MF dengan utilitas terkait 3MF."
type: docs
weight: 104
url: /id/java/com.aspose.threed/microsoft3mfformat/
---
...
Instansi format file untuk Microsoft 3MF dengan utilitas terkait 3MF.
## Bidang
...
| [getObjectType(Node node)](#getObjectType-com.aspose.threed.Node-) | Mendapatkan tipe model untuk node yang ditentukan. |
| [getTransformForBuild(Node node)](#getTransformForBuild-com.aspose.threed.Node-) | Dapatkan matriks transformasi untuk node yang digunakan dalam build. |
| [getVersion()](#getVersion--) | Mendapatkan versi format file |
| [hashCode()](#hashCode--) |  |
| [isBuildable(Node node)](#isBuildable-com.aspose.threed.Node-) | Periksa apakah node ini ditandai sebagai build. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBuildable(Node node, boolean value, Matrix4 transform)](#setBuildable-com.aspose.threed.Node-boolean-com.aspose.threed.Matrix4-) | Tandai sebuah node untuk build. |
| [setObjectType(Node node, String modelType)](#setObjectType-com.aspose.threed.Node-java.lang.String-) | Atur tipe model untuk node yang ditentukan. |
...
Mendapatkan tipe model untuk node yang ditentukan.
...
**Returns:**
java.lang.String - tipe objek 3MF untuk node yang diberikan
...
Dapatkan matriks transformasi untuk node yang digunakan dalam build.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Node mana yang akan diambil matriks transformasinya untuk build 3MF. |
...
Periksa apakah node ini ditandai sebagai build.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Node mana yang akan diperiksa |

**Returns:**
boolean - True jika ditandai sebagai build
### notify() {#notify--}
```
...
Tandai sebuah node untuk build.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| node | [Node](../../com.aspose.threed/node) | Node mana yang akan ditandai sebagai build. |
| nilai | boolean |  |
| transform | [Matrix4](../../com.aspose.threed/matrix4) | Transformasi node dalam build. |
...
Atur tipe model untuk node yang ditentukan. Nilai yang mungkin: model surface solidsupport support other

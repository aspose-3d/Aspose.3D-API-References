...
description: Dibuat oleh lexchou pada 13/6/2017.
type: docs
weight: 101
url: /id/java/com.aspose.threed/memorystream/
---
...
Dibuat oleh lexchou pada 13/6/2017.
## Konstruktor
...
| [setCapacity(int cap)](#setCapacity-int-) | Mengatur kapasitas ke nilai yang ditentukan |
...
| [wrap(OutputStream stream)](#wrap-java.io.OutputStream-) | Bungkus sebuah OutputStream sebagai Stream, stream harus ditutup untuk mengalirkan data ke output stream. |
...
Mengatur kapasitas ke nilai yang ditentukan

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| cap | int | kapasitas baru dari aliran memori. |
...
Bungkus sebuah OutputStream sebagai Stream, stream harus ditutup untuk mengalirkan data ke output stream.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| aliran | java.io.OutputStream | output stream untuk dibungkus |

...
description: Profil teks profil ini menjelaskan kontur menggunakan font dan teks.
type: docs
weight: 183
url: /id/java/com.aspose.threed/text/
---
...
Profil teks, profil ini menjelaskan kontur menggunakan font dan teks. **Contoh:** Kode berikut menunjukkan cara membuat mesh 3D dari teks menggunakan file font yang ditentukan.
...
| [getClass()](#getClass--) |  |
| [getContent()](#getContent--) | Konten teks |
...
| [getFont()](#getFont--) | Font teks. |
| [getFontSize()](#getFontSize--) | Skala ukuran font. |
...
| [setContent(String value)](#setContent-java.lang.String-) | Konten teks |
| [setExcluded(boolean value)](#setExcluded-boolean-) | Mengatur apakah entitas ini akan dikecualikan saat mengekspor. |
| [setFont(FontFile value)](#setFont-com.aspose.threed.FontFile-) | Font teks. |
| [setFontSize(float value)](#setFontSize-float-) | Skala ukuran font. |
...
**Returns:**
java.lang.String - Konten teks **Contoh:** Kode berikut menunjukkan cara membuat mesh 3D dari teks menggunakan file font yang ditentukan.
...
**Returns:**
float - Skala ukuran font. **Contoh:** Kode berikut menunjukkan cara membuat mesh 3D dari teks menggunakan file font yang ditentukan.
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
|  | nilai | java.lang.String | Nilai baru **Contoh:** Kode berikut menunjukkan cara membuat mesh 3D dari teks menggunakan file font yang ditentukan. |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
|  | value | [FontFile](../../com.aspose.threed/fontfile) | Nilai baru **Contoh:** Kode berikut menunjukkan cara membuat mesh 3D dari teks menggunakan file font yang ditentukan. |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
|  | nilai | float | Nilai baru **Contoh:** Kode berikut menunjukkan cara membuat mesh 3D dari teks menggunakan file font yang ditentukan. |

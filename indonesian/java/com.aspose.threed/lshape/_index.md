...
description: "Profil bentuk L yang kompatibel dengan IFC yang didefinisikan oleh parameter."
type: docs
weight: 91
url: /id/java/com.aspose.threed/lshape/
---
...
Profil bentuk L yang kompatibel dengan IFC yang didefinisikan oleh parameter.
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [LShape()](#LShape--) | Konstruktor dari [LShape](../../com.aspose.threed/lshape) |
## Metode
...
| [getEdgeRadius()](#getEdgeRadius--) | Mendapatkan radius tepi. |
...
| [getFilletRadius()](#getFilletRadius--) | Mendapatkan radius fillet. |
...
| [getThickness()](#getThickness--) | Mendapatkan ketebalan dinding konstan. |
...
| [setEdgeRadius(double value)](#setEdgeRadius-double-) | Mengatur radius tepi. |
| [setExcluded(boolean value)](#setExcluded-boolean-) | Mengatur apakah entitas ini akan dikecualikan saat mengekspor. |
| [setFilletRadius(double value)](#setFilletRadius-double-) | Mengatur radius fillet. |
...
| [setThickness(double value)](#setThickness-double-) | Mengatur ketebalan dinding konstan. |
...
Konstruktor dari [LShape](../../com.aspose.threed/lshape)
...
Mendapatkan ketebalan dinding konstan.

**Returns:**
double - ketebalan dinding konstan.
### getWidth() {#getWidth--}
```
...
Mengatur ketebalan dinding konstan.

...
description: "Material untuk model shading blinn-phong."
type: docs
weight: 126
url: /id/java/com.aspose.threed/phongmaterial/
---
...
| --- | --- |
| [PhongMaterial()](#PhongMaterial--) | Menginisialisasi sebuah instance baru dari kelas [PhongMaterial](../../com.aspose.threed/phongmaterial). |
| [PhongMaterial(String name)](#PhongMaterial-java.lang.String-) | Menginisialisasi sebuah instance baru dari kelas [PhongMaterial](../../com.aspose.threed/phongmaterial). |
## Bidang
...
| [getReflectionColor()](#getReflectionColor--) | Mendapatkan warna refleksi. |
| [getReflectionFactor()](#getReflectionFactor--) | Mendapatkan atenuasi warna refleksi. |
| [getShininess()](#getShininess--) | Mendapatkan tingkat kilau, ini mengontrol ukuran sorotan spekular. |
| [getSpecularColor()](#getSpecularColor--) | Mendapatkan warna spekular. |
| [getSpecularFactor()](#getSpecularFactor--) | Mendapatkan faktor spekular. |
...
| [setReflectionColor(Vector3 value)](#setReflectionColor-com.aspose.threed.Vector3-) | Mengatur warna refleksi. |
| [setReflectionFactor(double value)](#setReflectionFactor-double-) | Mengatur redaman warna refleksi. |
| [setShininess(double value)](#setShininess-double-) | Mengatur kilau, ini mengontrol ukuran sorotan spekular. |
| [setSpecularColor(Vector3 value)](#setSpecularColor-com.aspose.threed.Vector3-) | Mengatur warna spekular. |
| [setSpecularFactor(double value)](#setSpecularFactor-double-) | Mengatur faktor spekular. |
...
Menginisialisasi sebuah instance baru dari kelas [PhongMaterial](../../com.aspose.threed/phongmaterial).
...
Mendapatkan atenuasi warna refleksi.

**Returns:**
double - redaman warna refleksi.
...
Mendapatkan kilau, ini mengontrol ukuran sorotan spekular. Rumus spekular: SpecularColor \* SpecularFactor \* (N dot H) ^ Shininess

**Returns:**
double - kilau, ini mengontrol ukuran sorotan spekular. Rumus spekular: SpecularColor \* SpecularFactor \* (N dot H) ^ Shininess
...
Mendapatkan faktor spekular. Rumus spekular: SpecularColor \* SpecularFactor \* (N dot H) ^ Shininess

**Returns:**
double - faktor spekular. Rumus spekular: SpecularColor \* SpecularFactor \* (N dot H) ^ Shininess
...
Mengatur redaman warna refleksi.
...
Mengatur kilau, ini mengontrol ukuran sorotan spekular. Rumus spekular: SpecularColor \* SpecularFactor \* (N dot H) ^ Shininess
...
Mengatur faktor spekular. Rumus spekular: SpecularColor \* SpecularFactor \* (N dot H) ^ Shininess

...
description: Profil lingkaran kompatibel IFC yang dapat digunakan untuk membangun mesh melalui
type: docs
weight: 32
url: /id/java/com.aspose.threed/circleshape/
---
...
Profil lingkaran kompatibel IFC, yang dapat digunakan untuk membangun mesh melalui [LinearExtrusion](../../com.aspose.threed/linearextrusion)
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [CircleShape()](#CircleShape--) | Membuat profil [CircleShape](../../com.aspose.threed/circleshape) dengan radius default (5). |
| [CircleShape(double radius)](#CircleShape-double-) | Membuat profil [CircleShape](../../com.aspose.threed/circleshape) dengan radius yang ditentukan. |
## Metode
...
| [getRadius()](#getRadius--) | Mendapatkan radius lingkaran. |
...
| [setRadius(double value)](#setRadius-double-) | Mengatur radius lingkaran. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Membuat profil [CircleShape](../../com.aspose.threed/circleshape) dengan radius default (5).
...
Membuat profil [CircleShape](../../com.aspose.threed/circleshape) dengan radius yang ditentukan.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| radius | double | Radius lingkaran |
...
Mendapatkan radius lingkaran.

**Returns:**
double - jari-jari lingkaran.
### getScene() {#getScene--}
```

...
description: File font berisi definisi untuk glif yang digunakan untuk membuat profil teks.
type: docs
weight: 68
url: /id/java/com.aspose.threed/fontfile/
---
...
File font berisi definisi untuk glif, ini digunakan untuk membuat profil teks. **Example:** Kode berikut menunjukkan cara membuat mesh 3D dari teks menggunakan file font yang ditentukan.
...
| [fromFile(String fileName)](#fromFile-java.lang.String-) | Muat FontFile dari nama file |
| [getClass()](#getClass--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [parse(byte[] bytes)](#parse-byte---) | Urai FontFile dari byte |
...
Muat FontFile dari nama file

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| fileName | java.lang.String | Jalur ke file font |
...
Urai FontFile dari byte

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| bytes | byte[] | Konten mentah file font OTF |

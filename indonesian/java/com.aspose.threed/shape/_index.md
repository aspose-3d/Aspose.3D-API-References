...
description: Bentuk menggambarkan deformasi pada sekumpulan titik kontrol yang mirip dengan cluster deformer di Maya.
type: docs
weight: 171
url: /id/java/com.aspose.threed/shape/
---
...
Bentuk menggambarkan deformasi pada sekumpulan titik kontrol, yang mirip dengan cluster deformer di Maya. Misalnya, kita dapat menambahkan sebuah bentuk ke geometri yang dibuat. Bentuk dan geometri memiliki informasi topologi yang sama tetapi posisi titik kontrol yang berbeda. Dengan tingkat pengaruh yang bervariasi, geometri menghasilkan efek deformasi.
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [Shape()](#Shape--) | Menginisialisasi sebuah instance baru dari kelas [Shape](../../com.aspose.threed/shape). |
| [Shape(String name)](#Shape-java.lang.String-) | Menginisialisasi sebuah instance baru dari kelas [Shape](../../com.aspose.threed/shape). |
## Metode
...
| [fromControlPoints(Vector3[] controlPoints)](#fromControlPoints-com.aspose.threed.Vector3...-) | Buat sebuah bentuk dengan titik kontrol yang ditentukan dengan indeks default. |
...
| [getIndices()](#getIndices--) | Mendapatkan indeks. |
...
Menginisialisasi sebuah instance baru dari kelas [Shape](../../com.aspose.threed/shape).
...
Buat sebuah bentuk dengan titik kontrol yang ditentukan dengan indeks default.
...
**Returns:**
java.util.List<java.lang.Integer> - indeks.
### getName() {#getName--}
```

...
type: docs
weight: 184
url: /id/java/com.aspose.threed/texture/
---
...
| --- | --- |
| [Texture()](#Texture--) | Menginisialisasi sebuah instance baru dari kelas [Texture](../../com.aspose.threed/texture). |
| [Texture(String name)](#Texture-java.lang.String-) | Menginisialisasi sebuah instance baru dari kelas [Texture](../../com.aspose.threed/texture). |
## Metode
...
| [getClass()](#getClass--) |  |
| [getContent()](#getContent--) | Mendapatkan konten biner dari tekstur. |
| [getEnableMipMap()](#getEnableMipMap--) | Mendapatkan apakah mipmap diaktifkan untuk tekstur ini. |
| [getFileName()](#getFileName--) | Mendapatkan file tekstur yang terkait. |
...
| [setContent(byte[] value)](#setContent-byte---) | Mengatur konten biner tekstur. |
| [setEnableMipMap(boolean value)](#setEnableMipMap-boolean-) | Mengatur apakah mipmap diaktifkan untuk tekstur ini |
| [setFileName(String value)](#setFileName-java.lang.String-) | Mengatur file tekstur yang terkait. |
...
Menginisialisasi sebuah instance baru dari kelas [Texture](../../com.aspose.threed/texture).
...
Mendapatkan konten biner tekstur. Konten tekstur yang tertanam bersifat opsional, pengguna harus memuat tekstur dari file eksternal jika ini tidak ada.

**Returns:**
byte[] - konten biner tekstur. Konten tekstur yang tertanam bersifat opsional, pengguna harus memuat tekstur dari file eksternal jika ini tidak ada.
...
Mendapatkan apakah mipmap diaktifkan untuk tekstur ini.

**Returns:**
boolean - apakah mipmap diaktifkan untuk tekstur ini
...
Mendapatkan file tekstur yang terkait.

**Returns:**
java.lang.String - file tekstur yang terkait.
...
Mengatur konten biner tekstur. Konten tekstur yang tertanam bersifat opsional, pengguna harus memuat tekstur dari file eksternal jika ini tidak ada.
...
Mengatur apakah mipmap diaktifkan untuk tekstur ini
...
Mengatur file tekstur yang terkait.

...
description: Opsi muat untuk STL
type: docs
weight: 176
url: /id/java/com.aspose.threed/stlloadoptions/
---
...
| --- | --- |
| [StlLoadOptions()](#StlLoadOptions--) | Menginisialisasi sebuah instance baru [StlLoadOptions](../../com.aspose.threed/stlloadoptions). |
| [StlLoadOptions(FileContentType contentType)](#StlLoadOptions-com.aspose.threed.FileContentType-) | Menginisialisasi sebuah instance baru [StlLoadOptions](../../com.aspose.threed/stlloadoptions). |
## Metode
...
| [getFlipCoordinateSystem()](#getFlipCoordinateSystem--) | Mendapatkan apakah akan membalik sistem koordinat titik kontrol/normal selama impor. |
...
| [getRecalculateNormal()](#getRecalculateNormal--) | Abaikan data normal yang disimpan dalam file STL dan hitung ulang data normal berdasarkan posisi vertex. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFlipCoordinateSystem(boolean value)](#setFlipCoordinateSystem-boolean-) | Mengatur apakah akan membalik sistem koordinat titik kontrol/normal selama impor. |
...
| [setRecalculateNormal(boolean value)](#setRecalculateNormal-boolean-) | Abaikan data normal yang disimpan dalam file STL dan hitung ulang data normal berdasarkan posisi vertex. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Menginisialisasi sebuah instance baru [StlLoadOptions](../../com.aspose.threed/stlloadoptions).
...
Mendapatkan apakah akan membalik sistem koordinat titik kontrol/normal selama impor.

**Returns:**
boolean - apakah akan membalik sistem koordinat titik kontrol/normal selama impor.
...
Abaikan data normal yang disimpan dalam file STL dan hitung ulang data normal berdasarkan posisi vertex. Nilai default adalah false

**Returns:**
boolean - Abaikan data normal yang disimpan dalam file STL dan hitung ulang data normal berdasarkan posisi vertex. Nilai default adalah false
### hashCode() {#hashCode--}
```
...
Mengatur apakah akan membalik sistem koordinat titik kontrol/normal selama impor.

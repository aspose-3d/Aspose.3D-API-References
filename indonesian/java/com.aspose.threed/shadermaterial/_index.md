...
description: Material shader memungkinkan untuk mendeskripsikan material menggunakan mesin render eksternal atau bahasa shader.
type: docs
weight: 164
url: /id/java/com.aspose.threed/shadermaterial/
---
...
Material shader memungkinkan mendeskripsikan material dengan mesin render eksternal atau bahasa shader. [ShaderMaterial](../../com.aspose.threed/shadermaterial) menggunakan [ShaderTechnique](../../com.aspose.threed/shadertechnique) untuk mendeskripsikan detail rendering yang konkret, dan yang paling cocok akan digunakan sesuai platform rendering akhir. Misalnya, instance [ShaderMaterial](../../com.aspose.threed/shadermaterial) Anda dapat memiliki dua teknik, satu didefinisikan oleh HLSL, dan yang lain didefinisikan oleh GLSL. Pada platform non‑window, GLSL harus digunakan alih-alih HLSL
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [ShaderMaterial()](#ShaderMaterial--) | Menginisialisasi sebuah instance baru dari kelas [ShaderMaterial](../../com.aspose.threed/shadermaterial). |
| [ShaderMaterial(String name)](#ShaderMaterial-java.lang.String-) | Menginisialisasi sebuah instance baru dari kelas [ShaderMaterial](../../com.aspose.threed/shadermaterial). |
## Bidang
...
| [getTechniques()](#getTechniques--) | Mendapatkan semua teknik yang tersedia yang didefinisikan dalam material ini. |
...
Menginisialisasi sebuah instance baru dari kelas [ShaderMaterial](../../com.aspose.threed/shadermaterial).
...
Mendapatkan semua teknik yang tersedia yang didefinisikan dalam material ini.

**Returns:**
java.util.List<com.aspose.threed.ShaderTechnique> - semua teknik yang tersedia yang didefinisikan dalam material ini.

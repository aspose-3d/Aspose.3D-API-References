...
description: Profil garis tengah yang kompatibel dengan IFC
type: docs
weight: 30
url: /id/java/com.aspose.threed/centerlineprofile/
---
...
Profil garis tengah yang kompatibel dengan IFC
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [CenterLineProfile(Curve curve, double thickness)](#CenterLineProfile-com.aspose.threed.Curve-double-) | Membuat sebuah [CenterLineProfile](../../com.aspose.threed/centerlineprofile) baru dengan kurva yang ditentukan sebagai garis tengah. |
| [CenterLineProfile(Curve curve)](#CenterLineProfile-com.aspose.threed.Curve-) | Membuat sebuah [CenterLineProfile](../../com.aspose.threed/centerlineprofile) baru dengan kurva yang ditentukan sebagai garis tengah. |
## Metode
...
| [getClass()](#getClass--) |  |
| [getCurve()](#getCurve--) | Kurva garis tengah dari profil |
...
| [getThickness()](#getThickness--) | Ketebalan yang diterapkan sepanjang garis tengah |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setCurve(Curve value)](#setCurve-com.aspose.threed.Curve-) | Kurva garis tengah dari profil |
...
| [setThickness(double value)](#setThickness-double-) | Ketebalan yang diterapkan sepanjang garis tengah |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Membuat sebuah [CenterLineProfile](../../com.aspose.threed/centerlineprofile) baru dengan kurva yang ditentukan sebagai garis tengah.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| curve | [Curve](../../com.aspose.threed/curve) | Kurva garis tengah |
| ketebalan | double | Ketebalan yang diterapkan sepanjang garis tengah |
...
Kurva garis tengah dari profil
...
Ketebalan yang diterapkan sepanjang garis tengah

**Returns:**
double - Ketebalan yang diterapkan sepanjang garis tengah
### hashCode() {#hashCode--}
```

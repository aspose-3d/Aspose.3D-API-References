...
description: "Contoh Adobe Portable Document Format Kode berikut menunjukkan cara mengekstrak semua adegan 3D yang didukung dari file PDF 3D dan menuliskannya ke format obj."
type: docs
weight: 123
url: /id/java/com.aspose.threed/pdfformat/
---
...
Format Dokumen Portabel Adobe **Contoh:** Kode berikut menunjukkan cara mengekstrak semua adegan 3D yang didukung dari file PDF 3D, dan menuliskannya ke format obj.
...
| [extract(Stream stream)](#extract-com.aspose.threed.Stream-) | Ekstrak konten 3D mentah dari aliran PDF. |
| [extract(Stream stream, byte[] password)](#extract-com.aspose.threed.Stream-byte---) | Ekstrak konten 3D mentah dari aliran PDF. |
| [extract(String fileName)](#extract-java.lang.String-) | Ekstrak konten 3D mentah dari file PDF. |
| [extract(String fileName, byte[] password)](#extract-java.lang.String-byte---) | Ekstrak konten 3D mentah dari file PDF. |
| [extractScene(Stream stream)](#extractScene-com.aspose.threed.Stream-) | Ekstrak konten 3D mentah dari aliran PDF. |
| [extractScene(Stream stream, byte[] password)](#extractScene-com.aspose.threed.Stream-byte---) | Ekstrak konten 3D mentah dari aliran PDF. |
| [extractScene(String fileName)](#extractScene-java.lang.String-) | Ekstrak adegan 3D dari file PDF. |
| [extractScene(String fileName, byte[] password)](#extractScene-java.lang.String-byte---) | Ekstrak adegan 3D dari file PDF. |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | Aliran file PDF masukan |

**Returns:**
java.util.ArrayList<byte[]> - Daftar semua konten 3D dalam byte, termasuk format yang tidak didukung oleh Aspose.3D. **Example:** Kode berikut menunjukkan cara mengekstrak semua konten 3D mentah dari file PDF 3D, dan menuliskannya ke file.
...
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | Aliran file PDF masukan |
| kata sandi | byte[] | Kata sandi file PDF |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| fileName | java.lang.String | Nama file PDF masukan |
...
**Returns:**
java.util.ArrayList<com.aspose.threed.Scene> - Daftar adegan 3D yang didekode yang didukung oleh Aspose.3D **Example:** Kode berikut menunjukkan cara mengekstrak semua adegan 3D yang didukung dari file PDF 3D, dan menuliskannya ke format obj.

...
description: Contoh format Google Draco         Kode berikut menunjukkan cara meng-encode dan decode Mesh ke/dari array byte
type: docs
weight: 46
url: /id/java/com.aspose.threed/dracoformat/
---
...
Format Google Draco **Contoh:** Kode berikut menunjukkan cara mengkodekan dan mendekode Mesh ke/dari array byte:
...
| [decode(byte[] data)](#decode-byte---) | Decode awan titik atau mesh dari data memori |
| [decode(String fileName)](#decode-java.lang.String-) | Decode awan titik atau mesh dari nama file yang ditentukan |
...
| [encode(Entity entity)](#encode-com.aspose.threed.Entity-) | Encode entitas ke data mentah Draco |
| [encode(Entity entity, DracoSaveOptions options)](#encode-com.aspose.threed.Entity-com.aspose.threed.DracoSaveOptions-) | Encode entitas ke data mentah Draco |
| [encode(Entity entity, Stream stream)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-) | Encode entitas ke stream yang ditentukan |
| [encode(Entity entity, Stream stream, DracoSaveOptions options)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-com.aspose.threed.DracoSaveOptions-) | Encode entitas ke stream yang ditentukan |
| [encode(Entity entity, String fileName)](#encode-com.aspose.threed.Entity-java.lang.String-) | Encode entitas ke file yang ditentukan |
| [encode(Entity entity, String fileName, DracoSaveOptions options)](#encode-com.aspose.threed.Entity-java.lang.String-com.aspose.threed.DracoSaveOptions-) | Encode entitas ke file yang ditentukan |
...
Decode awan titik atau mesh dari data memori
...
Decode awan titik atau mesh dari nama file yang ditentukan

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| fileName | java.lang.String | Nama file berisi file drc |
...
Encode entitas ke data mentah Draco

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | Entitas yang akan di-encode |

**Returns:**
byte[] - Data draco yang di-encode direpresentasikan dalam byte **Example:** Kode berikut menunjukkan cara meng-encode dan decode Mesh ke/dari array byte:
...
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | Entitas yang akan di-encode |
| options | [DracoSaveOptions](../../com.aspose.threed/dracosaveoptions) | Opsi tambahan untuk meng-encode awan titik |
...
Encode entitas ke stream yang ditentukan

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | Entitas yang akan di-encode |
| stream | [Stream](../../com.aspose.threed/stream) | Stream tempat data yang di-encode akan ditulis |
...
Encode entitas ke file yang ditentukan

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | Entitas yang akan di-encode |
| fileName | java.lang.String | Nama file yang akan ditulis |

...
type: docs
weight: 129
url: /id/java/com.aspose.threed/plyformat/
---
...
Format PLY. **Contoh:** Kode berikut menunjukkan cara mendekode mesh dari file PLY:
...
| [decode(Stream stream)](#decode-com.aspose.threed.Stream-) | Dekode awan titik atau mesh dari aliran yang ditentukan. |
| [decode(Stream stream, PlyLoadOptions opt)](#decode-com.aspose.threed.Stream-com.aspose.threed.PlyLoadOptions-) | Dekode awan titik atau mesh dari aliran yang ditentukan. |
| [decode(String fileName)](#decode-java.lang.String-) | Dekode awan titik atau mesh dari aliran yang ditentukan. |
| [decode(String fileName, PlyLoadOptions opt)](#decode-java.lang.String-com.aspose.threed.PlyLoadOptions-) | Dekode awan titik atau mesh dari aliran yang ditentukan. |
...
| [encode(Entity entity, Stream stream)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-) | Enkode entitas dan simpan hasilnya ke dalam aliran. |
| [encode(Entity entity, Stream stream, PlySaveOptions opt)](#encode-com.aspose.threed.Entity-com.aspose.threed.Stream-com.aspose.threed.PlySaveOptions-) | Enkode entitas dan simpan hasilnya ke dalam aliran. |
| [encode(Entity entity, String fileName)](#encode-com.aspose.threed.Entity-java.lang.String-) | Enkode entitas dan simpan hasilnya ke dalam file eksternal. |
| [encode(Entity entity, String fileName, PlySaveOptions opt)](#encode-com.aspose.threed.Entity-java.lang.String-com.aspose.threed.PlySaveOptions-) | Enkode entitas dan simpan hasilnya ke dalam file eksternal. |
...
Dekode awan titik atau mesh dari aliran yang ditentukan.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | Aliran masukan |
...
| --- | --- | --- |
| stream | [Stream](../../com.aspose.threed/stream) | Aliran masukan |
| opt | [PlyLoadOptions](../../com.aspose.threed/plyloadoptions) | Opsi muat format PLY |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| fileName | java.lang.String | Aliran masukan |
...
Enkode entitas dan simpan hasilnya ke dalam aliran.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | Entitas yang akan dienkode |
|  | stream | [Stream](../../com.aspose.threed/stream) | Aliran untuk menulis, metode ini tidak akan menutup aliran ini **Example:** Kode berikut menunjukkan cara mengkodekan mesh ke file PLY: |
...
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | Entitas yang akan dienkode |
| stream | [Stream](../../com.aspose.threed/stream) | Aliran untuk menulis, metode ini tidak akan menutup aliran ini |
|  | opt | [PlySaveOptions](../../com.aspose.threed/plysaveoptions) | Opsi penyimpanan **Example:** Kode berikut menunjukkan cara mengkodekan mesh ke file PLY: |
...
Enkode entitas dan simpan hasilnya ke dalam file eksternal.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | Entitas yang akan dienkode |
|  | fileName | java.lang.String | File untuk menulis **Example:** Kode berikut menunjukkan cara mengkodekan mesh ke file PLY: |
...
| --- | --- | --- |
| entity | [Entity](../../com.aspose.threed/entity) | Entitas yang akan dienkode |
| fileName | java.lang.String | File untuk menulis |
|  | opt | [PlySaveOptions](../../com.aspose.threed/plysaveoptions) | Opsi penyimpanan **Example:** Kode berikut menunjukkan cara mengkodekan mesh ke file PLY: |

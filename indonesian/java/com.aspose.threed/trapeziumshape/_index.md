...
description: Bentuk Trapesium yang kompatibel dengan IFC didefinisikan oleh parameter.
type: docs
weight: 193
url: /id/java/com.aspose.threed/trapeziumshape/
---
...
Bentuk Trapesium yang kompatibel dengan IFC didefinisikan oleh parameter.
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [TrapeziumShape()](#TrapeziumShape--) | Konstruktor [TrapeziumShape](../../com.aspose.threed/trapeziumshape) |
## Metode
...
| [getBottomXDim()](#getBottomXDim--) | Mendapatkan panjang garis bawah yang diukur sepanjang sumbu x. |
...
| [getTopXDim()](#getTopXDim--) | Mendapatkan panjang garis atas yang diukur sepanjang sumbu x. |
| [getTopXOffset()](#getTopXOffset--) | Mendapatkan offset dari awal garis atas ke garis bawah. |
| [getYDim()](#getYDim--) | Mendapatkan jarak antara garis atas dan bawah yang diukur sepanjang sumbu y. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setBottomXDim(double value)](#setBottomXDim-double-) | Mengatur panjang garis bawah yang diukur sepanjang sumbu x. |
...
| [setTopXDim(double value)](#setTopXDim-double-) | Mengatur panjang garis atas yang diukur sepanjang sumbu x. |
| [setTopXOffset(double value)](#setTopXOffset-double-) | Mengatur offset dari awal garis atas ke garis bawah. |
| [setYDim(double value)](#setYDim-double-) | Mengatur jarak antara garis atas dan bawah yang diukur sepanjang sumbu y. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Konstruktor [TrapeziumShape](../../com.aspose.threed/trapeziumshape)
...
Mendapatkan panjang garis bawah yang diukur sepanjang sumbu x.

**Returns:**
double - panjang garis bawah yang diukur sepanjang sumbu x.
...
Mendapatkan panjang garis atas yang diukur sepanjang sumbu x.

**Returns:**
double - panjang garis atas yang diukur sepanjang sumbu x.
...
Mendapatkan offset dari awal garis atas ke garis bawah.

**Returns:**
double - offset dari awal garis atas ke garis bawah.
### getYDim() {#getYDim--}
```
...
Mendapatkan jarak antara garis atas dan bawah yang diukur sepanjang sumbu y.

**Returns:**
double - jarak antara garis atas dan bawah yang diukur sepanjang sumbu y.
### hashCode() {#hashCode--}
```
...
Mengatur panjang garis bawah yang diukur sepanjang sumbu x.
...
Mengatur panjang garis atas yang diukur sepanjang sumbu x.
...
Mengatur offset dari awal garis atas ke garis bawah.
...
Mengatur jarak antara garis atas dan bawah yang diukur sepanjang sumbu y.

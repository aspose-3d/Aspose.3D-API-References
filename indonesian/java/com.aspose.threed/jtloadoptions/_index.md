...
description: Opsi pemuatan untuk Siemens JT
type: docs
weight: 88
url: /id/java/com.aspose.threed/jtloadoptions/
---
...
Opsi pemuatan untuk Siemens JT
## Konstruktor
...
| [getLoadPMI()](#getLoadPMI--) | Muat informasi PMI dari file JT jika memungkinkan, data akan disimpan sebagai properti "PMI" dari [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). |
| [getLoadProperties()](#getLoadProperties--) | Muat properti dari tabel properti JT sebagai properti Aspose.3D. |
...
| [setLoadPMI(boolean value)](#setLoadPMI-boolean-) | Muat informasi PMI dari file JT jika memungkinkan, data akan disimpan sebagai properti "PMI" dari [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). |
| [setLoadProperties(boolean value)](#setLoadProperties-boolean-) | Muat properti dari tabel properti JT sebagai properti Aspose.3D. |
...
Muat informasi PMI dari file JT jika memungkinkan, data akan disimpan sebagai properti "PMI" dari [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). Nilai default adalah false.

**Returns:**
boolean - Muat informasi PMI dari file JT jika memungkinkan, data akan disimpan sebagai properti "PMI" dari [Scene.getAssetInfo](../../com.aspose.threed/scene\#getAssetInfo). Nilai default adalah false.
...
Muat properti dari tabel properti JT sebagai properti Aspose.3D. Nilai default adalah false.

**Returns:**
boolean - Muat properti dari tabel properti JT sebagai properti Aspose.3D. Nilai default adalah false.

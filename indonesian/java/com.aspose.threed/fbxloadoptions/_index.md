...
description: Opsi muat untuk format Fbx.
type: docs
weight: 62
url: /id/java/com.aspose.threed/fbxloadoptions/
---
...
Opsi muat untuk format Fbx.
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [FbxLoadOptions(FileFormat format)](#FbxLoadOptions-com.aspose.threed.FileFormat-) | Konstruktor dari [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions) |
| [FbxLoadOptions()](#FbxLoadOptions--) | Konstruktor dari [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions) |
## Metode
...
| [getClass()](#getClass--) |  |
| [getCompatibleMode()](#getCompatibleMode--) | Mendapatkan apakah akan mengaktifkan mode kompatibel. |
...
| [getKeepBuiltinGlobalSettings()](#getKeepBuiltinGlobalSettings--) | Mendapatkan apakah akan mempertahankan properti bawaan di GlobalSettings yang memiliki pengganti properti native di [AssetInfo](../../com.aspose.threed/assetinfo). |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setCompatibleMode(boolean value)](#setCompatibleMode-boolean-) | Mengatur apakah akan mengaktifkan mode kompatibel. |
...
| [setKeepBuiltinGlobalSettings(boolean value)](#setKeepBuiltinGlobalSettings-boolean-) | Mengatur apakah akan mempertahankan properti bawaan di GlobalSettings yang memiliki pengganti properti native di [AssetInfo](../../com.aspose.threed/assetinfo). |
...
Konstruktor dari [FbxLoadOptions](../../com.aspose.threed/fbxloadoptions)

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| format | [FileFormat](../../com.aspose.threed/fileformat) | Instansi dari [getFileFormat](../../com.aspose.threed/fbxloadoptions\#getFileFormat), harus berupa format FBX yang valid. |
...
Mendapatkan apakah akan mengaktifkan mode kompatibel. Mode kompatibel akan mencoba mendukung definisi FBX non-standar seperti material PBR yang diekspor oleh Blender. Nilai default adalah false.

**Returns:**
boolean - apakah akan mengaktifkan mode kompatibel. Mode kompatibel akan mencoba mendukung definisi FBX non-standar seperti material PBR yang diekspor oleh Blender. Nilai default adalah false.
...
Mendapatkan apakah akan mempertahankan properti bawaan di GlobalSettings yang memiliki pengganti properti native di [AssetInfo](../../com.aspose.threed/assetinfo). Atur ini ke true jika Anda menginginkan properti lengkap di GlobalSettings. Nilai default adalah false

**Returns:**
boolean - apakah akan mempertahankan properti bawaan di GlobalSettings yang memiliki pengganti properti native di [AssetInfo](../../com.aspose.threed/assetinfo). Atur ini ke true jika Anda menginginkan properti lengkap di GlobalSettings. Nilai default adalah false
...
Mengatur apakah akan mengaktifkan mode kompatibel. Mode kompatibel akan mencoba mendukung definisi FBX non-standar seperti material PBR yang diekspor oleh Blender. Nilai default adalah false.
...
Mengatur apakah akan mempertahankan properti bawaan di GlobalSettings yang memiliki pengganti properti native di [AssetInfo](../../com.aspose.threed/assetinfo). Atur ini ke true jika Anda menginginkan properti lengkap di GlobalSettings. Nilai default adalah false

...
description: API rendering yang umum digunakan
type: docs
weight: 269
url: /id/java/com.aspose.threed/renderingapi/
---
...
API rendering yang umum digunakan
## Bidang

| Bidang | Deskripsi |
| --- | --- |
| [ARNOLD](#ARNOLD) | Renderer Arnold |
| [CUSTOM](#CUSTOM) | API rendering khusus |
| [DIRECTX](#DIRECTX) | DirectX |
| [MANTLE](#MANTLE) | AMD Mantle |
| [MENTAL_RAY](#MENTAL-RAY) | MentalRay |
| [METAL](#METAL) | Metal yang dikembangkan oleh Apple |
| [NONE](#NONE) | Tidak ada API rendering |
| [OPENGL](#OPENGL) | OpenGL |
| [OPENGLES](#OPENGLES) | OpenGL ES |
| [PREVIEW](#PREVIEW) | PreviewColorAPI, kompatibel dengan FBX |
| [RENDER_MAN](#RENDER-MAN) | RenderMan |
| [RENDER_WARE](#RENDER-WARE) | RenderWare |
| [SHADERFX](#SHADERFX) | Renderer ShaderFX |
| [STAGE3D](#STAGE3D) | Stage3D yang digunakan dalam Adobe Flash |
...
Metal yang dikembangkan oleh Apple
...
PreviewColorAPI, kompatibel dengan FBX
...
Stage3D yang digunakan dalam Adobe Flash

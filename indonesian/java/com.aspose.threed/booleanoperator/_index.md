...
description: Operator Boolean memungkinkan Anda menerapkan operasi Boolean pada dua instance.
type: docs
weight: 23
url: /id/java/com.aspose.threed/booleanoperator/
---
...
Operator Boolean memungkinkan Anda menerapkan operasi Boolean pada dua instance [IMeshConvertible](../../com.aspose.threed/imeshconvertible).
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [BooleanOperator()](#BooleanOperator--) | Konstruktor dari [BooleanOperator](../../com.aspose.threed/booleanoperator) |
| [BooleanOperator(BooleanOperation operation, A3DObject first, A3DObject second)](#BooleanOperator-com.aspose.threed.BooleanOperation-com.aspose.threed.A3DObject-com.aspose.threed.A3DObject-) | Membuat instance baru dari [BooleanOperator](../../com.aspose.threed/booleanoperator) dengan dua operand. |
## Metode
...
| [getFirst()](#getFirst--) | Operand pertama dari operator Boolean |
| [getName()](#getName--) | Mendapatkan nama. |
| [getOperator()](#getOperator--) | Operator Boolean yang digunakan dalam operasi untuk membuat mesh hasil. |
...
| [getSecond()](#getSecond--) | Operand kedua dari operator Boolean |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFirst(BooleanOperand value)](#setFirst-com.aspose.threed.BooleanOperand-) | Operand pertama dari operator Boolean |
| [setName(String value)](#setName-java.lang.String-) | Mengatur nama. |
| [setOperator(BooleanOperation value)](#setOperator-com.aspose.threed.BooleanOperation-) | Operator Boolean yang digunakan dalam operasi untuk membuat mesh hasil. |
...
| [setSecond(BooleanOperand value)](#setSecond-com.aspose.threed.BooleanOperand-) | Operand kedua dari operator Boolean |
| [toMesh()](#toMesh--) | Lakukan operasi Boolean pada dua operand |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Konstruktor dari [BooleanOperator](../../com.aspose.threed/booleanoperator)
...
Membuat instance baru dari [BooleanOperator](../../com.aspose.threed/booleanoperator) dengan dua operand.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| operation | [BooleanOperation](../../com.aspose.threed/booleanoperation) | Jenis operasi Boolean |
| first | [A3DObject](../../com.aspose.threed/a3dobject) | Instance dari [IMeshConvertible](../../com.aspose.threed/imeshconvertible), [HalfSpace](../../com.aspose.threed/halfspace) atau [Node](../../com.aspose.threed/node) |
| second | [A3DObject](../../com.aspose.threed/a3dobject) | Instance dari [IMeshConvertible](../../com.aspose.threed/imeshconvertible), [HalfSpace](../../com.aspose.threed/halfspace) atau [Node](../../com.aspose.threed/node) |
...
Operand pertama dari operator Boolean
...
Operator Boolean yang digunakan dalam operasi untuk membuat mesh hasil.
...
Operand kedua dari operator Boolean
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| value | [BooleanOperand](../../com.aspose.threed/booleanoperand) | Nilai baru |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| value | [BooleanOperation](../../com.aspose.threed/booleanoperation) | Nilai baru |
...
Lakukan operasi Boolean pada dua operand

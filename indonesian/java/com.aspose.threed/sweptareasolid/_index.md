...
description: "Sebuah konstruktor membangun geometri dengan menyapu profil sepanjang directrix."
type: docs
weight: 181
url: /id/java/com.aspose.threed/sweptareasolid/
---
...
Sebuah [SweptAreaSolid](../../com.aspose.threed/sweptareasolid) membangun geometri dengan menyapu profil sepanjang directrix. **Contoh:** Kode berikut menunjukkan cara memodelkan entitas solid dengan menyapu bentuk C pada sebuah lingkaran
...
| [getClass()](#getClass--) |  |
| [getDirectrix()](#getDirectrix--) | Directrix yang menjadi jalur penyapuan area yang disapu. |
| [getEndPoint()](#getEndPoint--) | Titik akhir dari directrix. |
...
| [getShape()](#getShape--) | Profil dasar untuk membangun geometri. |
| [getStartPoint()](#getStartPoint--) | Titik awal dari directrix. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setDirectrix(Curve value)](#setDirectrix-com.aspose.threed.Curve-) | Directrix yang menjadi jalur penyapuan area yang disapu. |
| [setEndPoint(EndPoint value)](#setEndPoint-com.aspose.threed.EndPoint-) | Titik akhir dari directrix. |
...
| [setShape(Profile value)](#setShape-com.aspose.threed.Profile-) | Profil dasar untuk membangun geometri. |
| [setStartPoint(EndPoint value)](#setStartPoint-com.aspose.threed.EndPoint-) | Titik awal dari directrix. |
...
Directrix yang menjadi jalur penyapuan area yang disapu.
...
Profil dasar untuk membangun geometri.

...
description: Profil bentuk C yang kompatibel dengan IFC yang ditentukan oleh parameter. Posisi tengah profil berada di tengah kotak pembatas.
type: docs
weight: 1520
url: /id/net/aspose.threed.profiles/cshape/
---
## CShape class

Profil bentuk C yang kompatibel dengan IFC yang ditentukan oleh parameter. Posisi tengah profil berada di tengah kotak pembatas.
...
| Nama | Keterangan |
| --- | --- |
| [CShape](cshape/)() | Pembuat dari`CShape` |

## Properti

| Nama | Keterangan |
| --- | --- |
| [Depth](../../aspose.threed.profiles/cshape/depth/) { get; set; } | Mendapat atau menyetel kedalaman profil. |
...
| [Girth](../../aspose.threed.profiles/cshape/girth/) { get; set; } | Mendapat atau mengatur panjang ketebalan. |
| [InternalFilletRadius](../../aspose.threed.profiles/cshape/internalfilletradius/) { get; set; } | Mendapat atau menyetel radius fillet internal. |
...
| [WallThickness](../../aspose.threed.profiles/cshape/wallthickness/) { get; set; } | Mendapat atau mengatur ketebalan dinding. |
| [Width](../../aspose.threed.profiles/cshape/width/) { get; set; } | Mendapat atau mengatur lebar profil. |
...
| override [GetExtent](../../aspose.threed.profiles/cshape/getextent/)() | Mendapat luasan dalam dimensi x dan y. |

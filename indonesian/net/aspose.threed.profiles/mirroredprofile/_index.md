...
description: IFC compatible mirror profile. Profil ini mendefinisikan profil baru dengan mencerminkan profil dasar tentang sumbu y.
type: docs
weight: 1590
url: /id/net/aspose.threed.profiles/mirroredprofile/
---
## MirroredProfile class

IFC compatible mirror profile. Profil ini mendefinisikan profil baru dengan mencerminkan profil dasar tentang sumbu y.
...
| Nama | Keterangan |
| --- | --- |
| [MirroredProfile](mirroredprofile/)(Profile) | Bangun yang baru`MirroredProfile` dari profil yang ada. |

## Properti

| Nama | Keterangan |
| --- | --- |
| [BaseProfile](../../aspose.threed.profiles/mirroredprofile/baseprofile/) { get; } | Profil dasar yang akan dicerminkan. |

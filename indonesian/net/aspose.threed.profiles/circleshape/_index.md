...
description: Profil lingkaran yang kompatibel dengan IFC yang dapat digunakan untuk membuat mesh throughLinearExtrusion../aspose.threed.entities/linearextrusion/
type: docs
weight: 1530
url: /id/net/aspose.threed.profiles/circleshape/
---
## CircleShape class

Profil lingkaran yang kompatibel dengan IFC, yang dapat digunakan untuk membuat mesh through[`LinearExtrusion`](../../aspose.threed.entities/linearextrusion/)
...
| Nama | Keterangan |
| --- | --- |
| [CircleShape](circleshape/#constructor)() | Bangun a`CircleShape` profil dengan radius default(5). |
| [CircleShape](circleshape/#constructor_1)(double) | Bangun a`CircleShape` profil dengan radius tertentu. |

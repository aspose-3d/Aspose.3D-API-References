...
description: Awan titik tidak berisi informasi topologi tetapi hanya titik kontrol dan elemen simpul.
type: docs
weight: 540
url: /id/net/aspose.threed.entities/pointcloud/
---
## PointCloud class

Awan titik tidak berisi informasi topologi tetapi hanya titik kontrol dan elemen simpul.
...
| Nama | Keterangan |
| --- | --- |
| [PointCloud](pointcloud/#constructor)() | Pembuat dari`PointCloud` |
| [PointCloud](pointcloud/#constructor_1)(string) | Pembuat dari`PointCloud` |
...
| Nama | Keterangan |
| --- | --- |
| static [FromGeometry](../../aspose.threed.entities/pointcloud/fromgeometry/#fromgeometry)(Geometry) | Buat instance PointCloud baru dari objek geometri |
| static [FromGeometry](../../aspose.threed.entities/pointcloud/fromgeometry/#fromgeometry_1)(Geometry, int) | Buat instance point cloud baru dari objek geometri. Kepadatan adalah jumlah titik per satuan segitiga(Satuan segitiga adalah segitiga dengan luas permukaan maksimum dari mesh) |
...
| override [GetEntityRendererKey](../../aspose.threed.entities/pointcloud/getentityrendererkey/)() | Mendapat kunci dari perender entitas yang terdaftar di perender |

...
type: docs
weight: 60
url: /id/python-net/aspose.threed.entities/polygonmodifier/merge_mesh/
is_root: false
---
...
# File input mungkin berisi beberapa objek
scene = Scene.from_file("input.fbx")
# sekarang gabungkan menjadi satu mesh
merged = PolygonModifier.merge_mesh(scene)
# kemudian kami menyimpannya ke file dengan hanya satu mesh

...
type: docs
weight: 130
url: /id/python-net/aspose.threed/node/select_single_object/
is_root: false
---
...
# Pilih objek kamera tunggal di bawah node anak dari node bernama 'c' di bawah node akar
c1 = s.root_node.select_single_object("/c/*/<Camera>")
#  Pilih node bernama 'a1' di bawah node akar, bahkan jika 'a1' bukan node anak langsung dari
obj = s.root_node.select_single_object("a1")
# Pilih node itu sendiri, karena '/' dipilih langsung pada node akar, sehingga node akar dipilih.
